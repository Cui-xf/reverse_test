...
public final class UStringsKt {
    ...
    public static final String m8325toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m8327toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m8326toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString($this$toString_u2dV7xB4Y4 & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m8324toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m7094constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m7011boximpl(UByte.m7017constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m7094constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m7274boximpl(UShort.m7280constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m7094constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m7094constructorimpl(result * uradix);
            result = UInt.m7094constructorimpl(UInt.m7094constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m7088boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m7173constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m7173constructorimpl(result * uradix);
            result = ULong.m7173constructorimpl(ULong.m7173constructorimpl(UInt.m7094constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m7167boximpl(result);
    }
}
