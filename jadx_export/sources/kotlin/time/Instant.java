...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m8438plusLRDsOJo(long duration) {
        long secondsToAdd = Duration.m8352getInWholeSecondsimpl(duration);
        int nanosecondsToAdd = Duration.m8354getNanosecondsComponentimpl(duration);
        ...
        if ((a$iv ^ sum$iv) < 0 && (a$iv ^ secondsToAdd) >= 0) {
            return Duration.m8365isPositiveimpl(duration) ? MAX : MIN;
        }
    ...
    public final Instant m8436minusLRDsOJo(long duration) {
        return m8438plusLRDsOJo(Duration.m8382unaryMinusUwyO8pc(duration));
    }

    /* renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m8437minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m8367plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public int hashCode() {
        return FloatFloatPair$$ExternalSyntheticBackport0.m(this.epochSeconds) + (this.nanosecondsOfSecond * 51);
    }
