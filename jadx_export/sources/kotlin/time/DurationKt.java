...
public final class DurationKt {
    ...
    private static final long m8435timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m8369timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m8434timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m8368timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m8338constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m8338constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m8338constructorimpl((normalValue << 1) + unitDiscriminator);
    }
