...
public interface TimeMark {
    ...
    TimeMark mo8329minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo8331plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8449plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8448minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo8331plusLRDsOJo(Duration.m8382unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m8364isNegativeimpl($this.mo8328elapsedNowUwyO8pc());
        }
