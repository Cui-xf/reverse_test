...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo8328elapsedNowUwyO8pc() {
            return Duration.m8366minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo8331plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m8367plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo8330minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m8343equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m8363isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m8429getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m8366minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m8343equalsimpl0(startedAtDiff, Duration.m8382unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m8429getZEROUwyO8pc() : Duration.m8367plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m8343equalsimpl0(mo8330minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m8429getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m8359hashCodeimpl(Duration.m8367plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m8378toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m8429getZEROUwyO8pc(), null);
    }
}
