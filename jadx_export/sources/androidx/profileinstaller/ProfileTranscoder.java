...
class ProfileTranscoder {
    ...
    private static DexProfileData[] readUncompressedBody(InputStream is, String apkName, int numberOfDexFiles) throws IOException {
        ...
        while (i2 < i) {
            ...
            lines[i2] = new DexProfileData(apkName, Encoding.readString(is, dexNameSize), dexChecksum, 0L, classSetSize, (int) hotMethodRegionSize, (int) numMethodIds, new int[classSetSize], new TreeMap());
            i2++;
            i = numberOfDexFiles;
        }
        for (DexProfileData data : lines) {
