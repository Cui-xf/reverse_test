    ...
    */
    public final boolean remove(long r25) {
        /*
            ...
            r2 = 0
            r3 = 0
            int r4 = androidx.collection.FloatFloatPair$$ExternalSyntheticBackport0.m(r25)
    ...
    */
    public final void minusAssign(long r23) {
        /*
            ...
            r2 = 0
            r3 = 0
            int r4 = androidx.collection.FloatFloatPair$$ExternalSyntheticBackport0.m(r23)
            r5 = -862048943(0xffffffffcc9e2d51, float:-8.293031E7)
            int r4 = r4 * r5
            int r5 = r4 << 16
            r3 = r4 ^ r5
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i < previousCapacity) {
            if (!(((previousMetadata2[i >> 3] >> ((i & 7) << 3)) & 255) < 128)) {
                ...
                int hash$iv = FloatFloatPair$$ExternalSyntheticBackport0.m(previousElement) * ScatterMapKt.MurmurHashC1;
