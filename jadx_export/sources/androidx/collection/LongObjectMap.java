    ...
    */
    public final V getOrDefault(long r22, V r24) {
        /*
            ...
            r1 = 0
            r2 = 0
            int r3 = androidx.collection.FloatFloatPair$$ExternalSyntheticBackport0.m(r22)
    ...
    */
    public final boolean contains(long r24) {
        /*
            ...
            r1 = 0
            r2 = 0
            int r3 = androidx.collection.FloatFloatPair$$ExternalSyntheticBackport0.m(r24)
            r4 = -862048943(0xffffffffcc9e2d51, float:-8.293031E7)
            int r3 = r3 * r4
            int r4 = r3 << 16
            r2 = r3 ^ r4
                ...
                if ((((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    for (int j$iv$iv = 0; j$iv$iv < bitCount$iv$iv2; j$iv$iv++) {
                        ...
                        if (value$iv$iv$iv < 128) {
                            ...
                            long key = k$iv[index$iv$iv];
                            Object value = v$iv[index$iv$iv];
                            hash += FloatFloatPair$$ExternalSyntheticBackport0.m(key) ^ (value != null ? value.hashCode() : 0);
                        }
                        slot$iv$iv >>= 8;
                    }
