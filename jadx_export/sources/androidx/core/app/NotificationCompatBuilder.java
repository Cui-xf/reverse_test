...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder b) {
        ...
        if (i < 23) {
            builder.setLargeIcon(b.mLargeIcon == null ? null : b.mLargeIcon.getBitmap());
        } else {
            Api23Impl.setLargeIcon(builder, b.mLargeIcon == null ? null : b.mLargeIcon.toIcon(this.mContext));
        }
        Notification.Builder builder2 = this.mBuilder.setSubText(b.mSubText);
        Notification.Builder builder1 = builder2.setUsesChronometer(b.mUseChronometer);
        ...
        if (b.mInvisibleActions.size() > 0) {
            ...
            for (int i2 = 0; i2 < b.mInvisibleActions.size(); i2++) {
                listBundle.putBundle(Integer.toString(i2), NotificationCompatJellybean.getBundleForAction(b.mInvisibleActions.get(i2)));
            }
