...
public final class BottomSheetDefaults {
    ...
    private static final float Elevation = SheetBottomTokens.INSTANCE.m3501getDockedModalContainerElevationD9Ej5fM();
    private static final float SheetPeekHeight = Dp.m6693constructorimpl(56);
    private static final float SheetMaxWidth = Dp.m6693constructorimpl(640);
    ...
    public final long getScrimColor(Composer $composer, int $changed) {
        ...
        long jM4185copywmQWz5c = Color.m4185copywmQWz5c(value, (14 & 1) != 0 ? Color.m4189getAlphaimpl(value) : 0.32f, (14 & 2) != 0 ? Color.m4193getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(value) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final float m1812getSheetPeekHeightD9Ej5fM() {
        return SheetPeekHeight;
    }

    /* renamed from: getSheetMaxWidth-D9Ej5fM, reason: not valid java name */
    public final float m1811getSheetMaxWidthD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets windowInsetsM752onlybOOhFvg = WindowInsetsKt.m752onlybOOhFvg(WindowInsets_androidKt.getSafeDrawing(WindowInsets.INSTANCE, $composer, 6), WindowInsetsSides.INSTANCE.m770getBottomJoeWqyM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final void m1809DragHandlelgZ2HuY(Modifier modifier, float width, float height, Shape shape, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        final float width2;
        float height2;
        Shape shape2;
        ...
        if (($dirty2 & 9363) == 9362 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i3 != 0) {
                    width2 = SheetBottomTokens.INSTANCE.m3500getDockedDragHandleWidthD9Ej5fM();
                }
                if (i4 != 0) {
                    height2 = SheetBottomTokens.INSTANCE.m3499getDockedDragHandleHeightD9Ej5fM();
                }
                if ((i & 8) != 0) {
                    $dirty2 &= -7169;
            ...
            final String dragHandleDescription = Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_bottom_sheet_drag_handle_description), $composer3, 0);
            ...
            $composer2 = $composer3;
            SurfaceKt.m2561SurfaceT9BRK9s(SemanticsModifierKt.semantics$default(modifierM683paddingVpY3zN4$default, false, (Function1) value$iv, 1, null), shape2, color2, 0L, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1039573072, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    BoxKt.Box(SizeKt.m728sizeVpY3zN4(Modifier.INSTANCE, width2, height3), $composer4, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$3
                ...
                public final void invoke(Composer composer, int i7) {
                    this.$tmp1_rcvr.m1809DragHandlelgZ2HuY(modifier4, width3, height4, shape3, color3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
