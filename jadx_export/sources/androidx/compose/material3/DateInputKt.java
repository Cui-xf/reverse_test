...
public final class DateInputKt {
    private static final PaddingValues InputTextFieldPadding = PaddingKt.m678PaddingValuesa9UjIt4$default(Dp.m6693constructorimpl(24), Dp.m6693constructorimpl(10), Dp.m6693constructorimpl(24), 0.0f, 8, null);
    private static final float InputTextNonErroneousBottomPadding = Dp.m6693constructorimpl(16);
    ...
    public static final void DateInputContent(final Long selectedDateMillis, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange yearRange, final DatePickerFormatter dateFormatter, final SelectableDates selectableDates, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if ((599187 & $dirty2) != 599186 || !$composer4.getSkipping()) {
            ...
            String errorDatePattern = Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_input_invalid_for_pattern), $composer4, 0);
            Strings.Companion companion2 = Strings.INSTANCE;
            String errorDateOutOfYearRange = Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_input_invalid_year_range), $composer4, 0);
            Strings.Companion companion3 = Strings.INSTANCE;
            String errorInvalidNotAllowed = Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_input_invalid_not_allowed), $composer4, 0);
            ...
            if (invalid$iv2 || value$iv2 == Composer.INSTANCE.getEmpty()) {
                ...
                $composer2 = $composer4;
                $dirty = $dirty2;
                value$iv2 = new DateInputValidator(yearRange, selectableDates2, dateInputFormat, dateFormatter, errorDatePattern, errorDateOutOfYearRange, errorInvalidNotAllowed, "", null, null, 768, null);
            ...
            final String labelText = Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_input_label), $composer2, 0);
            ...
            int iM2193getSingleDateInputJ2x2o4M = InputIdentifier.INSTANCE.m2193getSingleDateInputJ2x2o4M();
            dateInputValidator.setCurrentStartDateMillis$material3_release(selectedDateMillis);
            Composer $composer5 = $composer2;
            m2011DateInputTextFieldtQNruF0(modifierPadding, selectedDateMillis, function1, calendarModel, ComposableLambdaKt.rememberComposableLambda(-1819015125, r3, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt.DateInputContent.2
                ...
                public final void invoke(Composer $composer6, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer6.getSkipping()) {
                        ...
                        TextKt.m2711Text4IGK_g(str, SemanticsModifierKt.semantics$default(companion5, false, (Function1) value$iv3, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer6, 0, 0, 131068);
                        if (ComposerKt.isTraceInProgress()) {
                ...
                public final void invoke(Composer $composer6, int $changed2) {
                    ...
                    TextKt.m2711Text4IGK_g(pattern, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateInputKt.DateInputContent.3.1
                        @Override // kotlin.jvm.functions.Function1
                        public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                            invoke2(semanticsPropertyReceiver);
                            return Unit.INSTANCE;
            ...
            }, $composer2, 54), iM2193getSingleDateInputJ2x2o4M, dateInputValidator, dateInputFormat, defaultLocale, colors, $composer5, (($dirty << 3) & 112) | 1794054 | (($dirty << 3) & 896) | (($dirty << 3) & 7168), ($dirty >> 18) & 14);
            $composer3 = $composer5;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void m2011DateInputTextFieldtQNruF0(final Modifier modifier, final Long initialDateMillis, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final int inputIdentifier, final DateInputValidator dateInputValidator, DateInputFormat dateInputFormat, final Locale locale, final DatePickerColors colors, Composer $composer, final int $changed, final int $changed1) {
        ...
        if (($dirty2 & 306783379) != 306783378 || ($dirty1 & 3) != 2 || !$composer3.getSkipping()) {
            ...
            MutableState errorText2 = (MutableState) RememberSaveableKt.m3772rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<MutableState<String>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$errorText$1
                    ...
                    */
                    public final androidx.compose.runtime.MutableState<androidx.compose.ui.text.input.TextFieldValue> invoke() {
                        /*
                            ...
                            if (r0 == 0) goto L22
                            androidx.compose.material3.internal.CalendarModel r1 = r3
                            androidx.compose.material3.internal.DateInputFormat r2 = r4
                ...
                Object obj = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$1$1
                    ...
                    public final void invoke2(TextFieldValue input) {
                        ...
                        if (input.getText().length() <= dateInputFormat2.getPatternWithoutDelimiters().length()) {
                            ...
                            errorText.setValue(dateInputValidator.m2012validateXivgLIo(parsedDate, i2, locale));
            ...
            if (StringsKt.isBlank((CharSequence) errorText.getValue())) {
                fM6693constructorimpl = InputTextNonErroneousBottomPadding;
            } else {
                fM6693constructorimpl = Dp.m6693constructorimpl(0);
            }
            Modifier modifierM685paddingqDBjuR0$default = PaddingKt.m685paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, fM6693constructorimpl, 7, null);
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            OutlinedTextFieldKt.OutlinedTextField(textFieldValueDateInputTextField_tQNruF0$lambda$4, (Function1<? super TextFieldValue, Unit>) function14, SemanticsModifierKt.semantics$default(modifierM685paddingqDBjuR0$default, false, (Function1) value$iv3, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.rememberComposableLambda(-591991974, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (!StringsKt.isBlank(errorText.getValue())) {
                        TextKt.m2711Text4IGK_g(errorText.getValue(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer4, 0, 0, 131070);
                    }
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
            }, $composer3, 54), !StringsKt.isBlank((CharSequence) errorText.getValue()), (VisualTransformation) new DateVisualTransformation(dateInputFormat2), new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m6383getNumberPjHm6EE(), ImeAction.INSTANCE.m6327getDoneeUduSuo(), (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 113, (DefaultConstructorMarker) null), (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, colors.getDateTextFieldColors(), $composer3, (($dirty << 6) & 3670016) | (($dirty << 6) & 29360128), 12779904, 0, 4001592);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
                ...
                public final void invoke(Composer composer, int i3) {
                    DateInputKt.m2011DateInputTextFieldtQNruF0(modifier, initialDateMillis, function1, calendarModel, function2, function22, inputIdentifier, dateInputValidator, dateInputFormat2, locale, colors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1));
                }
            });
        }
    }
