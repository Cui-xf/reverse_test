...
public final class ButtonDefaults {
    ...
    private static final float ButtonHorizontalPadding = Dp.m6693constructorimpl(24);
    private static final float ButtonVerticalPadding = Dp.m6693constructorimpl(8);
    ...
    private static final float ButtonWithIconHorizontalStartPadding = Dp.m6693constructorimpl(16);
    ...
    private static final float TextButtonHorizontalPadding = Dp.m6693constructorimpl(12);
    ...
    private static final float TextButtonWithIconHorizontalEndPadding = Dp.m6693constructorimpl(16);
    ...
    private static final float MinWidth = Dp.m6693constructorimpl(58);
    private static final float MinHeight = Dp.m6693constructorimpl(40);
    private static final float IconSize = FilledButtonTokens.INSTANCE.m3262getIconSizeD9Ej5fM();
    ...
    public final float m1836getMinWidthD9Ej5fM() {
        return MinWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM, reason: not valid java name */
    public final float m1835getMinHeightD9Ej5fM() {
        return MinHeight;
    }
    ...
    public final float m1834getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }
    ...
    public final ButtonColors m1827buttonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        ButtonColors buttonColorsM1822copyjRlVdoo = getDefaultButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1822copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return buttonColorsM1822copyjRlVdoo;
    }
    ...
    public final ButtonColors getDefaultButtonColors$material3_release(ColorScheme $this$defaultButtonColors) {
        ...
        if (it == null) {
            ...
            long jM4185copywmQWz5c = Color.m4185copywmQWz5c(jFromToken3, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken3) : 0.12f, (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken3) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken3) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken3) : 0.0f);
            long jFromToken4 = ColorSchemeKt.fromToken($this$defaultButtonColors, FilledButtonTokens.INSTANCE.getDisabledLabelTextColor());
            ButtonColors it2 = new ButtonColors(jFromToken, jFromToken2, jM4185copywmQWz5c, Color.m4185copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken4) : 0.38f, (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken4) : 0.0f), null);
    ...
    public final ButtonColors m1829elevatedButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        ButtonColors buttonColorsM1822copyjRlVdoo = getDefaultElevatedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1822copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final ButtonColors getDefaultElevatedButtonColors$material3_release(ColorScheme $this$defaultElevatedButtonColors) {
        ...
        if (it == null) {
            ...
            long jM4185copywmQWz5c = Color.m4185copywmQWz5c(jFromToken3, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken3) : ElevatedButtonTokens.INSTANCE.getDisabledContainerOpacity(), (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken3) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken3) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken3) : 0.0f);
            ...
            ButtonColors it2 = new ButtonColors(jFromToken, jFromToken2, jM4185copywmQWz5c, Color.m4185copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken4) : ElevatedButtonTokens.INSTANCE.getDisabledLabelTextOpacity(), (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken4) : 0.0f), null);
    ...
    public final ButtonColors m1831filledTonalButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        ButtonColors buttonColorsM1822copyjRlVdoo = getDefaultFilledTonalButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1822copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final ButtonColors m1837outlinedButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        ButtonColors buttonColorsM1822copyjRlVdoo = getDefaultOutlinedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1822copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final ButtonColors getDefaultOutlinedButtonColors$material3_release(ColorScheme $this$defaultOutlinedButtonColors) {
        ...
        ButtonColors it2 = new ButtonColors(jM4222getTransparent0d7_KjU, jFromToken, jM4222getTransparent0d7_KjU2, Color.m4185copywmQWz5c(jFromToken2, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken2) : 0.38f, (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken2) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken2) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken2) : 0.0f), null);
    ...
    public final ButtonColors m1838textButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        ButtonColors buttonColorsM1822copyjRlVdoo = getDefaultTextButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m1822copyjRlVdoo(containerColor2, contentColor2, disabledContainerColor2, disabledContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final ButtonElevation m1828buttonElevationR_JCAzs(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = FilledButtonTokens.INSTANCE.m3257getContainerElevationD9Ej5fM();
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = FilledButtonTokens.INSTANCE.m3263getPressedContainerElevationD9Ej5fM();
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float focusedElevation3 = FilledButtonTokens.INSTANCE.m3260getFocusContainerElevationD9Ej5fM();
            focusedElevation2 = focusedElevation3;
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            float hoveredElevation3 = FilledButtonTokens.INSTANCE.m3261getHoverContainerElevationD9Ej5fM();
            hoveredElevation2 = hoveredElevation3;
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        float disabledElevation2 = (i & 16) != 0 ? FilledButtonTokens.INSTANCE.m3259getDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1830elevatedButtonElevationR_JCAzs(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float defaultElevation2;
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = ElevatedButtonTokens.INSTANCE.m3176getContainerElevationD9Ej5fM();
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = ElevatedButtonTokens.INSTANCE.m3182getPressedContainerElevationD9Ej5fM();
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float focusedElevation3 = ElevatedButtonTokens.INSTANCE.m3179getFocusContainerElevationD9Ej5fM();
            focusedElevation2 = focusedElevation3;
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            float hoveredElevation3 = ElevatedButtonTokens.INSTANCE.m3180getHoverContainerElevationD9Ej5fM();
            hoveredElevation2 = hoveredElevation3;
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        float disabledElevation2 = (i & 16) != 0 ? ElevatedButtonTokens.INSTANCE.m3178getDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1832filledTonalButtonElevationR_JCAzs(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float defaultElevation2;
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = FilledTonalButtonTokens.INSTANCE.m3280getContainerElevationD9Ej5fM();
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = FilledTonalButtonTokens.INSTANCE.m3286getPressedContainerElevationD9Ej5fM();
            pressedElevation2 = pressedElevation3;
        } else {
            pressedElevation2 = pressedElevation;
        }
        if ((i & 4) != 0) {
            float focusedElevation3 = FilledTonalButtonTokens.INSTANCE.m3283getFocusContainerElevationD9Ej5fM();
            focusedElevation2 = focusedElevation3;
        } else {
            focusedElevation2 = focusedElevation;
        }
        if ((i & 8) != 0) {
            float hoveredElevation3 = FilledTonalButtonTokens.INSTANCE.m3284getHoverContainerElevationD9Ej5fM();
            hoveredElevation2 = hoveredElevation3;
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        float disabledElevation2 = (i & 16) != 0 ? Dp.m6693constructorimpl(0) : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer $composer, int $changed) {
        ...
        BorderStroke borderStrokeM257BorderStrokecXLIe8U = BorderStrokeKt.m257BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m3362getOutlineWidthD9Ej5fM(), ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), $composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final BorderStroke outlinedButtonBorder(boolean enabled, Composer $composer, int $changed, int i) {
        ...
        float fM3362getOutlineWidthD9Ej5fM = OutlinedButtonTokens.INSTANCE.m3362getOutlineWidthD9Ej5fM();
        if (enabled) {
            $composer.startReplaceGroup(-855870548);
            ComposerKt.sourceInformation($composer, "893@41926L5");
            jM4185copywmQWz5c = ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), $composer, 6);
            ...
            jM4185copywmQWz5c = Color.m4185copywmQWz5c(value, (14 & 1) != 0 ? Color.m4189getAlphaimpl(value) : 0.12f, (14 & 2) != 0 ? Color.m4193getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(value) : 0.0f);
            $composer.endReplaceGroup();
        }
        BorderStroke borderStrokeM257BorderStrokecXLIe8U = BorderStrokeKt.m257BorderStrokecXLIe8U(fM3362getOutlineWidthD9Ej5fM, jM4185copywmQWz5c);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
