...
public final class PullToRefreshModifierNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, NestedScrollConnection {
    ...
    public final void m3020setThreshold0680j_4(float f) {
        this.threshold = f;
    }
    ...
    public final int getThresholdPx() {
        ...
        return $this$_get_thresholdPx__u24lambda_u240.mo361roundToPx0680j_4(this.threshold);
    }
    ...
    static final class C05721 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PullToRefreshModifierNode.this.new C05721(continuation);
        }
    ...
    public void onAttach() {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C05721(null), 3, null);
    }
    ...
    public long mo479onPreScrollOzD1aCk(long available, int source) {
        if (!this.state.isAnimating() && this.enabled) {
            if (NestedScrollSource.m5286equalsimpl0(source, NestedScrollSource.INSTANCE.m5298getUserInputWNlRxjI()) && Offset.m3946getYimpl(available) < 0.0f) {
                return m3018consumeAvailableOffsetMKHz9U(available);
            }
    ...
    public long mo477onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (!this.state.isAnimating() && this.enabled) {
            if (NestedScrollSource.m5286equalsimpl0(source, NestedScrollSource.INSTANCE.m5298getUserInputWNlRxjI())) {
                long jM3018consumeAvailableOffsetMKHz9U = m3018consumeAvailableOffsetMKHz9U(available);
                ...
                return jM3018consumeAvailableOffsetMKHz9U;
            }
            return Offset.INSTANCE.m3961getZeroF1C5BW0();
        }
        return Offset.INSTANCE.m3961getZeroF1C5BW0();
    ...
    */
    public java.lang.Object mo478onPreFlingQWom1Mo(long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        ...
        L34:
            kotlin.ResultKt.throwOnFailure(r9)
            r2 = r6
            float r3 = androidx.compose.ui.unit.Velocity.m6935getYimpl(r7)
            r4 = 0
            r0.F$0 = r4
            r5 = 1
            r0.label = r5
        ...
        L49:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.pulltorefresh.PullToRefreshModifierNode.mo478onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    static final class C05741 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PullToRefreshModifierNode.this.new C05741(continuation);
        }
    ...
    public final void update() {
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C05741(null), 3, null);
    }

    /* renamed from: consumeAvailableOffset-MK-Hz9U, reason: not valid java name */
    private final long m3018consumeAvailableOffsetMKHz9U(long available) {
        float dragConsumed;
        if (this.isRefreshing) {
            dragConsumed = 0.0f;
        } else {
            float newOffset = RangesKt.coerceAtLeast(getDistancePulled() + Offset.m3946getYimpl(available), 0.0f);
    ...
    */
    public final java.lang.Object onRelease(float r8, kotlin.coroutines.Continuation<? super java.lang.Float> r9) {
        /*
            r7 = this;
            boolean r0 = r9 instanceof androidx.compose.material3.pulltorefresh.PullToRefreshModifierNode.C05731
            if (r0 == 0) goto L14
            r0 = r9
            androidx.compose.material3.pulltorefresh.PullToRefreshModifierNode$onRelease$1 r0 = (androidx.compose.material3.pulltorefresh.PullToRefreshModifierNode.C05731) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    public final java.lang.Object animateToThreshold(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof androidx.compose.material3.pulltorefresh.PullToRefreshModifierNode.C05711
            if (r0 == 0) goto L14
            r0 = r6
            androidx.compose.material3.pulltorefresh.PullToRefreshModifierNode$animateToThreshold$1 r0 = (androidx.compose.material3.pulltorefresh.PullToRefreshModifierNode.C05711) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
