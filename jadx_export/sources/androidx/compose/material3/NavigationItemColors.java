...
public final class NavigationItemColors {
    ...
    public final NavigationItemColors m2310copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2318iconColorWaAFU9c(boolean selected, boolean enabled) {
    ...
    public final long m2319textColorWaAFU9c(boolean selected, boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationItemColors) && Color.m4188equalsimpl0(this.selectedIconColor, ((NavigationItemColors) other).selectedIconColor) && Color.m4188equalsimpl0(this.unselectedIconColor, ((NavigationItemColors) other).unselectedIconColor) && Color.m4188equalsimpl0(this.selectedTextColor, ((NavigationItemColors) other).selectedTextColor) && Color.m4188equalsimpl0(this.unselectedTextColor, ((NavigationItemColors) other).unselectedTextColor) && Color.m4188equalsimpl0(this.selectedIndicatorColor, ((NavigationItemColors) other).selectedIndicatorColor) && Color.m4188equalsimpl0(this.disabledIconColor, ((NavigationItemColors) other).disabledIconColor) && Color.m4188equalsimpl0(this.disabledTextColor, ((NavigationItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
