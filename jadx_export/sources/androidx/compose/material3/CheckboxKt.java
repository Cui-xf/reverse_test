...
public final class CheckboxKt {
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if ((74899 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (function0 != null) {
                ...
                float arg0$iv = CheckboxTokens.INSTANCE.m3046getStateLayerSizeD9Ej5fM();
                $dirty2 = $dirty;
                boolean enabled5 = enabled3;
                toggleableModifier = ToggleableKt.m948triStateToggleableO2vRcR0(companion, toggleableState, interactionSource2, RippleKt.m2425rippleOrFallbackImplementation9IZ8Weo(false, Dp.m6693constructorimpl(arg0$iv / 2), 0L, $composer2, 54, 4), enabled5, Role.m5949boximpl(iM5957getCheckboxo7Vup1c), function0);
                interactionSource3 = interactionSource2;
                enabled3 = enabled5;
            } else {
                interactionSource3 = interactionSource2;
            ...
            CheckboxImpl(enabled3, state, PaddingKt.m681padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors5, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            colors4 = colors5;
    ...
    */
    ...
    public static final void m1870drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
    ...
    public static final void m1871drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
