...
public final class TopAppBarColors {
    ...
    public final TopAppBarColors m2868copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
    ...
    public final long m2867containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m4238lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof TopAppBarColors) && Color.m4188equalsimpl0(this.containerColor, ((TopAppBarColors) other).containerColor) && Color.m4188equalsimpl0(this.scrolledContainerColor, ((TopAppBarColors) other).scrolledContainerColor) && Color.m4188equalsimpl0(this.navigationIconContentColor, ((TopAppBarColors) other).navigationIconContentColor) && Color.m4188equalsimpl0(this.titleContentColor, ((TopAppBarColors) other).titleContentColor) && Color.m4188equalsimpl0(this.actionIconContentColor, ((TopAppBarColors) other).actionIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m4194hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4194hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4194hashCodeimpl(this.titleContentColor)) * 31) + Color.m4194hashCodeimpl(this.actionIconContentColor);
    }
}
