...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        final int topPaddingValue = measureScope.mo361roundToPx0680j_4(textFieldMeasurePolicy.paddingValues.getTop());
        int bottomPaddingValue = measureScope.mo361roundToPx0680j_4(textFieldMeasurePolicy.paddingValues.getBottom());
        int occupiedSpaceHorizontally2 = 0;
        long looseConstraints3 = Constraints.m6626copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(constraints) : 0);
        int index$iv$iv = 0;
        int size = list.size();
        while (true) {
            if (index$iv$iv >= size) {
        ...
        Placeable leadingPlaceable = measurable != null ? measurable.mo5535measureBRTryo0(looseConstraints3) : null;
        ...
        if (measurable2 != null) {
            ...
            trailingPlaceable = measurable2.mo5535measureBRTryo0(ConstraintsKt.m6656offsetNN6EwU$default(looseConstraints, -occupiedSpaceHorizontally3, 0, 2, null));
        } else {
            looseConstraints = looseConstraints3;
        ...
        final Placeable prefixPlaceable = measurable3 != null ? measurable3.mo5535measureBRTryo0(ConstraintsKt.m6656offsetNN6EwU$default(looseConstraints, -occupiedSpaceHorizontally4, 0, 2, null)) : null;
        ...
        if (measurable4 != null) {
            ...
            suffixPlaceable = measurable4.mo5535measureBRTryo0(ConstraintsKt.m6656offsetNN6EwU$default(looseConstraints, -occupiedSpaceHorizontally5, 0, 2, null));
        } else {
            looseConstraints2 = looseConstraints;
        ...
        long labelConstraints = ConstraintsKt.m6655offsetNN6EwU(looseConstraints2, -occupiedSpaceHorizontally6, -bottomPaddingValue);
        ...
        final Placeable labelPlaceable = measurable5 != null ? measurable5.mo5535measureBRTryo0(labelConstraints) : null;
        ...
        long textFieldConstraints = ConstraintsKt.m6655offsetNN6EwU(Constraints.m6626copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(constraints) : 0), -occupiedSpaceHorizontally6, ((-effectiveTopOffset) - bottomPaddingValue) - supportingIntrinsicHeight);
        int $i$f$fastFirst = 0;
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it7), "TextField")) {
                final Placeable textFieldPlaceable = ((Measurable) item$iv$iv).mo5535measureBRTryo0(textFieldConstraints);
                long placeholderConstraints = Constraints.m6626copyZbe2FdA(textFieldConstraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(textFieldConstraints) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(textFieldConstraints) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(textFieldConstraints) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(textFieldConstraints) : 0);
                ...
                final Placeable placeholderPlaceable = measurable6 != null ? measurable6.mo5535measureBRTryo0(placeholderConstraints) : null;
                ...
                final int width = TextFieldKt.m2709calculateWidthyeHjK3Y(TextFieldImplKt.widthOrZero(leadingPlaceable2), TextFieldImplKt.widthOrZero(trailingPlaceable), TextFieldImplKt.widthOrZero(prefixPlaceable), TextFieldImplKt.widthOrZero(suffixPlaceable2), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable), TextFieldImplKt.widthOrZero(placeholderPlaceable), constraints);
                long jM6656offsetNN6EwU$default = ConstraintsKt.m6656offsetNN6EwU$default(looseConstraints2, 0, -occupiedSpaceVertically5, 1, null);
                long supportingConstraints = Constraints.m6626copyZbe2FdA(jM6656offsetNN6EwU$default, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(jM6656offsetNN6EwU$default) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(jM6656offsetNN6EwU$default) : width, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(jM6656offsetNN6EwU$default) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(jM6656offsetNN6EwU$default) : 0);
                Placeable supportingPlaceable = supportingMeasurable != null ? supportingMeasurable.mo5535measureBRTryo0(supportingConstraints) : null;
                int supportingHeight = TextFieldImplKt.heightOrZero(supportingPlaceable);
                int totalHeight = TextFieldKt.m2708calculateHeightmKXJcVc(textFieldPlaceable.getHeight(), TextFieldImplKt.heightOrZero(labelPlaceable), TextFieldImplKt.heightOrZero(leadingPlaceable2), TextFieldImplKt.heightOrZero(trailingPlaceable), TextFieldImplKt.heightOrZero(prefixPlaceable), TextFieldImplKt.heightOrZero(suffixPlaceable2), TextFieldImplKt.heightOrZero(placeholderPlaceable), TextFieldImplKt.heightOrZero(supportingPlaceable), textFieldMeasurePolicy.animationProgress, constraints, measureScope.getDensity(), textFieldMeasurePolicy.paddingValues);
                ...
                while (totalHeight3 < totalHeight2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it9), TextFieldImplKt.ContainerId)) {
                        ...
                        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, totalHeight4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TextFieldMeasurePolicy$measure$1
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                return TextFieldKt.m2709calculateWidthyeHjK3Y(leadingWidth, trailingWidth, prefixWidth, suffixWidth, textFieldWidth, labelWidth, placeholderWidth, TextFieldImplKt.getZeroConstraints());
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        while (index$iv$iv6 < size6) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv2), "TextField")) {
                ...
                return TextFieldKt.m2708calculateHeightmKXJcVc(textFieldHeight3, textFieldHeight4, leadingHeight, trailingHeight, labelHeight3, suffixHeight, placeholderHeight, supportingHeight, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
            }
            index$iv$iv6++;
