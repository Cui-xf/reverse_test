...
public final class AlertDialogKt {
    private static final float DialogMinWidth = Dp.m6693constructorimpl(280);
    private static final float DialogMaxWidth = Dp.m6693constructorimpl(560);
    private static final float ButtonsMainAxisSpacing = Dp.m6693constructorimpl(8);
    private static final float ButtonsCrossAxisSpacing = Dp.m6693constructorimpl(12);
    private static final PaddingValues DialogPadding = PaddingKt.m674PaddingValues0680j_4(Dp.m6693constructorimpl(24));
    private static final PaddingValues IconPadding = PaddingKt.m678PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m6693constructorimpl(16), 7, null);
    private static final PaddingValues TitlePadding = PaddingKt.m678PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m6693constructorimpl(16), 7, null);
    private static final PaddingValues TextPadding = PaddingKt.m678PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m6693constructorimpl(24), 7, null);
            ...
            AndroidDialog_androidKt.Dialog(function02, properties3, ComposableLambdaKt.rememberComposableLambda(905289008, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt.BasicAlertDialog.1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        ...
                        final String dialogPaneDescription = Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_dialog), $composer3, 0);
                        Modifier modifierM730sizeInqDBjuR0$default = SizeKt.m730sizeInqDBjuR0$default(modifier4, AlertDialogKt.getDialogMinWidth(), 0.0f, AlertDialogKt.getDialogMaxWidth(), 0.0f, 10, null);
            ...
            BasicAlertDialog(function02, modifier, properties, ComposableLambdaKt.rememberComposableLambda(-1852840226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogImpl$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        AlertDialogKt.m1775AlertDialogContent4hvqGtA(ComposableLambdaKt.rememberComposableLambda(1163543932, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogImpl$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                if (($changed3 & 3) != 2 || !$composer5.getSkipping()) {
                                    ...
                                    AlertDialogKt.m1776AlertDialogFlowRowixp7dh8(f, f2, ComposableLambdaKt.rememberComposableLambda(1887135077, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt.AlertDialogImpl.1.1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(2);
    ...
    public static final void m1775AlertDialogContent4hvqGtA(final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Shape shape, final long containerColor, final float tonalElevation, final long buttonContentColor, final long iconContentColor, final long titleContentColor, final long textContentColor, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty3 & 306783379) != 306783378 || ($dirty1 & 19) != 18 || !$composer3.getSkipping()) {
            ...
            SurfaceKt.m2561SurfaceT9BRK9s(modifier4, shape2, containerColor, 0L, f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-2126308228, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogContent$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogContent$2
                ...
                public final void invoke(Composer composer, int i4) {
                    AlertDialogKt.m1775AlertDialogContent4hvqGtA(function2, modifier3, function22, function23, function24, shape, containerColor, tonalElevation, buttonContentColor, iconContentColor, titleContentColor, textContentColor, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void m1776AlertDialogFlowRowixp7dh8(final float mainAxisSpacing, final float crossAxisSpacing, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
                ...
                value$iv = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$1
                    ...
                    public final MeasureResult mo34measure3p2s80s(final MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                        ...
                        while (index$iv2 < size) {
                            ...
                            Placeable placeable = measurable.mo5535measureBRTryo0(constraints);
                            int i = size;
                            ...
                            if (!currentSequence.isEmpty()) {
                                currentMainAxisSize.element += $this$Layout.mo361roundToPx0680j_4(f);
                            }
                        ...
                        final int mainAxisLayoutSize = Math.max(mainAxisSpace.element, Constraints.m6638getMinWidthimpl(constraints));
                        ...
                        return MeasureScope.CC.layout$default($this$Layout, mainAxisLayoutSize, crossAxisLayoutSize, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(Placeable.PlacementScope $this$layout) {
                                List $this$fastForEachIndexed$iv = sequences3;
                                ...
                                while (index$iv3 < size2) {
                                    ...
                                    int i4 = 0;
                                    while (i4 < size3) {
                                        childrenMainAxisSizes[i4] = placeables.get(i4).getWidth() + (i4 < CollectionsKt.getLastIndex(placeables) ? measureScope.mo361roundToPx0680j_4(f4) : 0);
                                        i4++;
                                    }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$2
                ...
                public final void invoke(Composer composer, int i) {
                    AlertDialogKt.m1776AlertDialogFlowRowixp7dh8(mainAxisSpacing, crossAxisSpacing, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
