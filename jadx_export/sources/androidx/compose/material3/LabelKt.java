...
public final class LabelKt {
    ...
    public static final void Label(final Function3<? super TooltipScope, ? super Composer, ? super Integer, Unit> function3, Modifier modifier, MutableInteractionSource interactionSource, boolean isPersistent, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) throws Resources.NotFoundException {
        Modifier modifier2;
        ...
        if (($dirty2 & 9363) == 9362 && $composer2.getSkipping()) {
            ...
            PopupPositionProvider positionProvider = TooltipDefaults.INSTANCE.m2859rememberPlainTooltipPositionProviderkHDZbjc(0.0f, $composer2, 48, 1);
            if (isPersistent3) {
