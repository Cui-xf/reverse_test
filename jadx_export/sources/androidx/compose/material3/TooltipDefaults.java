...
public final class TooltipDefaults {
    ...
    private static final long caretSize = DpKt.m6715DpSizeYgX7TsA(Dp.m6693constructorimpl(16), Dp.m6693constructorimpl(8));
    ...
    public final RichTooltipColors m2861richTooltipColorsro_MJ88(long containerColor, long contentColor, long titleContentColor, long actionContentColor, Composer $composer, int $changed, int i) {
        ...
        long titleContentColor2 = (i & 4) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : titleContentColor;
        long actionContentColor2 = (i & 8) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : actionContentColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        RichTooltipColors richTooltipColorsM2415copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2415copyjRlVdoo(containerColor2, contentColor2, titleContentColor2, actionContentColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final PopupPositionProvider m2859rememberPlainTooltipPositionProviderkHDZbjc(float spacingBetweenTooltipAndAnchor, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        final int tooltipAnchorSpacing = $this$rememberPlainTooltipPositionProvider_kHDZbjc_u24lambda_u241.mo361roundToPx0680j_4(spacingBetweenTooltipAndAnchor);
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo339calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int x = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m6867getWidthimpl(popupContentSize)) / 2);
                    int y = (anchorBounds.getTop() - IntSize.m6866getHeightimpl(popupContentSize)) - tooltipAnchorSpacing;
                    if (y < 0) {
    ...
    public final PopupPositionProvider m2860rememberRichTooltipPositionProviderkHDZbjc(float spacingBetweenTooltipAndAnchor, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        final int tooltipAnchorSpacing = $this$rememberRichTooltipPositionProvider_kHDZbjc_u24lambda_u243.mo361roundToPx0680j_4(spacingBetweenTooltipAndAnchor);
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo339calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    ...
                    if (IntSize.m6867getWidthimpl(popupContentSize) + x > IntSize.m6867getWidthimpl(windowSize) && (x = anchorBounds.getRight() - IntSize.m6867getWidthimpl(popupContentSize)) < 0) {
                        x = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m6867getWidthimpl(popupContentSize)) / 2);
                    }
                    int y = (anchorBounds.getTop() - IntSize.m6866getHeightimpl(popupContentSize)) - tooltipAnchorSpacing;
                    if (y < 0) {
                        y = anchorBounds.getBottom() + tooltipAnchorSpacing;
