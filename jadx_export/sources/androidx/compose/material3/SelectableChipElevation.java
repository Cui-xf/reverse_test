...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (it$iv4 == Composer.INSTANCE.getEmpty()) {
            value$iv4 = new Animatable(Dp.m6691boximpl(target), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.LaunchedEffect(dpM6691boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv5, $composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipElevation) && Dp.m6698equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) && Dp.m6698equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) && Dp.m6698equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) && Dp.m6698equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) && Dp.m6698equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Dp.m6699hashCodeimpl(this.elevation);
