...
public final class MaterialThemeKt {
    ...
    public static final void MaterialTheme(ColorScheme colorScheme, Shapes shapes, Typography typography, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            int $dirty3 = $dirty;
            Indication rippleIndication = RippleKt.m2425rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7);
                ...
                CompositionLocalKt.CompositionLocalProvider(LocalUsingExpressiveTheme.provides(true), ComposableLambdaKt.rememberComposableLambda(2050809758, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MaterialThemeKt.MaterialExpressiveTheme.1
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                            ...
                            MaterialThemeKt.MaterialTheme(colorScheme4, shapes5, typography5 == null ? new Typography(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, LayoutKt.LargeDimension, null) : typography5, function2, $composer4, 0, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
    ...
    public static final SelectionColors rememberTextSelectionColors(ColorScheme colorScheme, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new SelectionColors(primaryColor, Color.m4185copywmQWz5c(primaryColor, (14 & 1) != 0 ? Color.m4189getAlphaimpl(primaryColor) : 0.4f, (14 & 2) != 0 ? Color.m4193getRedimpl(primaryColor) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(primaryColor) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(primaryColor) : 0.0f), null);
