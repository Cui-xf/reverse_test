...
public final class KeylineListKt {
    ...
    public static final KeylineList m2905keylineListOfWNYm7Xg(float carouselMainAxisSize, float itemSpacing, int carouselAlignment, Function1<? super KeylineListScope, Unit> function1) {
        KeylineListScopeImpl keylineListScope = new KeylineListScopeImpl();
        function1.invoke(keylineListScope);
        return keylineListScope.m2906createWithAlignmentwaks0t8(carouselMainAxisSize, itemSpacing, carouselAlignment);
    }
