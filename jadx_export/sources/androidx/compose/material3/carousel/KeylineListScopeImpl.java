...
final class KeylineListScopeImpl implements KeylineListScope {
    ...
    private static final /* data */ class TmpKeyline {
        ...
        public int hashCode() {
            return (Float.floatToIntBits(this.size) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isAnchor);
        }
    ...
    public final KeylineList m2906createWithAlignmentwaks0t8(float carouselMainAxisSize, float itemSpacing, int carouselAlignment) {
        float f;
        ...
        if (CarouselAlignment.m2890equalsimpl0(carouselAlignment, CarouselAlignment.INSTANCE.m2894getCenterNUL3oTo())) {
            ...
            boolean zM2890equalsimpl0 = CarouselAlignment.m2890equalsimpl0(carouselAlignment, CarouselAlignment.INSTANCE.m2895getEndNUL3oTo());
            float f2 = this.focalItemSize;
            f = zM2890equalsimpl0 ? carouselMainAxisSize - (f2 / 2.0f) : f2 / 2.0f;
        }
        this.pivotOffset = f;
