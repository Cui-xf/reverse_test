        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new GenericShape(new Function3<Path, Size, LayoutDirection, Unit>() { // from class: androidx.compose.material3.carousel.CarouselItemScopeImpl$rememberMaskShape$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Path path, Size size, LayoutDirection layoutDirection) {
                    m2900invoke12SF9DM(path, size.getPackedValue(), layoutDirection);
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-12SF9DM, reason: not valid java name */
                public final void m2900invoke12SF9DM(Path $this$$receiver, long size, LayoutDirection direction) {
                    Rect rect = this.this$0.getItemInfo().getMaskRect().intersect(SizeKt.m4035toRectuvyYCjk(size));
                    OutlineKt.addOutline($this$$receiver, shape.mo278createOutlinePq9zytI(rect.m3978getSizeNHjbRc(), direction, density));
                    $this$$receiver.mo4082translatek4lQ0M(OffsetKt.Offset(rect.getLeft(), rect.getTop()));
                }
            });
