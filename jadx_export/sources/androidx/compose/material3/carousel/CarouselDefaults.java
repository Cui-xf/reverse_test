...
public final class CarouselDefaults {
    ...
    private static final float MinSmallItemSize = Dp.m6693constructorimpl(40);
    private static final float MaxSmallItemSize = Dp.m6693constructorimpl(56);
    private static final float AnchorSize = Dp.m6693constructorimpl(10);
    ...
    public final TargetedFlingBehavior singleAdvanceFlingBehavior(CarouselState state, AnimationSpec<Float> animationSpec, Composer $composer, int $changed, int i) {
        ...
        TargetedFlingBehavior targetedFlingBehaviorFlingBehavior = PagerDefaults.INSTANCE.flingBehavior(state.getPagerState(), PagerSnapDistance.INSTANCE.atMost(1), null, snapAnimationSpec, 0.0f, $composer, (($changed << 6) & 7168) | (PagerDefaults.$stable << 15), 20);
        if (ComposerKt.isTraceInProgress()) {
