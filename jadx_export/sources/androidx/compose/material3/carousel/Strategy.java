    ...
    */
    ...
    public final KeylineList getKeylineListForScrollOffset$material3_release(float scrollOffset, float maxScrollOffset, boolean roundToNearestStep) {
        ...
        if (!z) {
            ...
            ShiftPointRange shiftPointRange = StrategyKt.getShiftPointRange(steps.size(), shiftPoints, interpolation);
    ...
    public int hashCode() {
        ...
        if (!z) {
            return ChangeSize$$ExternalSyntheticBackport0.m(z2);
        }
        int result = ChangeSize$$ExternalSyntheticBackport0.m(z2);
        return (((((((((((((((((((result * 31) + Float.floatToIntBits(this.availableSpace)) * 31) + Float.floatToIntBits(this.itemSpacing)) * 31) + Float.floatToIntBits(this.beforeContentPadding)) * 31) + Float.floatToIntBits(this.afterContentPadding)) * 31) + Float.floatToIntBits(getItemMainAxisSize())) * 31) + Float.floatToIntBits(this.startShiftDistance)) * 31) + Float.floatToIntBits(this.endShiftDistance)) * 31) + this.startShiftPoints.hashCode()) * 31) + this.endShiftPoints.hashCode()) * 31) + this.defaultKeylines.hashCode();
    }
