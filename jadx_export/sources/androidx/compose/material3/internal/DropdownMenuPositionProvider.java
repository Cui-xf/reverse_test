...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m2914copyuVxBXkw$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, int i, Function2 function2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m2916copyuVxBXkw(j2, density2, i3, function2);
    }
    ...
    public final DropdownMenuPositionProvider m2916copyuVxBXkw(long contentOffset, Density density, int verticalMargin, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m6753equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && this.verticalMargin == dropdownMenuPositionProvider.verticalMargin && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((((DpOffset.m6758hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + this.verticalMargin) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m6761toStringimpl(this.contentOffset)) + ", density=" + this.density + ", verticalMargin=" + this.verticalMargin + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    private DropdownMenuPositionProvider(long contentOffset, Density density, int verticalMargin, Function2<? super IntRect, ? super IntRect, Unit> function2) {
        ...
        int contentOffsetX = $this$_init__u24lambda_u241.mo361roundToPx0680j_4(DpOffset.m6754getXD9Ej5fM(this.contentOffset));
        ...
        int contentOffsetY = $this$_init__u24lambda_u242.mo361roundToPx0680j_4(DpOffset.m6756getYD9Ej5fM(this.contentOffset));
    ...
    public /* synthetic */ DropdownMenuPositionProvider(long j, Density $this$_init__u24lambda_u240, int i, Function2 function2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        int iMo361roundToPx0680j_4;
        Function2 function22;
        if ((i2 & 4) == 0) {
            iMo361roundToPx0680j_4 = i;
        } else {
            iMo361roundToPx0680j_4 = $this$_init__u24lambda_u240.mo361roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
        }
        if ((i2 & 8) == 0) {
        ...
        this(j, $this$_init__u24lambda_u240, iMo361roundToPx0680j_4, function22, null);
    }

    /* renamed from: getContentOffset-RKDOV3M, reason: not valid java name */
    public final long m2917getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public long mo339calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        MenuPosition.Horizontal[] horizontalArr = new MenuPosition.Horizontal[3];
        horizontalArr[0] = this.startToAnchorStart;
        horizontalArr[1] = this.endToAnchorEnd;
        horizontalArr[2] = IntOffset.m6825getXimpl(anchorBounds.m6848getCenternOccac()) < IntSize.m6867getWidthimpl(windowSize) / 2 ? this.leftToWindowLeft : this.rightToWindowRight;
        List xCandidates = CollectionsKt.listOf((Object[]) horizontalArr);
        int x = 0;
        int size = xCandidates.size();
        for (int index = 0; index < size; index++) {
            int xCandidate = ((MenuPosition.Horizontal) xCandidates.get(index)).mo2908position95KtPRI(anchorBounds, windowSize, IntSize.m6867getWidthimpl(popupContentSize), layoutDirection);
            if (index == CollectionsKt.getLastIndex(xCandidates) || (xCandidate >= 0 && IntSize.m6867getWidthimpl(popupContentSize) + xCandidate <= IntSize.m6867getWidthimpl(windowSize))) {
                x = xCandidate;
                break;
            }
        }
        ...
        verticalArr[3] = IntOffset.m6826getYimpl(anchorBounds.m6848getCenternOccac()) < IntSize.m6866getHeightimpl(windowSize) / 2 ? this.topToWindowTop : this.bottomToWindowBottom;
        List yCandidates = CollectionsKt.listOf((Object[]) verticalArr);
        int y = 0;
        int size2 = yCandidates.size();
        for (int index2 = 0; index2 < size2; index2++) {
            int yCandidate = ((MenuPosition.Vertical) yCandidates.get(index2)).mo2909positionJVtK1S4(anchorBounds, windowSize, IntSize.m6866getHeightimpl(popupContentSize));
            if (index2 == CollectionsKt.getLastIndex(yCandidates) || (yCandidate >= this.verticalMargin && IntSize.m6866getHeightimpl(popupContentSize) + yCandidate <= IntSize.m6866getHeightimpl(windowSize) - this.verticalMargin)) {
                y = yCandidate;
                break;
            }
        }
        long menuOffset = IntOffsetKt.IntOffset(x, y);
        this.onPositionCalculated.invoke(anchorBounds, IntRectKt.m6857IntRectVbeCjmY(menuOffset, popupContentSize));
        return menuOffset;
    }
}
