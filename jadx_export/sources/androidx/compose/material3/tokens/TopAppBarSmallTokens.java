...
public final class TopAppBarSmallTokens {
    ...
    private static final float ContainerHeight = Dp.m6693constructorimpl((float) 64.0d);
    ...
    private static final float OnScrollContainerElevation = ElevationTokens.INSTANCE.m3192getLevel2D9Ej5fM();
    ...
    public final float m3585getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3586getOnScrollContainerElevationD9Ej5fM() {
    ...
    public final float m3587getTrailingIconSizeD9Ej5fM() {
