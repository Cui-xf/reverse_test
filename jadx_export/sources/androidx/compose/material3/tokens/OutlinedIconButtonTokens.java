...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6693constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6693constructorimpl((float) 24.0d);
    ...
    public final float m3371getContainerSizeD9Ej5fM() {
    ...
    public final float m3372getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3373getUnselectedOutlineWidthD9Ej5fM() {
