...
public final class AppBarKt {
    ...
    public static final /* synthetic */ void TopAppBar(final Function2 title, Modifier modifier, Function2 navigationIcon, Function3 actions, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i4 != 0) {
                    navigationIcon2 = ComposableSingletons$AppBarKt.INSTANCE.m1958getLambda1$material3_release();
                }
                if (i5 != 0) {
                    actions2 = ComposableSingletons$AppBarKt.INSTANCE.m1968getLambda2$material3_release();
                }
                if ((i & 16) != 0) {
                    $dirty &= -57345;
            ...
            $composer2 = $composer3;
            m1792TopAppBarGHTll3U(function2, modifier3, navigationIcon3, actions3, TopAppBarDefaults.INSTANCE.m2879getTopAppBarExpandedHeightD9Ej5fM(), windowInsets3, colors3, scrollBehavior2, $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (($dirty << 3) & 458752) | (($dirty << 3) & 3670016) | (29360128 & ($dirty << 3)), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1792TopAppBarGHTll3U(final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, float expandedHeight, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 4793491) == 4793490 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    navigationIcon = ComposableSingletons$AppBarKt.INSTANCE.m1969getLambda3$material3_release();
                }
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1970getLambda4$material3_release();
                }
                if (i7 != 0) {
                    expandedHeight2 = TopAppBarDefaults.INSTANCE.m2879getTopAppBarExpandedHeightD9Ej5fM();
                }
                if ((i & 32) != 0) {
                    $dirty = $dirty3 & (-458753);
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
            ...
            $composer2 = $composer3;
            m1791SingleRowTopAppBarcJHQLPU(modifier3, function23, TypographyKt.getValue(TopAppBarSmallTokens.INSTANCE.getHeadlineFont(), $composer3, 6), false, navigationIcon2, actions2, (Dp.m6698equalsimpl0(expandedHeight3, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM()) || Dp.m6698equalsimpl0(expandedHeight3, Dp.INSTANCE.m6712getInfinityD9Ej5fM())) ? TopAppBarDefaults.INSTANCE.m2879getTopAppBarExpandedHeightD9Ej5fM() : expandedHeight3, windowInsets3, colors3, scrollBehavior2, $composer2, (($dirty >> 3) & 14) | 3072 | (($dirty << 3) & 112) | (($dirty << 6) & 57344) | (($dirty << 6) & 458752) | (($dirty << 6) & 29360128) | (($dirty << 6) & 234881024) | (($dirty << 6) & 1879048192), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt.TopAppBar.2
                ...
                public final void invoke(Composer composer, int i11) {
                    AppBarKt.m1792TopAppBarGHTll3U(function2, modifier4, navigationIcon3, actions3, expandedHeight4, windowInsets4, colors4, scrollBehavior3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void CenterAlignedTopAppBar(final Function2 title, Modifier modifier, Function2 navigationIcon, Function3 actions, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier.Companion modifier5 = i3 != 0 ? Modifier.INSTANCE : modifier2;
                if (i4 != 0) {
                    navigationIcon2 = ComposableSingletons$AppBarKt.INSTANCE.m1971getLambda5$material3_release();
                }
                if (i5 != 0) {
                    actions2 = ComposableSingletons$AppBarKt.INSTANCE.m1972getLambda6$material3_release();
                }
                if ((i & 16) != 0) {
                    $dirty &= -57345;
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
            ...
            $composer2 = $composer3;
            m1788CenterAlignedTopAppBarGHTll3U(function2, modifier3, navigationIcon3, actions3, TopAppBarDefaults.INSTANCE.m2879getTopAppBarExpandedHeightD9Ej5fM(), windowInsets3, colors3, scrollBehavior2, $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (($dirty << 3) & 458752) | (($dirty << 3) & 3670016) | (29360128 & ($dirty << 3)), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
    ...
    public static final void m1788CenterAlignedTopAppBarGHTll3U(final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, float expandedHeight, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        Function2<? super Composer, ? super Integer, Unit> function23;
        Modifier modifier2;
        Function2 navigationIcon;
        Function3 actions;
        ...
        if (($dirty2 & 4793491) == 4793490 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier.Companion modifier5 = i4 != 0 ? Modifier.INSTANCE : modifier2;
                if (i5 != 0) {
                    navigationIcon = ComposableSingletons$AppBarKt.INSTANCE.m1973getLambda7$material3_release();
                }
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1974getLambda8$material3_release();
                }
                if (i7 != 0) {
                    expandedHeight2 = TopAppBarDefaults.INSTANCE.m2879getTopAppBarExpandedHeightD9Ej5fM();
                }
            ...
            $composer2 = $composer3;
            m1791SingleRowTopAppBarcJHQLPU(modifier3, function23, TypographyKt.getValue(TopAppBarSmallTokens.INSTANCE.getHeadlineFont(), $composer3, 6), true, navigationIcon2, actions2, (Dp.m6698equalsimpl0(expandedHeight3, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM()) || Dp.m6698equalsimpl0(expandedHeight3, Dp.INSTANCE.m6712getInfinityD9Ej5fM())) ? TopAppBarDefaults.INSTANCE.m2879getTopAppBarExpandedHeightD9Ej5fM() : expandedHeight3, windowInsets3, colors3, scrollBehavior2, $composer2, (($dirty >> 3) & 14) | 3072 | (($dirty << 3) & 112) | (($dirty << 6) & 57344) | (($dirty << 6) & 458752) | (($dirty << 6) & 29360128) | (($dirty << 6) & 234881024) | (($dirty << 6) & 1879048192), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            expandedHeight4 = expandedHeight3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt.CenterAlignedTopAppBar.2
                ...
                public final void invoke(Composer composer, int i11) {
                    AppBarKt.m1788CenterAlignedTopAppBarGHTll3U(function2, modifier4, navigationIcon3, actions3, expandedHeight4, windowInsets4, colors4, scrollBehavior3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void MediumTopAppBar(final Function2 title, Modifier modifier, Function2 navigationIcon, Function3 actions, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier.Companion modifier5 = i3 != 0 ? Modifier.INSTANCE : modifier2;
                if (i4 != 0) {
                    navigationIcon2 = ComposableSingletons$AppBarKt.INSTANCE.m1975getLambda9$material3_release();
                }
                if (i5 != 0) {
                    actions2 = ComposableSingletons$AppBarKt.INSTANCE.m1959getLambda10$material3_release();
                }
                if ((i & 16) != 0) {
                    $dirty &= -57345;
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
            ...
            $composer2 = $composer3;
            m1790MediumTopAppBaroKE7A98(function2, modifier3, navigationIcon3, actions3, TopAppBarDefaults.INSTANCE.m2877getMediumAppBarCollapsedHeightD9Ej5fM(), TopAppBarDefaults.INSTANCE.m2878getMediumAppBarExpandedHeightD9Ej5fM(), windowInsets3, colors3, scrollBehavior2, $composer2, ($dirty & 14) | 221184 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (($dirty << 6) & 3670016) | (($dirty << 6) & 29360128) | (($dirty << 6) & 234881024), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
    ...
    public static final void m1790MediumTopAppBaroKE7A98(final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, float collapsedHeight, float expandedHeight, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        Function2<? super Composer, ? super Integer, Unit> function23;
        Modifier modifier2;
        Function2 navigationIcon;
        Function3 actions;
        ...
        if (($dirty3 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i4 != 0) {
                    navigationIcon = ComposableSingletons$AppBarKt.INSTANCE.m1960getLambda11$material3_release();
                }
                if (i5 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1961getLambda12$material3_release();
                }
                if (i6 != 0) {
                    collapsedHeight2 = TopAppBarDefaults.INSTANCE.m2877getMediumAppBarCollapsedHeightD9Ej5fM();
                }
                if (i7 != 0) {
                    expandedHeight2 = TopAppBarDefaults.INSTANCE.m2878getMediumAppBarExpandedHeightD9Ej5fM();
                }
                if ((i & 64) != 0) {
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
            ...
            $composer2 = $composer3;
            m1794TwoRowsTopAppBarnS6u9G4(modifier3, function23, TypographyKt.getValue(TopAppBarMediumTokens.INSTANCE.getHeadlineFont(), $composer3, 6), MediumTitleBottomPadding, function2, TypographyKt.getValue(TopAppBarSmallTokens.INSTANCE.getHeadlineFont(), $composer3, 6), navigationIcon2, actions2, (Dp.m6698equalsimpl0(collapsedHeight3, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM()) || Dp.m6698equalsimpl0(collapsedHeight3, Dp.INSTANCE.m6712getInfinityD9Ej5fM())) ? TopAppBarDefaults.INSTANCE.m2877getMediumAppBarCollapsedHeightD9Ej5fM() : collapsedHeight3, (Dp.m6698equalsimpl0(expandedHeight3, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM()) || Dp.m6698equalsimpl0(expandedHeight3, Dp.INSTANCE.m6712getInfinityD9Ej5fM())) ? TopAppBarDefaults.INSTANCE.m2878getMediumAppBarExpandedHeightD9Ej5fM() : expandedHeight3, windowInsets3, colors3, scrollBehavior2, $composer2, (($dirty2 >> 3) & 14) | 3072 | (($dirty2 << 3) & 112) | (($dirty2 << 12) & 57344) | (($dirty2 << 12) & 3670016) | (29360128 & ($dirty2 << 12)), (($dirty2 >> 18) & 14) | (($dirty2 >> 18) & 112) | (($dirty2 >> 18) & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt.MediumTopAppBar.2
                ...
                public final void invoke(Composer composer, int i9) {
                    AppBarKt.m1790MediumTopAppBaroKE7A98(function2, modifier4, navigationIcon3, actions3, collapsedHeight4, expandedHeight4, windowInsets4, colors4, scrollBehavior3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void LargeTopAppBar(final Function2 title, Modifier modifier, Function2 navigationIcon, Function3 actions, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        if ((599187 & $dirty) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier.Companion modifier5 = i3 != 0 ? Modifier.INSTANCE : modifier2;
                if (i4 != 0) {
                    navigationIcon2 = ComposableSingletons$AppBarKt.INSTANCE.m1962getLambda13$material3_release();
                }
                if (i5 != 0) {
                    actions2 = ComposableSingletons$AppBarKt.INSTANCE.m1963getLambda14$material3_release();
                }
                if ((i & 16) != 0) {
                    $dirty &= -57345;
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
    ...
    public static final void m1789LargeTopAppBaroKE7A98(final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, float collapsedHeight, float expandedHeight, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        Function2<? super Composer, ? super Integer, Unit> function23;
        Modifier modifier2;
        Function2 navigationIcon;
        Function3 actions;
        ...
        if (($dirty3 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i4 != 0) {
                    navigationIcon = ComposableSingletons$AppBarKt.INSTANCE.m1964getLambda15$material3_release();
                }
                if (i5 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1965getLambda16$material3_release();
                }
                if (i6 != 0) {
                    collapsedHeight2 = TopAppBarDefaults.INSTANCE.m2875getLargeAppBarCollapsedHeightD9Ej5fM();
                }
                if (i7 != 0) {
                    expandedHeight2 = TopAppBarDefaults.INSTANCE.m2876getLargeAppBarExpandedHeightD9Ej5fM();
                }
                if ((i & 64) != 0) {
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
                    $dirty = $dirty4 & (-3670017);
            ...
            $composer2 = $composer3;
            m1794TwoRowsTopAppBarnS6u9G4(modifier3, function23, TypographyKt.getValue(TopAppBarLargeTokens.INSTANCE.getHeadlineFont(), $composer3, 6), LargeTitleBottomPadding, function2, TypographyKt.getValue(TopAppBarSmallTokens.INSTANCE.getHeadlineFont(), $composer3, 6), navigationIcon2, actions2, (Dp.m6698equalsimpl0(collapsedHeight3, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM()) || Dp.m6698equalsimpl0(collapsedHeight3, Dp.INSTANCE.m6712getInfinityD9Ej5fM())) ? TopAppBarDefaults.INSTANCE.m2875getLargeAppBarCollapsedHeightD9Ej5fM() : collapsedHeight3, (Dp.m6698equalsimpl0(expandedHeight3, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM()) || Dp.m6698equalsimpl0(expandedHeight3, Dp.INSTANCE.m6712getInfinityD9Ej5fM())) ? TopAppBarDefaults.INSTANCE.m2876getLargeAppBarExpandedHeightD9Ej5fM() : expandedHeight3, windowInsets3, colors3, scrollBehavior2, $composer2, (($dirty2 >> 3) & 14) | 3072 | (($dirty2 << 3) & 112) | (($dirty2 << 12) & 57344) | (($dirty2 << 12) & 3670016) | (29360128 & ($dirty2 << 12)), (($dirty2 >> 18) & 14) | (($dirty2 >> 18) & 112) | (($dirty2 >> 18) & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            collapsedHeight4 = collapsedHeight3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt.LargeTopAppBar.2
                ...
                public final void invoke(Composer composer, int i9) {
                    AppBarKt.m1789LargeTopAppBaroKE7A98(function2, modifier4, navigationIcon3, actions3, collapsedHeight4, expandedHeight4, windowInsets4, colors4, scrollBehavior3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1785BottomAppBarSnr_uVM(final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, long containerColor, long contentColor, float tonalElevation, PaddingValues contentPadding, WindowInsets windowInsets, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 4793491) == 4793490 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    contentColor2 = ColorSchemeKt.m1948contentColorForek8zF_U(containerColor2, $composer3, ($dirty >> 9) & 14);
                    $dirty &= -57345;
                }
                if (i7 != 0) {
                    tonalElevation2 = BottomAppBarDefaults.INSTANCE.m1808getContainerElevationD9Ej5fM();
                }
            ...
            $composer2 = $composer3;
            m1787BottomAppBarqhFBPw4(function32, modifier3, floatingActionButton2, containerColor3, contentColor3, tonalElevation3, contentPadding2, windowInsets2, null, $composer2, ($dirty & 14) | 100663296 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | (458752 & $dirty) | (3670016 & $dirty) | (29360128 & $dirty), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$1
                ...
                public final void invoke(Composer composer, int i9) {
                    AppBarKt.m1785BottomAppBarSnr_uVM(function3, modifier4, floatingActionButton3, containerColor4, contentColor4, tonalElevation4, contentPadding3, windowInsets3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1787BottomAppBarqhFBPw4(final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, long containerColor, long contentColor, float tonalElevation, PaddingValues contentPadding, WindowInsets windowInsets, BottomAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            m1786BottomAppBare3WI5M(modifier3, containerColor3, contentColor3, tonalElevation3, contentPadding2, windowInsets3, scrollBehavior2, ComposableLambdaKt.rememberComposableLambda(1566394874, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(3);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$3
                ...
                public final void invoke(Composer composer, int i12) {
                    AppBarKt.m1787BottomAppBarqhFBPw4(function3, modifier4, floatingActionButton2, containerColor4, contentColor4, tonalElevation4, contentPadding3, windowInsets4, scrollBehavior3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1784BottomAppBar1oL4kX8(Modifier modifier, long containerColor, long contentColor, float tonalElevation, PaddingValues contentPadding, WindowInsets windowInsets, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty4 & 599187) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    i2 = -458753;
                    contentColor2 = ColorSchemeKt.m1948contentColorForek8zF_U(containerColor2, $composer3, ($dirty >> 3) & 14);
                    $dirty &= -897;
                } else {
                    i2 = -458753;
                }
            ...
            $composer2 = $composer3;
            m1786BottomAppBare3WI5M(modifier3, containerColor3, contentColor3, tonalElevation3, contentPadding3, windowInsets3, null, function3, $composer2, $dirty3 | ($dirty2 & 14) | ($dirty2 & 112) | ($dirty2 & 896) | ($dirty2 & 7168) | (57344 & $dirty2) | (458752 & $dirty2) | (29360128 & ($dirty2 << 3)), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            containerColor4 = containerColor3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$4
                ...
                public final void invoke(Composer composer, int i10) {
                    AppBarKt.m1784BottomAppBar1oL4kX8(modifier4, containerColor4, contentColor4, tonalElevation4, contentPadding4, windowInsets4, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1786BottomAppBare3WI5M(Modifier modifier, long containerColor, long contentColor, float tonalElevation, PaddingValues contentPadding, WindowInsets windowInsets, BottomAppBarScrollBehavior scrollBehavior, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 48) == 0) {
            if ((i & 2) == 0) {
                containerColor2 = containerColor;
                int i6 = $composer3.changed(containerColor2) ? 32 : 16;
                $dirty4 |= i6;
            } else {
                containerColor2 = containerColor;
            }
        ...
        if (($changed & 384) == 0) {
            if ((i & 4) == 0) {
                contentColor2 = contentColor;
                int i7 = $composer3.changed(contentColor2) ? 256 : 128;
                $dirty4 |= i7;
            } else {
                contentColor2 = contentColor;
            }
        ...
        if ((4793491 & $dirty4) == 4793490 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                float tonalElevation4 = i8 != 0 ? BottomAppBarDefaults.INSTANCE.m1808getContainerElevationD9Ej5fM() : f;
                contentPadding2 = i9 != 0 ? BottomAppBarDefaults.INSTANCE.getContentPadding() : paddingValues;
                if ((i & 32) != 0) {
                    windowInsets2 = BottomAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
                    $dirty &= -458753;
                } else {
            ...
            $composer3.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(i2, $dirty2, -1, "androidx.compose.material3.BottomAppBar (AppBar.kt:867)");
            }
            ...
            boolean invalid$iv3 = ($dirty3 & i4) == 1048576;
            ...
            if (invalid$iv3 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$5$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                        return m1798invoke3p2s80s(measureScope, measurable, constraints.getValue());
                    }

                    /* renamed from: invoke-3p2s80s, reason: not valid java name */
                    public final MeasureResult m1798invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
                        ...
                        if (state2 != null) {
                            state2.setHeightOffsetLimit(-$this$layout.mo367toPx0680j_4(BottomAppBarTokens.INSTANCE.m3034getContainerHeightD9Ej5fM()));
                        }
                        ...
                        return MeasureScope.CC.layout$default($this$layout, placeable.getWidth(), MathKt.roundToInt(height2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$5$1.1
                            {
                                super(1);
                            }
            ...
            SurfaceKt.m2561SurfaceT9BRK9s(LayoutModifierKt.layout(modifier2, (Function3) value$iv).then(appBarDragModifier), value, containerColor3, contentColor3, tonalElevation2, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(1243053520, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$6
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifier$iv = PaddingKt.padding(SizeKt.m712height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), windowInsets3), BottomAppBarTokens.INSTANCE.m3034getContainerHeightD9Ej5fM()), contentPadding2);
            ...
            }, $composer3, 54), $composer2, (($dirty3 << 3) & 896) | i3 | (($dirty3 << 3) & 7168) | (57344 & ($dirty3 << 3)), 96);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            windowInsets4 = windowInsets3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$7
                ...
                public final void invoke(Composer composer, int i11) {
                    AppBarKt.m1786BottomAppBare3WI5M(modifier3, containerColor4, contentColor4, tonalElevation3, contentPadding3, windowInsets4, scrollBehavior3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final TopAppBarState rememberTopAppBarState(final float initialHeightOffsetLimit, final float initialHeightOffset, final float initialContentOffset, Composer $composer, int $changed, int i) {
        ...
        TopAppBarState topAppBarState = (TopAppBarState) RememberSaveableKt.m3772rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final BottomAppBarState rememberBottomAppBarState(final float initialHeightOffsetLimit, final float initialHeightOffset, final float initialContentOffset, Composer $composer, int $changed, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        BottomAppBarState bottomAppBarState = (BottomAppBarState) RememberSaveableKt.m3772rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    */
    ...
    static {
        ...
        float other$iv = Dp.m6693constructorimpl(12);
        BottomAppBarHorizontalPadding = Dp.m6693constructorimpl(arg0$iv - other$iv);
        float arg0$iv2 = Dp.m6693constructorimpl(16);
        float other$iv2 = Dp.m6693constructorimpl(12);
        BottomAppBarVerticalPadding = Dp.m6693constructorimpl(arg0$iv2 - other$iv2);
        float arg0$iv3 = Dp.m6693constructorimpl(16);
        float other$iv3 = BottomAppBarHorizontalPadding;
        FABHorizontalPadding = Dp.m6693constructorimpl(arg0$iv3 - other$iv3);
        float arg0$iv4 = Dp.m6693constructorimpl(12);
        float other$iv4 = BottomAppBarVerticalPadding;
        FABVerticalPadding = Dp.m6693constructorimpl(arg0$iv4 - other$iv4);
        TopTitleAlphaEasing = new CubicBezierEasing(0.8f, 0.0f, 0.8f, 0.15f);
        MediumTitleBottomPadding = Dp.m6693constructorimpl(24);
        LargeTitleBottomPadding = Dp.m6693constructorimpl(28);
        TopAppBarHorizontalPadding = Dp.m6693constructorimpl(4);
        float arg0$iv5 = Dp.m6693constructorimpl(16);
        float other$iv5 = TopAppBarHorizontalPadding;
        TopAppBarTitleInset = Dp.m6693constructorimpl(arg0$iv5 - other$iv5);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m1791SingleRowTopAppBarcJHQLPU(androidx.compose.ui.Modifier r35, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, final androidx.compose.ui.text.TextStyle r37, final boolean r38, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r39, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r40, final float r41, final androidx.compose.foundation.layout.WindowInsets r42, final androidx.compose.material3.TopAppBarColors r43, final androidx.compose.material3.TopAppBarScrollBehavior r44, androidx.compose.runtime.Composer r45, final int r46, final int r47) {
        /*
            Method dump skipped, instructions count: 927
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AppBarKt.m1791SingleRowTopAppBarcJHQLPU(androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, androidx.compose.ui.text.TextStyle, boolean, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, float, androidx.compose.foundation.layout.WindowInsets, androidx.compose.material3.TopAppBarColors, androidx.compose.material3.TopAppBarScrollBehavior, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m1794TwoRowsTopAppBarnS6u9G4(androidx.compose.ui.Modifier r43, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r44, final androidx.compose.ui.text.TextStyle r45, final float r46, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r47, final androidx.compose.ui.text.TextStyle r48, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r49, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r50, final float r51, final float r52, final androidx.compose.foundation.layout.WindowInsets r53, final androidx.compose.material3.TopAppBarColors r54, final androidx.compose.material3.TopAppBarScrollBehavior r55, androidx.compose.runtime.Composer r56, final int r57, final int r58, final int r59) {
        /*
            Method dump skipped, instructions count: 1143
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AppBarKt.m1794TwoRowsTopAppBarnS6u9G4(androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, androidx.compose.ui.text.TextStyle, float, kotlin.jvm.functions.Function2, androidx.compose.ui.text.TextStyle, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, float, float, androidx.compose.foundation.layout.WindowInsets, androidx.compose.material3.TopAppBarColors, androidx.compose.material3.TopAppBarScrollBehavior, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m1793TopAppBarLayoutkXwM9vE(final androidx.compose.ui.Modifier r59, final androidx.compose.material3.ScrolledOffset r60, long r61, final long r63, final long r65, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r67, final androidx.compose.ui.text.TextStyle r68, final float r69, final androidx.compose.foundation.layout.Arrangement.Vertical r70, final androidx.compose.foundation.layout.Arrangement.Horizontal r71, final int r72, final boolean r73, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r74, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r75, androidx.compose.runtime.Composer r76, final int r77, final int r78) {
        /*
            Method dump skipped, instructions count: 1812
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AppBarKt.m1793TopAppBarLayoutkXwM9vE(androidx.compose.ui.Modifier, androidx.compose.material3.ScrolledOffset, long, long, long, kotlin.jvm.functions.Function2, androidx.compose.ui.text.TextStyle, float, androidx.compose.foundation.layout.Arrangement$Vertical, androidx.compose.foundation.layout.Arrangement$Horizontal, int, boolean, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
