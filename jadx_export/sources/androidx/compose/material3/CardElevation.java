...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (interactionSource == null) {
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6691boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (it$iv3 == Composer.INSTANCE.getEmpty()) {
            value$iv3 = new Animatable(Dp.m6691boximpl(target), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        Dp dpM6691boximpl = Dp.m6691boximpl(target);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.LaunchedEffect(dpM6691boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv4, $composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardElevation) && Dp.m6698equalsimpl0(this.defaultElevation, ((CardElevation) other).defaultElevation) && Dp.m6698equalsimpl0(this.pressedElevation, ((CardElevation) other).pressedElevation) && Dp.m6698equalsimpl0(this.focusedElevation, ((CardElevation) other).focusedElevation) && Dp.m6698equalsimpl0(this.hoveredElevation, ((CardElevation) other).hoveredElevation) && Dp.m6698equalsimpl0(this.disabledElevation, ((CardElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Dp.m6699hashCodeimpl(this.defaultElevation);
        return (((((((result * 31) + Dp.m6699hashCodeimpl(this.pressedElevation)) * 31) + Dp.m6699hashCodeimpl(this.focusedElevation)) * 31) + Dp.m6699hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m6699hashCodeimpl(this.disabledElevation);
    }
}
