...
public abstract class ExposedDropdownMenuBoxScope {
    ...
    public abstract Modifier mo2101menuAnchorfsE2BvY(Modifier modifier, String str, boolean z);

    private ExposedDropdownMenuBoxScope() {
    }

    /* renamed from: menuAnchor-fsE2BvY$default, reason: not valid java name */
    public static /* synthetic */ Modifier m2097menuAnchorfsE2BvY$default(ExposedDropdownMenuBoxScope exposedDropdownMenuBoxScope, Modifier modifier, String str, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return exposedDropdownMenuBoxScope.mo2101menuAnchorfsE2BvY(modifier, str, z);
    }
    ...
    public final void m2099ExposedDropdownMenuvNxi1II(final boolean expanded, final Function0<Unit> function0, Modifier modifier, ScrollState scrollState, boolean matchTextFieldWidth, Shape shape, long containerColor, float tonalElevation, float shadowElevation, BorderStroke border, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty2 & 306783379) == 306783378 && ($dirty12 & 19) == 18 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                float tonalElevation4 = i10 != 0 ? MenuDefaults.INSTANCE.m2246getTonalElevationD9Ej5fM() : tonalElevation;
                float shadowElevation4 = i3 != 0 ? MenuDefaults.INSTANCE.m2245getShadowElevationD9Ej5fM() : shadowElevation;
                if (i4 != 0) {
                    modifier3 = modifier5;
            ...
            if (((Boolean) expandedState.getCurrentState()).booleanValue() || ((Boolean) expandedState.getTargetState()).booleanValue()) {
                ...
                if (it$iv4 == Composer.INSTANCE.getEmpty()) {
                    $dirty = $dirty2;
                    value$iv3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TransformOrigin.m4572boximpl(TransformOrigin.INSTANCE.m4585getCenterSzJe1aQ()), null, 2, null);
                ...
                if (invalid$iv || it$iv5 == Composer.INSTANCE.getEmpty()) {
                    value$iv4 = new ExposedDropdownMenuPositionProvider(density, topWindowInsets, keyboardSignalState, 0, new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuBoxScope$ExposedDropdownMenu$popupPositionProvider$1$1
                        ...
                        public final void invoke2(IntRect anchorBounds, IntRect menuBounds) {
                            transformOriginState.setValue(TransformOrigin.m4572boximpl(MenuKt.calculateTransformOrigin(anchorBounds, menuBounds)));
                        }
                    }, 8, null);
                ...
                ComposerKt.sourceInformationMarkerEnd($composer3);
                AndroidPopup_androidKt.Popup(popupPositionProvider, function02, ExposedDropdownMenuDefaults.INSTANCE.m2105popupPropertiespR6Bxps$material3_release(mo2100getAnchorTypeMg6Rgbw$material3_release(), $composer3, 48), ComposableLambdaKt.rememberComposableLambda(-1082380263, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuBoxScope.ExposedDropdownMenu.2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                            ...
                            MenuKt.m2259DropdownMenuContentQj0Zi0g(ExposedDropdownMenuBoxScope.this.exposedDropdownSize(modifier3, matchTextFieldWidth3), expandedState, transformOriginState, scrollState3, shape3, containerColor3, tonalElevation2, shadowElevation2, border2, function3, $composer4, (MutableTransitionState.$stable << 3) | 384);
                            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Modifier menuAnchor(Modifier $this$menuAnchor) {
        return m2097menuAnchorfsE2BvY$default(this, $this$menuAnchor, MenuAnchorType.INSTANCE.m2243getPrimaryNotEditableMg6Rgbw(), false, 2, null);
    }
    ...
    public final void m2098ExposedDropdownMenukbRbctU(final boolean expanded, final Function0<Unit> function0, Modifier modifier, ScrollState scrollState, boolean focusable, boolean matchTextFieldWidth, Shape shape, long containerColor, float tonalElevation, float shadowElevation, BorderStroke border, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int $changed1, final int i) {
        boolean z;
        Function0<Unit> function02;
        Modifier modifier2;
        ScrollState scrollState2;
        ...
        if (($dirty & 306775187) == 306775186 && ($dirty12 & 147) == 146 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                float tonalElevation4 = i10 != 0 ? MenuDefaults.INSTANCE.m2246getTonalElevationD9Ej5fM() : tonalElevation;
                float shadowElevation4 = i2 != 0 ? MenuDefaults.INSTANCE.m2245getShadowElevationD9Ej5fM() : shadowElevation;
                if (i3 != 0) {
                    modifier3 = modifier5;
                    tonalElevation2 = tonalElevation4;
                    scrollState4 = scrollState3;
            ...
            $composer2 = $composer3;
            m2099ExposedDropdownMenuvNxi1II(z, function02, modifier3, scrollState4, matchTextFieldWidth3, shape3, containerColor3, tonalElevation2, shadowElevation2, border2, function3, $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (($dirty >> 3) & 57344) | (($dirty >> 3) & 458752) | (($dirty >> 3) & 3670016) | (($dirty >> 3) & 29360128) | (($dirty >> 3) & 234881024) | (($dirty12 << 27) & 1879048192), (($dirty12 >> 3) & 14) | (($dirty12 >> 3) & 112), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            $dirty1 = $dirty12;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuBoxScope.ExposedDropdownMenu.4
                ...
                public final void invoke(Composer composer, int i13) {
                    ExposedDropdownMenuBoxScope.this.m2098ExposedDropdownMenukbRbctU(expanded, function0, modifier4, scrollState5, focusable3, matchTextFieldWidth4, shape4, containerColor4, tonalElevation3, shadowElevation3, border3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public final /* synthetic */ void ExposedDropdownMenu(final boolean expanded, final Function0 onDismissRequest, Modifier modifier, ScrollState scrollState, final Function3 content, Composer $composer, final int $changed, final int i) {
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            exposedDropdownMenuBoxScope.m2099ExposedDropdownMenuvNxi1II(z, function0, modifier3, scrollState3, true, MenuDefaults.INSTANCE.getShape($composer3, 6), MenuDefaults.INSTANCE.getContainerColor($composer3, 6), MenuDefaults.INSTANCE.m2246getTonalElevationD9Ej5fM(), MenuDefaults.INSTANCE.m2245getShadowElevationD9Ej5fM(), null, function3, $composer2, ($dirty & 14) | 918577152 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), (($dirty >> 12) & 14) | (($dirty >> 12) & 112), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier2 = modifier3;
