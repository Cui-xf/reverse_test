...
public final class DatePickerDialog_androidKt {
    private static final PaddingValues DialogButtonsPadding = PaddingKt.m678PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m6693constructorimpl(6), Dp.m6693constructorimpl(8), 3, null);
    private static final float DialogButtonsMainAxisSpacing = Dp.m6693constructorimpl(8);
    private static final float DialogButtonsCrossAxisSpacing = Dp.m6693constructorimpl(12);

    /* renamed from: DatePickerDialog-GmEhDVc, reason: not valid java name */
    public static final void m2043DatePickerDialogGmEhDVc(final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Shape shape, float tonalElevation, DatePickerColors colors, DialogProperties properties, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty3 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    tonalElevation2 = DatePickerDefaults.INSTANCE.m2042getTonalElevationD9Ej5fM();
                }
                if ((i & 64) != 0) {
                    $dirty &= -3670017;
            ...
            AlertDialogKt.BasicAlertDialog(function02, SizeKt.wrapContentHeight$default(modifier3, null, false, 3, null), properties2, ComposableLambdaKt.rememberComposableLambda(-10625622, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerDialog_androidKt$DatePickerDialog$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifierM714heightInVpY3zN4$default = SizeKt.m714heightInVpY3zN4$default(SizeKt.m723requiredWidth3ABfNKs(Modifier.INSTANCE, DatePickerModalTokens.INSTANCE.m3158getContainerWidthD9Ej5fM()), 0.0f, DatePickerModalTokens.INSTANCE.m3157getContainerHeightD9Ej5fM(), 1, null);
                        Shape shape5 = shape3;
                        ...
                        SurfaceKt.m2561SurfaceT9BRK9s(modifierM714heightInVpY3zN4$default, shape5, containerColor, 0L, f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1706202235, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerDialog_androidKt$DatePickerDialog$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerDialog_androidKt$DatePickerDialog$2
                ...
                public final void invoke(Composer composer, int i8) {
                    DatePickerDialog_androidKt.m2043DatePickerDialogGmEhDVc(function0, function2, modifier4, dismissButton3, shape4, tonalElevation4, colors3, properties3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
