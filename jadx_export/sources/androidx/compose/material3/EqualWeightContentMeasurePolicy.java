...
final class EqualWeightContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        int width2 = Constraints.m6636getMaxWidthimpl(constraints);
        int itemHeight = Constraints.m6637getMinHeightimpl(constraints);
        int itemsCount = list.size();
        if (itemsCount < 1) {
            return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width2, itemHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.EqualWeightContentMeasurePolicy$measure$1
        ...
        if (!Constraints.m6632getHasBoundedWidthimpl(constraints)) {
            ...
            while (index$iv$iv < size) {
                ...
                target$iv.add(it.mo5535measureBRTryo0(ConstraintsKt.m6651constrainN9IONVI(constraints, Constraints.INSTANCE.m6647fixedHeightOenEA2s(itemHeight))));
                index$iv$iv++;
            ...
            while (index$iv$iv2 < size3) {
                ...
                target$iv2.add(it3.mo5535measureBRTryo0(ConstraintsKt.m6651constrainN9IONVI(constraints, Constraints.INSTANCE.m6646fixedJhjzzOo(width4, itemHeight))));
                index$iv$iv2++;
        ...
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, itemHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.EqualWeightContentMeasurePolicy$measure$5
