...
public final class SearchBar_androidKt {
    ...
    private static final TextFieldColors UnspecifiedTextFieldColors = new TextFieldColors(Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), new SelectionColors(Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), null), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), null);
    ...
    public static final void m2444SearchBarY92LkZI(final Function2<? super Composer, ? super Integer, Unit> function2, boolean expanded, final Function1<? super Boolean, Unit> function1, Modifier modifier, Shape shape, SearchBarColors colors, float tonalElevation, float shadowElevation, WindowInsets windowInsets, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 100663296) == 0) {
            if ((i & 256) == 0) {
                ...
                int i8 = $composer3.changed(windowInsets2) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
                $dirty4 |= i8;
            } else {
                windowInsets2 = windowInsets;
            }
        ...
        if (($dirty4 & 306783379) == 306783378 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    i2 = 6;
                    colors2 = SearchBarDefaults.INSTANCE.m2434colorsdgg9oW8(0L, 0L, $composer3, 384, 3);
                    $dirty &= -458753;
                } else {
                    i2 = 6;
                    colors2 = colors;
                }
                float tonalElevation4 = i6 != 0 ? SearchBarDefaults.INSTANCE.m2438getTonalElevationD9Ej5fM() : tonalElevation;
                float shadowElevation4 = i7 != 0 ? SearchBarDefaults.INSTANCE.m2437getShadowElevationD9Ej5fM() : f2;
                if ((i & 256) != 0) {
                    modifier3 = modifier6;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$SearchBar$3
                ...
                public final void invoke(Composer composer, int i10) {
                    SearchBar_androidKt.m2444SearchBarY92LkZI(function2, z, function1, modifier5, shape6, colors5, tonalElevation3, shadowElevation3, windowInsets4, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2441DockedSearchBarEQC0FA8(final Function2<? super Composer, ? super Integer, Unit> function2, final boolean expanded, final Function1<? super Boolean, Unit> function1, Modifier modifier, Shape shape, SearchBarColors colors, float tonalElevation, float shadowElevation, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        Shape shape2;
        SearchBarColors searchBarColors;
        float f;
        ...
        if ((38347923 & $dirty3) == 38347922 && $composer4.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    i2 = i7;
                    colors2 = SearchBarDefaults.INSTANCE.m2434colorsdgg9oW8(0L, 0L, $composer4, 384, 3);
                    $composer2 = $composer4;
                    $dirty &= -458753;
                } else {
                    $composer2 = $composer4;
                ...
                if (i2 != 0) {
                    ...
                    shadowElevation2 = SearchBarDefaults.INSTANCE.m2437getShadowElevationD9Ej5fM();
                    tonalElevation2 = tonalElevation4;
                    $dirty2 = $dirty;
                } else {
            ...
            long jM2430getContainerColor0d7_KjU = colors3.m2430getContainerColor0d7_KjU();
            long jM1948contentColorForek8zF_U = ColorSchemeKt.m1948contentColorForek8zF_U(colors3.m2430getContainerColor0d7_KjU(), $composer2, 0);
            SearchBarColors colors5 = colors3;
            Composer $composer5 = $composer2;
            Shape shape5 = shape2;
            SurfaceKt.m2561SurfaceT9BRK9s(SizeKt.m731width3ABfNKs(ZIndexModifierKt.zIndex(modifier2, 1.0f), SearchBarMinWidth), shape5, jM2430getContainerColor0d7_KjU, jM1948contentColorForek8zF_U, tonalElevation2, shadowElevation2, null, ComposableLambdaKt.rememberComposableLambda(878471280, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$DockedSearchBar$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$DockedSearchBar$3
                ...
                public final void invoke(Composer composer, int i8) {
                    SearchBar_androidKt.m2441DockedSearchBarEQC0FA8(function2, expanded, function1, modifier3, shape4, colors4, tonalElevation3, shadowElevation3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2443SearchBarWuY5d9Q(final String query, final Function1<? super String, Unit> function1, final Function1<? super String, Unit> function12, final boolean active, final Function1<? super Boolean, Unit> function13, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Shape shape, SearchBarColors colors, float tonalElevation, float shadowElevation, WindowInsets windowInsets, MutableInteractionSource interactionSource, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty2 & 306783379) == 306783378 && ($dirty1 & 599187) == 599186 && $composer4.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                ...
                Function2 leadingIcon3 = i8 != 0 ? null : function22;
                ...
                if ((i & 2048) != 0) {
                    ...
                    $dirty = $dirty2;
                    $composer2 = $composer4;
                    colors2 = SearchBarDefaults.INSTANCE.m2434colorsdgg9oW8(0L, 0L, $composer2, 384, 3);
                    $dirty12 &= -113;
                } else {
                    i3 = i11;
                    $composer2 = $composer4;
                ...
                float tonalElevation4 = i10 != 0 ? SearchBarDefaults.INSTANCE.m2438getTonalElevationD9Ej5fM() : tonalElevation;
                float shadowElevation4 = i3 != 0 ? SearchBarDefaults.INSTANCE.m2437getShadowElevationD9Ej5fM() : shadowElevation;
                if ((i & 16384) != 0) {
            ...
            ComposableLambda composableLambdaRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(-1158111311, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$SearchBar$4
                ...
                public final void invoke(Composer $composer5, int $changed2) {
                    ...
                    SearchBarDefaults.INSTANCE.InputField(query, function15, function12, active, function13, SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), enabled2, placeholder2, leadingIcon, trailingIcon, colors3.getInputFieldColors(), interactionSource2, $composer5, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 384, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
            }, $composer2, 54);
            int i13 = 6 | (($dirty >> 6) & 112) | (($dirty >> 6) & 896) | (($dirty >> 6) & 7168) | (($dirty13 << 12) & 57344) | (($dirty13 << 12) & 458752) | (($dirty13 << 12) & 3670016) | (($dirty13 << 12) & 29360128) | (234881024 & ($dirty13 << 12)) | (($dirty13 << 9) & 1879048192);
            Composer $composer5 = $composer2;
            SearchBarColors colors5 = colors3;
            m2444SearchBarY92LkZI(composableLambdaRememberComposableLambda, active, function13, modifier3, shape3, colors5, tonalElevation2, shadowElevation2, windowInsets3, function3, $composer5, i13, 0);
            $composer3 = $composer5;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$SearchBar$5
                ...
                public final void invoke(Composer composer, int i14) {
                    SearchBar_androidKt.m2443SearchBarWuY5d9Q(query, function1, function12, active, function13, modifier4, enabled3, placeholder3, leadingIcon2, trailingIcon2, shape4, colors4, tonalElevation3, shadowElevation3, windowInsets4, interactionSource3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void m2442DockedSearchBareWTbjVg(final String query, final Function1<? super String, Unit> function1, final Function1<? super String, Unit> function12, final boolean active, final Function1<? super Boolean, Unit> function13, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Shape shape, SearchBarColors colors, float tonalElevation, float shadowElevation, MutableInteractionSource interactionSource, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty2 & 306783379) == 306783378 && ($dirty1 & 74899) == 74898 && $composer4.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                ...
                Function2 leadingIcon3 = i7 != 0 ? null : function22;
                Function2 trailingIcon3 = i2 != 0 ? null : function23;
                if ((i & 1024) != 0) {
                    $dirty12 = $dirty1 & (-15);
                ...
                float tonalElevation4 = i9 != 0 ? SearchBarDefaults.INSTANCE.m2438getTonalElevationD9Ej5fM() : tonalElevation;
                float shadowElevation4 = i10 != 0 ? SearchBarDefaults.INSTANCE.m2437getShadowElevationD9Ej5fM() : shadowElevation;
                if (i3 != 0) {
                    leadingIcon = leadingIcon3;
                    tonalElevation2 = tonalElevation4;
                    shadowElevation2 = shadowElevation4;
            ...
            Composer $composer5 = $composer2;
            SearchBarColors colors5 = colors3;
            m2441DockedSearchBarEQC0FA8(composableLambdaRememberComposableLambda, active, function13, modifier3, shape3, colors5, tonalElevation2, shadowElevation2, function3, $composer5, i12, 0);
            $composer3 = $composer5;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$DockedSearchBar$5
                ...
                public final void invoke(Composer composer, int i13) {
                    SearchBar_androidKt.m2442DockedSearchBareWTbjVg(query, function1, function12, active, function13, modifier4, enabled3, placeholder3, leadingIcon2, trailingIcon2, shape4, colors4, tonalElevation3, shadowElevation3, interactionSource3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void m2445SearchBarImplj1jLAyQ(final Animatable<Float, AnimationVector1D> animatable, final MutableFloatState finalBackProgress, final MutableState<BackEventCompat> mutableState, final MutableState<BackEventCompat> mutableState2, Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Shape shape, SearchBarColors colors, float tonalElevation, float shadowElevation, WindowInsets windowInsets, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((306783379 & $dirty3) == 306783378 && ($dirty12 & 19) == 18 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                float tonalElevation4 = i2 != 0 ? SearchBarDefaults.INSTANCE.m2438getTonalElevationD9Ej5fM() : tonalElevation;
                float shadowElevation4 = i3 != 0 ? SearchBarDefaults.INSTANCE.m2437getShadowElevationD9Ej5fM() : shadowElevation;
                if ((i & 1024) != 0) {
                    shadowElevation2 = shadowElevation4;
                ...
                if (Intrinsics.areEqual(shape3, defaultInputFieldShape2)) {
                    ...
                    value$iv = new GenericShape(new Function3<Path, Size, LayoutDirection, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$SearchBarImpl$animatedShape$1$1
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Path path, Size size, LayoutDirection layoutDirection) {
                            m2450invoke12SF9DM(path, size.getPackedValue(), layoutDirection);
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-12SF9DM, reason: not valid java name */
                        public final void m2450invoke12SF9DM(Path $this$$receiver, long size, LayoutDirection layoutDirection) {
                            ...
                            float radius = $this$invoke_12SF9DM_u24lambda_u240.mo367toPx0680j_4(Dp.m6693constructorimpl(arg0$iv * other$iv));
                            Path.CC.addRoundRect$default($this$$receiver, RoundRectKt.m4000RoundRectsniSvfs(androidx.compose.ui.geometry.SizeKt.m4035toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null)), null, 2, null);
                        }
                    });
                } else {
                    shape4 = shape3;
            ...
            Function2 surface2 = ComposableLambdaKt.rememberComposableLambda(-170534294, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$SearchBarImpl$surface$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        SurfaceKt.m2561SurfaceT9BRK9s(null, animatedShape, colors3.m2430getContainerColor0d7_KjU(), ColorSchemeKt.m1948contentColorForek8zF_U(colors3.m2430getContainerColor0d7_KjU(), $composer4, 0), tonalElevation2, shadowElevation2, null, ComposableSingletons$SearchBar_androidKt.INSTANCE.m1997getLambda2$material3_release(), $composer4, 12582912, 65);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            Function2 wrappedContent = SearchBarImpl_j1jLAyQ$lambda$12(showContent$delegate) ? ComposableLambdaKt.rememberComposableLambda(147843820, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SearchBar_androidKt$SearchBarImpl$wrappedContent$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    DividerKt.m2090HorizontalDivider9IZ8Weo(null, 0.0f, searchBarColors3.m2431getDividerColor0d7_KjU(), $composer4, 0, 3);
    ...
    */
    ...
    public static final int m2448calculatePredictiveBackOffsetXrOvwMX4(long constraints, int minMargin, BackEventCompat currentBackEvent, LayoutDirection layoutDirection, float progress, float predictiveBackMultiplier) {
        if (currentBackEvent != null) {
            if (!(predictiveBackMultiplier == 0.0f)) {
                ...
                float maxOffsetX = (Constraints.m6636getMaxWidthimpl(constraints) * SearchBarPredictiveBackMaxOffsetXRatio) - minMargin;
    ...
    public static final int m2449calculatePredictiveBackOffsetYdzo92Q0(long constraints, int minMargin, BackEventCompat currentBackEvent, BackEventCompat firstBackEvent, int height, int maxOffsetY, float predictiveBackMultiplier) {
        if (firstBackEvent != null && currentBackEvent != null) {
            if (!(predictiveBackMultiplier == 0.0f)) {
                int availableVerticalSpace = Math.max(0, ((Constraints.m6635getMaxHeightimpl(constraints) - height) / 2) - minMargin);
                ...
                float yProgress = Math.abs(yDelta) / Constraints.m6635getMaxHeightimpl(constraints);
    ...
    static {
        float arg0$iv = SearchBarDefaults.INSTANCE.m2436getInputFieldHeightD9Ej5fM();
        SearchBarCornerRadius = Dp.m6693constructorimpl(arg0$iv / 2);
        DockedExpandedTableMinHeight = Dp.m6693constructorimpl(240);
        SearchBarMinWidth = Dp.m6693constructorimpl(360);
        SearchBarMaxWidth = Dp.m6693constructorimpl(720);
        SearchBarVerticalPadding = Dp.m6693constructorimpl(8);
        SearchBarIconOffsetX = Dp.m6693constructorimpl(4);
        SearchBarPredictiveBackMinMargin = Dp.m6693constructorimpl(8);
        SearchBarPredictiveBackMaxOffsetY = Dp.m6693constructorimpl(24);
