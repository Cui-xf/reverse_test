...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m726size3ABfNKs(Modifier.INSTANCE, IconButtonTokens.INSTANCE.m3307getIconSizeD9Ej5fM());

    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m2168Iconww6aTOc(final ImageVector imageVector, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        String str;
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    ...
                    $dirty &= -7169;
                    modifier3 = modifier4;
                    tint3 = ((Color) objConsume).m4197unboximpl();
                } else {
                    modifier3 = modifier4;
                    tint3 = tint2;
                }
            ...
            m2167Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, $composer2, $dirty & 14), str, modifier3, tint3, $composer2, VectorPainter.$stable | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt.Icon.1
                ...
                public final void invoke(Composer composer, int i4) {
                    IconKt.m2168Iconww6aTOc(imageVector, contentDescription, modifier2, tint2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m2166Iconww6aTOc(final ImageBitmap bitmap, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        String str;
        Modifier modifier2;
        long j;
        int $dirty;
        ...
        if (($dirty2 & 1171) == 1170 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    ...
                    long tint4 = ((Color) objConsume).m4197unboximpl();
                    $dirty = $dirty2 & (-7169);
                    modifier3 = modifier5;
                    tint2 = tint4;
                } else {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            m2167Iconww6aTOc(painter, str, modifier3, tint2, $composer3, ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt.Icon.2
                ...
                public final void invoke(Composer composer, int i4) {
                    IconKt.m2166Iconww6aTOc(bitmap, contentDescription, modifier4, tint3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m2167Iconww6aTOc(final Painter painter, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long tint2;
        Modifier modifier3;
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    ...
                    $dirty &= -7169;
                    modifier3 = modifier5;
                    tint2 = ((Color) objConsume).m4197unboximpl();
                } else {
                    tint2 = j;
                    modifier3 = modifier5;
                }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt.Icon.3
                ...
                public final void invoke(Composer composer, int i4) {
                    IconKt.m2167Iconww6aTOc(painter, contentDescription, modifier4, tint3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
            ...
            if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$4$1
                    ...
                    public final void invoke2(DrawScope $this$drawBehind) {
                        ColorFilter colorFilterM4228tintxETnrds$default;
                        Painter $this$invoke_u24lambda_u241 = painter;
                        ColorProducer colorProducer = tint;
                        long jMo4662getSizeNHjbRc = $this$drawBehind.mo4662getSizeNHjbRc();
                        if (colorProducer != null) {
                            long it = colorProducer.mo1537invoke0d7_KjU();
                            colorFilterM4228tintxETnrds$default = ColorFilter.Companion.m4228tintxETnrds$default(ColorFilter.INSTANCE, it, 0, 2, null);
                        } else {
                            colorFilterM4228tintxETnrds$default = null;
                        }
                        Painter.m4874drawx_KDEd0$default($this$invoke_u24lambda_u241, $this$drawBehind, jMo4662getSizeNHjbRc, 0.0f, colorFilterM4228tintxETnrds$default, 2, null);
                    }
                };
                $composer2.updateRememberedValue(value$iv);
            } else {
    ...
    private static final Modifier defaultSizeForColorProducer(Modifier $this$defaultSizeForColorProducer, Painter painter) {
        ...
        if (Size.m4010equalsimpl0(painter.getIntrinsicSize(), Size.INSTANCE.m4022getUnspecifiedNHjbRc()) || m2169isInfiniteuvyYCjk(painter.getIntrinsicSize())) {
            modifierLayout = DefaultIconSizeModifier;
        } else {
            long intrinsicSize = painter.getIntrinsicSize();
            final float srcWidth = Size.m4014getWidthimpl(intrinsicSize);
            final float srcHeight = Size.m4011getHeightimpl(intrinsicSize);
            modifierLayout = LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.IconKt.defaultSizeForColorProducer.1
                ...
                public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                    return m2170invoke3p2s80s(measureScope, measurable, constraints.getValue());
                }

                /* renamed from: invoke-3p2s80s, reason: not valid java name */
                public final MeasureResult m2170invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long j) {
                    final Placeable placeable = measurable.mo5535measureBRTryo0(Constraints.INSTANCE.m6646fixedJhjzzOo((int) srcWidth, (int) srcHeight));
                    return MeasureScope.CC.layout$default($this$layout, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.IconKt.defaultSizeForColorProducer.1.1
                        {
                            super(1);
                        }
    ...
    private static final boolean m2169isInfiniteuvyYCjk(long $this$isInfinite_u2duvyYCjk) {
