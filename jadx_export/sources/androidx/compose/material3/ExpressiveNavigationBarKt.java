...
public final class ExpressiveNavigationBarKt {
    ...
    private static final float IconSize = Dp.m6693constructorimpl((float) 24.0d);
    private static final float TopIconItemActiveIndicatorWidth = Dp.m6693constructorimpl(56);
    private static final float TopIconItemActiveIndicatorHeight = Dp.m6693constructorimpl(32);
    private static final float StartIconItemActiveIndicatorHeight = Dp.m6693constructorimpl(40);
    ...
    private static final float NavigationBarHeight = Dp.m6693constructorimpl(64);
    private static final float TopIconItemVerticalPadding = Dp.m6693constructorimpl(6);

    /* renamed from: ExpressiveNavigationBar-NiJtXQ4, reason: not valid java name */
    public static final void m2113ExpressiveNavigationBarNiJtXQ4(Modifier modifier, long containerColor, long contentColor, WindowInsets windowInsets, int arrangement, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    arrangement2 = ExpressiveNavigationBarDefaults.INSTANCE.m2112getArrangementEbr7WPU();
                    $dirty &= -57345;
            ...
            $composer2 = $composer3;
            SurfaceKt.m2561SurfaceT9BRK9s(null, null, containerColor3, contentColor3, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(1573697866, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExpressiveNavigationBarKt$ExpressiveNavigationBar$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifierSelectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m711defaultMinSizeVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(modifier3, windowInsets2), 0.0f, ExpressiveNavigationBarKt.NavigationBarHeight, 1, null));
                        int i8 = arrangement2;
                        if (NavigationBarArrangement.m2270equalsimpl0(i8, NavigationBarArrangement.INSTANCE.m2275getEqualWeightEbr7WPU())) {
                            centeredContentMeasurePolicy = new EqualWeightContentMeasurePolicy();
                        } else if (NavigationBarArrangement.m2270equalsimpl0(i8, NavigationBarArrangement.INSTANCE.m2274getCenteredEbr7WPU())) {
                        ...
                        Updater.m3685setimpl($this$Layout_u24lambda_u240$iv, centeredContentMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExpressiveNavigationBarKt$ExpressiveNavigationBar$2
                ...
                public final void invoke(Composer composer, int i8) {
                    ExpressiveNavigationBarKt.m2113ExpressiveNavigationBarNiJtXQ4(modifier4, containerColor4, contentColor4, windowInsets3, arrangement3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2114ExpressiveNavigationBarItemplit6k(final boolean selected, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, int iconPosition, NavigationItemColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        boolean z;
        ...
        if (($changed & 100663296) == 0) {
            $dirty2 |= ((i & 256) == 0 && $composer3.changed(colors)) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
        }
        int i9 = i & 512;
        if (i9 != 0) {
            $dirty2 |= 805306368;
        ...
        if (($dirty2 & 306783379) == 306783378 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                iconPosition2 = i2 != 0 ? NavigationItemIconPosition.INSTANCE.m2328getTopxw1Ddg() : iconPosition;
                if ((i & 256) != 0) {
            ...
            boolean isIconPositionTop = NavigationItemIconPosition.m2323equalsimpl0(iconPosition2, NavigationItemIconPosition.INSTANCE.m2328getTopxw1Ddg());
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExpressiveNavigationBarKt$ExpressiveNavigationBarItem$1
                ...
                public final void invoke(Composer composer, int i10) {
                    ExpressiveNavigationBarKt.m2114ExpressiveNavigationBarItemplit6k(selected, function0, function2, modifier4, enabled4, label3, badge3, iconPosition3, colors4, interactionSource4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    static {
        ...
        TopIconIndicatorVerticalPadding = Dp.m6693constructorimpl(Dp.m6693constructorimpl(arg0$iv - other$iv) / 2);
        float arg0$iv2 = TopIconItemActiveIndicatorWidth;
        float other$iv2 = IconSize;
        TopIconIndicatorHorizontalPadding = Dp.m6693constructorimpl(Dp.m6693constructorimpl(arg0$iv2 - other$iv2) / 2);
        float arg0$iv3 = StartIconItemActiveIndicatorHeight;
        float other$iv3 = IconSize;
        StartIconIndicatorVerticalPadding = Dp.m6693constructorimpl(Dp.m6693constructorimpl(arg0$iv3 - other$iv3) / 2);
        TopIconIndicatorToLabelPadding = Dp.m6693constructorimpl(4);
        StartIconIndicatorHorizontalPadding = Dp.m6693constructorimpl(16);
        StartIconToLabelPadding = Dp.m6693constructorimpl(4);
    }
