...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int initialHour, int initialMinute, boolean is24Hour) {
        ...
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m2762boximpl(TimePickerSelectionMode.INSTANCE.m2769getHouryecRtBI()), null, 2, null);
    ...
    public int mo1778getSelectionyecRtBI() {
        ...
        return ((TimePickerSelectionMode) $this$getValue$iv.getValue()).m2768unboximpl();
    }
    ...
    public void mo1779setSelection6_8s6DQ(int i) {
        ...
        $this$setValue$iv.setValue(TimePickerSelectionMode.m2762boximpl(i));
    }
