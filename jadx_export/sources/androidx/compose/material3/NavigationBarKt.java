...
public final class NavigationBarKt {
    ...
    private static final float NavigationBarHeight = NavigationBarTokens.INSTANCE.m3338getContainerHeightD9Ej5fM();
    private static final float NavigationBarItemHorizontalPadding = Dp.m6693constructorimpl(8);
    private static final float NavigationBarIndicatorToLabelPadding = Dp.m6693constructorimpl(4);

    /* renamed from: NavigationBar-HsRjFd4, reason: not valid java name */
    public static final void m2291NavigationBarHsRjFd4(Modifier modifier, long containerColor, long contentColor, float tonalElevation, WindowInsets windowInsets, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    contentColor2 = ColorSchemeKt.m1947contentColorFor4WTKRHQ(MaterialTheme.INSTANCE.getColorScheme($composer3, 6), containerColor2);
                    $dirty &= -897;
                }
                if (i5 != 0) {
                    tonalElevation2 = NavigationBarDefaults.INSTANCE.m2276getElevationD9Ej5fM();
                }
                if ((i & 16) != 0) {
            ...
            $composer2 = $composer3;
            SurfaceKt.m2561SurfaceT9BRK9s(modifier3, null, containerColor3, contentColor3, tonalElevation3, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(105663120, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBar$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.m557spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding());
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBar$2
                ...
                public final void invoke(Composer composer, int i7) {
                    NavigationBarKt.m2291NavigationBarHsRjFd4(modifier4, containerColor4, contentColor4, tonalElevation4, windowInsets4, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    */
    ...
    public static final void NavigationBarItemLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean alwaysShowLabel, final Function0<Float> function0, Composer $composer, final int $changed) {
        ...
        if ((74899 & $dirty) == 74898 && $composer3.getSkipping()) {
                    ...
                    public final MeasureResult mo34measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                        ...
                        while (index$iv$iv < size) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                                ...
                                int indicatorHeight = height + measureScope.mo361roundToPx0680j_4(Dp.m6693constructorimpl(2 * arg0$iv2));
                                int size2 = list.size();
                                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "indicatorRipple")) {
                                        ...
                                        if (function24 == null) {
                                            return NavigationBarKt.m2294placeIconX9ElhV4($this$Layout, iconPlaceable2, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                                        }
                                        Intrinsics.checkNotNull(labelPlaceable);
                                        return NavigationBarKt.m2295placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable2, indicatorRipplePlaceable, indicatorPlaceable, constraints, alwaysShowLabel, animationProgress);
                                    }
            ...
            if (function24 != null) {
                ...
                Modifier modifier$iv3 = PaddingKt.m683paddingVpY3zN4$default(modifierGraphicsLayer, Dp.m6693constructorimpl(arg0$iv / 2), 0.0f, 2, null);
                ComposerKt.sourceInformationMarkerStart($composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
    ...
    public static final MeasureResult m2294placeIconX9ElhV4(MeasureScope $this$placeIcon_u2dX9ElhV4, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints) {
        final int width = Constraints.m6636getMaxWidthimpl(constraints);
        final int height = ConstraintsKt.m6652constrainHeightK40F9xA(constraints, $this$placeIcon_u2dX9ElhV4.mo361roundToPx0680j_4(NavigationBarHeight));
    ...
    public static final MeasureResult m2295placeLabelAndIconzUg2_y0(final MeasureScope $this$placeLabelAndIcon_u2dzUg2_y0, final Placeable labelPlaceable, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints, final boolean alwaysShowLabel, final float animationProgress) {
        float contentHeight = iconPlaceable.getHeight() + $this$placeLabelAndIcon_u2dzUg2_y0.mo367toPx0680j_4(IndicatorVerticalPadding) + $this$placeLabelAndIcon_u2dzUg2_y0.mo367toPx0680j_4(NavigationBarIndicatorToLabelPadding) + labelPlaceable.getHeight();
        final float contentVerticalPadding = RangesKt.coerceAtLeast((Constraints.m6637getMinHeightimpl(constraints) - contentHeight) / 2.0f, $this$placeLabelAndIcon_u2dzUg2_y0.mo367toPx0680j_4(IndicatorVerticalPadding));
        ...
        final float labelY = iconPlaceable.getHeight() + contentVerticalPadding + $this$placeLabelAndIcon_u2dzUg2_y0.mo367toPx0680j_4(IndicatorVerticalPadding) + $this$placeLabelAndIcon_u2dzUg2_y0.mo367toPx0680j_4(NavigationBarIndicatorToLabelPadding);
        final int containerWidth = Constraints.m6636getMaxWidthimpl(constraints);
        ...
        final float rippleY = contentVerticalPadding - $this$placeLabelAndIcon_u2dzUg2_y0.mo367toPx0680j_4(IndicatorVerticalPadding);
        return MeasureScope.CC.layout$default($this$placeLabelAndIcon_u2dzUg2_y0, containerWidth, MathKt.roundToInt(height), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeLabelAndIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            */
            public final void invoke2(androidx.compose.ui.layout.Placeable.PlacementScope r21) {
                /*
                    ...
                    int r2 = r4.mo361roundToPx0680j_4(r2)
                    float r2 = (float) r2
                    float r3 = r3 - r2
                    float r5 = r5 + r3
    ...
    static {
        float arg0$iv = NavigationBarTokens.INSTANCE.m3336getActiveIndicatorWidthD9Ej5fM();
        float other$iv = NavigationBarTokens.INSTANCE.m3339getIconSizeD9Ej5fM();
        IndicatorHorizontalPadding = Dp.m6693constructorimpl(Dp.m6693constructorimpl(arg0$iv - other$iv) / 2);
        float arg0$iv2 = NavigationBarTokens.INSTANCE.m3335getActiveIndicatorHeightD9Ej5fM();
        float other$iv2 = NavigationBarTokens.INSTANCE.m3339getIconSizeD9Ej5fM();
        IndicatorVerticalPadding = Dp.m6693constructorimpl(Dp.m6693constructorimpl(arg0$iv2 - other$iv2) / 2);
        IndicatorVerticalOffset = Dp.m6693constructorimpl(12);
    }
