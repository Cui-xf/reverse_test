...
public final class MenuKt {
    ...
    private static final float MenuVerticalMargin = Dp.m6693constructorimpl(48);
    private static final float MenuListItemContainerHeight = Dp.m6693constructorimpl(48);
    private static final float DropdownMenuItemHorizontalPadding = Dp.m6693constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m6693constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m6693constructorimpl(112);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m6693constructorimpl(280);
    ...
    public static final void m2259DropdownMenuContentQj0Zi0g(final Modifier modifier, final MutableTransitionState<Boolean> mutableTransitionState, final MutableState<TransformOrigin> mutableState, final ScrollState scrollState, final Shape shape, final long containerColor, final float tonalElevation, final float shadowElevation, final BorderStroke border, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 306783379) == 306783378 && $composer6.getSkipping()) {
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope $this$graphicsLayer) {
                        ...
                        $this$graphicsLayer.mo4360setTransformOrigin__ExYCQ(mutableState.getValue().getPackedValue());
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd($composer6);
            SurfaceKt.m2561SurfaceT9BRK9s(GraphicsLayerModifierKt.graphicsLayer(companion, (Function1) value$iv), shape, containerColor, 0L, tonalElevation, shadowElevation, border, ComposableLambdaKt.rememberComposableLambda(1573559053, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer $composer7, int $changed6) {
                    ...
                    if (($changed6 & 3) != 2 || !$composer7.getSkipping()) {
                        ...
                        Modifier modifier$iv = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m683paddingVpY3zN4$default(modifier, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), scrollState, false, null, false, 14, null);
                        ...
                        content$iv.invoke(ColumnScopeInstance.INSTANCE, $composer7, Integer.valueOf(((0 >> 6) & 112) | 6));
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$3
                ...
                public final void invoke(Composer composer, int i) {
                    MenuKt.m2259DropdownMenuContentQj0Zi0g(modifier, mutableTransitionState, mutableState, scrollState, shape, containerColor, tonalElevation, shadowElevation, border, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
