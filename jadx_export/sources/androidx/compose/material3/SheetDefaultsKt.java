...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m6693constructorimpl(22);
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt.ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection.1
            ...
            public Object mo478onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
                ...
                if (toFling < 0.0f && currentOffset > minAnchor) {
                    ...
                    jM6945getZero9UxMQ8M = available;
                } else {
                    jM6945getZero9UxMQ8M = Velocity.INSTANCE.m6945getZero9UxMQ8M();
                }
                return Velocity.m6925boximpl(jM6945getZero9UxMQ8M);
            }
            ...
            public Object mo476onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
                ...
                return Velocity.m6925boximpl(available);
            }
            ...
            private final float velocityToFloat(long $this$toFloat) {
                return orientation == Orientation.Horizontal ? Velocity.m6934getXimpl($this$toFloat) : Velocity.m6935getYimpl($this$toFloat);
            }

            private final float offsetToFloat(long $this$toFloat) {
                return orientation == Orientation.Horizontal ? Offset.m3945getXimpl($this$toFloat) : Offset.m3946getYimpl($this$toFloat);
            }
        };
    }
    ...
    public static final SheetState rememberSheetState(boolean skipPartiallyExpanded, Function1<? super SheetValue, Boolean> function1, SheetValue initialValue, boolean skipHiddenState, Composer $composer, int $changed, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        SheetState sheetState = (SheetState) RememberSaveableKt.m3772rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
