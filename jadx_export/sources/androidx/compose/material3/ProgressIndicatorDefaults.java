...
public final class ProgressIndicatorDefaults {
    ...
    private static final float CircularStrokeWidth = ProgressIndicatorTokens.INSTANCE.m3485getTrackThicknessD9Ej5fM();
    private static final int LinearStrokeCap = StrokeCap.INSTANCE.m4548getRoundKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.INSTANCE.m4548getRoundKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.INSTANCE.m4548getRoundKaPHkGw();
    private static final float LinearTrackStopIndicatorSize = ProgressIndicatorTokens.INSTANCE.m3484getStopSizeD9Ej5fM();
    private static final float LinearIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3481getActiveTrackSpaceD9Ej5fM();
    private static final float CircularIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3481getActiveTrackSpaceD9Ej5fM();
    ...
    public final long getCircularTrackColor(Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        return jM4222getTransparent0d7_KjU;
    }
    ...
    public final void m2374drawStopIndicatorEgI2THU(DrawScope drawScope, float stopSize, long color, int strokeCap) {
        float adjustedStopSize = Math.min(drawScope.mo367toPx0680j_4(stopSize), Size.m4011getHeightimpl(drawScope.mo4662getSizeNHjbRc()));
        float stopOffset = (Size.m4011getHeightimpl(drawScope.mo4662getSizeNHjbRc()) - adjustedStopSize) / 2.0f;
        if (StrokeCap.m4543equalsimpl0(strokeCap, StrokeCap.INSTANCE.m4548getRoundKaPHkGw())) {
            DrawScope.CC.m4734drawCircleVaOC9Bg$default(drawScope, color, adjustedStopSize / 2.0f, OffsetKt.Offset((Size.m4014getWidthimpl(drawScope.mo4662getSizeNHjbRc()) - (adjustedStopSize / 2.0f)) - stopOffset, Size.m4011getHeightimpl(drawScope.mo4662getSizeNHjbRc()) / 2.0f), 0.0f, null, null, 0, 120, null);
        } else {
            DrawScope.CC.m4747drawRectnJ9OG0$default(drawScope, color, OffsetKt.Offset((Size.m4014getWidthimpl(drawScope.mo4662getSizeNHjbRc()) - adjustedStopSize) - stopOffset, (Size.m4011getHeightimpl(drawScope.mo4662getSizeNHjbRc()) - adjustedStopSize) / 2.0f), SizeKt.Size(adjustedStopSize, adjustedStopSize), 0.0f, null, null, 0, 120, null);
        }
    }
}
