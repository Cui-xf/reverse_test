...
public final class NavigationRailItemColors {
    ...
    public final NavigationRailItemColors m2340copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2349iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
    ...
    public final long m2350textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationRailItemColors) && Color.m4188equalsimpl0(this.selectedIconColor, ((NavigationRailItemColors) other).selectedIconColor) && Color.m4188equalsimpl0(this.unselectedIconColor, ((NavigationRailItemColors) other).unselectedIconColor) && Color.m4188equalsimpl0(this.selectedTextColor, ((NavigationRailItemColors) other).selectedTextColor) && Color.m4188equalsimpl0(this.unselectedTextColor, ((NavigationRailItemColors) other).unselectedTextColor) && Color.m4188equalsimpl0(this.selectedIndicatorColor, ((NavigationRailItemColors) other).selectedIndicatorColor) && Color.m4188equalsimpl0(this.disabledIconColor, ((NavigationRailItemColors) other).disabledIconColor) && Color.m4188equalsimpl0(this.disabledTextColor, ((NavigationRailItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((result * 31) + Color.m4194hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m4194hashCodeimpl(this.selectedTextColor)) * 31) + Color.m4194hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m4194hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m4194hashCodeimpl(this.disabledIconColor)) * 31) + Color.m4194hashCodeimpl(this.disabledTextColor);
    }
}
