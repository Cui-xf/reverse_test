...
final class ListItemType implements Comparable<ListItemType> {
    ...
    public static final /* synthetic */ ListItemType m2222boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2224constructorimpl(int i) {
        return i;
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m2229compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m2223compareToyh95HIg(int arg0, int other) {
        return Intrinsics.compare(arg0, other);
    }

    /* renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m2229compareToyh95HIg(int other) {
        return m2223compareToyh95HIg(this.lines, other);
    }
    ...
    public static final class Companion {
        ...
        public final int m2234invokeZLSjz4$material3_release(boolean hasOverline, boolean hasSupporting, boolean isSupportingMultiline) {
