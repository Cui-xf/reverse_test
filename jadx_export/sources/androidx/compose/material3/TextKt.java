    ...
    public static final void m2711Text4IGK_g(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, int minLines, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty5 & 306783379) == 306783378 && (599187 & $dirty13) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i7 != 0) {
                    color2 = Color.INSTANCE.m4223getUnspecified0d7_KjU();
                }
                if (i8 != 0) {
                    fontSize2 = TextUnit.INSTANCE.m6901getUnspecifiedXSAIIZE();
                }
                if (i9 != 0) {
                    fontStyle2 = null;
                }
                ...
                long letterSpacing4 = $dirty4 != 0 ? TextUnit.INSTANCE.m6901getUnspecifiedXSAIIZE() : letterSpacing;
                TextDecoration textDecoration4 = i3 != 0 ? null : textDecoration;
                textAlign2 = i4 != 0 ? null : textAlign;
                long lineHeight4 = $dirty14 != 0 ? TextUnit.INSTANCE.m6901getUnspecifiedXSAIIZE() : lineHeight;
                overflow2 = i5 != 0 ? TextOverflow.INSTANCE.m6599getClipgIe3tQ8() : overflow;
                if (i15 != 0) {
                    softWrap2 = true;
                }
            ...
            if ($this$takeOrElse_u2dDxMtmZc$iv != 16) {
                ...
                long $this$takeOrElse_u2dDxMtmZc$iv2 = style2.m6176getColor0d7_KjU();
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != 16) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer3);
                    $this$takeOrElse_u2dDxMtmZc$iv2 = ((Color) objConsume2).m4197unboximpl();
                }
                $composer3.endReplaceGroup();
                textColor = $this$takeOrElse_u2dDxMtmZc$iv2;
            }
            $composer3.endReplaceGroup();
            BasicTextKt.m983BasicTextVhcvRP8(str, modifier2, TextStyle.m6166mergedA7vx0o$default(style2, textColor, fontSize3, fontWeight3, fontStyle3, null, fontFamily2, null, letterSpacing2, null, null, null, 0L, textDecoration2, null, null, textAlign2 != null ? textAlign2.getValue() : TextAlign.INSTANCE.m6556getUnspecifiede0LSkKk(), 0, lineHeight2, null, null, 0, 0, null, null, 16609104, null), (Function1<? super TextLayoutResult, Unit>) onTextLayout, overflow2, softWrap2, maxLines2, minLines2, (ColorProducer) null, $composer3, ($dirty2 & 14) | ($dirty2 & 112) | (($dirty13 >> 6) & 7168) | (($dirty13 << 9) & 57344) | (($dirty13 << 9) & 458752) | (($dirty13 << 9) & 3670016) | (29360128 & ($dirty13 << 9)), 256);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ void m2713TextfLXpl1I(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Function1 onTextLayout, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty4 & 306783379) == 306783378 && (74899 & $dirty13) == 74898 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                FontFamily fontFamily4 = i11 != 0 ? null : fontFamily;
                long letterSpacing5 = $dirty3 != 0 ? TextUnit.INSTANCE.m6901getUnspecifiedXSAIIZE() : letterSpacing;
                TextDecoration textDecoration4 = i3 != 0 ? null : textDecoration;
                TextAlign textAlign4 = i4 != 0 ? null : textAlign;
                long lineHeight3 = $dirty14 != 0 ? TextUnit.INSTANCE.m6901getUnspecifiedXSAIIZE() : lineHeight;
                int overflow4 = i5 != 0 ? TextOverflow.INSTANCE.m6599getClipgIe3tQ8() : overflow;
                if (i15 != 0) {
                    softWrap2 = true;
                }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$3
                ...
                public final void invoke(Composer composer, int i18) {
                    TextKt.m2713TextfLXpl1I(text, modifier4, color4, fontSize4, fontStyle4, fontWeight4, fontFamily3, letterSpacing4, textDecoration3, textAlign3, lineHeight2, overflow3, softWrap4, maxLines3, onTextLayout3, style3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void m2712TextIbK3jfQ(final AnnotatedString text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, int minLines, Map<String, InlineTextContent> map, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty5 & 306783379) == 306783378 && (4793491 & $dirty13) == 4793490 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                long lineHeight4 = i5 != 0 ? TextUnit.INSTANCE.m6901getUnspecifiedXSAIIZE() : lineHeight;
                int overflow5 = $dirty16 != 0 ? TextOverflow.INSTANCE.m6599getClipgIe3tQ8() : overflow;
                boolean softWrap4 = i15 != 0 ? true : softWrap;
                int maxLines3 = i16 != 0 ? Integer.MAX_VALUE : maxLines;
                int minLines5 = i17 != 0 ? 1 : minLines;
                Map inlineContent3 = i18 != 0 ? MapsKt.emptyMap() : map;
                Function1 onTextLayout3 = i19 != 0 ? new Function1<TextLayoutResult, Unit>() { // from class: androidx.compose.material3.TextKt$Text$4
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(TextLayoutResult textLayoutResult) {
                        invoke2(textLayoutResult);
                        return Unit.INSTANCE;
            ...
            if (textColor != 16) {
                ...
                long $this$takeOrElse_u2dDxMtmZc$iv = style2.m6176getColor0d7_KjU();
                if ($this$takeOrElse_u2dDxMtmZc$iv != 16) {
                    overflow3 = overflow2;
                } else {
                    ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
                    ...
                    Object objConsume2 = $composer3.consume(localContentColor);
                    ComposerKt.sourceInformationMarkerEnd($composer3);
                    $this$takeOrElse_u2dDxMtmZc$iv = ((Color) objConsume2).m4197unboximpl();
                }
                $composer3.endReplaceGroup();
                textColor = $this$takeOrElse_u2dDxMtmZc$iv;
            }
            ...
            BasicTextKt.m981BasicTextRWo7tUw(annotatedString, modifier2, TextStyle.m6166mergedA7vx0o$default(style2, textColor, fontSize3, fontWeight3, fontStyle3, null, fontFamily3, null, letterSpacing2, null, null, null, 0L, textDecoration2, null, null, textAlign3 != null ? textAlign3.getValue() : TextAlign.INSTANCE.m6556getUnspecifiede0LSkKk(), 0, lineHeight2, null, null, 0, 0, null, null, 16609104, null), onTextLayout4, overflow3, softWrap5, maxLines4, minLines6, inlineContent4, null, $composer3, (($dirty113 >> 9) & 7168) | ($dirty2 & 14) | ($dirty2 & 112) | (($dirty113 << 9) & 57344) | (($dirty113 << 9) & 458752) | (($dirty113 << 9) & 3670016) | (($dirty113 << 9) & 29360128) | (($dirty113 << 9) & 234881024), 512);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$5
                ...
                public final void invoke(Composer composer, int i22) {
                    TextKt.m2712TextIbK3jfQ(text, modifier3, color3, fontSize4, fontStyle2, fontWeight4, fontFamily4, letterSpacing3, textDecoration3, textAlign4, lineHeight3, overflow4, softWrap3, maxLines2, minLines4, inlineContent2, onTextLayout2, style3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$7
                ...
                public final void invoke(Composer composer, int i21) {
                    TextKt.m2710Text4IGK_g(text, modifier4, color4, fontSize4, fontStyle4, fontWeight4, fontFamily3, letterSpacing4, textDecoration3, textAlign3, lineHeight2, overflow3, softWrap4, maxLines3, inlineContent3, onTextLayout3, style3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
