...
public final /* data */ class ClockDialModifier extends ModifierNodeElement<ClockDialNode> {
    ...
    public static /* synthetic */ ClockDialModifier m1899copye8ubxrI$default(ClockDialModifier clockDialModifier, AnalogTimePickerState analogTimePickerState, boolean z, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return clockDialModifier.m1900copye8ubxrI(analogTimePickerState, z, i);
    }

    /* renamed from: copy-e8ubxrI, reason: not valid java name */
    public final ClockDialModifier m1900copye8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.state.hashCode() * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.autoSwitchToMinute)) * 31) + TimePickerSelectionMode.m2766hashCodeimpl(this.selection);
    }
    ...
    public void update(ClockDialNode node) {
        node.m1901updateNodee8ubxrI(this.state, this.autoSwitchToMinute, this.selection);
    }
