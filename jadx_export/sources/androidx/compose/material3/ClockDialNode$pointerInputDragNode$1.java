            ...
            case 0:
                ...
                Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputDragNode$1.1
                    ...
                    static final class C00971 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        C00971(ClockDialNode clockDialNode, Continuation<? super C00971> continuation) {
                            super(2, continuation);
                            this.this$0 = clockDialNode;
                        }
                            ...
                            switch (this.label) {
                                case 0:
                                    ...
                                    if (this.this$0.autoSwitchToMinute) {
                                        this.this$0.state.mo1779setSelection6_8s6DQ(TimePickerSelectionMode.INSTANCE.m2770getMinuteyecRtBI());
                                    }
                                    this.label = 1;
                    ...
                    public final void invoke2() {
                        BuildersKt__Builders_commonKt.launch$default(clockDialNode.getCoroutineScope(), null, null, new C00971(clockDialNode, null), 3, null);
                    }
                };
                ...
                if (DragGestureDetectorKt.detectDragGestures$default($this$SuspendingPointerInputModifierNode, null, function0, null, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputDragNode$1.2
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                        m1902invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                        return Unit.INSTANCE;
                    }
                    ...
                    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                case 0:
                                    ResultKt.throwOnFailure($result);
                                    this.this$0.offsetX += Offset.m3945getXimpl(this.$dragAmount);
                                    this.this$0.offsetY += Offset.m3946getYimpl(this.$dragAmount);
                                    this.label = 1;
                                    if (AnalogTimePickerState.rotateTo$default(this.this$0.state, TimePickerKt.atan(this.this$0.offsetY - IntOffset.m6826getYimpl(this.this$0.center), this.this$0.offsetX - IntOffset.m6825getXimpl(this.this$0.center)), false, this, 2, null) != coroutine_suspended) {
                                        break;
                                    } else {
                                        return coroutine_suspended;
                                    }
                    ...
                    public final void m1902invokeUv8p0NA(PointerInputChange pointerInputChange, long dragAmount) {
