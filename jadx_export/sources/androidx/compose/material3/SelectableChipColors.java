...
public final class SelectableChipColors {
    ...
    public static /* synthetic */ SelectableChipColors m2476copydaRQuJA$default(SelectableChipColors selectableChipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, int i, Object obj) {
        long j14;
        long j15;
        ...
        return selectableChipColors.m2478copydaRQuJA(j23, j17, j18, j19, j20, j21, j22, j24, j25, j26, j27, j14, j15);
    }

    /* renamed from: copy-daRQuJA, reason: not valid java name */
    public final SelectableChipColors m2478copydaRQuJA(long containerColor, long labelColor, long leadingIconColor, long trailingIconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor) {
    ...
    public final long m2477containerColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
    ...
    public final long m2479labelColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
    ...
    public final long m2480leadingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
    ...
    public final long m2481trailingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipColors) && Color.m4188equalsimpl0(this.containerColor, ((SelectableChipColors) other).containerColor) && Color.m4188equalsimpl0(this.labelColor, ((SelectableChipColors) other).labelColor) && Color.m4188equalsimpl0(this.leadingIconColor, ((SelectableChipColors) other).leadingIconColor) && Color.m4188equalsimpl0(this.trailingIconColor, ((SelectableChipColors) other).trailingIconColor) && Color.m4188equalsimpl0(this.disabledContainerColor, ((SelectableChipColors) other).disabledContainerColor) && Color.m4188equalsimpl0(this.disabledLabelColor, ((SelectableChipColors) other).disabledLabelColor) && Color.m4188equalsimpl0(this.disabledLeadingIconColor, ((SelectableChipColors) other).disabledLeadingIconColor) && Color.m4188equalsimpl0(this.disabledTrailingIconColor, ((SelectableChipColors) other).disabledTrailingIconColor) && Color.m4188equalsimpl0(this.selectedContainerColor, ((SelectableChipColors) other).selectedContainerColor) && Color.m4188equalsimpl0(this.disabledSelectedContainerColor, ((SelectableChipColors) other).disabledSelectedContainerColor) && Color.m4188equalsimpl0(this.selectedLabelColor, ((SelectableChipColors) other).selectedLabelColor) && Color.m4188equalsimpl0(this.selectedLeadingIconColor, ((SelectableChipColors) other).selectedLeadingIconColor) && Color.m4188equalsimpl0(this.selectedTrailingIconColor, ((SelectableChipColors) other).selectedTrailingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((((((((result * 31) + Color.m4194hashCodeimpl(this.labelColor)) * 31) + Color.m4194hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4194hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4194hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4194hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4194hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4194hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4194hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m4194hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m4194hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m4194hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m4194hashCodeimpl(this.selectedTrailingIconColor);
    }
}
