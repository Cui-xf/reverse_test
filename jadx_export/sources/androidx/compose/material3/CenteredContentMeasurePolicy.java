...
final class CenteredContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        int width2;
        int width3 = Constraints.m6636getMaxWidthimpl(constraints);
        int itemHeight = Constraints.m6637getMinHeightimpl(constraints);
        int itemsCount = list.size();
        if (itemsCount < 1) {
            return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width3, itemHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.CenteredContentMeasurePolicy$measure$1
        ...
        if (Constraints.m6632getHasBoundedWidthimpl(constraints)) {
            ...
            while (index$iv < size) {
                ...
                if (itemHeight >= measurableHeight) {
                    ...
                    width2 = width3;
                    itemHeight = RangesKt.coerceAtMost(measurableHeight, Constraints.m6635getMaxHeightimpl(constraints));
                }
                index$iv++;
                width3 = width2;
            }
            ...
            while (index$iv$iv < size2) {
                ...
                int $i$f$fastMap3 = Constraints.m6637getMinHeightimpl(constraints);
                ...
                arrayList.add(it.mo5535measureBRTryo0(ConstraintsKt.m6651constrainN9IONVI(constraints, Constraints.INSTANCE.m6646fixedJhjzzOo(currentItemWidth, itemHeight))));
                index$iv$iv++;
            ...
            while (index$iv$iv2 < size3) {
                ...
                itemsPlaceables4.add(((Measurable) item$iv$iv2).mo5535measureBRTryo0(ConstraintsKt.m6651constrainN9IONVI(constraints, Constraints.INSTANCE.m6647fixedHeightOenEA2s(itemHeight))));
                index$iv$iv2++;
        ...
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, itemHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.CenteredContentMeasurePolicy$measure$5
