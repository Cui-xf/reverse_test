...
public final class RadioButtonKt {
    ...
    private static final float RadioButtonRippleRadius = Dp.m6693constructorimpl(24);
    private static final float RadioButtonPadding = Dp.m6693constructorimpl(2);
    private static final float RadioButtonSize = Dp.m6693constructorimpl(20);
    ...
    public static final void RadioButton(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, RadioButtonColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((74899 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    RadioButtonColors colors5 = RadioButtonDefaults.INSTANCE.m1638colorsRGew2ao(0L, 0L, 0L, $composer2, 3072, 7);
                    $composer2 = $composer2;
                    modifier3 = modifier5;
                    enabled2 = enabled3;
            ...
            if (function0 != null) {
                ...
                i2 = 2;
                $dirty2 = $dirty;
                selectableModifier = SelectableKt.m939selectableO2vRcR0(Modifier.INSTANCE, selected, interactionSource2, RippleKt.m1646rippleOrFallbackImplementation9IZ8Weo(false, RadioButtonRippleRadius, 0L, $composer2, 54, 4), enabled2, Role.m5949boximpl(Role.INSTANCE.m5960getRadioButtono7Vup1c()), function0);
            ...
            Modifier modifierM718requiredSize3ABfNKs = SizeKt.m718requiredSize3ABfNKs(PaddingKt.m681padding3ABfNKs(SizeKt.wrapContentSize$default(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(selectableModifier), Alignment.INSTANCE.getCenter(), z2, i2, obj), RadioButtonPadding), RadioButtonSize);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.RadioButtonKt$RadioButton$1$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        ...
                        DrawScope.CC.m4734drawCircleVaOC9Bg$default($this$Canvas, radioColor.getValue().m4197unboximpl(), $this$Canvas.mo367toPx0680j_4(RadioButtonKt.RadioRadius) - (strokeWidth / 2.0f), 0L, 0.0f, new Stroke(strokeWidth, 0.0f, 0, 0, null, 30, null), null, 0, 108, null);
                        if (Dp.m6692compareTo0680j_4(dotRadius3.getValue().m6707unboximpl(), Dp.m6693constructorimpl(0)) > 0) {
                            DrawScope.CC.m4734drawCircleVaOC9Bg$default($this$Canvas, radioColor.getValue().m4197unboximpl(), $this$Canvas.mo367toPx0680j_4(dotRadius3.getValue().m6707unboximpl()) - (strokeWidth / 2.0f), 0L, 0.0f, Fill.INSTANCE, null, 0, 108, null);
                        }
                    }
                };
    ...
    static {
        ...
        RadioRadius = Dp.m6693constructorimpl(arg0$iv / 2);
        RadioButtonDotSize = Dp.m6693constructorimpl(12);
        RadioStrokeWidth = Dp.m6693constructorimpl(2);
    }
}
