...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo278createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        Path.CC.addRect$default(boundingRectangle, new Rect(0.0f, 0.0f, Size.m4014getWidthimpl(size), Size.m4011getHeightimpl(size)), null, 2, null);
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.mo4079opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.INSTANCE.m4486getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        float cutoutOffset = density.mo367toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        ...
        float cutoutEndX = cutoutStartX + Size.m4014getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m4011getHeightimpl(cutoutSize) / 2.0f;
        float cutoutStartY = -cutoutRadius;
        OutlineKt.addOutline($this$addCutoutShape, this.cutoutShape.mo278createOutlinePq9zytI(cutoutSize, layoutDirection, density));
        $this$addCutoutShape.mo4082translatek4lQ0M(OffsetKt.Offset(cutoutStartX, cutoutStartY));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            float edgeRadius = density.mo367toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius);
