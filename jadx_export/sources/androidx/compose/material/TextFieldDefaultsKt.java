...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m1726animateBorderStrokeAsStateNuRrP5Q(boolean enabled, boolean isError, InteractionSource interactionSource, TextFieldColors colors, float focusedBorderThickness, float unfocusedBorderThickness, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            animatedThickness = AnimateAsStateKt.m122animateDpAsStateAjpBEmI(targetThickness, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, $composer, 48, 12);
            $composer.endReplaceGroup();
        } else {
            $composer.startReplaceGroup(772737540);
            ComposerKt.sourceInformation($composer, "989@43310L46");
            animatedThickness = SnapshotStateKt.rememberUpdatedState(Dp.m6691boximpl(unfocusedBorderThickness), $composer, ($changed >> 15) & 14);
            $composer.endReplaceGroup();
        }
        State<BorderStroke> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(new BorderStroke(animatedThickness.getValue().m6707unboximpl(), new SolidColor(indicatorColor.getValue().m4197unboximpl(), null), null), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
