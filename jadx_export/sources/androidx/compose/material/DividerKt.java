...
public final class DividerKt {
    ...
    public static final void m1538DivideroMI9zvI(Modifier modifier, long color, float thickness, float startIndent, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float thickness2;
        float startIndent2;
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            long color4 = color2;
            BoxKt.Box(BackgroundKt.m230backgroundbw27NRU$default(SizeKt.m712height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3.then(indentMod), 0.0f, 1, null), targetThickness), color4, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
                ...
                public final void invoke(Composer composer, int i6) {
                    DividerKt.m1538DivideroMI9zvI(modifier4, color3, thickness3, startIndent3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
