    ...
    public static final void m1707TabRowpAZo6Ak(final int selectedTabIndex, Modifier modifier, long backgroundColor, long contentColor, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 599187) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i6 != 0) {
                    indicator = ComposableLambdaKt.rememberComposableLambda(-553782708, true, new Function3<List<? extends TabPosition>, Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$1
                        ...
                        public final void invoke(List<TabPosition> list, Composer $composer4, int $changed2) {
                            ...
                            TabRowDefaults.INSTANCE.m1701Indicator9IZ8Weo(TabRowDefaults.INSTANCE.tabIndicatorOffset(Modifier.INSTANCE, list.get(selectedTabIndex)), 0.0f, 0L, $composer4, 3072, 6);
                            if (ComposerKt.isTraceInProgress()) {
                ...
                if (i7 != 0) {
                    divider = ComposableSingletons$TabRowKt.INSTANCE.m1533getLambda1$material_release();
            ...
            $composer2 = $composer3;
            SurfaceKt.m1676SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, backgroundColor3, contentColor3, null, 0.0f, ComposableLambdaKt.rememberComposableLambda(-1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    ...
                    if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                        value$iv = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                return m1709invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                            }

                            /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m1709invoke0kLqBqw(final SubcomposeMeasureScope $this$SubcomposeLayout, final long constraints) {
                                Object maxElem$iv;
                                ...
                                while (index$iv$iv < size) {
                                    ...
                                    long jM6626copyZbe2FdA = Constraints.m6626copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(constraints) : index$iv$iv3, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(constraints) : tabWidth, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(constraints) : 0);
                                    tabWidth = index$iv$iv3;
                                    target$iv.add(it.mo5535measureBRTryo0(jM6626copyZbe2FdA));
                                ...
                                for (int i9 = 0; i9 < tabCount; i9++) {
                                    int index = i9;
                                    float arg0$iv = $this$SubcomposeLayout.mo364toDpu2uoSUM(tabWidth);
                                    arrayList.add(new TabPosition(Dp.m6693constructorimpl(index * arg0$iv), $this$SubcomposeLayout.mo364toDpu2uoSUM(tabWidth), null));
                                }
                                ...
                                return MeasureScope.CC.layout$default($this$SubcomposeLayout, tabRowWidth2, tabRowHeight2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    /* JADX WARN: Multi-variable type inference failed */
                                    {
                                        super(1);
                                    ...
                                    public final void invoke2(Placeable.PlacementScope $this$layout) {
                                        ...
                                        for (int index$iv2 = 0; index$iv2 < size3; index$iv2++) {
                                            ...
                                            Placeable placeable2 = it4.mo5535measureBRTryo0(Constraints.m6626copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(j) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(j) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(j) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(j) : 0));
                                        ...
                                        for (int index$iv3 = 0; index$iv3 < size4; index$iv3++) {
                                            ...
                                            Placeable.PlacementScope.placeRelative$default($this$layout, it5.mo5535measureBRTryo0(Constraints.INSTANCE.m6646fixedJhjzzOo(i12, i13)), 0, 0, 0.0f, 4, null);
                                        }
                                    }
                                }, 4, null);
                            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
                ...
                public final void invoke(Composer composer, int i8) {
                    TabRowKt.m1707TabRowpAZo6Ak(selectedTabIndex, modifier3, backgroundColor4, contentColor4, indicator3, divider2, function22, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1706ScrollableTabRowsKfQg0A(final int selectedTabIndex, Modifier modifier, long backgroundColor, long contentColor, float edgePadding, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 4793491) == 4793490 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    contentColor2 = ColorsKt.m1512contentColorForek8zF_U(backgroundColor2, $composer3, ($dirty2 >> 6) & 14);
                    $dirty2 &= -7169;
                }
                if (i7 != 0) {
                    edgePadding2 = TabRowDefaults.INSTANCE.m1704getScrollableTabRowPaddingD9Ej5fM();
                }
                if (i8 != 0) {
            ...
            $composer2 = $composer3;
            SurfaceKt.m1676SurfaceFjzlyU(modifier3, null, backgroundColor3, contentColor3, null, 0.0f, ComposableLambdaKt.rememberComposableLambda(1455860572, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                            value$iv2 = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2$1$1
                                ...
                                @Override // kotlin.jvm.functions.Function2
                                public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                    return m1708invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                                }

                                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                                public final MeasureResult m1708invoke0kLqBqw(final SubcomposeMeasureScope $this$SubcomposeLayout, final long constraints) {
                                    ...
                                    long tabConstraints = Constraints.m6626copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(constraints) : minTabWidth, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(constraints) : 0);
                                    ...
                                    while (index$iv$iv < size) {
                                        ...
                                        target$iv.add(((Measurable) item$iv$iv).mo5535measureBRTryo0(tabConstraints));
                                        index$iv$iv++;
                                        $this$fastMap$iv = $this$fastMap$iv;
                                        padding = padding;
                                    }
                                    ...
                                    final int i14 = i11;
                                    final Function3<List<TabPosition>, Composer, Integer, Unit> function33 = function32;
                                    return MeasureScope.CC.layout$default($this$SubcomposeLayout, i12, i13, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$2$1$1.2
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(1);
                                        ...
                                        public final void invoke2(Placeable.PlacementScope $this$layout) {
                                            ...
                                            for (int index$iv2 = 0; index$iv2 < size3; index$iv2++) {
                                                ...
                                                tabPositions.add(new TabPosition(subcomposeMeasureScope.mo364toDpu2uoSUM(left2), subcomposeMeasureScope.mo364toDpu2uoSUM(it2.getWidth()), null));
                                                left2 += it2.getWidth();
                                            }
                                            ...
                                            for (int index$iv3 = 0; index$iv3 < size4; index$iv3++) {
                                                ...
                                                Placeable placeable = it3.mo5535measureBRTryo0(Constraints.m6626copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(j) : intRef.element, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(j) : intRef.element, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(j) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(j) : 0));
                                            ...
                                            for (int index$iv4 = 0; index$iv4 < size5; index$iv4++) {
                                                ...
                                                Placeable.PlacementScope.placeRelative$default($this$layout, it4.mo5535measureBRTryo0(Constraints.INSTANCE.m6646fixedJhjzzOo(intRef3.element, intRef4.element)), 0, 0, 0.0f, 4, null);
                                            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$ScrollableTabRow$3
                ...
                public final void invoke(Composer composer, int i11) {
                    TabRowKt.m1706ScrollableTabRowsKfQg0A(selectedTabIndex, modifier4, backgroundColor4, contentColor4, edgePadding4, indicator3, divider2, function22, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
