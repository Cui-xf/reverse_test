...
public final class RippleHostView extends View {
    ...
    public final void m1761addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        m1762setRippleProperties07v42R4(size, color, alpha);
        if (bounded) {
            ripple.setHotspot(Offset.m3945getXimpl(interaction.getPressPosition()), Offset.m3946getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m1762setRippleProperties07v42R4(long size, long color, float alpha) {
        UnprojectedRipple ripple = this.ripple;
        if (ripple == null) {
            return;
        }
        ripple.m1773setColorDxMtmZc(color, alpha);
        Rect newBounds = new Rect(0, 0, MathKt.roundToInt(Size.m4014getWidthimpl(size)), MathKt.roundToInt(Size.m4011getHeightimpl(size)));
