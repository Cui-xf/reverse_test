...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void drawRipples(DrawScope $this$drawRipples) {
        ...
        if ($this$drawRipples_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawRipples_u24lambda_u241_u24lambda_u240.m1762setRippleProperties07v42R4(getRippleSize(), m1766getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
    ...
    public void mo1755addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        $this$addRipple_12SF9DM_u24lambda_u243_u24lambda_u242.m1761addRippleKOepWvA(interaction, getBounded(), size, MathKt.roundToInt(targetRadius), m1766getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0<Unit>() { // from class: androidx.compose.material.ripple.AndroidRippleNode$addRipple$1$1$1
            {
                super(0);
            }
