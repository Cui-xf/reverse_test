...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        int iRoundToInt;
        this.rippleSize = $this$drawIndication.mo4662getSizeNHjbRc();
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            iRoundToInt = MathKt.roundToInt(RippleAnimationKt.m1759getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo4662getSizeNHjbRc()));
        } else {
            iRoundToInt = $this$drawIndication.mo361roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = iRoundToInt;
        long color = this.color.getValue().m4197unboximpl();
        float alpha = this.rippleAlpha.getValue().getPressedAlpha();
        $this$drawIndication.drawContent();
        m1763drawStateLayerH2RKhps($this$drawIndication, this.radius, color);
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m1762setRippleProperties07v42R4($this$drawIndication.mo4662getSizeNHjbRc(), color, alpha);
            $this$drawIndication_u24lambda_u241_u24lambda_u240.draw(AndroidCanvas_androidKt.getNativeCanvas(canvas));
        }
    }

    @Override // androidx.compose.material.ripple.RippleIndicationInstance
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        $this$addRipple_u24lambda_u243_u24lambda_u242.m1761addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m4197unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
