...
public final class RippleKt {
    ...
    public static final DelegatableNode m1764createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean bounded, float radius, ColorProducer color, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m1770createPlatformRippleNodeTDGSqEk(interactionSource, bounded, radius, color, function0);
    }
    ...
    public static final Indication m1765rememberRipple9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        if ((i & 2) != 0) {
            radius = Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM();
        }
        if ((i & 4) != 0) {
            color = Color.INSTANCE.m4223getUnspecified0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1635163520, $changed, -1, "androidx.compose.material.ripple.rememberRipple (Ripple.kt:146)");
        }
        State colorState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(color), $composer, ($changed >> 6) & 14);
