...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1517defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1769defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1769defaultRippleColor5vOe2sY(Color.INSTANCE.m4213getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return jM1769defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha rippleAlphaM1768defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1768defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4213getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return rippleAlphaM1768defaultRippleAlphaDxMtmZc;
    }
}
