...
public final class CallKt {
    ...
    public static final ImageVector getCall(Icons.Sharp $this$Call) {
        ...
        _call = ImageVector.Builder.m4883addPathoIyEayM$default($this$_get_Call__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
