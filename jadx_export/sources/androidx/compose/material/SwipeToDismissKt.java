...
public final class SwipeToDismissKt {
    private static final float DISMISS_THRESHOLD = Dp.m6693constructorimpl(56);
    ...
    public static final DismissState rememberDismissState(final DismissValue initialValue, final Function1<? super DismissValue, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        DismissState dismissState = (DismissState) RememberSaveableKt.m3772rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ...
            BoxWithConstraintsKt.BoxWithConstraints(modifier5, null, false, ComposableLambdaKt.rememberComposableLambda(338007641, true, new Function3<BoxWithConstraintsScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.SwipeToDismissKt.SwipeToDismiss.2
                ...
                */
                public final void invoke(androidx.compose.foundation.layout.BoxWithConstraintsScope r62, androidx.compose.runtime.Composer r63, int r64) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeToDismissKt.AnonymousClass2.invoke(androidx.compose.foundation.layout.BoxWithConstraintsScope, androidx.compose.runtime.Composer, int):void");
                }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SwipeToDismissKt.SwipeToDismiss.3
                ...
                public final void invoke(Composer composer, int i5) {
                    SwipeToDismissKt.SwipeToDismiss(state, modifier3, directions, dismissThresholds, function3, function32, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
