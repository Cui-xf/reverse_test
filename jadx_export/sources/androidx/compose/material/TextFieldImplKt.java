...
public final class TextFieldImplKt {
        ...
        if (($dirty & 306783379) != 306783378 || (74899 & $dirty1) != 74898 || !$composer3.getSkipping()) {
            ...
            Function3 labelColor = new Function3<InputPhase, Composer, Integer, Color>() { // from class: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$labelColor$1
                ...
                public /* bridge */ /* synthetic */ Color invoke(InputPhase inputPhase, Composer composer, Integer num) {
                    return Color.m4177boximpl(m1730invokeXeAY9LY(inputPhase, composer, num.intValue()));
                }

                /* renamed from: invoke-XeAY9LY, reason: not valid java name */
                public final long m1730invokeXeAY9LY(InputPhase it, Composer $composer4, int $changed2) {
                    ...
                    long jM4197unboximpl = colors.labelColor(enabled, it == InputPhase.UnfocusedEmpty ? false : isError, interactionSource, $composer4, 0).getValue().m4197unboximpl();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    $composer4.endReplaceGroup();
                    return jM4197unboximpl;
                }
            };
            ...
            final boolean shouldOverrideTextStyleColor = (Color.m4188equalsimpl0(subtitle1.m6176getColor0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU()) && !Color.m4188equalsimpl0(caption.m6176getColor0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU())) || (!Color.m4188equalsimpl0(subtitle1.m6176getColor0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU()) && Color.m4188equalsimpl0(caption.m6176getColor0d7_KjU(), Color.INSTANCE.m4223getUnspecified0d7_KjU()));
            ...
            long $this$CommonDecorationBox_u24lambda_u242 = MaterialTheme.INSTANCE.getTypography($composer3, 6).getCaption().m6176getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if (($this$takeOrElse_u2dDxMtmZc$iv != 16 ? 1 : 0) != 0) {
                    ...
                    textFieldTransitionScope = textFieldTransitionScope2;
                    inputState2 = inputState3;
                    $this$takeOrElse_u2dDxMtmZc$iv = labelColor.invoke(inputState2, $composer3, 0).m4197unboximpl();
                }
            ...
            long $this$CommonDecorationBox_u24lambda_u244 = MaterialTheme.INSTANCE.getTypography($composer3, 6).getSubtitle1().m6176getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if (($this$takeOrElse_u2dDxMtmZc$iv2 != 16 ? 1 : 0) == 0) {
                    $this$takeOrElse_u2dDxMtmZc$iv2 = labelColor.invoke(inputState2, $composer3, 0).m4197unboximpl();
                }
                $composer3.endReplaceGroup();
            ...
            textFieldTransitionScope.m1735TransitionDTcfvLk(inputState2, $this$takeOrElse_u2dDxMtmZc$iv, j, labelColor, function22 != null, ComposableLambdaKt.rememberComposableLambda(225557475, true, new Function6<Float, Color, Color, Float, Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt.CommonDecorationBox.3
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Float f, Color color, Color color2, Float f2, Composer composer, Integer num) {
                    m1728invokeRIQooxk(f.floatValue(), color.m4197unboximpl(), color2.m4197unboximpl(), f2.floatValue(), composer, num.intValue());
                ...
                */
                public final void m1728invokeRIQooxk(float r36, long r37, final long r39, final float r41, androidx.compose.runtime.Composer r42, int r43) {
                    /*
                        Method dump skipped, instructions count: 770
                        To view this dump change 'Code comments level' option to 'DEBUG'
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TextFieldImplKt.AnonymousClass3.m1728invokeRIQooxk(float, long, long, float, androidx.compose.runtime.Composer, int):void");
                }
    ...
    public static final void m1727DecorationeuL9pac(final long contentColor, TextStyle typography, Float contentAlpha, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
            ...
            Function2 colorAndEmphasis = ComposableLambdaKt.rememberComposableLambda(494684590, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$Decoration$colorAndEmphasis$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        ...
                        ProvidedValue<Color> providedValueProvides = ContentColorKt.getLocalContentColor().provides(Color.m4177boximpl(contentColor));
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 3) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    if (f != null) {
                                        ...
                                        CompositionLocalKt.CompositionLocalProvider(ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m4189getAlphaimpl(j))), function22, $composer4, ProvidedValue.$stable);
                                        $composer4.endReplaceGroup();
                                    }
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$Decoration$1
                ...
                public final void invoke(Composer composer, int i4) {
                    TextFieldImplKt.m1727DecorationeuL9pac(contentColor, typography2, contentAlpha3, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
