...
public final class CompatRippleTheme implements RippleTheme {
    ...
    public long mo1517defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1641rippleColor5vOe2sY = rippleDefaults.m1641rippleColor5vOe2sY(((Color) objConsume).m4197unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return jM1641rippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        Object objConsume = $composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd($composer);
        RippleAlpha rippleAlphaM1640rippleAlphaDxMtmZc = rippleDefaults.m1640rippleAlphaDxMtmZc(((Color) objConsume).m4197unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return rippleAlphaM1640rippleAlphaDxMtmZc;
    }
}
