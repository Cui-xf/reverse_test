...
final class FloatingActionButtonElevationAnimatable {
    ...
    static final class C03961 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    private FloatingActionButtonElevationAnimatable(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation) {
        ...
        this.animatable = new Animatable<>(Dp.m6691boximpl(this.defaultElevation), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
    }

    /* renamed from: calculateTarget-u2uoSUM, reason: not valid java name */
    private final float m1581calculateTargetu2uoSUM(Interaction $this$calculateTarget_u2du2uoSUM) {
    ...
    public final Object m1582updateElevationlDy3nrA(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Continuation<? super Unit> continuation) throws Throwable {
        this.defaultElevation = defaultElevation;
        this.pressedElevation = pressedElevation;
        this.hoveredElevation = hoveredElevation;
        this.focusedElevation = focusedElevation;
    ...
    */
    public final java.lang.Object snapElevation(kotlin.coroutines.Continuation<? super kotlin.Unit> r9) throws java.lang.Throwable {
        /*
            r8 = this;
            boolean r0 = r9 instanceof androidx.compose.material.FloatingActionButtonElevationAnimatable.C03961
            if (r0 == 0) goto L14
            r0 = r9
            androidx.compose.material.FloatingActionButtonElevationAnimatable$snapElevation$1 r0 = (androidx.compose.material.FloatingActionButtonElevationAnimatable.C03961) r0
            int r1 = r0.label
        ...
        L36:
            ...
            float r3 = r2.m1581calculateTargetu2uoSUM(r3)
            ...
            float r4 = r4.m6707unboximpl()
            boolean r4 = androidx.compose.ui.unit.Dp.m6698equalsimpl0(r4, r3)
            if (r4 != 0) goto L74
        L53:
            ...
            androidx.compose.ui.unit.Dp r5 = androidx.compose.ui.unit.Dp.m6691boximpl(r3)     // Catch: java.lang.Throwable -> L6b
    ...
    */
    public final java.lang.Object animateElevation(androidx.compose.foundation.interaction.Interaction r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) throws java.lang.Throwable {
        ...
        L3a:
            ...
            r2 = r8
            float r3 = r2.m1581calculateTargetu2uoSUM(r9)
            r2.targetInteraction = r9
            androidx.compose.animation.core.Animatable<androidx.compose.ui.unit.Dp, androidx.compose.animation.core.AnimationVector1D> r4 = r2.animatable     // Catch: java.lang.Throwable -> L73
            java.lang.Object r4 = r4.getTargetValue()     // Catch: java.lang.Throwable -> L73
            androidx.compose.ui.unit.Dp r4 = (androidx.compose.ui.unit.Dp) r4     // Catch: java.lang.Throwable -> L73
            float r4 = r4.m6707unboximpl()     // Catch: java.lang.Throwable -> L73
            boolean r4 = androidx.compose.ui.unit.Dp.m6698equalsimpl0(r4, r3)     // Catch: java.lang.Throwable -> L73
            if (r4 != 0) goto L6d
            androidx.compose.animation.core.Animatable<androidx.compose.ui.unit.Dp, androidx.compose.animation.core.AnimationVector1D> r4 = r2.animatable     // Catch: java.lang.Throwable -> L73
            androidx.compose.foundation.interaction.Interaction r5 = r2.lastTargetInteraction     // Catch: java.lang.Throwable -> L73
            r0.L$0 = r2     // Catch: java.lang.Throwable -> L73
            r0.L$1 = r9     // Catch: java.lang.Throwable -> L73
            r6 = 1
            r0.label = r6     // Catch: java.lang.Throwable -> L73
            java.lang.Object r3 = androidx.compose.material.ElevationKt.m1559animateElevationrAjV9yQ(r4, r3, r5, r9, r0)     // Catch: java.lang.Throwable -> L73
            if (r3 != r1) goto L6b
            return r1
        L6b:
            r1 = r2
