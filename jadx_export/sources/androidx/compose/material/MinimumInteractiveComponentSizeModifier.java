...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo60measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        final int width = Math.max(placeable.getWidth(), $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(DpSize.m6791getWidthD9Ej5fM(this.size)));
        final int height = Math.max(placeable.getHeight(), $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(DpSize.m6789getHeightD9Ej5fM(this.size)));
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumInteractiveComponentSizeModifier$measure$1
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m6788equalsimpl0(this.size, otherModifier.size);
    }

    public int hashCode() {
        return DpSize.m6793hashCodeimpl(this.size);
    }
}
