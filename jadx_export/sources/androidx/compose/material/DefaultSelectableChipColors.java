...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(target), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4188equalsimpl0(this.backgroundColor, ((DefaultSelectableChipColors) other).backgroundColor) && Color.m4188equalsimpl0(this.contentColor, ((DefaultSelectableChipColors) other).contentColor) && Color.m4188equalsimpl0(this.leadingIconColor, ((DefaultSelectableChipColors) other).leadingIconColor) && Color.m4188equalsimpl0(this.disabledBackgroundColor, ((DefaultSelectableChipColors) other).disabledBackgroundColor) && Color.m4188equalsimpl0(this.disabledContentColor, ((DefaultSelectableChipColors) other).disabledContentColor) && Color.m4188equalsimpl0(this.disabledLeadingIconColor, ((DefaultSelectableChipColors) other).disabledLeadingIconColor) && Color.m4188equalsimpl0(this.selectedBackgroundColor, ((DefaultSelectableChipColors) other).selectedBackgroundColor) && Color.m4188equalsimpl0(this.selectedContentColor, ((DefaultSelectableChipColors) other).selectedContentColor) && Color.m4188equalsimpl0(this.selectedLeadingIconColor, ((DefaultSelectableChipColors) other).selectedLeadingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4194hashCodeimpl(this.backgroundColor);
        return (((((((((((((((result * 31) + Color.m4194hashCodeimpl(this.contentColor)) * 31) + Color.m4194hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4194hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4194hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4194hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4194hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m4194hashCodeimpl(this.selectedContentColor)) * 31) + Color.m4194hashCodeimpl(this.selectedLeadingIconColor);
    }
}
