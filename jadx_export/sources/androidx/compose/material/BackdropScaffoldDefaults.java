...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m6693constructorimpl(56);
    private static final float HeaderHeight = Dp.m6693constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m6693constructorimpl(1);
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape cornerBasedShapeCopy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m963CornerSize0680j_4(Dp.m6693constructorimpl(16)), CornerSizeKt.m963CornerSize0680j_4(Dp.m6693constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        long jM4185copywmQWz5c = Color.m4185copywmQWz5c(jM1498getSurface0d7_KjU, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jM1498getSurface0d7_KjU) : 0.6f, (14 & 2) != 0 ? Color.m4193getRedimpl(jM1498getSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jM1498getSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jM1498getSurface0d7_KjU) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
