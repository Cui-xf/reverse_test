...
public final class CheckboxKt {
    ...
    private static final float CheckboxRippleRadius = Dp.m6693constructorimpl(24);
    private static final float CheckboxDefaultPadding = Dp.m6693constructorimpl(2);
    private static final float CheckboxSize = Dp.m6693constructorimpl(20);
    private static final float StrokeWidth = Dp.m6693constructorimpl(2);
    private static final float RadiusSize = Dp.m6693constructorimpl(2);
    ...
    public static final void Checkbox(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((74899 & $dirty) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    CheckboxColors colors4 = CheckboxDefaults.INSTANCE.m1472colorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $composer2 = $composer2;
                    $dirty &= -458753;
                    modifier3 = modifier5;
                    enabled2 = enabled4;
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((74899 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (function0 != null) {
                ...
                toggleableModifier = ToggleableKt.m948triStateToggleableO2vRcR0(Modifier.INSTANCE, toggleableState, interactionSource2, RippleKt.m1646rippleOrFallbackImplementation9IZ8Weo(false, CheckboxRippleRadius, 0L, $composer2, 54, 4), enabled5, Role.m5949boximpl(Role.INSTANCE.m5957getCheckboxo7Vup1c()), function0);
                interactionSource3 = interactionSource2;
                enabled2 = enabled5;
                $composer2.endReplaceGroup();
            } else {
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m681padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors5, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 6) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            colors3 = colors5;
    ...
    */
    ...
    public static final void m1475drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
        float halfStrokeWidth = strokeWidth / 2.0f;
        Stroke stroke = new Stroke(strokeWidth, 0.0f, 0, 0, null, 30, null);
        float checkboxSize = Size.m4014getWidthimpl($this$drawBox_u2d1wkBAMs.mo4662getSizeNHjbRc());
        if (Color.m4188equalsimpl0(boxColor, borderColor)) {
            DrawScope.CC.m4749drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, 0L, SizeKt.Size(checkboxSize, checkboxSize), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
        } else {
            DrawScope.CC.m4749drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, OffsetKt.Offset(strokeWidth, strokeWidth), SizeKt.Size(checkboxSize - (strokeWidth * 2.0f), checkboxSize - (strokeWidth * 2.0f)), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, radius - strokeWidth), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
            DrawScope.CC.m4749drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, borderColor, OffsetKt.Offset(halfStrokeWidth, halfStrokeWidth), SizeKt.Size(checkboxSize - strokeWidth, checkboxSize - strokeWidth), CornerRadiusKt.CornerRadius$default(radius - halfStrokeWidth, 0.0f, 2, null), stroke, 0.0f, null, 0, 224, null);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawCheck-3IgeMak, reason: not valid java name */
    public static final void m1476drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
        Stroke stroke = new Stroke(strokeWidthPx, 0.0f, StrokeCap.INSTANCE.m4549getSquareKaPHkGw(), 0, null, 26, null);
        float width = Size.m4014getWidthimpl($this$drawCheck_u2d3IgeMak.mo4662getSizeNHjbRc());
        ...
        DrawScope.CC.m4743drawPathLG529CI$default($this$drawCheck_u2d3IgeMak, drawingCache.getPathToDraw(), checkColor, 0.0f, stroke, null, 0, 52, null);
    }
}
