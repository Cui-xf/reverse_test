            ...
            SharedTransitionScope(ComposableLambdaKt.rememberComposableLambda(-130587847, true, new Function4<SharedTransitionScope, Modifier, Composer, Integer, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeKt.SharedTransitionLayout.1
                ...
                */
                public final void invoke(androidx.compose.animation.SharedTransitionScope r28, androidx.compose.ui.Modifier r29, androidx.compose.runtime.Composer r30, int r31) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.SharedTransitionScopeKt.AnonymousClass1.invoke(androidx.compose.animation.SharedTransitionScope, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int):void");
                }
                    ...
                    if (it$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv2 = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.SharedTransitionScopeKt$SharedTransitionScope$1$1$1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                                return m105invoke3p2s80s(measureScope, measurable, constraints.getValue());
                            }

                            /* renamed from: invoke-3p2s80s, reason: not valid java name */
                            public final MeasureResult m105invoke3p2s80s(final MeasureScope $this$layout, Measurable measurable, long constraints) {
                                final Placeable p = measurable.mo5535measureBRTryo0(constraints);
                                int width = p.getWidth();
                                int height = p.getHeight();
                                final SharedTransitionScopeImpl sharedTransitionScopeImpl = sharedScope;
                                return MeasureScope.CC.layout$default($this$layout, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeKt$SharedTransitionScope$1$1$1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(1);
                                    }
                                    ...
                                    public final void invoke2(Placeable.PlacementScope $this$layout2) {
                                        ...
                                        if (coords != null) {
                                            boolean zIsLookingAhead = $this$layout.isLookingAhead();
