...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        long jM168constructorimpl$default;
        if ((i2 & 4) == 0) {
        ...
        if ((i2 & 8) == 0) {
            jM168constructorimpl$default = j;
        } else {
            jM168constructorimpl$default = StartOffset.m168constructorimpl$default(0, 0, 2, null);
        }
        this(i, durationBasedAnimationSpec, repeatMode2, jM168constructorimpl$default, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ RepeatableSpec(int iterations, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(iterations, animation, repeatMode, StartOffset.m168constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof RepeatableSpec) && ((RepeatableSpec) other).iterations == this.iterations && Intrinsics.areEqual(((RepeatableSpec) other).animation, this.animation) && ((RepeatableSpec) other).repeatMode == this.repeatMode && StartOffset.m170equalsimpl0(((RepeatableSpec) other).initialStartOffset, this.initialStartOffset);
    }
