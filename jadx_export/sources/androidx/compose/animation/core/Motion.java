...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m152boximpl(long j) {
        return new Motion(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m153constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m156equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m162unboximpl();
    }
    ...
    public static final float m158getValueimpl(long arg0) {
        int bits$iv$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: getVelocity-impl, reason: not valid java name */
    public static final float m159getVelocityimpl(long arg0) {
        int bits$iv$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: copy-XB9eQnU, reason: not valid java name */
    public static final long m154copyXB9eQnU(long arg0, float value, float velocity) {
        return SpringSimulationKt.Motion(value, velocity);
    }

    /* renamed from: copy-XB9eQnU$default, reason: not valid java name */
    public static /* synthetic */ long m155copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m158getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m159getVelocityimpl(j);
        }
        return m154copyXB9eQnU(j, f, f2);
    }
}
