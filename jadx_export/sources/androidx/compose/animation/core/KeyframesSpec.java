...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public final KeyframeEntity<T> m151usingngzHuyU(KeyframeEntity<T> keyframeEntity, int arcMode) {
            keyframeEntity.m150setArcModeRur9ykg$animation_core_release(arcMode);
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> converter) {
        ...
        timestamps.sort();
        return new VectorizedKeyframesSpec<>(timestamps, timeToInfoMap, this.config.getDurationMillis(), this.config.getDelayMillis(), EasingKt.getLinearEasing(), ArcMode.INSTANCE.m146getArcLinear9TMq4(), null);
    }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i2 & 2) != 0 ? EasingKt.getLinearEasing() : easing, (i2 & 4) != 0 ? ArcMode.INSTANCE.m146getArcLinear9TMq4() : i, null);
        }
        ...
        public final void m150setArcModeRur9ykg$animation_core_release(int i) {
            this.arcMode = i;
        }
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof KeyframeEntity) && Intrinsics.areEqual(((KeyframeEntity) other).getValue$animation_core_release(), getValue$animation_core_release()) && Intrinsics.areEqual(((KeyframeEntity) other).getEasing(), getEasing()) && ArcMode.m140equalsimpl0(((KeyframeEntity) other).arcMode, this.arcMode);
        }
        ...
        public int hashCode() {
            ...
            return (((result * 31) + ArcMode.m141hashCodeimpl(this.arcMode)) * 31) + getEasing().hashCode();
        }
    }
}
