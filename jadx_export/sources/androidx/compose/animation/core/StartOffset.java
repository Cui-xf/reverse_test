...
public final class StartOffset {
    ...
    public static final /* synthetic */ StartOffset m165boximpl(long j) {
    ...
    public static String m174toStringimpl(long j) {
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m166constructorimpl(int offsetMillis, int offsetType) {
        return m167constructorimpl(offsetMillis * offsetType);
    }

    /* renamed from: constructor-impl$default, reason: not valid java name */
    public static /* synthetic */ long m168constructorimpl$default(int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i3 & 2) != 0) {
            i2 = StartOffsetType.INSTANCE.m183getDelayEo1U57Q();
        }
        return m166constructorimpl(i, i2);
    }

    /* renamed from: getOffsetMillis-impl, reason: not valid java name */
    public static final int m171getOffsetMillisimpl(long arg0) {
        return Math.abs((int) arg0);
    }

    /* renamed from: getOffsetType-Eo1U57Q, reason: not valid java name */
    public static final int m172getOffsetTypeEo1U57Q(long arg0) {
        boolean z = arg0 > 0;
        if (z) {
            return StartOffsetType.INSTANCE.m184getFastForwardEo1U57Q();
        }
        if (z) {
            throw new NoWhenBranchMatchedException();
        }
        return StartOffsetType.INSTANCE.m183getDelayEo1U57Q();
    }
}
