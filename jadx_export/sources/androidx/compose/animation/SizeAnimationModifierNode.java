...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m109setLookaheadConstraintsBRTryo0(long value) {
        this.lookaheadConstraints = value;
        this.lookaheadConstraintsAvailable = true;
    }

    /* renamed from: targetConstraints-ZezNO4M, reason: not valid java name */
    private final long m110targetConstraintsZezNO4M(long j) {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m112copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m114copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m114copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m6865equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m6868hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m6870toStringimpl(this.startSize)) + ')';
        }
        ...
        public final long m115getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m116setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo86measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            m109setLookaheadConstraintsBRTryo0(constraints);
            placeable = measurable.mo5535measureBRTryo0(constraints);
        } else {
            placeable = measurable.mo5535measureBRTryo0(m110targetConstraintsZezNO4M(constraints));
        }
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            ...
            long it2 = m111animateTomzRDjE0(AnimationModifierKt.m64isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : measuredSize);
            it = ConstraintsKt.m6650constrain4WqzIAM(constraints, it2);
        }
        final int iM6867getWidthimpl = IntSize.m6867getWidthimpl(it);
        final int height = IntSize.m6866getHeightimpl(it);
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, iM6867getWidthimpl, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                long offset = this.this$0.getAlignment().mo3791alignKFBX0sM(measuredSize, IntSizeKt.IntSize(iM6867getWidthimpl, height), $this$measure_u2d3p2s80s.getLayoutDirection());
                Placeable.PlacementScope.m5606placeRelative70tqf50$default($this$layout, placeable, offset, 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m111animateTomzRDjE0(long targetSize) {
        AnimData data = getAnimData();
        if (data != null) {
            boolean wasInterrupted = (IntSize.m6865equalsimpl0(targetSize, data.getAnim().getValue().getPackedValue()) || data.getAnim().isRunning()) ? false : true;
            if (!IntSize.m6865equalsimpl0(targetSize, data.getAnim().getTargetValue().getPackedValue()) || wasInterrupted) {
                data.m116setStartSizeozmzZPI(data.getAnim().getValue().getPackedValue());
            ...
            data = new AnimData(new Animatable(IntSize.m6859boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m6859boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
        setAnimData(data);
