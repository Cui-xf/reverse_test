...
public final class SharedTransitionScopeImpl implements SharedTransitionScope, LookaheadScope {
    ...
    public long mo104localLookaheadPositionOfauaQtc(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        return this.$$delegate_0.mo104localLookaheadPositionOfauaQtc(layoutCoordinates, layoutCoordinates2, j, z);
    }
    ...
    */
            ...
            */
            public final androidx.compose.ui.Modifier invoke(androidx.compose.ui.Modifier r21, androidx.compose.runtime.Composer r22, int r23) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.SharedTransitionScopeImpl.C01891.invoke(androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int):androidx.compose.ui.Modifier");
            }
        }, 1, null);
    }
    ...
    private static final class ShapeBasedClip implements SharedTransitionScope.OverlayClip {
        ...
        public Path getClipPath(SharedTransitionScope.SharedContentState state, Rect bounds, LayoutDirection layoutDirection, Density density) {
            this.path.reset();
            OutlineKt.addOutline(this.path, this.clipShape.mo278createOutlinePq9zytI(bounds.m3978getSizeNHjbRc(), layoutDirection, density));
            this.path.mo4082translatek4lQ0M(bounds.m3980getTopLeftF1C5BW0());
            return this.path;
        }
    }
}
