    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                IntSize intSizeM6859boximpl = IntSize.m6859boximpl(sizeAnimationModifierNode$animateTo$data$1$1.$targetSize);
                ...
                Object objAnimateTo = anim.animateTo(intSizeM6859boximpl, (4 & 2) != 0 ? anim.defaultSpringSpec : animationSpec, (4 & 4) != 0 ? anim.getVelocity() : null, (4 & 8) != 0 ? null : null, sizeAnimationModifierNode$animateTo$data$1$1);
        ...
        if (result.getEndReason() == AnimationEndReason.Finished && (listener = sizeAnimationModifierNode$animateTo$data$1$1.this$0.getListener()) != 0) {
            listener.invoke(IntSize.m6859boximpl(sizeAnimationModifierNode$animateTo$data$1$1.$this_apply.m115getStartSizeYbymL2g()), result.getEndState().getValue());
        }
