...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6859boximpl(IntSize.INSTANCE.m6872getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo35slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m56isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6867getWidthimpl(this.m55getCurrentSizeYbymL2g()) - IntOffset.m6825getXimpl(this.m54calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m55getCurrentSizeYbymL2g()))));
            }
        }) : m57isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m6825getXimpl(this.m54calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m55getCurrentSizeYbymL2g()))) - it));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m51getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6866getHeightimpl(this.m55getCurrentSizeYbymL2g()) - IntOffset.m6826getYimpl(this.m54calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m55getCurrentSizeYbymL2g()))));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m46getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m6826getYimpl(this.m54calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m55getCurrentSizeYbymL2g()))) - it));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m56isLeftgWo6LJ4(int $this$isLeft) {
        return AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m48getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m50getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m47getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m57isRightgWo6LJ4(int $this$isRight) {
        return AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m49getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m50getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m47getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m54calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo3791alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }
    ...
    public ExitTransition mo36slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m56isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int it) {
                ...
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6872getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6825getXimpl(this.this$0.m54calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) - it));
            }
        }) : m57isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6872getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6825getXimpl(this.this$0.m54calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m6867getWidthimpl(targetSize)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m42equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m51getUpDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6872getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6826getYimpl(this.this$0.m54calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) - it));
            }
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6872getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6826getYimpl(this.this$0.m54calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m6866getHeightimpl(targetSize)));
            }
        }) : ExitTransition.INSTANCE.getNone();
    }

    /* renamed from: getMeasuredSize-YbymL2g$animation_release, reason: not valid java name */
    public final long m58getMeasuredSizeYbymL2g$animation_release() {
        State $this$getValue$iv = this.measuredSize;
        return ((IntSize) $this$getValue$iv.getValue()).getPackedValue();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release, reason: not valid java name */
    public final void m59setMeasuredSizeozmzZPI$animation_release(long j) {
    ...
    public final long m55getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().getPackedValue() : m58getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo60measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            final Placeable placeableMo5535measureBRTryo0 = measurable.mo5535measureBRTryo0(j);
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo117createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long initial = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6872getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long target = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m6872getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo117createAnimationSpecTemP2vQ = value.mo117createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo117createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m6859boximpl(m61invokeYEO4UFw(obj));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m61invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentTransitionScopeImpl2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6872getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(stateAnimate);
            if (measureScope.isLookingAhead()) {
                packedValue = IntSizeKt.IntSize(placeableMo5535measureBRTryo0.getWidth(), placeableMo5535measureBRTryo0.getHeight());
            } else {
                packedValue = stateAnimate.getValue().getPackedValue();
            }
            int iM6867getWidthimpl = IntSize.m6867getWidthimpl(packedValue);
            int iM6866getHeightimpl = IntSize.m6866getHeightimpl(packedValue);
            final AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl3 = AnimatedContentTransitionScopeImpl.this;
            return MeasureScope.CC.layout$default(measureScope, iM6867getWidthimpl, iM6866getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope $this$layout) {
                    long offset = animatedContentTransitionScopeImpl3.getContentAlignment().mo3791alignKFBX0sM(IntSizeKt.IntSize(placeableMo5535measureBRTryo0.getWidth(), placeableMo5535measureBRTryo0.getHeight()), packedValue, LayoutDirection.Ltr);
                    Placeable.PlacementScope.m5605place70tqf50$default($this$layout, placeableMo5535measureBRTryo0, offset, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
