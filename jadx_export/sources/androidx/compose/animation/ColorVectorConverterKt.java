        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m66invoke8_81llA(color.m4197unboximpl());
                }

                /* renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m66invoke8_81llA(long color) {
                    long jM4184convertvNxB06k = Color.m4184convertvNxB06k(color, ColorSpaces.INSTANCE.getOklab());
                    float l = Color.m4193getRedimpl(jM4184convertvNxB06k);
                    float a = Color.m4192getGreenimpl(jM4184convertvNxB06k);
                    float b = Color.m4190getBlueimpl(jM4184convertvNxB06k);
                    float alpha = Color.m4189getAlphaimpl(jM4184convertvNxB06k);
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m4177boximpl(m67invokevNxB06k(animationVector4D));
                }

                /* renamed from: invoke-vNxB06k, reason: not valid java name */
                public final long m67invokevNxB06k(AnimationVector4D vector) {
                    ...
                    return Color.m4184convertvNxB06k(ColorKt.Color($this$fastCoerceAtLeast$iv$iv, $this$fastCoerceAtLeast$iv$iv2, $this$fastCoerceAtLeast$iv$iv3, $this$fastCoerceAtLeast$iv$iv4, ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };
