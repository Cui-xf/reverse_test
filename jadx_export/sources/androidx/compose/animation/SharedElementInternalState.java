...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public void drawInOverlay(DrawScope drawScope) throws Throwable {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset offsetM3934boximpl = currentBounds != null ? Offset.m3934boximpl(currentBounds.m3980getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(offsetM3934boximpl);
            long packedValue = offsetM3934boximpl.getPackedValue();
            float fM3945getXimpl = Offset.m3945getXimpl(packedValue);
            float fM3946getYimpl = Offset.m3946getYimpl(packedValue);
            ...
            if (it == null) {
                ...
                try {
                    ...
                    $this$clipPath_KD09W0M_u24lambda_u245$iv.mo4671clipPathmtrdDE(it, clipOp$iv);
                    drawScope.getDrawContext().getTransform().translate(fM3945getXimpl, fM3946getYimpl);
                } catch (Throwable th) {
                    th = th;
                }
                try {
            ...
            if (unit == null) {
                ...
                $this$translate$iv.getDrawContext().getTransform().translate(fM3945getXimpl, fM3946getYimpl);
                try {
    ...
    public final long m102getNonNullLookaheadSizeNHjbRc() {
        ...
        return IntSizeKt.m6879toSizeozmzZPI(layoutCoordinatesInvoke.mo5537getSizeYbymL2g());
    }
    ...
    public final long m101calculateLookaheadOffsetF1C5BW0() {
        LayoutCoordinates layoutCoordinatesInvoke = this.lookaheadCoords.invoke();
        if (layoutCoordinatesInvoke == null) {
        ...
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo5538localPositionOfR5De75A(c, Offset.INSTANCE.m3961getZeroF1C5BW0());
    }
