...
final class SkipToLookaheadNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m119setLookaheadConstraints_Sx5XlM(Constraints constraints) {
    ...
    public MeasureResult mo86measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        final Placeable p = measurable.mo5535measureBRTryo0(constraints2.getValue());
        final long contentSize = IntSizeKt.IntSize(p.getWidth(), p.getHeight());
        final long constrainedSize = ConstraintsKt.m6650constrain4WqzIAM(constraints, contentSize);
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, IntSize.m6867getWidthimpl(constrainedSize), IntSize.m6866getHeightimpl(constrainedSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                final long resolvedScale = (IntSize.m6867getWidthimpl(contentSize) == 0 || IntSize.m6866getHeightimpl(contentSize) == 0) ? ScaleFactorKt.ScaleFactor(1.0f, 1.0f) : contentScale.mo5526computeScaleFactorH7hwNQA(IntSizeKt.m6879toSizeozmzZPI(contentSize), IntSizeKt.m6879toSizeozmzZPI(constrainedSize));
                long jMo3791alignKFBX0sM = scaleToBounds.getAlignment().mo3791alignKFBX0sM(IntSizeKt.IntSize(MathKt.roundToInt(IntSize.m6867getWidthimpl(contentSize) * ScaleFactor.m5630getScaleXimpl(resolvedScale)), MathKt.roundToInt(IntSize.m6866getHeightimpl(contentSize) * ScaleFactor.m5631getScaleYimpl(resolvedScale))), constrainedSize, $this$measure_u2d3p2s80s.getLayoutDirection());
                int iM6825getXimpl = IntOffset.m6825getXimpl(jMo3791alignKFBX0sM);
                int y = IntOffset.m6826getYimpl(jMo3791alignKFBX0sM);
                Placeable.PlacementScope.placeWithLayer$default($this$layout, p, iM6825getXimpl, y, 0.0f, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(GraphicsLayerScope $this$placeWithLayer) {
                        $this$placeWithLayer.setScaleX(ScaleFactor.m5630getScaleXimpl(resolvedScale));
                        $this$placeWithLayer.setScaleY(ScaleFactor.m5631getScaleYimpl(resolvedScale));
                        $this$placeWithLayer.mo4360setTransformOrigin__ExYCQ(TransformOriginKt.TransformOrigin(0.0f, 0.0f));
                    }
                }, 4, (Object) null);
            }
        }, 4, null);
