...
final class DrawStretchOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    public void draw(ContentDrawScope $this$draw) throws Throwable {
        ...
        float maxElevation = $this$draw.mo367toPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        ...
        if ($this$draw_u24lambda_u244.isLeftAnimating()) {
            ...
            if ($this$draw_u24lambda_u244.isLeftStretched()) {
                float displacementY = Offset.m3946getYimpl(this.overscrollEffect.m213displacementF1C5BW0$foundation_release());
                f = 1.0f;
        ...
        if ($this$draw_u24lambda_u244.isTopAnimating()) {
            ...
            if ($this$draw_u24lambda_u244.isTopStretched()) {
                float displacementX = Offset.m3945getXimpl(this.overscrollEffect.m213displacementF1C5BW0$foundation_release());
        ...
        if ($this$draw_u24lambda_u244.isRightAnimating()) {
            ...
            if ($this$draw_u24lambda_u244.isRightStretched()) {
                float displacementY2 = Offset.m3946getYimpl(this.overscrollEffect.m213displacementF1C5BW0$foundation_release());
        ...
        if ($this$draw_u24lambda_u244.isBottomAnimating()) {
            ...
            if ($this$draw_u24lambda_u244.isBottomStretched()) {
                float displacementX2 = Offset.m3945getXimpl(this.overscrollEffect.m213displacementF1C5BW0$foundation_release());
        ...
        long size$iv = $this$draw.mo4662getSizeNHjbRc();
