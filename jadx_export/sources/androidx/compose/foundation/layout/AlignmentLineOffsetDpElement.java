...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float before, float after, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if ((this.before >= 0.0f || Dp.m6698equalsimpl0(this.before, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM())) && (this.after >= 0.0f || Dp.m6698equalsimpl0(this.after, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM()))) {
        } else {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m540setBefore0680j_4(this.before);
        node.m539setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return otherModifier != null && Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && Dp.m6698equalsimpl0(this.before, otherModifier.before) && Dp.m6698equalsimpl0(this.after, otherModifier.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.alignmentLine.hashCode();
        return (((result * 31) + Dp.m6699hashCodeimpl(this.before)) * 31) + Dp.m6699hashCodeimpl(this.after);
    }
}
