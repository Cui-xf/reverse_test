...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final IntIntPair m608ellipsisSizeF35zmw$foundation_layout_release(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
    ...
    public final void m610setOverflowMeasurableshBUhpc$foundation_layout_release(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        ...
        if (seeMoreMeasurable != null) {
            int mainAxisSize = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m6635getMaxHeightimpl(orientationIndependentConstraints));
            int crossAxisSize = FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, mainAxisSize);
            this.seeMoreSize = IntIntPair.m17boximpl(IntIntPair.m20constructorimpl(mainAxisSize, crossAxisSize));
        ...
        if (collapseMeasurable != null) {
            int mainAxisSize2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m6635getMaxHeightimpl(orientationIndependentConstraints));
            int crossAxisSize2 = FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, mainAxisSize2);
            this.collapseSize = IntIntPair.m17boximpl(IntIntPair.m20constructorimpl(mainAxisSize2, crossAxisSize2));
    ...
    /* renamed from: setOverflowMeasurables--hBUhpc$foundation_layout_release, reason: not valid java name */
    public final void m609setOverflowMeasurableshBUhpc$foundation_layout_release(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        ...
        long orientationIndependentConstraints = OrientationIndependentConstraints.m651copyyUG9Ft0(jM650constructorimpl, (10 & 1) != 0 ? Constraints.m6638getMinWidthimpl(jM650constructorimpl) : 0, (10 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(jM650constructorimpl) : 0, (10 & 4) != 0 ? Constraints.m6637getMinHeightimpl(jM650constructorimpl) : 0, (10 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(jM650constructorimpl) : 0);
        ...
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m606measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, finalConstraints, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$3$1
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.seeMoreSize = IntIntPair.m17boximpl(IntIntPair.m20constructorimpl(mainAxisSize, crossAxisSize));
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m606measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, finalConstraints, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$4$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.collapseSize = IntIntPair.m17boximpl(IntIntPair.m20constructorimpl(mainAxisSize, crossAxisSize));
    ...
    public final void m611setOverflowMeasurablesVKLhPVY$foundation_layout_release(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        this.itemShown = 0;
        ...
        m609setOverflowMeasurableshBUhpc$foundation_layout_release(measurePolicy, seeMoreMeasurable, collapseMeasurable, constraints);
    }
}
