...
final class OffsetModifierElement extends ModifierNodeElement<OffsetNode> {
    ...
    public boolean equals(Object other) {
        ...
        return otherModifierElement != null && Dp.m6698equalsimpl0(this.x, otherModifierElement.x) && Dp.m6698equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m6699hashCodeimpl(this.x);
        return (((result * 31) + Dp.m6699hashCodeimpl(this.y)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m6704toStringimpl(this.x)) + ", y=" + ((Object) Dp.m6704toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
