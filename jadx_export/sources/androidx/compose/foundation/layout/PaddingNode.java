...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m6693constructorimpl(0) : f, (i & 2) != 0 ? Dp.m6693constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m6693constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m6693constructorimpl(0) : f4, z, null);
    }
    ...
    public MeasureResult mo86measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        int horizontal = $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.start) + $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.end);
        int vertical = $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.top) + $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.bottom);
        ...
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelative$default($this$layout, placeable2, $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.this$0.getStart()), $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default($this$layout, placeable2, $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.this$0.getStart()), $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
