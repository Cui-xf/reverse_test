...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m6693constructorimpl(0) : f, (i & 2) != 0 ? Dp.m6693constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m6693constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m6693constructorimpl(0) : f4, z, function1, null);
    }
    ...
    private PaddingElement(float start, float top, float end, float bottom, boolean rtlAware, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if ((this.start >= 0.0f || Dp.m6698equalsimpl0(this.start, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM())) && (this.top >= 0.0f || Dp.m6698equalsimpl0(this.top, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM())) && ((this.end >= 0.0f || Dp.m6698equalsimpl0(this.end, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM())) && (this.bottom >= 0.0f || Dp.m6698equalsimpl0(this.bottom, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM())))) {
        } else {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m6699hashCodeimpl(this.start);
        return (((((((result * 31) + Dp.m6699hashCodeimpl(this.top)) * 31) + Dp.m6699hashCodeimpl(this.end)) * 31) + Dp.m6699hashCodeimpl(this.bottom)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        PaddingElement otherModifierElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        return otherModifierElement != null && Dp.m6698equalsimpl0(this.start, otherModifierElement.start) && Dp.m6698equalsimpl0(this.top, otherModifierElement.top) && Dp.m6698equalsimpl0(this.end, otherModifierElement.end) && Dp.m6698equalsimpl0(this.bottom, otherModifierElement.bottom) && this.rtlAware == otherModifierElement.rtlAware;
    }
