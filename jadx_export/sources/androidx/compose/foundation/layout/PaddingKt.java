...
public final class PaddingKt {
    ...
    public static final Modifier m684paddingqDBjuR0(Modifier $this$padding_u2dqDBjuR0, final float start, final float top, final float end, final float bottom) {
        return $this$padding_u2dqDBjuR0.then(new PaddingElement(start, top, end, bottom, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.1
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                ...
                $this$$receiver.getProperties().set("start", Dp.m6691boximpl(start));
                $this$$receiver.getProperties().set("top", Dp.m6691boximpl(top));
                $this$$receiver.getProperties().set("end", Dp.m6691boximpl(end));
                $this$$receiver.getProperties().set("bottom", Dp.m6691boximpl(bottom));
            }
        }, null));
    }
    ...
    public static final Modifier m682paddingVpY3zN4(Modifier $this$padding_u2dVpY3zN4, final float horizontal, final float vertical) {
        return $this$padding_u2dVpY3zN4.then(new PaddingElement(horizontal, vertical, horizontal, vertical, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.2
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                $this$$receiver.setName("padding");
                $this$$receiver.getProperties().set("horizontal", Dp.m6691boximpl(horizontal));
                $this$$receiver.getProperties().set("vertical", Dp.m6691boximpl(vertical));
            }
        }, null));
    }
    ...
    public static final Modifier m681padding3ABfNKs(Modifier $this$padding_u2d3ABfNKs, final float all) {
        return $this$padding_u2d3ABfNKs.then(new PaddingElement(all, all, all, all, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.3
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                $this$$receiver.setName("padding");
                $this$$receiver.setValue(Dp.m6691boximpl(all));
            }
        }, null));
    }
    ...
    public static final Modifier m679absolutePaddingqDBjuR0(Modifier $this$absolutePadding_u2dqDBjuR0, final float left, final float top, final float right, final float bottom) {
        return $this$absolutePadding_u2dqDBjuR0.then(new PaddingElement(left, top, right, bottom, false, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$absolutePadding$1
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                ...
                $this$$receiver.getProperties().set("left", Dp.m6691boximpl(left));
                $this$$receiver.getProperties().set("top", Dp.m6691boximpl(top));
                $this$$receiver.getProperties().set("right", Dp.m6691boximpl(right));
                $this$$receiver.getProperties().set("bottom", Dp.m6691boximpl(bottom));
            }
        }, null));
    }
