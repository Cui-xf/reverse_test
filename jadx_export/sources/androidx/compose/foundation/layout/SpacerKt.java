...
public final class SpacerKt {
    public static final void Spacer(Modifier modifier, Composer $composer, int $changed) {
        ...
        Composer $this$Layout_u24lambda_u241$iv = Updater.m3678constructorimpl($composer);
        Updater.m3685setimpl($this$Layout_u24lambda_u241$iv, spacerMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
