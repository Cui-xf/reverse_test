...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo60measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        int height = this.heightCalc.invoke(getUnconsumedInsets(), $this$measure_u2d3p2s80s).intValue();
        if (height == 0) {
            return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$1
        ...
        long childConstraints = Constraints.m6626copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(constraints) : height, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(constraints) : height);
        final Placeable placeable = measurable.mo5535measureBRTryo0(childConstraints);
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
            {
                super(1);
            }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DerivedHeightModifier) && Intrinsics.areEqual(this.insets, ((DerivedHeightModifier) other).insets) && this.heightCalc == ((DerivedHeightModifier) other).heightCalc;
    }
