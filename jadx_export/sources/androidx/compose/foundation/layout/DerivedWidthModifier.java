...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo60measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if (width == 0) {
            return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$1
        ...
        long childConstraints = Constraints.m6626copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(constraints) : width, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(constraints) : width, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(constraints) : 0);
        final Placeable placeable = measurable.mo5535measureBRTryo0(childConstraints);
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
            {
                super(1);
            }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DerivedWidthModifier) && Intrinsics.areEqual(this.insets, ((DerivedWidthModifier) other).insets) && this.widthCalc == ((DerivedWidthModifier) other).widthCalc;
    }
