...
public final class AndroidExternalSurfaceZOrder {
    ...
    private static final int Behind = m218constructorimpl(0);
    private static final int MediaOverlay = m218constructorimpl(1);
    private static final int OnTop = m218constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AndroidExternalSurfaceZOrder m217boximpl(int i) {
        return new AndroidExternalSurfaceZOrder(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m218constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m219equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidExternalSurfaceZOrder) && i == ((AndroidExternalSurfaceZOrder) obj).m223unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m219equalsimpl(this.zOrder, obj);
    }

    public int hashCode() {
        return m221hashCodeimpl(this.zOrder);
    }

    public String toString() {
        return m222toStringimpl(this.zOrder);
    }
