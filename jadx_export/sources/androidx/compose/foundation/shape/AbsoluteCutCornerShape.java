...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo954createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m4014getWidthimpl(size) - topEnd, 0.0f);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m4014getWidthimpl(size), topEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m4014getWidthimpl(size), Size.m4011getHeightimpl(size) - bottomEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m4014getWidthimpl(size) - bottomEnd, Size.m4011getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(bottomStart, Size.m4011getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(0.0f, Size.m4011getHeightimpl(size) - bottomStart);
