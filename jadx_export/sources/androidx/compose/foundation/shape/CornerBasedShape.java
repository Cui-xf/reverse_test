...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline mo954createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection);
    ...
    public final Outline mo278createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float topStart = this.topStart.mo962toPxTmRCtEA(size, density);
        float topEnd = this.topEnd.mo962toPxTmRCtEA(size, density);
        float bottomEnd = this.bottomEnd.mo962toPxTmRCtEA(size, density);
        float bottomStart = this.bottomStart.mo962toPxTmRCtEA(size, density);
        float minDimension = Size.m4013getMinDimensionimpl(size);
        ...
        if (topStart >= 0.0f && topEnd >= 0.0f && bottomEnd >= 0.0f && bottomStart >= 0.0f) {
            return mo954createOutlineLjSzlW0(size, topStart, topEnd, bottomEnd, bottomStart, layoutDirection);
        }
