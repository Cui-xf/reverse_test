...
public abstract class RectListNode extends Modifier.Node implements GlobalPositionAwareModifierNode {
    ...
    private final Rect calcBounds(LayoutCoordinates layoutCoordinates, androidx.compose.ui.geometry.Rect rect) {
        ...
        long topLeft = root.mo5538localPositionOfR5De75A(layoutCoordinates, rect.m3980getTopLeftF1C5BW0());
        long topRight = root.mo5538localPositionOfR5De75A(layoutCoordinates, rect.m3981getTopRightF1C5BW0());
        long bottomLeft = root.mo5538localPositionOfR5De75A(layoutCoordinates, rect.m3973getBottomLeftF1C5BW0());
        long bottomRight = root.mo5538localPositionOfR5De75A(layoutCoordinates, rect.m3974getBottomRightF1C5BW0());
        float left = ComparisonsKt.minOf(Offset.m3945getXimpl(topLeft), Offset.m3945getXimpl(topRight), Offset.m3945getXimpl(bottomLeft), Offset.m3945getXimpl(bottomRight));
        float top = ComparisonsKt.minOf(Offset.m3946getYimpl(topLeft), Offset.m3946getYimpl(topRight), Offset.m3946getYimpl(bottomLeft), Offset.m3946getYimpl(bottomRight));
        float right = ComparisonsKt.maxOf(Offset.m3945getXimpl(topLeft), Offset.m3945getXimpl(topRight), Offset.m3945getXimpl(bottomLeft), Offset.m3945getXimpl(bottomRight));
        float bottom = ComparisonsKt.maxOf(Offset.m3946getYimpl(topLeft), Offset.m3946getYimpl(topRight), Offset.m3946getYimpl(bottomLeft), Offset.m3946getYimpl(bottomRight));
