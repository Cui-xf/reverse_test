        ...
        if (($dirty & 19) != 18 || !$composer4.getSkipping()) {
            ...
            while (index$iv < size) {
                ...
                MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                    ...
                    public final MeasureResult mo34measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list2, long constrains) {
                        ...
                        for (int index$iv$iv = 0; index$iv$iv < size2; index$iv$iv++) {
                            ...
                            target$iv.add(it.mo5535measureBRTryo0(constrains));
                        }
                        final List placeables = target$iv;
                        return MeasureScope.CC.layout$default($this$Layout, Constraints.m6636getMaxWidthimpl(constrains), Constraints.m6635getMaxHeightimpl(constrains), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2.1
