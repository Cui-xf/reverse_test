...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m1080typedCommandZmokQxo(KeyEvent event) {
        Integer numM1001consumeZmokQxo;
        if (!TextFieldKeyInput_androidKt.m1085isTypedEventZmokQxo(event) || (numM1001consumeZmokQxo = this.keyCombiner.m1001consumeZmokQxo(event)) == null) {
            return null;
        }
        int codePoint = numM1001consumeZmokQxo.intValue();
    ...
    public final boolean m1081processZmokQxo(KeyEvent event) {
        final KeyCommand command;
        CommitTextCommand it = m1080typedCommandZmokQxo(event);
        if (it != null) {
            if (this.editable) {
                apply(it);
        ...
        if (!KeyEventType.m5250equalsimpl0(KeyEvent_androidKt.m5258getTypeZmokQxo(event), KeyEventType.INSTANCE.m5254getKeyDownCS__XNY()) || (command = this.keyMapping.mo1003mapZmokQxo(event)) == null || (command.getEditsText() && !this.editable)) {
            return false;
        }
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[command.ordinal()]) {
                    ...
                    case 20:
                        List<EditCommand> listDeleteIfSelectedOr = $this$commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
                                return new DeleteSurroundingTextCommand(TextRange.m6141getEndimpl($this$deleteIfSelectedOr.getSelection()) - $this$deleteIfSelectedOr.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr2 = $this$commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m6141getEndimpl($this$deleteIfSelectedOr.getSelection()));
                                }
                                return null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr3 = $this$commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
                                ...
                                if (previousWordOffset != null) {
                                    ...
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m6141getEndimpl($this$deleteIfSelectedOr.getSelection()) - it4, 0);
                                } else {
                        ...
                        List<EditCommand> listDeleteIfSelectedOr4 = $this$commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection $this$deleteIfSelectedOr) {
                                ...
                                if (nextWordOffset != null) {
                                    ...
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(0, it4 - TextRange.m6141getEndimpl($this$deleteIfSelectedOr.getSelection()));
                                } else {
                                    deleteSurroundingTextCommand = null;
                                }
                                return deleteSurroundingTextCommand;
                    ...
                    case 26:
                        ...
                        if (!singleLine) {
                            ...
                            textFieldKeyInput.getState().getOnImeActionPerformed().invoke(ImeAction.m6310boximpl(this.imeAction));
                            break;
                        }
                    case 27:
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (!TextRange.m6139equalsimpl0(preparedSelection.getSelection(), this.value.getSelection()) || !Intrinsics.areEqual(preparedSelection.getAnnotatedString(), this.value.getText())) {
