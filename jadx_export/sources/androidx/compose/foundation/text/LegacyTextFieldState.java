...
public final class LegacyTextFieldState {
    ...
    private final MutableState minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6691boximpl(Dp.m6693constructorimpl(0)), null, 2, null);
    ...
    private final Function1<TextFieldValue, Unit> onValueChange = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onValueChange$1
        ...
        public final void invoke2(TextFieldValue it) {
            ...
            this.this$0.m1027setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6151getZerod9O1mEE());
            this.this$0.m1024setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6151getZerod9O1mEE());
    ...
    private final Function1<ImeAction, Unit> onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onImeActionPerformed$1
        ...
        public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
            m1029invokeKlQnJC8(imeAction.getValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-KlQnJC8, reason: not valid java name */
        public final void m1029invokeKlQnJC8(int imeAction) {
            this.this$0.keyboardActionRunner.m1005runActionKlQnJC8(imeAction);
        }
    };
    private final Paint highlightPaint = AndroidPaint_androidKt.Paint();
    private long selectionBackgroundColor = Color.INSTANCE.m4223getUnspecified0d7_KjU();

    /* renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6134boximpl(TextRange.INSTANCE.m6151getZerod9O1mEE()), null, 2, null);

    /* renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6134boximpl(TextRange.INSTANCE.m6151getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1021getMinHeightForSingleLineFieldD9Ej5fM() {
        State $this$getValue$iv = this.minHeightForSingleLineField;
        return ((Dp) $this$getValue$iv.getValue()).m6707unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1025setMinHeightForSingleLineField0680j_4(float f) {
        MutableState $this$setValue$iv = this.minHeightForSingleLineField;
        $this$setValue$iv.setValue(Dp.m6691boximpl(f));
    }
    ...
    public final void m1026setSelectionBackgroundColor8_81llA(long j) {
        this.selectionBackgroundColor = j;
    }

    /* renamed from: getSelectionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1023getSelectionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1027setSelectionPreviewHighlightRange5zctL8(long j) {
        MutableState $this$setValue$iv = this.selectionPreviewHighlightRange;
        $this$setValue$iv.setValue(TextRange.m6134boximpl(j));
    }

    /* renamed from: getDeletionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1020getDeletionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1024setDeletionPreviewHighlightRange5zctL8(long j) {
        MutableState $this$setValue$iv = this.deletionPreviewHighlightRange;
        $this$setValue$iv.setValue(TextRange.m6134boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m6140getCollapsedimpl(m1023getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m6140getCollapsedimpl(m1020getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* renamed from: update-fnh65Uc, reason: not valid java name */
    public final void m1028updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate newTextDelegate = TextDelegateKt.m1063updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
