...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1096getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1097getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1097getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        long coercedPosition = coerceInVisibleBounds ? m1095coercedInVisibleBoundsOfInputTextMKHz9U(position) : position;
        long relativePosition = m1099translateDecorationToInnerCoordinatesMKHz9U$foundation_release(coercedPosition);
        return this.value.m6118getOffsetForPositionk4lQ0M(relativePosition);
    }

    public final int getLineForVerticalPosition(float vertical) {
        long coercedPosition = m1095coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical));
        float relativeVertical = Offset.m3946getYimpl(m1099translateDecorationToInnerCoordinatesMKHz9U$foundation_release(coercedPosition));
    ...
    public final boolean m1098isPositionOnTextk4lQ0M(long offset) {
        long visibleOffset = m1095coercedInVisibleBoundsOfInputTextMKHz9U(offset);
        long relativeOffset = m1099translateDecorationToInnerCoordinatesMKHz9U$foundation_release(visibleOffset);
        int line = this.value.getLineForVerticalPosition(Offset.m3946getYimpl(relativeOffset));
        return Offset.m3945getXimpl(relativeOffset) >= this.value.getLineLeft(line) && Offset.m3945getXimpl(relativeOffset) <= this.value.getLineRight(line);
    }

    /* renamed from: translateDecorationToInnerCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1099translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long offset) {
        ...
        if (innerCoords != null) {
            ...
            if (innerCoords != null && (it = this.decorationBoxCoordinates) != null) {
                ...
                if (decorationCoords != null) {
                    return innerCoords.mo5538localPositionOfR5De75A(decorationCoords, offset);
                }
            }
            return offset;
        }
    ...
    public final long m1100translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long offset) {
        LayoutCoordinates it;
        LayoutCoordinates innerCoords = this.innerTextFieldCoordinates;
        if (innerCoords != null) {
            if (!innerCoords.isAttached()) {
            ...
            if (innerCoords != null && (it = this.decorationBoxCoordinates) != null) {
                LayoutCoordinates decorationCoords = it.isAttached() ? it : null;
                if (decorationCoords != null) {
                    return decorationCoords.mo5538localPositionOfR5De75A(innerCoords, offset);
                }
            }
            return offset;
        }
    ...
    */
    private final long m1095coercedInVisibleBoundsOfInputTextMKHz9U(long r7) {
        /*
            r6 = this;
        ...
        L26:
            long r0 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m1101access$coerceIn3MmeM6k(r7, r3)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m1095coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}
