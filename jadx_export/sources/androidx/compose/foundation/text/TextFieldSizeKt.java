        ...
        return ComposedModifierKt.composed$default($this$textFieldMinSize, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldSizeKt.textFieldMinSize.1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM6178getFontStyle4Lr2A7w = resolvedStyle2.m6178getFontStyle4Lr2A7w();
                    resolvedStyle = resolvedStyle2;
                    int iM6261unboximpl = fontStyleM6178getFontStyle4Lr2A7w != null ? fontStyleM6178getFontStyle4Lr2A7w.m6261unboximpl() : FontStyle.INSTANCE.m6265getNormal_LCdwA();
                    FontSynthesis fontSynthesisM6179getFontSynthesisZQGJjVo = resolvedStyle.m6179getFontSynthesisZQGJjVo();
                    value$iv2 = fontFamilyResolver.mo6232resolveDPcqOEQ(fontFamily, fontWeight, iM6261unboximpl, fontSynthesisM6179getFontSynthesisZQGJjVo != null ? fontSynthesisM6179getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m6275getAllGVVA2EU());
                ...
                if (invalid$iv3 || it$iv4 == Composer.INSTANCE.getEmpty()) {
                    value$iv4 = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.text.TextFieldSizeKt$textFieldMinSize$1$1$1
                        ...
                        public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                            return m1093invoke3p2s80s(measureScope, measurable, constraints.getValue());
                        }

                        /* renamed from: invoke-3p2s80s, reason: not valid java name */
                        public final MeasureResult m1093invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
                            long minSize = minSizeState.getMinSize();
                            long childConstraints = Constraints.m6626copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(constraints) : RangesKt.coerceIn(IntSize.m6867getWidthimpl(minSize), Constraints.m6638getMinWidthimpl(constraints), Constraints.m6636getMaxWidthimpl(constraints)), (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(constraints) : RangesKt.coerceIn(IntSize.m6866getHeightimpl(minSize), Constraints.m6637getMinHeightimpl(constraints), Constraints.m6635getMaxHeightimpl(constraints)), (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(constraints) : 0);
                            final Placeable measured = measurable.mo5535measureBRTryo0(childConstraints);
                            return MeasureScope.CC.layout$default($this$layout, measured.getWidth(), measured.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldSizeKt$textFieldMinSize$1$1$1.1
                                {
                                    super(1);
                                }
                ...
                ComposerKt.sourceInformationMarkerEnd($composer);
                Modifier modifierLayout = LayoutModifierKt.layout(companion, (Function3) value$iv4);
                if (ComposerKt.isTraceInProgress()) {
