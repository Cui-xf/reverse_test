...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6599getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m1324updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        if (textChanged || layoutChanged) {
            getLayoutCache().m1317updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
        if (!getIsAttached()) {
            return;
        }
    ...
    public final boolean setSubstitution(String updatedText) {
        ...
        if (currentTextSubstitution != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1317updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
        ...
        if (localSemanticsTextLayoutResult == null) {
            localSemanticsTextLayoutResult = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode.applySemantics.1
                ...
                public final Boolean invoke(List<TextLayoutResult> list) {
                    ...
                    TextLayoutResult layout = layoutCache.slowCreateTextLayoutResultOrNull(TextStyle.m6166mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo1537invoke0d7_KjU() : Color.INSTANCE.m4223getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null));
                    if (layout != null) {
                        list.add(layout);
                    } else {
                        layout = null;
    ...
    public MeasureResult mo86measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        boolean didChangeLayout = layoutCache.m1315layoutWithConstraintsK40F9xA(constraints, $this$measure_u2d3p2s80s.getLayoutDirection());
        ...
        final Placeable placeable = measurable.mo5535measureBRTryo0(Constraints.INSTANCE.m6645fitPrioritizingWidthZbe2FdA(IntSize.m6867getWidthimpl(layoutSize), IntSize.m6867getWidthimpl(layoutSize), IntSize.m6866getHeightimpl(layoutSize), IntSize.m6866getHeightimpl(layoutSize)));
        int iM6867getWidthimpl = IntSize.m6867getWidthimpl(layoutSize);
        int iM6866getHeightimpl = IntSize.m6866getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return $this$measure_u2d3p2s80s.layout(iM6867getWidthimpl, iM6866getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        if (getIsAttached()) {
            ...
            if (willClip) {
                float width = IntSize.m6867getWidthimpl(layoutCache.getLayoutSize());
                float height = IntSize.m6866getHeightimpl(layoutCache.getLayoutSize());
                canvas.save();
                Canvas.CC.m4160clipRectN_I0leg$default(canvas, 0.0f, 0.0f, width, height, 0, 16, null);
            }
            try {
                ...
                if (brush == null) {
                    ...
                    Paragraph.CC.m6019paintLG529CI$default(localParagraph, canvas, color, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                } else {
                    float alpha = this.style.getAlpha();
                    Paragraph.CC.m6021painthn5TExg$default(localParagraph, canvas, brush, alpha, shadow2, textDecoration2, drawStyle2, 0, 64, null);
                }
            } finally {
                if (willClip) {
                    canvas.restore();
