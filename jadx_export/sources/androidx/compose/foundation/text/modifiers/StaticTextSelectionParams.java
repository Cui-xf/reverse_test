...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        return (it == null || TextOverflow.m6592equalsimpl0(it.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m6601getVisiblegIe3tQ8()) || !it.getHasVisualOverflow()) ? false : true;
    }
