...
public final class AndroidCursorHandle_androidKt {
    private static final float CursorHandleHeight = Dp.m6693constructorimpl(25);
    private static final float CursorHandleWidth;
    private static final float Sqrt2 = 1.4142135f;

    static {
        float arg0$iv = CursorHandleHeight;
        CursorHandleWidth = Dp.m6693constructorimpl(Dp.m6693constructorimpl(arg0$iv * 2.0f) / 2.4142137f);
    }
    ...
    public static final void m974CursorHandleUSBMPiE(final OffsetProvider offsetProvider, final Modifier modifier, long minTouchTargetSize, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) != 0 && !$composer2.getDefaultsInvalid()) {
                ...
                minTouchTargetSize2 = DpSize.INSTANCE.m6800getUnspecifiedMYxV2XQ();
                $dirty &= -897;
            }
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$finalModifier$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                        $this$semantics.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, offsetProvider.mo977provideF1C5BW0(), SelectionHandleAnchor.Middle, true, null));
                    }
                };
            ...
            AndroidSelectionHandles_androidKt.HandlePopup(offsetProvider, Alignment.INSTANCE.getTopCenter(), ComposableLambdaKt.rememberComposableLambda(-1653527038, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if ($this$isSpecified$iv != InlineClassHelperKt.UnspecifiedPackedFloats) {
                        ...
                        Modifier modifier$iv = SizeKt.m722requiredSizeInqDBjuR0$default(finalModifier, DpSize.m6791getWidthD9Ej5fM(minTouchTargetSize2), DpSize.m6789getHeightD9Ej5fM(minTouchTargetSize2), 0.0f, 0.0f, 12, null);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
                ...
                public final void invoke(Composer composer, int i3) {
                    AndroidCursorHandle_androidKt.m974CursorHandleUSBMPiE(offsetProvider, modifier, minTouchTargetSize3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
                ...
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope $this$drawWithCache) {
                            final float radius = Size.m4014getWidthimpl($this$drawWithCache.m3835getSizeNHjbRc()) / 2.0f;
                            ...
                            return $this$drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope $this$onDrawWithContent) throws Throwable {
                                    ...
                                    long previousSize$iv2 = $this$withTransform_u24lambda_u246$iv.mo4669getSizeNHjbRc();
                                    ...
                                    try {
                                        ...
                                        $this$invoke_u24lambda_u240.mo4675rotateUv8p0NA(45.0f, Offset.INSTANCE.m3961getZeroF1C5BW0());
                                        previousSize$iv = previousSize$iv2;
                                        try {
                                            DrawScope.CC.m4737drawImagegbVJVH8$default($this$withTransform$iv, imageBitmap2, 0L, 0.0f, null, colorFilter2, 0, 46, null);
