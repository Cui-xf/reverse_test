...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1111getOriginalRangejx7JFs(int changeIndex);

        /* renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1112getRangejx7JFs(int changeIndex);
    }
    ...
    public final long m1107getOriginalSelectiond9O1mEE() {
    ...
    public final boolean hasSelection() {
        return !TextRange.m6140getCollapsedimpl(getSelectionInChars());
    }
    ...
    public final void m1109setSelection5zctL8(long value) {
        m1105requireValidRange5zctL8(value);
    ...
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        int selStart = TextRange.m6144getMinimpl(getSelectionInChars());
        int selEnd2 = TextRange.m6143getMaximpl(getSelectionInChars());
        if (selEnd2 < start) {
            return;
        }
    ...
    public final void revertAllChanges() {
        ...
        m1109setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1106toTextFieldCharSequenceudt6zUU$foundation_release$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldBuffer.m1110toTextFieldCharSequenceudt6zUU$foundation_release(j, textRange);
    }

    /* renamed from: toTextFieldCharSequence-udt6zUU$foundation_release, reason: not valid java name */
    public final TextFieldCharSequence m1110toTextFieldCharSequenceudt6zUU$foundation_release(long selection, TextRange composition) {
    ...
    private final void m1105requireValidRange5zctL8(long range) {
        long validRange = TextRangeKt.TextRange(0, getLength());
        if (!TextRange.m6136contains5zctL8(validRange, range)) {
            throw new IllegalArgumentException(("Expected " + ((Object) TextRange.m6149toStringimpl(range)) + " to be in " + ((Object) TextRange.m6149toStringimpl(validRange))).toString());
        }
    }
}
