...
final /* data */ class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.INSTANCE.m6358getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 126, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer $this$transformInput) {
        ...
        for (int i$iv = 0; i$iv < $this$forEachChange$iv.getChangeCount(); i$iv++) {
            long range = $this$forEachChange$iv.mo1112getRangejx7JFs(i$iv);
            $this$forEachChange$iv.mo1111getOriginalRangejx7JFs(i$iv);
            if (!TextRange.m6140getCollapsedimpl(range)) {
                $this$transformInput.replace(TextRange.m6144getMinimpl(range), TextRange.m6143getMaximpl(range), StringKt.toUpperCase(TextRangeKt.m6153substringFDrldGo($this$transformInput.asCharSequence(), range), this.locale));
            }
        }
    }
