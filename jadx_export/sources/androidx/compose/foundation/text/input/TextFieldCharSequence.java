...
public final class TextFieldCharSequence implements CharSequence {
    ...
    private TextFieldCharSequence(CharSequence text, long selection, TextRange composition, Pair<TextHighlightType, TextRange> pair) {
        ...
        this.selection = TextRangeKt.m6152coerceIn8ffj60Q(selection, 0, text.length());
        this.composition = composition != null ? TextRange.m6134boximpl(TextRangeKt.m6152coerceIn8ffj60Q(composition.getPackedValue(), 0, text.length())) : null;
        this.highlight = pair != null ? Pair.copy$default(pair, null, TextRange.m6134boximpl(TextRangeKt.m6152coerceIn8ffj60Q(pair.getSecond().getPackedValue(), 0, text.length())), 1, null) : null;
    }
    ...
    public /* synthetic */ TextFieldCharSequence(CharSequence charSequence, long j, TextRange textRange, Pair pair, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : charSequence, (i & 2) != 0 ? TextRange.INSTANCE.m6151getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (i & 8) != 0 ? null : pair, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (TextRange.m6139equalsimpl0(this.selection, ((TextFieldCharSequence) other).selection) && Intrinsics.areEqual(this.composition, ((TextFieldCharSequence) other).composition) && Intrinsics.areEqual(this.highlight, ((TextFieldCharSequence) other).highlight) && contentEquals(((TextFieldCharSequence) other).text)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result3 = (result2 + (textRange != null ? TextRange.m6147hashCodeimpl(textRange.getPackedValue()) : 0)) * 31;
