...
public final class HandwritingGesture_androidKt {
    ...
    public static final long m1163adjustHandwritingDeleteGestureRange72CqOWE(long $this$adjustHandwritingDeleteGestureRange_u2d72CqOWE, CharSequence text) {
        int codePointBeforeStart;
        int start = TextRange.m6146getStartimpl($this$adjustHandwritingDeleteGestureRange_u2d72CqOWE);
        int end = TextRange.m6141getEndimpl($this$adjustHandwritingDeleteGestureRange_u2d72CqOWE);
    ...
    public static final long m1172getRangeForScreenRectOH9lIzo(TextLayoutState $this$getRangeForScreenRect_u2dOH9lIzo, Rect rectInScreen, int granularity, TextInclusionStrategy inclusionStrategy) {
        TextLayoutResult layoutResult = $this$getRangeForScreenRect_u2dOH9lIzo.getLayoutResult();
        return m1170getRangeForScreenRectO048IG0(layoutResult != null ? layoutResult.getMultiParagraph() : null, rectInScreen, $this$getRangeForScreenRect_u2dOH9lIzo.getTextLayoutNodeCoordinates(), granularity, inclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRects-O048IG0, reason: not valid java name */
    public static final long m1174getRangeForScreenRectsO048IG0(TextLayoutState $this$getRangeForScreenRects_u2dO048IG0, Rect startRectInScreen, Rect endRectInScreen, int granularity, TextInclusionStrategy inclusionStrategy) {
        long startRange = m1172getRangeForScreenRectOH9lIzo($this$getRangeForScreenRects_u2dO048IG0, startRectInScreen, granularity, inclusionStrategy);
        if (TextRange.m6140getCollapsedimpl(startRange)) {
            return TextRange.INSTANCE.m6151getZerod9O1mEE();
        }
        long endRange = m1172getRangeForScreenRectOH9lIzo($this$getRangeForScreenRects_u2dO048IG0, endRectInScreen, granularity, inclusionStrategy);
        return TextRange.m6140getCollapsedimpl(endRange) ? TextRange.INSTANCE.m6151getZerod9O1mEE() : m1164enclosurepWDy79M(startRange, endRange);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRect-OH9lIzo, reason: not valid java name */
    public static final long m1171getRangeForScreenRectOH9lIzo(LegacyTextFieldState $this$getRangeForScreenRect_u2dOH9lIzo, Rect rectInScreen, int granularity, TextInclusionStrategy inclusionStrategy) {
        TextLayoutResult value;
        TextLayoutResultProxy layoutResult = $this$getRangeForScreenRect_u2dOH9lIzo.getLayoutResult();
        return m1170getRangeForScreenRectO048IG0((layoutResult == null || (value = layoutResult.getValue()) == null) ? null : value.getMultiParagraph(), rectInScreen, $this$getRangeForScreenRect_u2dOH9lIzo.getLayoutCoordinates(), granularity, inclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRects-O048IG0, reason: not valid java name */
    public static final long m1173getRangeForScreenRectsO048IG0(LegacyTextFieldState $this$getRangeForScreenRects_u2dO048IG0, Rect startRectInScreen, Rect endRectInScreen, int granularity, TextInclusionStrategy inclusionStrategy) {
    ...
    public static final int m1167getOffsetForHandwritingGestured4ec7I(TextLayoutState $this$getOffsetForHandwritingGesture_u2dd_u2d4ec7I, long pointInScreen, ViewConfiguration viewConfiguration) {
        ...
        if (layoutResult != null && (multiParagraph = layoutResult.getMultiParagraph()) != null) {
            return m1168getOffsetForHandwritingGestureubNVwUQ(multiParagraph, pointInScreen, $this$getOffsetForHandwritingGesture_u2dd_u2d4ec7I.getTextLayoutNodeCoordinates(), viewConfiguration);
        }
        return -1;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getOffsetForHandwritingGesture-d-4ec7I, reason: not valid java name */
    public static final int m1166getOffsetForHandwritingGestured4ec7I(LegacyTextFieldState $this$getOffsetForHandwritingGesture_u2dd_u2d4ec7I, long pointInScreen, ViewConfiguration viewConfiguration) {
        TextLayoutResult value;
        MultiParagraph multiParagraph;
        ...
        if (layoutResult != null && (value = layoutResult.getValue()) != null && (multiParagraph = value.getMultiParagraph()) != null) {
            return m1168getOffsetForHandwritingGestureubNVwUQ(multiParagraph, pointInScreen, $this$getOffsetForHandwritingGesture_u2dd_u2d4ec7I.getLayoutCoordinates(), viewConfiguration);
        }
        return -1;
    }
    ...
    private static final long m1170getRangeForScreenRectO048IG0(MultiParagraph $this$getRangeForScreenRect_u2dO048IG0, Rect rectInScreen, LayoutCoordinates layoutCoordinates, int granularity, TextInclusionStrategy inclusionStrategy) {
        if ($this$getRangeForScreenRect_u2dO048IG0 == null || layoutCoordinates == null) {
            return TextRange.INSTANCE.m6151getZerod9O1mEE();
        }
        long screenOriginInLocal = layoutCoordinates.mo5543screenToLocalMKHz9U(Offset.INSTANCE.m3961getZeroF1C5BW0());
        Rect localRect = rectInScreen.m3982translatek4lQ0M(screenOriginInLocal);
        return $this$getRangeForScreenRect_u2dO048IG0.m6013getRangeForRect86BmAI(localRect, granularity, inclusionStrategy);
    }

    /* renamed from: getOffsetForHandwritingGesture-ubNVwUQ, reason: not valid java name */
    private static final int m1168getOffsetForHandwritingGestureubNVwUQ(MultiParagraph $this$getOffsetForHandwritingGesture_u2dubNVwUQ, long pointInScreen, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        long localPoint;
        int line;
        if (layoutCoordinates == null || (line = m1165getLineForHandwritingGestured4ec7I($this$getOffsetForHandwritingGesture_u2dubNVwUQ, (localPoint = layoutCoordinates.mo5543screenToLocalMKHz9U(pointInScreen)), viewConfiguration)) == -1) {
            return -1;
        }
        long adjustedPoint = Offset.m3939copydBAh8RU$default(localPoint, 0.0f, ($this$getOffsetForHandwritingGesture_u2dubNVwUQ.getLineTop(line) + $this$getOffsetForHandwritingGesture_u2dubNVwUQ.getLineBottom(line)) / 2.0f, 1, null);
        return $this$getOffsetForHandwritingGesture_u2dubNVwUQ.m6012getOffsetForPositionk4lQ0M(adjustedPoint);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForRemoveSpaceGesture-5iVPX68, reason: not valid java name */
    public static final long m1169getRangeForRemoveSpaceGesture5iVPX68(TextLayoutResult $this$getRangeForRemoveSpaceGesture_u2d5iVPX68, long startPointInScreen, long endPointerInScreen, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        int iMin;
        int line;
        if ($this$getRangeForRemoveSpaceGesture_u2d5iVPX68 == null || layoutCoordinates == null) {
            return TextRange.INSTANCE.m6151getZerod9O1mEE();
        }
        long localStartPoint = layoutCoordinates.mo5543screenToLocalMKHz9U(startPointInScreen);
        long localEndPoint = layoutCoordinates.mo5543screenToLocalMKHz9U(endPointerInScreen);
        int startLine = m1165getLineForHandwritingGestured4ec7I($this$getRangeForRemoveSpaceGesture_u2d5iVPX68.getMultiParagraph(), localStartPoint, viewConfiguration);
        int endLine = m1165getLineForHandwritingGestured4ec7I($this$getRangeForRemoveSpaceGesture_u2d5iVPX68.getMultiParagraph(), localEndPoint, viewConfiguration);
        if (startLine == -1) {
            if (endLine == -1) {
                return TextRange.INSTANCE.m6151getZerod9O1mEE();
            }
        ...
        Rect rect = new Rect(Math.min(Offset.m3945getXimpl(localStartPoint), Offset.m3945getXimpl(localEndPoint)), lineCenter - 0.1f, Math.max(Offset.m3945getXimpl(localStartPoint), Offset.m3945getXimpl(localEndPoint)), lineCenter + 0.1f);
        return $this$getRangeForRemoveSpaceGesture_u2d5iVPX68.getMultiParagraph().m6013getRangeForRect86BmAI(rect, TextGranularity.INSTANCE.m6110getCharacterDRrd7Zo(), TextInclusionStrategy.INSTANCE.getAnyOverlap());
    }

    /* renamed from: getLineForHandwritingGesture-d-4ec7I, reason: not valid java name */
    private static final int m1165getLineForHandwritingGestured4ec7I(MultiParagraph $this$getLineForHandwritingGesture_u2dd_u2d4ec7I, long localPoint, ViewConfiguration viewConfiguration) {
        float lineMargin = viewConfiguration != null ? viewConfiguration.getHandwritingGestureLineMargin() : 0.0f;
        int line = $this$getLineForHandwritingGesture_u2dd_u2d4ec7I.getLineForVerticalPosition(Offset.m3946getYimpl(localPoint));
        if (Offset.m3946getYimpl(localPoint) < $this$getLineForHandwritingGesture_u2dd_u2d4ec7I.getLineTop(line) - lineMargin || Offset.m3946getYimpl(localPoint) > $this$getLineForHandwritingGesture_u2dd_u2d4ec7I.getLineBottom(line) + lineMargin || Offset.m3945getXimpl(localPoint) < (-lineMargin) || Offset.m3945getXimpl(localPoint) > $this$getLineForHandwritingGesture_u2dd_u2d4ec7I.getWidth() + lineMargin) {
            return -1;
        }
        return line;
    }
    ...
    private static final long m1164enclosurepWDy79M(long a, long b) {
        return TextRangeKt.TextRange(Math.min(TextRange.m6146getStartimpl(a), TextRange.m6146getStartimpl(a)), Math.max(TextRange.m6141getEndimpl(b), TextRange.m6141getEndimpl(b)));
    }
}
