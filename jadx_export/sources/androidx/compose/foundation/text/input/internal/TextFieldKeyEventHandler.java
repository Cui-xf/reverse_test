...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1140onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        long selection = textFieldState.getVisualText().getSelection();
        if (!TextRange.m6140getCollapsedimpl(selection) && KeyEventHelpers_androidKt.m1002cancelsTextSelectionZmokQxo(event)) {
    ...
    public boolean mo1139onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        boolean consumed;
        TextFieldPreparedSelection preparedSelection$iv;
        boolean consumed2;
        Integer codePoint;
        if (!KeyEventType.m5250equalsimpl0(KeyEvent_androidKt.m5258getTypeZmokQxo(event), KeyEventType.INSTANCE.m5254getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m1085isTypedEventZmokQxo(event) && (codePoint = this.deadKeyCombiner.m1001consumeZmokQxo(event)) != null) {
            String text = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), codePoint.intValue()).toString();
            if (!editable) {
                return false;
            }
            boolean restartImeIfContentChanges$iv = !TextFieldKeyEventHandler_androidKt.m1207isFromSoftKeyboardZmokQxo(event);
        ...
        KeyCommand command = this.keyMapping.mo1003mapZmokQxo(event);
        if (command == null) {
            return false;
        }
        ...
        boolean isFromSoftKeyboard$iv = TextFieldKeyEventHandler_androidKt.m1207isFromSoftKeyboardZmokQxo(event);
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[command.ordinal()]) {
            ...
            case 20:
                consumed = true;
                preparedSelection$iv = preparedSelection$iv2;
                if (TextRange.m6140getCollapsedimpl(preparedSelection$iv2.getSelection())) {
                    ...
                    if (numValueOf != null) {
                        ...
                        textRangeM6134boximpl = TextRange.m6134boximpl(TextRangeKt.TextRange(it2, TextRange.m6141getEndimpl(preparedSelection$iv2.getSelection())));
                    }
                    if (textRangeM6134boximpl != null) {
                        long it$iv = textRangeM6134boximpl.getPackedValue();
                        TransformedTextFieldState.m1228replaceTextM8tDOmk$default(preparedSelection$iv2.state, "", it$iv, null, !preparedSelection$iv2.isFromSoftKeyboard, 4, null);
                    }
                } else {
                    TransformedTextFieldState.m1228replaceTextM8tDOmk$default(preparedSelection$iv2.state, "", preparedSelection$iv2.getSelection(), null, !preparedSelection$iv2.isFromSoftKeyboard, 4, null);
                }
                consumed2 = consumed;
                break;
            case 21:
                ...
                if (TextRange.m6140getCollapsedimpl(preparedSelection$iv2.getSelection())) {
                    ...
                    if (numValueOf2 != null) {
                        ...
                        textRangeM6134boximpl = TextRange.m6134boximpl(TextRangeKt.TextRange(TextRange.m6146getStartimpl(preparedSelection$iv2.getSelection()), it4));
                    }
                    if (textRangeM6134boximpl != null) {
                        long it$iv2 = textRangeM6134boximpl.getPackedValue();
                        TransformedTextFieldState.m1228replaceTextM8tDOmk$default(preparedSelection$iv2.state, "", it$iv2, null, !preparedSelection$iv2.isFromSoftKeyboard, 4, null);
                    }
                } else {
                    TransformedTextFieldState.m1228replaceTextM8tDOmk$default(preparedSelection$iv2.state, "", preparedSelection$iv2.getSelection(), null, !preparedSelection$iv2.isFromSoftKeyboard, 4, null);
                }
            ...
            case 22:
                ...
                if (!TextRange.m6140getCollapsedimpl(preparedSelection$iv2.getSelection())) {
                    ...
                    TransformedTextFieldState.m1228replaceTextM8tDOmk$default(preparedSelection$iv2.state, "", TextRangeKt.TextRange(preparedSelection$iv2.getPreviousWordOffset(), TextRange.m6141getEndimpl(preparedSelection$iv2.getSelection())), null, !preparedSelection$iv2.isFromSoftKeyboard, 4, null);
                }
                consumed2 = consumed;
                break;
            case 23:
                ...
                if (!TextRange.m6140getCollapsedimpl(preparedSelection$iv2.getSelection())) {
                    ...
                    TransformedTextFieldState.m1228replaceTextM8tDOmk$default(preparedSelection$iv2.state, "", TextRangeKt.TextRange(TextRange.m6146getStartimpl(preparedSelection$iv2.getSelection()), preparedSelection$iv2.getNextWordOffset()), null, !preparedSelection$iv2.isFromSoftKeyboard, 4, null);
                }
                consumed2 = consumed;
                break;
            case 24:
                ...
                if (!TextRange.m6140getCollapsedimpl(preparedSelection$iv2.getSelection())) {
                    ...
                    TransformedTextFieldState.m1228replaceTextM8tDOmk$default(preparedSelection$iv2.state, "", TextRangeKt.TextRange(preparedSelection$iv2.getLineStartByOffset(), TextRange.m6141getEndimpl(preparedSelection$iv2.getSelection())), null, !preparedSelection$iv2.isFromSoftKeyboard, 4, null);
                }
                consumed2 = consumed;
                break;
            case 25:
                ...
                if (!TextRange.m6140getCollapsedimpl(preparedSelection$iv2.getSelection())) {
                    ...
                    TransformedTextFieldState.m1228replaceTextM8tDOmk$default(preparedSelection$iv2.state, "", TextRangeKt.TextRange(TextRange.m6146getStartimpl(preparedSelection$iv2.getSelection()), preparedSelection$iv2.getLineEndByOffset()), null, !preparedSelection$iv2.isFromSoftKeyboard, 4, null);
                }
                consumed2 = consumed;
                break;
            case 26:
        ...
        if (!TextRange.m6139equalsimpl0(preparedSelection$iv.getSelection(), preparedSelection$iv.getInitialValue().getSelection())) {
            textFieldState.m1235selectCharsIn5zctL8(preparedSelection$iv.getSelection());
        }
        return consumed2;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, boolean isFromSoftKeyboard, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (!TextRange.m6139equalsimpl0(preparedSelection.getSelection(), preparedSelection.getInitialValue().getSelection())) {
            state.m1235selectCharsIn5zctL8(preparedSelection.getSelection());
        }
    }
        ...
        if (textLayoutCoordinates != null) {
            ...
            if (textLayoutCoordinates != null) {
                ...
                if (it != null) {
                    ...
                    if (it != null) {
                        rectLocalBoundingBoxOf$default = LayoutCoordinates.CC.localBoundingBoxOf$default(it, textLayoutCoordinates, false, 2, null);
                    }
                }
                if (rectLocalBoundingBoxOf$default != null) {
                    return Size.m4011getHeightimpl(rectLocalBoundingBoxOf$default.m3978getSizeNHjbRc());
                }
            }
        }
        return Float.NaN;
