...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState $this$undo, TextUndoOperation op) {
        ...
        $this$undo_u24lambda_u240.setSelection(TextRange.m6146getStartimpl(op.getPreSelection()), TextRange.m6141getEndimpl(op.getPreSelection()));
        TextFieldCharSequence afterEditValue$iv = new TextFieldCharSequence($this$undo.getMainBuffer().toString(), $this$undo.getMainBuffer().m1145getSelectiond9O1mEE(), $this$undo.getMainBuffer().m1144getCompositionMzsxiRA(), null, 8, null);
    ...
    public static final void redo(TextFieldState $this$redo, TextUndoOperation op) {
        ...
        $this$redo_u24lambda_u241.setSelection(TextRange.m6146getStartimpl(op.getPostSelection()), TextRange.m6141getEndimpl(op.getPostSelection()));
        TextFieldCharSequence afterEditValue$iv = new TextFieldCharSequence($this$redo.getMainBuffer().toString(), $this$redo.getMainBuffer().m1145getSelectiond9O1mEE(), $this$redo.getMainBuffer().m1144getCompositionMzsxiRA(), null, 8, null);
