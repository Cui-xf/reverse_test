...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final TextLayoutResult m1209layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
    ...
    private final TextLayoutResult getOrComputeLayout(NonMeasureInputs nonMeasureInputs, MeasureInputs measureInputs) throws Throwable {
        CacheRecord $this$getOrComputeLayout_u24lambda_u243_u24lambda_u242_u24lambda_u241;
        ...
        if (cachedResult != null) {
            ...
            if ((visualText2 != null && StringsKt.contentEquals(visualText2, visualText)) && Intrinsics.areEqual(cachedRecord.getComposition(), visualText.getComposition()) && cachedRecord.getSingleLine() == nonMeasureInputs.getSingleLine() && cachedRecord.getSoftWrap() == nonMeasureInputs.getSoftWrap() && cachedRecord.getLayoutDirection() == measureInputs.getLayoutDirection()) {
                if (cachedRecord.getDensityValue() == measureInputs.getDensity().getDensity()) {
                    if ((cachedRecord.getFontScale() == measureInputs.getDensity().getFontScale()) && Constraints.m6629equalsimpl0(cachedRecord.getConstraints(), measureInputs.getConstraints()) && Intrinsics.areEqual(cachedRecord.getFontFamilyResolver(), measureInputs.getFontFamilyResolver()) && !cachedResult.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts()) {
        ...
        synchronized (lock$iv$iv$iv$iv) {
            try {
                $this$getOrComputeLayout_u24lambda_u243_u24lambda_u242_u24lambda_u241 = (CacheRecord) SnapshotKt.writableRecord($this$writable$iv$iv, this, snapshot$iv);
                $this$getOrComputeLayout_u24lambda_u243_u24lambda_u242_u24lambda_u241.setVisualText(visualText);
                $this$getOrComputeLayout_u24lambda_u243_u24lambda_u242_u24lambda_u241.m1212setCompositionOEnZFl4(visualText.getComposition());
            ...
            try {
                $this$getOrComputeLayout_u24lambda_u243_u24lambda_u242_u24lambda_u241.m1213setConstraintsBRTryo0(measureInputs.getConstraints());
    ...
    private static final class CacheRecord extends StateRecord {
        ...
        public final void m1212setCompositionOEnZFl4(TextRange textRange) {
        ...
        public final void m1213setConstraintsBRTryo0(long j) {
            this.constraints = j;
        }
    ...
    static final class MeasureInputs {
        ...
        private static final SnapshotMutationPolicy<MeasureInputs> mutationPolicy = new SnapshotMutationPolicy<MeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$MeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a, TextFieldLayoutStateCache.MeasureInputs b) {
                ...
                if (a.getDensityValue() == b.getDensityValue()) {
                    if ((a.getFontScale() == b.getFontScale()) && a.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.m6629equalsimpl0(a.getConstraints(), b.getConstraints())) {
                        return true;
                    }
                }
                return false;
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m6641toStringimpl(this.constraints)) + ')';
        }
