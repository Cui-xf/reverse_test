...
public final class TransformedTextFieldStateKt {
    public static final <R> R getIndexTransformationType(TransformedTextFieldState $this$getIndexTransformationType, int transformedQueryIndex, Function3<? super IndexTransformationType, ? super TextRange, ? super TextRange, ? extends R> function3) {
        ...
        long untransformed = $this$getIndexTransformationType.m1230mapFromTransformedjx7JFs(transformedQueryIndex);
        long retransformed = $this$getIndexTransformationType.m1233mapToTransformedGEjPoXI(untransformed);
        if (TextRange.m6140getCollapsedimpl(untransformed) && TextRange.m6140getCollapsedimpl(retransformed)) {
            type = IndexTransformationType.Untransformed;
        } else if (!TextRange.m6140getCollapsedimpl(untransformed) && !TextRange.m6140getCollapsedimpl(retransformed)) {
        ...
        return function3.invoke(type, TextRange.m6134boximpl(untransformed), TextRange.m6134boximpl(retransformed));
    }
}
