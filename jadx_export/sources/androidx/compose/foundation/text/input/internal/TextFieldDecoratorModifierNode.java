...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode {
    ...
    private final DragAndDropModifierNode dragAndDropNode = (DragAndDropModifierNode) delegate(TextFieldDragAndDropNode_androidKt.textFieldDragAndDropNode$default(new Function0<Set<? extends MediaType>>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$dragAndDropNode$1
        ...
        public final Boolean invoke(ClipEntry clipEntry, ClipMetadata clipMetadata) {
            ...
            if (receiveContentConfiguration != null) {
                TransferableContent transferableContent = new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m331getDragAndDropkB6V9T0(), null, 8, null);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
            m1204invokek4lQ0M(offset.getPackedValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m1204invokek4lQ0M(long position) {
            long positionOnTextField = TextLayoutStateKt.m1225fromWindowToDecorationUv8p0NA(this.this$0.getTextLayoutState(), position);
            int cursorPosition = TextLayoutState.m1215getOffsetForPosition3MmeM6k$default(this.this$0.getTextLayoutState(), positionOnTextField, false, 2, null);
            this.this$0.getTextFieldState().m1235selectCharsIn5zctL8(TextRangeKt.TextRange(cursorPosition));
            this.this$0.getTextFieldSelectionState().m1272updateHandleDraggingUv8p0NA(Handle.Cursor, positionOnTextField);
        }
    ...
    public /* synthetic */ void mo357onRemeasuredozmzZPI(long j) {
        LayoutAwareModifierNode.CC.m5687$default$onRemeasuredozmzZPI(this, j);
    }
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation filter, boolean enabled, boolean readOnly, final KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean singleLine, MutableInteractionSource interactionSource) {
        ...
        this.stylusHandwritingNode = (StylusHandwritingNode) delegate(new StylusHandwritingNode(new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$stylusHandwritingNode$1
            ...
            public final Boolean invoke() {
                ...
                if (!KeyboardType.m6366equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6385getPasswordPjHm6EE()) && !KeyboardType.m6366equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6384getNumberPasswordPjHm6EE()) && (stylusHandwritingTrigger = this.this$0.getStylusHandwritingTrigger()) != null) {
    ...
    public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
        ...
        SemanticsPropertiesKt.m5976setTextSelectionRangeFDrldGo($this$applySemantics, selection);
        if (!this.enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default($this$applySemantics, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.4
            ...
            public final Boolean invoke(int start, int end, boolean relativeToOriginal) {
                ...
                if (start == TextRange.m6146getStartimpl(selection2) && end == TextRange.m6141getEndimpl(selection2)) {
                    return true;
                }
                ...
                if (relativeToOriginal) {
                    textFieldDecoratorModifierNode2.getTextFieldState().m1236selectUntransformedCharsIn5zctL8(selectionRange);
                } else {
                    textFieldDecoratorModifierNode2.getTextFieldState().m1235selectCharsIn5zctL8(selectionRange);
                }
                return true;
            }
        }, 1, null);
        final int effectiveImeAction = this.keyboardOptions.m1018getImeActionOrDefaulteUduSuo$foundation_release();
        SemanticsPropertiesKt.m5971onImeAction9UiTYpY$default($this$applySemantics, effectiveImeAction, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            @Override // kotlin.jvm.functions.Function0
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.m1203onImeActionPerformedKlQnJC8(effectiveImeAction);
                return true;
            }
        }, 2, null);
        SemanticsPropertiesKt.onClick$default($this$applySemantics, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.6
            ...
            @Override // kotlin.jvm.functions.Function0
            public final Boolean invoke() {
                boolean zIsFocused = TextFieldDecoratorModifierNode.this.isFocused();
                TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = TextFieldDecoratorModifierNode.this;
                if (!zIsFocused) {
        ...
        if (!TextRange.m6140getCollapsedimpl(selection)) {
    ...
    public final void onFocusChange() {
        ...
        if (isFocused() && this.observeChangesJob == null) {
            this.observeChangesJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03421(null), 3, null);
        } else if (!isFocused()) {
    ...
    static final class C03421 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C03421(continuation);
        }
    ...
    public void mo203onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.stylusHandwritingNode.mo203onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputNode.mo203onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo204onPreKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1140onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* renamed from: onKeyEvent-ZmokQxo */
    public boolean mo202onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1139onKeyEvent6ptp14s(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.enabled && !this.readOnly, this.singleLine, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onKeyEvent$1
            {
                super(0);
            }
            ...
            public final void invoke2() {
                this.this$0.m1203onImeActionPerformedKlQnJC8(this.this$0.getKeyboardOptions().m1018getImeActionOrDefaulteUduSuo$foundation_release());
            }
        });
    }
    ...
    public final void startInputSession(boolean fromTap) {
        if (fromTap || this.keyboardOptions.getShowKeyboardOnFocusOrDefault$foundation_release()) {
            ...
            this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03441(receiveContentConfiguration, null), 3, null);
        }
    }
    ...
    static final class C03441 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03441(ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C03441> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C03441(this.$receiveContentConfiguration, continuation);
        }
        ...
        static final class C00521 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
            ...
            /* synthetic */ class C00531 extends FunctionReferenceImpl implements Function1<ImeAction, Unit> {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                    m1205invokeKlQnJC8(imeAction.getValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-KlQnJC8, reason: not valid java name */
                public final void m1205invokeKlQnJC8(int p0) {
                    ((TextFieldDecoratorModifierNode) this.receiver).m1203onImeActionPerformedKlQnJC8(p0);
                }
            }
        }
    }
    ...
    public final void m1203onImeActionPerformedKlQnJC8(final int imeAction) {
        if (ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6330getNoneeUduSuo()) || ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6326getDefaulteUduSuo()) || this.keyboardActionHandler == null) {
            this.keyboardActionScope.mo1004defaultKeyboardActionKlQnJC8(imeAction);
            return;
        }
        ...
        if (keyboardActionHandler != null) {
            keyboardActionHandler.onKeyboardAction(new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.keyboardActionScope.mo1004defaultKeyboardActionKlQnJC8(imeAction);
                }
            });
        }
    }
