...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m3961getZeroF1C5BW0();
    ...
    public long mo339calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long $this$takeOrElse_u2d3MmeM6k$iv = this.positionProvider.mo977provideF1C5BW0();
        if (!OffsetKt.m3964isSpecifiedk4lQ0M($this$takeOrElse_u2d3MmeM6k$iv)) {
            $this$takeOrElse_u2d3MmeM6k$iv = this.prevPosition;
        }
        this.prevPosition = $this$takeOrElse_u2d3MmeM6k$iv;
        long adjustment = this.handleReferencePoint.mo3791alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m6872getZeroYbymL2g(), layoutDirection);
        return IntOffset.m6829plusqkQi6aY(IntOffset.m6829plusqkQi6aY(anchorBounds.m6853getTopLeftnOccac(), IntOffsetKt.m6841roundk4lQ0M($this$takeOrElse_u2d3MmeM6k$iv)), adjustment);
    }
}
