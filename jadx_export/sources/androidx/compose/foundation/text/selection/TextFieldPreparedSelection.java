...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m6390copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), getSelection(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m6144getMinimpl(getSelection()), TextRange.m6144getMinimpl(getSelection()))});
    }
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r10, int r11) {
        ...
        L1c:
            ...
            int r1 = androidx.compose.ui.text.TextRange.m6141getEndimpl(r1)
            ...
            float r2 = r1.getLeft()
            float r4 = r1.getTop()
            long r5 = r3.m3978getSizeNHjbRc()
            float r5 = androidx.compose.ui.geometry.Size.m4011getHeightimpl(r5)
            float r6 = (float) r11
            float r5 = r5 * r6
            float r4 = r4 + r5
            ...
            int r6 = r6.m6118getOffsetForPositionk4lQ0M(r7)
