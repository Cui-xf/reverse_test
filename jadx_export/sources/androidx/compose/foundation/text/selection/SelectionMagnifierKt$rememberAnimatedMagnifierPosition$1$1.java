            ...
            case 0:
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1.1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3934boximpl(m1351invokeF1C5BW0());
                    }
                ...
                if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1.2
                    ...
                    public final Object m1352emit3MmeM6k(long targetValue, Continuation<? super Unit> continuation) {
                        if (OffsetKt.m3964isSpecifiedk4lQ0M(animatable.getValue().getPackedValue()) && OffsetKt.m3964isSpecifiedk4lQ0M(targetValue)) {
                            if (!(Offset.m3946getYimpl(animatable.getValue().getPackedValue()) == Offset.m3946getYimpl(targetValue))) {
                        ...
                        Object objSnapTo = animatable.snapTo(Offset.m3934boximpl(targetValue), continuation);
