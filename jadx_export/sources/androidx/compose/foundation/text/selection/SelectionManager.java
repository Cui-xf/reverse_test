...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3934boximpl(Offset.INSTANCE.m3961getZeroF1C5BW0()), null, 2, null);

    /* renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3934boximpl(Offset.INSTANCE.m3961getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        this.selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public final void m1376invokeRg1IO4c(boolean isInTouchMode, LayoutCoordinates layoutCoordinates, long rawPosition, SelectionAdjustment selectionMode) {
                long position;
                long $this$invoke_Rg1IO4c_u24lambda_u240 = layoutCoordinates.mo5537getSizeYbymL2g();
                Rect textRect = new Rect(0.0f, 0.0f, IntSize.m6867getWidthimpl($this$invoke_Rg1IO4c_u24lambda_u240), IntSize.m6866getHeightimpl($this$invoke_Rg1IO4c_u24lambda_u240));
                if (SelectionManagerKt.m1381containsInclusiveUv8p0NA(textRect, rawPosition)) {
                    position = rawPosition;
                } else {
                    position = TextLayoutStateKt.m1222coerceIn3MmeM6k(rawPosition, textRect);
                }
                long positionInContainer = SelectionManager.this.m1360convertToContainerCoordinatesR5De75A(layoutCoordinates, position);
                if (OffsetKt.m3964isSpecifiedk4lQ0M(positionInContainer)) {
        ...
        this.selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public final Boolean m1377invokepGV3PM0(boolean isInTouchMode, LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment selectionMode) {
                ...
                SelectionManager.this.setInTouchMode(isInTouchMode);
                return Boolean.valueOf(SelectionManager.this.m1375updateSelectionqNKwrvQ$foundation_release(Offset.m3934boximpl(newPositionInContainer), previousPositionInContainer, isStartHandle, selectionMode));
            }
        });
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1378invokeZmokQxo(keyEvent.m5246unboximpl());
            }
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates value) {
        ...
        if (getHasFocus() && getSelection() != null) {
            Offset positionInWindow = value != null ? Offset.m3934boximpl(LayoutCoordinatesKt.positionInWindow(value)) : null;
    ...
    public final void updateHandleOffsets() {
        ...
        if (startLayoutCoordinates != null) {
            ...
            long handlePosition = startSelectable.mo1330getHandlePositiondBAh8RU(selection, true);
            if (OffsetKt.m3966isUnspecifiedk4lQ0M(handlePosition)) {
                offsetM3934boximpl = null;
            } else {
                long position = containerCoordinates.mo5538localPositionOfR5De75A(handleCoordinates, handlePosition);
                offsetM3934boximpl = Offset.m3934boximpl(position);
                long it = offsetM3934boximpl.getPackedValue();
        ...
        if (endLayoutCoordinates != null) {
            ...
            long handlePosition2 = endSelectable.mo1330getHandlePositiondBAh8RU(selection, false);
            if (OffsetKt.m3966isUnspecifiedk4lQ0M(handlePosition2)) {
                offset2 = null;
            } else {
                long position2 = containerCoordinates.mo5538localPositionOfR5De75A(handleCoordinates2, handlePosition2);
                Offset offsetM3934boximpl2 = Offset.m3934boximpl(position2);
                long it2 = offsetM3934boximpl2.getPackedValue();
                if (!(getDraggingHandle() == Handle.SelectionEnd || SelectionManagerKt.m1381containsInclusiveUv8p0NA(visibleBounds, it2))) {
                    offsetM3934boximpl2 = null;
                }
                offset2 = offsetM3934boximpl2;
            }
        } else {
            offset2 = null;
        }
    ...
    public final void updateSelectionToolbar() {
        ...
        if (getHasFocus() && (textToolbar = this.textToolbar) != null) {
            if (this.showToolbar && isInTouchMode()) {
                ...
                TextToolbar.CC.showMenu$default(textToolbar, rect, isNonEmptySelection$foundation_release() ? new C03761(this) : null, null, null, isEntireContainerSelected$foundation_release() ? null : new C03772(this), 12, null);
                return;
            }
    ...
    /* synthetic */ class C03761 extends FunctionReferenceImpl implements Function0<Unit> {
        C03761(Object obj) {
    ...
    /* synthetic */ class C03772 extends FunctionReferenceImpl implements Function0<Unit> {
        C03772(Object obj) {
    ...
    private final Rect getContentRect() {
        ...
        Rect rootRect = visibleRect.m3982translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(containerCoordinates));
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo1064onDownk4lQ0M(long point) {
                ...
                SelectionManager selectionManager = this;
                Offset offsetM1373getStartHandlePosition_m7T9E = z ? selectionManager.m1373getStartHandlePosition_m7T9E() : selectionManager.m1372getEndHandlePosition_m7T9E();
                ...
                long handlePosition = selectable.mo1330getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3966isUnspecifiedk4lQ0M(handlePosition)) {
                    return;
                }
                long beginCoordinates = SelectionHandlesKt.m1344getAdjustedCoordinatesk4lQ0M(handlePosition);
                this.m1362setCurrentDragPosition_kEHs6E(Offset.m3934boximpl(this.requireContainerCoordinates$foundation_release().mo5538localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates)));
            ...
            public void mo1066onStartk4lQ0M(long startPoint) {
                ...
                long handlePosition = selectable2.mo1330getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3966isUnspecifiedk4lQ0M(handlePosition)) {
                    return;
                }
                long beginCoordinates = SelectionHandlesKt.m1344getAdjustedCoordinatesk4lQ0M(handlePosition);
                this.m1363setDragBeginPositionk4lQ0M(this.requireContainerCoordinates$foundation_release().mo5538localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates));
                this.m1364setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3961getZeroF1C5BW0());
            }
            ...
            public void mo1065onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1364setDragTotalDistancek4lQ0M(Offset.m3950plusMKHz9U(selectionManager.m1371getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long endPosition = Offset.m3950plusMKHz9U(this.m1370getDragBeginPositionF1C5BW0$foundation_release(), this.m1371getDragTotalDistanceF1C5BW0$foundation_release());
                boolean consumed = this.m1375updateSelectionqNKwrvQ$foundation_release(Offset.m3934boximpl(endPosition), this.m1370getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate());
                if (consumed) {
    ...
    static final class C03732 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03732(Function1<? super Offset, Unit> function1, Continuation<? super C03732> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03732 c03732 = new C03732(this.$onTap, continuation);
            c03732.L$0 = obj;
            return c03732;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C03732) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c03732 = this;
                    AwaitPointerEventScope $this$awaitEachGesture = (AwaitPointerEventScope) c03732.L$0;
                    c03732.label = 1;
                    Object objWaitForUpOrCancellation$default = TapGestureDetectorKt.waitForUpOrCancellation$default($this$awaitEachGesture, null, c03732, 1, null);
            ...
            if (it != null) {
                c03732.$onTap.invoke(Offset.m3934boximpl(it.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope $this$detectNonConsumingTap, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture($this$detectNonConsumingTap, new C03732(function1, null), continuation);
    ...
    static final class C03751 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03751 c03751 = SelectionManager.this.new C03751(this.$block, continuation);
            c03751.L$0 = obj;
            return c03751;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C03751) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    private final Modifier onClearSelectionRequested(Modifier $this$onClearSelectionRequested, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput($this$onClearSelectionRequested, Unit.INSTANCE, new C03751(function0, null)) : $this$onClearSelectionRequested;
    }
    ...
    public final long m1360convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        ...
        return requireContainerCoordinates$foundation_release().mo5538localPositionOfR5De75A(layoutCoordinates, offset);
    }
    ...
    public final void m1367startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1374updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m3960getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }
    ...
    public final boolean m1374updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        m1362setCurrentDragPosition_kEHs6E(Offset.m3934boximpl(position));
    ...
    private final SelectionLayout m1361getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
        ...
        Selection previousSelection = OffsetKt.m3966isUnspecifiedk4lQ0M(previousHandlePosition) ? null : getSelection();
    ...
    public final void m1368contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        boolean isEmptySelection = selection != null ? TextRange.m6140getCollapsedimpl(selection.m1336toTextRanged9O1mEE()) : true;
        if (isEmptySelection) {
