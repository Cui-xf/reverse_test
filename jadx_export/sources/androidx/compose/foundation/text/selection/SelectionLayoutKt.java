...
public final class SelectionLayoutKt {
    ...
    public static final SelectionLayout m1347getTextFieldSelectionLayoutRcvTLA(TextLayoutResult layoutResult, int rawStartHandleOffset, int rawEndHandleOffset, int rawPreviousHandleOffset, long previousSelectionRange, boolean isStartOfSelection, boolean isStartHandle) {
        return new SingleSelectionLayout(isStartHandle, 1, 1, isStartOfSelection ? null : new Selection(new Selection.AnchorInfo(getTextDirectionForOffset(layoutResult, TextRange.m6146getStartimpl(previousSelectionRange)), TextRange.m6146getStartimpl(previousSelectionRange), 1L), new Selection.AnchorInfo(getTextDirectionForOffset(layoutResult, TextRange.m6141getEndimpl(previousSelectionRange)), TextRange.m6141getEndimpl(previousSelectionRange), 1L), TextRange.m6145getReversedimpl(previousSelectionRange)), new SelectableInfo(1L, 1, rawStartHandleOffset, rawEndHandleOffset, rawPreviousHandleOffset, layoutResult));
    }
