...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode {
    ...
    public final void m232setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private BackgroundNode(long color, Brush brush, float alpha, Shape shape) {
        ...
        this.alpha = alpha;
        this.shape = shape;
        this.lastSize = Size.INSTANCE.m4022getUnspecifiedNHjbRc();
    }
    ...
    private final void drawRect(ContentDrawScope $this$drawRect) {
        if (!Color.m4188equalsimpl0(this.color, Color.INSTANCE.m4223getUnspecified0d7_KjU())) {
            DrawScope.CC.m4747drawRectnJ9OG0$default($this$drawRect, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush it = this.brush;
        if (it != null) {
            DrawScope.CC.m4746drawRectAsUm42w$default($this$drawRect, it, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope $this$drawOutline) {
        ...
        if (!Color.m4188equalsimpl0(this.color, Color.INSTANCE.m4223getUnspecified0d7_KjU())) {
            OutlineKt.m4451drawOutlinewDX37Ww($this$drawOutline, outline, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m4751getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush it = this.brush;
        if (it != null) {
            OutlineKt.m4449drawOutlinehn5TExg($this$drawOutline, outline, it, (56 & 4) != 0 ? 1.0f : this.alpha, (56 & 8) != 0 ? Fill.INSTANCE : null, (56 & 16) != 0 ? null : null, (56 & 32) != 0 ? DrawScope.INSTANCE.m4751getDefaultBlendMode0nO6VwU() : 0);
        }
    }
    ...
    private final Outline getOutline(final ContentDrawScope $this$getOutline) {
        ...
        if (Size.m4010equalsimpl0($this$getOutline.mo4662getSizeNHjbRc(), this.lastSize) && $this$getOutline.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            ?? r1 = this.lastOutline;
            ...
            ObserverModifierNodeKt.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.foundation.BackgroundNode.getOutline.1
                ...
                public final void invoke2() {
                    outline.element = this.getShape().mo278createOutlinePq9zytI($this$getOutline.mo4662getSizeNHjbRc(), $this$getOutline.getLayoutDirection(), $this$getOutline);
                }
            });
        }
        this.lastOutline = (Outline) outline.element;
        this.lastSize = $this$getOutline.mo4662getSizeNHjbRc();
