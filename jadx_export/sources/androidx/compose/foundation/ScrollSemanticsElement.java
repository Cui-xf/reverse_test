...
final /* data */ class ScrollSemanticsElement extends ModifierNodeElement<ScrollSemanticsModifierNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((this.state.hashCode() * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.reverseScrolling)) * 31) + (this.flingBehavior == null ? 0 : this.flingBehavior.hashCode())) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isScrollable)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isVertical);
    }
