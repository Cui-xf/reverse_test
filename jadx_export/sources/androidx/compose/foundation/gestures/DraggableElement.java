...
public final class DraggableElement extends ModifierNodeElement<DraggableNode> {
    ...
    public int hashCode() {
        ...
        int result2 = ((((result * 31) + this.orientation.hashCode()) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.enabled)) * 31;
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        return ((((((((result2 + (mutableInteractionSource != null ? mutableInteractionSource.hashCode() : 0)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.startDragImmediately)) * 31) + this.onDragStarted.hashCode()) * 31) + this.onDragStopped.hashCode()) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.reverseDirection);
    }
