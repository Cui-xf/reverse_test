...
final class AnchoredDraggableElement<T> extends ModifierNodeElement<AnchoredDraggableNode<T>> {
    ...
    public int hashCode() {
        ...
        int result4 = (((result3 + (mutableInteractionSource != null ? mutableInteractionSource.hashCode() : 0)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.startDragImmediately)) * 31;
