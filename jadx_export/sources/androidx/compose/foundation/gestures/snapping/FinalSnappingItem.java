...
public final class FinalSnappingItem {
    ...
    private static final int ClosestItem = m514constructorimpl(0);
    private static final int NextItem = m514constructorimpl(1);
    private static final int PreviousItem = m514constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FinalSnappingItem m513boximpl(int i) {
        return new FinalSnappingItem(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m514constructorimpl(int i) {
        return i;
    }
    ...
    public static int m517hashCodeimpl(int i) {
        return i;
    }
