...
public final class PagerSnapLayoutInfoProviderKt {
    ...
    public static final float dragGestureDelta(PagerState $this$dragGestureDelta) {
        if ($this$dragGestureDelta.getLayoutInfo().getOrientation() == Orientation.Horizontal) {
            return Offset.m3945getXimpl($this$dragGestureDelta.m936getUpDownDifferenceF1C5BW0$foundation_release());
        }
        return Offset.m3946getYimpl($this$dragGestureDelta.m936getUpDownDifferenceF1C5BW0$foundation_release());
    }
    ...
    public static final float calculateFinalSnappingBound(PagerState pagerState, LayoutDirection layoutDirection, float snapPositionalThreshold, float flingVelocity, float lowerBoundOffset, float upperBoundOffset) {
        ...
        if (FinalSnappingItem.m516equalsimpl0(finalSnappingItem, FinalSnappingItem.INSTANCE.m520getClosestItembbeMdSM())) {
            return Math.abs(offsetFromSnappedPositionOverflow) <= snapPositionalThreshold ? upperBoundOffset : upperBoundOffset;
        }
        if (!FinalSnappingItem.m516equalsimpl0(finalSnappingItem, FinalSnappingItem.INSTANCE.m521getNextItembbeMdSM())) {
            if (!FinalSnappingItem.m516equalsimpl0(finalSnappingItem, FinalSnappingItem.INSTANCE.m522getPreviousItembbeMdSM())) {
                return 0.0f;
            }
