...
public final class ScrollExtensionsKt {
    ...
    */
    public static final java.lang.Object animateScrollBy(androidx.compose.foundation.gestures.ScrollableState r7, float r8, androidx.compose.animation.core.AnimationSpec<java.lang.Float> r9, kotlin.coroutines.Continuation<? super java.lang.Float> r10) {
        ...
        L35:
            ...
            r5 = 1
            r6 = 0
            java.lang.Object r8 = androidx.compose.foundation.gestures.ScrollableState.CC.scroll$default(r1, r2, r3, r4, r5, r6)
            if (r8 != r0) goto L56
            return r0
        L56:
            float r8 = r7.element
    ...
    */
    public static final java.lang.Object scrollBy(androidx.compose.foundation.gestures.ScrollableState r7, float r8, kotlin.coroutines.Continuation<? super java.lang.Float> r9) {
        /*
            boolean r0 = r9 instanceof androidx.compose.foundation.gestures.ScrollExtensionsKt.C02521
            if (r0 == 0) goto L14
            r0 = r9
            androidx.compose.foundation.gestures.ScrollExtensionsKt$scrollBy$1 r0 = (androidx.compose.foundation.gestures.ScrollExtensionsKt.C02521) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    static final class C02532 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02532(Ref.FloatRef floatRef, float f, Continuation<? super C02532> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02532 c02532 = new C02532(this.$consumed, this.$value, continuation);
            c02532.L$0 = obj;
            return c02532;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(ScrollScope scrollScope, Continuation<? super Unit> continuation) {
            return ((C02532) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class C02542 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        ...
        C02542(Continuation<? super C02542> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02542(continuation);
        }
    ...
    public static final Object stopScroll(ScrollableState $this$stopScroll, MutatePriority scrollPriority, Continuation<? super Unit> continuation) {
        Object objScroll = $this$stopScroll.scroll(scrollPriority, new C02542(null), continuation);
