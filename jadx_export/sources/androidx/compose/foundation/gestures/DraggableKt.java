...
public final class DraggableKt {
    ...
    public static final DraggableState rememberDraggableState(Function1<? super Float, Unit> function1, Composer $composer, int $changed) {
        Object value$iv;
        ComposerKt.sourceInformationMarkerStart($composer, -183245213, "C(rememberDraggableState)137@5893L29,138@5934L61:Draggable.kt#8bwon0");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-183245213, $changed, -1, "androidx.compose.foundation.gestures.rememberDraggableState (Draggable.kt:136)");
        }
    ...
    public static final float m440toFloat3MmeM6k(long $this$toFloat_u2d3MmeM6k, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m3946getYimpl($this$toFloat_u2d3MmeM6k) : Offset.m3945getXimpl($this$toFloat_u2d3MmeM6k);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m441toFloatsFctU(long $this$toFloat_u2dsF_u2dc_u2dtU, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m6935getYimpl($this$toFloat_u2dsF_u2dc_u2dtU) : Velocity.m6934getXimpl($this$toFloat_u2dsF_u2dc_u2dtU);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m442toValidVelocityTH1AsA0(long $this$toValidVelocity_u2dTH1AsA0) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m6934getXimpl($this$toValidVelocity_u2dTH1AsA0)) ? 0.0f : Velocity.m6934getXimpl($this$toValidVelocity_u2dTH1AsA0), Float.isNaN(Velocity.m6935getYimpl($this$toValidVelocity_u2dTH1AsA0)) ? 0.0f : Velocity.m6935getYimpl($this$toValidVelocity_u2dTH1AsA0));
    }
}
