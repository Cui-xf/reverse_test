    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), Offset.m3934boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
                Offset offsetM3934boximpl = Offset.m3934boximpl(this.$offset);
                ...
                Function1<AnimationScope<Offset, AnimationVector2D>, Unit> function1 = new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2.1
                    ...
                    public final void invoke2(AnimationScope<Offset, AnimationVector2D> animationScope) {
                        long delta = Offset.m3949minusMKHz9U(animationScope.getValue().getPackedValue(), longRef.element);
                        TransformScope.CC.m505transformByd4ec7I$default($this$transform, 0.0f, delta, 0.0f, 5, null);
                        longRef.element = animationScope.getValue().getPackedValue();
                    }
                };
                this.label = 1;
                if (SuspendAnimationKt.animateTo(animationState, offsetM3934boximpl, (4 & 2) != 0 ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : animationSpec, (4 & 4) != 0 ? false : false, (4 & 8) != 0 ? SuspendAnimationKt.C02042.INSTANCE : function1, this) != coroutine_suspended) {
                    break;
                } else {
