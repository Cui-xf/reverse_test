...
final class TransformableElement extends ModifierNodeElement<TransformableNode> {
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + this.canPan.hashCode()) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.lockRotationOnZoomPan)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.enabled);
    }
