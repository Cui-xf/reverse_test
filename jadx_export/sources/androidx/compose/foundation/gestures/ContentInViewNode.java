...
public final class ContentInViewNode extends Modifier.Node implements BringIntoViewResponder, LayoutAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    private long viewportSize = IntSize.INSTANCE.m6872getZeroYbymL2g();
    ...
    public Rect calculateRectForParent(Rect localRect) {
        if (IntSize.m6865equalsimpl0(this.viewportSize, IntSize.INSTANCE.m6872getZeroYbymL2g())) {
            throw new IllegalStateException("Expected BringIntoViewRequester to not be used before parents are placed.".toString());
        }
        return m391computeDestinationO0kMr_c(localRect, this.viewportSize);
    }
    ...
    public Object bringChildIntoView(Function0<Rect> function0, Continuation<? super Unit> continuation) {
        ...
        boolean z = false;
        if (rectInvoke != null && !m393isMaxVisibleO0kMr_c$default(this, rectInvoke, 0L, 1, null)) {
            z = true;
        }
        if (!z) {
    ...
    public void mo357onRemeasuredozmzZPI(long size) {
        ...
        if (m389compareToTemP2vQ(size, oldSize) < 0 && (focusedChild = getFocusedChildBounds()) != null) {
            ...
            if (!this.isAnimationRunning && !this.trackingFocusedChild && m392isMaxVisibleO0kMr_c(previousFocusedChildBounds, oldSize) && !m392isMaxVisibleO0kMr_c(focusedChild, size)) {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Type inference failed for: r1v2, types: [androidx.compose.foundation.gestures.ContentInViewNode$launchAnimation$2] */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) throws Throwable {
            CancellationException cancellationException;
            AnonymousClass2 anonymousClass2;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            AnonymousClass2 anonymousClass22 = this.label;
            try {
                switch (anonymousClass22) {
                    case 0:
                        ResultKt.throwOnFailure(obj);
                        anonymousClass22 = this;
                        Job job = JobKt.getJob(((CoroutineScope) anonymousClass22.L$0).getCoroutineContext());
                        try {
                            ContentInViewNode.this.isAnimationRunning = true;
                            anonymousClass22.label = 1;
                            if (ContentInViewNode.this.scrollingLogic.scroll(MutatePriority.Default, new AnonymousClass1(anonymousClass22.$animationState, ContentInViewNode.this, anonymousClass22.$bringIntoViewSpec, job, null), (Continuation) anonymousClass22) == coroutine_suspended) {
                    ...
                    case 0:
                        ...
                        Function1<Float, Unit> function1 = new Function1<Float, Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewNode.launchAnimation.2.1.1
                            ...
                            public final void invoke(float delta) {
                                ...
                                float consumedScroll = $this$invoke_u24lambda_u240.m494toFloatk4lQ0M($this$invoke_u24lambda_u240.m492reverseIfNeededMKHz9U($this$scroll.mo448scrollByOzD1aCk($this$invoke_u24lambda_u240.m492reverseIfNeededMKHz9U($this$invoke_u24lambda_u240.m495toOffsettuRUvjQ(adjustedDelta)), NestedScrollSource.INSTANCE.m5298getUserInputWNlRxjI()))) * scrollMultiplier;
                        ...
                        if (updatableAnimationState.animateToZero(function1, new Function0<Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewNode.launchAnimation.2.1.2
                            ...
                            public final void invoke2() {
                                ...
                                while (true) {
                                    ...
                                    if (!(bounds == null ? true : ContentInViewNode.m393isMaxVisibleO0kMr_c$default(contentInViewNode3, bounds, 0L, 1, null))) {
                                        break;
                                    }
                                    ...
                                    continuation.resumeWith(Result.m6999constructorimpl(unit));
                                }
                                if (contentInViewNode2.trackingFocusedChild) {
                                    Rect focusedChildBounds = contentInViewNode2.getFocusedChildBounds();
                                    if (focusedChildBounds != null && ContentInViewNode.m393isMaxVisibleO0kMr_c$default(contentInViewNode2, focusedChildBounds, 0L, 1, null)) {
    ...
    public final float calculateScrollDelta(BringIntoViewSpec bringIntoViewSpec) {
        ...
        long size = IntSizeKt.m6879toSizeozmzZPI(this.viewportSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return bringIntoViewSpec.calculateScrollDistance(rectangleToMakeVisible.getTop(), rectangleToMakeVisible.getBottom() - rectangleToMakeVisible.getTop(), Size.m4011getHeightimpl(size));
            case 2:
                return bringIntoViewSpec.calculateScrollDistance(rectangleToMakeVisible.getLeft(), rectangleToMakeVisible.getRight() - rectangleToMakeVisible.getLeft(), Size.m4014getWidthimpl(size));
            default:
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                if (bounds != null) {
                    Rect rect2 = rect;
                    this_$iv = this_$iv2;
                    if (m390compareToiLBOSCw(bounds.m3978getSizeNHjbRc(), IntSizeKt.m6879toSizeozmzZPI(this.viewportSize)) > 0) {
    ...
    private final Rect m391computeDestinationO0kMr_c(Rect childBounds, long containerSize) {
        return childBounds.m3982translatek4lQ0M(Offset.m3954unaryMinusF1C5BW0(m394relocationOffsetBMxPBkI(childBounds, containerSize)));
    }

    /* renamed from: isMaxVisible-O0kMr_c$default, reason: not valid java name */
    static /* synthetic */ boolean m393isMaxVisibleO0kMr_c$default(ContentInViewNode contentInViewNode, Rect rect, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = contentInViewNode.viewportSize;
        }
        return contentInViewNode.m392isMaxVisibleO0kMr_c(rect, j);
    }

    /* renamed from: isMaxVisible-O0kMr_c, reason: not valid java name */
    private final boolean m392isMaxVisibleO0kMr_c(Rect $this$isMaxVisible_u2dO0kMr_c, long size) {
        long relocationOffset = m394relocationOffsetBMxPBkI($this$isMaxVisible_u2dO0kMr_c, size);
        return Math.abs(Offset.m3945getXimpl(relocationOffset)) <= 0.5f && Math.abs(Offset.m3946getYimpl(relocationOffset)) <= 0.5f;
    }

    /* renamed from: relocationOffset-BMxPBkI, reason: not valid java name */
    private final long m394relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long size = IntSizeKt.m6879toSizeozmzZPI(containerSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return OffsetKt.Offset(0.0f, requireBringIntoViewSpec().calculateScrollDistance(childBounds.getTop(), childBounds.getBottom() - childBounds.getTop(), Size.m4011getHeightimpl(size)));
            case 2:
                return OffsetKt.Offset(requireBringIntoViewSpec().calculateScrollDistance(childBounds.getLeft(), childBounds.getRight() - childBounds.getLeft(), Size.m4014getWidthimpl(size)), 0.0f);
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    private final int m389compareToTemP2vQ(long $this$compareTo_u2dTemP2vQ, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Intrinsics.compare(IntSize.m6866getHeightimpl($this$compareTo_u2dTemP2vQ), IntSize.m6866getHeightimpl(other));
            case 2:
                return Intrinsics.compare(IntSize.m6867getWidthimpl($this$compareTo_u2dTemP2vQ), IntSize.m6867getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    private final int m390compareToiLBOSCw(long $this$compareTo_u2diLBOSCw, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Float.compare(Size.m4011getHeightimpl($this$compareTo_u2diLBOSCw), Size.m4011getHeightimpl(other));
            case 2:
                return Float.compare(Size.m4014getWidthimpl($this$compareTo_u2diLBOSCw), Size.m4014getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
