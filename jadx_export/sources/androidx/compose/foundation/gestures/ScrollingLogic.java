...
public final class ScrollingLogic {
    ...
    private int latestScrollSource = NestedScrollSource.INSTANCE.m5298getUserInputWNlRxjI();
    ...
    private final ScrollingLogic$nestedScrollScope$1 nestedScrollScope = new NestedScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$nestedScrollScope$1
        ...
        public long mo448scrollByOzD1aCk(long offset, int source) {
            ScrollScope $this$scrollBy_OzD1aCk_u24lambda_u240 = this.this$0.outerStateScope;
            return this.this$0.m485performScroll3eAAhYA($this$scrollBy_OzD1aCk_u24lambda_u240, offset, source);
        }

        @Override // androidx.compose.foundation.gestures.NestedScrollScope
        /* renamed from: scrollByWithOverscroll-OzD1aCk */
        public long mo449scrollByWithOverscrollOzD1aCk(long offset, int source) {
            ...
            if (overscroll == null || !this.this$0.getShouldDispatchOverscroll()) {
                ...
                return this.this$0.m485performScroll3eAAhYA($this$scrollByWithOverscroll_OzD1aCk_u24lambda_u241, offset, source);
            }
            return overscroll.mo212applyToScrollRhakbz0(offset, this.this$0.latestScrollSource, this.this$0.performScrollForOverscroll);
        }
    };
    private final Function1<Offset, Offset> performScrollForOverscroll = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$performScrollForOverscroll$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
            return Offset.m3934boximpl(m497invokeMKHz9U(offset.getPackedValue()));
        }

        /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
        public final long m497invokeMKHz9U(long delta) {
            ScrollScope $this$invoke_MK_Hz9U_u24lambda_u240 = this.this$0.outerStateScope;
            ScrollingLogic scrollingLogic = this.this$0;
            return scrollingLogic.m485performScroll3eAAhYA($this$invoke_MK_Hz9U_u24lambda_u240, delta, scrollingLogic.latestScrollSource);
        }
    };
    ...
    public final long m495toOffsettuRUvjQ(float $this$toOffset_u2dtuRUvjQ) {
    ...
    public final long m493singleAxisOffsetMKHz9U(long $this$singleAxisOffset_u2dMK_u2dHz9U) {
        return this.orientation == Orientation.Horizontal ? Offset.m3939copydBAh8RU$default($this$singleAxisOffset_u2dMK_u2dHz9U, 0.0f, 0.0f, 1, null) : Offset.m3939copydBAh8RU$default($this$singleAxisOffset_u2dMK_u2dHz9U, 0.0f, 0.0f, 2, null);
    }

    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m494toFloatk4lQ0M(long $this$toFloat_u2dk_u2d4lQ0M) {
        return this.orientation == Orientation.Horizontal ? Offset.m3945getXimpl($this$toFloat_u2dk_u2d4lQ0M) : Offset.m3946getYimpl($this$toFloat_u2dk_u2d4lQ0M);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-TH1AsA0, reason: not valid java name */
    public final float m487toFloatTH1AsA0(long $this$toFloat_u2dTH1AsA0) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6934getXimpl($this$toFloat_u2dTH1AsA0) : Velocity.m6935getYimpl($this$toFloat_u2dTH1AsA0);
    }

    /* renamed from: singleAxisVelocity-AH228Gc, reason: not valid java name */
    private final long m486singleAxisVelocityAH228Gc(long $this$singleAxisVelocity_u2dAH228Gc) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6930copyOhffZ5M$default($this$singleAxisVelocity_u2dAH228Gc, 0.0f, 0.0f, 1, null) : Velocity.m6930copyOhffZ5M$default($this$singleAxisVelocity_u2dAH228Gc, 0.0f, 0.0f, 2, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: update-QWom1Mo, reason: not valid java name */
    public final long m488updateQWom1Mo(long $this$update_u2dQWom1Mo, float newValue) {
        return this.orientation == Orientation.Horizontal ? Velocity.m6930copyOhffZ5M$default($this$update_u2dQWom1Mo, newValue, 0.0f, 2, null) : Velocity.m6930copyOhffZ5M$default($this$update_u2dQWom1Mo, 0.0f, newValue, 1, null);
    }
    ...
    public final long m492reverseIfNeededMKHz9U(long $this$reverseIfNeeded_u2dMK_u2dHz9U) {
        return this.reverseDirection ? Offset.m3952timestuRUvjQ($this$reverseIfNeeded_u2dMK_u2dHz9U, -1.0f) : $this$reverseIfNeeded_u2dMK_u2dHz9U;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: performScroll-3eAAhYA, reason: not valid java name */
    public final long m485performScroll3eAAhYA(ScrollScope $this$performScroll_u2d3eAAhYA, long delta, int source) {
        long consumedByPreScroll = this.nestedScrollDispatcher.m5282dispatchPreScrollOzD1aCk(delta, source);
        long scrollAvailableAfterPreScroll = Offset.m3949minusMKHz9U(delta, consumedByPreScroll);
        float singleAxisDeltaForSelfScroll = m494toFloatk4lQ0M(m492reverseIfNeededMKHz9U(m493singleAxisOffsetMKHz9U(scrollAvailableAfterPreScroll)));
        long consumedBySelfScroll = m492reverseIfNeededMKHz9U(m495toOffsettuRUvjQ($this$performScroll_u2d3eAAhYA.scrollBy(singleAxisDeltaForSelfScroll)));
        long deltaAvailableAfterScroll = Offset.m3949minusMKHz9U(scrollAvailableAfterPreScroll, consumedBySelfScroll);
        long consumedByPostScroll = this.nestedScrollDispatcher.m5280dispatchPostScrollDzOQY0M(consumedBySelfScroll, deltaAvailableAfterScroll, source);
        return Offset.m3950plusMKHz9U(Offset.m3950plusMKHz9U(consumedByPreScroll, consumedBySelfScroll), consumedByPostScroll);
    }
    ...
    public final long m491performRawScrollMKHz9U(long scroll) {
        if (this.scrollableState.isScrollInProgress()) {
            return Offset.INSTANCE.m3961getZeroF1C5BW0();
        }
        return m495toOffsettuRUvjQ(reverseIfNeeded(this.scrollableState.dispatchRawDelta(reverseIfNeeded(m494toFloatk4lQ0M(scroll)))));
    }

    /* renamed from: onDragStopped-sF-c-tU, reason: not valid java name */
    public final Object m490onDragStoppedsFctU(long initialVelocity, Continuation<? super Unit> continuation) {
        long availableVelocity = m486singleAxisVelocityAH228Gc(initialVelocity);
        ...
        if (overscroll != null && getShouldDispatchOverscroll()) {
            Object objMo211applyToFlingBMRW4eQ = overscroll.mo211applyToFlingBMRW4eQ(availableVelocity, performFling, continuation);
            return objMo211applyToFlingBMRW4eQ == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMo211applyToFlingBMRW4eQ : Unit.INSTANCE;
        }
        Object objInvoke = performFling.invoke(Velocity.m6925boximpl(availableVelocity), continuation);
    ...
    */
    public final java.lang.Object m489doFlingAnimationQWom1Mo(long r9, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r11) {
        /*
            r8 = this;
        ...
        L57:
            long r1 = r9.element
            androidx.compose.ui.unit.Velocity r10 = androidx.compose.ui.unit.Velocity.m6925boximpl(r1)
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.ScrollingLogic.m489doFlingAnimationQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
