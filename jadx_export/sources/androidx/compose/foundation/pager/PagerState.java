...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int currentPage, float currentPageOffsetFraction, PrefetchScheduler prefetchScheduler) {
        ...
        this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3934boximpl(Offset.INSTANCE.m3961getZeroF1C5BW0()), null, 2, null);
        ...
        this.placementScopeInvalidator = ObservableScopeInvalidator.m865constructorimpl$default(null, 1, null);
        this.measurementScopeInvalidator = ObservableScopeInvalidator.m865constructorimpl$default(null, 1, null);
    ...
    public final long m936getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m938setUpDownDifferencek4lQ0M$foundation_release(long j) {
    ...
    public final float performScroll(float delta) {
        ...
        if (layoutInfo.tryToApplyScrollWithoutRemeasure(-((int) scrollDelta))) {
            ...
            ObservableScopeInvalidator.m869invalidateScopeimpl(this.placementScopeInvalidator);
    ...
    public final float getPositionThresholdFraction$foundation_release() {
        ...
        float minThreshold = Math.min($this$_get_positionThresholdFraction__u24lambda_u244.mo367toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f);
    ...
    public final void m937setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public final MutableState<Unit> m934getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final void snapToItem$foundation_release(int page, float offsetFraction, boolean forceRemeasure) {
        ...
        ObservableScopeInvalidator.m869invalidateScopeimpl(this.measurementScopeInvalidator);
    }

    /* renamed from: getMeasurementScopeInvalidator-zYiylxw$foundation_release, reason: not valid java name */
    public final MutableState<Unit> m933getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    static final class C03201 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PagerState.this.new C03201(continuation);
        }
    ...
    public final void requestScrollToPage(int page, float pageOffsetFraction) {
        if (isScrollInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.pagerLayoutInfoState.getValue().getCoroutineScope(), null, null, new C03201(null), 3, null);
        }
    ...
    */
    static /* synthetic */ java.lang.Object scroll$suspendImpl(androidx.compose.foundation.pager.PagerState r5, androidx.compose.foundation.MutatePriority r6, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            boolean r0 = r8 instanceof androidx.compose.foundation.pager.PagerState.C03211
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.pager.PagerState$scroll$1 r0 = (androidx.compose.foundation.pager.PagerState.C03211) r0
            int r1 = r0.label
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        return (getLayoutInfo().getOrientation() == Orientation.Vertical ? (Math.signum(scrollDelta) > Math.signum(-Offset.m3946getYimpl(m936getUpDownDifferenceF1C5BW0$foundation_release())) ? 1 : (Math.signum(scrollDelta) == Math.signum(-Offset.m3946getYimpl(m936getUpDownDifferenceF1C5BW0$foundation_release())) ? 0 : -1)) == 0 : (Math.signum(scrollDelta) > Math.signum(-Offset.m3945getXimpl(m936getUpDownDifferenceF1C5BW0$foundation_release())) ? 1 : (Math.signum(scrollDelta) == Math.signum(-Offset.m3945getXimpl(m936getUpDownDifferenceF1C5BW0$foundation_release())) ? 0 : -1)) == 0) || isNotGestureAction();
    }

    private final boolean isNotGestureAction() {
        return ((int) Offset.m3945getXimpl(m936getUpDownDifferenceF1C5BW0$foundation_release())) == 0 && ((int) Offset.m3946getYimpl(m936getUpDownDifferenceF1C5BW0$foundation_release())) == 0;
    }
        ...
        if (this.prefetchingEnabled && !info.getVisiblePagesInfo().isEmpty()) {
            ...
            if (z) {
                if (indexToPrefetch != this.indexToPrefetch) {
                    ...
                    this.currentPrefetchHandle = this.prefetchState.m860schedulePrefetch0kLqBqw(indexToPrefetch, this.premeasureConstraints);
                }
                if (isPrefetchingForward) {
