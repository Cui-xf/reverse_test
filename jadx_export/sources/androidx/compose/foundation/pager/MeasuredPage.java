...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long offset = m923getOffsetBjo55l4(index);
            if (!this.reverseLayout) {
                $this$place_u24lambda_u247 = $this$place_u24lambda_u2472;
            } else {
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m6825getXimpl(offset);
                    $this$place_u24lambda_u247 = $this$place_u24lambda_u2472;
                } else {
                    int mainAxisOffset2 = IntOffset.m6825getXimpl(offset);
                    $this$place_u24lambda_u247 = $this$place_u24lambda_u2472;
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m6826getYimpl(offset);
                    int mainAxisOffset4 = this.mainAxisLayoutSize;
                    iM6826getYimpl = (mainAxisOffset4 - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    iM6826getYimpl = IntOffset.m6826getYimpl(offset);
                }
                long $this$copy_u2d4Tuh3kE$iv = IntOffsetKt.IntOffset(mainAxisOffset, iM6826getYimpl);
    ...
    private final long m923getOffsetBjo55l4(int index) {
    ...
    private final long m922copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE))).intValue(), this.isVertical ? function1.invoke(Integer.valueOf(IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE));
    }
}
