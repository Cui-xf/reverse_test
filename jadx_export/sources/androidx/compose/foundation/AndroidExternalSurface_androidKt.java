...
public final class AndroidExternalSurface_androidKt {
    ...
    */
    public static final void m228AndroidExternalSurface58FFMhA(androidx.compose.ui.Modifier r23, boolean r24, long r25, int r27, boolean r28, final kotlin.jvm.functions.Function1<? super androidx.compose.foundation.AndroidExternalSurfaceScope, kotlin.Unit> r29, androidx.compose.runtime.Composer r30, final int r31, final int r32) {
        /*
            Method dump skipped, instructions count: 572
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AndroidExternalSurface_androidKt.m228AndroidExternalSurface58FFMhA(androidx.compose.ui.Modifier, boolean, long, int, boolean, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m227AndroidEmbeddedExternalSurfacesv6N_fY(Modifier modifier, boolean isOpaque, long surfaceSize, float[] transform, final Function1<? super AndroidExternalSurfaceScope, Unit> function1, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        boolean isOpaque2;
        ...
        if (i5 != 0) {
            ...
            $dirty |= $composer2.changedInstance(transform != null ? Matrix.m4422boximpl(transform) : null) ? 2048 : 1024;
        }
        if ((i & 16) != 0) {
            $dirty |= 24576;
        ...
        if (($dirty & 9363) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    $dirty &= -897;
                    surfaceSize2 = IntSize.INSTANCE.m6872getZeroYbymL2g();
                }
                if (i5 != 0) {
                    modifier3 = modifier5;
                    transform2 = null;
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<Context, TextureView>() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$1$1
                    ...
                    public final TextureView invoke(Context context) {
                        ...
                        androidEmbeddedExternalSurfaceState.m216setSurfaceSizeozmzZPI(j);
            ...
            boolean invalid$iv2 = (((($dirty & 896) ^ 384) > 256 && $composer2.changed(surfaceSize2)) || ($dirty & 384) == 256) | $composer2.changedInstance(state) | (($dirty & 112) == 32) | $composer2.changedInstance(transform2 != null ? Matrix.m4422boximpl(transform2) : null);
            ...
            if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv2 = new Function1<TextureView, Unit>() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$3$1
                    ...
                    public final void invoke2(TextureView view) {
                        ...
                        if (!IntSize.m6865equalsimpl0(surfaceSize3, IntSize.INSTANCE.m6872getZeroYbymL2g()) && (surfaceTexture = view.getSurfaceTexture()) != null) {
                            surfaceTexture.setDefaultBufferSize(IntSize.m6867getWidthimpl(surfaceSize3), IntSize.m6866getHeightimpl(surfaceSize3));
                        }
                        state.m216setSurfaceSizeozmzZPI(surfaceSize3);
                        ...
                        if (transform2 != null) {
                            ...
                            AndroidMatrixConversions_androidKt.m4057setFromEL8BTi8($this$invoke_u24lambda_u241_u24lambda_u240, fArr);
                        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$AndroidEmbeddedExternalSurface$4
                ...
                public final void invoke(Composer composer, int i6) {
                    AndroidExternalSurface_androidKt.m227AndroidEmbeddedExternalSurfacesv6N_fY(modifier4, isOpaque4, surfaceSize4, transform3, function1, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
