...
public final class LazyGridMeasuredItem implements LazyGridItemInfo, LazyLayoutMeasuredItem {
    ...
    private LazyGridMeasuredItem(int index, Object key, boolean isVertical, int crossAxisSize, int mainAxisSpacing, boolean reverseLayout, LayoutDirection layoutDirection, int beforeContentPadding, int afterContentPadding, List<? extends Placeable> list, long visualOffset, Object contentType, LazyLayoutItemAnimator<LazyGridMeasuredItem> lazyLayoutItemAnimator, long constraints, int lane, int span) {
        ...
        this.offset = IntOffset.INSTANCE.m6835getZeronOccac();
        this.row = -1;
        this.column = -1;
    }
    ...
    public long mo792getOffsetBjo55l4(int index) {
        return getOffset();
    }
    ...
    public final void applyScrollDelta(int delta) {
        ...
        if (getIsVertical()) {
            it = IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE$iv);
        } else {
            int it3 = IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE$iv);
            it = it3 + delta;
        }
        if (getIsVertical()) {
            int it4 = IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE$iv);
            it2 = it4 + delta;
        } else {
            it2 = IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE$iv);
        }
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (animation != null) {
                ...
                if (getIsVertical()) {
                    iIntValue = IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE$iv2);
                } else {
                    int mainAxis2 = IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE$iv2);
                    iIntValue = Integer.valueOf(mainAxis2 + delta).intValue();
                }
                if (getIsVertical()) {
                    int mainAxis3 = IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE$iv2);
                    mainAxis = mainAxis3 + delta;
                } else {
                    mainAxis = IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE$iv2);
                }
                animation.m843setRawOffsetgyyYBs(IntOffsetKt.IntOffset(iIntValue, mainAxis));
            }
        }
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), index);
            if (animation != null) {
                long animatedOffset = IntOffset.m6829plusqkQi6aY(offset, animation.m839getPlacementDeltanOccac());
                $this$place_u24lambda_u247 = $this$place_u24lambda_u2472;
                if ((m823getMainAxisgyyYBs(offset) <= minOffset && m823getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m823getMainAxisgyyYBs(offset) >= maxOffset && m823getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
            ...
            if (!this.reverseLayout) {
                ...
                if (getIsVertical()) {
                    layer2 = layer;
                    mainAxisSize = IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE$iv);
                } else {
                    int mainAxisOffset = IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE$iv);
                    layer2 = layer;
                    mainAxisSize = (this.mainAxisLayoutSize - mainAxisOffset) - getMainAxisSize(placeable);
                }
                if (getIsVertical()) {
                    int mainAxisOffset2 = IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE$iv);
                    iM6826getYimpl = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                } else {
                    iM6826getYimpl = IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(mainAxisSize, iM6826getYimpl);
            }
            long offset2 = IntOffset.m6829plusqkQi6aY(offset, this.visualOffset);
            if (animation != null) {
                animation.m841setFinalOffsetgyyYBs(offset2);
            }
            if (getIsVertical()) {
                if (layer2 != null) {
                    $this$place_u24lambda_u2472 = $this$place_u24lambda_u247;
                    Placeable.PlacementScope.m5610placeWithLayeraW9wM$default($this$place_u24lambda_u2472, placeable, offset2, layer2, 0.0f, 4, (Object) null);
                } else {
                    $this$place_u24lambda_u2472 = $this$place_u24lambda_u247;
                    Placeable.PlacementScope.m5609placeWithLayeraW9wM$default($this$place_u24lambda_u2472, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
                }
            } else {
                $this$place_u24lambda_u2472 = $this$place_u24lambda_u247;
                if (layer2 != null) {
                    Placeable.PlacementScope.m5608placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u2472, placeable, offset2, layer2, 0.0f, 4, (Object) null);
                } else {
                    Placeable.PlacementScope.m5607placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u2472, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
                }
            }
        }
    }
    ...
    private final int m823getMainAxisgyyYBs(long $this$mainAxis) {
        return getIsVertical() ? IntOffset.m6826getYimpl($this$mainAxis) : IntOffset.m6825getXimpl($this$mainAxis);
    }
    ...
    private final long m822copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(getIsVertical() ? IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE))).intValue(), getIsVertical() ? function1.invoke(Integer.valueOf(IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE));
    }
}
