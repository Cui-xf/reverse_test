...
public final class LazyGridState implements ScrollableState {
            ...
            public List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int lineIndex) {
                ...
                try {
                    ...
                    while (index$iv < size) {
                        ...
                        prefetchHandles.add(lazyGridState2.getPrefetchState().m860schedulePrefetch0kLqBqw(it.getFirst().intValue(), it.getSecond().getValue()));
                        index$iv++;
    ...
    public final MutableState<Unit> m827getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final MutableState<Unit> m826getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    */
    public java.lang.Object scroll(androidx.compose.foundation.MutatePriority r7, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r8, kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r6 = this;
            boolean r0 = r9 instanceof androidx.compose.foundation.lazy.grid.LazyGridState.C03061
            if (r0 == 0) goto L14
            r0 = r9
            androidx.compose.foundation.lazy.grid.LazyGridState$scroll$1 r0 = (androidx.compose.foundation.lazy.grid.LazyGridState.C03061) r0
            int r1 = r0.label
