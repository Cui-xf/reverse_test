    ...
    private static final List<LazyListMeasuredItem> createItemsAfterList(List<LazyListMeasuredItem> list, LazyListMeasuredItemProvider measuredItemProvider, int itemsCount, int beyondBoundsItemCount, List<Integer> list2, float consumedScroll, boolean isLookingAhead, LazyListLayoutInfo lastPostLookaheadLayoutInfo) {
        ...
        if (i2 <= end) {
            ...
            while (true) {
                ...
                list3.add(LazyListMeasuredItemProvider.m793getAndMeasure0kLqBqw$default(measuredItemProvider, i3, 0L, 2, null));
                if (i3 == end) {
                    break;
                }
                i3++;
        ...
        if (isLookingAhead && lastPostLookaheadLayoutInfo != null && !lastPostLookaheadLayoutInfo.getVisibleItemsInfo().isEmpty()) {
            ...
            for (int i4 = $this$createItemsAfterList_u24lambda_u247.size() - 1; -1 < i4; i4--) {
                if ($this$createItemsAfterList_u24lambda_u247.get(i4).getIndex() > end && (i4 == 0 || $this$createItemsAfterList_u24lambda_u247.get(i4 - 1).getIndex() <= end)) {
                    LazyListItemInfo found2 = $this$createItemsAfterList_u24lambda_u247.get(i4);
                    found = found2;
                    break;
                }
            }
            ...
            if (found != null && (i = found.getIndex()) <= (iMin = Math.min(lastVisibleItem.getIndex(), itemsCount - 1))) {
                ...
                while (true) {
                    if (list3 != null) {
                        ...
                        while (true) {
                            if (index$iv$iv < size) {
                                ...
                                it$iv3 = item$iv$iv;
                                if (((LazyListMeasuredItem) it$iv3).getIndex() == i5) {
                                    break;
                                }
                                index$iv$iv++;
                            } else {
                    ...
                    if (lazyListMeasuredItem == null) {
                        ...
                        list3.add(LazyListMeasuredItemProvider.m793getAndMeasure0kLqBqw$default(measuredItemProvider, i5, 0L, 2, null));
                    }
                    if (i5 == iMin) {
                        break;
                    }
            ...
            if (additionalOffset > 0.0f) {
                ...
                while (index < itemsCount && totalOffset < additionalOffset) {
                    ...
                    if (item != null) {
                        ...
                        list3.add(LazyListMeasuredItemProvider.m793getAndMeasure0kLqBqw$default(measuredItemProvider, index, 0L, 2, null));
                        index++;
        ...
        for (int index$iv = 0; index$iv < size4; index$iv++) {
            ...
            if (index2 > end) {
                ...
                list3.add(LazyListMeasuredItemProvider.m793getAndMeasure0kLqBqw$default(measuredItemProvider, index2, 0L, 2, null));
            }
        }
    ...
    private static final List<LazyListMeasuredItem> createItemsBeforeList(int currentFirstItemIndex, LazyListMeasuredItemProvider measuredItemProvider, int beyondBoundsItemCount, List<Integer> list) {
        ...
        if (start <= i) {
            ...
            while (true) {
                ...
                arrayList.add(LazyListMeasuredItemProvider.m793getAndMeasure0kLqBqw$default(measuredItemProvider, i2, 0L, 2, null));
                if (i2 == start) {
                    break;
                }
                i2--;
        ...
        if (size >= 0) {
            do {
                ...
                if (index < start) {
                    ...
                    arrayList.add(LazyListMeasuredItemProvider.m793getAndMeasure0kLqBqw$default(measuredItemProvider, index, 0L, 2, null));
                }
            } while (size >= 0);
        }
