...
public interface LazyLayoutMeasureScope extends MeasureScope {
    ...
    List<Placeable> mo851measure0kLqBqw(int index, long constraints);
    ...
    public final /* synthetic */ class CC {
        ...
        public static float m852$default$toDpGaN1DYA(LazyLayoutMeasureScope _this, long $this$toDp_u2dGaN1DYA) {
            if (TextUnitType.m6918equalsimpl0(TextUnit.m6889getTypeUIouoOA($this$toDp_u2dGaN1DYA), TextUnitType.INSTANCE.m6923getSpUIouoOA())) {
        ...
        public static float m854$default$toDpu2uoSUM(LazyLayoutMeasureScope _this, int $this$toDp_u2du2uoSUM) {
            float $this$dp$iv = $this$toDp_u2du2uoSUM / _this.getDensity();
            return Dp.m6693constructorimpl($this$dp$iv);
        }

        /* renamed from: $default$toDp-u2uoSUM, reason: not valid java name */
        public static float m853$default$toDpu2uoSUM(LazyLayoutMeasureScope _this, float $this$toDp_u2du2uoSUM) {
            float $this$dp$iv = $this$toDp_u2du2uoSUM / _this.getDensity();
            return Dp.m6693constructorimpl($this$dp$iv);
        }

        /* renamed from: $default$toSize-XkaWNTQ, reason: not valid java name */
        public static long m856$default$toSizeXkaWNTQ(LazyLayoutMeasureScope _this, long $this$toSize_u2dXkaWNTQ) {
        ...
        public static long m855$default$toDpSizekrfVVM(LazyLayoutMeasureScope _this, long $this$toDpSize_u2dk_u2drfVVM) {
