        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutKt.LazyLayout.2
                ...
                public final void invoke(Composer composer, int i4) {
                    LazyLayoutKt.LazyLayout(itemProvider, modifier2, prefetchState2, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
            ...
            LazySaveableStateHolderKt.LazySaveableStateHolderProvider(ComposableLambdaKt.rememberComposableLambda(-1488997347, true, new Function3<SaveableStateHolder, Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutKt.LazyLayout.3
                ...
                public final void invoke(SaveableStateHolder saveableStateHolder, Composer $composer3, int $changed2) {
                    ...
                    if (prefetchState != null) {
                        ...
                        boolean invalid$iv = $composer3.changed(prefetchState) | $composer3.changedInstance(itemContentFactory) | $composer3.changedInstance(subcomposeLayoutState) | $composer3.changedInstance(executor);
                        final LazyLayoutPrefetchState lazyLayoutPrefetchState = prefetchState;
                        ...
                        if (invalid$iv || it$iv3 == Composer.INSTANCE.getEmpty()) {
                            value$iv4 = (Function1) new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutKt$LazyLayout$3$1$1
                                ...
                                public final DisposableEffectResult invoke(DisposableEffectScope $this$DisposableEffect) {
                                    lazyLayoutPrefetchState.setPrefetchHandleProvider$foundation_release(new PrefetchHandleProvider(itemContentFactory, subcomposeLayoutState, executor));
                                    ...
                                    return new DisposableEffectResult() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutKt$LazyLayout$3$1$1$invoke$$inlined$onDispose$1
                                        ...
                                        public void dispose() {
                                            lazyLayoutPrefetchState2.setPrefetchHandleProvider$foundation_release(null);
                                        }
                                    };
                                }
                            };
                    ...
                    if (invalid$iv2 || it$iv4 == Composer.INSTANCE.getEmpty()) {
                        value$iv3 = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutKt$LazyLayout$3$2$1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                return m850invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                            }

                            /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m850invoke0kLqBqw(SubcomposeMeasureScope $this$null, long constraints) {
                                ...
                                return function22.invoke($this$invoke_0kLqBqw_u24lambda_u240, Constraints.m6624boximpl(constraints));
                            }
                        };
