...
public final class LazyLayoutItemContentFactoryKt {
    ...
    public static final void m848SkippableItemJVlU9Rs(final LazyLayoutItemProvider itemProvider, final Object saveableStateHolder, final int index, final Object key, Composer $composer, final int $changed) {
        Composer $composer2 = $composer.startRestartGroup(1439843069);
        ComposerKt.sourceInformation($composer2, "C(SkippableItem)P(1,3:c#foundation.lazy.layout.StableValue!,2:c#foundation.lazy.layout.StableValue)133@4741L51,133@4708L84:LazyLayoutItemContentFactory.kt#wow0x6");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactoryKt$SkippableItem$2
                ...
                public final void invoke(Composer composer, int i) {
                    LazyLayoutItemContentFactoryKt.m848SkippableItemJVlU9Rs(itemProvider, saveableStateHolder, index, key, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
