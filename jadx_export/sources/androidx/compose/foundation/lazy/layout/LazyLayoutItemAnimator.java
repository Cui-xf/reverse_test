...
public final class LazyLayoutItemAnimator<T extends LazyLayoutMeasuredItem> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:199:0x0576 A[LOOP:13: B:189:0x0556->B:199:0x0576, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:210:0x0593  */
    /* JADX WARN: Removed duplicated region for block: B:303:0x0574 A[SYNTHETIC] */
    /*
    ...
    */
    ...
    private final void initializeAnimation(T item, int mainAxisOffset, LazyLayoutItemAnimator<T>.ItemInfo itemInfo) {
        ...
        T t = item;
        int i2 = 0;
        long firstPlaceableOffset = t.mo792getOffsetBjo55l4(0);
        if (t.getIsVertical()) {
            targetFirstPlaceableOffset = IntOffset.m6821copyiSbpLlY$default(firstPlaceableOffset, 0, mainAxisOffset, 1, null);
        } else {
            targetFirstPlaceableOffset = IntOffset.m6821copyiSbpLlY$default(firstPlaceableOffset, mainAxisOffset, 0, 2, null);
        }
        ...
        while (i2 < length) {
            ...
            if (lazyLayoutItemAnimation == null) {
                ...
                long diffToFirstPlaceableOffset = IntOffset.m6828minusqkQi6aY(t.mo792getOffsetBjo55l4(index$iv), firstPlaceableOffset);
                i = i2;
                lazyLayoutItemAnimation.m843setRawOffsetgyyYBs(IntOffset.m6829plusqkQi6aY(targetFirstPlaceableOffset, diffToFirstPlaceableOffset));
            }
            i2 = i + 1;
            t = item;
            index$iv = index$iv2;
    ...
    private final void startPlacementAnimationsIfNeeded(T item, boolean isMovingAway) {
        ...
        while (i < length) {
            ...
            int index$iv2 = index$iv + 1;
            if (lazyLayoutItemAnimation != null) {
                long newTarget = item.mo792getOffsetBjo55l4(index$iv);
                long currentTarget = lazyLayoutItemAnimation.getRawOffset();
                itemInfo = itemInfo3;
                if (IntOffset.m6824equalsimpl0(currentTarget, LazyLayoutItemAnimation.INSTANCE.m844getNotInitializednOccac()) || IntOffset.m6824equalsimpl0(currentTarget, newTarget)) {
                    lazyLayoutItemAnimationArr = animations;
                } else {
                    lazyLayoutItemAnimationArr = animations;
                    lazyLayoutItemAnimation.m836animatePlacementDeltaar5cAso(IntOffset.m6828minusqkQi6aY(newTarget, currentTarget), isMovingAway);
                }
                lazyLayoutItemAnimation.m843setRawOffsetgyyYBs(newTarget);
            } else {
                itemInfo = itemInfo3;
                lazyLayoutItemAnimationArr = animations;
            }
    ...
    public final long m845getMinSizeToFitDisappearingItemsYbymL2g() {
        long size = IntSize.INSTANCE.m6872getZeroYbymL2g();
        ...
        for (int index$iv = 0; index$iv < size2; index$iv++) {
            ...
            if (layer != null) {
                size = IntSizeKt.IntSize(Math.max(IntSize.m6867getWidthimpl(size), IntOffset.m6825getXimpl(it.getRawOffset()) + IntSize.m6867getWidthimpl(layer.getSize())), Math.max(IntSize.m6866getHeightimpl(size), IntOffset.m6826getYimpl(it.getRawOffset()) + IntSize.m6866getHeightimpl(layer.getSize())));
            }
        }
        return size;
    }
    ...
    private final int getMainAxisOffset(LazyLayoutMeasuredItem $this$mainAxisOffset) {
        long it = $this$mainAxisOffset.mo792getOffsetBjo55l4(0);
        return $this$mainAxisOffset.getIsVertical() ? IntOffset.m6826getYimpl(it) : IntOffset.m6825getXimpl(it);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final int getCrossAxisOffset(LazyLayoutMeasuredItem $this$crossAxisOffset) {
        long it = $this$crossAxisOffset.mo792getOffsetBjo55l4(0);
        return !$this$crossAxisOffset.getIsVertical() ? IntOffset.m6826getYimpl(it) : IntOffset.m6825getXimpl(it);
    }
    ...
    private final class ItemInfo {
        ...
        public final void m847setConstraints_Sx5XlM(Constraints constraints) {
        ...
        public final void updateAnimation(T positionedItem, CoroutineScope coroutineScope, GraphicsContext graphicsContext, int layoutMinOffset, int layoutMaxOffset, int crossAxisOffset) {
            ...
            this.constraints = Constraints.m6624boximpl(positionedItem.getConstraints());
        ...
        public void draw(ContentDrawScope $this$draw) {
            ...
            while (index$iv < size) {
                ...
                if (layer == null) {
                    ...
                    float x = IntOffset.m6825getXimpl(it.getFinalOffset());
                    float y = IntOffset.m6826getYimpl(it.getFinalOffset());
                    ContentDrawScope $this$translate$iv = $this$draw;
                    float left$iv = x - IntOffset.m6825getXimpl(layer.getTopLeft());
                    float top$iv = y - IntOffset.m6826getYimpl(layer.getTopLeft());
