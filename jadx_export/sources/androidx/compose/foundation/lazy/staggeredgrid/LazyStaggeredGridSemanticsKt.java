            ...
            value$iv = new LazyLayoutSemanticState() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridSemanticsKt$rememberLazyStaggeredGridSemanticState$1$1
                ...
                public int getViewport() {
                    ...
                    if (orientation == orientation2) {
                        return IntSize.m6866getHeightimpl(lazyStaggeredGridState.getLayoutInfo().getViewportSize());
                    }
                    return IntSize.m6867getWidthimpl(lazyStaggeredGridState.getLayoutInfo().getViewportSize());
                }
