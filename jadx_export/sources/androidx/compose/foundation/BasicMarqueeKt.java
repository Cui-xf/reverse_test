...
public final class BasicMarqueeKt {
    ...
    public static /* synthetic */ Modifier m236basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = MarqueeDefaults.INSTANCE.getIterations();
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.INSTANCE.m308getImmediatelyZbEOnfQ();
        }
        if ((i5 & 4) != 0) {
            i3 = MarqueeDefaults.INSTANCE.getRepeatDelayMillis();
        }
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m304equalsimpl0(i2, MarqueeAnimationMode.INSTANCE.m308getImmediatelyZbEOnfQ()) ? i3 : 0;
        }
        if ((i5 & 16) != 0) {
            marqueeSpacing = MarqueeDefaults.INSTANCE.getSpacing();
        }
        float fM310getVelocityD9Ej5fM = (i5 & 32) != 0 ? MarqueeDefaults.INSTANCE.m310getVelocityD9Ej5fM() : f;
        MarqueeSpacing marqueeSpacing2 = marqueeSpacing;
        return m235basicMarquee1Mj1MLw(modifier, i, i2, i3, i4, marqueeSpacing2, fM310getVelocityD9Ej5fM);
    }

    /* renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m235basicMarquee1Mj1MLw(Modifier $this$basicMarquee_u2d1Mj1MLw, int iterations, int animationMode, int repeatDelayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
    ...
    public static final AnimationSpec<Float> m237createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float velocity, Density density) {
        float pxPerSec = density.mo367toPx0680j_4(velocity);
        TweenSpec singleSpec = velocityBasedTween(Math.abs(pxPerSec), targetValue, delayMillis);
        long startOffset = StartOffset.m168constructorimpl$default((-delayMillis) + initialDelayMillis, 0, 2, null);
        if (iterations == Integer.MAX_VALUE) {
            return AnimationSpecKt.m133infiniteRepeatable9IiC70o$default(singleSpec, null, startOffset, 2, null);
        }
        return AnimationSpecKt.m135repeatable91I0pcU$default(iterations, singleSpec, null, startOffset, 4, null);
    }
    ...
    public static final MarqueeSpacing m233MarqueeSpacing0680j_4(final float spacing) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$$ExternalSyntheticLambda0
            ...
            public final int calculateSpacing(Density density, int i, int i2) {
                return density.mo361roundToPx0680j_4(spacing);
            }
        };
    }
}
