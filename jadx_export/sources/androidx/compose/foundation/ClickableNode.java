...
public class ClickableNode extends AbstractClickableNode {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m272invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m272invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (ClickableNode.this.getEnabled()) {
                        this.label = 1;
                        if (ClickableNode.this.m201handlePressInteractiond4ec7I($this$detectTapAndPress, offset, this) == coroutine_suspended) {
    ...
    static /* synthetic */ Object clickPointerInput$suspendImpl(ClickableNode $this, PointerInputScope $receiver, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress($receiver, $this.new AnonymousClass2(null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableNode.clickPointerInput.3
            ...
            public final void m273invokek4lQ0M(long it) {
                if (ClickableNode.this.getEnabled()) {
    ...
    public final void m271updateQzZPfjk(MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
