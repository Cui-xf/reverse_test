...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m3677boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3678constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3679equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3680equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3681hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3686toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3679equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3681hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3686toStringimpl(this.composer);
    }
    ...
    public static final void m3684setimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m3685setimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m3687updateimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m3688updateimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = arg0.getInserting();
    ...
    public static final void m3682initimpl(Composer arg0, final Function1<? super T, Unit> function1) {
    ...
    public static final void m3683reconcileimpl(Composer arg0, final Function1<? super T, Unit> function1) {
