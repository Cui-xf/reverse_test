...
public final class EffectsKt {
    ...
    public static final void DisposableEffect(Object key1, Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        Object value$iv;
        ComposerKt.sourceInformationMarkerStart($composer, -1371986847, "C(DisposableEffect)P(1)156@6245L47:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1371986847, $changed, -1, "androidx.compose.runtime.DisposableEffect (Effects.kt:155)");
        }
        ComposerKt.sourceInformationMarkerStart($composer, 1176205207, "CC(remember):Effects.kt#9igjgp");
    ...
    public static final void DisposableEffect(Object key1, Object key2, Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        Object value$iv;
        ComposerKt.sourceInformationMarkerStart($composer, 1429097729, "C(DisposableEffect)P(1,2)196@8131L53:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1429097729, $changed, -1, "androidx.compose.runtime.DisposableEffect (Effects.kt:195)");
        }
        ComposerKt.sourceInformationMarkerStart($composer, 1176265565, "CC(remember):Effects.kt#9igjgp");
    ...
    public static final void DisposableEffect(Object key1, Object key2, Object key3, Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        Object value$iv;
        ComposerKt.sourceInformationMarkerStart($composer, -1239538271, "C(DisposableEffect)P(1,2,3)237@10055L59:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1239538271, $changed, -1, "androidx.compose.runtime.DisposableEffect (Effects.kt:236)");
        }
        ComposerKt.sourceInformationMarkerStart($composer, 1176327139, "CC(remember):Effects.kt#9igjgp");
    ...
    public static final void DisposableEffect(Object[] keys, Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> function1, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, -1307627122, "C(DisposableEffect)P(1)277@11951L48:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void LaunchedEffect(Object key1, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, int $changed) {
        Object value$iv;
        ComposerKt.sourceInformationMarkerStart($composer, 1179185413, "C(LaunchedEffect)P(1)339@14315L58:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
        ...
        ComposerKt.sourceInformationMarkerStart($composer, 2064964180, "CC(remember):Effects.kt#9igjgp");
        boolean invalid$iv = $composer.changed(key1);
        Object it$iv = $composer.rememberedValue();
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
    ...
    public static final void LaunchedEffect(Object key1, Object key2, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, int $changed) {
        Object value$iv;
        ComposerKt.sourceInformationMarkerStart($composer, 590241125, "C(LaunchedEffect)P(1,2)362@15323L64:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(590241125, $changed, -1, "androidx.compose.runtime.LaunchedEffect (Effects.kt:360)");
        }
        CoroutineContext applyContext = $composer.getApplyCoroutineContext();
        ComposerKt.sourceInformationMarkerStart($composer, 2064996442, "CC(remember):Effects.kt#9igjgp");
        boolean invalid$iv = $composer.changed(key1) | $composer.changed(key2);
        Object it$iv = $composer.rememberedValue();
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new LaunchedEffectImpl(applyContext, function2);
    ...
    public static final void LaunchedEffect(Object key1, Object key2, Object key3, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, int $changed) {
        Object value$iv;
        ComposerKt.sourceInformationMarkerStart($composer, -54093371, "C(LaunchedEffect)P(1,2,3)386@16361L70:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-54093371, $changed, -1, "androidx.compose.runtime.LaunchedEffect (Effects.kt:384)");
        }
        CoroutineContext applyContext = $composer.getApplyCoroutineContext();
        ComposerKt.sourceInformationMarkerStart($composer, 2065029664, "CC(remember):Effects.kt#9igjgp");
        boolean invalid$iv = $composer.changed(key1) | $composer.changed(key2) | $composer.changed(key3);
        Object it$iv = $composer.rememberedValue();
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new LaunchedEffectImpl(applyContext, function2);
    ...
    public static final void LaunchedEffect(Object[] keys, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Composer $composer, int $changed) {
        ComposerKt.sourceInformationMarkerStart($composer, -139560008, "C(LaunchedEffect)P(1)419@17702L59:Effects.kt#9igjgp");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-139560008, $changed, -1, "androidx.compose.runtime.LaunchedEffect (Effects.kt:417)");
        }
        CoroutineContext applyContext = $composer.getApplyCoroutineContext();
        Object[] keys$iv = Arrays.copyOf(keys, keys.length);
        ComposerKt.sourceInformationMarkerStart($composer, -568225417, "CC(remember)P(1):Composables.kt#9igjgp");
