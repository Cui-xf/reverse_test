...
public final class RememberSaveableKt {
    ...
    public static final <T> T m3772rememberSaveable(final Object[] objArr, Saver<T, ? extends Object> saver, String str, Function0<? extends T> function0, Composer composer, int i, int i2) {
        String str2;
        Object[] objArr2;
        final T t;
        Object obj;
        ...
        if (str4 == null || str4.length() == 0) {
            String string = Integer.toString(currentCompositeKeyHash, CharsKt.checkRadix(MaxSupportedRadix));
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            Object objRestore = (saveableStateRegistry == null || (objConsumeRestored = saveableStateRegistry.consumeRestored(str2)) == null) ? null : saverAutoSaver.restore(objConsumeRestored);
            objArr2 = objArr;
            objRememberedValue = new SaveableHolder(saverAutoSaver, saveableStateRegistry, str2, objRestore == null ? function0.invoke() : objRestore, objArr2);
        ...
        boolean zChangedInstance2 = composer.changedInstance(objArr2) | z | zChangedInstance | composer.changedInstance(saveableStateRegistry) | composer.changed(str2) | composer.changedInstance(valueIfInputsDidntChange);
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] inputs, Saver<T, ? extends Object> saver, String key, Function0<? extends MutableState<T>> function0, Composer $composer, int $changed, int i) {
        ...
        MutableState<T> mutableState = (MutableState) m3772rememberSaveable(Arrays.copyOf(inputs, inputs.length), mutableStateSaver(saver), key2, (Function0) function0, $composer, ($changed & 896) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
