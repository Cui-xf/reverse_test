...
public abstract class Snapshot {
    ...
    public abstract void mo3773nestedActivated$runtime_release(Snapshot snapshot);

    /* renamed from: nestedDeactivated$runtime_release */
    public abstract void mo3774nestedDeactivated$runtime_release(Snapshot snapshot);

    public abstract void notifyObjectsInitialized$runtime_release();

    /* renamed from: recordModified$runtime_release */
    public abstract void mo3775recordModified$runtime_release(StateObject state);
    ...
    public static final class Companion {
        ...
        */
        public final androidx.compose.runtime.snapshots.Snapshot makeCurrentNonObservable(androidx.compose.runtime.snapshots.Snapshot r12) {
            /*
                r11 = this;
                boolean r0 = r12 instanceof androidx.compose.runtime.snapshots.TransparentObserverMutableSnapshot
                r1 = 1
                r2 = 0
                r3 = 0
                if (r0 == 0) goto L25
            ...
            L1c:
                ...
                goto L45
            L25:
                boolean r0 = r12 instanceof androidx.compose.runtime.snapshots.TransparentObserverSnapshot
                if (r0 == 0) goto L47
                r0 = r12
            ...
            L47:
                r0 = 6
                androidx.compose.runtime.snapshots.Snapshot r0 = androidx.compose.runtime.snapshots.SnapshotKt.createTransparentSnapshotWithNoParentReadObserver$default(r12, r3, r2, r0, r3)
                r0.makeCurrent()
            L51:
                return r0
            */
        ...
        static final void registerGlobalWriteObserver$lambda$9(Function1 $observer) throws Throwable {
            Object lock$iv$iv = SnapshotKt.getLock();
            synchronized (lock$iv$iv) {
