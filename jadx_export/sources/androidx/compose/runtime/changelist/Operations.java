...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> args) {
        ...
        pushOp(operation);
        args.invoke(WriteScope.m3760boximpl(WriteScope.m3761constructorimpl(operations)));
        ...
        for (int i = 0; i < ints; i++) {
            ...
            if (((1 << arg) & operations.pushedIntMask) != 0) {
                ...
                $this$push_u24lambda_u246_u24lambda_u243.append(operation.mo3690intParamNamew8GmfQM(Operation.IntParameter.m3718constructorimpl(arg)));
                missingIntCount++;
            }
        }
        ...
        while (missingObjectCount2 < objects) {
            ...
            if (((1 << arg2) & operations.pushedObjectMask) != 0) {
                ...
                $this$push_u24lambda_u246_u24lambda_u245.append(operation.mo3691objectParamName31yXWZQ(Operation.ObjectParameter.m3729constructorimpl(arg2)));
                missingObjectCount++;
            }
            missingObjectCount2++;
            operations = this;
    ...
    public static final class WriteScope {
        ...
        public static final /* synthetic */ WriteScope m3760boximpl(Operations operations) {
            return new WriteScope(operations);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Operations m3761constructorimpl(Operations operations) {
            return operations;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3762equalsimpl(Operations operations, Object obj) {
            return (obj instanceof WriteScope) && Intrinsics.areEqual(operations, ((WriteScope) obj).getStack());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3763equalsimpl0(Operations operations, Operations operations2) {
            return Intrinsics.areEqual(operations, operations2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m3765hashCodeimpl(Operations operations) {
            return operations.hashCode();
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m3768toStringimpl(Operations operations) {
            return "WriteScope(stack=" + operations + ')';
        }

        public boolean equals(Object obj) {
            return m3762equalsimpl(this.stack, obj);
        }

        public int hashCode() {
            return m3765hashCodeimpl(this.stack);
        }

        public String toString() {
            return m3768toStringimpl(this.stack);
        }
        ...
        public static final Operation m3764getOperationimpl(Operations arg0) {
            return arg0.peekOperation();
        }

        /* renamed from: setInt-A6tL2VI, reason: not valid java name */
        public static final void m3766setIntA6tL2VI(Operations arg0, int parameter, int value) {
            int mask = 1 << parameter;
            boolean value$iv = (arg0.pushedIntMask & mask) == 0;
            if (!value$iv) {
                PreconditionsKt.throwIllegalStateException("Already pushed argument " + m3764getOperationimpl(arg0).mo3690intParamNamew8GmfQM(parameter));
            }
            arg0.pushedIntMask |= mask;
            arg0.intArgs[arg0.m3758topIntIndexOfw8GmfQM(parameter)] = value;
        }

        /* renamed from: setObject-DKhxnng, reason: not valid java name */
        public static final <T> void m3767setObjectDKhxnng(Operations arg0, int parameter, T t) {
            int mask = 1 << parameter;
            boolean value$iv = (arg0.pushedObjectMask & mask) == 0;
            if (!value$iv) {
                PreconditionsKt.throwIllegalStateException("Already pushed argument " + m3764getOperationimpl(arg0).mo3691objectParamName31yXWZQ(parameter));
            }
            arg0.pushedObjectMask |= mask;
            arg0.objectArgs[arg0.m3759topObjectIndexOf31yXWZQ(parameter)] = t;
        }
    }
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public int mo3754getIntw8GmfQM(int parameter) {
            return Operations.this.intArgs[this.intIdx + parameter];
        }

        @Override // androidx.compose.runtime.changelist.OperationArgContainer
        /* renamed from: getObject-31yXWZQ */
        public <T> T mo3755getObject31yXWZQ(int parameter) {
    ...
    private final String currentOpToDebugString(OpIterator $this$currentOpToDebugString, String linePrefix) {
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            int offset = i2;
            int param = Operation.IntParameter.m3718constructorimpl(offset);
            String name = operation.mo3690intParamNamew8GmfQM(param);
            if (isFirstParam) {
                isFirstParam = false;
            } else {
                $this$currentOpToDebugString_u24lambda_u2417.append(", ");
            ...
            $this$currentOpToDebugString_u24lambda_u2417.append(" = ");
            $this$currentOpToDebugString_u24lambda_u2417.append($this$currentOpToDebugString.mo3754getIntw8GmfQM(param));
        }
        int objects = operation.getObjects();
        int i3 = 0;
        while (i3 < objects) {
            ...
            int param2 = Operation.ObjectParameter.m3729constructorimpl(offset2);
            int i4 = i;
            String name2 = operation.mo3691objectParamName31yXWZQ(param2);
            if (isFirstParam) {
                isFirstParam = false;
            } else {
                $this$currentOpToDebugString_u24lambda_u2417.append(", ");
            ...
            $this$currentOpToDebugString_u24lambda_u2417.append(" = ");
            $this$currentOpToDebugString_u24lambda_u2417.append(formatOpArgumentToString($this$currentOpToDebugString.mo3755getObject31yXWZQ(param2), argLinePrefix));
            i3++;
