...
public final class FontScaleConverterTable implements FontScaleConverter {
    ...
    public boolean equals(Object other) {
        ...
        return other != null && (other instanceof FontScaleConverterTable) && Arrays.equals(this.mFromSpValues, ((FontScaleConverterTable) other).mFromSpValues) && Arrays.equals(this.toDpValues, ((FontScaleConverterTable) other).toDpValues);
    }
