...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback, OwnerScope {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
                if (this.$this_run.getChildCount() == 0) {
                    return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, Constraints.m6638getMinWidthimpl(constraints), Constraints.m6637getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        @Override // kotlin.jvm.functions.Function1
                ...
                if (Constraints.m6638getMinWidthimpl(constraints) != 0) {
                    this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m6638getMinWidthimpl(constraints));
                }
                if (Constraints.m6637getMinHeightimpl(constraints) != 0) {
                    this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m6637getMinHeightimpl(constraints));
                }
                AndroidViewHolder androidViewHolder = this.$this_run;
                AndroidViewHolder androidViewHolder2 = this.$this_run;
                int iM6638getMinWidthimpl = Constraints.m6638getMinWidthimpl(constraints);
                ...
                int iObtainMeasureSpec = androidViewHolder2.obtainMeasureSpec(iM6638getMinWidthimpl, iM6636getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder3 = this.$this_run;
                int iM6637getMinHeightimpl = Constraints.m6637getMinHeightimpl(constraints);
                int iM6635getMaxHeightimpl = Constraints.m6635getMaxHeightimpl(constraints);
                ViewGroup.LayoutParams layoutParams2 = this.$this_run.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams2);
                androidViewHolder.measure(iObtainMeasureSpec, androidViewHolder3.obtainMeasureSpec(iM6637getMinHeightimpl, iM6635getMaxHeightimpl, layoutParams2.height));
                ...
                return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, measuredWidth, measuredHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        if (isNestedScrollingEnabled()) {
            long consumedByParent = this.dispatcher.m5280dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3945getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3946getYimpl(consumedByParent));
        }
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        if (isNestedScrollingEnabled()) {
            this.dispatcher.m5280dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        if (isNestedScrollingEnabled()) {
            long consumedByParent = this.dispatcher.m5282dispatchPreScrollOzD1aCk(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dx), AndroidViewHolder_androidKt.toComposeOffset(dy)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3945getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3946getYimpl(consumedByParent));
        }
    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!z) {
                        this.label = 1;
                        if (androidViewHolder.dispatcher.m5279dispatchPostFlingRZ2iAVY(Velocity.INSTANCE.m6945getZero9UxMQ8M(), this.$viewVelocity, this) != coroutine_suspended) {
                            break;
                        } else {
                        ...
                        this.label = 2;
                        if (androidViewHolder.dispatcher.m5279dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.INSTANCE.m6945getZero9UxMQ8M(), this) != coroutine_suspended) {
                            break;
                        } else {
                            return coroutine_suspended;
                        }
    ...
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.dispatcher.getCoroutineScope(), null, null, new C06381(toBeConsumed, null), 3, null);
        return false;
    }
    ...
    static final class C06381 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06381(long j, Continuation<? super C06381> continuation) {
            super(2, continuation);
            this.$toBeConsumed = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidViewHolder.this.new C06381(this.$toBeConsumed, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    this.label = 1;
                    if (AndroidViewHolder.this.dispatcher.m5281dispatchPreFlingQWom1Mo(this.$toBeConsumed, this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
