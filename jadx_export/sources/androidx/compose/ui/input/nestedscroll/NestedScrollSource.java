...
public final class NestedScrollSource {
    ...
    private static final int UserInput = m5284constructorimpl(1);
    private static final int SideEffect = m5284constructorimpl(2);
    private static final int Drag = UserInput;
    private static final int Fling = SideEffect;
    private static final int Relocate = m5284constructorimpl(3);
    private static final int Wheel = UserInput;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m5283boximpl(int i) {
        return new NestedScrollSource(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m5284constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5285equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5286equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5287hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m5285equalsimpl(this.value, obj);
    }
    ...
    public static String m5288toStringimpl(int arg0) {
        if (m5286equalsimpl0(arg0, UserInput)) {
            return "UserInput";
        }
        if (m5286equalsimpl0(arg0, SideEffect)) {
            return "SideEffect";
        }
        if (m5286equalsimpl0(arg0, Relocate)) {
            return "Relocate";
        }
        return "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m5290getDragWNlRxjI$annotations() {
        }
        ...
        public static /* synthetic */ void m5291getFlingWNlRxjI$annotations() {
        }

        @Deprecated(message = "Do not use. Will be removed in the future.")
        /* renamed from: getRelocate-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m5292getRelocateWNlRxjI$annotations() {
        }

        @Deprecated(message = "This has been replaced by UserInput.", replaceWith = @ReplaceWith(expression = "NestedScrollSource.UserInput", imports = {"import androidx.compose.ui.input.nestedscroll.NestedScrollSource.Companion.UserInput"}))
        /* renamed from: getWheel-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m5293getWheelWNlRxjI$annotations() {
        }
