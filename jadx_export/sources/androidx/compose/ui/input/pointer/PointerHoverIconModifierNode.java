...
public final class PointerHoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public void mo203onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            if (PointerEventType.m5353equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5357getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m5353equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5358getExit7fucELk())) {
                onExit();
            }
        }
    }
