...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        while (index$iv < size) {
            ...
            PointerInputData previousData = this.previousPointerInputData.get(it.m5419getIdJ3iCeTQ());
            if (previousData == null) {
                long previousTime2 = it.getUptime();
                long previousPosition2 = it.m5421getPositionF1C5BW0();
                previousDown = false;
                ...
                long previousPosition3 = positionCalculator.mo5488screenToLocalMKHz9U(previousData.getPositionOnScreen());
                previousDown = previousDown2;
                previousTime = previousTime3;
                previousPosition = previousPosition3;
            }
            long previousTime4 = it.m5419getIdJ3iCeTQ();
            changes.put(previousTime4, new PointerInputChange(it.m5419getIdJ3iCeTQ(), it.getUptime(), it.m5421getPositionF1C5BW0(), it.getDown(), it.getPressure(), previousTime, previousPosition, previousDown, false, it.m5424getTypeT8wyACA(), it.getHistorical(), it.m5423getScrollDeltaF1C5BW0(), it.m5420getOriginalEventPositionF1C5BW0(), null));
            boolean down = it.getDown();
            LongSparseArray<PointerInputData> longSparseArray = this.previousPointerInputData;
            if (down) {
                longSparseArray.put(it.m5419getIdJ3iCeTQ(), new PointerInputData(it.getUptime(), it.m5422getPositionOnScreenF1C5BW0(), it.getDown(), it.m5424getTypeT8wyACA(), null));
            } else {
                longSparseArray.remove(it.m5419getIdJ3iCeTQ());
            }
            index$iv++;
