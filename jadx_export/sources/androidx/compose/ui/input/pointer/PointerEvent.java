...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m5337constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m5468constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m5343calculatePointerEventType7fucELk();
    }
    ...
    public final void m5347setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m5343calculatePointerEventType7fucELk() {
        MotionEvent motionEvent = getMotionEvent$ui_release();
        if (motionEvent != null) {
            switch (motionEvent.getActionMasked()) {
            }
            return PointerEventType.INSTANCE.m5360getPress7fucELk();
        }
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m5361getRelease7fucELk();
            }
            if (PointerEventKt.changedToDownIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m5360getPress7fucELk();
            }
        }
        return PointerEventType.INSTANCE.m5359getMove7fucELk();
    }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (index$iv < size) {
            ...
            long jM5402getIdJ3iCeTQ = change.getId();
            long uptimeMillis = change.getUptimeMillis();
            long jM5404getPositionF1C5BW0 = change.getPosition();
            long jM5404getPositionF1C5BW02 = change.getPosition();
            boolean pressed = change.getPressed();
            float pressure = change.getPressure();
            int iM5407getTypeT8wyACA = change.getType();
            ...
            if (internalPointerEvent != null) {
                ...
                if (internalPointerEvent.m5333activeHoverEvent0FcD4WY(change.getId())) {
                    z = true;
                }
            } else {
                $this$fastForEach$iv = $this$fastForEach$iv2;
            ...
            arrayList.add(new PointerInputEventData(jM5402getIdJ3iCeTQ, uptimeMillis, jM5404getPositionF1C5BW0, jM5404getPositionF1C5BW02, pressed, pressure, iM5407getTypeT8wyACA, z, null, 0L, 0L, 1792, null));
            index$iv++;
