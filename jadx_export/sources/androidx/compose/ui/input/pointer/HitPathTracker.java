...
public final class HitPathTracker {
    ...
    public static /* synthetic */ void m5331addHitPathQJqDSyo$default(HitPathTracker hitPathTracker, long j, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        hitPathTracker.m5332addHitPathQJqDSyo(j, list, z);
    }
    ...
    */
    public final void m5332addHitPathQJqDSyo(long r25, java.util.List<? extends androidx.compose.ui.Modifier.Node> r27, boolean r28) {
        /*
            Method dump skipped, instructions count: 371
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.HitPathTracker.m5332addHitPathQJqDSyo(long, java.util.List, boolean):void");
    }
