...
public final class Node extends NodeParent {
    ...
    public boolean dispatchMainEventPass(LongSparseArray<PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        if (!this_$iv4.relevantChanges.isEmpty() && this_$iv4.pointerInputFilter.getIsAttached()) {
            ...
            long size = layoutCoordinates.mo5537getSizeYbymL2g();
            ...
            while (true) {
                ...
                if (nodePop instanceof PointerInputModifierNode) {
                    ...
                    it.mo203onPointerEventH0pRuoY(event, PointerEventPass.Initial, size);
                    this_$iv2 = this_$iv4;
            ...
            while (nodePop2 != null) {
                if (nodePop2 instanceof PointerInputModifierNode) {
                    ...
                    it3.mo203onPointerEventH0pRuoY(event, PointerEventPass.Main, size);
                    $this$dispatchForKind_u2d6rFNWt0$iv = $this$dispatchForKind_u2d6rFNWt0$iv4;
                    kind$iv = kind$iv3;
                } else {
                    Modifier.Node this_$iv$iv3 = nodePop2;
                    if (!((this_$iv$iv3.getKindSet() & kind$iv3) != 0) || !(nodePop2 instanceof DelegatingNode)) {
                        $this$dispatchForKind_u2d6rFNWt0$iv = $this$dispatchForKind_u2d6rFNWt0$iv4;
                        kind$iv = kind$iv3;
                    } else {
                        int count$iv2 = 0;
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (!this_$iv4.relevantChanges.isEmpty() && this_$iv4.pointerInputFilter.getIsAttached()) {
            ...
            while (true) {
                ...
                if (nodePop instanceof PointerInputModifierNode) {
                    PointerInputModifierNode it = (PointerInputModifierNode) nodePop;
                    it.mo203onPointerEventH0pRuoY(event, PointerEventPass.Final, size);
                    this_$iv2 = this_$iv4;
                    $i$f$dispatchIfNeeded = $i$f$dispatchIfNeeded3;
                } else {
                    Modifier.Node this_$iv$iv = nodePop;
    ...
    public boolean buildCache(LongSparseArray<PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        while (j2 < size) {
            ...
            if (this.pointerIds.contains(keyValue)) {
                ...
                if (Offset.m3948isValidimpl(prevPosition) && Offset.m3948isValidimpl(currentPosition)) {
                    ...
                    while (j3 < size2) {
                        ...
                        if (Offset.m3948isValidimpl(historicalPosition)) {
                            long uptimeMillis = it.getUptimeMillis();
                            i2 = size2;
                            LayoutCoordinates layoutCoordinates = this.coordinates;
                            Intrinsics.checkNotNull(layoutCoordinates);
                            historical.add(new HistoricalChange(uptimeMillis, layoutCoordinates.mo5538localPositionOfR5De75A(parentCoordinates, historicalPosition), it.getOriginalEventPosition(), null));
                        } else {
                            i2 = size2;
                        }
                        j3 = index$iv + 1;
                    ...
                    LayoutCoordinates layoutCoordinates2 = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates2);
                    long jMo5538localPositionOfR5De75A = layoutCoordinates2.mo5538localPositionOfR5De75A(parentCoordinates, prevPosition);
                    LayoutCoordinates layoutCoordinates3 = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates3);
                    longSparseArray.put(keyValue, PointerInputChange.m5393copyOHpmEuE$default(change, 0L, 0L, layoutCoordinates3.mo5538localPositionOfR5De75A(parentCoordinates, currentPosition), false, 0L, jMo5538localPositionOfR5De75A, false, 0, historical, 0L, 731, null));
                } else {
                    j = j2;
                    i = size;
                }
        ...
        while (true) {
            ...
            long pointerId = this.pointerIds.m5500get_I2yYro(i5);
        ...
        while (true) {
            ...
            it$iv = item$iv$iv;
            if (internalPointerEvent.m5333activeHoverEvent0FcD4WY(((PointerInputChange) it$iv).getId())) {
                break;
            }
            index$iv$iv++;
        }
        ...
        if (activeHoverChange != null) {
            if (!isInBounds) {
                ...
                long size5 = layoutCoordinates4.mo5537getSizeYbymL2g();
                this.isIn = !PointerEventKt.m5348isOutOfBoundsO0kMr_c(activeHoverChange, size5);
            }
            if (this.isIn != this.wasIn && (PointerEventType.m5353equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5359getMove7fucELk()) || PointerEventType.m5353equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5357getEnter7fucELk()) || PointerEventType.m5353equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5358getExit7fucELk()))) {
                event.m5347setTypeEhbLWgg$ui_release(this.isIn ? PointerEventType.INSTANCE.m5357getEnter7fucELk() : PointerEventType.INSTANCE.m5358getExit7fucELk());
            } else if (PointerEventType.m5353equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5357getEnter7fucELk()) && this.wasIn && !this.hasExited) {
                event.m5347setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m5359getMove7fucELk());
            } else if (PointerEventType.m5353equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5358getExit7fucELk()) && this.isIn && activeHoverChange.getPressed()) {
                event.m5347setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m5359getMove7fucELk());
            }
        }
        boolean changed = childChanged4 || !PointerEventType.m5353equalsimpl0(event.getType(), PointerEventType.INSTANCE.m5359getMove7fucELk()) || hasPositionChanged(this.pointerEvent, event);
    ...
    private final boolean hasPositionChanged(PointerEvent oldEvent, PointerEvent newEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!Offset.m3942equalsimpl0(old.getPosition(), current.getPosition())) {
                return true;
            }
        }
        return false;
    ...
    public void cleanUpHits(InternalPointerEvent internalPointerEvent) {
        ...
        while (true) {
            ...
            if (index$iv >= size) {
                this.isIn = false;
                this.hasExited = PointerEventType.m5353equalsimpl0(event2.getType(), PointerEventType.INSTANCE.m5358getExit7fucELk());
                return;
            }
            ...
            boolean nonHoverEventStream = !internalPointerEvent.m5333activeHoverEvent0FcD4WY(change.getId());
            ...
            if (!removePointerId) {
                ...
                event = event2;
                $this$fastForEach$iv = $this$fastForEach$iv2;
                this.pointerIds.m5501remove0FcD4WY(change.getId());
            }
            index$iv++;
            event2 = event;
