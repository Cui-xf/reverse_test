...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String strM6622getEnterjXw82LU;
        this.animation = animation;
        if (getAnimation().m6608getAnimationObject().getCurrentState().booleanValue()) {
            strM6622getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m6623getExitjXw82LU();
        } else {
            strM6622getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m6622getEnterjXw82LU();
        }
        this.state = strM6622getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ ComposeAnimationState getState() {
        return AnimatedVisibilityState.m6615boximpl(getState());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(ComposeAnimationState composeAnimationState) {
        m6614setState7IW2chM(((AnimatedVisibilityState) composeAnimationState).m6621unboximpl());
    }
    ...
    public void m6614setState7IW2chM(String value) {
        this.state = value;
        setClockTime(0L);
    }
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m6614setState7IW2chM(((AnimatedVisibilityState) par1).m6621unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition it = getAnimation().m6608getAnimationObject();
        Pair<Boolean, Boolean> pairM6612toCurrentTargetPair7IW2chM = m6612toCurrentTargetPair7IW2chM(getState());
        boolean current = pairM6612toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = pairM6612toCurrentTargetPair7IW2chM.component2().booleanValue();
    ...
    private final Pair<Boolean, Boolean> m6612toCurrentTargetPair7IW2chM(String $this$toCurrentTargetPair_u2d7IW2chM) {
        return AnimatedVisibilityState.m6618equalsimpl0($this$toCurrentTargetPair_u2d7IW2chM, AnimatedVisibilityState.INSTANCE.m6622getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
