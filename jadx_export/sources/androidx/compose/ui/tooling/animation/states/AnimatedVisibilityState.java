...
public final class AnimatedVisibilityState implements ComposeAnimationState {
    ...
    private static final String Enter = m6616constructorimpl("Enter");
    private static final String Exit = m6616constructorimpl("Exit");
    private final String value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AnimatedVisibilityState m6615boximpl(String str) {
        return new AnimatedVisibilityState(str);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static String m6616constructorimpl(String str) {
        return str;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m6617equalsimpl(String str, Object obj) {
        return (obj instanceof AnimatedVisibilityState) && Intrinsics.areEqual(str, ((AnimatedVisibilityState) obj).m6621unboximpl());
    }
    ...
    public boolean equals(Object obj) {
        return m6617equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m6619hashCodeimpl(this.value);
    }
    ...
    public static String m6620toStringimpl(String arg0) {
        return arg0;
    }

    public String toString() {
        return m6620toStringimpl(this.value);
    }
