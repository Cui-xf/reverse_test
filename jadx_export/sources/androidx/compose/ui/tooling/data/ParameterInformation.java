...
public final /* data */ class ParameterInformation {
    ...
    public int hashCode() {
        return (((((((((((this.name.hashCode() * 31) + (this.value == null ? 0 : this.value.hashCode())) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.fromDefault)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.static)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.compared)) * 31) + (this.inlineClass != null ? this.inlineClass.hashCode() : 0)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.stable);
    }
