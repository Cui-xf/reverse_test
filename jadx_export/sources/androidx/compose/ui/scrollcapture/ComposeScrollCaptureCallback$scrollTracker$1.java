...
final class ComposeScrollCaptureCallback$scrollTracker$1 extends SuspendLambda implements Function2<Float, Continuation<? super Float>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (scrollByOffset != null) {
                    ...
                    Offset offsetM3934boximpl = Offset.m3934boximpl(OffsetKt.Offset(0.0f, delta));
                    this.Z$0 = reverseScrolling;
                    this.label = 1;
                    Object objInvoke = scrollByOffset.invoke(offsetM3934boximpl, this);
        ...
        return Boxing.boxFloat(reverseScrolling ? -Offset.m3946getYimpl(consumed) : Offset.m3946getYimpl(consumed));
    }
}
