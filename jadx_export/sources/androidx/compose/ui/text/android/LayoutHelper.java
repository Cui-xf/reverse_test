...
public final class LayoutHelper {
    ...
    public final BidiRun[] getLineBidiRuns$ui_text_release(int lineIndex) {
        ...
        if (bidiAnalyzeBidi == null || (lineBidi = bidiAnalyzeBidi.createLineBidi(bidiStart, bidiEnd)) == null) {
            ...
            bidiRunArr[c] = new BidiRun(lineStart, lineEnd, this.layout.isRtlCharAt(lineStart));
            return bidiRunArr;
        }
        int runCount = lineBidi.getRunCount();
        BidiRun[] bidiRunArr2 = new BidiRun[runCount];
        for (int i = 0; i < runCount; i++) {
            bidiRunArr2[i] = new BidiRun(lineStart + lineBidi.getRunStart(i), lineStart + lineBidi.getRunLimit(i), lineBidi.getRunLevel(i) % 2 == 1);
        }
        return bidiRunArr2;
    }
