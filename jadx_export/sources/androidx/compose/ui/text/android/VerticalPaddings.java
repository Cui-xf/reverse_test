...
public final class VerticalPaddings {
    ...
    public static final /* synthetic */ VerticalPaddings m6193boximpl(long j) {
    ...
    public static int m6199hashCodeimpl(long j) {
        return FloatFloatPair$$ExternalSyntheticBackport0.m(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6200toStringimpl(long j) {
        return "VerticalPaddings(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m6195equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m6199hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m6200toStringimpl(this.packedValue);
    }
    ...
    public static final int m6198getTopPaddingimpl(long arg0) {
        return (int) (arg0 >> 32);
    }

    /* renamed from: getBottomPadding-impl, reason: not valid java name */
    public static final int m6197getBottomPaddingimpl(long arg0) {
