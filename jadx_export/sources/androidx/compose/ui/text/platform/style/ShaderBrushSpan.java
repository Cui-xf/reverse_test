...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4002boximpl(Size.INSTANCE.m4022getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            long $this$isUnspecified$iv = this.this$0.m6432getSizeNHjbRc();
            if (($this$isUnspecified$iv == InlineClassHelperKt.UnspecifiedPackedFloats) || Size.m4016isEmptyimpl(this.this$0.m6432getSizeNHjbRc())) {
                return null;
            }
            return this.this$0.getShaderBrush().mo4156createShaderuvyYCjk(this.this$0.m6432getSizeNHjbRc());
        }
    });
