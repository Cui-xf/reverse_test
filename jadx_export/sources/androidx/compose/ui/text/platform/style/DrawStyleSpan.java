...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
        ...
        if (textPaint != null) {
            ...
            if (!Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                if (drawStyle instanceof Stroke) {
                    ...
                    textPaint.setStrokeJoin(m6431toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                    textPaint.setStrokeCap(m6430toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m6431toAndroidJoinWw9F2mQ(int $this$toAndroidJoin_u2dWw9F2mQ) {
        return StrokeJoin.m4553equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m4558getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m4553equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m4559getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m4553equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m4557getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m6430toAndroidCapBeK7IIE(int $this$toAndroidCap_u2dBeK7IIE) {
        return StrokeCap.m4543equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m4547getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m4543equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m4548getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m4543equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m4549getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
