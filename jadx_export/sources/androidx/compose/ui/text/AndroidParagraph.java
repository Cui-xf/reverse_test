...
public final class AndroidParagraph implements Paragraph {
    ...
    */
    ...
    public float getWidth() {
        return Constraints.m6636getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo5979getOffsetForPositionk4lQ0M(long position) {
        int line = this.layout.getLineForVertical((int) Offset.m3946getYimpl(position));
        return this.layout.getOffsetForHorizontal(line, Offset.m3945getXimpl(position));
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public long mo5980getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int[] range = this.layout.getRangeForRect(RectHelper_androidKt.toAndroidRectF(rect), AndroidParagraph_androidKt.m5996toLayoutTextGranularityduNsdkg(granularity), new Function2<RectF, RectF, Boolean>() { // from class: androidx.compose.ui.text.AndroidParagraph$getRangeForRect$range$1
            {
                super(2);
            }
    ...
    public void mo5977fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m6144getMinimpl(range), TextRange.m6143getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo5981getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5983paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u2410.m6415setColor8_81llA(color);
    ...
    public void mo5982paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        ...
        $this$paint_LG529CI_u24lambda_u2411.m6415setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u2411.m6412setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m6412setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo5984painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int currBlendMode = getTextPaint$ui_text_release().getBackingBlendMode();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2412 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2412.m6413setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2412.m6412setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m6412setBlendModes9anfk8(currBlendMode);
    }
