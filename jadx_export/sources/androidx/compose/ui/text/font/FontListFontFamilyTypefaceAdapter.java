...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily family, PlatformFontLoader resourceLoader, Continuation<? super Unit> continuation) {
        ...
        while (index$iv$iv < size) {
            ...
            if (FontLoadingStrategy.m6245equalsimpl0(it.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m6249getAsyncPKNRLFQ())) {
                target$iv.add(it);
            }
            index$iv$iv++;
        ...
        while (index$iv$iv2 < size2) {
            ...
            target$iv2.add(TuplesKt.to(it2.getWeight(), FontStyle.m6255boximpl(it2.getStyle())));
            index$iv$iv2++;
        ...
        while (index$iv < size4) {
            ...
            int fontStyle = ((FontStyle) pair.component2()).m6261unboximpl();
            List matched = fontMatcher.m6254matchFontRetOiIg((List<? extends Font>) allFonts, fontWeight, fontStyle);
            List allFonts2 = allFonts;
            TypefaceRequest typeRequest = new TypefaceRequest(family, fontWeight, fontStyle, FontSynthesis.INSTANCE.m6275getAllGVVA2EU(), resourceLoader.getCacheKey(), null);
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        List matched = fontMatcher.m6254matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m6303getFontStyle_LCdwA());
