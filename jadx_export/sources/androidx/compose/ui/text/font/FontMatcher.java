...
public final class FontMatcher {
    ...
    public final List<Font> m6254matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int fontStyle) {
        int i;
        ...
        while (true) {
            ...
            Font it = font;
            if (Intrinsics.areEqual(it.getWeight(), fontWeight) && FontStyle.m6258equalsimpl0(it.getStyle(), fontStyle)) {
                z = true;
            }
            if (z) {
                target$iv.add(font);
        ...
        for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
            ...
            if (FontStyle.m6258equalsimpl0(it3.getStyle(), fontStyle)) {
                target$iv2.add(it3);
            }
        }
    ...
    /* renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m6252matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m6253matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
    }

    /* renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m6253matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        return m6254matchFontRetOiIg(fontFamily.getFonts(), fontWeight, fontStyle);
    }
}
