...
public final class FontKt {
    ...
    public static /* synthetic */ Font m6239FontRetOiIg$default(int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i3 & 4) != 0) {
            i2 = FontStyle.INSTANCE.m6265getNormal_LCdwA();
        }
        return m6238FontRetOiIg(i, fontWeight, i2);
    }
    ...
    public static final /* synthetic */ Font m6238FontRetOiIg(int resId, FontWeight weight, int style) {
        return new ResourceFont(resId, weight, style, null, FontLoadingStrategy.INSTANCE.m6250getBlockingPKNRLFQ(), 8, null);
    }

    /* renamed from: Font-YpTlLL0$default, reason: not valid java name */
    public static /* synthetic */ Font m6241FontYpTlLL0$default(int i, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = FontLoadingStrategy.INSTANCE.m6250getBlockingPKNRLFQ();
        }
        return m6240FontYpTlLL0(i, fontWeight, i2, i3);
    }

    /* renamed from: Font-YpTlLL0, reason: not valid java name */
    public static final Font m6240FontYpTlLL0(int resId, FontWeight weight, int style, int loadingStrategy) {
    ...
    public static /* synthetic */ Font m6237FontF3nL8kk$default(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 16) != 0) {
            settings = FontVariation.INSTANCE.m6280Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m6236FontF3nL8kk(i, fontWeight, i2, i3, settings);
    }

    /* renamed from: Font-F3nL8kk, reason: not valid java name */
    public static final Font m6236FontF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
