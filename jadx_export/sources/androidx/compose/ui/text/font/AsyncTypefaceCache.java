...
public final class AsyncTypefaceCache {
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final boolean m6219isPermanentFailureimpl(Object arg0) {
            return arg0 == null;
        }
    }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object result, boolean forever) {
        ...
        synchronized (lock$iv) {
            try {
                if (result == null) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m6214boximpl(this.PermanentFailure));
                } else if (forever) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m6214boximpl(AsyncTypefaceResult.m6215constructorimpl(result)));
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m6214boximpl(AsyncTypefaceResult.m6215constructorimpl(result)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    */
    public final java.lang.Object runCached(androidx.compose.ui.text.font.Font r8, androidx.compose.ui.text.font.PlatformFontLoader r9, boolean r10, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r11, kotlin.coroutines.Continuation<java.lang.Object> r12) {
        ...
        L62:
            if (r5 == 0) goto L6a
            java.lang.Object r9 = r5.m6221unboximpl()     // Catch: java.lang.Throwable -> Lbc
            monitor-exit(r8)
            return r9
        L6a:
        ...
        L7e:
            ...
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r11 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m6214boximpl(r11)     // Catch: java.lang.Throwable -> L94
        ...
        L96:
            if (r10 == 0) goto La7
            androidx.compose.ui.text.caches.SimpleArrayMap<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r10 = r2.permanentCache     // Catch: java.lang.Throwable -> L94
            java.lang.Object r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m6215constructorimpl(r11)     // Catch: java.lang.Throwable -> L94
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m6214boximpl(r6)     // Catch: java.lang.Throwable -> L94
    ...
    public final Object runCachedBlocking(Font font, PlatformFontLoader platformFontLoader, Function0<? extends Object> block) throws Throwable {
        ...
        synchronized (lock$iv) {
            try {
                ...
                if (priorResult != null) {
                    return priorResult.m6221unboximpl();
                }
