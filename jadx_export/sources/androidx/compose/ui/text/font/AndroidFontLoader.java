...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) throws Resources.NotFoundException {
        ...
        } else if (FontLoadingStrategy.m6245equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6251getOptionalLocalPKNRLFQ())) {
            try {
                Result.Companion companion = Result.INSTANCE;
                AndroidFontLoader $this$loadBlocking_u24lambda_u240 = this;
                objM6999constructorimpl = Result.m6999constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, $this$loadBlocking_u24lambda_u240.context));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6999constructorimpl = Result.m6999constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m7005isFailureimpl(objM6999constructorimpl) ? null : objM6999constructorimpl);
        } else {
            if (FontLoadingStrategy.m6245equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6249getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m6247toStringimpl(font.getLoadingStrategy())));
        }
