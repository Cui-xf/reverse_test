...
public final class TextMotion {
    ...
    static {
        ...
        Static = new TextMotion(Linearity.INSTANCE.m6586getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(Linearity.INSTANCE.m6587getLinear4e0Vf04(), true, defaultConstructorMarker);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release$default, reason: not valid java name */
    public static /* synthetic */ TextMotion m6576copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m6577copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release, reason: not valid java name */
    public final TextMotion m6577copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextMotion) && Linearity.m6582equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning;
    }

    public int hashCode() {
        int result = Linearity.m6583hashCodeimpl(this.linearity);
        return (result * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        ...
        private static final int Linear = m6580constructorimpl(1);
        private static final int FontHinting = m6580constructorimpl(2);
        private static final int None = m6580constructorimpl(3);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Linearity m6579boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m6580constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m6581equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m6582equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m6583hashCodeimpl(int i) {
            return i;
        }

        public boolean equals(Object obj) {
            return m6581equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m6583hashCodeimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m6587getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04, reason: not valid java name */
            public final int m6586getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04, reason: not valid java name */
            public final int m6588getNone4e0Vf04() {
        ...
        public static String m6584toStringimpl(int arg0) {
            return m6582equalsimpl0(arg0, Linear) ? "Linearity.Linear" : m6582equalsimpl0(arg0, FontHinting) ? "Linearity.FontHinting" : m6582equalsimpl0(arg0, None) ? "Linearity.None" : "Invalid";
        }
