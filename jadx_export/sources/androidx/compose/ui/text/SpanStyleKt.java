...
public final class SpanStyleKt {
    ...
    private static final long DefaultBackgroundColor = Color.INSTANCE.m4222getTransparent0d7_KjU();
    private static final long DefaultColor = Color.INSTANCE.m4213getBlack0d7_KjU();
    private static final TextForegroundStyle DefaultColorForegroundStyle = TextForegroundStyle.INSTANCE.m6571from8_81llA(DefaultColor);

    /* renamed from: lerpTextUnitInheritable-C3pnCVY, reason: not valid java name */
    public static final long m6102lerpTextUnitInheritableC3pnCVY(long a, long b, float t) {
        if (TextUnitKt.m6908isUnspecifiedR2X_6o(a) || TextUnitKt.m6908isUnspecifiedR2X_6o(b)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m6880boximpl(a), TextUnit.m6880boximpl(b), t)).getPackedValue();
        }
        return TextUnitKt.m6910lerpC3pnCVY(a, b, t);
    }
    ...
    public static final SpanStyle lerp(SpanStyle start, SpanStyle stop, float fraction) {
        ...
        long jM6102lerpTextUnitInheritableC3pnCVY = m6102lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), fraction);
        ...
        long jM6102lerpTextUnitInheritableC3pnCVY2 = m6102lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), fraction);
        BaselineShift baselineShift = start.getBaselineShift();
        float fM6440unboximpl = baselineShift != null ? baselineShift.m6440unboximpl() : BaselineShift.m6435constructorimpl(0.0f);
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float fM6447lerpjWV1Mfo = BaselineShiftKt.m6447lerpjWV1Mfo(fM6440unboximpl, baselineShift2 != null ? baselineShift2.m6440unboximpl() : BaselineShift.m6435constructorimpl(0.0f), fraction);
        ...
        long jM4238lerpjxsXWHM = ColorKt.m4238lerpjxsXWHM(start.getBackground(), stop.getBackground(), fraction);
        ...
        return new SpanStyle(textForegroundStyleLerp, jM6102lerpTextUnitInheritableC3pnCVY, fontWeightLerp, fontStyle, fontSynthesis, fontFamily, str, jM6102lerpTextUnitInheritableC3pnCVY2, BaselineShift.m6434boximpl(fM6447lerpjWV1Mfo), textGeometricTransformLerp, localeList, jM4238lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, fraction), lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), fraction), (DrawStyle) lerpDiscrete(start.getDrawStyle(), stop.getDrawStyle(), fraction), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle style) {
        ...
        long fontSize = TextUnitKt.m6908isUnspecifiedR2X_6o(style.getFontSize()) ? DefaultFontSize : style.getFontSize();
        ...
        FontSynthesis fontSynthesisM6266boximpl = FontSynthesis.m6266boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6275getAllGVVA2EU());
        ...
        if (TextUnitKt.m6908isUnspecifiedR2X_6o(style.getLetterSpacing())) {
            letterSpacing = DefaultLetterSpacing;
        } else {
            letterSpacing = style.getLetterSpacing();
        }
        BaselineShift baselineShift = style.getBaselineShift();
        BaselineShift baselineShiftM6434boximpl = BaselineShift.m6434boximpl(baselineShift != null ? baselineShift.m6440unboximpl() : BaselineShift.INSTANCE.m6444getNoney9eOQZs());
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM6255boximpl, fontSynthesisM6266boximpl, fontFamily2, str, letterSpacing, baselineShiftM6434boximpl, textGeometricTransform2, localeList2, j, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }

    /* JADX WARN: Removed duplicated region for block: B:113:0x01e5 A[RETURN] */
