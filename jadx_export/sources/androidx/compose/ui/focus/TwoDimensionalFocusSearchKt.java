...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m3910twoDimensionalFocusSearchsMXa3k8(FocusTargetNode $this$twoDimensionalFocusSearch_u2dsMXa3k8, int direction, Rect previouslyFocusedRect, Function1<? super FocusTargetNode, Boolean> function1) {
        switch (WhenMappings.$EnumSwitchMapping$0[$this$twoDimensionalFocusSearch_u2dsMXa3k8.getFocusState().ordinal()]) {
            case 1:
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[focusedChild.getFocusState().ordinal()]) {
                    case 1:
                        Boolean found = m3910twoDimensionalFocusSearchsMXa3k8(focusedChild, direction, previouslyFocusedRect, function1);
                        if (Intrinsics.areEqual((Object) found, (Object) false)) {
                            return Boolean.valueOf(m3907generateAndSearchChildren4C6V_qg($this$twoDimensionalFocusSearch_u2dsMXa3k8, previouslyFocusedRect == null ? FocusTraversalKt.focusRect(activeNode(focusedChild)) : previouslyFocusedRect, direction, function1));
                        }
                        return found;
                    case 2:
                    case 3:
                        return Boolean.valueOf(m3907generateAndSearchChildren4C6V_qg($this$twoDimensionalFocusSearch_u2dsMXa3k8, previouslyFocusedRect == null ? FocusTraversalKt.focusRect(focusedChild) : previouslyFocusedRect, direction, function1));
                    case 4:
                        throw new IllegalStateException(NoActiveChild.toString());
                    default:
            ...
            case 2:
            case 3:
                return Boolean.valueOf(m3906findChildCorrespondingToFocusEnterOMvw8($this$twoDimensionalFocusSearch_u2dsMXa3k8, direction, function1));
            case 4:
                ...
                return Boolean.valueOf(m3909searchChildren4C6V_qg($this$twoDimensionalFocusSearch_u2dsMXa3k8, previouslyFocusedRect, direction, function1));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    public static final boolean m3906findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode $this$findChildCorrespondingToFocusEnter_u2d_u2dOM_u2dvw8, int direction, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m3857equalsimpl0(direction, FocusDirection.INSTANCE.m3864getEnterdhqQ8s())) {
            requestedDirection = FocusDirection.INSTANCE.m3869getRightdhqQ8s();
        } else {
            requestedDirection = direction;
        }
        if (FocusDirection.m3857equalsimpl0(requestedDirection, FocusDirection.INSTANCE.m3869getRightdhqQ8s()) ? true : FocusDirection.m3857equalsimpl0(requestedDirection, FocusDirection.INSTANCE.m3863getDowndhqQ8s())) {
            initialFocusRect = topLeft(FocusTraversalKt.focusRect($this$findChildCorrespondingToFocusEnter_u2d_u2dOM_u2dvw8));
        } else {
            if (!(FocusDirection.m3857equalsimpl0(requestedDirection, FocusDirection.INSTANCE.m3866getLeftdhqQ8s()) ? true : FocusDirection.m3857equalsimpl0(requestedDirection, FocusDirection.INSTANCE.m3870getUpdhqQ8s()))) {
        ...
        FocusTargetNode nextCandidate = m3905findBestCandidate4WY_MpI(focusableChildren, initialFocusRect, requestedDirection);
    ...
    private static final boolean m3907generateAndSearchChildren4C6V_qg(final FocusTargetNode $this$generateAndSearchChildren_u2d4C6V_qg, final Rect focusedItem, final int direction, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m3909searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m3853searchBeyondBoundsOMvw8($this$generateAndSearchChildren_u2d4C6V_qg, direction, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope $this$searchBeyondBounds) {
                Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m3909searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, function1));
    ...
    public static final boolean m3909searchChildren4C6V_qg(FocusTargetNode $this$searchChildren_u2d4C6V_qg, Rect focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        while (children.isNotEmpty() && (nextItem = m3905findBestCandidate4WY_MpI(children, focusedItem, direction)) != null) {
            if (nextItem.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(nextItem).booleanValue();
            }
            if (m3907generateAndSearchChildren4C6V_qg(nextItem, focusedItem, direction, function1)) {
                return true;
            }
    ...
    private static final void collectAccessibleChildren(DelegatableNode $this$collectAccessibleChildren, MutableVector<FocusTargetNode> mutableVector) {
        ...
        int count$iv$iv2 = NodeKind.m5778constructorimpl(1024);
    ...
    private static final FocusTargetNode m3905findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect focusRect, int direction) {
        Rect rectTranslate;
        if (FocusDirection.m3857equalsimpl0(direction, FocusDirection.INSTANCE.m3866getLeftdhqQ8s())) {
            rectTranslate = focusRect.translate(focusRect.getWidth() + 1.0f, 0.0f);
        } else if (FocusDirection.m3857equalsimpl0(direction, FocusDirection.INSTANCE.m3869getRightdhqQ8s())) {
            rectTranslate = focusRect.translate(-(focusRect.getWidth() + 1.0f), 0.0f);
        } else if (FocusDirection.m3857equalsimpl0(direction, FocusDirection.INSTANCE.m3870getUpdhqQ8s())) {
            rectTranslate = focusRect.translate(0.0f, focusRect.getHeight() + 1.0f);
        } else {
            if (!FocusDirection.m3857equalsimpl0(direction, FocusDirection.INSTANCE.m3863getDowndhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rectTranslate = focusRect.translate(0.0f, -(focusRect.getHeight() + 1.0f));
        }
        ...
        if (size$iv > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(candidateNode)) {
                    ...
                    if (m3908isBetterCandidateI7lrPNg(candidateRect, rectTranslate, focusRect, direction)) {
    ...
    private static final boolean isBetterCandidate_I7lrPNg$isCandidate(Rect $this$isBetterCandidate_I7lrPNg_u24isCandidate, int $direction, Rect $focusedRect) {
        ...
        if (FocusDirection.m3857equalsimpl0($direction, FocusDirection.INSTANCE.m3869getRightdhqQ8s())) {
        ...
        if (FocusDirection.m3857equalsimpl0($direction, FocusDirection.INSTANCE.m3870getUpdhqQ8s())) {
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect $this$isBetterCandidate_I7lrPNg_u24minorAxisDistance, int $direction, Rect $focusedRect) {
        if (FocusDirection.m3857equalsimpl0($direction, FocusDirection.INSTANCE.m3866getLeftdhqQ8s()) ? true : FocusDirection.m3857equalsimpl0($direction, FocusDirection.INSTANCE.m3869getRightdhqQ8s())) {
        ...
        if (FocusDirection.m3857equalsimpl0($direction, FocusDirection.INSTANCE.m3870getUpdhqQ8s()) ? true : FocusDirection.m3857equalsimpl0($direction, FocusDirection.INSTANCE.m3863getDowndhqQ8s())) {
    ...
    private static final boolean m3908isBetterCandidateI7lrPNg(Rect proposedCandidate, Rect currentCandidate, Rect focusedRect, int direction) {
        if (!isBetterCandidate_I7lrPNg$isCandidate(proposedCandidate, direction, focusedRect)) {
            return false;
        }
        if (isBetterCandidate_I7lrPNg$isCandidate(currentCandidate, direction, focusedRect) && !m3904beamBeatsI7lrPNg(focusedRect, proposedCandidate, currentCandidate, direction)) {
            return !m3904beamBeatsI7lrPNg(focusedRect, currentCandidate, proposedCandidate, direction) && isBetterCandidate_I7lrPNg$weightedDistance(direction, focusedRect, proposedCandidate) < isBetterCandidate_I7lrPNg$weightedDistance(direction, focusedRect, currentCandidate);
        }
        return true;
    }
    ...
    private static final boolean m3904beamBeatsI7lrPNg(Rect source, Rect rect1, Rect rect2, int direction) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect2, direction, source) || !beamBeats_I7lrPNg$inSourceBeam(rect1, direction, source)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect2, direction, source) || FocusDirection.m3857equalsimpl0(direction, FocusDirection.INSTANCE.m3866getLeftdhqQ8s()) || FocusDirection.m3857equalsimpl0(direction, FocusDirection.INSTANCE.m3869getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$6(rect1, direction, source) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect2, direction, source);
    }
