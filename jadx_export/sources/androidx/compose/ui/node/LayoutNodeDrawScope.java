...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo4642drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4642drawArcillE91I(brush, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4643drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4643drawArcyD3GUKo(color, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4644drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4644drawCircleV9BoPsw(brush, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4645drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4645drawCircleVaOC9Bg(color, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public /* synthetic */ void mo4646drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4646drawImage9jGpkUE(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4647drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        this.canvasDrawScope.mo4647drawImageAZ2fEMs(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode, filterQuality);
    }
    ...
    public void mo4648drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4648drawImagegbVJVH8(image, topLeft, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4649drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4649drawLine1RTmtNc(brush, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4650drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4650drawLineNGM6Ib0(color, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4651drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4651drawOvalAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4652drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4652drawOvalnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4653drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4653drawPathGBMwjPU(path, brush, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4654drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4654drawPathLG529CI(path, color, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4655drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4655drawPointsF8ZwMP8(points, pointMode, color, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4656drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4656drawPointsGsft0Ws(points, pointMode, brush, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4657drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4657drawRectAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4658drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4658drawRectnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4659drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4659drawRoundRectZuiqVtQ(brush, topLeft, size, cornerRadius, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4660drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4660drawRoundRectuAw5IA(color, topLeft, size, cornerRadius, style, alpha, colorFilter, blendMode);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo4661getCenterF1C5BW0() {
        return this.canvasDrawScope.mo4661getCenterF1C5BW0();
    }
    ...
    public long mo4662getSizeNHjbRc() {
        return this.canvasDrawScope.mo4662getSizeNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: record-JVtK1S4 */
    public void mo4663recordJVtK1S4(GraphicsLayer graphicsLayer, long j, Function1<? super DrawScope, Unit> function1) {
        this.canvasDrawScope.mo4663recordJVtK1S4(graphicsLayer, j, function1);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo360roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo360roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo361roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo361roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo362toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo362toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo363toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo363toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo364toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo364toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo365toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo365toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo366toPxR2X_6o(long j) {
        return this.canvasDrawScope.mo366toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo367toPx0680j_4(float f) {
        return this.canvasDrawScope.mo367toPx0680j_4(f);
    }
    ...
    public long mo368toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo368toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo369toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo369toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo370toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo370toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo371toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo371toSpkPz2Gy4(i);
    }
    ...
    public void drawContent() {
        ...
        if (nodeNextDrawNode == null) {
            NodeCoordinator nodeCoordinatorM5664requireCoordinator64DMado = DelegatableNodeKt.m5664requireCoordinator64DMado(drawModifierNode, NodeKind.m5778constructorimpl(4));
            if (nodeCoordinatorM5664requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                wrapped = nodeCoordinatorM5664requireCoordinator64DMado.getWrapped();
                Intrinsics.checkNotNull(wrapped);
            } else {
                wrapped = nodeCoordinatorM5664requireCoordinator64DMado;
            }
        ...
        while (nodePop != 0) {
            if (nodePop instanceof DrawModifierNode) {
                layoutNodeDrawScope3.performDraw(nodePop, canvas, layoutNodeDrawScope3.getDrawContext().getGraphicsLayer());
                ...
                if (!((nodePop.getKindSet() & iM5778constructorimpl) != 0) || !(nodePop instanceof DelegatingNode)) {
                    ...
                    while (delegate != null) {
                        ...
                        if (!((node.getKindSet() & iM5778constructorimpl) != 0)) {
    ...
    public final void performDraw(DrawModifierNode $this$performDraw, Canvas canvas, GraphicsLayer layer) {
        NodeCoordinator coordinator = DelegatableNodeKt.m5664requireCoordinator64DMado($this$performDraw, NodeKind.m5778constructorimpl(4));
        long size = IntSizeKt.m6879toSizeozmzZPI(coordinator.mo5537getSizeYbymL2g());
        LayoutNodeDrawScope drawScope = coordinator.getLayoutNode().getMDrawScope$ui_release();
        drawScope.m5706drawDirecteZhPAX0$ui_release(canvas, size, coordinator, $this$performDraw, layer);
    }
    ...
    public final void m5705draweZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode, GraphicsLayer layer) {
        int i;
        int i2;
        MutableVector mutableVector;
        int iM5778constructorimpl = NodeKind.m5778constructorimpl(4);
        ...
        while (nodePop != 0) {
            if (nodePop instanceof DrawModifierNode) {
                m5706drawDirecteZhPAX0$ui_release(canvas, size, coordinator, nodePop, layer);
                i = iM5778constructorimpl;
            } else {
                int i3 = 1;
                if (!((nodePop.getKindSet() & iM5778constructorimpl) != 0) || !(nodePop instanceof DelegatingNode)) {
                    i = iM5778constructorimpl;
    ...
    public final void m5706drawDirecteZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, DrawModifierNode drawNode, GraphicsLayer layer) {
        ...
        $this$draw_ymL40Pk_u24lambda_u247$iv.mo4670setSizeuvyYCjk(size);
        ...
        try {
            ...
            $this$draw_ymL40Pk_u24lambda_u248$iv2.mo4670setSizeuvyYCjk(prevSize$iv);
