...
public interface LayoutAwareModifierNode extends DelegatableNode {
    ...
    void mo357onRemeasuredozmzZPI(long size);

    /* compiled from: LayoutAwareModifierNode.kt */
    /* renamed from: androidx.compose.ui.node.LayoutAwareModifierNode$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        public static void $default$onPlaced(LayoutAwareModifierNode _this, LayoutCoordinates coordinates) {
        }

        /* renamed from: $default$onRemeasured-ozmzZPI, reason: not valid java name */
        public static void m5687$default$onRemeasuredozmzZPI(LayoutAwareModifierNode _this, long size) {
        }
    }
}
