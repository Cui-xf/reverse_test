...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List measurables, long constraints) {
            return (MeasureResult) m5700measure3p2s80s($this$measure_u2d3p2s80s, (List<? extends Measurable>) measurables, constraints);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m5700measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo5699getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m6801getZeroMYxV2XQ();
        }
    };
    ...
    /* JADX WARN: Type inference failed for: r4v1, types: [T, androidx.compose.ui.semantics.SemanticsConfiguration] */
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        Trace.beginSection("collapseSemantics");
        try {
            if (this.nodes.m5739hasH91voCI$ui_release(NodeKind.m5778constructorimpl(8)) && this._collapsedSemantics == null) {
                ...
                LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1$1
                    ...
                    public final void invoke2() {
                        ...
                        int count$iv$iv2 = NodeKind.m5778constructorimpl(8);
                            ...
                            if ((it$iv$iv.getKindSet() & count$iv$iv2) != 0) {
                                ...
                                while (nodePop != null) {
                                    ...
                                    if (nodePop instanceof SemanticsModifierNode) {
                                        ...
                                        if (((this_$iv$iv$iv.getKindSet() & type$iv) != 0 ? 1 : 0) != 0 && (nodePop instanceof DelegatingNode)) {
                                            int count$iv$iv3 = 0;
    ...
    */
    ...
    public final void detach$ui_release() {
        ...
        if (this.nodes.m5739hasH91voCI$ui_release(NodeKind.m5778constructorimpl(8))) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long innerContentConstraints = getInnerCoordinator$ui_release().m5762getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m6634getHasFixedWidthimpl(innerContentConstraints) && Constraints.m6633getHasFixedHeightimpl(innerContentConstraints);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List measurables, int width) {
            return ((Number) m5701maxIntrinsicHeight($this$maxIntrinsicHeight, (List<? extends IntrinsicMeasurable>) measurables, width)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List measurables, int height) {
            return ((Number) m5702maxIntrinsicWidth($this$maxIntrinsicWidth, (List<? extends IntrinsicMeasurable>) measurables, height)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List measurables, int width) {
            return ((Number) m5703minIntrinsicHeight($this$minIntrinsicHeight, (List<? extends IntrinsicMeasurable>) measurables, width)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List measurables, int height) {
            return ((Number) m5704minIntrinsicWidth($this$minIntrinsicWidth, (List<? extends IntrinsicMeasurable>) measurables, height)).intValue();
        }

        /* renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m5704minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicHeight, reason: collision with other method in class */
        public Void m5703minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicWidth, reason: collision with other method in class */
        public Void m5702maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m5701maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    public void setDensity(Density value) {
        if (!Intrinsics.areEqual(this.density, value)) {
            ...
            for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
                ...
                if ((node.getKindSet() & NodeKind.m5778constructorimpl(16)) != 0) {
    ...
    public void setLayoutDirection(LayoutDirection value) {
        ...
        if (this.layoutDirection != value) {
            ...
            int iM5778constructorimpl = NodeKind.m5778constructorimpl(4);
            if ((this_$iv3.getAggregateChildKindSet() & iM5778constructorimpl) == 0) {
                return;
            }
            Modifier.Node node$iv$iv$iv = this_$iv3.getHead();
            while (node$iv$iv$iv != null) {
                Modifier.Node it$iv$iv = node$iv$iv$iv;
                if ((it$iv$iv.getKindSet() & iM5778constructorimpl) == 0) {
                    this_$iv = this_$iv3;
                } else {
                    MutableVector mutableVector2 = null;
                    Modifier.Node nodePop = it$iv$iv;
                ...
                if ((it$iv$iv.getAggregateChildKindSet() & iM5778constructorimpl) == 0) {
                    return;
                }
    ...
    public void setViewConfiguration(ViewConfiguration value) {
        ...
        if (!Intrinsics.areEqual(this.viewConfiguration, value)) {
            ...
            if ((this_$iv4.getAggregateChildKindSet() & iM5778constructorimpl) == 0) {
                return;
            }
                ...
                if ((it$iv$iv.getKindSet() & iM5778constructorimpl) == 0) {
                    ...
                    while (nodePop != null) {
                        if (nodePop instanceof PointerInputModifierNode) {
                            ...
                            Modifier.Node this_$iv$iv$iv = nodePop;
                            if (((this_$iv$iv$iv.getKindSet() & iM5778constructorimpl) != 0 ? 1 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                                this_$iv2 = this_$iv4;
                            } else {
                                int count$iv$iv2 = 0;
                                DelegatingNode this_$iv$iv$iv2 = (DelegatingNode) nodePop;
    ...
    public void setCompositionLocalMap(CompositionLocalMap value) {
        ...
        NodeChain this_$iv3 = this.nodes;
        int iM5778constructorimpl = NodeKind.m5778constructorimpl(32768);
        if ((this_$iv3.getAggregateChildKindSet() & iM5778constructorimpl) == 0) {
            return;
        }
        Modifier.Node node$iv$iv$iv = this_$iv3.getHead();
    ...
    public final boolean getAlignmentLinesRequired$ui_release() {
        ...
        LayoutNodeLayoutDelegate $this$_get_alignmentLinesRequired__u24lambda_u2424 = this.layoutDelegate;
        if ($this$_get_alignmentLinesRequired__u24lambda_u2424.getAlignmentLinesOwner$ui_release().getAlignmentLines().getRequired$ui_release()) {
            return true;
        }
        AlignmentLinesOwner lookaheadAlignmentLinesOwner$ui_release = $this$_get_alignmentLinesRequired__u24lambda_u2424.getLookaheadAlignmentLinesOwner$ui_release();
    ...
    private final void applyModifier(Modifier modifier) {
        ...
        if (this.lookaheadRoot == null && this.nodes.m5739hasH91voCI$ui_release(NodeKind.m5778constructorimpl(512))) {
    ...
    public final void place$ui_release(int x, int y) {
        ...
        Placeable.PlacementScope $this$place_u24lambda_u2428 = placementScope;
        Placeable.PlacementScope.placeRelative$default($this$place_u24lambda_u2428, getMeasurePassDelegate$ui_release(), x, y, 0.0f, 4, null);
    }
    ...
    public final void m5695hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        long positionInWrapped = NodeCoordinator.m5749fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null);
        getOuterCoordinator$ui_release().m5765hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), positionInWrapped, hitTestResult, isTouchEvent, isInLayer);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release$default, reason: not valid java name */
    public static /* synthetic */ void m5692hitTestSemanticsM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        if ((i & 8) != 0) {
        ...
        layoutNode.m5696hitTestSemanticsM_7yMNQ$ui_release(j, hitTestResult, z, z2);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m5696hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        long positionInWrapped = NodeCoordinator.m5749fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null);
        getOuterCoordinator$ui_release().m5765hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), positionInWrapped, hitSemanticsEntities, true, isInLayer);
    }
    ...
    private final void invalidateFocusOnAttach() {
        ...
        int $this$or_u2d64DMado$iv = NodeKind.m5778constructorimpl(1024) | NodeKind.m5778constructorimpl(2048);
        if (nodeChain.has$ui_release($this$or_u2d64DMado$iv | NodeKind.m5778constructorimpl(4096))) {
            NodeChain this_$iv = this.nodes;
            for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
                Modifier.Node it = node$iv;
                int kind$iv = (it.getKindSet() & NodeKind.m5778constructorimpl(1024)) != 0 ? 1 : 0;
                int kind$iv2 = (it.getKindSet() & NodeKind.m5778constructorimpl(2048)) != 0 ? 1 : 0;
                if ((kind$iv | kind$iv2 | ((it.getKindSet() & NodeKind.m5778constructorimpl(4096)) == 0 ? 0 : 1)) != 0) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain this_$iv3 = this.nodes;
        int type$iv3 = NodeKind.m5778constructorimpl(256);
            ...
            if ((it$iv$iv.getKindSet() & type$iv3) == 0) {
                ...
                while (this_$iv$iv$iv2 != null) {
                    if (this_$iv$iv$iv2 instanceof GlobalPositionAwareModifierNode) {
                        ...
                        this_$iv2 = this_$iv3;
                        type$iv2 = type$iv3;
                        it.onGloballyPositioned(DelegatableNodeKt.m5664requireCoordinator64DMado(it, NodeKind.m5778constructorimpl(256)));
                    } else {
                        this_$iv2 = this_$iv3;
                        type$iv2 = type$iv3;
                        int i = 1;
    ...
    public static /* synthetic */ boolean m5693lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m5712getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m5697lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: lookaheadRemeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m5697lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null && this.lookaheadRoot != null) {
            LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
            Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
            return lookaheadPassDelegate$ui_release.m5716remeasureBRTryo0(constraints.getValue());
        }
        return false;
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release$default, reason: not valid java name */
    public static /* synthetic */ boolean m5694remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m5711getLastConstraintsDWUhwKw();
        }
        return layoutNode.m5698remeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m5698remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null) {
            if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
                clearSubtreeIntrinsicsUsage$ui_release();
            }
            return getMeasurePassDelegate$ui_release().m5720remeasureBRTryo0(constraints.getValue());
        }
        return false;
    }
    ...
    public final void invalidateSubtree(boolean isRootOfInvalidation) {
        ...
        requestRemeasure$ui_release$default(this, false, false, false, 7, null);
        NodeChain this_$iv3 = this.nodes;
        int type$iv4 = NodeKind.m5778constructorimpl(2);
                ...
                if ((it$iv$iv.getKindSet() & type$iv4) == 0) {
                    ...
                    while (nodePop != null) {
                        if (nodePop instanceof LayoutModifierNode) {
                            ...
                            this_$iv2 = this_$iv3;
                            OwnedLayer layer = DelegatableNodeKt.m5664requireCoordinator64DMado(it, NodeKind.m5778constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                            type$iv2 = type$iv4;
    ...
    public void forceRemeasure() {
        ...
        Constraints lastConstraints = this.layoutDelegate.m5711getLastConstraintsDWUhwKw();
        Owner owner = this.owner;
        if (lastConstraints != null) {
            if (owner != null) {
                owner.mo5834measureAndLayout0kLqBqw(this, lastConstraints.getValue());
            }
        } else if (owner != null) {
            Owner.CC.measureAndLayout$default(owner, false, 1, null);
        }
    }
    ...
    public void onLayoutComplete() {
        ...
        int type$iv4 = NodeKind.m5778constructorimpl(128);
        int i4 = 0;
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m5739hasH91voCI$ui_release(NodeKind.m5778constructorimpl(4)) && !this.nodes.m5739hasH91voCI$ui_release(NodeKind.m5778constructorimpl(2))) {
            return true;
        }
        NodeChain this_$iv = this.nodes;
        for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
            Modifier.Node it = node$iv;
            int kind$iv = (it.getKindSet() & NodeKind.m5778constructorimpl(2)) != 0 ? 1 : 0;
            if (kind$iv != 0 && DelegatableNodeKt.m5664requireCoordinator64DMado(it, NodeKind.m5778constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((it.getKindSet() & NodeKind.m5778constructorimpl(4)) != 0) {
                return true;
            }
        }
        return true;
    ...
    static final int ZComparator$lambda$42(LayoutNode node1, LayoutNode node2) {
