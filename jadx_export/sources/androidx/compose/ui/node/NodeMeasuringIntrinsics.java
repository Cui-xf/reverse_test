...
public final class NodeMeasuringIntrinsics {
    ...
    public interface ApproachMeasureBlock {
        ...
        MeasureResult mo5511measure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j);
    }
    ...
    public interface MeasureBlock {
        /* renamed from: measure-3p2s80s */
        MeasureResult mo5688measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    }
    ...
    public final int minWidth$ui_release(ApproachMeasureBlock measureBlock, ApproachIntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        ...
        MeasureResult layoutResult = measureBlock.mo5511measure3p2s80s(new ApproachIntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
    ...
    public final int minWidth$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        DefaultIntrinsicMeasurable measurable = new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width);
        long constraints = ConstraintsKt.Constraints$default(0, 0, 0, h, 7, null);
        MeasureResult layoutResult = measureBlock.mo5688measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
        return layoutResult.get$w();
    }
    ...
    private static final class DefaultIntrinsicMeasurable implements Measurable {
        ...
        public Placeable mo5535measureBRTryo0(long constraints) {
            ...
            if (intrinsicWidthHeight == intrinsicWidthHeight2) {
                ...
                int width = intrinsicMinMax == intrinsicMinMax2 ? intrinsicMeasurable.maxIntrinsicWidth(Constraints.m6635getMaxHeightimpl(constraints)) : intrinsicMeasurable.minIntrinsicWidth(Constraints.m6635getMaxHeightimpl(constraints));
            ...
            int height2 = intrinsicMinMax == intrinsicMinMax3 ? intrinsicMeasurable2.maxIntrinsicHeight(Constraints.m6636getMaxWidthimpl(constraints)) : intrinsicMeasurable2.minIntrinsicHeight(Constraints.m6636getMaxWidthimpl(constraints));
            if (Constraints.m6632getHasBoundedWidthimpl(constraints)) {
                height = Constraints.m6636getMaxWidthimpl(constraints);
            }
