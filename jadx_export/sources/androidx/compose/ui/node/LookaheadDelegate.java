...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m5729setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m5725getSizeYbymL2g$ui_release() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: getConstraints-msEJaDk$ui_release, reason: not valid java name */
    public final long m5724getConstraintsmsEJaDk$ui_release() {
    ...
    public final void set_measureResult(MeasureResult result) {
        Unit unit;
        if (result != null) {
            m5603setMeasuredSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            ...
            $this$_set__measureResult__u24lambda_u241.m5603setMeasuredSizeozmzZPI(IntSize.INSTANCE.m6872getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo5536placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo5536placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m5723placeSelfgyyYBs(position);
    ...
    private final void m5723placeSelfgyyYBs(long position) {
        if (!IntOffset.m6824equalsimpl0(getPosition(), position)) {
            m5729setPositiongyyYBs(position);
    ...
    public final void m5727placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m5723placeSelfgyyYBs(IntOffset.m6829plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m5726performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m5728positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long aggregatedOffset = IntOffset.INSTANCE.m6835getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                aggregatedOffset = IntOffset.m6829plusqkQi6aY(aggregatedOffset, lookaheadDelegate.getPosition());
            }
