...
public final class LayoutNodeLayoutDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            this.this$0.getOuterCoordinator().mo5535measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    ...
    public final Constraints m5711getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m5719getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m5712getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        private long lastPosition = IntOffset.INSTANCE.m6835getZeronOccac();
        ...
        private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m6835getZeronOccac();
        ...
        public MeasurePassDelegate() {
            ...
            this.placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinatorBlock$1
                ...
                public final void invoke2() {
                    ...
                    if (layer != null) {
                        $this$invoke_u24lambda_u240.m5620placeWithLayeraW9wM(layoutNodeLayoutDelegate2.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, layer, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else if (layerBlock == null) {
                        $this$invoke_u24lambda_u240.m5611place70tqf50(layoutNodeLayoutDelegate2.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else {
                        $this$invoke_u24lambda_u240.m5619placeWithLayeraW9wM(layoutNodeLayoutDelegate2.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, (Function1<? super GraphicsLayerScope, Unit>) layerBlock);
                    }
                }
            };
        }
        ...
        /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m5719getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m6624boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo5535measureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                $this$measure_BRTryo0_u24lambda_u2413.mo5535measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m5720remeasureBRTryo0(constraints);
            return this;
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m5720remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m6629equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            long outerPreviousMeasuredSize = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo5537getSizeYbymL2g();
            m5604setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m5710performMeasureBRTryo0(constraints);
            if (IntSize.m6865equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo5537getSizeYbymL2g(), outerPreviousMeasuredSize) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                sizeChanged = false;
            }
            m5603setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return sizeChanged;
        }
        ...
        public void mo5536placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m5718placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        public void mo5602placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m5718placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        private final void m5718placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            Placeable.PlacementScope scope;
            this.isPlacedByParent = true;
            boolean z = false;
            if (!IntOffset.m6824equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default($this$placeSelf_MLgxB_4_u24lambda_u2418, it, IntOffset.m6825getXimpl(position), IntOffset.m6826getYimpl(position), 0.0f, 4, null);
            }
            ...
            m5717placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
        }

        /* renamed from: placeOuterCoordinator-MLgxB_4, reason: not valid java name */
        private final void m5717placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            boolean value$iv = !LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated();
            if (!value$iv) {
            ...
            if (LayoutNodeLayoutDelegate.this.getLayoutPending() || !getIsPlaced()) {
                ...
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m5768placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
        ...
        public final void replace() {
            ...
            try {
                ...
                m5717placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
        ...
        private final void onBeforeLayoutChildren() {
            ...
            do {
                LayoutNode it = (LayoutNode) content$iv$iv[i$iv$iv];
                if (it.getMeasurePending$ui_release() && it.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m5694remeasure_Sx5XlM$ui_release$default(it, null, 1, null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadDelegate != null) {
                if (lookaheadDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                    ...
                    mo5535measureBRTryo0(lookaheadConstraints.getValue());
                    return;
                } else {
                    if (lookaheadDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InLayoutBlock && parent.getLayoutState$ui_release() == LayoutNode.LayoutState.LayingOut) {
                        ...
                        mo5535measureBRTryo0(lookaheadConstraints2.getValue());
                        return;
                    }
                    return;
                }
        ...
        public final void placeBasedOnLookahead() {
            LookaheadPassDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getLookaheadPassDelegate();
            if (lookaheadDelegate != null) {
                m5718placeSelfMLgxB_4(lookaheadDelegate.getLastPosition(), lookaheadDelegate.getLastZIndex(), lookaheadDelegate.getLastLayerBlock$ui_release(), lookaheadDelegate.getLastExplicitLayer());
            } else {
                InlineClassHelperKt.throwIllegalStateExceptionForNullCheck("invalid lookaheadDelegate");
                throw new KotlinNothingValueException();
            }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        */
        public androidx.compose.ui.layout.Placeable mo5535measureBRTryo0(long r4) {
            /*
                r3 = this;
            ...
            L51:
                r3.m5716remeasureBRTryo0(r4)
                r0 = r3
                androidx.compose.ui.layout.Placeable r0 = (androidx.compose.ui.layout.Placeable) r0
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.mo5535measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
        }
        ...
        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m5716remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m6629equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m6624boximpl(constraints);
            m5604setMeasurementConstraintsBRTryo0(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            LayoutNodeLayoutDelegate.this.m5709performLookaheadMeasureBRTryo0(constraints);
            m5603setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m6867getWidthimpl(lastLookaheadSize) == lookaheadDelegate.getWidth() && IntSize.m6866getHeightimpl(lastLookaheadSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo5536placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m5713placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo5602placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m5713placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
        private final void m5713placeSelfMLgxB_4(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            boolean value$iv = !LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated();
            if (!value$iv) {
                InlineClassHelperKt.throwIllegalArgumentException("place is called on a deactivated node");
            }
            ...
            this.placedOnce = true;
            this.onNodePlacedCalled = false;
            if (!IntOffset.m6824equalsimpl0(position, this.lastPosition)) {
            ...
            if (LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() || !getIsPlaced()) {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeSelf$2
                    ...
                    public final void invoke2() {
                        LookaheadDelegate lookaheadDelegate;
                        boolean zIsOutMostLookaheadRoot = LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode);
                        LayoutNodeLayoutDelegate layoutNodeLayoutDelegate2 = layoutNodeLayoutDelegate;
                        ...
                        Placeable.PlacementScope.m5605place70tqf50$default($this$invoke_u24lambda_u240, lookaheadDelegate2, j, 0.0f, 2, null);
                    }
                }, 2, null);
            } else {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m5727placeSelfApparentToRealOffsetgyyYBs$ui_release(position);
                onNodePlaced$ui_release();
            }
            this.lastPosition = position;
            this.lastZIndex = zIndex;
        ...
        private final void onBeforeLayoutChildren() {
            ...
            do {
                ...
                if (it.getLookaheadMeasurePending$ui_release() && it.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                    LookaheadPassDelegate lookaheadPassDelegate = it.getLayoutDelegate().getLookaheadPassDelegate();
                    Intrinsics.checkNotNull(lookaheadPassDelegate);
                    Constraints constraintsM5712getLastLookaheadConstraintsDWUhwKw = it.getLayoutDelegate().m5712getLastLookaheadConstraintsDWUhwKw();
                    Intrinsics.checkNotNull(constraintsM5712getLastLookaheadConstraintsDWUhwKw);
                    if (lookaheadPassDelegate.m5716remeasureBRTryo0(constraintsM5712getLastLookaheadConstraintsDWUhwKw.getValue())) {
        ...
        public final void replace() {
            ...
            try {
                ...
                this.onNodePlacedCalled = false;
                boolean wasPlacedBefore = getIsPlaced();
                m5713placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
                if (wasPlacedBefore && !this.onNodePlacedCalled && (parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release()) != null) {
    ...
    public final void m5710performMeasureBRTryo0(long constraints) {
    ...
    public final void m5709performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo5535measureBRTryo0(constraints);
            }
        }, 2, null);
