...
public abstract class AlignmentLines {
    ...
    protected abstract long mo5649calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            position = mo5649calculatePositionInParentR5De75A(coordinator, position);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            $this$fastRoundToInt$iv = Offset.m3946getYimpl(position);
        } else {
            $this$fastRoundToInt$iv = Offset.m3945getXimpl(position);
        }
