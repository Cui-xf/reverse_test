    ...
    */
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        for (Modifier.Node node = start.getParent(); node != null; node = node.getParent()) {
            if (node == NodeChainKt.SentinelHead) {
                ...
                if (!((this_$iv.getKindSet() & NodeKind.m5778constructorimpl(2)) != 0)) {
                    node.updateCoordinator$ui_release(coordinator);
                } else {
                    return;
                }
    ...
    private final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            if ((toRemove.getKindSet() & NodeKind.m5778constructorimpl(2)) != 0) {
    ...
    public final /* synthetic */ <T> T m5738firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
        int i;
        NodeChain nodeChain;
        int i2;
        int i3;
            ...
            if ((node.getKindSet() & i9) == 0) {
                ...
                while (nodePop != null) {
                    ...
                    if (nodePop instanceof Object) {
                        ...
                        if (((nodePop.getKindSet() & type) != 0 ? 1 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                            i4 = i9;
                            nodeChain3 = nodeChain6;
                        } else {
                            int i11 = 0;
    ...
    public final /* synthetic */ <T> void m5741headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        int i;
        int mask$iv;
        NodeChain this_$iv;
    ...
    public final /* synthetic */ <T> void m5743tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        int mask$iv;
        NodeChain this_$iv;
    ...
    public final /* synthetic */ <T> T m5742tailH91voCI$ui_release(int type) {
        int i;
        int i2;
        int i3;
        int i4;
    ...
    public final /* synthetic */ <T> T m5740headH91voCI$ui_release(int type) {
        int i;
        NodeChain nodeChain;
        int i2;
        int i3;
    ...
    public final boolean m5739hasH91voCI$ui_release(int type) {
