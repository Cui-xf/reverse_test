...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((this.painter.hashCode() * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.sizeToIntrinsics)) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.floatToIntBits(this.alpha)) * 31) + (this.colorFilter == null ? 0 : this.colorFilter.hashCode());
    }
    ...
    public void update(PainterModifier node) {
        boolean intrinsicsChanged = node.getSizeToIntrinsics() != this.sizeToIntrinsics || (this.sizeToIntrinsics && !Size.m4010equalsimpl0(node.getPainter().mo4869getIntrinsicSizeNHjbRc(), this.painter.mo4869getIntrinsicSizeNHjbRc()));
