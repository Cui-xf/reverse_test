...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        long offset = OffsetKt.Offset(coordinate, IntSize.m6866getHeightimpl(sourceCoordinates.mo5537getSizeYbymL2g()) / 2.0f);
        return Offset.m3945getXimpl(targetCoordinates.mo5538localPositionOfR5De75A(sourceCoordinates, offset));
    }
}
