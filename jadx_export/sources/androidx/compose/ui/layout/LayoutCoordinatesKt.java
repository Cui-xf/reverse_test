...
public final class LayoutCoordinatesKt {
    public static final long positionInRoot(LayoutCoordinates $this$positionInRoot) {
        return $this$positionInRoot.mo5540localToRootMKHz9U(Offset.INSTANCE.m3961getZeroF1C5BW0());
    }

    public static final long positionInWindow(LayoutCoordinates $this$positionInWindow) {
        return $this$positionInWindow.mo5542localToWindowMKHz9U(Offset.INSTANCE.m3961getZeroF1C5BW0());
    }

    public static final long positionOnScreen(LayoutCoordinates $this$positionOnScreen) {
        return $this$positionOnScreen.mo5541localToScreenMKHz9U(Offset.INSTANCE.m3961getZeroF1C5BW0());
    }
    ...
    public static final Rect boundsInWindow(LayoutCoordinates $this$boundsInWindow) {
        ...
        float rootWidth = IntSize.m6867getWidthimpl(root.mo5537getSizeYbymL2g());
        float rootHeight = IntSize.m6866getHeightimpl(root.mo5537getSizeYbymL2g());
        ...
        if (!($this$fastCoerceAtLeast$iv$iv == $this$fastCoerceAtLeast$iv$iv3)) {
            if (!($this$fastCoerceAtLeast$iv$iv2 == $this$fastCoerceAtLeast$iv$iv4)) {
                long topLeft = root.mo5542localToWindowMKHz9U(OffsetKt.Offset($this$fastCoerceAtLeast$iv$iv, $this$fastCoerceAtLeast$iv$iv2));
                long topRight = root.mo5542localToWindowMKHz9U(OffsetKt.Offset($this$fastCoerceAtLeast$iv$iv3, $this$fastCoerceAtLeast$iv$iv2));
                long bottomRight = root.mo5542localToWindowMKHz9U(OffsetKt.Offset($this$fastCoerceAtLeast$iv$iv3, $this$fastCoerceAtLeast$iv$iv4));
                long bottomLeft = root.mo5542localToWindowMKHz9U(OffsetKt.Offset($this$fastCoerceAtLeast$iv$iv, $this$fastCoerceAtLeast$iv$iv4));
                float topLeftX = Offset.m3945getXimpl(topLeft);
                float topRightX = Offset.m3945getXimpl(topRight);
                float bottomLeftX = Offset.m3945getXimpl(bottomLeft);
                float bottomRightX = Offset.m3945getXimpl(bottomRight);
                ...
                float topLeftY = Offset.m3946getYimpl(topLeft);
                float topRightY = Offset.m3946getYimpl(topRight);
                float bottomLeftY = Offset.m3946getYimpl(bottomLeft);
                float bottomRightY = Offset.m3946getYimpl(bottomRight);
    ...
    public static final long positionInParent(LayoutCoordinates $this$positionInParent) {
        ...
        return parentLayoutCoordinates != null ? parentLayoutCoordinates.mo5538localPositionOfR5De75A($this$positionInParent, Offset.INSTANCE.m3961getZeroF1C5BW0()) : Offset.INSTANCE.m3961getZeroF1C5BW0();
    }
    ...
    public static final Rect boundsInParent(LayoutCoordinates $this$boundsInParent) {
        ...
        return (parentLayoutCoordinates == null || (rectLocalBoundingBoxOf$default = LayoutCoordinates.CC.localBoundingBoxOf$default(parentLayoutCoordinates, $this$boundsInParent, false, 2, null)) == null) ? new Rect(0.0f, 0.0f, IntSize.m6867getWidthimpl($this$boundsInParent.mo5537getSizeYbymL2g()), IntSize.m6866getHeightimpl($this$boundsInParent.mo5537getSizeYbymL2g())) : rectLocalBoundingBoxOf$default;
    }
