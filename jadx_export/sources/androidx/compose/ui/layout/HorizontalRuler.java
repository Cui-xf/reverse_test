...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        long offset = OffsetKt.Offset(IntSize.m6867getWidthimpl(sourceCoordinates.mo5537getSizeYbymL2g()) / 2.0f, coordinate);
        return Offset.m3946getYimpl(targetCoordinates.mo5538localPositionOfR5De75A(sourceCoordinates, offset));
    }
}
