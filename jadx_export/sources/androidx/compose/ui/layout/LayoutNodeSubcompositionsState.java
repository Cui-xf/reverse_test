...
public final class LayoutNodeSubcompositionsState implements ComposeNodeLifecycleCallback {
    ...
    public final List<Measurable> subcompose(Object slotId, Function2<? super Composer, ? super Integer, Unit> content) throws Throwable {
        ...
        LayoutNode layoutNode = $this$getOrPut$iv.get(slotId);
        if (layoutNode == null) {
            ...
            $this$getOrPut$iv.put(slotId, layoutNodeTakeNodeFromReusables);
        } else {
            layoutNodeTakeNodeFromReusables = layoutNode;
        }
        LayoutNode node = layoutNodeTakeNodeFromReusables;
    ...
    private final void subcompose(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) throws Throwable {
        ...
        if (nodeState2 == null) {
            nodeState = new NodeState(slotId, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m5525getLambda1$ui_release(), null, 4, null);
    ...
    private final void subcompose(LayoutNode node, final NodeState nodeState) throws Throwable {
        ...
        try {
            ...
            content = nodeState.getContent();
            composition = nodeState.getComposition();
            compositionContext = this.compositionContext;
        } catch (Throwable th) {
            th = th;
        }
        try {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(this.NoIntrinsicsMessage) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.createMeasurePolicy.1
            ...
            public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
                ...
                if ($this$measure_u2d3p2s80s.isLookingAhead() || LayoutNodeSubcompositionsState.this.root.getLookaheadRoot() == null) {
                    ...
                    final MeasureResult result = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m6624boximpl(constraints));
                ...
                final MeasureResult result2 = block.invoke(LayoutNodeSubcompositionsState.this.postLookaheadMeasureScope, Constraints.m6624boximpl(constraints));
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) throws Throwable {
        ...
        if (!this.root.isAttached()) {
            return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.precompose.1
                ...
                public /* synthetic */ void mo5566premeasure0kLqBqw(int i, long j) {
                    SubcomposeLayoutState.PrecomposedSlotHandle.CC.m5647$default$premeasure0kLqBqw(this, i, j);
                }
        ...
        if (!this.slotIdToNode.containsKey(slotId)) {
            ...
            if (layoutNode == null) {
                ...
                if (reusedNode != null) {
                    ...
                    layoutNodeCreateNodeAt = createNodeAt(layoutNode2.getFoldedChildren$ui_release().size());
                    this.precomposedCount++;
                }
                $this$getOrPut$iv.put(slotId, layoutNodeCreateNodeAt);
            } else {
                layoutNodeCreateNodeAt = layoutNode;
            }
            LayoutNode node = layoutNodeCreateNodeAt;
            subcompose(node, slotId, content);
        }
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.precompose.2
            ...
            public void mo5566premeasure0kLqBqw(int index, long constraints) {
                ...
                if (node2 != null && node2.isAttached()) {
                    ...
                    this_$iv.ignoreRemeasureRequests = true;
                    LayoutNodeKt.requireOwner(node2).mo5834measureAndLayout0kLqBqw(node2.getChildren$ui_release().get(index), constraints);
                    this_$iv.ignoreRemeasureRequests = false;
                }
            }
