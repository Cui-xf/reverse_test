...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m3819containsUv8p0NA(DragAndDropModifierNode $this$contains_u2dUv8p0NA, long position) {
        ...
        long jMo5537getSizeYbymL2g = currentCoordinates.mo5537getSizeYbymL2g();
        int iM6867getWidthimpl = IntSize.m6867getWidthimpl(jMo5537getSizeYbymL2g);
        int height = IntSize.m6866getHeightimpl(jMo5537getSizeYbymL2g);
        long jPositionInRoot = LayoutCoordinatesKt.positionInRoot(currentCoordinates);
        float x1 = Offset.m3945getXimpl(jPositionInRoot);
        float y1 = Offset.m3946getYimpl(jPositionInRoot);
        float x2 = iM6867getWidthimpl + x1;
        float y2 = height + y1;
        float fM3945getXimpl = Offset.m3945getXimpl(position);
        if (!(x1 <= fM3945getXimpl && fM3945getXimpl <= x2)) {
            return false;
        }
        float fM3946getYimpl = Offset.m3946getYimpl(position);
        return (y1 > fM3946getYimpl ? 1 : (y1 == fM3946getYimpl ? 0 : -1)) <= 0 && (fM3946getYimpl > y2 ? 1 : (fM3946getYimpl == y2 ? 0 : -1)) <= 0;
    }
