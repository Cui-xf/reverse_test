...
public final class TileMode {
    ...
    private static final int Clamp = m4561constructorimpl(0);
    private static final int Repeated = m4561constructorimpl(1);
    private static final int Mirror = m4561constructorimpl(2);
    private static final int Decal = m4561constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TileMode m4560boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4567getClamp3opZhB0() {
            return TileMode.Clamp;
        }

        /* renamed from: getRepeated-3opZhB0, reason: not valid java name */
        public final int m4570getRepeated3opZhB0() {
            return TileMode.Repeated;
        }

        /* renamed from: getMirror-3opZhB0, reason: not valid java name */
        public final int m4569getMirror3opZhB0() {
            return TileMode.Mirror;
        }

        /* renamed from: getDecal-3opZhB0, reason: not valid java name */
        public final int m4568getDecal3opZhB0() {
    ...
    public static String m4565toStringimpl(int arg0) {
        return m4563equalsimpl0(arg0, Clamp) ? "Clamp" : m4563equalsimpl0(arg0, Repeated) ? "Repeated" : m4563equalsimpl0(arg0, Mirror) ? "Mirror" : m4563equalsimpl0(arg0, Decal) ? "Decal" : "Unknown";
    }
