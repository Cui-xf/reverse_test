...
public final class SolidColor extends Brush {
    ...
    public void mo4134applyToPq9zytI(long size, Paint p, float alpha) {
        p.setAlpha(1.0f);
        boolean z = alpha == 1.0f;
        long jM4185copywmQWz5c = this.value;
        if (!z) {
            jM4185copywmQWz5c = Color.m4185copywmQWz5c(jM4185copywmQWz5c, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jM4185copywmQWz5c) : Color.m4189getAlphaimpl(this.value) * alpha, (14 & 2) != 0 ? Color.m4193getRedimpl(jM4185copywmQWz5c) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jM4185copywmQWz5c) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jM4185copywmQWz5c) : 0.0f);
        }
        p.mo4066setColor8_81llA(jM4185copywmQWz5c);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m4188equalsimpl0(this.value, ((SolidColor) other).value);
    }

    public int hashCode() {
        return Color.m4194hashCodeimpl(this.value);
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m4195toStringimpl(this.value)) + ')';
    }
}
