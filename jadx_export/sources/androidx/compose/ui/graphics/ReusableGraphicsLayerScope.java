...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m4275getAutoNrFUSI();
    private long size = Size.INSTANCE.m4022getUnspecifiedNHjbRc();
    ...
    public void mo4357setAmbientShadowColor8_81llA(long value) {
        if (!Color.m4188equalsimpl0(this.ambientShadowColor, value)) {
    ...
    public void mo4359setSpotShadowColor8_81llA(long value) {
        if (!Color.m4188equalsimpl0(this.spotShadowColor, value)) {
    ...
    public void mo4360setTransformOrigin__ExYCQ(long value) {
        if (!TransformOrigin.m4579equalsimpl0(this.transformOrigin, value)) {
    ...
    public void mo4358setCompositingStrategyaDBOjCE(int value) {
        if (!CompositingStrategy.m4271equalsimpl0(this.compositingStrategy, value)) {
    ...
    public void m4506setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo4357setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo4359setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo4360setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m4585getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo4358setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m4275getAutoNrFUSI());
        m4506setSizeuvyYCjk(Size.INSTANCE.m4022getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui_release() {
        this.outline = getShape().mo278createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
