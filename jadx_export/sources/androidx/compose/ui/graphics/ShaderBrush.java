...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo4156createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m4022getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo4134applyToPq9zytI(long size, Paint p, float alpha) {
        Shader shader = this.internalShader;
        if (shader == null || !Size.m4010equalsimpl0(this.createdSize, size)) {
            if (Size.m4016isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.INSTANCE.m4022getUnspecifiedNHjbRc();
            } else {
                Shader it = mo4156createShaderuvyYCjk(size);
                this.internalShader = it;
                shader = it;
                this.createdSize = size;
            }
        }
        if (!Color.m4188equalsimpl0(p.mo4060getColor0d7_KjU(), Color.INSTANCE.m4213getBlack0d7_KjU())) {
            p.mo4066setColor8_81llA(Color.INSTANCE.m4213getBlack0d7_KjU());
        }
