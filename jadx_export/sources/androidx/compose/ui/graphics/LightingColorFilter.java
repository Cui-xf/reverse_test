...
public final class LightingColorFilter extends ColorFilter {
    ...
    private LightingColorFilter(long multiply, long add) {
        this(multiply, add, AndroidColorFilter_androidKt.m4052actualLightingColorFilterOWjLjI(multiply, add), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LightingColorFilter) && Color.m4188equalsimpl0(this.multiply, ((LightingColorFilter) other).multiply) && Color.m4188equalsimpl0(this.add, ((LightingColorFilter) other).add);
    }

    public int hashCode() {
        int result = Color.m4194hashCodeimpl(this.multiply);
        return (result * 31) + Color.m4194hashCodeimpl(this.add);
    }

    public String toString() {
        return "LightingColorFilter(multiply=" + ((Object) Color.m4195toStringimpl(this.multiply)) + ", add=" + ((Object) Color.m4195toStringimpl(this.add)) + ')';
    }
}
