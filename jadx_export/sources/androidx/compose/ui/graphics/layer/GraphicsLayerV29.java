...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m4023getZeroNHjbRc();
        this.renderNode.setClipToBounds(false);
        m4865applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m4830getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo4859setBlendModes9anfk8(int value) {
        ...
        $this$setBlendMode_s9anfk8_u24lambda_u240.setBlendMode(AndroidBlendMode_androidKt.m4037toAndroidBlendModes9anfk8(value));
    ...
    public void mo4861setPivotOffsetk4lQ0M(long value) {
        ...
        boolean zM3966isUnspecifiedk4lQ0M = OffsetKt.m3966isUnspecifiedk4lQ0M(value);
        RenderNode renderNode = this.renderNode;
        if (zM3966isUnspecifiedk4lQ0M) {
            renderNode.resetPivot();
        } else {
            renderNode.setPivotX(Offset.m3945getXimpl(value));
    ...
    public void mo4858setAmbientShadowColor8_81llA(long value) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m4241toArgb8_81llA(value));
    }
    ...
    public void mo4863setSpotShadowColor8_81llA(long value) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m4241toArgb8_81llA(value));
    }
    ...
    private final void m4865applyCompositingStrategyZ1X6vPc(RenderNode $this$applyCompositingStrategy_u2dZ1X6vPc, int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        ...
        if (zRequiresCompositingLayer) {
            m4865applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m4832getOffscreenke2Ky5w());
        } else {
            m4865applyCompositingStrategyZ1X6vPc(renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo4862setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setPosition(x, y, IntSize.m6867getWidthimpl(size) + x, IntSize.m6866getHeightimpl(size) + y);
        this.size = IntSizeKt.m6879toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            it.mo4670setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4826equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4832getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
