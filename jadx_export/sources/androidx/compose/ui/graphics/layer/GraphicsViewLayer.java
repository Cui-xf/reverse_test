...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer layerContainer, long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3961getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    public void mo4859setBlendModes9anfk8(int value) {
        ...
        $this$setBlendMode_s9anfk8_u24lambda_u240.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m4038toPorterDuffModes9anfk8(value)));
    ...
    private final void m4866applyCompositingLayerWpw9cng(int compositingStrategy) {
        ...
        if (CompositingStrategy.m4826equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4832getOffscreenke2Ky5w())) {
            ...
            boolean zM4826equalsimpl0 = CompositingStrategy.m4826equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4831getModulateAlphake2Ky5w());
            ViewLayer viewLayer2 = this.viewLayer;
            if (zM4826equalsimpl0) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4866applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m4832getOffscreenke2Ky5w());
        } else {
            m4866applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4826equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4832getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m4098equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4129getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo4861setPivotOffsetk4lQ0M(long value) {
        ...
        if (OffsetKt.m3966isUnspecifiedk4lQ0M(value)) {
            ...
            this.viewLayer.setPivotX(IntSize.m6867getWidthimpl(this.size) / 2.0f);
            this.viewLayer.setPivotY(IntSize.m6866getHeightimpl(this.size) / 2.0f);
            return;
        }
        this.shouldManuallySetCenterPivot = false;
        this.viewLayer.setPivotX(Offset.m3945getXimpl(value));
        this.viewLayer.setPivotY(Offset.m3946getYimpl(value));
    }
    ...
    public void mo4858setAmbientShadowColor8_81llA(long value) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m4241toArgb8_81llA(value));
        }
    }
    ...
    public void mo4863setSpotShadowColor8_81llA(long value) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m4241toArgb8_81llA(value));
        }
    }
    ...
    public void mo4862setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m6865equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x, y, IntSize.m6867getWidthimpl(size) + x, IntSize.m6866getHeightimpl(size) + y);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m6867getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m6866getHeightimpl(size) / 2.0f);
            }
        } else {
            if (this.x != x) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (p != null) {
                Canvas pictureCanvas = p.beginRecording(IntSize.m6867getWidthimpl(this.size), IntSize.m6866getHeightimpl(this.size));
                try {
                    ...
                    if (this_$iv2 != null) {
                        ...
                        if (this_$iv3 != null) {
                            ...
                            $this$draw_yzxVdVo_u24lambda_u240$iv.m4668setSizeuvyYCjk(size$iv);
                            ...
                            $this$draw_yzxVdVo_u24lambda_u241$iv.m4668setSizeuvyYCjk(prevSize$iv);
                        } else {
                            this_$iv = this_$iv2;
                        }
