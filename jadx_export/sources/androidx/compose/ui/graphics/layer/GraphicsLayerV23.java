...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View ownerView, long ownerId, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.renderNode.setClipToBounds(false);
        m4864applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m4830getAutoke2Ky5w());
        this.compositingStrategy = CompositingStrategy.INSTANCE.m4830getAutoke2Ky5w();
        this.blendMode = BlendMode.INSTANCE.m4129getSrcOver0nO6VwU();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m3960getUnspecifiedF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        this.ambientShadowColor = Color.INSTANCE.m4213getBlack0d7_KjU();
        this.spotShadowColor = Color.INSTANCE.m4213getBlack0d7_KjU();
    ...
    public void mo4860setCompositingStrategyWpw9cng(int value) {
        this.compositingStrategy = value;
        updateLayerProperties();
    }

    /* renamed from: applyCompositingStrategy-Wpw9cng, reason: not valid java name */
    private final void m4864applyCompositingStrategyWpw9cng(int compositingStrategy) {
        RenderNode $this$applyCompositingStrategy_Wpw9cng_u24lambda_u241 = this.renderNode;
        if (CompositingStrategy.m4826equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4832getOffscreenke2Ky5w())) {
        ...
        } else if (CompositingStrategy.m4826equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4831getModulateAlphake2Ky5w())) {
    ...
    public void mo4859setBlendModes9anfk8(int value) {
        if (!BlendMode.m4098equalsimpl0(this.blendMode, value)) {
            this.blendMode = value;
            Paint $this$setBlendMode_s9anfk8_u24lambda_u242 = obtainLayerPaint();
            $this$setBlendMode_s9anfk8_u24lambda_u242.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m4038toPorterDuffModes9anfk8(value)));
            updateLayerProperties();
        }
    }

    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m4826equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m4832getOffscreenke2Ky5w()) && BlendMode.m4098equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4129getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m4864applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m4832getOffscreenke2Ky5w());
        } else {
            m4864applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void mo4861setPivotOffsetk4lQ0M(long value) {
        this.pivotOffset = value;
        if (OffsetKt.m3966isUnspecifiedk4lQ0M(value)) {
            this.shouldManuallySetCenterPivot = true;
            this.renderNode.setPivotX(IntSize.m6867getWidthimpl(this.size) / 2.0f);
            this.renderNode.setPivotY(IntSize.m6866getHeightimpl(this.size) / 2.0f);
        } else {
            this.shouldManuallySetCenterPivot = false;
            this.renderNode.setPivotX(Offset.m3945getXimpl(value));
            this.renderNode.setPivotY(Offset.m3946getYimpl(value));
        }
    }
    ...
    public void mo4858setAmbientShadowColor8_81llA(long value) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.ambientShadowColor = value;
            RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m4241toArgb8_81llA(value));
        }
    }
    ...
    public void mo4863setSpotShadowColor8_81llA(long value) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.spotShadowColor = value;
            RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m4241toArgb8_81llA(value));
        }
    }
    ...
    public void mo4862setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setLeftTopRightBottom(x, y, IntSize.m6867getWidthimpl(size) + x, IntSize.m6866getHeightimpl(size) + y);
        if (!IntSize.m6865equalsimpl0(this.size, size)) {
            if (this.shouldManuallySetCenterPivot) {
                this.renderNode.setPivotX(IntSize.m6867getWidthimpl(size) / 2.0f);
                this.renderNode.setPivotY(IntSize.m6866getHeightimpl(size) / 2.0f);
            }
            this.size = size;
        }
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        Canvas canvasStart = this.renderNode.start(IntSize.m6867getWidthimpl(this.size), IntSize.m6866getHeightimpl(this.size));
        try {
            ...
            long size$iv = IntSizeKt.m6879toSizeozmzZPI(this.size);
