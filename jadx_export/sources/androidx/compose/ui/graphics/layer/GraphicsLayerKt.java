...
public final class GraphicsLayerKt {
    ...
    public static final void setOutline(GraphicsLayer $this$setOutline, Outline outline) {
        if (outline instanceof Outline.Rectangle) {
            $this$setOutline.m4849setRectOutlinetz77jQw(OffsetKt.Offset(((Outline.Rectangle) outline).getRect().getLeft(), ((Outline.Rectangle) outline).getRect().getTop()), SizeKt.Size(((Outline.Rectangle) outline).getRect().getWidth(), ((Outline.Rectangle) outline).getRect().getHeight()));
            return;
        }
        if (!(outline instanceof Outline.Generic)) {
            if (outline instanceof Outline.Rounded) {
                if (((Outline.Rounded) outline).getRoundRectPath() != null) {
                    ...
                    $this$setOutline.m4850setRoundRectOutlineTNW_H78(OffsetKt.Offset(rr.getLeft(), rr.getTop()), SizeKt.Size(rr.getWidth(), rr.getHeight()), CornerRadius.m3920getXimpl(rr.m3993getBottomLeftCornerRadiuskKHJgLs()));
                    return;
                }
            }
            return;
