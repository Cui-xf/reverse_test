...
public final class AndroidPath implements Path {
    ...
    public int mo4078getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m4476getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m4477getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo4080setFillTypeoQ8Xj4U(int value) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m4472equalsimpl0(value, PathFillType.INSTANCE.m4476getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        $this$addRoundRect_u24lambda_u240[0] = CornerRadius.m3920getXimpl(roundRect.m3995getTopLeftCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u240[1] = CornerRadius.m3921getYimpl(roundRect.m3995getTopLeftCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u240[2] = CornerRadius.m3920getXimpl(roundRect.m3996getTopRightCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u240[3] = CornerRadius.m3921getYimpl(roundRect.m3996getTopRightCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u240[4] = CornerRadius.m3920getXimpl(roundRect.m3994getBottomRightCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u240[5] = CornerRadius.m3921getYimpl(roundRect.m3994getBottomRightCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u240[6] = CornerRadius.m3920getXimpl(roundRect.m3993getBottomLeftCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u240[7] = CornerRadius.m3921getYimpl(roundRect.m3993getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo4077addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m3945getXimpl(offset), Offset.m3946getYimpl(offset));
            return;
        }
    ...
    public void mo4082translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m3945getXimpl(offset), Offset.m3946getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo4081transform58bKbWc(float[] matrix) {
        if (this.mMatrix == null) {
            this.mMatrix = new android.graphics.Matrix();
        }
        android.graphics.Matrix matrix2 = this.mMatrix;
        Intrinsics.checkNotNull(matrix2);
        AndroidMatrixConversions_androidKt.m4057setFromEL8BTi8(matrix2, matrix);
        android.graphics.Path path = this.internalPath;
        android.graphics.Matrix matrix3 = this.mMatrix;
        Intrinsics.checkNotNull(matrix3);
        path.transform(matrix3);
    ...
    public boolean mo4079opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m4482equalsimpl0(operation, PathOperation.INSTANCE.m4486getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m4482equalsimpl0(operation, PathOperation.INSTANCE.m4487getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m4482equalsimpl0(operation, PathOperation.INSTANCE.m4488getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m4482equalsimpl0(operation, PathOperation.INSTANCE.m4489getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
