...
public final class ColorMatrixColorFilter extends ColorFilter {
    ...
    private ColorMatrixColorFilter(float[] colorMatrix) {
        this(colorMatrix, AndroidColorFilter_androidKt.m4051actualColorMatrixColorFilterjHGOpc(colorMatrix), null);
    }

    /* renamed from: copyColorMatrix-gBh15pI$default, reason: not valid java name */
    public static /* synthetic */ float[] m4264copyColorMatrixgBh15pI$default(ColorMatrixColorFilter colorMatrixColorFilter, float[] fArr, int i, Object obj) {
        if ((i & 1) != 0) {
            fArr = ColorMatrix.m4244constructorimpl$default(null, 1, null);
        }
        return colorMatrixColorFilter.m4266copyColorMatrixgBh15pI(fArr);
    }

    /* renamed from: copyColorMatrix-gBh15pI, reason: not valid java name */
    public final float[] m4266copyColorMatrixgBh15pI(float[] targetColorMatrix) {
        float[] curMatrix = m4265obtainColorMatrixp10uLo();
    ...
    public boolean equals(Object other) {
        ...
        float[] colorMatrix = m4265obtainColorMatrixp10uLo();
        float[] otherColorMatrix = ((ColorMatrixColorFilter) other).m4265obtainColorMatrixp10uLo();
        return Arrays.equals(colorMatrix, otherColorMatrix);
    }

    /* renamed from: obtainColorMatrix-p10-uLo, reason: not valid java name */
    private final float[] m4265obtainColorMatrixp10uLo() {
    ...
    public int hashCode() {
        float[] fArr = this.colorMatrix;
        if (fArr != null) {
            return ColorMatrix.m4251hashCodeimpl(fArr);
        }
        return 0;
    }
    ...
    public String toString() {
        ...
        float[] fArr = this.colorMatrix;
        return sbAppend.append((Object) (fArr == null ? "null" : ColorMatrix.m4262toStringimpl(fArr))).append(')').toString();
    }
}
