...
public final class PathFillType {
    ...
    private static final int NonZero = m4470constructorimpl(0);
    private static final int EvenOdd = m4470constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathFillType m4469boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4477getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os, reason: not valid java name */
        public final int m4476getEvenOddRgk1Os() {
    ...
    public static String m4474toStringimpl(int arg0) {
        return m4472equalsimpl0(arg0, NonZero) ? "NonZero" : m4472equalsimpl0(arg0, EvenOdd) ? "EvenOdd" : "Unknown";
    }
