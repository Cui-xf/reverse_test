...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter(GroupComponent root) {
        this.size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4002boximpl(Size.INSTANCE.m4023getZeroNHjbRc()), null, 2, null);
    ...
    public final long m4902getSizeNHjbRc$ui_release() {
        State $this$getValue$iv = this.size;
        return ((Size) $this$getValue$iv.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m4904setSizeuvyYCjk$ui_release(long j) {
    ...
    public final long m4903getViewportSizeNHjbRc$ui_release() {
        return this.vector.m4894getViewportSizeNHjbRc$ui_release();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m4905setViewportSizeuvyYCjk$ui_release(long value) {
        this.vector.m4895setViewportSizeuvyYCjk$ui_release(value);
    }
    ...
    public final int m4901getBitmapConfig_sVssgQ$ui_release() {
        return this.vector.m4893getCacheBitmapConfig_sVssgQ$ui_release();
    }
    ...
    public long getIntrinsicSize() {
        return m4902getSizeNHjbRc$ui_release();
    }
    ...
    protected void onDraw(DrawScope $this$onDraw) throws Throwable {
        ...
        if (!getAutoMirror$ui_release() || $this$onDraw.getLayoutDirection() != LayoutDirection.Rtl) {
            ...
            long pivot$iv$iv = $this$onDraw.mo4661getCenterF1C5BW0();
            DrawContext $this$withTransform_u24lambda_u246$iv$iv$iv = $this$onDraw.getDrawContext();
            long previousSize$iv$iv$iv = $this$withTransform_u24lambda_u246$iv$iv$iv.mo4669getSizeNHjbRc();
            ...
            try {
                ...
                $this$scale_Fgt4K4Q_u24lambda_u242$iv$iv.mo4676scale0AR0LA0(-1.0f, 1.0f, pivot$iv$iv);
            } catch (Throwable th) {
                th = th;
            }
            try {
                ...
                $this$withTransform_u24lambda_u246$iv$iv$iv.mo4670setSizeuvyYCjk(previousSize$iv$iv$iv);
            } catch (Throwable th2) {
                th = th2;
                $this$withTransform_u24lambda_u246$iv$iv$iv.getCanvas().restore();
                $this$withTransform_u24lambda_u246$iv$iv$iv.mo4670setSizeuvyYCjk(previousSize$iv$iv$iv);
