...
public abstract class PathNode {
    ...
    public static final /* data */ class RelativeArcTo extends PathNode {
        ...
        public int hashCode() {
            return (((((((((((Float.floatToIntBits(this.horizontalEllipseRadius) * 31) + Float.floatToIntBits(this.verticalEllipseRadius)) * 31) + Float.floatToIntBits(this.theta)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isMoreThanHalf)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isPositiveArc)) * 31) + Float.floatToIntBits(this.arcStartDx)) * 31) + Float.floatToIntBits(this.arcStartDy);
        }
    ...
    public static final /* data */ class ArcTo extends PathNode {
        ...
        public int hashCode() {
            return (((((((((((Float.floatToIntBits(this.horizontalEllipseRadius) * 31) + Float.floatToIntBits(this.verticalEllipseRadius)) * 31) + Float.floatToIntBits(this.theta)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isMoreThanHalf)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isPositiveArc)) * 31) + Float.floatToIntBits(this.arcStartX)) * 31) + Float.floatToIntBits(this.arcStartY);
        }
