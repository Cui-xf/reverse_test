...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4917getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4547getButtKaPHkGw();
        }
        return m4916getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4916getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeCap.INSTANCE.m4547getButtKaPHkGw();
            case 1:
                return StrokeCap.INSTANCE.m4548getRoundKaPHkGw();
            case 2:
                return StrokeCap.INSTANCE.m4549getSquareKaPHkGw();
            default:
                return defValue;
        }
    }
    ...
    static /* synthetic */ int m4919getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4558getMiterLxFBmk8();
        }
        return m4918getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4918getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeJoin.INSTANCE.m4558getMiterLxFBmk8();
            case 1:
                return StrokeJoin.INSTANCE.m4559getRoundLxFBmk8();
            case 2:
                return StrokeJoin.INSTANCE.m4557getBevelLxFBmk8();
            default:
                return defValue;
        }
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) throws XmlPullParserException {
        ...
        if (vectorAttrs.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (value.type != 2 && (tintColorStateList = $this$createVectorImageBuilder.getNamedColorStateList(vectorAttrs, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                ...
                tintColor = Color.INSTANCE.m4223getUnspecified0d7_KjU();
            }
        } else {
            tintColor = Color.INSTANCE.m4223getUnspecified0d7_KjU();
        }
        ...
        if (blendModeValue != -1) {
            switch (blendModeValue) {
                case 3:
                    tintBlendMode = BlendMode.INSTANCE.m4129getSrcOver0nO6VwU();
                    break;
                case 5:
                    tintBlendMode = BlendMode.INSTANCE.m4127getSrcIn0nO6VwU();
                    break;
                case 9:
                    tintBlendMode = BlendMode.INSTANCE.m4126getSrcAtop0nO6VwU();
                    break;
                case 14:
                    tintBlendMode = BlendMode.INSTANCE.m4118getModulate0nO6VwU();
                    break;
                case 15:
                    tintBlendMode = BlendMode.INSTANCE.m4123getScreen0nO6VwU();
                    break;
                case 16:
                    tintBlendMode = BlendMode.INSTANCE.m4121getPlus0nO6VwU();
                    break;
                default:
                    tintBlendMode = BlendMode.INSTANCE.m4127getSrcIn0nO6VwU();
                    break;
        ...
        float defaultWidthDp = Dp.m6693constructorimpl($this$dp$iv);
        float $this$dp$iv2 = defaultHeight / res.getDisplayMetrics().density;
        float defaultHeightDp = Dp.m6693constructorimpl($this$dp$iv2);
        vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int strokeLineCap = m4916getStrokeLineCapCSYIeUk(lineCap, StrokeCap.INSTANCE.m4547getButtKaPHkGw());
        ...
        int strokeLineJoin = m4918getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.INSTANCE.m4557getBevelLxFBmk8());
        ...
        int fillPathType = fillRule == 0 ? companion.m4477getNonZeroRgk1Os() : companion.m4476getEvenOddRgk1Os();
        builder.m4884addPathoIyEayM(pathData, fillPathType, name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
    }
