...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent root) {
        ...
        this.viewportSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4002boximpl(Size.INSTANCE.m4023getZeroNHjbRc()), null, 2, null);
        this.previousDrawSize = Size.INSTANCE.m4022getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope $this$null) {
                ...
                long pivot$iv = Offset.INSTANCE.m3961getZeroF1C5BW0();
                ...
                try {
                    ...
                    $this$scale_Fgt4K4Q_u24lambda_u242$iv.mo4676scale0AR0LA0(scaleX$iv, scaleY$iv, pivot$iv);
    ...
    public final int m4893getCacheBitmapConfig_sVssgQ$ui_release() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo4054getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m4414getArgb8888_sVssgQ();
    }
    ...
    public final long m4894getViewportSizeNHjbRc$ui_release() {
        State $this$getValue$iv = this.viewportSize;
        return ((Size) $this$getValue$iv.getValue()).getPackedValue();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m4895setViewportSizeuvyYCjk$ui_release(long j) {
        MutableState $this$setValue$iv = this.viewportSize;
        $this$setValue$iv.setValue(Size.m4002boximpl(j));
    }
    ...
    */
    public final void draw(androidx.compose.ui.graphics.drawscope.DrawScope r18, float r19, androidx.compose.ui.graphics.ColorFilter r20) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L22:
            ...
            if (r2 == 0) goto L3c
            boolean r2 = androidx.compose.ui.graphics.vector.VectorKt.tintableWithAlphaMask(r20)
            if (r2 == 0) goto L3c
            androidx.compose.ui.graphics.ImageBitmapConfig$Companion r2 = androidx.compose.ui.graphics.ImageBitmapConfig.INSTANCE
            int r2 = r2.m4413getAlpha8_sVssgQ()
            goto L42
        L3c:
            androidx.compose.ui.graphics.ImageBitmapConfig$Companion r2 = androidx.compose.ui.graphics.ImageBitmapConfig.INSTANCE
            int r2 = r2.m4414getArgb8888_sVssgQ()
        L42:
            r10 = r2
            boolean r2 = r0.isDirty
            if (r2 != 0) goto L5d
            long r4 = r0.previousDrawSize
            long r6 = r1.mo4662getSizeNHjbRc()
            boolean r2 = androidx.compose.ui.geometry.Size.m4010equalsimpl0(r4, r6)
            if (r2 == 0) goto L5d
            int r2 = r0.m4893getCacheBitmapConfig_sVssgQ$ui_release()
            boolean r2 = androidx.compose.ui.graphics.ImageBitmapConfig.m4409equalsimpl0(r10, r2)
            if (r2 != 0) goto Ldc
        L5d:
            androidx.compose.ui.graphics.ImageBitmapConfig$Companion r2 = androidx.compose.ui.graphics.ImageBitmapConfig.INSTANCE
            int r2 = r2.m4413getAlpha8_sVssgQ()
            boolean r2 = androidx.compose.ui.graphics.ImageBitmapConfig.m4409equalsimpl0(r10, r2)
            if (r2 == 0) goto L7a
            androidx.compose.ui.graphics.ColorFilter$Companion r11 = androidx.compose.ui.graphics.ColorFilter.INSTANCE
            androidx.compose.ui.graphics.vector.GroupComponent r2 = r0.root
            long r12 = r2.getTintColor()
            r15 = 2
            r16 = 0
            r14 = 0
            androidx.compose.ui.graphics.ColorFilter r2 = androidx.compose.ui.graphics.ColorFilter.Companion.m4228tintxETnrds$default(r11, r12, r14, r15, r16)
            goto L7b
        L7a:
            r2 = 0
        L7b:
            r0.tintFilter = r2
            long r4 = r1.mo4662getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m4014getWidthimpl(r4)
            long r4 = r0.m4894getViewportSizeNHjbRc$ui_release()
            float r4 = androidx.compose.ui.geometry.Size.m4014getWidthimpl(r4)
            float r2 = r2 / r4
            r0.rootScaleX = r2
            long r4 = r1.mo4662getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m4011getHeightimpl(r4)
            long r4 = r0.m4894getViewportSizeNHjbRc$ui_release()
            float r4 = androidx.compose.ui.geometry.Size.m4011getHeightimpl(r4)
            float r2 = r2 / r4
            r0.rootScaleY = r2
            androidx.compose.ui.graphics.vector.DrawCache r9 = r0.cacheDrawScope
            long r4 = r1.mo4662getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m4014getWidthimpl(r4)
            double r4 = (double) r2
            ...
            float r4 = (float) r4
            int r4 = (int) r4
            long r11 = androidx.compose.ui.unit.IntSizeKt.IntSize(r2, r4)
            r13 = r1
            androidx.compose.ui.unit.Density r13 = (androidx.compose.ui.unit.Density) r13
            androidx.compose.ui.unit.LayoutDirection r14 = r1.getLayoutDirection()
            kotlin.jvm.functions.Function1<androidx.compose.ui.graphics.drawscope.DrawScope, kotlin.Unit> r15 = r0.drawVectorBlock
            r9.m4876drawCachedImageFqjB98A(r10, r11, r13, r14, r15)
            r0.isDirty = r3
            long r2 = r1.mo4662getSizeNHjbRc()
    ...
    public String toString() {
        ...
        $this$toString_u24lambda_u240.append("\tviewportWidth: ").append(Size.m4014getWidthimpl(m4894getViewportSizeNHjbRc$ui_release())).append("\n");
        $this$toString_u24lambda_u240.append("\tviewportHeight: ").append(Size.m4011getHeightimpl(m4894getViewportSizeNHjbRc$ui_release())).append("\n");
