...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m4531constructorimpl(0);
    private static final int Rotate = m4531constructorimpl(1);
    private static final int Morph = m4531constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m4530boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4539getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk, reason: not valid java name */
        public final int m4538getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk, reason: not valid java name */
        public final int m4537getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4535toStringimpl(int arg0) {
        return m4533equalsimpl0(arg0, Translate) ? "Translate" : m4533equalsimpl0(arg0, Rotate) ? "Rotate" : m4533equalsimpl0(arg0, Morph) ? "Morph" : "Unknown";
    }
