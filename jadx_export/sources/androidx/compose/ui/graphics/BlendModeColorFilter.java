...
public final class BlendModeColorFilter extends ColorFilter {
    ...
    private BlendModeColorFilter(long color, int blendMode) {
        this(color, blendMode, AndroidColorFilter_androidKt.m4053actualTintColorFilterxETnrds(color, blendMode), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BlendModeColorFilter) && Color.m4188equalsimpl0(this.color, ((BlendModeColorFilter) other).color) && BlendMode.m4098equalsimpl0(this.blendMode, ((BlendModeColorFilter) other).blendMode);
    }

    public int hashCode() {
        int result = Color.m4194hashCodeimpl(this.color);
        return (result * 31) + BlendMode.m4099hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "BlendModeColorFilter(color=" + ((Object) Color.m4195toStringimpl(this.color)) + ", blendMode=" + ((Object) BlendMode.m4100toStringimpl(this.blendMode)) + ')';
    }
}
