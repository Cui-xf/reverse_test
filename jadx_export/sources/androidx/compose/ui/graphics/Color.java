...
public final class Color {
    ...
    public static final /* synthetic */ Color m4177boximpl(long j) {
        return new Color(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4183constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4187equalsimpl(long j, Object obj) {
        return (obj instanceof Color) && j == ((Color) obj).m4197unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4188equalsimpl0(long j, long j2) {
        return ULong.m7180equalsimpl0(j, j2);
    }
    ...
    public static int m4194hashCodeimpl(long j) {
        return ULong.m7185hashCodeimpl(j);
    }

    public boolean equals(Object obj) {
        return m4187equalsimpl(this.value, obj);
    }
    ...
    public static final ColorSpace m4191getColorSpaceimpl(long arg0) {
        ColorSpaces this_$iv = ColorSpaces.INSTANCE;
        int id$iv = (int) ULong.m7173constructorimpl(63 & arg0);
        return this_$iv.getColorSpacesArray$ui_graphics_release()[id$iv];
    }

    /* renamed from: convert-vNxB06k, reason: not valid java name */
    public static final long m4184convertvNxB06k(long arg0, ColorSpace colorSpace) {
        Connector connector = ColorSpaceKt.m4613connectYBCOT_4$default(m4191getColorSpaceimpl(arg0), colorSpace, 0, 2, null);
        return connector.mo4616transformToColorl2rxGTc$ui_graphics_release(arg0);
    }

    /* renamed from: getRed-impl, reason: not valid java name */
    public static final float m4193getRedimpl(long arg0) {
        if (ULong.m7173constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m7173constructorimpl(ULong.m7173constructorimpl(arg0 >>> 48) & 255))) / 255.0f;
        }
        short h$iv = (short) ULong.m7173constructorimpl(ULong.m7173constructorimpl(arg0 >>> 48) & 65535);
    ...
    public static final float m4192getGreenimpl(long arg0) {
        if (ULong.m7173constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m7173constructorimpl(ULong.m7173constructorimpl(arg0 >>> 40) & 255))) / 255.0f;
        }
        short h$iv = (short) ULong.m7173constructorimpl(ULong.m7173constructorimpl(arg0 >>> 32) & 65535);
        int bits$iv = 65535 & h$iv;
        int s$iv = 32768 & bits$iv;
        int e$iv = (bits$iv >>> 10) & 31;
        int m$iv = bits$iv & 1023;
    ...
    public static final float m4190getBlueimpl(long arg0) {
        if (ULong.m7173constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m7173constructorimpl(ULong.m7173constructorimpl(arg0 >>> 32) & 255))) / 255.0f;
        }
        short h$iv = (short) ULong.m7173constructorimpl(ULong.m7173constructorimpl(arg0 >>> 16) & 65535);
        int bits$iv = 65535 & h$iv;
        int s$iv = 32768 & bits$iv;
        int e$iv = (bits$iv >>> 10) & 31;
        int m$iv = bits$iv & 1023;
    ...
    public static final float m4189getAlphaimpl(long arg0) {
        if (ULong.m7173constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m7173constructorimpl(ULong.m7173constructorimpl(arg0 >>> 56) & 255))) / 255.0f;
        }
        return ((float) UnsignedKt.ulongToDouble(ULong.m7173constructorimpl(ULong.m7173constructorimpl(arg0 >>> 6) & 1023))) / 1023.0f;
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m4178component1impl(long arg0) {
        return m4193getRedimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m4179component2impl(long arg0) {
        return m4192getGreenimpl(arg0);
    }

    /* renamed from: component3-impl, reason: not valid java name */
    public static final float m4180component3impl(long arg0) {
        return m4190getBlueimpl(arg0);
    }

    /* renamed from: component4-impl, reason: not valid java name */
    public static final float m4181component4impl(long arg0) {
        return m4189getAlphaimpl(arg0);
    }

    /* renamed from: component5-impl, reason: not valid java name */
    public static final ColorSpace m4182component5impl(long arg0) {
        return m4191getColorSpaceimpl(arg0);
    }

    /* renamed from: copy-wmQWz5c, reason: not valid java name */
    public static final long m4185copywmQWz5c(long arg0, float alpha, float red, float green, float blue) {
        return ColorKt.Color(red, green, blue, alpha, m4191getColorSpaceimpl(arg0));
    }
    ...
    public static String m4195toStringimpl(long arg0) {
        return "Color(" + m4193getRedimpl(arg0) + ", " + m4192getGreenimpl(arg0) + ", " + m4190getBlueimpl(arg0) + ", " + m4189getAlphaimpl(arg0) + ", " + m4191getColorSpaceimpl(arg0).getName() + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m4213getBlack0d7_KjU() {
            return Color.Black;
        }

        /* renamed from: getDarkGray-0d7_KjU, reason: not valid java name */
        public final long m4216getDarkGray0d7_KjU() {
            return Color.DarkGray;
        }

        /* renamed from: getGray-0d7_KjU, reason: not valid java name */
        public final long m4217getGray0d7_KjU() {
            return Color.Gray;
        }

        /* renamed from: getLightGray-0d7_KjU, reason: not valid java name */
        public final long m4219getLightGray0d7_KjU() {
        ...
        public final long m4221getRed0d7_KjU() {
            return Color.Red;
        }

        /* renamed from: getGreen-0d7_KjU, reason: not valid java name */
        public final long m4218getGreen0d7_KjU() {
            return Color.Green;
        }

        /* renamed from: getBlue-0d7_KjU, reason: not valid java name */
        public final long m4214getBlue0d7_KjU() {
            return Color.Blue;
        }

        /* renamed from: getYellow-0d7_KjU, reason: not valid java name */
        public final long m4225getYellow0d7_KjU() {
            return Color.Yellow;
        }

        /* renamed from: getCyan-0d7_KjU, reason: not valid java name */
        public final long m4215getCyan0d7_KjU() {
            return Color.Cyan;
        }

        /* renamed from: getMagenta-0d7_KjU, reason: not valid java name */
        public final long m4220getMagenta0d7_KjU() {
            return Color.Magenta;
        }

        /* renamed from: getTransparent-0d7_KjU, reason: not valid java name */
        public final long m4222getTransparent0d7_KjU() {
            return Color.Transparent;
        }

        /* renamed from: getUnspecified-0d7_KjU, reason: not valid java name */
        public final long m4223getUnspecified0d7_KjU() {
            return Color.Unspecified;
        }

        /* renamed from: hsv-JlNiLsg$default, reason: not valid java name */
        public static /* synthetic */ long m4212hsvJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            Rgb srgb;
            ...
            return companion.m4227hsvJlNiLsg(f, f2, f3, f5, srgb);
        }

        /* renamed from: hsv-JlNiLsg, reason: not valid java name */
        public final long m4227hsvJlNiLsg(float hue, float saturation, float value, float alpha, Rgb colorSpace) {
        ...
        public static /* synthetic */ long m4211hslJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            Rgb srgb;
            float f5 = (i & 8) != 0 ? 1.0f : f4;
            if ((i & 16) == 0) {
                srgb = rgb;
            ...
            return companion.m4226hslJlNiLsg(f, f2, f3, f5, srgb);
        }
        ...
        */
        public final long m4226hslJlNiLsg(float r7, float r8, float r9, float r10, androidx.compose.ui.graphics.colorspace.Rgb r11) {
            /*
                r6 = this;
                r0 = 1
                r1 = 0
            ...
            L30:
                ...
                androidx.compose.ui.graphics.InlineClassHelperKt.throwIllegalArgumentException(r3)
            L64:
                float r0 = r6.hslToRgbComponent(r1, r7, r8, r9)
                r1 = 8
                ...
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.Color.Companion.m4226hslJlNiLsg(float, float, float, float, androidx.compose.ui.graphics.colorspace.Rgb):long");
        }
