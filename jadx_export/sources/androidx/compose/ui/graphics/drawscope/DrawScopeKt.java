...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m4797rotateRg1IO4c$default(DrawScope $this$rotate_u2dRg1IO4c_u24default, float degrees, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$rotate_u2dRg1IO4c_u24default.mo4661getCenterF1C5BW0();
        }
        ...
        try {
            ...
            $this$rotate_Rg1IO4c_u24lambda_u240.mo4675rotateUv8p0NA(degrees, pivot);
    ...
    public static final void m4796rotateRg1IO4c(DrawScope $this$rotate_u2dRg1IO4c, float degrees, long pivot, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4799rotateRadRg1IO4c$default(DrawScope $this$rotateRad_u2dRg1IO4c_u24default, float radians, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$rotateRad_u2dRg1IO4c_u24default.mo4661getCenterF1C5BW0();
        }
        ...
        try {
            ...
            $this$rotateRad_Rg1IO4c_u24lambda_u241.mo4675rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
    ...
    public static final void m4798rotateRadRg1IO4c(DrawScope $this$rotateRad_u2dRg1IO4c, float radians, long pivot, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4801scaleFgt4K4Q$default(DrawScope $this$scale_u2dFgt4K4Q_u24default, float scaleX, float scaleY, long pivot, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            pivot = $this$scale_u2dFgt4K4Q_u24default.mo4661getCenterF1C5BW0();
        }
        ...
        try {
            ...
            $this$scale_Fgt4K4Q_u24lambda_u242.mo4676scale0AR0LA0(scaleX, scaleY, pivot);
    ...
    public static final void m4800scaleFgt4K4Q(DrawScope $this$scale_u2dFgt4K4Q, float scaleX, float scaleY, long pivot, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4803scaleRg1IO4c$default(DrawScope $this$scale_u2dRg1IO4c_u24default, float scale, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = $this$scale_u2dRg1IO4c_u24default.mo4661getCenterF1C5BW0();
        }
        ...
        try {
            ...
            $this$scale_Rg1IO4c_u24lambda_u243.mo4676scale0AR0LA0(scale, scale, pivot);
    ...
    public static final void m4802scaleRg1IO4c(DrawScope $this$scale_u2dRg1IO4c, float scale, long pivot, Function1<? super DrawScope, Unit> function1) {
    ...
    public static /* synthetic */ void m4792clipRectrOu3jXo$default(DrawScope $this$clipRect_u2drOu3jXo_u24default, float left, float top, float right, float bottom, int clipOp, Function1 block, int i, Object obj) {
        float right2;
        float bottom2;
        int clipOp2;
        ...
        if ((i & 4) != 0) {
            float right3 = Size.m4014getWidthimpl($this$clipRect_u2drOu3jXo_u24default.mo4662getSizeNHjbRc());
            right2 = right3;
        } else {
            right2 = right;
        }
        if ((i & 8) != 0) {
            float bottom3 = Size.m4011getHeightimpl($this$clipRect_u2drOu3jXo_u24default.mo4662getSizeNHjbRc());
            bottom2 = bottom3;
        } else {
            bottom2 = bottom;
        }
        if ((i & 16) != 0) {
            int clipOp3 = ClipOp.INSTANCE.m4176getIntersectrtfAjoo();
            clipOp2 = clipOp3;
        } else {
            clipOp2 = clipOp;
        }
        ...
        try {
            ...
            $this$clipRect_rOu3jXo_u24lambda_u244.mo4672clipRectN_I0leg(left2, top2, right2, bottom2, clipOp2);
    ...
    public static final void m4791clipRectrOu3jXo(DrawScope $this$clipRect_u2drOu3jXo, float left, float top, float right, float bottom, int clipOp, Function1<? super DrawScope, Unit> function1) throws Throwable {
        DrawContext $this$withTransform_u24lambda_u246$iv = $this$clipRect_u2drOu3jXo.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo4669getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        try {
            DrawTransform $this$clipRect_rOu3jXo_u24lambda_u244 = $this$withTransform_u24lambda_u246$iv.getTransform();
            $this$clipRect_rOu3jXo_u24lambda_u244.mo4672clipRectN_I0leg(left, top, right, bottom, clipOp);
        } catch (Throwable th) {
            th = th;
        }
        try {
    ...
    public static /* synthetic */ void m4790clipPathKD09W0M$default(DrawScope $this$clipPath_u2dKD09W0M_u24default, Path path, int clipOp, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            clipOp = ClipOp.INSTANCE.m4176getIntersectrtfAjoo();
        }
        ...
        try {
            ...
            $this$clipPath_KD09W0M_u24lambda_u245.mo4671clipPathmtrdDE(path, clipOp);
    ...
    public static final void m4789clipPathKD09W0M(DrawScope $this$clipPath_u2dKD09W0M, Path path, int clipOp, Function1<? super DrawScope, Unit> function1) {
    ...
    public static final void withTransform(DrawScope $this$withTransform, Function1<? super DrawTransform, Unit> function1, Function1<? super DrawScope, Unit> function12) {
        ...
        long previousSize = $this$withTransform_u24lambda_u246.mo4669getSizeNHjbRc();
        ...
        try {
            ...
            $this$withTransform_u24lambda_u246.mo4670setSizeuvyYCjk(previousSize);
        }
    }
    ...
    public static final /* synthetic */ void m4793drawGRGpd60(DrawScope $this$draw_u2dGRGpd60, Density density, LayoutDirection layoutDirection, Canvas canvas, long size, Function1<? super DrawScope, Unit> function1) {
        ...
        long prevSize$iv = $this$draw_u2dGRGpd60.getDrawContext().mo4669getSizeNHjbRc();
    ...
    public static /* synthetic */ void m4795drawymL40Pk$default(DrawScope $this$draw_u2dymL40Pk_u24default, Density density, LayoutDirection layoutDirection, Canvas canvas, long size, GraphicsLayer graphicsLayer, Function1 block, int i, Object obj) {
        ...
        long prevSize = $this$draw_u2dymL40Pk_u24default.getDrawContext().mo4669getSizeNHjbRc();
        ...
        $this$draw_ymL40Pk_u24lambda_u247.mo4670setSizeuvyYCjk(size);
        ...
        try {
            ...
            $this$draw_ymL40Pk_u24lambda_u248.mo4670setSizeuvyYCjk(prevSize);
            $this$draw_ymL40Pk_u24lambda_u248.setGraphicsLayer(prevLayer);
        }
    }

    /* renamed from: draw-ymL40Pk, reason: not valid java name */
    public static final void m4794drawymL40Pk(DrawScope $this$draw_u2dymL40Pk, Density density, LayoutDirection layoutDirection, Canvas canvas, long size, GraphicsLayer graphicsLayer, Function1<? super DrawScope, Unit> function1) {
        ...
        long prevSize = $this$draw_u2dymL40Pk.getDrawContext().mo4669getSizeNHjbRc();
