...
public final class Float16Kt {
    ...
    private static final short One = Float16.m4294constructorimpl(1.0f);
    private static final short NegativeOne = Float16.m4294constructorimpl(-1.0f);
    ...
    public static final short m4333minAoSsdG0(short x, short y) {
        if (Float16.m4305isNaNimpl(x) || Float16.m4305isNaNimpl(y)) {
            return Float16.Companion.m4327getNaNslo4al4();
        }
        return Float16.m4292compareTo41bOqos(x, y) <= 0 ? x : y;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m4332maxAoSsdG0(short x, short y) {
        if (Float16.m4305isNaNimpl(x) || Float16.m4305isNaNimpl(y)) {
            return Float16.Companion.m4327getNaNslo4al4();
        }
        return Float16.m4292compareTo41bOqos(x, y) >= 0 ? x : y;
