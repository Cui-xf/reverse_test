...
public final class VertexMode {
    ...
    private static final int Triangles = m4587constructorimpl(0);
    private static final int TriangleStrip = m4587constructorimpl(1);
    private static final int TriangleFan = m4587constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m4586boximpl(int i) {
        return new VertexMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4587constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4588equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4589equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4590hashCodeimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m4595getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI, reason: not valid java name */
        public final int m4594getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI, reason: not valid java name */
        public final int m4593getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4591toStringimpl(int arg0) {
        return m4589equalsimpl0(arg0, Triangles) ? "Triangles" : m4589equalsimpl0(arg0, TriangleStrip) ? "TriangleStrip" : m4589equalsimpl0(arg0, TriangleFan) ? "TriangleFan" : "Unknown";
    }
