...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m4129getSrcOver0nO6VwU();
    }
    ...
    public long mo4060getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo4066setColor8_81llA(long color) {
        AndroidPaint_androidKt.m4072setNativeColor4WTKRHQ(this.internalPaint, color);
    }
    ...
    public void mo4065setBlendModes9anfk8(int value) {
        if (!BlendMode.m4098equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m4071setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo4064getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo4070setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m4076setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo4062getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo4068setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m4074setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo4063getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo4069setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m4075setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int mo4061getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo4067setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m4073setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }
