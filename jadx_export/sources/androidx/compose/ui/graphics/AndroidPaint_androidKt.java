...
public final class AndroidPaint_androidKt {
    ...
    public static final void m4071setNativeBlendModeGB0RdKg(android.graphics.Paint $this$setNativeBlendMode_u2dGB0RdKg, int mode) {
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m4597setBlendModeGB0RdKg($this$setNativeBlendMode_u2dGB0RdKg, mode);
        } else {
            $this$setNativeBlendMode_u2dGB0RdKg.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m4038toPorterDuffModes9anfk8(mode)));
        }
    }
    ...
    public static final void m4072setNativeColor4WTKRHQ(android.graphics.Paint $this$setNativeColor_u2d4WTKRHQ, long value) {
        $this$setNativeColor_u2d4WTKRHQ.setColor(ColorKt.m4241toArgb8_81llA(value));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m4076setNativeStyle5YerkU(android.graphics.Paint $this$setNativeStyle_u2d_u2d5YerkU, int value) {
        $this$setNativeStyle_u2d_u2d5YerkU.setStyle(PaintingStyle.m4456equalsimpl0(value, PaintingStyle.INSTANCE.m4461getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint $this$getNativeStyle) {
        ...
        return (style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1 ? PaintingStyle.INSTANCE.m4461getStrokeTiuSbCo() : PaintingStyle.INSTANCE.m4460getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint $this$getNativeStrokeCap) {
        ...
        return StrokeCap.INSTANCE.m4547getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m4074setNativeStrokeCapCSYIeUk(android.graphics.Paint $this$setNativeStrokeCap_u2dCSYIeUk, int value) {
        Paint.Cap cap;
        if (StrokeCap.m4543equalsimpl0(value, StrokeCap.INSTANCE.m4549getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m4543equalsimpl0(value, StrokeCap.INSTANCE.m4548getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m4543equalsimpl0(value, StrokeCap.INSTANCE.m4547getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint $this$getNativeStrokeJoin) {
        ...
        return StrokeJoin.INSTANCE.m4558getMiterLxFBmk8();
    }

    /* renamed from: setNativeStrokeJoin-kLtJ_vA, reason: not valid java name */
    public static final void m4075setNativeStrokeJoinkLtJ_vA(android.graphics.Paint $this$setNativeStrokeJoin_u2dkLtJ_vA, int value) {
        Paint.Join join;
        if (StrokeJoin.m4553equalsimpl0(value, StrokeJoin.INSTANCE.m4558getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m4553equalsimpl0(value, StrokeJoin.INSTANCE.m4557getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m4553equalsimpl0(value, StrokeJoin.INSTANCE.m4559getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint $this$getNativeFilterQuality) {
        if (!$this$getNativeFilterQuality.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m4288getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m4286getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m4073setNativeFilterQuality50PEsBU(android.graphics.Paint $this$setNativeFilterQuality_u2d50PEsBU, int value) {
        $this$setNativeFilterQuality_u2d50PEsBU.setFilterBitmap(!FilterQuality.m4281equalsimpl0(value, FilterQuality.INSTANCE.m4288getNonefv9h1I()));
    }
