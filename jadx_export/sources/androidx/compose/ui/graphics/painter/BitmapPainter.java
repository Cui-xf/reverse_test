...
public final class BitmapPainter extends Painter {
    ...
    public /* synthetic */ BitmapPainter(ImageBitmap imageBitmap, long j, long j2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(imageBitmap, jM6835getZeronOccac, jIntSize, null);
    }
    ...
    private BitmapPainter(ImageBitmap image, long srcOffset, long srcSize) {
        ...
        this.filterQuality = FilterQuality.INSTANCE.m4286getLowfv9h1I();
        this.size = m4867validateSizeN5eqBDc(this.srcOffset, this.srcSize);
        this.alpha = 1.0f;
    }
    ...
    public final void m4870setFilterQualityvDHp3xo$ui_graphics_release(int i) {
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        ...
        float $this$fastRoundToInt$iv = Size.m4014getWidthimpl($this$onDraw.mo4662getSizeNHjbRc());
        int iRound = Math.round($this$fastRoundToInt$iv);
        float $this$fastRoundToInt$iv2 = Size.m4011getHeightimpl($this$onDraw.mo4662getSizeNHjbRc());
        DrawScope.CC.m4736drawImageAZ2fEMs$default($this$onDraw, imageBitmap, j, j2, 0L, IntSizeKt.IntSize(iRound, Math.round($this$fastRoundToInt$iv2)), this.alpha, null, this.colorFilter, 0, this.filterQuality, 328, null);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    /* renamed from: getIntrinsicSize-NH-jbRc, reason: not valid java name */
    public long mo4869getIntrinsicSizeNHjbRc() {
        return IntSizeKt.m6879toSizeozmzZPI(this.size);
    }
    ...
    private final long m4867validateSizeN5eqBDc(long srcOffset, long srcSize) {
        if (!(IntOffset.m6825getXimpl(srcOffset) >= 0 && IntOffset.m6826getYimpl(srcOffset) >= 0 && IntSize.m6867getWidthimpl(srcSize) >= 0 && IntSize.m6866getHeightimpl(srcSize) >= 0 && IntSize.m6867getWidthimpl(srcSize) <= this.image.getWidth() && IntSize.m6866getHeightimpl(srcSize) <= this.image.getHeight())) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BitmapPainter) && Intrinsics.areEqual(this.image, ((BitmapPainter) other).image) && IntOffset.m6824equalsimpl0(this.srcOffset, ((BitmapPainter) other).srcOffset) && IntSize.m6865equalsimpl0(this.srcSize, ((BitmapPainter) other).srcSize) && FilterQuality.m4281equalsimpl0(this.filterQuality, ((BitmapPainter) other).filterQuality);
    }

    public int hashCode() {
        int result = this.image.hashCode();
        return (((((result * 31) + IntOffset.m6827hashCodeimpl(this.srcOffset)) * 31) + IntSize.m6868hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m4282hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + ((Object) IntOffset.m6832toStringimpl(this.srcOffset)) + ", srcSize=" + ((Object) IntSize.m6870toStringimpl(this.srcSize)) + ", filterQuality=" + ((Object) FilterQuality.m4283toStringimpl(this.filterQuality)) + ')';
    }
}
