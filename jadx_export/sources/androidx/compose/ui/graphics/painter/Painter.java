...
public abstract class Painter {
    ...
    public abstract long mo4869getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m4874drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        ...
        painter.m4875drawx_KDEd0(drawScope, j, f2, colorFilter2);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m4875drawx_KDEd0(DrawScope $this$draw_u2dx_KDEd0, long size, float alpha, ColorFilter colorFilter) {
        configureAlpha(alpha);
        configureColorFilter(colorFilter);
        configureLayoutDirection($this$draw_u2dx_KDEd0.getLayoutDirection());
        float right$iv = Size.m4014getWidthimpl($this$draw_u2dx_KDEd0.mo4662getSizeNHjbRc()) - Size.m4014getWidthimpl(size);
        float bottom$iv = Size.m4011getHeightimpl($this$draw_u2dx_KDEd0.mo4662getSizeNHjbRc()) - Size.m4011getHeightimpl(size);
        $this$draw_u2dx_KDEd0.getDrawContext().getTransform().inset(0.0f, 0.0f, right$iv, bottom$iv);
        if (alpha > 0.0f) {
            try {
                if (Size.m4014getWidthimpl(size) > 0.0f && Size.m4011getHeightimpl(size) > 0.0f) {
                    if (this.useLayer) {
                        Rect layerRect = RectKt.m3985Recttz77jQw(Offset.INSTANCE.m3961getZeroF1C5BW0(), SizeKt.Size(Size.m4014getWidthimpl(size), Size.m4011getHeightimpl(size)));
