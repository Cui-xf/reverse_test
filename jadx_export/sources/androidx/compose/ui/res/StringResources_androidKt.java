...
public final class StringResources_androidKt {
    public static final String stringResource(int id, Composer $composer, int $changed) throws Resources.NotFoundException {
    ...
    public static final String stringResource(int id, Object[] formatArgs, Composer $composer, int $changed) throws Resources.NotFoundException {
    ...
    public static final String[] stringArrayResource(int id, Composer $composer, int $changed) throws Resources.NotFoundException {
    ...
    public static final String pluralStringResource(int id, int count, Composer $composer, int $changed) throws Resources.NotFoundException {
    ...
    public static final String pluralStringResource(int id, int count, Object[] formatArgs, Composer $composer, int $changed) throws Resources.NotFoundException {
