...
public final class PainterResources_androidKt {
    ...
    public static final Painter painterResource(int id, Composer $composer, int $changed) throws XmlPullParserException, Resources.NotFoundException, IllegalArgumentException {
        Object value$iv;
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        ResourceIdCache resourceIdCache = (ResourceIdCache) objConsume2;
    ...
    private static final ImageVector loadVectorResource(Resources.Theme theme, Resources res, int id, int changingConfigurations, Composer $composer, int $changed) throws XmlPullParserException, Resources.NotFoundException, IllegalArgumentException {
