...
public final class VectorResources_androidKt {
    public static final ImageVector vectorResource(ImageVector.Companion $this$vectorResource, int id, Composer $composer, int $changed) throws XmlPullParserException, Resources.NotFoundException, IOException {
        Object value$iv;
    ...
    public static final ImageVector vectorResource(ImageVector.Companion $this$vectorResource, Resources.Theme theme, Resources res, int resId) throws XmlPullParserException, Resources.NotFoundException, IOException {
    ...
    public static final ImageVectorCache.ImageVectorEntry loadVectorResourceInner(Resources.Theme theme, Resources res, XmlResourceParser parser, int changingConfigurations) throws XmlPullParserException, IllegalArgumentException {
