...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m4585getCenterSzJe1aQ();
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((maybeChangedFields & 4096) != 0) {
            ...
            setPivotX(TransformOrigin.m4580getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
            setPivotY(TransformOrigin.m4581getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            if ((maybeChangedFields & 64) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m4241toArgb8_81llA(scope.getAmbientShadowColor()));
            }
            if ((maybeChangedFields & 128) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m4241toArgb8_81llA(scope.getSpotShadowColor()));
            }
        }
        ...
        if ((32768 & maybeChangedFields) != 0) {
            int iMo4353getCompositingStrategyNrFUSI = scope.getCompositingStrategy();
            if (CompositingStrategy.m4271equalsimpl0(iMo4353getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m4277getOffscreenNrFUSI())) {
                setLayerType(2, null);
                z = true;
            } else if (CompositingStrategy.m4271equalsimpl0(iMo4353getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m4276getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
            } else {
                setLayerType(0, null);
                z = true;
    ...
    public void mo5829resizeozmzZPI(long size) {
        ...
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m4580getPivotFractionXimpl(this.mTransformOrigin) * width);
            setPivotY(TransformOrigin.m4581getPivotFractionYimpl(this.mTransformOrigin) * height);
            updateOutlineResolver();
    ...
    public void mo5828movegyyYBs(long position) {
        int left = IntOffset.m6825getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m6826getYimpl(position);
        if (top != getTop()) {
    ...
    public long mo5827mapOffset8S9VItk(long point, boolean inverse) {
        ...
        if (inverse) {
            float[] fArrM5904calculateInverseMatrixbWbORWo = layerMatrixCache.m5904calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m4430mapMKHz9U(layerMatrixCache.m5905calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        LayerMatrixCache<View> layerMatrixCache = this.matrixCache;
        if (inverse) {
            float[] matrix = layerMatrixCache.m5904calculateInverseMatrixbWbORWo(this);
            if (matrix != null) {
        ...
        androidx.compose.ui.graphics.Matrix.m4432mapimpl(layerMatrixCache.m5905calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo5830transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4441timesAssign58bKbWc(matrix, this.matrixCache.m5905calculateMatrixGrdbGEg(this));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* renamed from: inverseTransform-58bKbWc */
    public void mo5825inverseTransform58bKbWc(float[] matrix) {
        float[] inverse = this.matrixCache.m5904calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {
