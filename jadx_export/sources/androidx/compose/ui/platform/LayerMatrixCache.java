...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m5905calculateMatrixGrdbGEg(T target) {
        float[] it = this.matrixCache;
        if (it == null) {
            it = androidx.compose.ui.graphics.Matrix.m4424constructorimpl$default(null, 1, null);
            this.matrixCache = it;
        }
        if (!this.isDirty) {
            return it;
        ...
        if (prevMatrix == null || !Intrinsics.areEqual(it2, prevMatrix)) {
            AndroidMatrixConversions_androidKt.m4058setFromtUYjHk(it, it2);
    ...
    public final float[] m5904calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            float[] normalMatrix = m5905calculateMatrixGrdbGEg(target);
            this.isInverseValid = InvertMatrixKt.m5902invertToJiSxe2E(normalMatrix, it);
