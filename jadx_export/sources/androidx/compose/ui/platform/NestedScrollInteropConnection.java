...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo479onPreScrollOzD1aCk(long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m5923getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m5925toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3945getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3946getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m5925toViewTypeGyEprt8(source));
            return NestedScrollInteropConnectionKt.m5924toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
    ...
    public long mo477onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3945getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3946getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3945getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3946getYimpl(available)), null, NestedScrollInteropConnectionKt.m5925toViewTypeGyEprt8(source), this.consumedScrollCache);
        return NestedScrollInteropConnectionKt.m5924toOffsetUv8p0NA(this.consumedScrollCache, available);
    }
    ...
    public Object mo478onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        long result;
        if (this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6934getXimpl(available)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6935getYimpl(available)))) {
            result = available;
        } else {
            result = Velocity.INSTANCE.m6945getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m6925boximpl(result);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo476onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        long result;
        if (this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6934getXimpl(available)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6935getYimpl(available)), true)) {
            result = available;
        } else {
            result = Velocity.INSTANCE.m6945getZero9UxMQ8M();
        }
