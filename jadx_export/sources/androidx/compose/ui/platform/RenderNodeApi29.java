...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    public void mo5888setCompositingStrategyaDBOjCE(int value) {
        ...
        } else if (CompositingStrategy.m4271equalsimpl0(value, CompositingStrategy.INSTANCE.m4276getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.CC.m4159clipPathmtrdDE$default($this$record_u24lambda_u241, clipPath, 0, 2, null);
        }
