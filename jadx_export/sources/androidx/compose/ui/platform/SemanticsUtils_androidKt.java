...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m5929toLegacyClassNameV4PA4sw(int $this$toLegacyClassName_u2dV4PA4sw) {
        if (Role.m5952equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m5956getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m5952equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m5957getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m5952equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m5960getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m5952equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m5959getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m5952equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m5958getDropdownListo7Vup1c())) {
    ...
    private static final void getAllUncoveredSemanticsNodesToIntObjectMap$findAllSemanticNodesRecursive(Region unaccountedSpace, SemanticsNode root, MutableIntObjectMap<SemanticsNodeWithAdjustedBounds> mutableIntObjectMap, SemanticsNode currentNode, Region region) {
        ...
        if (!unaccountedSpace.isEmpty() || currentNode.getId() == root.getId()) {
            ...
            int iRound2 = Math.round($this$fastRoundToInt$iv6);
            ...
            mutableIntObjectMap.set(virtualViewId, new SemanticsNodeWithAdjustedBounds(currentNode, new android.graphics.Rect(iRound, iRound2, left2, Math.round($this$fastRoundToInt$iv8))));
        }
    }
}
