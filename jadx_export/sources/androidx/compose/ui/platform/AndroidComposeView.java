...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        super(context);
        this.lastDownPointerPosition = Offset.INSTANCE.m3960getUnspecifiedF1C5BW0();
        ...
        this.keyInputModifier = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m5868invokeZmokQxo(keyEvent.m5246unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m5868invokeZmokQxo(android.view.KeyEvent keyEvent) {
                final FocusDirection focusDirection = this.this$0.mo5833getFocusDirectionP8AzH3I(keyEvent);
                if (focusDirection != null && KeyEventType.m5250equalsimpl0(KeyEvent_androidKt.m5258getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m5254getKeyDownCS__XNY())) {
                    Rect focusedRect = this.this$0.onFetchFocusRect();
                    Boolean boolMo3876focusSearchULY8qGw = this.this$0.getFocusOwner().mo3876focusSearchULY8qGw(focusDirection.getValue(), focusedRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1$focusWasMovedOrCancelled$1
                        {
                            super(1);
                        }
                        ...
                        public final Boolean invoke(FocusTargetNode it) {
                            Boolean boolM3896requestFocusMxy_nc0 = FocusTransactionsKt.m3896requestFocusMxy_nc0(it, focusDirection.getValue());
                            return Boolean.valueOf(boolM3896requestFocusMxy_nc0 != null ? boolM3896requestFocusMxy_nc0.booleanValue() : true);
                        }
                    });
                    boolean focusWasMovedOrCancelled = boolMo3876focusSearchULY8qGw != null ? boolMo3876focusSearchULY8qGw.booleanValue() : true;
                    if (focusWasMovedOrCancelled) {
                        return true;
                    }
                    if (!FocusOwnerImplKt.m3883is1dFocusSearch3ESFkO8(focusDirection.getValue())) {
                        return false;
                    }
                    Integer numM3871toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3871toAndroidFocusDirection3ESFkO8(focusDirection.getValue());
                    if (numM3871toAndroidFocusDirection3ESFkO8 == null) {
                        throw new IllegalStateException("Invalid focus direction".toString());
                    }
                    int androidDirection = numM3871toAndroidFocusDirection3ESFkO8.intValue();
                    ...
                    boolean clearedFocusSuccessfully = this.this$0.getFocusOwner().mo3873clearFocusI7lrPNg(false, true, false, focusDirection.getValue());
                    if (!clearedFocusSuccessfully) {
                        return true;
                    }
                    Boolean boolMo3876focusSearchULY8qGw2 = this.this$0.getFocusOwner().mo3876focusSearchULY8qGw(focusDirection.getValue(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1.1
                        {
                            super(1);
                        }
                    ...
                    return Boolean.valueOf(boolMo3876focusSearchULY8qGw2 != null ? boolMo3876focusSearchULY8qGw2.booleanValue() : true);
                }
                return false;
            }
        });
        ...
        this.tmpMatrix = Matrix.m4424constructorimpl$default(null, 1, null);
        this.viewToWindowMatrix = Matrix.m4424constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m4424constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m3959getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m3794constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m4940getTouchaOaMEAU() : InputMode.INSTANCE.m4939getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m5864invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m5864invokeiuPiT84(int it) {
                boolean zRequestFocusFromTouch;
                if (InputMode.m4935equalsimpl0(it, InputMode.INSTANCE.m4940getTouchaOaMEAU())) {
                    zRequestFocusFromTouch = this.this$0.isInTouchMode();
                } else if (InputMode.m4935equalsimpl0(it, InputMode.INSTANCE.m4939getKeyboardaOaMEAU())) {
        ...
        this.matrixToWindow = Build.VERSION.SDK_INT < 29 ? new CalculateMatrixToWindowApi21(this.tmpMatrix, b == true ? 1 : 0) : new CalculateMatrixToWindowApi29();
    ...
    public void setCoroutineContext(CoroutineContext value) {
        ...
        int iM5778constructorimpl = NodeKind.m5778constructorimpl(16);
        ...
        while (layout$iv$iv != null) {
            ...
            if ((node$iv$iv2.getAggregateChildKindSet() & iM5778constructorimpl) != 0) {
                while (node$iv$iv2 != null) {
                    if ((node$iv$iv2.getKindSet() & iM5778constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            if (nodePop instanceof PointerInputModifierNode) {
                                ...
                                int kindSet = this_$iv$iv$iv.getKindSet() & iM5778constructorimpl;
                                int i = 1;
    ...
    public final boolean m5859onMoveFocusInChildren3ESFkO8(int focusDirection) {
        View nextView;
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3864getEnterdhqQ8s()) || FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3865getExitdhqQ8s())) {
            return false;
        }
        ...
        int direction = numM3871toAndroidFocusDirection3ESFkO8.intValue();
    ...
    static final void touchModeChangeListener$lambda$6(AndroidComposeView this$0, boolean touchMode) {
        ...
        inputModeManagerImpl.m4943setInputModeiuPiT84(touchMode ? companion.m4940getTouchaOaMEAU() : companion.m4939getKeyboardaOaMEAU());
    }
    ...
    */
    public java.lang.Object textInputSession(kotlin.jvm.functions.Function2<? super androidx.compose.ui.platform.PlatformTextInputSessionScope, ? super kotlin.coroutines.Continuation<?>, ? extends java.lang.Object> r6, kotlin.coroutines.Continuation<?> r7) {
        /*
            r5 = this;
            boolean r0 = r7 instanceof androidx.compose.ui.platform.AndroidComposeView.C06131
            if (r0 == 0) goto L14
            r0 = r7
            androidx.compose.ui.platform.AndroidComposeView$textInputSession$1 r0 = (androidx.compose.ui.platform.AndroidComposeView.C06131) r0
            int r1 = r0.label
        ...
        L30:
            ...
            r2 = 1
            r0.label = r2
            java.lang.Object r6 = androidx.compose.ui.SessionMutex.m3801withSessionCancellingPreviousimpl(r3, r4, r6, r0)
            if (r6 != r1) goto L48
            return r1
        L48:
    ...
    static final void sendHoverExitEvent$lambda$8(AndroidComposeView this$0) {
        ...
        this$0.m5862sendMotionEvent8iAsVTc(lastEvent);
    }
    ...
    public View focusSearch(View focused, int direction) {
        if (focused != null) {
            ...
            int focusDirection2 = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m3863getDowndhqQ8s();
            if (Intrinsics.areEqual((Object) getFocusOwner().mo3876focusSearchULY8qGw(focusDirection2, focusedBounds, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.focusSearch.1
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(FocusTargetNode it) {
                    return true;
                }
    ...
    public boolean requestFocus(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int focusDirection2 = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m3864getEnterdhqQ8s();
        Boolean boolMo3876focusSearchULY8qGw = getFocusOwner().mo3876focusSearchULY8qGw(focusDirection2, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.requestFocus.1
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode it) {
                Boolean boolM3896requestFocusMxy_nc0 = FocusTransactionsKt.m3896requestFocusMxy_nc0(it, focusDirection2);
    ...
    public final boolean m5860onRequestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
        Integer numM3871toAndroidFocusDirection3ESFkO8;
        if (isFocused() || hasFocus()) {
            return true;
        }
        return super.requestFocus((focusDirection == null || (numM3871toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m3871toAndroidFocusDirection3ESFkO8(focusDirection.getValue())) == null) ? 130 : numM3871toAndroidFocusDirection3ESFkO8.intValue(), previouslyFocusedRect != null ? RectHelper_androidKt.toAndroidRect(previouslyFocusedRect) : null);
    }
    ...
    public boolean mo5835sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        return getFocusOwner().mo3874dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.CC.m3879dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchKeyEvent(final android.view.KeyEvent event) {
        if (isFocused()) {
            this._windowInfo.m5938setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m5468constructorimpl(event.getMetaState()));
            return FocusOwner.CC.m3879dispatchKeyEventYhN2O0w$default(getFocusOwner(), KeyEvent.m5241constructorimpl(event), null, 2, null) || super.dispatchKeyEvent(event);
        }
        return getFocusOwner().mo3875dispatchKeyEventYhN2O0w(KeyEvent.m5241constructorimpl(event), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.dispatchKeyEvent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        return (isFocused() && getFocusOwner().mo3874dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m5241constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public final boolean m5863startDrag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
        ...
        return startDrag(transferData.getClipData(), shadowBuilder, transferData.getLocalState(), transferData.getFlags());
    }
                    ...
                    androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1 r1 = new kotlin.jvm.functions.Function1<androidx.compose.ui.node.LayoutNode, java.lang.Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                        ...
                        public final java.lang.Boolean invoke(androidx.compose.ui.node.LayoutNode r4) {
                            /*
                                ...
                                r1 = 0
                                r2 = 8
                                int r1 = androidx.compose.ui.node.NodeKind.m5778constructorimpl(r2)
                                boolean r0 = r0.m5739hasH91voCI$ui_release(r1)
    ...
    public void mo5834measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m5732measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) throws Throwable {
        ...
        try {
            ...
            long $this$component2_u2dVKZWuLQ$iv = m5857convertMeasureSpecI7RO_PI(widthMeasureSpec);
            minWidth = (int) ULong.m7173constructorimpl($this$component2_u2dVKZWuLQ$iv >>> 32);
            maxWidth = (int) ULong.m7173constructorimpl($this$component2_u2dVKZWuLQ$iv & 4294967295L);
        } catch (Throwable th) {
            th = th;
        }
        try {
            long $this$component2_u2dVKZWuLQ$iv2 = m5857convertMeasureSpecI7RO_PI(heightMeasureSpec);
            int minHeight = (int) ULong.m7173constructorimpl($this$component2_u2dVKZWuLQ$iv2 >>> 32);
            int maxHeight = (int) ULong.m7173constructorimpl($this$component2_u2dVKZWuLQ$iv2 & 4294967295L);
            long constraints = ConstraintsKt.Constraints(minWidth, maxWidth, minHeight, maxHeight);
            if (this.onMeasureConstraints == null) {
                this.onMeasureConstraints = Constraints.m6624boximpl(constraints);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                Constraints constraints2 = this.onMeasureConstraints;
                if (!(constraints2 != null ? Constraints.m6629equalsimpl0(constraints2.getValue(), constraints) : false)) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m5733updateRootConstraintsBRTryo0(constraints);
    ...
    private final int m5855component1VKZWuLQ(long $this$component1_u2dVKZWuLQ) {
        return (int) ULong.m7173constructorimpl($this$component1_u2dVKZWuLQ >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m5856component2VKZWuLQ(long $this$component2_u2dVKZWuLQ) {
        return (int) ULong.m7173constructorimpl(4294967295L & $this$component2_u2dVKZWuLQ);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m5861packZIaKswc(int a, int b) {
        return ULong.m7173constructorimpl(ULong.m7173constructorimpl(ULong.m7173constructorimpl(a) << 32) | ULong.m7173constructorimpl(b));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m5857convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        switch (mode) {
            case Integer.MIN_VALUE:
                return m5861packZIaKswc(0, size);
            case 0:
                return m5861packZIaKswc(0, Integer.MAX_VALUE);
            case 1073741824:
                return m5861packZIaKswc(size, size);
            default:
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        int iM6825getXimpl = IntOffset.m6825getXimpl(j);
        int globalY = IntOffset.m6826getYimpl(j);
        if (iM6825getXimpl != this.tmpPositionArray[0] || globalY != this.tmpPositionArray[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(this.tmpPositionArray[0], this.tmpPositionArray[1]);
            if (iM6825getXimpl != Integer.MAX_VALUE && globalY != Integer.MAX_VALUE) {
    ...
    public final boolean recycle$ui_release(OwnedLayer layer) {
        boolean cacheValue = this.viewLayersContainer == null || ViewLayer.INSTANCE.getShouldUseDispatchDraw() || Build.VERSION.SDK_INT >= 23;
        if (cacheValue) {
    ...
    public FocusDirection mo5833getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        long jM5257getKeyZmokQxo = KeyEvent_androidKt.m5257getKeyZmokQxo(keyEvent);
        if (Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5185getTabEK5gGoQ())) {
            return FocusDirection.m3854boximpl(KeyEvent_androidKt.m5263isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m3868getPreviousdhqQ8s() : FocusDirection.INSTANCE.m3867getNextdhqQ8s());
        }
        if (Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5026getDirectionRightEK5gGoQ())) {
            return FocusDirection.m3854boximpl(FocusDirection.INSTANCE.m3869getRightdhqQ8s());
        }
        if (Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5025getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m3854boximpl(FocusDirection.INSTANCE.m3866getLeftdhqQ8s());
        }
        if (Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5027getDirectionUpEK5gGoQ()) ? true : Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5138getPageUpEK5gGoQ())) {
            return FocusDirection.m3854boximpl(FocusDirection.INSTANCE.m3870getUpdhqQ8s());
        }
        if (Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5022getDirectionDownEK5gGoQ()) ? true : Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5137getPageDownEK5gGoQ())) {
            return FocusDirection.m3854boximpl(FocusDirection.INSTANCE.m3863getDowndhqQ8s());
        }
        if (Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5021getDirectionCenterEK5gGoQ()) ? true : Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5035getEnterEK5gGoQ()) ? true : Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5127getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m3854boximpl(FocusDirection.INSTANCE.m3864getEnterdhqQ8s());
        }
        if (Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m4964getBackEK5gGoQ()) ? true : Key.m4949equalsimpl0(jM5257getKeyZmokQxo, Key.INSTANCE.m5038getEscapeEK5gGoQ())) {
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m4943setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m4940getTouchaOaMEAU() : InputMode.INSTANCE.m4939getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return motionEvent.isFromSource(4194304) ? handleRotaryEvent(motionEvent) : ProcessResult.m5494getDispatchedToAPointerInputModifierimpl(m5858handleMotionEvent8iAsVTc(motionEvent));
        }
        return super.dispatchGenericMotionEvent(motionEvent);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int processResult = m5858handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m5493getAnyMovementConsumedimpl(processResult)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m5494getDispatchedToAPointerInputModifierimpl(processResult);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:90:0x0138 A[Catch: all -> 0x017d, TryCatch #2 {all -> 0x017d, blocks: (B:5:0x001f, B:7:0x0029, B:17:0x0044, B:39:0x00a4, B:46:0x00c2, B:47:0x00c5, B:49:0x00c9, B:54:0x00d4, B:56:0x00d8, B:58:0x00de, B:60:0x00e5, B:63:0x00ed, B:64:0x00f4, B:66:0x00fa, B:68:0x0100, B:70:0x0106, B:72:0x010d, B:74:0x0111, B:75:0x0115, B:88:0x0133, B:90:0x0138, B:92:0x013f, B:105:0x015a, B:106:0x015f, B:107:0x0164), top: B:122:0x001f }] */
    /* JADX WARN: Removed duplicated region for block: B:91:0x013d  */
    /* JADX WARN: Removed duplicated region for block: B:94:0x0147  */
    /* JADX WARN: Removed duplicated region for block: B:95:0x0149  */
    /* JADX WARN: Removed duplicated region for block: B:98:0x014d A[ADDED_TO_REGION] */
    /* renamed from: handleMotionEvent-8iAsVTc, reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final int m5858handleMotionEvent8iAsVTc(android.view.MotionEvent r23) {
        /*
            Method dump skipped, instructions count: 390
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.AndroidComposeView.m5858handleMotionEvent8iAsVTc(android.view.MotionEvent):int");
    }
    ...
    private final int m5862sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        Object item$iv;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m5938setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m5468constructorimpl(motionEvent.getMetaState()));
        }
        ...
        if (pointerInputEventData != null) {
            long it2 = pointerInputEventData.m5421getPositionF1C5BW0();
            this.lastDownPointerPosition = it2;
        }
        int result = this.pointerInputEventProcessor.m5426processBIzXfog(pointerInputEvent, this, isInBounds(motionEvent));
        int action = motionEvent.getActionMasked();
        if ((action != 0 && action != 5) || ProcessResult.m5494getDispatchedToAPointerInputModifierimpl(result)) {
            return result;
        }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long screenPosition = mo5487localToScreenMKHz9U(localPosition);
            coords.x = Offset.m3945getXimpl(screenPosition);
            coords.y = Offset.m3946getYimpl(screenPosition);
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m5426processBIzXfog(pointerInputEvent, this, true);
        event.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.composeAccessibilityDelegate.m5870canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.composeAccessibilityDelegate.m5870canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo5487localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long local = Matrix.m4430mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m3945getXimpl(local) + Offset.m3945getXimpl(this.windowPosition), Offset.m3946getYimpl(local) + Offset.m3946getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: localToScreen-58bKbWc */
    public void mo5486localToScreen58bKbWc(float[] localTransform) {
        recalculateWindowPosition();
        Matrix.m4441timesAssign58bKbWc(localTransform, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m5875preTranslatecG2Xzmc(localTransform, Offset.m3945getXimpl(this.windowPosition), Offset.m3946getYimpl(this.windowPosition), this.tmpMatrix);
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo5488screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        float x = Offset.m3945getXimpl(positionOnScreen) - Offset.m3945getXimpl(this.windowPosition);
        float y = Offset.m3946getYimpl(positionOnScreen) - Offset.m3946getYimpl(this.windowPosition);
        return Matrix.m4430mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(x, y));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long positionInWindow = Matrix.m4430mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m3945getXimpl(positionInWindow), motionEvent.getRawY() - Offset.m3946getYimpl(positionInWindow));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo5876calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m5902invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }

    @Override // android.view.View
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession parentSession = (AndroidPlatformTextInputSession) SessionMutex.m3798getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo5831calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m4430mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo5832calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m4430mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        int result = m5858handleMotionEvent8iAsVTc(event);
        return ProcessResult.m5494getDispatchedToAPointerInputModifierimpl(result);
    }
