...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        ...
        return CornerRadius.m3914constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final long m3931lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m3920getXimpl(start), CornerRadius.m3920getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m3921getYimpl(start), CornerRadius.m3921getYimpl(stop), fraction));
    }
}
