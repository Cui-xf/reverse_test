...
public final class SizeKt {
    ...
    public static /* synthetic */ void m4025getCenteruvyYCjk$annotations(long j) {
    }

    /* renamed from: isSpecified-uvyYCjk$annotations, reason: not valid java name */
    public static /* synthetic */ void m4027isSpecifieduvyYCjk$annotations(long j) {
    }

    /* renamed from: isUnspecified-uvyYCjk$annotations, reason: not valid java name */
    public static /* synthetic */ void m4029isUnspecifieduvyYCjk$annotations(long j) {
    }
    ...
    public static final long Size(float width, float height) {
        ...
        return Size.m4005constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }

    /* renamed from: isSpecified-uvyYCjk, reason: not valid java name */
    public static final boolean m4026isSpecifieduvyYCjk(long $this$isSpecified) {
        return $this$isSpecified != InlineClassHelperKt.UnspecifiedPackedFloats;
    }

    /* renamed from: isUnspecified-uvyYCjk, reason: not valid java name */
    public static final boolean m4028isUnspecifieduvyYCjk(long $this$isUnspecified) {
        return $this$isUnspecified == InlineClassHelperKt.UnspecifiedPackedFloats;
    }

    /* renamed from: takeOrElse-TmRCtEA, reason: not valid java name */
    public static final long m4031takeOrElseTmRCtEA(long $this$takeOrElse_u2dTmRCtEA, Function0<Size> function0) {
    ...
    public static final long m4030lerpVgWVRYQ(long start, long stop, float fraction) {
    ...
    public static final long m4034timesd16Qtg0(int $this$times_u2dd16Qtg0, long size) {
        return Size.m4017times7Ah8Wj8(size, $this$times_u2dd16Qtg0);
    }

    /* renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m4032timesd16Qtg0(double $this$times_u2dd16Qtg0, long size) {
        return Size.m4017times7Ah8Wj8(size, (float) $this$times_u2dd16Qtg0);
    }

    /* renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m4033timesd16Qtg0(float $this$times_u2dd16Qtg0, long size) {
        return Size.m4017times7Ah8Wj8(size, $this$times_u2dd16Qtg0);
    }

    /* renamed from: toRect-uvyYCjk, reason: not valid java name */
    public static final Rect m4035toRectuvyYCjk(long $this$toRect_u2duvyYCjk) {
        return RectKt.m3985Recttz77jQw(Offset.INSTANCE.m3961getZeroF1C5BW0(), $this$toRect_u2duvyYCjk);
    }

    /* renamed from: getCenter-uvyYCjk, reason: not valid java name */
    public static final long m4024getCenteruvyYCjk(long $this$center) {
