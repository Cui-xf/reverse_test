...
public final class Size {
    ...
    private static final long Zero = m4005constructorimpl(0);
    private static final long Unspecified = m4005constructorimpl(InlineClassHelperKt.UnspecifiedPackedFloats);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Size m4002boximpl(long j) {
        return new Size(j);
    }
    ...
    public static boolean m4009equalsimpl(long j, Object obj) {
        return (obj instanceof Size) && j == ((Size) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4010equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m4015hashCodeimpl(long j) {
        return FloatFloatPair$$ExternalSyntheticBackport0.m(j);
    }

    public boolean equals(Object obj) {
        return m4009equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4015hashCodeimpl(this.packedValue);
    }
    ...
    public static final float m4014getWidthimpl(long arg0) {
    ...
    public static final float m4011getHeightimpl(long arg0) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
    ...
    public static final float m4003component1impl(long arg0) {
        return m4014getWidthimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m4004component2impl(long arg0) {
        return m4011getHeightimpl(arg0);
    }

    /* renamed from: copy-xjbvk4A$default, reason: not valid java name */
    public static /* synthetic */ long m4007copyxjbvk4A$default(long value$iv, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m4006copyxjbvk4A(value$iv, f, f2);
    }

    /* renamed from: copy-xjbvk4A, reason: not valid java name */
    public static final long m4006copyxjbvk4A(long arg0, float width, float height) {
        long v1$iv = Float.floatToRawIntBits(width);
        long v2$iv = Float.floatToRawIntBits(height);
        return m4005constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4020getUnspecifiedNHjbRc$annotations() {
        }

        /* renamed from: getZero-NH-jbRc$annotations, reason: not valid java name */
        public static /* synthetic */ void m4021getZeroNHjbRc$annotations() {
        }
        ...
        public final long m4023getZeroNHjbRc() {
            return Size.Zero;
        }

        /* renamed from: getUnspecified-NH-jbRc, reason: not valid java name */
        public final long m4022getUnspecifiedNHjbRc() {
            return Size.Unspecified;
        }
    }

    /* renamed from: isEmpty-impl, reason: not valid java name */
    public static final boolean m4016isEmptyimpl(long arg0) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
    ...
    public static final long m4017times7Ah8Wj8(long arg0, float operand) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
        int bits$iv$iv = (int) (arg0 >> 32);
    ...
    public static final long m4008div7Ah8Wj8(long arg0, float operand) {
        if (arg0 == InlineClassHelperKt.UnspecifiedPackedFloats) {
            InlineClassHelperKt.throwIllegalStateException("Size is unspecified");
        }
        int bits$iv$iv = (int) (arg0 >> 32);
    ...
    public static String m4018toStringimpl(long arg0) {
        if (arg0 != InlineClassHelperKt.UnspecifiedPackedFloats) {
            return "Size(" + GeometryUtilsKt.toStringAsFixed(m4014getWidthimpl(arg0), 1) + ", " + GeometryUtilsKt.toStringAsFixed(m4011getHeightimpl(arg0), 1) + ')';
        }
        return "Size.Unspecified";
    }
}
