...
public final class SemanticsNodeKt {
    public static final SemanticsNode SemanticsNode(LayoutNode layoutNode, boolean mergingEnabled) {
        ...
        int count$iv$iv$iv2 = NodeKind.m5778constructorimpl(8);
        int i4 = 0;
            ...
            loop0: while (node$iv$iv$iv$iv != null) {
                ...
                if ((it$iv$iv$iv.getKindSet() & count$iv$iv$iv2) == 0) {
                    ...
                    while (nodePop != null) {
                        ...
                        if (((this_$iv$iv$iv$iv.getKindSet() & type$iv2) != 0 ? 1 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                            i2 = i4;
        ...
        return new SemanticsNode(node4, mergingEnabled, layoutNode, collapsedSemantics$ui_release);
    }
