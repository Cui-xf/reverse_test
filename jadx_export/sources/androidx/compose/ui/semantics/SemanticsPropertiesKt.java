...
public final class SemanticsPropertiesKt {
    ...
    public static final void m5974setLiveRegionhR3wRGc(SemanticsPropertyReceiver $this$liveRegion, int i) {
        SemanticsProperties.INSTANCE.getLiveRegion().setValue($this$liveRegion, $$delegatedProperties[3], LiveRegionMode.m5940boximpl(i));
    }
    ...
    public static final int getContentDataType(SemanticsPropertyReceiver $this$contentDataType) {
        return SemanticsProperties.INSTANCE.getContentDataType$ui_release().getValue($this$contentDataType, $$delegatedProperties[8]).m3809unboximpl();
    }

    /* renamed from: setContentDataType-NTL_tik, reason: not valid java name */
    public static final void m5972setContentDataTypeNTL_tik(SemanticsPropertyReceiver $this$contentDataType, int i) {
        SemanticsProperties.INSTANCE.getContentDataType$ui_release().setValue($this$contentDataType, $$delegatedProperties[8], ContentDataType.m3803boximpl(i));
    }
    ...
    public static final void m5975setRolekuIjeqM(SemanticsPropertyReceiver $this$role, int i) {
        SemanticsProperties.INSTANCE.getRole().setValue($this$role, $$delegatedProperties[12], Role.m5949boximpl(i));
    }
    ...
    public static final void m5976setTextSelectionRangeFDrldGo(SemanticsPropertyReceiver $this$textSelectionRange, long j) {
        SemanticsProperties.INSTANCE.getTextSelectionRange().setValue($this$textSelectionRange, $$delegatedProperties[17], TextRange.m6134boximpl(j));
    }
    ...
    public static final void m5973setImeAction4L7nppU(SemanticsPropertyReceiver $this$imeAction, int i) {
        SemanticsProperties.INSTANCE.getImeAction().setValue($this$imeAction, $$delegatedProperties[18], ImeAction.m6310boximpl(i));
    }
    ...
    public static /* synthetic */ void m5971onImeAction9UiTYpY$default(SemanticsPropertyReceiver semanticsPropertyReceiver, int i, String str, Function0 function0, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            str = null;
        }
        m5970onImeAction9UiTYpY(semanticsPropertyReceiver, i, str, function0);
    }

    /* renamed from: onImeAction-9UiTYpY, reason: not valid java name */
    public static final void m5970onImeAction9UiTYpY(SemanticsPropertyReceiver $this$onImeAction_u2d9UiTYpY, int imeActionType, String label, Function0<Boolean> function0) {
        $this$onImeAction_u2d9UiTYpY.set(SemanticsProperties.INSTANCE.getImeAction(), ImeAction.m6310boximpl(imeActionType));
