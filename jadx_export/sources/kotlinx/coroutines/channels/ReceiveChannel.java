...
public interface ReceiveChannel<E> {
    ...
    Object mo8493receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo8494tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo8494tryReceivePtdJZtk = receiveChannel.mo8494tryReceivePtdJZtk();
            if (ChannelResult.m8509isSuccessimpl(objMo8494tryReceivePtdJZtk)) {
                return (E) ChannelResult.m8505getOrThrowimpl(objMo8494tryReceivePtdJZtk);
            }
            Throwable thM8503exceptionOrNullimpl = ChannelResult.m8503exceptionOrNullimpl(objMo8494tryReceivePtdJZtk);
            if (thM8503exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM8503exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L37:
                ...
                r2 = 1
                r0.label = r2
                java.lang.Object r3 = r3.mo8493receiveCatchingJP2dKIU(r0)
                if (r3 != r1) goto L44
                return r1
            L44:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m8504getOrNullimpl(r3)
                return r3
            */
