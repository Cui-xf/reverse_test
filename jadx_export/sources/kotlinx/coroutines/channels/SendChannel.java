...
public interface SendChannel<E> {
    ...
    Object mo8489trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo8489trySendJP2dKIU(e);
            if (ChannelResult.m8509isSuccessimpl(result)) {
                return true;
            }
            Throwable thM8503exceptionOrNullimpl = ChannelResult.m8503exceptionOrNullimpl(result);
