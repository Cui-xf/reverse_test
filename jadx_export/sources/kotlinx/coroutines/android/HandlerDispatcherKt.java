...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM6999constructorimpl = Result.m6999constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6999constructorimpl = Result.m6999constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m7005isFailureimpl(objM6999constructorimpl) ? null : objM6999constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo8544dispatch(cont.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
