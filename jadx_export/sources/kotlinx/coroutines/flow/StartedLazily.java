...
final class StartedLazily implements SharingStarted {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (this.$subscriptionCount.collect(new C01551(started, $this$flow), this) != coroutine_suspended) {
                        break;
                    } else {
        ...
        static final class C01551<T> implements FlowCollector {
            final /* synthetic */ FlowCollector<SharingCommand> $$this$flow;
            final /* synthetic */ Ref.BooleanRef $started;

            /* JADX WARN: Multi-variable type inference failed */
            C01551(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
            ...
            */
            public final java.lang.Object emit(int r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
                ...
                L4e:
                    ...
                    return r6
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.StartedLazily.AnonymousClass1.C01551.emit(int, kotlin.coroutines.Continuation):java.lang.Object");
            }
