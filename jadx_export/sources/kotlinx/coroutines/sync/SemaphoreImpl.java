...
public class SemaphoreImpl implements Semaphore {
    ...
    */
    ...
    public final boolean addAcquireToQueue(Waiter waiter) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m8550getSegmentimpl(s$iv);
        int i = (int) (enqIdx % SemaphoreKt.SEGMENT_SIZE);
        if (!AtomicIntrinsicsKt$$ExternalSyntheticBackportWithForwarding0.m(segment.getAcquirers(), i, null, waiter)) {
            Object expected$iv = SemaphoreKt.PERMIT;
            Object value$iv = SemaphoreKt.TAKEN;
            if (AtomicIntrinsicsKt$$ExternalSyntheticBackportWithForwarding0.m(segment.getAcquirers(), i, expected$iv, value$iv)) {
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        if (value$iv != null) {
            return value$iv == SemaphoreKt.CANCELLED ? z : tryResumeAcquire(value$iv);
        }
        ...
        Object expected$iv = SemaphoreKt.PERMIT;
        return !AtomicIntrinsicsKt$$ExternalSyntheticBackportWithForwarding0.m(segment.getAcquirers(), i, expected$iv, SemaphoreKt.BROKEN);
    }
