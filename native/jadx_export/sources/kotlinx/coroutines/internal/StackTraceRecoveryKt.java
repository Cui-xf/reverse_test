...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM6999constructorimpl2;
        ...
        try {
            ...
            objM6999constructorimpl = Result.m6999constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6999constructorimpl = Result.m6999constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m7002exceptionOrNullimpl(objM6999constructorimpl) == null) {
            obj2 = objM6999constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM6999constructorimpl2 = Result.m6999constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM6999constructorimpl2 = Result.m6999constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m7002exceptionOrNullimpl(objM6999constructorimpl2) == null) {
            obj = objM6999constructorimpl2;
        }
