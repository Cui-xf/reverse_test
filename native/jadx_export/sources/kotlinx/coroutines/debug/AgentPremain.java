...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM6999constructorimpl = Result.m6999constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6999constructorimpl = Result.m6999constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m7005isFailureimpl(objM6999constructorimpl) ? null : objM6999constructorimpl);
