...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo8493receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m8491receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m6999constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m6999constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
                ...
                try {
                    switch (updateCellSend(channelSegment, index, e, s, cont, false)) {
                        case 0:
                            ...
                            Result.Companion companion = Result.INSTANCE;
                            cont.resumeWith(Result.m6999constructorimpl(Unit.INSTANCE));
                            break;
                        case 1:
                            Result.Companion companion2 = Result.INSTANCE;
                            cont.resumeWith(Result.m6999constructorimpl(Unit.INSTANCE));
                            ...
                            while (true) {
                                ...
                                switch (updateCellSend(segment$iv$iv, i$iv$iv, e, s$iv$iv, cont2, closed$iv$iv)) {
                                    case 0:
                                        ...
                                        cont2.resumeWith(Result.m6999constructorimpl(Unit.INSTANCE));
                                        break;
                                    case 1:
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuation.resumeWith(Result.m6999constructorimpl(ResultKt.createFailure(exception$iv)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo8489trySendJP2dKIU(E element) {
        ChannelSegment segment$iv;
        if (shouldSendSuspend(sendersAndCloseStatus$FU.get(this))) {
            return ChannelResult.INSTANCE.m8513failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (segment$iv2.id != id$iv) {
                ...
                if (segment$iv == null) {
                    if (closed$iv) {
                        return ChannelResult.INSTANCE.m8512closedJP2dKIU(getSendException());
                    }
                }
            } else {
            ...
            switch (updateCellSend(segment$iv, i$iv, element, s$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    return ChannelResult.INSTANCE.m8514successJP2dKIU(Unit.INSTANCE);
                case 1:
                    return ChannelResult.INSTANCE.m8514successJP2dKIU(Unit.INSTANCE);
                case 2:
                    if (closed$iv) {
        ...
        while (true) {
            ...
            if (segment$iv.id != id$iv) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cont.resumeWith(Result.m6999constructorimpl(Boxing.boxBoolean(false)));
                }
            }
            switch (bufferedChannel.updateCellSend(segment$iv, i$iv, e, s$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m6999constructorimpl(Boxing.boxBoolean(true)));
                    break;
                case 1:
                    Result.Companion companion3 = Result.INSTANCE;
                    cont.resumeWith(Result.m6999constructorimpl(Boxing.boxBoolean(true)));
    ...
    public static /* synthetic */ Object sendImpl$default(BufferedChannel $this, Object element, Object waiter, Function0 onRendezvousOrBuffered, Function2 onSuspend, Function0 onClosed, Function4 onNoWaiterSuspend, int i, Object obj) {
        ...
        while (true) {
            ...
            switch ($this.updateCellSend(segment, i2, element, $this$sendersCounter$iv, waiter, closed)) {
                case 0:
                    segment.cleanPrev();
                ...
                case 3:
                    return onNoWaiterSuspend2.invoke(segment, Integer.valueOf(i2), element, Long.valueOf($this$sendersCounter$iv));
                case 4:
    ...
    protected final <R> R sendImpl(E element, Object waiter, Function0<? extends R> onRendezvousOrBuffered, Function2<? super ChannelSegment<E>, ? super Integer, ? extends R> onSuspend, Function0<? extends R> onClosed, Function4<? super ChannelSegment<E>, ? super Integer, ? super E, ? super Long, ? extends R> onNoWaiterSuspend) {
        ...
        while (true) {
            ...
            long id = $this$sendersCounter$iv / BufferedChannelKt.SEGMENT_SIZE;
            int i = (int) ($this$sendersCounter$iv % BufferedChannelKt.SEGMENT_SIZE);
            if (segment.id != id) {
            ...
            switch (updateCellSend(segment, i, element, $this$sendersCounter$iv, waiter, closed)) {
                case 0:
                    segment.cleanPrev();
                    return onRendezvousOrBuffered.invoke();
                case 1:
                ...
                case 3:
                    return onNoWaiterSuspend.invoke(segment, Integer.valueOf(i), element, Long.valueOf($this$sendersCounter$iv));
                case 4:
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM8499boximpl = ChannelResult.m8499boximpl(ChannelResult.INSTANCE.m8514successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM8499boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, ((ReceiveCatching) $this$tryResumeReceiver).cont.getContext()) : null);
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m6999constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    static /* synthetic */ <E> java.lang.Object m8491receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r14, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r15) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 224
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m8491receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object m8492receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r25, int r26, long r27, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r29) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 450
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m8492receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m6999constructorimpl(ChannelResult.m8499boximpl(ChannelResult.INSTANCE.m8512closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo8494tryReceivePtdJZtk() {
        ...
        if (isClosedForReceive0(sendersAndCloseStatusCur)) {
            return ChannelResult.INSTANCE.m8512closedJP2dKIU(getCloseCause());
        }
        long $this$sendersCounter$iv = sendersAndCloseStatusCur & 1152921504606846975L;
        ...
        while (!isClosedForReceive()) {
            ...
            if (updCellResult$iv != BufferedChannelKt.FAILED) {
                ...
                return ChannelResult.INSTANCE.m8514successJP2dKIU(updCellResult$iv);
            }
    ...
    static /* synthetic */ Object receiveImpl$default(BufferedChannel $this, Object waiter, Function1 onElementRetrieved, Function3 onSuspend, Function0 onClosed, Function3 onNoWaiterSuspend, int i, Object obj) {
        ...
        while (!$this.isClosedForReceive()) {
            ...
            if (segment2.id != id) {
                segment = $this.findSegmentReceive(id, segment2);
                if (segment == null) {
                    continue;
                }
            } else {
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m8499boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m8512closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m8514successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (cause == null) {
                Result.Companion companion = Result.INSTANCE;
                cont.resumeWith(Result.m6999constructorimpl(false));
                return;
            }
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m6999constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
    ...
    private final void markClosed() {
        ...
        do {
            ...
            switch ($this$sendersCloseStatus$iv) {
                case 0:
                    cur2 = BufferedChannelKt.constructSendersAndCloseStatus(1152921504606846975L & cur, 2);
                    break;
                case 1:
                    cur2 = BufferedChannelKt.constructSendersAndCloseStatus(1152921504606846975L & cur, 3);
                    break;
                default:
                    return;
            }
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Object suspendedReceivers = InlineList.m8535constructorimpl$default(null, 1, null);
            ...
            for (int index = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < index; index--) {
                ...
                while (true) {
                    ...
                    if (state == null || state == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m8540plusFjFbRPM(suspendedReceivers, ((WaiterEB) state).waiter);
                            segment.onCancelledRequest(index, true);
                            break;
                        }
                    } else {
                        ...
                        if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m8540plusFjFbRPM(suspendedReceivers, state);
                            segment.onCancelledRequest(index, true);
                            break;
                        }
                    }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter $this$resumeWaiterOnClosedChannel, boolean receiver) {
        if (!($this$resumeWaiterOnClosedChannel instanceof SendBroadcast)) {
            if (!($this$resumeWaiterOnClosedChannel instanceof CancellableContinuation)) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m6999constructorimpl(ChannelResult.m8499boximpl(ChannelResult.INSTANCE.m8512closedJP2dKIU(getCloseCause()))));
                return;
            }
            Continuation continuation = (Continuation) $this$resumeWaiterOnClosedChannel;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m6999constructorimpl(ResultKt.createFailure(receiver ? getReceiveException() : getSendException())));
            return;
        }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        while (true) {
            ...
            if (SegmentOrClosed.m8552isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m8550getSegmentimpl(s$iv);
            while (true) {
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m8550getSegmentimpl(s$iv);
        if (segment.id > id) {
