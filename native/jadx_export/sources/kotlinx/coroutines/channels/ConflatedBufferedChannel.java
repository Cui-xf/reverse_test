...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object $this$onClosed_u2dWpGqRn0$iv = conflatedBufferedChannel.m8517trySendImplMj0NB7M(e, true);
        if ($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed) {
            ChannelResult.m8503exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object $this$onSuccess_u2dWpGqRn0$iv = conflatedBufferedChannel.m8517trySendImplMj0NB7M(e, true);
    ...
    public Object mo8489trySendJP2dKIU(E element) {
        return m8517trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m8517trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m8515trySendDropLatestMj0NB7M(element, isSendOp) : m8516trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m8515trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException it;
        Object result = super.mo8489trySendJP2dKIU(element);
        if (ChannelResult.m8509isSuccessimpl(result) || ChannelResult.m8507isClosedimpl(result)) {
            return result;
        }
    ...
    private final Object m8516trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object it = mo8489trySendJP2dKIU(element);
        if (!(it instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m8503exceptionOrNullimpl(it);
