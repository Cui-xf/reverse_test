...
public final class FloatFloatPair {
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m8constructorimpl(float first, float second) {
        long v1$iv = Float.floatToRawIntBits(first);
        long v2$iv = Float.floatToRawIntBits(second);
        return m9constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }

    /* renamed from: getFirst-impl, reason: not valid java name */
    public static final float m12getFirstimpl(long arg0) {
        int bits$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv);
    }

    /* renamed from: getSecond-impl, reason: not valid java name */
    public static final float m13getSecondimpl(long arg0) {
        int bits$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv);
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m6component1impl(long arg0) {
        int bits$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m7component2impl(long arg0) {
        int bits$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m15toStringimpl(long arg0) {
