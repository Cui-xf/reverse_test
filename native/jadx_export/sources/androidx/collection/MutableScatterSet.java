...
public final class MutableScatterSet<E> extends ScatterSet<E> {
    ...
    */
    ...
    private final class MutableSetWrapper extends ScatterSet<E>.SetWrapper implements Set<E>, KMutableSet {
        ...
        /* JADX WARN: Removed duplicated region for block: B:21:0x0074 A[PHI: r2
          0x0074: PHI (r2v4 'changed' boolean) = (r2v3 'changed' boolean), (r2v5 'changed' boolean) binds: [B:5:0x002d, B:20:0x0072] A[DONT_GENERATE, DONT_INLINE]] */
        @Override // androidx.collection.ScatterSet.SetWrapper, java.util.Set, java.util.Collection
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
