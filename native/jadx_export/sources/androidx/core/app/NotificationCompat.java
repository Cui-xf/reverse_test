...
public class NotificationCompat {
    ...
    public static class CallStyle extends Style {
        ...
        public void addCompatExtras(Bundle extras) {
            ...
            if (this.mVerificationIcon != null) {
                ...
                if (i2 >= 23) {
                    extras.putParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON, Api23Impl.castToParcelable(iconCompat.toIcon(this.mBuilder.mContext)));
                } else {
                    extras.putParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON_COMPAT, iconCompat.toBundle());
                }
            }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m6958clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m6959clone() {
            WearableExtender that = new WearableExtender();
