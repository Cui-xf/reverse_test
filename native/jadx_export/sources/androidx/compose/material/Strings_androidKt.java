...
public final class Strings_androidKt {
    ...
    public static final String m1675getString4foXLRw(int string, Composer $composer, int $changed) {
        String string2;
        ...
        if (Strings.m1664equalsimpl0(string, Strings.INSTANCE.m1672getNavigationMenuUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.navigation_menu);
        } else if (Strings.m1664equalsimpl0(string, Strings.INSTANCE.m1668getCloseDrawerUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.close_drawer);
        } else if (Strings.m1664equalsimpl0(string, Strings.INSTANCE.m1669getCloseSheetUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.close_sheet);
        } else if (Strings.m1664equalsimpl0(string, Strings.INSTANCE.m1670getDefaultErrorMessageUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.default_error_message);
        } else if (Strings.m1664equalsimpl0(string, Strings.INSTANCE.m1671getExposedDropdownMenuUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.dropdown_menu);
        } else if (Strings.m1664equalsimpl0(string, Strings.INSTANCE.m1674getSliderRangeStartUdPEhr4())) {
            string2 = resources.getString(androidx.compose.ui.R.string.range_start);
        } else {
            string2 = Strings.m1664equalsimpl0(string, Strings.INSTANCE.m1673getSliderRangeEndUdPEhr4()) ? resources.getString(androidx.compose.ui.R.string.range_end) : "";
        }
        if (ComposerKt.isTraceInProgress()) {
