...
public final class ElevationOverlayKt {
    ...
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material.ElevationOverlayKt$LocalAbsoluteElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m6691boximpl(m1563invokeD9Ej5fM());
        }

        /* renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1563invokeD9Ej5fM() {
    ...
    public static final long m1562calculateForegroundColorCLU3JFs(long backgroundColor, float elevation, Composer $composer, int $changed) {
        ...
        long baseForegroundColor = ColorsKt.m1512contentColorForek8zF_U(backgroundColor, $composer, $changed & 14);
        long jM4185copywmQWz5c = Color.m4185copywmQWz5c(baseForegroundColor, (14 & 1) != 0 ? Color.m4189getAlphaimpl(baseForegroundColor) : alpha, (14 & 2) != 0 ? Color.m4193getRedimpl(baseForegroundColor) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(baseForegroundColor) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(baseForegroundColor) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
