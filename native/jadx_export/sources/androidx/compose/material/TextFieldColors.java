...
public interface TextFieldColors {
    ...
    public final /* synthetic */ class CC {
        public static State $default$leadingIconColor(TextFieldColors _this, boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        public static State $default$trailingIconColor(TextFieldColors _this, boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
