...
public final class BadgeKt {
    ...
    private static final float BadgeRadius = Dp.m6693constructorimpl(4);
    private static final float BadgeWithContentRadius = Dp.m6693constructorimpl(8);
    private static final long BadgeContentFontSize = TextUnitKt.getSp(10);
    private static final float BadgeWithContentHorizontalPadding = Dp.m6693constructorimpl(4);
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m1441BadgeeopBjH0(androidx.compose.ui.Modifier r29, long r30, long r32, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, androidx.compose.runtime.Composer r35, final int r36, final int r37) {
        /*
            Method dump skipped, instructions count: 718
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BadgeKt.m1441BadgeeopBjH0(androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    static {
        float arg0$iv = Dp.m6693constructorimpl(6);
        BadgeWithContentHorizontalOffset = Dp.m6693constructorimpl(-arg0$iv);
        float arg0$iv2 = Dp.m6693constructorimpl(4);
        BadgeHorizontalOffset = Dp.m6693constructorimpl(-arg0$iv2);
    }
