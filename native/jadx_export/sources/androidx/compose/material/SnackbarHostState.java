...
public final class SnackbarHostState {
    ...
    /* JADX WARN: Removed duplicated region for block: B:27:0x00f0 A[Catch: all -> 0x0107, TRY_LEAVE, TryCatch #2 {all -> 0x0107, blocks: (B:25:0x00c9, B:27:0x00f0), top: B:52:0x00c9 }] */
    ...
    */
    public final java.lang.Object showSnackbar(java.lang.String r20, java.lang.String r21, androidx.compose.material.SnackbarDuration r22, kotlin.coroutines.Continuation<? super androidx.compose.material.SnackbarResult> r23) throws java.lang.Throwable {
        /*
    ...
    private static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                cancellableContinuation.resumeWith(Result.m6999constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                CancellableContinuation<SnackbarResult> cancellableContinuation = this.continuation;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m6999constructorimpl(SnackbarResult.Dismissed));
            }
        }
    }
}
