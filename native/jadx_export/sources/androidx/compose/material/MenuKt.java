...
public final class MenuKt {
    ...
    private static final float MenuElevation = Dp.m6693constructorimpl(8);
    private static final float MenuVerticalMargin = Dp.m6693constructorimpl(48);
    private static final float DropdownMenuItemHorizontalPadding = Dp.m6693constructorimpl(16);
    ...
    private static final float DropdownMenuItemDefaultMinHeight = Dp.m6693constructorimpl(48);
    ...
    public static final void DropdownMenuContent(final MutableTransitionState<Boolean> mutableTransitionState, final MutableState<TransformOrigin> mutableState, final ScrollState scrollState, Modifier modifier, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 9363) == 9362 && $composer3.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            CardKt.m1470CardFjzlyU(GraphicsLayerModifierKt.graphicsLayer(companion, (Function1) value$iv), null, 0L, 0L, null, MenuElevation, ComposableLambdaKt.rememberComposableLambda(895555282, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.MenuKt.DropdownMenuContent.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer $composer4, int $changed6) {
                    ...
                    if (($changed6 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifier$iv = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m683paddingVpY3zN4$default(modifier4, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), scrollState, false, null, false, 14, null);
