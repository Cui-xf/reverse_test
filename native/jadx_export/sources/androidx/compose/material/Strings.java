...
public final class Strings {
    ...
    private static final int NavigationMenu = m1662constructorimpl(0);
    private static final int CloseDrawer = m1662constructorimpl(1);
    private static final int CloseSheet = m1662constructorimpl(2);
    private static final int DefaultErrorMessage = m1662constructorimpl(3);
    private static final int ExposedDropdownMenu = m1662constructorimpl(4);
    private static final int SliderRangeStart = m1662constructorimpl(5);
    private static final int SliderRangeEnd = m1662constructorimpl(6);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Strings m1661boximpl(int i) {
        return new Strings(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1662constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1663equalsimpl(int i, Object obj) {
        return (obj instanceof Strings) && i == ((Strings) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1664equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1665hashCodeimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m1663equalsimpl(this.value, obj);
    }
