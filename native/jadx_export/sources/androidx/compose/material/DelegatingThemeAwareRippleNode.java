...
final class DelegatingThemeAwareRippleNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    public final void attachNewRipple() {
        ColorProducer calculateColor = new ColorProducer() { // from class: androidx.compose.material.DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1
            ...
            */
            public final long mo1537invoke0d7_KjU() {
                /*
                    r11 = this;
                    androidx.compose.material.DelegatingThemeAwareRippleNode r0 = r11.this$0
                    ...
                    long r0 = r0.mo1537invoke0d7_KjU()
                    r2 = r0
                    r4 = 0
                    r5 = 1
                    r6 = 0
                ...
                L17:
                    ...
                    goto L72
                L1b:
                    androidx.compose.material.DelegatingThemeAwareRippleNode r2 = r11.this$0
                ...
                L44:
                    ...
                    androidx.compose.material.DelegatingThemeAwareRippleNode r4 = r11.this$0
                    ...
                    long r4 = r4.m4197unboximpl()
                    androidx.compose.material.DelegatingThemeAwareRippleNode r6 = r11.this$0
                    ...
                    long r3 = r3.m1641rippleColor5vOe2sY(r4, r6)
                L72:
                    return r3
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1.mo1537invoke0d7_KjU():long");
            }
        };
        Function0 calculateRippleAlpha = new Function0<RippleAlpha>() { // from class: androidx.compose.material.DelegatingThemeAwareRippleNode$attachNewRipple$calculateRippleAlpha$1
            ...
            public final RippleAlpha invoke() {
                ...
                return (rippleConfiguration == null || (rippleAlpha = rippleConfiguration.getRippleAlpha()) == null) ? RippleDefaults.INSTANCE.m1640rippleAlphaDxMtmZc(((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ContentColorKt.getLocalContentColor())).m4197unboximpl(), ((Colors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ColorsKt.getLocalColors())).isLight()) : rippleAlpha;
            }
        };
        this.rippleNode = delegate(androidx.compose.material.ripple.RippleKt.m1764createRippleModifierNodeTDGSqEk(this.interactionSource, this.bounded, this.radius, calculateColor, calculateRippleAlpha));
    }
