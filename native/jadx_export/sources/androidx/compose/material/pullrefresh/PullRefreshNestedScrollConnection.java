...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo479onPreScrollOzD1aCk(long available, int source) {
        ...
        if (NestedScrollSource.m5286equalsimpl0(source, NestedScrollSource.INSTANCE.m5298getUserInputWNlRxjI()) && Offset.m3946getYimpl(available) < 0.0f) {
            return OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m3946getYimpl(available))).floatValue());
        }
        return Offset.INSTANCE.m3961getZeroF1C5BW0();
    }
    ...
    */
    public java.lang.Object mo478onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        ...
        L34:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m6935getYimpl(r8)
