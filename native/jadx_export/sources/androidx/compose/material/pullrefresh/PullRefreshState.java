...
public final class PullRefreshState {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C00911 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00911(PullRefreshState pullRefreshState, float f, Continuation<? super C00911> continuation) {
            ...
            public final Continuation<Unit> create(Continuation<?> continuation) {
                return new C00911(this.this$0, this.$offset, continuation);
            }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    this.label = 1;
                    if (MutatorMutex.mutate$default(PullRefreshState.this.mutatorMutex, null, new C00911(PullRefreshState.this, this.$offset, null), this, 1, null) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
