...
public final class RippleKt {
    ...
    private static final RippleNodeFactory DefaultBoundedRipple = new RippleNodeFactory(true, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), (DefaultConstructorMarker) null);
    private static final RippleNodeFactory DefaultUnboundedRipple = new RippleNodeFactory(false, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM(), Color.INSTANCE.m4223getUnspecified0d7_KjU(), (DefaultConstructorMarker) null);
    ...
    public static /* synthetic */ IndicationNodeFactory m1643rippleH2RKhps$default(boolean z, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            j = Color.INSTANCE.m4223getUnspecified0d7_KjU();
        }
        return m1642rippleH2RKhps(z, f, j);
    }

    /* renamed from: ripple-H2RKhps, reason: not valid java name */
    public static final IndicationNodeFactory m1642rippleH2RKhps(boolean bounded, float radius, long color) {
        if (Dp.m6698equalsimpl0(radius, Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM()) && Color.m4188equalsimpl0(color, Color.INSTANCE.m4223getUnspecified0d7_KjU())) {
    ...
    public static /* synthetic */ IndicationNodeFactory m1645ripplewH6b6FI$default(ColorProducer colorProducer, boolean z, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m1644ripplewH6b6FI(colorProducer, z, f);
    }

    /* renamed from: ripple-wH6b6FI, reason: not valid java name */
    public static final IndicationNodeFactory m1644ripplewH6b6FI(ColorProducer color, boolean bounded, float radius) {
        return new RippleNodeFactory(bounded, radius, color, (DefaultConstructorMarker) null);
    }
    ...
    public static final Indication m1646rippleOrFallbackImplementation9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        float radius2;
        long color2;
        Composer $composer2;
        IndicationNodeFactory indicationNodeFactoryM1642rippleH2RKhps;
        ...
        if ((i & 2) != 0) {
            float radius3 = Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM();
            radius2 = radius3;
        } else {
            radius2 = radius;
        }
        if ((i & 4) != 0) {
            long color3 = Color.INSTANCE.m4223getUnspecified0d7_KjU();
            color2 = color3;
        } else {
            color2 = color;
        }
        ...
        if (((Boolean) objConsume).booleanValue()) {
            ...
            $composer2 = $composer;
            indicationNodeFactoryM1642rippleH2RKhps = androidx.compose.material.ripple.RippleKt.m1765rememberRipple9IZ8Weo(bounded2, radius2, color2, $composer2, ($changed & 14) | ($changed & 112) | ($changed & 896), 0);
            $composer2.endReplaceGroup();
        } else {
            $composer2 = $composer;
            $composer2.startReplaceGroup(96503175);
            $composer2.endReplaceGroup();
            indicationNodeFactoryM1642rippleH2RKhps = m1642rippleH2RKhps(bounded2, radius2, color2);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer2);
        return indicationNodeFactoryM1642rippleH2RKhps;
    }
}
