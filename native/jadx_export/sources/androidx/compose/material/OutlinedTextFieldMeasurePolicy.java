...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        int bottomPadding = $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.getBottom());
        ...
        if (measurable2 != null) {
            ...
            trailingPlaceable = measurable2.mo5535measureBRTryo0(ConstraintsKt.m6656offsetNN6EwU$default(relaxedConstraints4, -occupiedSpaceHorizontally3, 0, 2, null));
        } else {
        ...
        int labelHorizontalPaddingOffset = $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.mo632calculateLeftPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection())) + $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.mo633calculateRightPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection()));
        long labelConstraints = ConstraintsKt.m6655offsetNN6EwU(relaxedConstraints2, MathHelpersKt.lerp((-occupiedSpaceHorizontally4) - labelHorizontalPaddingOffset, -labelHorizontalPaddingOffset, outlinedTextFieldMeasurePolicy.animationProgress), -bottomPadding);
        int index$iv$iv3 = 0;
        int size3 = list.size();
        while (true) {
        ...
        Placeable labelPlaceable = measurable3 != null ? measurable3.mo5535measureBRTryo0(labelConstraints) : null;
        if (labelPlaceable != null) {
            Placeable it4 = labelPlaceable;
            jM4023getZeroNHjbRc = SizeKt.Size(it4.getWidth(), it4.getHeight());
        } else {
        ...
        int topPadding = Math.max(TextFieldImplKt.heightOrZero(labelPlaceable) / 2, $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.getTop()));
        long jM6655offsetNN6EwU = ConstraintsKt.m6655offsetNN6EwU(constraints, -occupiedSpaceHorizontally4, (-bottomPadding) - topPadding);
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it5), "TextField")) {
                final Placeable textFieldPlaceable = ((Measurable) item$iv$iv).mo5535measureBRTryo0(textConstraints);
                ...
                Placeable placeholderPlaceable = measurable4 != null ? measurable4.mo5535measureBRTryo0(placeholderConstraints) : null;
                final int width = OutlinedTextFieldKt.m1615calculateWidthO3s9Psw(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable2), TextFieldImplKt.widthOrZero(placeholderPlaceable), outlinedTextFieldMeasurePolicy.animationProgress, constraints, $this$measure_u2d3p2s80s.getDensity(), outlinedTextFieldMeasurePolicy.paddingValues);
                final int height = OutlinedTextFieldKt.m1614calculateHeightO3s9Psw(TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable), textFieldPlaceable.getHeight(), TextFieldImplKt.heightOrZero(labelPlaceable2), TextFieldImplKt.heightOrZero(placeholderPlaceable), outlinedTextFieldMeasurePolicy.animationProgress, constraints, $this$measure_u2d3p2s80s.getDensity(), outlinedTextFieldMeasurePolicy.paddingValues);
                int index$iv$iv8 = 0;
                ...
                while (index$iv$iv8 < height2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it7), OutlinedTextFieldKt.BorderId)) {
                        final Placeable borderPlaceable = ((Measurable) item$iv$iv2).mo5535measureBRTryo0(ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : 0, width, height != Integer.MAX_VALUE ? height : 0, height));
                        final Placeable labelPlaceable3 = labelPlaceable2;
                        final Placeable leadingPlaceable3 = leadingPlaceable;
                        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldMeasurePolicy$measure$1
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope $this$intrinsicWidth, List<? extends IntrinsicMeasurable> list, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                return OutlinedTextFieldKt.m1615calculateWidthO3s9Psw(leadingWidth, trailingWidth, textFieldWidth, labelWidth, placeholderWidth, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicWidth.getDensity(), this.paddingValues);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        while (index$iv$iv4 < size4) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                return OutlinedTextFieldKt.m1614calculateHeightO3s9Psw(leadingHeight, trailingHeight, textFieldHeight, labelHeight, placeholderHeight, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
            }
            index$iv$iv4++;
