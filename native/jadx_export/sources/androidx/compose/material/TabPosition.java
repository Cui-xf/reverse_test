...
public final class TabPosition {
    ...
    public final float m1698getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m6698equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m6698equalsimpl0(this.width, ((TabPosition) other).width);
    }

    public int hashCode() {
        int result = Dp.m6699hashCodeimpl(this.left);
        return (result * 31) + Dp.m6699hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m6704toStringimpl(this.left)) + ", right=" + ((Object) Dp.m6704toStringimpl(m1698getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m6704toStringimpl(this.width)) + ')';
    }
}
