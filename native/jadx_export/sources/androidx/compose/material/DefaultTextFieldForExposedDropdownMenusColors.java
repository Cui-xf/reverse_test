...
final class DefaultTextFieldForExposedDropdownMenusColors implements TextFieldColors {
    ...
    public /* synthetic */ State leadingIconColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        return TextFieldColors.CC.$default$leadingIconColor(this, z, z2, interactionSource, composer, i);
    }
    ...
    public State<Color> leadingIconColor(boolean enabled, boolean isError, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(j), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> indicatorColor(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m108animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, $composer, 48, 12);
            $composer.endReplaceGroup();
        } else {
            $composer.startReplaceGroup(-887836783);
            ComposerKt.sourceInformation($composer, "639@27959L33");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(targetValue), $composer, 0);
            $composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(this.backgroundColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public State<Color> placeholderColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(enabled ? this.placeholderColor : this.disabledPlaceholderColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public State<Color> labelColor(boolean enabled, boolean error, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(targetValue), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public State<Color> textColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(enabled ? this.textColor : this.disabledTextColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public State<Color> cursorColor(boolean isError, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4177boximpl(isError ? this.errorCursorColor : this.cursorColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4188equalsimpl0(this.textColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).textColor) && Color.m4188equalsimpl0(this.disabledTextColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledTextColor) && Color.m4188equalsimpl0(this.cursorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).cursorColor) && Color.m4188equalsimpl0(this.errorCursorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorCursorColor) && Color.m4188equalsimpl0(this.focusedIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedIndicatorColor) && Color.m4188equalsimpl0(this.unfocusedIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).unfocusedIndicatorColor) && Color.m4188equalsimpl0(this.errorIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorIndicatorColor) && Color.m4188equalsimpl0(this.disabledIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledIndicatorColor) && Color.m4188equalsimpl0(this.leadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).leadingIconColor) && Color.m4188equalsimpl0(this.disabledLeadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledLeadingIconColor) && Color.m4188equalsimpl0(this.errorLeadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorLeadingIconColor) && Color.m4188equalsimpl0(this.trailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).trailingIconColor) && Color.m4188equalsimpl0(this.focusedTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedTrailingIconColor) && Color.m4188equalsimpl0(this.disabledTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledTrailingIconColor) && Color.m4188equalsimpl0(this.errorTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorTrailingIconColor) && Color.m4188equalsimpl0(this.backgroundColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).backgroundColor) && Color.m4188equalsimpl0(this.focusedLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedLabelColor) && Color.m4188equalsimpl0(this.unfocusedLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).unfocusedLabelColor) && Color.m4188equalsimpl0(this.disabledLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledLabelColor) && Color.m4188equalsimpl0(this.errorLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorLabelColor) && Color.m4188equalsimpl0(this.placeholderColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).placeholderColor) && Color.m4188equalsimpl0(this.disabledPlaceholderColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledPlaceholderColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m4194hashCodeimpl(this.textColor);
        return (((((((((((((((((((((((((((((((((((((((((result * 31) + Color.m4194hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4194hashCodeimpl(this.cursorColor)) * 31) + Color.m4194hashCodeimpl(this.errorCursorColor)) * 31) + Color.m4194hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m4194hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m4194hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m4194hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m4194hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4194hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4194hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m4194hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4194hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m4194hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4194hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m4194hashCodeimpl(this.backgroundColor)) * 31) + Color.m4194hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m4194hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m4194hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4194hashCodeimpl(this.errorLabelColor)) * 31) + Color.m4194hashCodeimpl(this.placeholderColor)) * 31) + Color.m4194hashCodeimpl(this.disabledPlaceholderColor);
    }
}
