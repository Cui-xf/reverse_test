...
public final class TabKt {
    ...
    private static final float SmallTabHeight = Dp.m6693constructorimpl(48);
    ...
    public static final void m1693Tab0nDMI0(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, final int $changed, final int i) {
        boolean z;
        ...
        if (($changed & 100663296) == 0) {
            $dirty |= ((i & 256) == 0 && $composer3.changed(unselectedContentColor)) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
        }
        int $dirty7 = $dirty;
        if (($dirty7 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 128) != 0) {
                    ...
                    long selectedContentColor5 = ((Color) objConsume).m4197unboximpl();
                ...
                if ((i & 256) != 0) {
                    unselectedContentColor2 = Color.m4185copywmQWz5c(selectedContentColor2, (14 & 1) != 0 ? Color.m4189getAlphaimpl(selectedContentColor2) : ContentAlpha.INSTANCE.getMedium($composer3, 6), (14 & 2) != 0 ? Color.m4193getRedimpl(selectedContentColor2) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(selectedContentColor2) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(selectedContentColor2) : 0.0f);
                ...
                Function2 it = ComposableLambdaKt.rememberComposableLambda(-1729014781, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$styledText$1$1
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                            ...
                            TextStyle style = TextStyle.m6159copyp1EtxEg$default(MaterialTheme.INSTANCE.getTypography($composer4, 6).getButton(), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, TextAlign.INSTANCE.m6550getCentere0LSkKk(), 0, 0L, null, null, null, 0, 0, null, 16744447, null);
            ...
            m1694TabEVJuX4I(z, function02, modifier4, enabled3, interactionSource2, selectedContentColor3, unselectedContentColor2, ComposableLambdaKt.rememberComposableLambda(-178151495, true, new Function3<ColumnScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(3);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$2
                ...
                public final void invoke(Composer composer, int i10) {
                    TabKt.m1693Tab0nDMI0(selected, function0, modifier3, enabled4, text2, icon2, interactionSource3, selectedContentColor4, unselectedContentColor3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1692LeadingIconTab0nDMI0(final boolean selected, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, final int $changed, final int i) {
        Function0<Unit> function02;
        ...
        if ((38347923 & $dirty) == 38347922 && $composer3.getSkipping()) {
            ...
            final Indication ripple = RippleKt.m1646rippleOrFallbackImplementation9IZ8Weo(true, 0.0f, selectedContentColor4, $composer3, 6 | (($dirty2 >> 15) & 896), 2);
            ...
            m1695TabTransitionKlgxPg(selectedContentColor4, unselectedContentColor4, selected, ComposableLambdaKt.rememberComposableLambda(866677691, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$LeadingIconTab$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifier$iv = SizeKt.fillMaxWidth$default(PaddingKt.m683paddingVpY3zN4$default(SelectableKt.m939selectableO2vRcR0(SizeKt.m712height3ABfNKs(modifier3, TabKt.SmallTabHeight), selected, interactionSource3, ripple, enabled3, Role.m5949boximpl(Role.INSTANCE.m5962getTabo7Vup1c()), function03), TabKt.HorizontalTextPadding, 0.0f, 2, null), 0.0f, 1, null);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$LeadingIconTab$2
                ...
                public final void invoke(Composer composer, int i6) {
                    TabKt.m1692LeadingIconTab0nDMI0(selected, function0, function2, function22, modifier4, enabled4, interactionSource4, selectedContentColor3, unselectedContentColor3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1694TabEVJuX4I(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        boolean z;
        Modifier modifier2;
        boolean enabled2;
        MutableInteractionSource interactionSource2;
        ...
        if (($dirty & 4793491) == 4793490 && $composer3.getSkipping()) {
            ...
            long selectedContentColor4 = selectedContentColor2;
            final Indication ripple = RippleKt.m1646rippleOrFallbackImplementation9IZ8Weo(true, 0.0f, selectedContentColor4, $composer3, (($dirty2 >> 9) & 896) | 6, 2);
            final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function33 = function32;
            final boolean z2 = z;
            m1695TabTransitionKlgxPg(selectedContentColor4, unselectedContentColor2, selected, ComposableLambdaKt.rememberComposableLambda(-1237246709, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(SelectableKt.m939selectableO2vRcR0(modifier3, z2, interactionSource3, ripple, enabled3, Role.m5949boximpl(Role.INSTANCE.m5962getTabo7Vup1c()), function0), 0.0f, 1, null);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$4
                ...
                public final void invoke(Composer composer, int i8) {
                    TabKt.m1694TabEVJuX4I(selected, function0, modifier4, enabled4, interactionSource4, selectedContentColor3, unselectedContentColor3, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1695TabTransitionKlgxPg(long activeColor, final long inactiveColor, final boolean selected, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        long j;
        long j2;
        boolean z;
        int $dirty;
        ...
        if (($dirty2 & 1171) == 1170 && $composer3.getSkipping()) {
            ...
            FiniteAnimationSpec<Color> animationSpec$iv$iv = transitionSpec$iv.invoke(transition.getSegment(), $composer3, Integer.valueOf(($changed$iv$iv >> 3) & 112));
            State color$delegate = TransitionKt.createTransitionAnimation(transition, initialValue$iv$iv, targetValue$iv$iv, animationSpec$iv$iv, typeConverter$iv, "ColorAnimation", $composer3, ($changed$iv$iv & 14) | (($changed$iv$iv << 9) & 57344) | (($changed$iv$iv << 6) & 458752));
            $composer2 = $composer3;
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            long jTabTransition_Klgx_Pg$lambda$2 = TabTransition_Klgx_Pg$lambda$2(color$delegate);
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{localContentColor.provides(Color.m4177boximpl(Color.m4185copywmQWz5c(jTabTransition_Klgx_Pg$lambda$2, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jTabTransition_Klgx_Pg$lambda$2) : 1.0f, (14 & 2) != 0 ? Color.m4193getRedimpl(jTabTransition_Klgx_Pg$lambda$2) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jTabTransition_Klgx_Pg$lambda$2) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jTabTransition_Klgx_Pg$lambda$2) : 0.0f))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m4189getAlphaimpl(TabTransition_Klgx_Pg$lambda$2(color$delegate))))}, function2, $composer2, ProvidedValue.$stable | (($dirty >> 6) & 112));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$TabTransition$1
                ...
                public final void invoke(Composer composer, int i) {
                    TabKt.m1695TabTransitionKlgxPg(j6, inactiveColor, selected, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    */
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope $this$placeTextAndIcon, Density density, Placeable textPlaceable, Placeable iconPlaceable, int tabWidth, int tabHeight, int firstBaseline, int lastBaseline) {
        ...
        int textOffset = density.mo361roundToPx0680j_4(baselineOffset) + density.mo361roundToPx0680j_4(TabRowDefaults.INSTANCE.m1703getIndicatorHeightD9Ej5fM());
