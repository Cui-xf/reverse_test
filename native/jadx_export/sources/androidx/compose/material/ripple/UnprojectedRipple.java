...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1773setColorDxMtmZc(long color, float alpha) {
        long newColor = m1772calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m4188equalsimpl0(color2.m4197unboximpl(), newColor))) {
            this.rippleColor = Color.m4177boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m4241toArgb8_81llA(newColor)));
        }
    }
    ...
    public final void trySetRadius(int radius) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    private final long m1772calculateRippleColor5vOe2sY(long color, float alpha) {
        float f;
        ...
        return Color.m4185copywmQWz5c(color, (14 & 1) != 0 ? Color.m4189getAlphaimpl(color) : transformedAlpha, (14 & 2) != 0 ? Color.m4193getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(color) : 0.0f);
    }
