...
final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        float fM1759getRippleEndRadiuscSwnlzA;
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            fM1759getRippleEndRadiuscSwnlzA = RippleAnimationKt.m1759getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo4662getSizeNHjbRc());
        } else {
            fM1759getRippleEndRadiuscSwnlzA = $this$drawIndication.mo367toPx0680j_4(this.radius);
        }
        this.targetRadius = fM1759getRippleEndRadiuscSwnlzA;
        long color = this.color.getValue().m4197unboximpl();
        $this$drawIndication.drawContent();
        m1763drawStateLayerH2RKhps($this$drawIndication, this.radius, color);
        m1757drawRipples4WTKRHQ($this$drawIndication, color);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        Offset origin = this.bounded ? Offset.m3934boximpl(interaction.getPressPosition()) : null;
    ...
    private final void m1757drawRipples4WTKRHQ(DrawScope $this$drawRipples_u2d4WTKRHQ, long color) {
        Map $this$forEach$iv = this.ripples;
        for (Map.Entry element$iv : $this$forEach$iv.entrySet()) {
            RippleAnimation ripple = element$iv.getValue();
            float alpha = this.rippleAlpha.getValue().getPressedAlpha();
            if (!(alpha == 0.0f)) {
                ripple.m1758draw4WTKRHQ($this$drawRipples_u2d4WTKRHQ, Color.m4185copywmQWz5c(color, (14 & 1) != 0 ? Color.m4189getAlphaimpl(color) : alpha, (14 & 2) != 0 ? Color.m4193getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(color) : 0.0f));
            }
        }
    }
