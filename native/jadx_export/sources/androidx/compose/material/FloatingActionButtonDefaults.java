...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m1579elevationixp7dh8(float defaultElevation, float pressedElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            float defaultElevation3 = Dp.m6693constructorimpl(6);
            defaultElevation2 = defaultElevation3;
        } else {
            defaultElevation2 = defaultElevation;
        }
        if ((i & 2) != 0) {
            float pressedElevation3 = Dp.m6693constructorimpl(12);
        ...
        FloatingActionButtonElevation floatingActionButtonElevationM1580elevationxZ9QkE = m1580elevationxZ9QkE(defaultElevation2, pressedElevation2, Dp.m6693constructorimpl(8), Dp.m6693constructorimpl(8), $composer, $this$dp$iv | 3456 | ($changed & 112) | (($changed << 6) & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return floatingActionButtonElevationM1580elevationxZ9QkE;
    }

    /* renamed from: elevation-xZ9-QkE, reason: not valid java name */
    public final FloatingActionButtonElevation m1580elevationxZ9QkE(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        float defaultElevation2;
        float pressedElevation2;
        ...
        if ((i & 4) != 0) {
            float hoveredElevation3 = Dp.m6693constructorimpl(8);
            hoveredElevation2 = hoveredElevation3;
        } else {
            hoveredElevation2 = hoveredElevation;
        }
        if ((i & 8) != 0) {
            float focusedElevation3 = Dp.m6693constructorimpl(8);
