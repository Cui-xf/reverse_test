...
public final class RippleKt {
    ...
    public static /* synthetic */ IndicationNodeFactory m2422rippleH2RKhps$default(boolean z, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        return m2421rippleH2RKhps(z, f, j);
    }

    /* renamed from: ripple-H2RKhps, reason: not valid java name */
    public static final IndicationNodeFactory m2421rippleH2RKhps(boolean bounded, float radius, long color) {
    ...
    public static /* synthetic */ IndicationNodeFactory m2424ripplewH6b6FI$default(ColorProducer colorProducer, boolean z, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m2423ripplewH6b6FI(colorProducer, z, f);
    }

    /* renamed from: ripple-wH6b6FI, reason: not valid java name */
    public static final IndicationNodeFactory m2423ripplewH6b6FI(ColorProducer color, boolean bounded, float radius) {
        return new RippleNodeFactory(bounded, radius, color, (DefaultConstructorMarker) null);
    }
    ...
    public static final Indication m2425rippleOrFallbackImplementation9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        float radius2;
        long color2;
        Composer $composer2;
        ...
        if (((Boolean) objConsume).booleanValue()) {
            $composer2 = $composer;
            indicationNodeFactoryM2421rippleH2RKhps = androidx.compose.material.ripple.RippleKt.m1765rememberRipple9IZ8Weo(bounded2, radius2, color2, $composer2, ($changed & 14) | ($changed & 112) | ($changed & 896), 0);
        } else {
            $composer2 = $composer;
            indicationNodeFactoryM2421rippleH2RKhps = m2421rippleH2RKhps(bounded2, radius2, color2);
        }
