...
final class AppBarKt$TwoRowsTopAppBar$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        if (($changed & 3) != 2 || !$composer.getSkipping()) {
            ...
            Composer $this$Layout_u24lambda_u240$iv$iv = Updater.m3678constructorimpl($composer);
            ...
            AppBarKt.m1793TopAppBarLayoutkXwM9vE(SizeKt.m714heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, windowInsets)), 0.0f, f, 1, null), new ScrolledOffset() { // from class: androidx.compose.material3.AppBarKt$TwoRowsTopAppBar$6$$ExternalSyntheticLambda0
            ...
            Modifier modifierM714heightInVpY3zN4$default = SizeKt.m714heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, WindowInsetsKt.m752onlybOOhFvg(windowInsets, WindowInsetsSides.INSTANCE.m772getHorizontalJoeWqyM()))), 0.0f, Dp.m6693constructorimpl(f3 - f), 1, null);
            ...
            AppBarKt.m1793TopAppBarLayoutkXwM9vE(modifierM714heightInVpY3zN4$default, (ScrolledOffset) value$iv, topAppBarColors.getNavigationIconContentColor(), topAppBarColors.getTitleContentColor(), topAppBarColors.getActionIconContentColor(), function24, textStyle2, f4, Arrangement.INSTANCE.getBottom(), Arrangement.INSTANCE.getStart(), intRef.element, z2, ComposableSingletons$AppBarKt.INSTANCE.m1966getLambda17$material3_release(), ComposableSingletons$AppBarKt.INSTANCE.m1967getLambda18$material3_release(), $composer, 905969664, 3456);
            ComposerKt.sourceInformationMarkerEnd($composer);
            ComposerKt.sourceInformationMarkerEnd($composer);
            $composer.endNode();
            ComposerKt.sourceInformationMarkerEnd($composer);
