            ...
            case 0:
                ...
                if (!Dp.m6698equalsimpl0(this.$animatable.getTargetValue().m6707unboximpl(), this.$target)) {
                    if (this.$enabled) {
                        ...
                        this.label = 2;
                        if (ElevationKt.m2918animateElevationrAjV9yQ(this.$animatable, this.$target, interactionAnimateElevation$lambda$2, this.$interaction, this) == coroutine_suspended) {
                        ...
                        this.label = 1;
                        if (this.$animatable.snapTo(Dp.m6691boximpl(this.$target), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
