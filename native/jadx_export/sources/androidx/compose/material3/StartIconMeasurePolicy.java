...
final class StartIconMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        long iconConstraints = ConstraintsKt.m6655offsetNN6EwU(looseConstraints, i, -measureScope.mo361roundToPx0680j_4(Dp.m6693constructorimpl(2 * arg0$iv2)));
        ...
        while (index$iv$iv < size) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                Placeable iconPlaceable = ((Measurable) item$iv$iv).mo5535measureBRTryo0(iconConstraints);
                ...
                while (index$iv$iv2 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "label")) {
                        Placeable labelPlaceable = ((Measurable) item$iv$iv2).mo5535measureBRTryo0(ConstraintsKt.m6656offsetNN6EwU$default(iconConstraints, -(iconPlaceable2.getWidth() + measureScope.mo361roundToPx0680j_4(this.startIconToLabelHorizontalPadding)), 0, 2, null));
                        ...
                        int totalIndicatorWidth = width + measureScope.mo361roundToPx0680j_4(Dp.m6693constructorimpl(arg0$iv3 + Dp.m6693constructorimpl(2 * arg0$iv4)));
                        int iMax = Math.max(iconPlaceable2.getHeight(), labelPlaceable.getHeight());
                        float arg0$iv5 = this.indicatorVerticalPadding;
                        int indicatorHeight = iMax + measureScope.mo361roundToPx0680j_4(Dp.m6693constructorimpl(2 * arg0$iv5));
                        ...
                        while (index$iv$iv3 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it3), "indicatorRipple")) {
                                Placeable indicatorRipplePlaceable = ((Measurable) item$iv$iv3).mo5535measureBRTryo0(ConstraintsKt.m6651constrainN9IONVI(looseConstraints, Constraints.INSTANCE.m6646fixedJhjzzOo(totalIndicatorWidth, indicatorHeight)));
                                ...
                                while (index$iv$iv5 < size4) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it4), "indicator")) {
                                        Placeable indicatorPlaceable = ((Measurable) item$iv$iv4).mo5535measureBRTryo0(ConstraintsKt.m6651constrainN9IONVI(looseConstraints, Constraints.INSTANCE.m6646fixedJhjzzOo(animatedIndicatorWidth, indicatorHeight)));
                                        return NavigationItemKt.m2336placeLabelAndStartIconnru01g4($this$measure_u2d3p2s80s, labelPlaceable2, iconPlaceable2, indicatorRipplePlaceable, indicatorPlaceable, constraints, this.startIconToLabelHorizontalPadding);
                                    }
                                    index$iv$iv5++;
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it), "icon")) {
                ...
                while (index$iv$iv2 < size2) {
                    ...
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it2), "label")) {
                        ...
                        int paddings = $this$maxIntrinsicWidth.mo361roundToPx0680j_4(Dp.m6693constructorimpl(arg0$iv2 + other$iv));
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it), "icon")) {
                ...
                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                    ...
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(it2), "label")) {
                        ...
                        int paddings = $this$maxIntrinsicHeight.mo361roundToPx0680j_4(Dp.m6693constructorimpl(2 * arg0$iv));
