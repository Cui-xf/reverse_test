...
public final class CarouselKt {
    ...
    public static final void m2902HorizontalMultiBrowseCarouselzCIJ0Nk(final CarouselState state, final float preferredItemWidth, Modifier modifier, float itemSpacing, TargetedFlingBehavior flingBehavior, float minSmallItemWidth, float maxSmallItemWidth, PaddingValues contentPadding, final Function4<? super CarouselItemScope, ? super Integer, ? super Composer, ? super Integer, Unit> function4, Composer $composer, final int $changed, final int i) {
        float f;
        ...
        if (($dirty3 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                float itemSpacing5 = i3 != 0 ? Dp.m6693constructorimpl(0) : f2;
                if ((i & 16) != 0) {
                ...
                if (i5 != 0) {
                    minSmallItemWidth2 = CarouselDefaults.INSTANCE.m2899getMinSmallItemSizeD9Ej5fM$material3_release();
                }
                if (i6 != 0) {
                    maxSmallItemWidth2 = CarouselDefaults.INSTANCE.m2898getMaxSmallItemSizeD9Ej5fM$material3_release();
                }
                if (i7 != 0) {
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv = (Function2) new Function2<Float, Float, KeylineList>() { // from class: androidx.compose.material3.carousel.CarouselKt$HorizontalMultiBrowseCarousel$1$1
                    ...
                    public final KeylineList invoke(float availableSpace, float itemSpacingPx) {
                        ...
                        float availableSpace2 = $this$invoke_u24lambda_u240.mo367toPx0680j_4(f5);
                        return KeylinesKt.multiBrowseKeylineList($this$invoke_u24lambda_u240, availableSpace, availableSpace2, itemSpacingPx, carouselState2.getItemCountState().getValue().invoke().intValue(), $this$invoke_u24lambda_u240.mo367toPx0680j_4(f6), $this$invoke_u24lambda_u240.mo367toPx0680j_4(f7));
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            m2901CarouselV95POc(state, orientation, (Function2) value$iv, contentPadding2, 2, modifier3, itemSpacing2, flingBehavior3, function4, $composer3, ($dirty4 & 14) | 24624 | (($dirty4 >> 12) & 7168) | (($dirty4 << 9) & 458752) | (($dirty4 << 9) & 3670016) | (29360128 & ($dirty4 << 9)) | ($dirty4 & 234881024), 0);
            $composer2 = $composer3;
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.carousel.CarouselKt$HorizontalMultiBrowseCarousel$2
                ...
                public final void invoke(Composer composer, int i9) {
                    CarouselKt.m2902HorizontalMultiBrowseCarouselzCIJ0Nk(state, preferredItemWidth, modifier2, itemSpacing3, flingBehavior4, itemSpacing4, maxSmallItemWidth4, contentPadding3, function4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    */
    public static final void m2903HorizontalUncontainedCarousel9QcgTRs(final androidx.compose.material3.carousel.CarouselState r21, final float r22, androidx.compose.ui.Modifier r23, float r24, androidx.compose.foundation.gestures.TargetedFlingBehavior r25, androidx.compose.foundation.layout.PaddingValues r26, final kotlin.jvm.functions.Function4<? super androidx.compose.material3.carousel.CarouselItemScope, ? super java.lang.Integer, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r27, androidx.compose.runtime.Composer r28, final int r29, final int r30) {
        /*
            Method dump skipped, instructions count: 528
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.carousel.CarouselKt.m2903HorizontalUncontainedCarousel9QcgTRs(androidx.compose.material3.carousel.CarouselState, float, androidx.compose.ui.Modifier, float, androidx.compose.foundation.gestures.TargetedFlingBehavior, androidx.compose.foundation.layout.PaddingValues, kotlin.jvm.functions.Function4, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m2901CarouselV95POc(final androidx.compose.material3.carousel.CarouselState r38, final androidx.compose.foundation.gestures.Orientation r39, final kotlin.jvm.functions.Function2<? super java.lang.Float, ? super java.lang.Float, androidx.compose.material3.carousel.KeylineList> r40, final androidx.compose.foundation.layout.PaddingValues r41, final int r42, androidx.compose.ui.Modifier r43, float r44, androidx.compose.foundation.gestures.TargetedFlingBehavior r45, final kotlin.jvm.functions.Function4<? super androidx.compose.material3.carousel.CarouselItemScope, ? super java.lang.Integer, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r46, androidx.compose.runtime.Composer r47, final int r48, final int r49) {
        /*
            Method dump skipped, instructions count: 850
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.carousel.CarouselKt.m2901CarouselV95POc(androidx.compose.material3.carousel.CarouselState, androidx.compose.foundation.gestures.Orientation, kotlin.jvm.functions.Function2, androidx.compose.foundation.layout.PaddingValues, int, androidx.compose.ui.Modifier, float, androidx.compose.foundation.gestures.TargetedFlingBehavior, kotlin.jvm.functions.Function4, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    private static final float calculateBeforeContentPadding(PaddingValues $this$calculateBeforeContentPadding, Orientation orientation, Composer $composer, int $changed) {
        ...
        float fMo367toPx0680j_4 = $this$calculateBeforeContentPadding_u24lambda_u243.mo367toPx0680j_4(dpValue);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return fMo367toPx0680j_4;
    }
    ...
    private static final float calculateAfterContentPadding(PaddingValues $this$calculateAfterContentPadding, Orientation orientation, Composer $composer, int $changed) {
        ...
        float fMo367toPx0680j_4 = $this$calculateAfterContentPadding_u24lambda_u244.mo367toPx0680j_4(dpValue);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final Modifier carouselItem(Modifier $this$carouselItem, final int index, final CarouselState state, final Function0<Strategy> function0, final CarouselItemInfoImpl carouselItemInfo, final Shape clipShape) {
        return LayoutModifierKt.layout($this$carouselItem, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.carousel.CarouselKt.carouselItem.1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                return m2904invoke3p2s80s(measureScope, measurable, constraints.getValue());
            }

            /* renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m2904invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
                long jM6626copyZbe2FdA;
                final Strategy strategyResult = function0.invoke();
                if (!strategyResult.getIsValid()) {
                    return MeasureScope.CC.layout$default($this$layout, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.carousel.CarouselKt.carouselItem.1.1
                ...
                if (isVertical) {
                    jM6626copyZbe2FdA = Constraints.m6626copyZbe2FdA(constraints, Constraints.m6638getMinWidthimpl(constraints), Constraints.m6636getMaxWidthimpl(constraints), MathKt.roundToInt(mainAxisSize), MathKt.roundToInt(mainAxisSize));
                } else {
                    jM6626copyZbe2FdA = Constraints.m6626copyZbe2FdA(constraints, MathKt.roundToInt(mainAxisSize), MathKt.roundToInt(mainAxisSize), Constraints.m6637getMinHeightimpl(constraints), Constraints.m6635getMaxHeightimpl(constraints));
                }
                long itemConstraints = jM6626copyZbe2FdA;
                final Placeable placeable = measurable.mo5535measureBRTryo0(itemConstraints);
                ...
                return MeasureScope.CC.layout$default($this$layout, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.carousel.CarouselKt.carouselItem.1.2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(Placeable.PlacementScope $this$layout2) {
                        ...
                        Placeable.PlacementScope.placeWithLayer$default($this$layout2, placeable2, 0, 0, 0.0f, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.carousel.CarouselKt.carouselItem.1.2.1
                            ...
                            public final void invoke2(GraphicsLayerScope $this$placeWithLayer) {
                                ...
                                float centerX = (z ? Size.m4011getHeightimpl($this$placeWithLayer.getSize()) : strategy.getItemMainAxisSize()) / 2.0f;
                                float centerY = (z ? strategy.getItemMainAxisSize() : Size.m4011getHeightimpl($this$placeWithLayer.getSize())) / 2.0f;
                                float halfMaskWidth = (z ? Size.m4014getWidthimpl($this$placeWithLayer.getSize()) : interpolatedKeyline.getSize()) / 2.0f;
                                float halfMaskHeight = (z ? interpolatedKeyline.getSize() : Size.m4011getHeightimpl($this$placeWithLayer.getSize())) / 2.0f;
                                ...
                                $this$placeWithLayer.setClip(!Intrinsics.areEqual(maskRect, new Rect(0.0f, 0.0f, Size.m4014getWidthimpl($this$placeWithLayer.getSize()), Size.m4011getHeightimpl($this$placeWithLayer.getSize()))));
