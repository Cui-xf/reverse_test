...
public final /* data */ class Keyline {
    ...
    public int hashCode() {
        return (((((((((((Float.floatToIntBits(this.size) * 31) + Float.floatToIntBits(this.offset)) * 31) + Float.floatToIntBits(this.unadjustedOffset)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isFocal)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isAnchor)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isPivot)) * 31) + Float.floatToIntBits(this.cutoff);
    }
