...
public final class ComposableSingletons$BottomSheetScaffoldKt {
    ...
    public static Function2<Composer, Integer, Unit> f41lambda1 = ComposableLambdaKt.composableLambdaInstance(-927355320, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$BottomSheetScaffoldKt$lambda-1$1
        ...
        public final void invoke(Composer $composer, int $changed) {
            ...
            BottomSheetDefaults.INSTANCE.m1809DragHandlelgZ2HuY(null, 0.0f, 0.0f, null, 0L, $composer, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function3<SnackbarHostState, Composer, Integer, Unit> m1977getLambda2$material3_release() {
        return f42lambda2;
    }

    /* renamed from: getLambda-3$material3_release, reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1978getLambda3$material3_release() {
        return f43lambda3;
    }
}
