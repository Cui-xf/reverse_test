...
public final class ComposableSingletons$TimePickerKt {
    ...
    public static Function3<RowScope, Composer, Integer, Unit> f73lambda1 = ComposableLambdaKt.composableLambdaInstance(1425358052, false, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$TimePickerKt$lambda-1$1
        ...
        public final void invoke(RowScope $this$ToggleItem, Composer $composer, int $changed) {
            ...
            if (($changed & 17) != 16 || !$composer.getSkipping()) {
                ...
                TextKt.m2711Text4IGK_g(Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_time_picker_am), $composer, 0), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer, 0, 0, 131070);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static Function3<RowScope, Composer, Integer, Unit> f74lambda2 = ComposableLambdaKt.composableLambdaInstance(-1179219109, false, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$TimePickerKt$lambda-2$1
        ...
        public final void invoke(RowScope $this$ToggleItem, Composer $composer, int $changed) {
            ...
            if (($changed & 17) != 16 || !$composer.getSkipping()) {
                ...
                Strings.Companion companion = Strings.INSTANCE;
                TextKt.m2711Text4IGK_g(Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_time_picker_pm), $composer, 0), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer, 0, 0, 131070);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                    return;
                }
    ...
    public final Function3<RowScope, Composer, Integer, Unit> m2008getLambda1$material3_release() {
        return f73lambda1;
    }

    /* renamed from: getLambda-2$material3_release, reason: not valid java name */
    public final Function3<RowScope, Composer, Integer, Unit> m2009getLambda2$material3_release() {
        return f74lambda2;
    }
}
