...
public final class SegmentedButtonDefaults {
    ...
    private static final float BorderWidth = OutlinedSegmentedButtonTokens.INSTANCE.m3376getOutlineWidthD9Ej5fM();
    private static final float IconSize = OutlinedSegmentedButtonTokens.INSTANCE.m3375getIconSizeD9Ej5fM();
    ...
    public final SegmentedButtonColors m2470colorsXqyqHi0(long activeContainerColor, long activeContentColor, long activeBorderColor, long inactiveContainerColor, long inactiveContentColor, long inactiveBorderColor, long disabledActiveContainerColor, long disabledActiveContentColor, long disabledActiveBorderColor, long disabledInactiveContainerColor, long disabledInactiveContentColor, long disabledInactiveBorderColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long activeContainerColor2 = (i & 1) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : activeContainerColor;
        long activeContentColor2 = (i & 2) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : activeContentColor;
        long activeBorderColor2 = (i & 4) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : activeBorderColor;
        long inactiveContainerColor2 = (i & 8) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : inactiveContainerColor;
        long inactiveContentColor2 = (i & 16) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : inactiveContentColor;
        long inactiveBorderColor2 = (i & 32) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : inactiveBorderColor;
        long disabledActiveContainerColor2 = (i & 64) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledActiveContainerColor;
        long disabledActiveContentColor2 = (i & 128) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledActiveContentColor;
        long disabledActiveBorderColor2 = (i & 256) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledActiveBorderColor;
        long disabledInactiveContainerColor2 = (i & 512) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledInactiveContainerColor;
        long disabledInactiveContentColor2 = (i & 1024) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledInactiveContentColor;
        long disabledInactiveBorderColor2 = (i & 2048) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledInactiveBorderColor;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SegmentedButtonColors getDefaultSegmentedButtonColors$material3_release(ColorScheme $this$defaultSegmentedButtonColors) {
        ...
        if (it == null) {
            ...
            long jM4185copywmQWz5c = Color.m4185copywmQWz5c(jFromToken7, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken7) : OutlinedSegmentedButtonTokens.INSTANCE.getDisabledLabelTextOpacity(), (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken7) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken7) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken7) : 0.0f);
            ...
            SegmentedButtonColors it2 = new SegmentedButtonColors(jFromToken, jFromToken2, jFromToken3, surface, jFromToken4, jFromToken5, jFromToken6, jM4185copywmQWz5c, Color.m4185copywmQWz5c(jFromToken8, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken8) : OutlinedSegmentedButtonTokens.INSTANCE.getDisabledOutlineOpacity(), (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken8) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken8) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken8) : 0.0f), $this$defaultSegmentedButtonColors.getSurface(), ColorSchemeKt.fromToken($this$defaultSegmentedButtonColors, OutlinedSegmentedButtonTokens.INSTANCE.getDisabledLabelTextColor()), ColorSchemeKt.fromToken($this$defaultSegmentedButtonColors, OutlinedSegmentedButtonTokens.INSTANCE.getOutlineColor()), null);
    ...
    public final void ActiveIcon(Composer $composer, final int $changed) {
        ...
        if (($dirty & 3) != 2 || !$composer2.getSkipping()) {
            ...
            IconKt.m2168Iconww6aTOc(CheckKt.getCheck(Icons.Filled.INSTANCE), (String) null, SizeKt.m726size3ABfNKs(Modifier.INSTANCE, IconSize), 0L, $composer2, 48, 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public final void Icon(final boolean active, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 147) == 146 && $composer2.getSkipping()) {
            ...
            final Function2 activeContent2 = i2 != 0 ? ComposableSingletons$SegmentedButtonKt.INSTANCE.m1998getLambda1$material3_release() : function23;
            ...
            if (inactiveContent == null) {
                ...
                AnimatedVisibilityKt.AnimatedVisibility(z, (Modifier) null, EnterExitTransitionKt.fadeIn$default(AnimationSpecKt.tween$default(350, 0, null, 6, null), 0.0f, 2, null).plus(EnterExitTransitionKt.m68scaleInL8ZKhE(AnimationSpecKt.tween$default(350, 0, null, 6, null), 0.0f, TransformOriginKt.TransformOrigin(0.0f, 1.0f))), ExitTransition.INSTANCE.getNone(), (String) null, ComposableLambdaKt.rememberComposableLambda(-750750819, true, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonDefaults.Icon.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ...
    public static /* synthetic */ BorderStroke m2468borderStrokel07J4OM$default(SegmentedButtonDefaults segmentedButtonDefaults, long j, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            f = BorderWidth;
        }
        return segmentedButtonDefaults.m2469borderStrokel07J4OM(j, f);
    }

    /* renamed from: borderStroke-l07J4OM, reason: not valid java name */
    public final BorderStroke m2469borderStrokel07J4OM(long color, float width) {
        return BorderStrokeKt.m257BorderStrokecXLIe8U(width, color);
    }
}
