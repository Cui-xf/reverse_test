...
public final class ChipColors {
    ...
    public static /* synthetic */ ChipColors m1872copyFD3wquc$default(ChipColors chipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, int i, Object obj) {
        long j9;
        long j10;
        ...
        return chipColors.m1874copyFD3wquc(j9, j12, j13, j14, j15, j16, j17, j10);
    }

    /* renamed from: copy-FD3wquc, reason: not valid java name */
    public final ChipColors m1874copyFD3wquc(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor) {
    ...
    public final long m1873containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1883labelColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1884leadingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1885trailingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipColors) && Color.m4188equalsimpl0(this.containerColor, ((ChipColors) other).containerColor) && Color.m4188equalsimpl0(this.labelColor, ((ChipColors) other).labelColor) && Color.m4188equalsimpl0(this.leadingIconContentColor, ((ChipColors) other).leadingIconContentColor) && Color.m4188equalsimpl0(this.trailingIconContentColor, ((ChipColors) other).trailingIconContentColor) && Color.m4188equalsimpl0(this.disabledContainerColor, ((ChipColors) other).disabledContainerColor) && Color.m4188equalsimpl0(this.disabledLabelColor, ((ChipColors) other).disabledLabelColor) && Color.m4188equalsimpl0(this.disabledLeadingIconContentColor, ((ChipColors) other).disabledLeadingIconContentColor) && Color.m4188equalsimpl0(this.disabledTrailingIconContentColor, ((ChipColors) other).disabledTrailingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((result * 31) + Color.m4194hashCodeimpl(this.labelColor)) * 31) + Color.m4194hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m4194hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m4194hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4194hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4194hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m4194hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
