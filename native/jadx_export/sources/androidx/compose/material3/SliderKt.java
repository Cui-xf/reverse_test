...
public final class SliderKt {
    ...
    private static final float TrackHeight = SliderTokens.INSTANCE.m3514getInactiveTrackHeightD9Ej5fM();
    private static final float ThumbWidth = SliderTokens.INSTANCE.m3512getHandleWidthD9Ej5fM();
    private static final float ThumbHeight = SliderTokens.INSTANCE.m3511getHandleHeightD9Ej5fM();
    private static final long ThumbSize = DpKt.m6715DpSizeYgX7TsA(ThumbWidth, ThumbHeight);
    private static final float ThumbTrackGapSize = SliderTokens.INSTANCE.m3504getActiveHandleLeadingSpaceD9Ej5fM();
    private static final float TrackInsideCornerSize = Dp.m6693constructorimpl(2);

    /* renamed from: isSpecified-If1S1O4$annotations, reason: not valid java name */
    public static /* synthetic */ void m2524isSpecifiedIf1S1O4$annotations(long j) {
    }
    ...
    public static final void Slider(final float value, final Function1<? super Float, Unit> function1, Modifier modifier, boolean enabled, ClosedFloatingPointRange<Float> closedFloatingPointRange, int steps, Function0<Unit> function0, SliderColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 24576) == 0) {
            if ((i & 16) == 0) {
                ...
                int i6 = $composer3.changed(valueRange) ? 16384 : 8192;
                $dirty2 |= i6;
            } else {
                valueRange = closedFloatingPointRange;
            }
        ...
        if (($dirty2 & 38347923) == 38347922 && $composer3.getSkipping()) {
            ...
            Slider(f, function12, modifier3, enabled3, onValueChangeFinished2, colors5, interactionSource4, steps3, ComposableLambdaKt.rememberComposableLambda(308249025, true, new Function3<SliderState, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.Slider.2
                ...
                public final void invoke(SliderState it, Composer $composer4, int $changed2) {
                    ...
                    SliderDefaults.INSTANCE.m2510Thumb9LiSoMs(interactionSource2, null, colors2, enabled3, 0L, $composer4, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 18);
                    if (ComposerKt.isTraceInProgress()) {
                ...
                public final void invoke(SliderState sliderState, Composer $composer4, int $changed2) {
                    ...
                    SliderDefaults.INSTANCE.m2512Track4EFweAY(sliderState, (Modifier) null, enabled3, colors2, (Function2<? super DrawScope, ? super Offset, Unit>) null, (Function3<? super DrawScope, ? super Offset, ? super Color, Unit>) null, 0.0f, 0.0f, $composer4, ($changed2 & 14) | 100663296, 242);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
                ...
                if (i6 != 0) {
                    ...
                    thumb = ComposableLambdaKt.rememberComposableLambda(1426271326, true, new Function3<SliderState, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.Slider.10
                        ...
                        public final void invoke(SliderState it, Composer $composer3, int $changed2) {
                            ...
                            SliderDefaults.INSTANCE.m2510Thumb9LiSoMs(interactionSource2, null, colors2, enabled4, 0L, $composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 18);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
                ...
                if (i7 != 0) {
                    track = ComposableLambdaKt.rememberComposableLambda(577038345, z2, new Function3<SliderState, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.Slider.11
                        ...
                        public final void invoke(SliderState sliderState2, Composer $composer3, int $changed2) {
                            ...
                            SliderDefaults.INSTANCE.m2512Track4EFweAY(sliderState2, (Modifier) null, enabled4, colors2, (Function2<? super DrawScope, ? super Offset, Unit>) null, (Function3<? super DrawScope, ? super Offset, ? super Color, Unit>) null, 0.0f, 0.0f, $composer3, ($changed2 & 14) | 100663296, 242);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.Slider.13
                ...
                public final void invoke(Composer composer, int i8) {
                    SliderKt.Slider(state, modifier5, enabled3, colors3, interactionSource4, thumb3, track2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void RangeSlider(final ClosedFloatingPointRange<Float> closedFloatingPointRange, final Function1<? super ClosedFloatingPointRange<Float>, Unit> function1, Modifier modifier, boolean enabled, ClosedFloatingPointRange<Float> closedFloatingPointRange2, int steps, Function0<Unit> function0, SliderColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 24576) == 0) {
            if ((i & 16) == 0) {
                ...
                int i4 = $composer3.changed(valueRange) ? 16384 : 8192;
                $dirty4 |= i4;
            } else {
                valueRange = closedFloatingPointRange2;
            }
        ...
        if (($dirty4 & 4793491) == 4793490 && $composer3.getSkipping()) {
            ...
            RangeSlider(closedFloatingPointRange3, function12, modifier3, enabled3, valueRange2, onValueChangeFinished2, null, startInteractionSource, endInteractionSource, ComposableLambdaKt.rememberComposableLambda(-811582901, true, new Function3<RangeSliderState, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.RangeSlider.1
                ...
                public final void invoke(RangeSliderState it, Composer $composer4, int $changed2) {
                    ...
                    SliderDefaults.INSTANCE.m2510Thumb9LiSoMs(startInteractionSource, null, colors2, enabled3, 0L, $composer4, 196614, 18);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
                ...
                public final void invoke(RangeSliderState it, Composer $composer4, int $changed2) {
                    ...
                    SliderDefaults.INSTANCE.m2510Thumb9LiSoMs(endInteractionSource, null, colors2, enabled3, 0L, $composer4, 196614, 18);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
                ...
                public final void invoke(RangeSliderState rangeSliderState, Composer $composer4, int $changed2) {
                    ...
                    SliderDefaults.INSTANCE.m2511Track4EFweAY(rangeSliderState, (Modifier) null, enabled3, colors2, (Function2<? super DrawScope, ? super Offset, Unit>) null, (Function3<? super DrawScope, ? super Offset, ? super Color, Unit>) null, 0.0f, 0.0f, $composer4, ($changed2 & 14) | 100663296, 242);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if (i10 != 0) {
                    ...
                    startThumb = ComposableLambdaKt.rememberComposableLambda(1884205643, true, new Function3<RangeSliderState, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.RangeSlider.14
                        ...
                        public final void invoke(RangeSliderState it, Composer $composer4, int $changed2) {
                            ...
                            SliderDefaults.INSTANCE.m2510Thumb9LiSoMs(startInteractionSource2, null, colors2, enabled2, 0L, $composer4, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 18);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
                ...
                Function3 endThumb3 = i2 != 0 ? ComposableLambdaKt.rememberComposableLambda(1016457138, z, new Function3<RangeSliderState, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.RangeSlider.15
                    ...
                    public final void invoke(RangeSliderState it, Composer $composer4, int $changed2) {
                        ...
                        SliderDefaults.INSTANCE.m2510Thumb9LiSoMs(endInteractionSource2, null, colors2, enabled2, 0L, $composer4, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 18);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
                ...
                if (i3 != 0) {
                    track = ComposableLambdaKt.rememberComposableLambda(-1617375262, z, new Function3<RangeSliderState, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.RangeSlider.16
                        ...
                        public final void invoke(RangeSliderState rangeSliderState2, Composer $composer4, int $changed2) {
                            ...
                            SliderDefaults.INSTANCE.m2511Track4EFweAY(rangeSliderState2, (Modifier) null, enabled2, colors2, (Function2<? super DrawScope, ? super Offset, Unit>) null, (Function3<? super DrawScope, ? super Offset, ? super Color, Unit>) null, 0.0f, 0.0f, $composer4, ($changed2 & 14) | 100663296, 242);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt.RangeSlider.18
                ...
                public final void invoke(Composer composer, int i13) {
                    SliderKt.RangeSlider(state, modifier4, enabled4, colors3, startInteractionSource4, endInteractionSource4, startThumb3, endThumb2, track2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object m2522awaitSlop8vUncbI(androidx.compose.ui.input.pointer.AwaitPointerEventScope r7, long r8, int r10, kotlin.coroutines.Continuation<? super kotlin.Pair<androidx.compose.ui.input.pointer.PointerInputChange, java.lang.Float>> r11) {
        /*
        ...
        L36:
            ...
            r8 = 1
            r6.label = r8
            java.lang.Object r8 = androidx.compose.material3.internal.DragGestureDetectorCopyKt.m2910awaitHorizontalPointerSlopOrCancellationgDDlDlE(r1, r2, r4, r5, r6)
            if (r8 != r0) goto L55
            return r0
        L55:
    ...
    public static final long m2525scaleziovWd0(float a1, float b1, long x, float a2, float b2) {
        return SliderRange(scale(a1, b1, SliderRange.m2537getStartimpl(x), a2, b2), scale(a1, b1, SliderRange.m2536getEndInclusiveimpl(x), a2, b2));
    }
                ...
                SemanticsPropertiesKt.setProgress$default($this$semantics, null, new Function1<Float, Boolean>() { // from class: androidx.compose.material3.SliderKt.rangeSliderStartThumbSemantics.1.1
                    ...
                    public final Boolean invoke(float targetValue) {
                        ...
                        if (resolvedValue == rangeSliderState.getActiveRangeStart()) {
                            ...
                            if (!SliderRange.m2535equalsimpl0(resolvedRange, activeRange)) {
                                ...
                                if (onValueChange$material3_release != null) {
                                    ...
                                    if (it != null) {
                                        it.invoke(SliderRange.m2532boximpl(resolvedRange));
                                    }
                                } else {
                                    rangeSliderState2.setActiveRangeStart(SliderRange.m2537getStartimpl(resolvedRange));
                                    rangeSliderState.setActiveRangeEnd(SliderRange.m2536getEndInclusiveimpl(resolvedRange));
                                }
                            }
    ...
    static final class C05331 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ SliderState $state;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05331(SliderState sliderState, Continuation<? super C05331> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05331 c05331 = new C05331(this.$state, continuation);
            c05331.L$0 = obj;
            return c05331;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C05331) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    C01211 c01211 = new C01211(this.$state, null);
                    final SliderState sliderState = this.$state;
                    this.label = 1;
                    if (TapGestureDetectorKt.detectTapGestures$default($this$pointerInput, null, null, c01211, new Function1<Offset, Unit>() { // from class: androidx.compose.material3.SliderKt.sliderTapModifier.1.2
                        {
                            super(1);
                        }
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                            m2531invokek4lQ0M(offset.getPackedValue());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                        public final void m2531invokek4lQ0M(long it) {
        ...
        static final class C01211 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
            final /* synthetic */ SliderState $state;
            /* synthetic */ long J$0;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01211(SliderState sliderState, Continuation<? super C01211> continuation) {
            ...
            public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
                return m2530invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
            }

            /* renamed from: invoke-d-4ec7I, reason: not valid java name */
            public final Object m2530invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
                C01211 c01211 = new C01211(this.$state, continuation);
                c01211.J$0 = j;
                return c01211.invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        long it = this.J$0;
                        this.$state.m2543onPressk4lQ0M$material3_release(it);
                        return Unit.INSTANCE;
                    default:
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
    ...
    private static final Modifier sliderTapModifier(Modifier $this$sliderTapModifier, SliderState state, MutableInteractionSource interactionSource, boolean enabled) {
        if (enabled) {
            return SuspendingPointerInputFilterKt.pointerInput($this$sliderTapModifier, state, interactionSource, new C05331(state, null));
        }
    ...
    static final class C05301 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05301(RangeSliderState rangeSliderState, MutableInteractionSource mutableInteractionSource, MutableInteractionSource mutableInteractionSource2, Continuation<? super C05301> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05301 c05301 = new C05301(this.$state, this.$startInteractionSource, this.$endInteractionSource, continuation);
            c05301.L$0 = obj;
            return c05301;
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (CoroutineScopeKt.coroutineScope(new C01171($this$pointerInput, this.$state, rangeSliderLogic, null), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
        ...
        static final class C01171 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01171(PointerInputScope pointerInputScope, RangeSliderState rangeSliderState, RangeSliderLogic rangeSliderLogic, Continuation<? super C01171> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C01171 c01171 = new C01171(this.$$this$pointerInput, this.$state, this.$rangeSliderLogic, continuation);
                c01171.L$0 = obj;
                return c01171;
            }
            ...
            static final class C01181 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C01181(RangeSliderState rangeSliderState, RangeSliderLogic rangeSliderLogic, CoroutineScope coroutineScope, Continuation<? super C01181> continuation) {
                    super(2, continuation);
                    this.$state = rangeSliderState;
                    this.$rangeSliderLogic = rangeSliderLogic;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    C01181 c01181 = new C01181(this.$state, this.$rangeSliderLogic, this.$$this$coroutineScope, continuation);
                    c01181.L$0 = obj;
                    return c01181;
                }
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r17) {
                    /*
                        ...
                        To view this dump change 'Code comments level' option to 'DEBUG'
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderKt.C05301.C01171.C01181.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        this.label = 1;
                        if (ForEachGestureKt.awaitEachGesture(this.$$this$pointerInput, new C01181(this.$state, this.$rangeSliderLogic, $this$coroutineScope, null), this) != coroutine_suspended) {
                            break;
                        } else {
                            return coroutine_suspended;
                        }
    ...
    private static final Modifier rangeSliderPressDragModifier(Modifier $this$rangeSliderPressDragModifier, RangeSliderState state, MutableInteractionSource startInteractionSource, MutableInteractionSource endInteractionSource, boolean enabled) {
        return enabled ? SuspendingPointerInputFilterKt.pointerInput($this$rangeSliderPressDragModifier, new Object[]{startInteractionSource, endInteractionSource, state}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new C05301(state, startInteractionSource, endInteractionSource, null)) : $this$rangeSliderPressDragModifier;
    }
    ...
    public static final long SliderRange(float start, float endInclusive) {
        ...
        return SliderRange.m2533constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final boolean m2523isSpecifiedIf1S1O4(long $this$isSpecified) {
        return $this$isSpecified != SliderRange.INSTANCE.m2542getUnspecifiedFYbKRX4();
    }
}
