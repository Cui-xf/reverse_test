...
public final class TimePickerLayoutType {
    ...
    public static final /* synthetic */ TimePickerLayoutType m2753boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2754constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2755equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2756equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2757hashCodeimpl(int i) {
        return i;
    }
    ...
    public static String m2758toStringimpl(int arg0) {
        return m2756equalsimpl0(arg0, Horizontal) ? "Horizontal" : m2756equalsimpl0(arg0, Vertical) ? "Vertical" : "Unknown";
    }
}
