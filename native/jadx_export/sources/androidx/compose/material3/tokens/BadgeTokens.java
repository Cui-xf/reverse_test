...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m6693constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m6693constructorimpl((float) 6.0d);
    ...
    public final float m3031getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m3032getSizeD9Ej5fM() {
        return Size;
    }
}
