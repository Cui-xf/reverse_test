...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m6693constructorimpl((float) 64.0d);
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m3192getLevel2D9Ej5fM();
    private static final float ContainerHeight = Dp.m6693constructorimpl((float) 80.0d);
    ...
    public final float m3335getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3336getActiveIndicatorWidthD9Ej5fM() {
