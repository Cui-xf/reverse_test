...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m6693constructorimpl((float) 512.0d);
    ...
    private static final float ContainerWidth = Dp.m6693constructorimpl((float) 328.0d);
    private static final float HeaderContainerHeight = Dp.m6693constructorimpl((float) 120.0d);
    private static final float HeaderContainerWidth = Dp.m6693constructorimpl((float) 328.0d);
