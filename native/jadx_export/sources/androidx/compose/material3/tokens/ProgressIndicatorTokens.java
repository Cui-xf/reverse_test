...
public final class ProgressIndicatorTokens {
    ...
    private static final float ActiveThickness = Dp.m6693constructorimpl((float) 4.0d);
    private static final float ActiveTrackSpace = Dp.m6693constructorimpl((float) 4.0d);
    private static final ColorSchemeKeyTokens StopColor = ColorSchemeKeyTokens.Primary;
    private static final float StopShape = Dp.m6693constructorimpl((float) 4.0d);
    private static final float StopSize = Dp.m6693constructorimpl((float) 4.0d);
    ...
    private static final float TrackThickness = Dp.m6693constructorimpl((float) 4.0d);
    private static final float Size = Dp.m6693constructorimpl((float) 48.0d);
    ...
    public final float m3480getActiveThicknessD9Ej5fM() {
        return ActiveThickness;
    }

    /* renamed from: getActiveTrackSpace-D9Ej5fM, reason: not valid java name */
    public final float m3481getActiveTrackSpaceD9Ej5fM() {
    ...
    public final float m3483getStopShapeD9Ej5fM() {
        return StopShape;
    }

    /* renamed from: getStopSize-D9Ej5fM, reason: not valid java name */
    public final float m3484getStopSizeD9Ej5fM() {
        return StopSize;
    }
    ...
    public final float m3485getTrackThicknessD9Ej5fM() {
        return TrackThickness;
    }

    /* renamed from: getSize-D9Ej5fM, reason: not valid java name */
    public final float m3482getSizeD9Ej5fM() {
        return Size;
    }
}
