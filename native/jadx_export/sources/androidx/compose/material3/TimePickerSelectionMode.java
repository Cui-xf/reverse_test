...
public final class TimePickerSelectionMode {
    ...
    public static final /* synthetic */ TimePickerSelectionMode m2762boximpl(int i) {
        return new TimePickerSelectionMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2763constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2764equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerSelectionMode) && i == ((TimePickerSelectionMode) obj).m2768unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2765equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2766hashCodeimpl(int i) {
        return i;
    }
    ...
    public static String m2767toStringimpl(int arg0) {
        return m2765equalsimpl0(arg0, Hour) ? "Hour" : m2765equalsimpl0(arg0, Minute) ? "Minute" : "";
    }
}
