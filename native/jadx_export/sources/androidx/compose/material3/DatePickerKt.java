...
public final class DatePickerKt {
    ...
    private static final float RecommendedSizeForAccessibility = Dp.m6693constructorimpl(48);
    private static final float MonthYearHeight = Dp.m6693constructorimpl(56);
    private static final float DatePickerHorizontalPadding = Dp.m6693constructorimpl(12);
    private static final PaddingValues DatePickerModeTogglePadding = PaddingKt.m678PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m6693constructorimpl(12), Dp.m6693constructorimpl(12), 3, null);
    private static final PaddingValues DatePickerTitlePadding = PaddingKt.m678PaddingValuesa9UjIt4$default(Dp.m6693constructorimpl(24), Dp.m6693constructorimpl(16), Dp.m6693constructorimpl(12), 0.0f, 8, null);
    private static final PaddingValues DatePickerHeadlinePadding = PaddingKt.m678PaddingValuesa9UjIt4$default(Dp.m6693constructorimpl(24), 0.0f, Dp.m6693constructorimpl(12), Dp.m6693constructorimpl(12), 2, null);
    private static final float YearsVerticalPadding = Dp.m6693constructorimpl(16);
    ...
    */
    ...
    public static final DatePickerState m2051rememberDatePickerStateEU0dCGE(Long initialSelectedDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, SelectableDates selectableDates, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        final int initialDisplayMode2 = (i & 8) != 0 ? DisplayMode.INSTANCE.m2087getPickerjFl4v0() : initialDisplayMode;
        ...
        DatePickerStateImpl datePickerStateImpl = (DatePickerStateImpl) RememberSaveableKt.m3772rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ DatePickerState m2047DatePickerStatesHin3Bw$default(Locale locale, Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            l = null;
        }
        if ((i2 & 4) != 0) {
        ...
        if ((i2 & 16) != 0) {
            i = DisplayMode.INSTANCE.m2087getPickerjFl4v0();
        }
        return m2046DatePickerStatesHin3Bw(locale, l, l2, intRange, i, (i2 & 32) != 0 ? DatePickerDefaults.INSTANCE.getAllDates() : selectableDates);
    }

    /* renamed from: DatePickerState-sHin3Bw, reason: not valid java name */
    public static final DatePickerState m2046DatePickerStatesHin3Bw(Locale locale, Long initialSelectedDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, SelectableDates selectableDates) {
    ...
    public static final void m2044DateEntryContainerau3_HiA(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final DatePickerColors colors, final TextStyle headlineTextStyle, final float headerMinHeight, final Function2<? super Composer, ? super Integer, Unit> function24, Composer $composer, final int $changed) {
        ...
        if ((4793491 & $dirty) != 4793490 || !$composer2.getSkipping()) {
            ...
            Modifier modifier$iv = BackgroundKt.m230backgroundbw27NRU$default(SemanticsModifierKt.semantics$default(SizeKt.m730sizeInqDBjuR0$default(modifier2, DatePickerModalTokens.INSTANCE.m3158getContainerWidthD9Ej5fM(), 0.0f, 0.0f, 0.0f, 14, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        ...
                        if (function27 != null) {
                            TextKt.ProvideTextStyle(textStyle3, ComposableLambdaKt.rememberComposableLambda(-962031352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1$1$1$1
                                ...
                                public final void invoke(Composer $composer5, int $changed3) {
                                    ...
                                    Composer $this$Layout_u24lambda_u240$iv$iv4 = Updater.m3678constructorimpl($composer5);
                        ...
                        if (function29 == null && function27 == null && function28 == null) {
                            ...
                            DividerKt.m2090HorizontalDivider9IZ8Weo(null, 0.0f, datePickerColors3.getDividerColor(), $composer3, 0, 3);
                            $composer4 = $composer3;
                        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$3
                ...
                public final void invoke(Composer composer, int i3) {
                    DatePickerKt.m2044DateEntryContainerau3_HiA(modifier, function2, function22, function23, colors, headlineTextStyle, headerMinHeight, function24, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void m2048DisplayModeToggleButtontER2X8s(Modifier modifier, final int displayMode, final Function1<? super DisplayMode, Unit> function1, Composer $composer, final int $changed) {
        boolean invalid$iv;
        Object value$iv;
        ...
        if (($dirty & 147) != 146 || !$composer2.getSkipping()) {
            ...
            if (DisplayMode.m2082equalsimpl0(displayMode, DisplayMode.INSTANCE.m2087getPickerjFl4v0())) {
                ...
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv2 = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$1$1
                        ...
                        public final void invoke2() {
                            function1.invoke(DisplayMode.m2079boximpl(DisplayMode.INSTANCE.m2086getInputjFl4v0()));
                        }
                    };
                ...
                ComposerKt.sourceInformationMarkerEnd($composer2);
                modifier2 = modifier;
                IconButtonKt.IconButton((Function0) value$iv2, modifier2, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1979getLambda1$material3_release(), $composer2, (($dirty << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                ...
                if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
                    value$iv = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$2$1
                        ...
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2() {
                            function1.invoke(DisplayMode.m2079boximpl(DisplayMode.INSTANCE.m2087getPickerjFl4v0()));
                        }
                    };
                ...
                ComposerKt.sourceInformationMarkerEnd($composer2);
                modifier2 = modifier;
                IconButtonKt.IconButton((Function0) value$iv, modifier2, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1980getLambda2$material3_release(), $composer2, (($dirty << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                $composer2.endReplaceGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$3
                ...
                public final void invoke(Composer composer, int i) {
                    DatePickerKt.m2048DisplayModeToggleButtontER2X8s(modifier2, displayMode, function1, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void m2049SwitchableDateEntryContentd7iavvg(final Long selectedDateMillis, final long displayedMonthMillis, int displayMode, final Function1<? super Long, Unit> function1, final Function1<? super Long, Unit> function12, final CalendarModel calendarModel, final IntRange yearRange, final DatePickerFormatter dateFormatter, final SelectableDates selectableDates, final DatePickerColors colors, Composer $composer, final int $changed) throws Throwable {
        ...
        if ((306783379 & $dirty2) == 306783378 && $composer3.getSkipping()) {
            ...
            final int parallaxTarget = -$this$SwitchableDateEntryContent_d7iavvg_u24lambda_u246.mo361roundToPx0680j_4(Dp.m6693constructorimpl(48));
            DisplayMode displayModeM2079boximpl = DisplayMode.m2079boximpl(i);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<AnimatedContentTransitionScope<DisplayMode>, ContentTransform>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$2$1
                    ...
                    public final ContentTransform invoke(AnimatedContentTransitionScope<DisplayMode> animatedContentTransitionScope) {
                        ...
                        if (DisplayMode.m2082equalsimpl0(animatedContentTransitionScope.getTargetState().getValue(), DisplayMode.INSTANCE.m2086getInputjFl4v0())) {
                        ...
                        return animatedContentTransitionScope.using(contentTransform, AnimatedContentKt.SizeTransform(true, new Function2<IntSize, IntSize, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$2$1.5
                            ...
                            public /* bridge */ /* synthetic */ FiniteAnimationSpec<IntSize> invoke(IntSize intSize, IntSize intSize2) {
                                return m2053invokeTemP2vQ(intSize.getPackedValue(), intSize2.getPackedValue());
                            }

                            /* renamed from: invoke-TemP2vQ, reason: not valid java name */
                            public final FiniteAnimationSpec<IntSize> m2053invokeTemP2vQ(long j, long j2) {
            ...
            AnimatedContentKt.AnimatedContent(displayModeM2079boximpl, modifierSemantics$default, (Function1) value$iv, null, "DatePickerDisplayModeAnimation", null, ComposableLambdaKt.rememberComposableLambda(-459778869, true, new Function4<AnimatedContentScope, DisplayMode, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$3
                ...
                public /* bridge */ /* synthetic */ Unit invoke(AnimatedContentScope animatedContentScope, DisplayMode displayMode2, Composer composer, Integer num) {
                    m2054invokefYndouo(animatedContentScope, displayMode2.getValue(), composer, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-fYndouo, reason: not valid java name */
                public final void m2054invokefYndouo(AnimatedContentScope $this$AnimatedContent, int mode, Composer $composer4, int $changed2) {
                    ...
                    if (DisplayMode.m2082equalsimpl0(mode, DisplayMode.INSTANCE.m2087getPickerjFl4v0())) {
                        ...
                        $composer4.endReplaceGroup();
                    } else if (DisplayMode.m2082equalsimpl0(mode, DisplayMode.INSTANCE.m2086getInputjFl4v0())) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$4
                ...
                public final void invoke(Composer composer, int i3) throws Throwable {
                    DatePickerKt.m2049SwitchableDateEntryContentd7iavvg(selectedDateMillis, displayedMonthMillis, i2, function1, function12, calendarModel, yearRange, dateFormatter, selectableDates, colors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    */
    ...
    public static final void m2045DatePickerHeaderpc5RIQQ(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final long titleContentColor, final long headlineContentColor, final float minHeight, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed) {
        ...
        if ((74899 & $dirty) != 74898 || !$composer2.getSkipping()) {
            ...
            if (function2 != null) {
                heightModifier = SizeKt.m711defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, minHeight, 1, null);
            } else {
            ...
            if (function2 == null) {
                ...
                $composer$iv = $composer2;
                ProvideContentColorTextStyleKt.m2920ProvideContentColorTextStyle3JVO9M(j, textStyle, ComposableLambdaKt.rememberComposableLambda(1936268514, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
            ...
            $composer2.endReplaceGroup();
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4177boximpl(headlineContentColor)), function22, $composer2, ProvidedValue.$stable | (($dirty2 >> 12) & 112));
            ComposerKt.sourceInformationMarkerEnd($composer2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$2
                ...
                public final void invoke(Composer composer, int i3) {
                    DatePickerKt.m2045DatePickerHeaderpc5RIQQ(modifier, function2, titleContentColor, headlineContentColor, minHeight, function22, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    */
    ...
    private static final String dayContentDescription(boolean rangeSelectionEnabled, boolean isToday, boolean isStartDate, boolean isEndDate, boolean isInRange, Composer $composer, int $changed) {
        ...
        if (rangeSelectionEnabled) {
            if (isStartDate) {
                ...
                descriptionBuilder.append(Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_range_picker_start_headline), $composer, 0));
                $composer.endReplaceGroup();
            } else if (isEndDate) {
                $composer.startReplaceGroup(-647751174);
                ComposerKt.sourceInformation($composer, "1896@86344L54");
                Strings.Companion companion2 = Strings.INSTANCE;
                descriptionBuilder.append(Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_range_picker_end_headline), $composer, 0));
                $composer.endReplaceGroup();
            } else if (isInRange) {
                $composer.startReplaceGroup(-647747239);
                ComposerKt.sourceInformation($composer, "1898@86467L53");
                Strings.Companion companion3 = Strings.INSTANCE;
                descriptionBuilder.append(Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_range_picker_day_in_range), $composer, 0));
                $composer.endReplaceGroup();
            } else {
        ...
        if (isToday) {
            ...
            descriptionBuilder.append(Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_picker_today_description), $composer, 0));
        }
        $composer.endReplaceGroup();
    ...
    public static final void Day(final Modifier modifier, final boolean selected, final Function0<Unit> function0, final boolean animateChecked, final boolean enabled, final boolean today, final boolean inRange, final String description, final DatePickerColors colors, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        DatePickerColors datePickerColors;
        Object value$iv;
        BorderStroke borderStrokeM257BorderStrokecXLIe8U;
        Composer $composer2;
        ...
        if ((306783379 & $dirty2) != 306783378 || !$composer3.getSkipping()) {
            ...
            long jM4197unboximpl = datePickerColors.dayContainerColor$material3_release(selected, z2, z, $composer3, (($dirty2 >> 3) & 14) | (($dirty2 >> 9) & 112) | (($dirty2 >> 3) & 896) | (($dirty2 >> 15) & 7168)).getValue().m4197unboximpl();
            long jM4197unboximpl2 = colors.dayContentColor$material3_release(today, selected, z3, enabled, $composer3, (($dirty2 >> 15) & 14) | ($dirty2 & 112) | (($dirty2 >> 12) & 896) | (($dirty2 >> 3) & 7168) | (57344 & ($dirty2 >> 12))).getValue().m4197unboximpl();
            if (today && !selected) {
                borderStrokeM257BorderStrokecXLIe8U = BorderStrokeKt.m257BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m3163getDateTodayContainerOutlineWidthD9Ej5fM(), colors.getTodayDateBorderColor());
            } else {
                borderStrokeM257BorderStrokecXLIe8U = null;
            }
            $composer2 = $composer3;
            SurfaceKt.m2562Surfaced85dljk(selected, function0, modifierSemantics, enabled, value, jM4197unboximpl, jM4197unboximpl2, 0.0f, 0.0f, borderStrokeM257BorderStrokecXLIe8U, (MutableInteractionSource) null, ComposableLambdaKt.rememberComposableLambda(-2031780827, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.Day.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifier$iv = SizeKt.m720requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerModalTokens.INSTANCE.m3162getDateStateLayerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m3161getDateStateLayerHeightD9Ej5fM());
                ...
                */
                public final void invoke(androidx.compose.runtime.Composer r32, int r33) {
                    /*
                        ...
                        To view this dump change 'Code comments level' option to 'DEBUG'
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.DatePickerKt.C04721.invoke(androidx.compose.runtime.Composer, int):void");
                }
            }, $composer2, 54), $composer2, 48);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        if ((4793491 & $dirty2) != 4793490 || !$composer3.getSkipping()) {
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                if (currentYear && !selected) {
                    $dirty = $dirty2;
                    value$iv = BorderStrokeKt.m257BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m3163getDateTodayContainerOutlineWidthD9Ej5fM(), colors.getTodayDateBorderColor());
                } else {
                    $dirty = $dirty2;
                    value$iv = null;
                }
            ...
            ComposerKt.sourceInformationMarkerEnd($composer3);
            $composer2 = $composer3;
            SurfaceKt.m2562Surfaced85dljk(selected, function0, SemanticsModifierKt.semantics(modifier, true, (Function1) value$iv2), enabled, ShapesKt.getValue(DatePickerModalTokens.INSTANCE.getSelectionYearStateLayerShape(), $composer3, 6), colors.yearContainerColor$material3_release(selected, enabled, $composer3, (($dirty >> 3) & 14) | (($dirty >> 9) & 112) | (($dirty >> 12) & 896)).getValue().m4197unboximpl(), colors.yearContentColor$material3_release(currentYear, selected, enabled, $composer3, (($dirty >> 6) & 14) | ($dirty & 112) | (($dirty >> 6) & 896) | (($dirty >> 9) & 7168)).getValue().m4197unboximpl(), 0.0f, 0.0f, border, (MutableInteractionSource) null, ComposableLambdaKt.rememberComposableLambda(-1573188346, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.Year.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
            ...
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4177boximpl(datePickerColors.getNavigationContentColor())), ComposableLambdaKt.rememberComposableLambda(-962805198, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        ...
                        DatePickerKt.YearPickerMenuButton(function08, z4, null, ComposableLambdaKt.rememberComposableLambda(1377272806, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(2);
                            }
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 3) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    ComposerKt.sourceInformationMarkerEnd($composer4);
                                    TextKt.m2711Text4IGK_g(str3, SemanticsModifierKt.semantics$default(companion, false, (Function1) value$iv, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer4, 0, 0, 131068);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                        ...
                        if (!yearPickerVisible) {
                            ...
                            if ($this$Layout_u24lambda_u240$iv$iv2.getInserting()) {
                                ...
                                IconButtonKt.IconButton(function09, null, z5, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1981getLambda3$material3_release(), $composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 26);
                                IconButtonKt.IconButton(function010, null, z3, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1982getLambda4$material3_release(), $composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 26);
                                ComposerKt.sourceInformationMarkerEnd($composer3);
                                ComposerKt.sourceInformationMarkerEnd($composer3);
                                $composer3.endNode();
                                ComposerKt.sourceInformationMarkerEnd($composer3);
    ...
    public static final void YearPickerMenuButton(final Function0<Unit> function0, final boolean expanded, Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            ButtonKt.TextButton(function02, modifier5, false, circleShape, buttonDefaults.m1838textButtonColorsro_MJ88(0L, ((Color) objConsume).m4197unboximpl(), 0L, 0L, $composer2, 24576, 13), null, null, null, null, ComposableLambdaKt.rememberComposableLambda(1899012021, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPickerMenuButton.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(3);
                ...
                public final void invoke(RowScope $this$TextButton, Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 17) != 16 || !$composer3.getSkipping()) {
                        ...
                        SpacerKt.Spacer(SizeKt.m726size3ABfNKs(Modifier.INSTANCE, ButtonDefaults.INSTANCE.m1834getIconSpacingD9Ej5fM()), $composer3, 6);
                        ...
                        if (expanded) {
                            ...
                            Strings.Companion companion = Strings.INSTANCE;
                            String strM2992getString2EP1pXo = Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_picker_switch_to_day_selection), $composer3, 0);
                            $composer3.endReplaceGroup();
                            str = strM2992getString2EP1pXo;
                        } else {
                            $composer3.startReplaceGroup(-1360797046);
                            ComposerKt.sourceInformation($composer3, "2204@98478L50");
                            Strings.Companion companion2 = Strings.INSTANCE;
                            String strM2992getString2EP1pXo2 = Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_date_picker_switch_to_year_selection), $composer3, 0);
                            $composer3.endReplaceGroup();
                            str = strM2992getString2EP1pXo2;
                        }
                        IconKt.m2168Iconww6aTOc(arrowDropDown, str, RotateKt.rotate(Modifier.INSTANCE, expanded ? 180.0f : 0.0f), 0L, $composer3, 0, 8);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
