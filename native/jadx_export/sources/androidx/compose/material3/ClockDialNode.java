...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    private ClockDialNode(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        ...
        this.center = IntOffset.INSTANCE.m6835getZeronOccac();
    ...
    public final float getMaxDist() {
        ...
        return $this$_get_maxDist__u24lambda_u240.mo367toPx0680j_4(TimePickerKt.MaxDistance);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo357onRemeasuredozmzZPI(long size) {
        this.center = IntSizeKt.m6873getCenterozmzZPI(size);
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* renamed from: onPointerEvent-H0pRuoY */
    public void mo203onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo203onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo203onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public final void m1901updateNodee8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        if (!TimePickerSelectionMode.m2765equalsimpl0(this.selection, selection)) {
            this.selection = selection;
