...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        int bottomPadding = measureScope.mo361roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.getBottom());
        long relaxedConstraints3 = Constraints.m6626copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(constraints) : 0);
        int index$iv$iv = 0;
        int size = list.size();
        while (true) {
            if (index$iv$iv >= size) {
        ...
        Placeable leadingPlaceable2 = measurable != null ? measurable.mo5535measureBRTryo0(relaxedConstraints3) : null;
        ...
        if (measurable2 != null) {
            ...
            trailingPlaceable = measurable2.mo5535measureBRTryo0(ConstraintsKt.m6656offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally3, 0, 2, null));
        } else {
            relaxedConstraints = relaxedConstraints3;
        ...
        final Placeable prefixPlaceable = measurable3 != null ? measurable3.mo5535measureBRTryo0(ConstraintsKt.m6656offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally4, 0, 2, null)) : null;
        ...
        if (measurable4 != null) {
            ...
            suffixPlaceable = measurable4.mo5535measureBRTryo0(ConstraintsKt.m6656offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally5, 0, 2, null));
        } else {
            relaxedConstraints2 = relaxedConstraints;
        ...
        int labelHorizontalPaddingOffset = measureScope.mo361roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.mo632calculateLeftPaddingu2uoSUM(measureScope.getLayoutDirection())) + measureScope.mo361roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.mo633calculateRightPaddingu2uoSUM(measureScope.getLayoutDirection()));
        long labelConstraints = ConstraintsKt.m6655offsetNN6EwU(relaxedConstraints2, MathHelpersKt.lerp((-occupiedSpaceHorizontally6) - labelHorizontalPaddingOffset, -labelHorizontalPaddingOffset, outlinedTextFieldMeasurePolicy.animationProgress), -bottomPadding);
        ...
        Placeable labelPlaceable = measurable5 != null ? measurable5.mo5535measureBRTryo0(labelConstraints) : null;
        if (labelPlaceable != null) {
            Placeable it6 = labelPlaceable;
            jM4023getZeroNHjbRc = SizeKt.Size(it6.getWidth(), it6.getHeight());
        } else {
            jM4023getZeroNHjbRc = Size.INSTANCE.m4023getZeroNHjbRc();
        }
        long labelSize = jM4023getZeroNHjbRc;
        outlinedTextFieldMeasurePolicy.onLabelMeasured.invoke(Size.m4002boximpl(labelSize));
        ...
        int supportingIntrinsicHeight = supportingMeasurable != null ? supportingMeasurable.minIntrinsicHeight(Constraints.m6638getMinWidthimpl(constraints)) : 0;
        int topPadding = Math.max(TextFieldImplKt.heightOrZero(labelPlaceable2) / 2, measureScope.mo361roundToPx0680j_4(outlinedTextFieldMeasurePolicy.paddingValues.getTop()));
        final Placeable trailingPlaceable2 = trailingPlaceable;
        long jM6655offsetNN6EwU = ConstraintsKt.m6655offsetNN6EwU(constraints, -occupiedSpaceHorizontally6, ((-bottomPadding) - topPadding) - supportingIntrinsicHeight);
        long textConstraints = Constraints.m6626copyZbe2FdA(jM6655offsetNN6EwU, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(jM6655offsetNN6EwU) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(jM6655offsetNN6EwU) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(jM6655offsetNN6EwU) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(jM6655offsetNN6EwU) : 0);
        ...
        while (index$iv$iv8 < occupiedSpaceHorizontally7) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it8), "TextField")) {
                Placeable textFieldPlaceable = ((Measurable) item$iv$iv).mo5535measureBRTryo0(textConstraints);
                long placeholderConstraints = Constraints.m6626copyZbe2FdA(textConstraints, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(textConstraints) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(textConstraints) : 0, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(textConstraints) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(textConstraints) : 0);
                ...
                Placeable placeholderPlaceable = measurable6 != null ? measurable6.mo5535measureBRTryo0(placeholderConstraints) : null;
                ...
                final int width = OutlinedTextFieldKt.m2370calculateWidthDHJA7U0(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable2), TextFieldImplKt.widthOrZero(prefixPlaceable), TextFieldImplKt.widthOrZero(suffixPlaceable2), textFieldPlaceable2.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable2), TextFieldImplKt.widthOrZero(placeholderPlaceable), outlinedTextFieldMeasurePolicy.animationProgress, constraints, measureScope.getDensity(), outlinedTextFieldMeasurePolicy.paddingValues);
                long relaxedConstraints4 = ConstraintsKt.m6656offsetNN6EwU$default(relaxedConstraints2, 0, -occupiedSpaceVertically5, 1, null);
                long supportingConstraints = Constraints.m6626copyZbe2FdA(relaxedConstraints4, (11 & 1) != 0 ? Constraints.m6638getMinWidthimpl(relaxedConstraints4) : 0, (11 & 2) != 0 ? Constraints.m6636getMaxWidthimpl(relaxedConstraints4) : width, (11 & 4) != 0 ? Constraints.m6637getMinHeightimpl(relaxedConstraints4) : 0, (11 & 8) != 0 ? Constraints.m6635getMaxHeightimpl(relaxedConstraints4) : 0);
                final Placeable supportingPlaceable = supportingMeasurable != null ? supportingMeasurable.mo5535measureBRTryo0(supportingConstraints) : null;
                int supportingHeight = TextFieldImplKt.heightOrZero(supportingPlaceable);
                final int totalHeight = OutlinedTextFieldKt.m2369calculateHeightmKXJcVc(TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable2), TextFieldImplKt.heightOrZero(prefixPlaceable), TextFieldImplKt.heightOrZero(suffixPlaceable2), textFieldPlaceable2.getHeight(), TextFieldImplKt.heightOrZero(labelPlaceable2), TextFieldImplKt.heightOrZero(placeholderPlaceable2), TextFieldImplKt.heightOrZero(supportingPlaceable), outlinedTextFieldMeasurePolicy.animationProgress, constraints, measureScope.getDensity(), outlinedTextFieldMeasurePolicy.paddingValues);
                ...
                while (index$iv$iv12 < totalHeight2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it10), TextFieldImplKt.ContainerId)) {
                        final Placeable containerPlaceable = ((Measurable) item$iv$iv2).mo5535measureBRTryo0(ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : 0, width, height != Integer.MAX_VALUE ? height : 0, height));
                        ...
                        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, totalHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$measure$1
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope $this$intrinsicWidth, List<? extends IntrinsicMeasurable> list, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                return OutlinedTextFieldKt.m2370calculateWidthDHJA7U0(leadingWidth, trailingWidth, prefixWidth, suffixWidth, textFieldWidth, labelWidth, placeholderWidth, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicWidth.getDensity(), this.paddingValues);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        while (index$iv$iv6 < size6) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) item$iv$iv), "TextField")) {
                ...
                return OutlinedTextFieldKt.m2369calculateHeightmKXJcVc(leadingHeight, trailingHeight3, prefixHeight3, trailingHeight4, textFieldHeight, labelHeight, prefixHeight4, supportingHeight, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
            }
            index$iv$iv6++;
