...
public final class RadioButtonKt {
    ...
    private static final float RadioButtonPadding = Dp.m6693constructorimpl(2);
    private static final float RadioButtonDotSize = Dp.m6693constructorimpl(12);
    private static final float RadioStrokeWidth = Dp.m6693constructorimpl(2);
    ...
    public static final void RadioButton(final boolean selected, final Function0<Unit> function0, Modifier modifier, boolean enabled, RadioButtonColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if ((74899 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (selected) {
                ...
                fM6693constructorimpl = Dp.m6693constructorimpl(arg0$iv / 2);
            } else {
                fM6693constructorimpl = Dp.m6693constructorimpl(0);
            }
            State dotRadius2 = AnimateAsStateKt.m122animateDpAsStateAjpBEmI(fM6693constructorimpl, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer2, 48, 12);
            ...
            if (function0 != null) {
                ...
                int iM5960getRadioButtono7Vup1c = Role.INSTANCE.m5960getRadioButtono7Vup1c();
                float arg0$iv2 = RadioButtonTokens.INSTANCE.m3487getStateLayerSizeD9Ej5fM();
                float arg0$iv3 = Dp.m6693constructorimpl(arg0$iv2 / 2);
                ...
                enabled4 = enabled3;
                $dirty2 = $dirty;
                selectableModifier = SelectableKt.m939selectableO2vRcR0(companion, selected, interactionSource2, RippleKt.m2425rippleOrFallbackImplementation9IZ8Weo(false, arg0$iv3, 0L, $composer2, 54, 4), enabled4, Role.m5949boximpl(iM5960getRadioButtono7Vup1c), function0);
            } else {
                modifier4 = modifier3;
                dotRadius = dotRadius2;
                radioColor = radioColor2;
            ...
            Modifier modifierM718requiredSize3ABfNKs = SizeKt.m718requiredSize3ABfNKs(PaddingKt.m681padding3ABfNKs(SizeKt.wrapContentSize$default(modifier4.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(selectableModifier), Alignment.INSTANCE.getCenter(), z, 2, obj), RadioButtonPadding), RadioButtonTokens.INSTANCE.m3486getIconSizeD9Ej5fM());
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.RadioButtonKt$RadioButton$1$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        float strokeWidth = $this$Canvas.mo367toPx0680j_4(RadioButtonKt.RadioStrokeWidth);
                        long jM4197unboximpl = radioColor3.getValue().m4197unboximpl();
                        float arg0$iv4 = RadioButtonTokens.INSTANCE.m3486getIconSizeD9Ej5fM();
                        DrawScope.CC.m4734drawCircleVaOC9Bg$default($this$Canvas, jM4197unboximpl, $this$Canvas.mo367toPx0680j_4(Dp.m6693constructorimpl(arg0$iv4 / 2)) - (strokeWidth / 2.0f), 0L, 0.0f, new Stroke(strokeWidth, 0.0f, 0, 0, null, 30, null), null, 0, 108, null);
                        if (Dp.m6692compareTo0680j_4(dotRadius3.getValue().m6707unboximpl(), Dp.m6693constructorimpl(0)) > 0) {
                            DrawScope.CC.m4734drawCircleVaOC9Bg$default($this$Canvas, radioColor3.getValue().m4197unboximpl(), $this$Canvas.mo367toPx0680j_4(dotRadius3.getValue().m6707unboximpl()) - (strokeWidth / 2.0f), 0L, 0.0f, Fill.INSTANCE, null, 0, 108, null);
                        }
                    }
                };
