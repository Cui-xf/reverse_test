...
public final class NavigationItemIconPosition {
    ...
    public static final /* synthetic */ NavigationItemIconPosition m2320boximpl(int i) {
        return new NavigationItemIconPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2321constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2322equalsimpl(int i, Object obj) {
        return (obj instanceof NavigationItemIconPosition) && i == ((NavigationItemIconPosition) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2323equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2324hashCodeimpl(int i) {
        return i;
    }
    ...
    public static String m2325toStringimpl(int arg0) {
        return m2323equalsimpl0(arg0, Top) ? "Top" : m2323equalsimpl0(arg0, Start) ? "Start" : "Unknown";
    }
}
