...
public final class SearchBarColors {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SearchBarColors) && Color.m4188equalsimpl0(this.containerColor, ((SearchBarColors) other).containerColor) && Color.m4188equalsimpl0(this.dividerColor, ((SearchBarColors) other).dividerColor) && Intrinsics.areEqual(this.inputFieldColors, ((SearchBarColors) other).inputFieldColors);
    }

    public int hashCode() {
        int result = Color.m4194hashCodeimpl(this.containerColor);
        return (((result * 31) + Color.m4194hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
