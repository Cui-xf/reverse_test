...
public final class InputChipDefaults {
    ...
    private static final float Height = InputChipTokens.INSTANCE.m3311getContainerHeightD9Ej5fM();
    private static final float IconSize = InputChipTokens.INSTANCE.m3313getLeadingIconSizeD9Ej5fM();
    private static final float AvatarSize = InputChipTokens.INSTANCE.m3309getAvatarSizeD9Ej5fM();
    ...
    public final SelectableChipColors m2183inputChipColorskwJvTHA(long containerColor, long labelColor, long leadingIconColor, long trailingIconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long leadingIconColor2 = (i & 4) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : leadingIconColor;
        long trailingIconColor2 = (i & 8) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : trailingIconColor;
        ...
        long disabledLeadingIconColor2 = (i & 64) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledLeadingIconColor;
        long disabledTrailingIconColor2 = (i & 128) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledTrailingIconColor;
        long selectedContainerColor2 = (i & 256) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : selectedContainerColor;
        long disabledSelectedContainerColor2 = (i & 512) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : disabledSelectedContainerColor;
        long selectedLabelColor2 = (i & 1024) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : selectedLabelColor;
        long selectedLeadingIconColor2 = (i & 2048) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : selectedLeadingIconColor;
        long selectedTrailingIconColor2 = (i & 4096) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : selectedTrailingIconColor;
        if (ComposerKt.isTraceInProgress()) {
        ...
        SelectableChipColors selectableChipColorsM2478copydaRQuJA = getDefaultInputChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme($composer, 6)).m2478copydaRQuJA(containerColor2, labelColor2, leadingIconColor2, trailingIconColor2, disabledContainerColor2, disabledLabelColor2, disabledLeadingIconColor2, disabledTrailingIconColor2, selectedContainerColor2, disabledSelectedContainerColor2, selectedLabelColor2, selectedLeadingIconColor2, selectedTrailingIconColor2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public final SelectableChipColors getDefaultInputChipColors$material3_release(ColorScheme $this$defaultInputChipColors) {
        ...
        long jM4185copywmQWz5c = Color.m4185copywmQWz5c(jFromToken4, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken4) : 0.38f, (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken4) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken4) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken4) : 0.0f);
        ...
        long jM4185copywmQWz5c2 = Color.m4185copywmQWz5c(jFromToken5, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken5) : 0.38f, (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken5) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken5) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken5) : 0.0f);
        ...
        long jM4185copywmQWz5c3 = Color.m4185copywmQWz5c(jFromToken6, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken6) : 0.38f, (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken6) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken6) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken6) : 0.0f);
        ...
        SelectableChipColors it2 = new SelectableChipColors(jM4222getTransparent0d7_KjU, jFromToken, jFromToken2, jFromToken3, jM4222getTransparent0d7_KjU2, jM4185copywmQWz5c, jM4185copywmQWz5c2, jM4185copywmQWz5c3, jFromToken7, Color.m4185copywmQWz5c(jFromToken8, (14 & 1) != 0 ? Color.m4189getAlphaimpl(jFromToken8) : 0.12f, (14 & 2) != 0 ? Color.m4193getRedimpl(jFromToken8) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(jFromToken8) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(jFromToken8) : 0.0f), ColorSchemeKt.fromToken($this$defaultInputChipColors, InputChipTokens.INSTANCE.getSelectedLabelTextColor()), ColorSchemeKt.fromToken($this$defaultInputChipColors, InputChipTokens.INSTANCE.getSelectedLeadingIconColor()), ColorSchemeKt.fromToken($this$defaultInputChipColors, InputChipTokens.INSTANCE.getSelectedTrailingIconColor()), null);
    ...
    public final SelectableChipElevation m2184inputChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float elevation2;
        ...
        if ((i & 1) != 0) {
            float elevation3 = InputChipTokens.INSTANCE.m3310getContainerElevationD9Ej5fM();
        ...
        float draggedElevation2 = (i & 16) != 0 ? InputChipTokens.INSTANCE.m3312getDraggedContainerElevationD9Ej5fM() : draggedElevation;
    ...
    public final BorderStroke m2182inputChipBorder_7El2pE(boolean enabled, boolean selected, long borderColor, long selectedBorderColor, long disabledBorderColor, long disabledSelectedBorderColor, float borderWidth, float selectedBorderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 16) != 0) {
            ...
            disabledBorderColor2 = Color.m4185copywmQWz5c(value, (14 & 1) != 0 ? Color.m4189getAlphaimpl(value) : 0.12f, (14 & 2) != 0 ? Color.m4193getRedimpl(value) : 0.0f, (14 & 4) != 0 ? Color.m4192getGreenimpl(value) : 0.0f, (14 & 8) != 0 ? Color.m4190getBlueimpl(value) : 0.0f);
        } else {
            disabledBorderColor2 = disabledBorderColor;
        }
        long disabledSelectedBorderColor2 = (i & 32) != 0 ? Color.INSTANCE.m4222getTransparent0d7_KjU() : disabledSelectedBorderColor;
        float borderWidth2 = (i & 64) != 0 ? InputChipTokens.INSTANCE.m3316getUnselectedOutlineWidthD9Ej5fM() : borderWidth;
        float selectedBorderWidth2 = (i & 128) != 0 ? InputChipTokens.INSTANCE.m3314getSelectedOutlineWidthD9Ej5fM() : selectedBorderWidth;
        if (ComposerKt.isTraceInProgress()) {
