...
public final class DateRangePickerKt {
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m678PaddingValuesa9UjIt4$default(Dp.m6693constructorimpl(24), Dp.m6693constructorimpl(20), 0.0f, Dp.m6693constructorimpl(8), 4, null);
    private static final PaddingValues DateRangePickerTitlePadding = PaddingKt.m678PaddingValuesa9UjIt4$default(Dp.m6693constructorimpl(64), 0.0f, Dp.m6693constructorimpl(12), 0.0f, 10, null);
    private static final PaddingValues DateRangePickerHeadlinePadding = PaddingKt.m678PaddingValuesa9UjIt4$default(Dp.m6693constructorimpl(64), 0.0f, Dp.m6693constructorimpl(12), Dp.m6693constructorimpl(12), 2, null);
    private static final float HeaderHeightOffset = Dp.m6693constructorimpl(60);
    ...
    */
    ...
    public static final DateRangePickerState m2066rememberDateRangePickerStateIlFM19s(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, SelectableDates selectableDates, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        final int initialDisplayMode2 = (i & 16) != 0 ? DisplayMode.INSTANCE.m2087getPickerjFl4v0() : initialDisplayMode;
        ...
        DateRangePickerStateImpl dateRangePickerStateImpl = (DateRangePickerStateImpl) RememberSaveableKt.m3772rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) value$iv, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ DateRangePickerState m2062DateRangePickerStateHVP43zI$default(Locale locale, Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            l = null;
        }
        if ((i2 & 4) != 0) {
        ...
        return m2061DateRangePickerStateHVP43zI(locale, l, l2, l3, intRange, i, selectableDates);
    }

    /* renamed from: DateRangePickerState-HVP43zI, reason: not valid java name */
    public static final DateRangePickerState m2061DateRangePickerStateHVP43zI(Locale locale, Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, SelectableDates selectableDates) {
    ...
    public static final void m2063SwitchableDateEntryContentRN2D1Q(final Long selectedStartDateMillis, final Long selectedEndDateMillis, final long displayedMonthMillis, int displayMode, final Function2<? super Long, ? super Long, Unit> function2, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange yearRange, final DatePickerFormatter dateFormatter, final SelectableDates selectableDates, final DatePickerColors colors, Composer $composer, final int $changed, final int $changed1) {
        ...
        if (($dirty2 & 306783379) != 306783378 || ($dirty1 & 3) != 2 || !$composer3.getSkipping()) {
            ...
            CrossfadeKt.Crossfade(DisplayMode.m2079boximpl(i), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode2, Composer composer, Integer num) {
                    m2068invokeQujVXRc(displayMode2.getValue(), composer, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m2068invokeQujVXRc(int mode, Composer $composer4, int $changed2) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$3
                ...
                public final void invoke(Composer composer, int i3) {
                    DateRangePickerKt.m2063SwitchableDateEntryContentRN2D1Q(selectedStartDateMillis, selectedEndDateMillis, displayedMonthMillis, i2, function2, function1, calendarModel, yearRange, dateFormatter, selectableDates, colors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1));
                }
            });
        }
    }
    ...
    */
    ...
    public static final void m2065drawRangeBackgroundmxwnekA(ContentDrawScope $this$drawRangeBackground_u2dmxwnekA, SelectedRangeInfo selectedRangeInfo, long color) {
        float fM4014getWidthimpl;
        ContentDrawScope contentDrawScope = $this$drawRangeBackground_u2dmxwnekA;
        float itemContainerWidth = contentDrawScope.mo367toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float itemContainerHeight = contentDrawScope.mo367toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float itemStateLayerHeight = contentDrawScope.mo367toPx0680j_4(DatePickerModalTokens.INSTANCE.m3161getDateStateLayerHeightD9Ej5fM());
        float stateLayerVerticalPadding = (itemContainerHeight - itemStateLayerHeight) / 2.0f;
        float horizontalSpaceBetweenItems = (Size.m4014getWidthimpl(contentDrawScope.mo4662getSizeNHjbRc()) - (7.0f * itemContainerWidth)) / 7.0f;
        long gridStartCoordinates = selectedRangeInfo.getGridStartCoordinates();
        int iM6825getXimpl = IntOffset.m6825getXimpl(gridStartCoordinates);
        int y1 = IntOffset.m6826getYimpl(gridStartCoordinates);
        long gridEndCoordinates = selectedRangeInfo.getGridEndCoordinates();
        int iM6825getXimpl2 = IntOffset.m6825getXimpl(gridEndCoordinates);
        int y2 = IntOffset.m6826getYimpl(gridEndCoordinates);
        float startX = (iM6825getXimpl * (itemContainerWidth + horizontalSpaceBetweenItems)) + (selectedRangeInfo.getFirstIsSelectionStart() ? itemContainerWidth / 2.0f : 0.0f) + (horizontalSpaceBetweenItems / 2.0f);
        float startY = (y1 * itemContainerHeight) + stateLayerVerticalPadding;
        float endX = (iM6825getXimpl2 * (itemContainerWidth + horizontalSpaceBetweenItems)) + (selectedRangeInfo.getLastIsSelectionEnd() ? itemContainerWidth / 2.0f : itemContainerWidth) + (horizontalSpaceBetweenItems / 2.0f);
        ...
        if (isRtl) {
            startX = Size.m4014getWidthimpl(contentDrawScope.mo4662getSizeNHjbRc()) - startX;
            endX = Size.m4014getWidthimpl(contentDrawScope.mo4662getSizeNHjbRc()) - endX;
        }
        ContentDrawScope contentDrawScope2 = contentDrawScope;
        long jOffset = OffsetKt.Offset(startX, startY);
        if (y1 == y2) {
            fM4014getWidthimpl = endX - startX;
        } else {
            fM4014getWidthimpl = isRtl ? -startX : Size.m4014getWidthimpl(contentDrawScope.mo4662getSizeNHjbRc()) - startX;
        }
        DrawScope.CC.m4747drawRectnJ9OG0$default(contentDrawScope2, color, jOffset, SizeKt.Size(fM4014getWidthimpl, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        if (y1 != y2) {
            int y = (y2 - y1) - 1;
            while (y > 0) {
                DrawScope.CC.m4747drawRectnJ9OG0$default(contentDrawScope, color, OffsetKt.Offset(0.0f, (y * itemContainerHeight) + startY), SizeKt.Size(Size.m4014getWidthimpl($this$drawRangeBackground_u2dmxwnekA.mo4662getSizeNHjbRc()), itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
                y--;
                contentDrawScope = $this$drawRangeBackground_u2dmxwnekA;
                itemContainerWidth = itemContainerWidth;
            }
            float topLeftX = $this$drawRangeBackground_u2dmxwnekA.getLayoutDirection() == LayoutDirection.Ltr ? 0.0f : Size.m4014getWidthimpl($this$drawRangeBackground_u2dmxwnekA.mo4662getSizeNHjbRc());
            DrawScope.CC.m4747drawRectnJ9OG0$default($this$drawRangeBackground_u2dmxwnekA, color, OffsetKt.Offset(topLeftX, endY), SizeKt.Size(isRtl ? endX - Size.m4014getWidthimpl($this$drawRangeBackground_u2dmxwnekA.mo4662getSizeNHjbRc()) : endX, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        }
    }
