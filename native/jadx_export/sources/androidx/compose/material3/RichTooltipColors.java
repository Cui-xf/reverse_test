...
public final class RichTooltipColors {
    ...
    public final RichTooltipColors m2415copyjRlVdoo(long containerColor, long contentColor, long titleContentColor, long actionContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof RichTooltipColors) && Color.m4188equalsimpl0(this.containerColor, ((RichTooltipColors) other).containerColor) && Color.m4188equalsimpl0(this.contentColor, ((RichTooltipColors) other).contentColor) && Color.m4188equalsimpl0(this.titleContentColor, ((RichTooltipColors) other).titleContentColor) && Color.m4188equalsimpl0(this.actionContentColor, ((RichTooltipColors) other).actionContentColor);
    }

    public int hashCode() {
        int result = Color.m4194hashCodeimpl(this.containerColor);
        return (((((result * 31) + Color.m4194hashCodeimpl(this.contentColor)) * 31) + Color.m4194hashCodeimpl(this.titleContentColor)) * 31) + Color.m4194hashCodeimpl(this.actionContentColor);
    }
}
