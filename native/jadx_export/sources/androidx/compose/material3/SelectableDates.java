...
public interface SelectableDates {
    ...
    public final /* synthetic */ class CC {
        public static boolean $default$isSelectableDate(SelectableDates _this, long utcTimeMillis) {
            return true;
        }

        public static boolean $default$isSelectableYear(SelectableDates _this, int year) {
            return true;
        }
    }
}
