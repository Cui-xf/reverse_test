...
public final class WindowAlignmentMarginPosition {
    ...
    public static final /* data */ class Horizontal implements MenuPosition.Horizontal {
        ...
        public int mo2908position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection) {
            if (menuWidth >= IntSize.m6867getWidthimpl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterHorizontally().align(menuWidth, IntSize.m6867getWidthimpl(windowSize), layoutDirection);
            }
            int x = this.alignment.align(menuWidth, IntSize.m6867getWidthimpl(windowSize), layoutDirection);
            return RangesKt.coerceIn(x, this.margin, (IntSize.m6867getWidthimpl(windowSize) - this.margin) - menuWidth);
        }
    }
    ...
    public static final /* data */ class Vertical implements MenuPosition.Vertical {
        ...
        public int mo2909positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight) {
            if (menuHeight >= IntSize.m6866getHeightimpl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterVertically().align(menuHeight, IntSize.m6866getHeightimpl(windowSize));
            }
            int y = this.alignment.align(menuHeight, IntSize.m6866getHeightimpl(windowSize));
            return RangesKt.coerceIn(y, this.margin, (IntSize.m6866getHeightimpl(windowSize) - this.margin) - menuHeight);
        }
    }
}
