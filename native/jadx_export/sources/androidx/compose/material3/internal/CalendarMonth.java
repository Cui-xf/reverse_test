...
public final /* data */ class CalendarMonth {
    ...
    public int hashCode() {
        return (((((((this.year * 31) + this.month) * 31) + this.numberOfDays) * 31) + this.daysFromStartOfWeekToFirstOfMonth) * 31) + FloatFloatPair$$ExternalSyntheticBackport0.m(this.startUtcTimeMillis);
    }
