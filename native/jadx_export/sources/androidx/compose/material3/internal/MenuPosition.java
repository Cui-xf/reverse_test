...
public final class MenuPosition {
    ...
    public interface Horizontal {
        ...
        int mo2908position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection);
    }
    ...
    public interface Vertical {
        ...
        int mo2909positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight);
    }
