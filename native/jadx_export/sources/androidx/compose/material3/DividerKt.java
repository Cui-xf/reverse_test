...
public final class DividerKt {
    ...
    public static final void m2090HorizontalDivider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        final long color2;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                thickness2 = i3 != 0 ? DividerDefaults.INSTANCE.m2088getThicknessD9Ej5fM() : f;
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.DividerKt$HorizontalDivider$1$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        float f2 = $this$Canvas.mo367toPx0680j_4(thickness2);
                        DrawScope.CC.m4739drawLineNGM6Ib0$default($this$Canvas, color2, OffsetKt.Offset(0.0f, $this$Canvas.mo367toPx0680j_4(thickness2) / 2.0f), OffsetKt.Offset(Size.m4014getWidthimpl($this$Canvas.mo4662getSizeNHjbRc()), $this$Canvas.mo367toPx0680j_4(thickness2) / 2.0f), f2, 0, null, 0.0f, null, 0, 496, null);
                    }
                };
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$HorizontalDivider$2
                ...
                public final void invoke(Composer composer, int i5) {
                    DividerKt.m2090HorizontalDivider9IZ8Weo(modifier4, thickness3, color3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2091VerticalDivider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        final long color2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.DividerKt$VerticalDivider$1$1
                    ...
                    public final void invoke2(DrawScope $this$Canvas) {
                        float f2 = $this$Canvas.mo367toPx0680j_4(thickness2);
                        DrawScope.CC.m4739drawLineNGM6Ib0$default($this$Canvas, color2, OffsetKt.Offset($this$Canvas.mo367toPx0680j_4(thickness2) / 2.0f, 0.0f), OffsetKt.Offset($this$Canvas.mo367toPx0680j_4(thickness2) / 2.0f, Size.m4011getHeightimpl($this$Canvas.mo4662getSizeNHjbRc())), f2, 0, null, 0.0f, null, 0, 496, null);
                    }
                };
                $composer2.updateRememberedValue(value$iv);
            } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$VerticalDivider$2
                ...
                public final void invoke(Composer composer, int i5) {
                    DividerKt.m2091VerticalDivider9IZ8Weo(modifier4, thickness3, color3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m2089Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long color2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            if (Dp.m6698equalsimpl0(thickness2, Dp.INSTANCE.m6711getHairlineD9Ej5fM())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart($composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object objConsume = $composer2.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                float $this$dp$iv = 1.0f / ((Density) objConsume).getDensity();
                targetThickness = Dp.m6693constructorimpl($this$dp$iv);
            } else {
                targetThickness = thickness2;
            }
            $composer2.endReplaceGroup();
            BoxKt.Box(BackgroundKt.m230backgroundbw27NRU$default(SizeKt.m712height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3, 0.0f, 1, null), targetThickness), color3, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
                ...
                public final void invoke(Composer composer, int i5) {
                    DividerKt.m2089Divider9IZ8Weo(modifier4, thickness3, color4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
