...
public interface LazyItemScope {
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ Modifier animateItem$default(LazyItemScope lazyItemScope, Modifier modifier, FiniteAnimationSpec finiteAnimationSpec, FiniteAnimationSpec finiteAnimationSpec2, FiniteAnimationSpec finiteAnimationSpec3, int i, Object obj) {
            ...
            if ((i & 2) != 0) {
                finiteAnimationSpec2 = AnimationSpecKt.spring$default(0.0f, 400.0f, IntOffset.m6816boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 1, null);
            }
            if ((i & 4) != 0) {
        ...
        public static Modifier $default$animateItem(LazyItemScope _this, Modifier $this$animateItem, FiniteAnimationSpec fadeInSpec, FiniteAnimationSpec placementSpec, FiniteAnimationSpec fadeOutSpec) {
        ...
        @Deprecated(message = "Use Modifier.animateItem() instead", replaceWith = @ReplaceWith(expression = "Modifier.animateItem(fadeInSpec = null, fadeOutSpec = null, placementSpec = animationSpec)", imports = {}))
        public static Modifier $default$animateItemPlacement(LazyItemScope _this, Modifier $this$animateItemPlacement, FiniteAnimationSpec animationSpec) {
            return _this.animateItem($this$animateItemPlacement, null, animationSpec, null);
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static Modifier animateItem(LazyItemScope $this, Modifier $receiver, FiniteAnimationSpec<Float> finiteAnimationSpec, FiniteAnimationSpec<IntOffset> finiteAnimationSpec2, FiniteAnimationSpec<Float> finiteAnimationSpec3) {
            return CC.$default$animateItem($this, $receiver, finiteAnimationSpec, finiteAnimationSpec2, finiteAnimationSpec3);
        }
        ...
        public static Modifier animateItemPlacement(LazyItemScope $this, Modifier $receiver, FiniteAnimationSpec<IntOffset> finiteAnimationSpec) {
            return CC.$default$animateItemPlacement($this, $receiver, finiteAnimationSpec);
        }
    }
}
