...
public final class LazyStaggeredGridKt {
    ...
    public static final void m889LazyStaggeredGridLJWHXA8(final LazyStaggeredGridState state, final Orientation orientation, final LazyGridStaggeredGridSlotsProvider slots, Modifier modifier, PaddingValues contentPadding, boolean reverseLayout, FlingBehavior flingBehavior, boolean userScrollEnabled, float mainAxisSpacing, float crossAxisSpacing, final Function1<? super LazyStaggeredGridScope, Unit> function1, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed & 1572864) == 0) {
            $dirty3 |= ((i & 64) == 0 && $composer3.changed(flingBehavior)) ? 1048576 : 524288;
        }
        int i7 = i & 128;
        if (i7 != 0) {
            $dirty3 |= 12582912;
        ...
        if ((306783379 & $dirty3) == 306783378 && ($dirty12 & 3) == 2 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                PaddingValues contentPadding4 = i5 != 0 ? PaddingKt.m674PaddingValues0680j_4(Dp.m6693constructorimpl(0)) : paddingValues;
                if (i6 != 0) {
                ...
                boolean userScrollEnabled4 = i7 != 0 ? true : userScrollEnabled;
                float mainAxisSpacing4 = i2 != 0 ? Dp.m6693constructorimpl(0) : mainAxisSpacing;
                if (i3 != 0) {
                    modifier3 = modifier5;
                    ...
                    $dirty2 = $dirty;
                    crossAxisSpacing2 = Dp.m6693constructorimpl(0);
            ...
            Modifier modifierLazyLayoutSemantics = LazyLayoutSemanticsKt.lazyLayoutSemantics(modifier3.then(state.getRemeasurementModifier()).then(state.getAwaitLayoutModifier()), itemProviderLambda, semanticState, orientation, userScrollEnabled5, reverseLayout4, $composer3, (($dirty5 << 6) & 7168) | (($dirty5 >> 9) & 57344) | ($dirty5 & 458752));
            LazyLayoutBeyondBoundsState lazyLayoutBeyondBoundsStateRememberLazyStaggeredGridBeyondBoundsState = LazyStaggeredGridBeyondBoundsModifierKt.rememberLazyStaggeredGridBeyondBoundsState(state, $composer3, $dirty5 & 14);
