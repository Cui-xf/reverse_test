...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m6825getXimpl(getOffset()) : IntOffset.m6826getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        while (index$iv < size) {
            ...
            if (animation != null) {
                ...
                if ((m905getMainAxisgyyYBs(offset) <= minOffset && m905getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m905getMainAxisgyyYBs(offset) >= maxOffset && m905getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
            ...
            if ($this$place_u24lambda_u2462.getReverseLayout()) {
                ...
                if (getIsVertical()) {
                    layer2 = layer;
                    height = IntOffset.m6825getXimpl($this$copy_u2d4Tuh3kE$iv);
                } else {
                ...
                if (getIsVertical()) {
                    ...
                    iM6826getYimpl = (this.mainAxisLayoutSize - mainAxisOffset2) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                } else {
                    iM6826getYimpl = IntOffset.m6826getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(height, iM6826getYimpl);
            } else {
                layer2 = layer;
            }
            long offset2 = IntOffset.m6829plusqkQi6aY(offset, $this$place_u24lambda_u2462.getContentOffset());
            if (animation != null) {
            ...
            if (layer2 != null) {
                ...
                Placeable.PlacementScope.m5608placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u246_u24lambda_u2452, placeable, offset2, layer2, 0.0f, 4, (Object) null);
            } else {
                $this$place_u24lambda_u246_u24lambda_u2452 = $this$place_u24lambda_u246_u24lambda_u245;
                Placeable.PlacementScope.m5607placeRelativeWithLayeraW9wM$default($this$place_u24lambda_u246_u24lambda_u2452, placeable, offset2, 0.0f, (Function1) null, 6, (Object) null);
            }
            index$iv++;
    ...
    private final int m905getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m904copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
