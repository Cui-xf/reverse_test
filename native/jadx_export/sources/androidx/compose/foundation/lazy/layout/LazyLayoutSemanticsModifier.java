...
final class LazyLayoutSemanticsModifier extends ModifierNodeElement<LazyLayoutSemanticsModifierNode> {
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + this.state.hashCode()) * 31) + this.orientation.hashCode()) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.userScrollEnabled)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.reverseScrolling);
    }
}
