                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 3) != 2 || !$composer.getSkipping()) {
                        ...
                        if (active$iv) {
                            ...
                            LazyLayoutItemContentFactoryKt.m848SkippableItemJVlU9Rs(itemProvider, StableValue.m876constructorimpl(lazyLayoutItemContentFactory2.saveableStateHolder), index, StableValue.m876constructorimpl(cachedItemContent.getKey()), $composer, 0);
