...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo807invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m6624boximpl(constraints));
