...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo86measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        long childConstraints = ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m6638getMinWidthimpl(constraints), width != Integer.MAX_VALUE ? width : Constraints.m6636getMaxWidthimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m6637getMinHeightimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m6635getMaxHeightimpl(constraints));
        final Placeable placeable = measurable.mo5535measureBRTryo0(childConstraints);
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            {
                super(1);
            }
