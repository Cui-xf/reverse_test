...
public abstract class LazyListMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo782createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m6636getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, !isVertical ? Constraints.m6635getMaxHeightimpl(constraints) : Integer.MAX_VALUE, 5, null);
    }
    ...
    public LazyListMeasuredItem mo794getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m795getAndMeasure0kLqBqw(index, constraints);
    }

    /* renamed from: getAndMeasure-0kLqBqw$default, reason: not valid java name */
    public static /* synthetic */ LazyListMeasuredItem m793getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, long j, int i2, Object obj) {
        if (obj != null) {
        ...
        return lazyListMeasuredItemProvider.m795getAndMeasure0kLqBqw(i, j);
    }

    /* renamed from: getAndMeasure-0kLqBqw, reason: not valid java name */
    public final LazyListMeasuredItem m795getAndMeasure0kLqBqw(int index, long constraints) {
        Object key = this.itemProvider.getKey(index);
        Object contentType = this.itemProvider.getContentType(index);
        List placeables = this.measureScope.mo851measure0kLqBqw(index, constraints);
        return mo782createItemX9ElhV4(index, key, contentType, placeables, constraints);
    }
