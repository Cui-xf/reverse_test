...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m302constructorimpl(0);
    private static final int WhileFocused = m302constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m301boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m302constructorimpl(int i) {
        return i;
    }
    ...
    public static String m306toStringimpl(int arg0) {
        if (m304equalsimpl0(arg0, Immediately)) {
            return "Immediately";
        }
        if (m304equalsimpl0(arg0, WhileFocused)) {
            return "WhileFocused";
        }
