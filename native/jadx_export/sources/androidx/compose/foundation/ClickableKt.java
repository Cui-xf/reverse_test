...
public final class ClickableKt {
    ...
    public static /* synthetic */ Modifier m263clickableXHw0xAI$default(Modifier modifier, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        return m262clickableXHw0xAI(modifier, z, str, role, function0);
    }

    /* renamed from: clickable-XHw0xAI, reason: not valid java name */
    public static final Modifier m262clickableXHw0xAI(Modifier $this$clickable_u2dXHw0xAI, final boolean enabled, final String onClickLabel, final Role role, final Function0<Unit> function0) {
        return ComposedModifierKt.composed($this$clickable_u2dXHw0xAI, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ClickableKt$clickable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                Modifier modifierM260clickableO2vRcR0 = ClickableKt.m260clickableO2vRcR0(Modifier.INSTANCE, interactionSource, localIndication2, enabled, onClickLabel, role, function0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceGroup();
                return modifierM260clickableO2vRcR0;
            }
        });
    }

    /* renamed from: clickable-O2vRcR0, reason: not valid java name */
    public static final Modifier m260clickableO2vRcR0(Modifier $this$clickable_u2dO2vRcR0, MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final String onClickLabel, final Role role, final Function0<Unit> function0) {
        ...
        if (indication instanceof IndicationNodeFactory) {
            ...
            clickableElementComposed$default = new ClickableElement(interactionSource, indicationNodeFactory, enabled, onClickLabel, role, function0, null);
        } else if (indication == null) {
            IndicationNodeFactory indicationNodeFactory2 = null;
            clickableElementComposed$default = new ClickableElement(interactionSource, indicationNodeFactory2, enabled, onClickLabel, role, function0, null);
        } else if (interactionSource != null) {
            IndicationNodeFactory indicationNodeFactory3 = null;
            clickableElementComposed$default = IndicationKt.indication(Modifier.INSTANCE, interactionSource, indication).then(new ClickableElement(interactionSource, indicationNodeFactory3, enabled, onClickLabel, role, function0, null));
        } else {
    ...
    public static /* synthetic */ Modifier m267combinedClickablecJG_KMw$default(Modifier modifier, boolean z, String str, Role role, String str2, Function0 function0, Function0 function02, Function0 function03, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        return m266combinedClickablecJG_KMw(modifier, z, str, role, str2, function0, (i & 32) != 0 ? null : function02, function03);
    }

    /* renamed from: combinedClickable-cJG_KMw, reason: not valid java name */
    public static final Modifier m266combinedClickablecJG_KMw(Modifier $this$combinedClickable_u2dcJG_KMw, final boolean enabled, final String onClickLabel, final Role role, final String onLongClickLabel, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> function03) {
        return ComposedModifierKt.composed($this$combinedClickable_u2dcJG_KMw, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable-cJG_KMw$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                Modifier modifierM264combinedClickableXVZzFYc = ClickableKt.m264combinedClickableXVZzFYc(Modifier.INSTANCE, interactionSource, localIndication2, enabled, onClickLabel, role, onLongClickLabel, function0, function02, function03);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceGroup();
                return modifierM264combinedClickableXVZzFYc;
            }
        });
    }

    /* renamed from: combinedClickable-XVZzFYc, reason: not valid java name */
    public static final Modifier m264combinedClickableXVZzFYc(Modifier $this$combinedClickable_u2dXVZzFYc, MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final String onClickLabel, final Role role, final String onLongClickLabel, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> function03) {
        CombinedClickableElement combinedClickableElementComposed$default;
        if (indication instanceof IndicationNodeFactory) {
            IndicationNodeFactory indicationNodeFactory = (IndicationNodeFactory) indication;
            combinedClickableElementComposed$default = new CombinedClickableElement(interactionSource, indicationNodeFactory, enabled, onClickLabel, role, function03, onLongClickLabel, function0, function02, null);
        } else if (indication == null) {
            IndicationNodeFactory indicationNodeFactory2 = null;
            combinedClickableElementComposed$default = new CombinedClickableElement(interactionSource, indicationNodeFactory2, enabled, onClickLabel, role, function03, onLongClickLabel, function0, function02, null);
        } else if (interactionSource != null) {
            IndicationNodeFactory indicationNodeFactory3 = null;
            combinedClickableElementComposed$default = IndicationKt.indication(Modifier.INSTANCE, interactionSource, indication).then(new CombinedClickableElement(interactionSource, indicationNodeFactory3, enabled, onClickLabel, role, function03, onLongClickLabel, function0, function02, null));
        } else {
    ...
    private static final Modifier genericClickableWithoutGesture_Kqv_Bsg$detectPressAndClickFromKey(Modifier $this$genericClickableWithoutGesture_Kqv_Bsg_u24detectPressAndClickFromKey, final boolean $enabled, final Map<Key, PressInteraction.Press> map, final State<Offset> state, final CoroutineScope $indicationScope, final Function0<Unit> function0, final MutableInteractionSource $interactionSource) {
        return KeyInputModifierKt.onKeyEvent($this$genericClickableWithoutGesture_Kqv_Bsg_u24detectPressAndClickFromKey, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.foundation.ClickableKt$genericClickableWithoutGesture$detectPressAndClickFromKey$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m270invokeZmokQxo(keyEvent.m5246unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m270invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean z = true;
                if ($enabled && Clickable_androidKt.m277isPressZmokQxo(keyEvent)) {
                    if (!map.containsKey(Key.m4946boximpl(KeyEvent_androidKt.m5257getKeyZmokQxo(keyEvent)))) {
                        PressInteraction.Press press = new PressInteraction.Press(state.getValue().getPackedValue(), null);
                        map.put(Key.m4946boximpl(KeyEvent_androidKt.m5257getKeyZmokQxo(keyEvent)), press);
                ...
                } else if ($enabled && Clickable_androidKt.m275isClickZmokQxo(keyEvent)) {
                    PressInteraction.Press it = map.remove(Key.m4946boximpl(KeyEvent_androidKt.m5257getKeyZmokQxo(keyEvent)));
                    if (it != null) {
    ...
    public static final Modifier m268genericClickableWithoutGestureKqvBsg(Modifier $this$genericClickableWithoutGesture_u2dKqv_u2dBsg, MutableInteractionSource interactionSource, Indication indication, CoroutineScope indicationScope, Map<Key, PressInteraction.Press> map, State<Offset> state, boolean enabled, String onClickLabel, Role role, String onLongClickLabel, Function0<Unit> function0, Function0<Unit> function02) {
    ...
    public static final CombinedClickableNode m259CombinedClickableNodenSzSaCc(Function0<Unit> function0, String onLongClickLabel, Function0<Unit> function02, Function0<Unit> function03, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, String onClickLabel, Role role) {
            ...
            */
            public final java.lang.Boolean invoke(androidx.compose.ui.node.TraversableNode r4) {
                ...
                L1c:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.ClickableKt.C02181.invoke(androidx.compose.ui.node.TraversableNode):java.lang.Boolean");
            }
        });
