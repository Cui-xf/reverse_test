...
final class BackgroundElement extends ModifierNodeElement<BackgroundNode> {
    ...
    public /* synthetic */ BackgroundElement(long j, Brush brush, float f, Shape shape, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        long jM4223getUnspecified0d7_KjU;
        Brush brush2;
        if ((i & 1) == 0) {
            jM4223getUnspecified0d7_KjU = j;
        } else {
            jM4223getUnspecified0d7_KjU = Color.INSTANCE.m4223getUnspecified0d7_KjU();
        }
        if ((i & 2) == 0) {
            brush2 = brush;
        } else {
        ...
        this(jM4223getUnspecified0d7_KjU, brush2, f, shape, function1, null);
    }
    ...
    public void update(BackgroundNode node) {
        node.m232setColor8_81llA(this.color);
    ...
    public boolean equals(Object other) {
        ...
        if (otherModifier != null && Color.m4188equalsimpl0(this.color, otherModifier.color) && Intrinsics.areEqual(this.brush, otherModifier.brush)) {
