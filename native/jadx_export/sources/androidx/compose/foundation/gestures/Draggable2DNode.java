...
public final class Draggable2DNode extends DragGestureNode {
                ...
                case 0:
                    ...
                    Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.Draggable2DNode.drag.2.1
                        ...
                        public final void invoke2(DragEvent.DragDelta dragDelta) {
                            $this$drag.mo397dragByk4lQ0M(draggable2DNode.m436reverseIfNeededMKHz9U(dragDelta.getDelta()));
                        }
                    };
                    this.label = 1;
    ...
    public void mo384onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStart.invoke(Offset.m3934boximpl(startedPosition));
    ...
    public void mo385onDragStoppedTH1AsA0(long velocity) {
        this.onDragStop.invoke(Velocity.m6925boximpl(velocity));
    ...
    public final long m435reverseIfNeededAH228Gc(long $this$reverseIfNeeded_u2dAH228Gc) {
        return Velocity.m6940timesadjELrA($this$reverseIfNeeded_u2dAH228Gc, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m436reverseIfNeededMKHz9U(long $this$reverseIfNeeded_u2dMK_u2dHz9U) {
        return Offset.m3952timestuRUvjQ($this$reverseIfNeeded_u2dMK_u2dHz9U, this.reverseDirection ? -1.0f : 1.0f);
    }
}
