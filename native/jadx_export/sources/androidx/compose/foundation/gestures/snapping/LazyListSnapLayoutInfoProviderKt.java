...
public final class LazyListSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyListState lazyListState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyListSnapLayoutInfoProviderKt.SnapLayoutInfoProvider.1
            ...
            public float calculateSnapOffset(float velocity) {
                ...
                return SnapFlingBehaviorKt.m523calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem($this$calculateSnapOffset_u24lambda_u242, velocity), lowerBoundOffset, upperBoundOffset);
            }
        };
    }
    ...
    public static final int getSingleAxisViewportSize(LazyListLayoutInfo $this$singleAxisViewportSize) {
        return $this$singleAxisViewportSize.getOrientation() == Orientation.Vertical ? IntSize.m6866getHeightimpl($this$singleAxisViewportSize.mo783getViewportSizeYbymL2g()) : IntSize.m6867getWidthimpl($this$singleAxisViewportSize.mo783getViewportSizeYbymL2g());
    }

    public static final int calculateFinalSnappingItem(Density $this$calculateFinalSnappingItem, float velocity) {
        if (Math.abs(velocity) < $this$calculateFinalSnappingItem.mo367toPx0680j_4(SnapFlingBehaviorKt.getMinFlingVelocityDp())) {
            return FinalSnappingItem.INSTANCE.m520getClosestItembbeMdSM();
        }
        return velocity > 0.0f ? FinalSnappingItem.INSTANCE.m521getNextItembbeMdSM() : FinalSnappingItem.INSTANCE.m522getPreviousItembbeMdSM();
    }
}
