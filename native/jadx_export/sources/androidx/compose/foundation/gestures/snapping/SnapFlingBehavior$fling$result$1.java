    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                $result2 = $result;
                float decayOffset = snapFlingBehavior$fling$result$1.this$0.snapLayoutInfoProvider.calculateApproachOffset(snapFlingBehavior$fling$result$1.$initialVelocity, DecayAnimationSpecKt.calculateTargetValue(snapFlingBehavior$fling$result$1.this$0.decayAnimationSpec, 0.0f, snapFlingBehavior$fling$result$1.$initialVelocity));
                if (Float.isNaN(decayOffset)) {
        ...
        float finalSnapOffset = snapFlingBehavior$fling$result$1.this$0.snapLayoutInfoProvider.calculateSnapOffset(((Number) animationState.getVelocity()).floatValue());
