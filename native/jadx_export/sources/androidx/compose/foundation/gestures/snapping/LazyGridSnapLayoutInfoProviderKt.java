...
public final class LazyGridSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyGridState lazyGridState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyGridSnapLayoutInfoProviderKt.SnapLayoutInfoProvider.1
            ...
            public float calculateSnapOffset(float velocity) {
                ...
                return SnapFlingBehaviorKt.m523calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem($this$calculateSnapOffset_u24lambda_u242, velocity), distanceFromItemBeforeTarget, distanceFromItemAfterTarget);
            }
        };
    }
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo $this$singleAxisViewportSize) {
        if ($this$singleAxisViewportSize.getOrientation() == Orientation.Vertical) {
            return IntSize.m6866getHeightimpl($this$singleAxisViewportSize.mo820getViewportSizeYbymL2g());
        }
        return IntSize.m6867getWidthimpl($this$singleAxisViewportSize.mo820getViewportSizeYbymL2g());
    }

    public static final int sizeOnMainAxis(LazyGridItemInfo $this$sizeOnMainAxis, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return IntSize.m6866getHeightimpl($this$sizeOnMainAxis.getSize());
        }
        return IntSize.m6867getWidthimpl($this$sizeOnMainAxis.getSize());
    }

    public static final int offsetOnMainAxis(LazyGridItemInfo $this$offsetOnMainAxis, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return IntOffset.m6826getYimpl($this$offsetOnMainAxis.getOffset());
        }
        return IntOffset.m6825getXimpl($this$offsetOnMainAxis.getOffset());
    }
}
