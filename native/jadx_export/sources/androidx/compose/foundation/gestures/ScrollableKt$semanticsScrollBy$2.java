    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                float fM494toFloatk4lQ0M = this.$this_semanticsScrollBy.m494toFloatk4lQ0M(this.$offset);
                final Ref.FloatRef floatRef = this.$previousValue;
                final ScrollingLogic scrollingLogic = this.$this_semanticsScrollBy;
                this.label = 1;
                if (SuspendAnimationKt.animate$default(0.0f, fM494toFloatk4lQ0M, 0.0f, null, new Function2<Float, Float, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(2);
                    }
                    ...
                    public final void invoke(float currentValue, float f) {
                        ...
                        float consumed = scrollingLogic.reverseIfNeeded(scrollingLogic.m494toFloatk4lQ0M($this$scroll.mo448scrollByOzD1aCk(scrollingLogic.m495toOffsettuRUvjQ(scrollingLogic.reverseIfNeeded(delta)), NestedScrollSource.INSTANCE.m5298getUserInputWNlRxjI())));
