...
public final class TransformableStateKt {
        ...
        if (it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = TransformableState(new Function3<Float, Offset, Float, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$rememberTransformableState$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Float f, Offset offset, Float f2) {
                    m512invoked4ec7I(f.floatValue(), offset.getPackedValue(), f2.floatValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-d-4ec7I, reason: not valid java name */
                public final void m512invoked4ec7I(float z, long p, float r) {
                    lambdaState.getValue().invoke(Float.valueOf(z), Offset.m3934boximpl(p), Float.valueOf(r));
                }
            });
                ...
                case 0:
                    ...
                    Function1<AnimationScope<Float, AnimationVector1D>, Unit> function1 = new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt.animateZoomBy.3.1
                        ...
                        public final void invoke2(AnimationScope<Float, AnimationVector1D> animationScope) {
                            ...
                            TransformScope.CC.m505transformByd4ec7I$default($this$transform, scaleFactor, 0L, 0.0f, 6, null);
                            floatRef.element = animationScope.getValue().floatValue();
                        }
                    };
                    this.label = 1;
                    if (SuspendAnimationKt.animateTo(animationStateAnimationState$default, fBoxFloat, (4 & 2) != 0 ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : animationSpec, (4 & 4) != 0 ? false : false, (4 & 8) != 0 ? SuspendAnimationKt.C02042.INSTANCE : function1, this) != coroutine_suspended) {
                        break;
                    } else {
                ...
                case 0:
                    ...
                    Function1<AnimationScope<Float, AnimationVector1D>, Unit> function1 = new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt.animateRotateBy.2.1
                        ...
                        public final void invoke2(AnimationScope<Float, AnimationVector1D> animationScope) {
                            ...
                            TransformScope.CC.m505transformByd4ec7I$default($this$transform, 0.0f, 0L, delta, 3, null);
                            floatRef.element = animationScope.getValue().floatValue();
                        }
                    };
                    this.label = 1;
    ...
    public static /* synthetic */ Object m510animatePanByubNVwUQ$default(TransformableState transformableState, long j, AnimationSpec animationSpec, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            animationSpec = new SpringSpec(0.0f, 200.0f, null, 5, null);
        }
        return m509animatePanByubNVwUQ(transformableState, j, animationSpec, continuation);
    }

    /* renamed from: animatePanBy-ubNVwUQ, reason: not valid java name */
    public static final Object m509animatePanByubNVwUQ(TransformableState $this$animatePanBy_u2dubNVwUQ, long offset, AnimationSpec<Offset> animationSpec, Continuation<? super Unit> continuation) {
        Ref.LongRef previous = new Ref.LongRef();
        previous.element = Offset.INSTANCE.m3961getZeroF1C5BW0();
    ...
    static final class C02642 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02642(float f, Continuation<? super C02642> continuation) {
            super(2, continuation);
            this.$zoomFactor = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02642 c02642 = new C02642(this.$zoomFactor, continuation);
            c02642.L$0 = obj;
            return c02642;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    $this$transform.mo398transformByd4ec7I(this.$zoomFactor, Offset.INSTANCE.m3961getZeroF1C5BW0(), 0.0f);
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
    ...
    public static final Object zoomBy(TransformableState $this$zoomBy, float zoomFactor, Continuation<? super Unit> continuation) {
        Object objTransform$default = TransformableState.CC.transform$default($this$zoomBy, null, new C02642(zoomFactor, null), continuation, 1, null);
        return objTransform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objTransform$default : Unit.INSTANCE;
    }
    ...
    static final class C02622 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $degrees;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02622(float f, Continuation<? super C02622> continuation) {
            super(2, continuation);
            this.$degrees = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02622 c02622 = new C02622(this.$degrees, continuation);
            c02622.L$0 = obj;
            return c02622;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(TransformScope transformScope, Continuation<? super Unit> continuation) {
            return ((C02622) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    TransformScope $this$transform = (TransformScope) this.L$0;
                    $this$transform.mo398transformByd4ec7I(1.0f, Offset.INSTANCE.m3961getZeroF1C5BW0(), this.$degrees);
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
    ...
    public static final Object rotateBy(TransformableState $this$rotateBy, float degrees, Continuation<? super Unit> continuation) {
        Object objTransform$default = TransformableState.CC.transform$default($this$rotateBy, null, new C02622(degrees, null), continuation, 1, null);
        return objTransform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objTransform$default : Unit.INSTANCE;
    }

    /* renamed from: panBy-d-4ec7I, reason: not valid java name */
    public static final Object m511panByd4ec7I(TransformableState $this$panBy_u2dd_u2d4ec7I, long offset, Continuation<? super Unit> continuation) {
    ...
    static final class C02632 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        ...
        C02632(Continuation<? super C02632> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02632(continuation);
        }
    ...
    public static final Object stopTransformation(TransformableState $this$stopTransformation, MutatePriority terminationPriority, Continuation<? super Unit> continuation) {
        Object objTransform = $this$stopTransformation.transform(terminationPriority, new C02632(null), continuation);
