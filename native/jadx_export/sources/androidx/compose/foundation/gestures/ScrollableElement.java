...
final class ScrollableElement extends ModifierNodeElement<ScrollableNode> {
    ...
    public int hashCode() {
        ...
        int result3 = (((((result2 + (overscrollEffect != null ? overscrollEffect.hashCode() : 0)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.enabled)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.reverseDirection)) * 31;
