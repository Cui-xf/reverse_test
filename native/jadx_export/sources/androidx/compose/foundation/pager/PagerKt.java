...
public final class PagerKt {
    ...
    public static final void m925HorizontalPageroI3XNZo(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondViewportPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, TargetedFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, SnapPosition snapPosition, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> function4, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty & 306783379) == 306783378 && ($dirty12 & 1171) == 1170 && $composer4.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer4.getDefaultsInvalid()) {
                ...
                PaddingValues contentPadding4 = i7 != 0 ? PaddingKt.m674PaddingValues0680j_4(Dp.m6693constructorimpl(0)) : paddingValues;
                PageSize pageSize5 = i8 != 0 ? PageSize.Fill.INSTANCE : pageSize2;
                int beyondViewportPageCount4 = i9 != 0 ? 0 : beyondViewportPageCount2;
                float pageSpacing4 = i10 != 0 ? Dp.m6693constructorimpl(0) : pageSpacing2;
                if (i11 != 0) {
            ...
            int $dirty17 = $dirty14;
            int i15 = (($dirty17 >> 3) & 14) | 384 | (($dirty17 << 3) & 112) | (($dirty2 >> 9) & 7168) | (($dirty17 << 6) & 57344) | (($dirty17 << 6) & 458752);
            Modifier modifier6 = modifier4;
            LazyLayoutPagerKt.m921PageruYRUAWA(modifier6, pagerState, contentPadding2, reverseLayout2, Orientation.Horizontal, flingBehavior3, userScrollEnabled2, beyondViewportPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection3, key, Alignment.INSTANCE.getCenterHorizontally(), verticalAlignment3, snapPosition2, function4, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 << 3) & 112) | ($dirty2 & 896) | (($dirty2 >> 18) & 7168) | (($dirty2 >> 6) & 458752) | (($dirty2 >> 6) & 3670016) | (($dirty2 << 9) & 29360128) | (($dirty2 << 9) & 234881024) | (($dirty2 << 18) & 1879048192), i15, 0);
            $composer3 = $composer2;
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$HorizontalPager$1
                ...
                public final void invoke(Composer composer, int i16) {
                    PagerKt.m925HorizontalPageroI3XNZo(state, modifier5, contentPadding3, pageSize4, beyondViewportPageCount3, pageSpacing3, verticalAlignment4, flingBehavior4, userScrollEnabled3, reverseLayout3, key, pageNestedScrollConnection4, snapPosition3, function4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    public static final void m926VerticalPageroI3XNZo(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondViewportPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, TargetedFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, SnapPosition snapPosition, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> function4, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        PaddingValues paddingValues;
        PageSize pageSize2;
        int beyondViewportPageCount2;
        ...
        if (($dirty & 306783379) == 306783378 && ($dirty12 & 1171) == 1170 && $composer4.getSkipping()) {
            ...
            int $dirty17 = $dirty14;
            int i15 = (($dirty17 >> 3) & 14) | 3072 | (($dirty17 << 3) & 112) | (($dirty2 >> 12) & 896) | (($dirty17 << 6) & 57344) | (($dirty17 << 6) & 458752);
            Modifier modifier6 = modifier4;
            LazyLayoutPagerKt.m921PageruYRUAWA(modifier6, pagerState, contentPadding2, reverseLayout2, Orientation.Vertical, flingBehavior3, userScrollEnabled2, beyondViewportPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection3, key, horizontalAlignment3, Alignment.INSTANCE.getCenterVertically(), snapPosition2, function4, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 << 3) & 112) | ($dirty2 & 896) | (($dirty2 >> 18) & 7168) | (($dirty2 >> 6) & 458752) | (($dirty2 >> 6) & 3670016) | (($dirty2 << 9) & 29360128) | (($dirty2 << 9) & 234881024) | (($dirty2 << 18) & 1879048192), i15, 0);
            $composer3 = $composer2;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$VerticalPager$1
                ...
                public final void invoke(Composer composer, int i16) {
                    PagerKt.m926VerticalPageroI3XNZo(state, modifier5, contentPadding3, pageSize4, beyondViewportPageCount3, pageSpacing3, horizontalAlignment4, flingBehavior4, userScrollEnabled3, reverseLayout3, key, pageNestedScrollConnection4, snapPosition3, function4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
