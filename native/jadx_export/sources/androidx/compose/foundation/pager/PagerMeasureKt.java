...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m930measurePagerbmk8ZPk(final LazyLayoutMeasureScope $this$measurePager_u2dbmk8ZPk, int pageCount, final PagerLazyLayoutItemProvider pagerItemProvider, int mainAxisAvailableSize, int beforeContentPadding, int afterContentPadding, int spaceBetweenPages, int currentPage, int currentPageOffset, long constraints, final Orientation orientation, final Alignment.Vertical verticalAlignment, final Alignment.Horizontal horizontalAlignment, final boolean reverseLayout, final long visualPageOffset, final int pageAvailableSize, int beyondViewportPageCount, List<Integer> list, SnapPosition snapPosition, final MutableState<Unit> mutableState, CoroutineScope coroutineScope, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (pageCount <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), pageAvailableSize, spaceBetweenPages, afterContentPadding, orientation, -i4, mainAxisAvailableSize + afterContentPadding, false, beyondViewportPageCount, null, null, 0.0f, 0, false, snapPosition, function3.invoke(Integer.valueOf(Constraints.m6638getMinWidthimpl(constraints)), Integer.valueOf(Constraints.m6637getMinHeightimpl(constraints)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$4
        ...
        if (orientation2 == Orientation.Vertical) {
            ...
            iM6636getMaxWidthimpl = pageAvailableSize;
        }
        if (orientation2 != Orientation.Vertical) {
            iM6635getMaxHeightimpl = Constraints.m6635getMaxHeightimpl(constraints);
        } else {
            iM6635getMaxHeightimpl = pageAvailableSize;
        }
        final long childConstraints = ConstraintsKt.Constraints$default(0, iM6636getMaxWidthimpl, 0, iM6635getMaxHeightimpl, 5, null);
        ...
        int minOffset = (-i4) + (spaceBetweenPages < 0 ? spaceBetweenPages : 0);
        ...
        while (previous < 0 && currentFirstPage2 > 0) {
            ...
            MeasuredPage measuredPage = m929getAndMeasureSGf7dI0($this$measurePager_u2dbmk8ZPk, currentFirstPageScrollOffset7, childConstraints, pagerItemProvider, visualPageOffset, orientation2, horizontalAlignment, verticalAlignment, $this$measurePager_u2dbmk8ZPk.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        while (true) {
            index = index2;
            int index3 = visiblePages3.size();
            if (pageSizeWithSpacing4 >= index3) {
                break;
            }
        ...
        int index4 = currentMainAxisOffset3;
        ...
        while (true) {
            if (currentFirstPageScrollOffset11 >= pageCount) {
                ...
                pageSizeWithSpacing2 = index4;
                currentMainAxisOffset = currentFirstPageScrollOffset11;
                maxCrossAxis = maxCrossAxis4;
                break;
            }
            if (index4 >= maxMainAxis && index4 > 0 && !visiblePages3.isEmpty()) {
                pageSizeWithSpacing = currentMainAxisOffset4;
                pageSizeWithSpacing2 = index4;
                currentMainAxisOffset = currentFirstPageScrollOffset11;
                maxCrossAxis = maxCrossAxis4;
            ...
            int pageSizeWithSpacing6 = index4;
            int maxMainAxis2 = maxMainAxis;
            int maxCrossAxis5 = maxCrossAxis4;
            MeasuredPage measuredPage2 = m929getAndMeasureSGf7dI0($this$measurePager_u2dbmk8ZPk, currentFirstPageScrollOffset11, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, $this$measurePager_u2dbmk8ZPk.getLayoutDirection(), reverseLayout, pageAvailableSize);
            int index5 = currentFirstPageScrollOffset11;
            int $i$f$debugLog = pageCount - 1;
            if (index5 == $i$f$debugLog) {
                i3 = pageAvailableSize;
            } else {
                i3 = pageSizeWithSpacing5;
            }
            int currentMainAxisOffset5 = pageSizeWithSpacing6 + i3;
            if (currentMainAxisOffset5 <= minOffset2 && index5 != pageCount - 1) {
                currentFirstPageScrollOffset10 -= pageSizeWithSpacing5;
                currentFirstPage3 = index5 + 1;
            ...
            currentFirstPageScrollOffset11 = index5 + 1;
            index4 = currentMainAxisOffset5;
            currentMainAxisOffset4 = pageSizeWithSpacing5;
            maxMainAxis = maxMainAxis2;
        }
        int index6 = mainAxisAvailableSize;
        if (pageSizeWithSpacing2 >= index6) {
            maxOffset = index6;
            maxOffset2 = currentMainAxisOffset;
            currentMainAxisOffset2 = currentFirstPageScrollOffset10;
        } else {
            int toScrollBack = index6 - pageSizeWithSpacing2;
            ...
            while (true) {
                ...
                int maxOffset3 = index6;
                int maxOffset4 = currentMainAxisOffset;
                MeasuredPage measuredPage3 = m929getAndMeasureSGf7dI0($this$measurePager_u2dbmk8ZPk, currentFirstPageScrollOffset13, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, $this$measurePager_u2dbmk8ZPk.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        if (beforeContentPadding > 0 || spaceBetweenPages < 0) {
            ...
            while (true) {
                ...
                if (i5 == currentFirstPageScrollOffset14) {
                    break;
                }
                int currentFirstPageScrollOffset15 = i5 + 1;
        ...
        List extraPagesBefore = createPagesBeforeList(maxCrossAxis7, beyondViewportPageCount, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int it) {
                return PagerMeasureKt.m929getAndMeasureSGf7dI0($this$measurePager_u2dbmk8ZPk, it, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, $this$measurePager_u2dbmk8ZPk.getLayoutDirection(), reverseLayout, pageAvailableSize);
            }
        });
        ...
        if (orientation == Orientation.Vertical) {
            ...
            i = pageSizeWithSpacing2;
        }
        int layoutWidth = ConstraintsKt.m6653constrainWidthK40F9xA(constraints, i);
        if (orientation == Orientation.Vertical) {
            i2 = pageSizeWithSpacing2;
        } else {
            i2 = maxCrossAxis9;
        }
        int layoutHeight = ConstraintsKt.m6652constrainHeightK40F9xA(constraints, i2);
        ...
        if (noExtraPages) {
            ...
            while (index$iv$iv < size5) {
                ...
                int i6 = size5;
                int index7 = it.getIndex();
                int $i$f$fastFilter2 = $i$f$fastFilter;
                int $i$f$fastFilter3 = ((MeasuredPage) visiblePages4.first()).getIndex();
                if (index7 >= $i$f$fastFilter3 && it.getIndex() <= ((MeasuredPage) visiblePages4.last()).getIndex()) {
        ...
        if (extraPagesAfter.isEmpty()) {
            ...
            arrayListEmptyList = target$iv3;
        }
        List positionedPagesAfter = arrayListEmptyList;
        ...
        float currentPageOffsetFraction = pageSizeWithSpacing7 == 0 ? 0.0f : RangesKt.coerceIn((snapOffset - currentPagePositionOffset) / pageSizeWithSpacing7, -0.5f, 0.5f);
    ...
    public static final MeasuredPage m929getAndMeasureSGf7dI0(LazyLayoutMeasureScope $this$getAndMeasure_u2dSGf7dI0, int index, long childConstraints, PagerLazyLayoutItemProvider pagerItemProvider, long visualPageOffset, Orientation orientation, Alignment.Horizontal horizontalAlignment, Alignment.Vertical verticalAlignment, LayoutDirection layoutDirection, boolean reverseLayout, int pageAvailableSize) {
        ...
        List placeable = $this$getAndMeasure_u2dSGf7dI0.mo851measure0kLqBqw(index, childConstraints);
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope $this$calculatePagesOffsets, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int layoutWidth, int layoutHeight, int finalMainAxisOffset, int maxOffset, int pagesScrollOffset, Orientation orientation, boolean reverseLayout, Density density, int spaceBetweenPages, int pageAvailableSize) {
        ...
        if (hasSpareSpace) {
            ...
            Arrangement.HorizontalOrVertical arrangement = Arrangement.Absolute.INSTANCE.m560spacedBy0680j_4($this$calculatePagesOffsets.mo364toDpu2uoSUM(spaceBetweenPages));
            if (orientation == Orientation.Vertical) {
