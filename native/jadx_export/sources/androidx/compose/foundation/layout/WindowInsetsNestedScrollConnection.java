...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo479onPreScrollOzD1aCk(long available, int source) {
        return m755scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m3945getXimpl(available), Offset.m3946getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo477onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m755scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m3945getXimpl(available), Offset.m3946getYimpl(available)));
    }
    ...
    public Object mo478onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        return m754flinghuYlsQE(available, this.sideCalculator.hideMotion(Velocity.m6934getXimpl(available), Velocity.m6935getYimpl(available)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo476onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return m754flinghuYlsQE(available, this.sideCalculator.showMotion(Velocity.m6934getXimpl(available), Velocity.m6935getYimpl(available)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m754flinghuYlsQE(long r24, float r26, boolean r27, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r28) {
        /*
