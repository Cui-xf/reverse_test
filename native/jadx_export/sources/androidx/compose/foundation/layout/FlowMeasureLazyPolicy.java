...
final /* data */ class FlowMeasureLazyPolicy implements FlowLineMeasurePolicy {
    ...
    public static /* synthetic */ FlowMeasureLazyPolicy m621copyE4Q9ldg$default(FlowMeasureLazyPolicy flowMeasureLazyPolicy, boolean z, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, float f, CrossAxisAlignment crossAxisAlignment, float f2, int i, int i2, int i3, FlowLayoutOverflowState flowLayoutOverflowState, List list, Function4 function4, int i4, Object obj) {
        ...
        float f3 = f2;
        return flowMeasureLazyPolicy.m623copyE4Q9ldg(z, horizontal, vertical, f, crossAxisAlignment2, f3, i6, i7, i5, flowLayoutOverflowState2, list2, function42);
    }
    ...
    public String toString() {
        ...
        sb.append("FlowMeasureLazyPolicy(isHorizontal=").append(this.isHorizontal).append(", horizontalArrangement=").append(this.horizontalArrangement).append(", verticalArrangement=").append(this.verticalArrangement).append(", mainAxisSpacing=").append((Object) Dp.m6704toStringimpl(this.mainAxisSpacing)).append(", crossAxisAlignment=").append(this.crossAxisAlignment).append(", crossAxisArrangementSpacing=").append((Object) Dp.m6704toStringimpl(this.crossAxisArrangementSpacing)).append(", itemCount=").append(this.itemCount).append(", maxLines=").append(this.maxLines).append(", maxItemsInMainAxis=").append(this.maxItemsInMainAxis).append(", overflow=").append(this.overflow).append(", overflowComposables=").append(this.overflowComposables).append(", getComposable=");
    ...
    public final MeasureResult m622measure0kLqBqw(final SubcomposeMeasureScope $this$measure_u2d0kLqBqw, long constraints) {
        ...
        if (this.itemCount <= 0 || this.maxLines == 0 || this.maxItemsInMainAxis == 0 || (Constraints.m6635getMaxHeightimpl(constraints) == 0 && this.overflow.getType$foundation_layout_release() != FlowLayoutOverflow.OverflowType.Visible)) {
            return MeasureScope.CC.layout$default($this$measure_u2d0kLqBqw, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$measure$1
        ...
        this.overflow.m611setOverflowMeasurablesVKLhPVY$foundation_layout_release(this, constraints, new Function2<Boolean, Integer, Measurable>() { // from class: androidx.compose.foundation.layout.FlowMeasureLazyPolicy$measure$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
        ...
        return FlowLayoutKt.m605breakDownItemsdi9J0FM(subcomposeMeasureScope, flowMeasureLazyPolicy, contextualFlowItemIterator, f, f2, OrientationIndependentConstraints.m650constructorimpl(constraints, layoutOrientation), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }
}
