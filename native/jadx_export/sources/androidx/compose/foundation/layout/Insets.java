...
final class Insets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo361roundToPx0680j_4(this.left);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo361roundToPx0680j_4(this.top);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo361roundToPx0680j_4(this.right);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo361roundToPx0680j_4(this.bottom);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m6704toStringimpl(this.left)) + ", top=" + ((Object) Dp.m6704toStringimpl(this.top)) + ", right=" + ((Object) Dp.m6704toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m6704toStringimpl(this.bottom)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Insets) && Dp.m6698equalsimpl0(this.left, ((Insets) other).left) && Dp.m6698equalsimpl0(this.top, ((Insets) other).top) && Dp.m6698equalsimpl0(this.right, ((Insets) other).right) && Dp.m6698equalsimpl0(this.bottom, ((Insets) other).bottom);
    }

    public int hashCode() {
        int result = Dp.m6699hashCodeimpl(this.left);
        return (((((result * 31) + Dp.m6699hashCodeimpl(this.top)) * 31) + Dp.m6699hashCodeimpl(this.right)) * 31) + Dp.m6699hashCodeimpl(this.bottom);
    }
}
