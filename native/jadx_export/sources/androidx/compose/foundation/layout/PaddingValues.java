...
final class PaddingValues implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo361roundToPx0680j_4(this.paddingValues.mo632calculateLeftPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo361roundToPx0680j_4(this.paddingValues.getTop());
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo361roundToPx0680j_4(this.paddingValues.mo633calculateRightPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo361roundToPx0680j_4(this.paddingValues.getBottom());
    }
    ...
    public String toString() {
        ...
        return "PaddingValues(" + ((Object) Dp.m6704toStringimpl(start)) + ", " + ((Object) Dp.m6704toStringimpl(top)) + ", " + ((Object) Dp.m6704toStringimpl(end)) + ", " + ((Object) Dp.m6704toStringimpl(bottom)) + ')';
    }
