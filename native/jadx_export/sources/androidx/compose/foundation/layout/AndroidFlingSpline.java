...
final class AndroidFlingSpline {
        ...
        while (true) {
            ...
            if (i < 100) {
                ...
                while (true) {
                    y = yMin + ((yMax - yMin) / f);
                    coef2 = y * f2 * (f3 - y);
                    float dy = ((((f3 - y) * 0.5f) + y) * coef2) + (y * y * y);
    ...
    public final long m547flingPositionLfoxSSI(float time) {
        ...
        return FlingResult.m549constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m548boximpl(long j) {
            return new FlingResult(j);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static long m549constructorimpl(long j) {
            return j;
        }
        ...
        public static String m555toStringimpl(long j) {
            return "FlingResult(packedValue=" + j + ')';
        }

        public boolean equals(Object obj) {
            return m550equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m554hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m555toStringimpl(this.packedValue);
        }
        ...
        public static final float m552getDistanceCoefficientimpl(long arg0) {
        ...
        public static final float m553getVelocityCoefficientimpl(long arg0) {
