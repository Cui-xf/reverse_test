...
public final class Arrangement {
    ...
    private static final Horizontal Start = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Start$1
        ...
        public /* synthetic */ float getSpacing() {
            return Arrangement.Horizontal.CC.m564$default$getSpacingD9Ej5fM(this);
        }
    ...
    private static final Vertical Top = new Vertical() { // from class: androidx.compose.foundation.layout.Arrangement$Top$1
        ...
        /* renamed from: getSpacing-D9Ej5fM */
        public /* synthetic */ float getSpacing() {
            return Arrangement.Vertical.CC.m574$default$getSpacingD9Ej5fM(this);
        }
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m6693constructorimpl(0);
    ...
    public interface Horizontal {
        ...
        public final /* synthetic */ class CC {
            ...
            public static float m564$default$getSpacingD9Ej5fM(Horizontal _this) {
        ...
        public static final class DefaultImpls {
            ...
            public static float m566getSpacingD9Ej5fM(Horizontal $this) {
                return CC.m564$default$getSpacingD9Ej5fM($this);
            }
        }
    }
    ...
    public interface Vertical {
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m574$default$getSpacingD9Ej5fM(Vertical _this) {
                return Dp.m6693constructorimpl(0);
            }
        }
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m576getSpacingD9Ej5fM(Vertical $this) {
                return CC.m574$default$getSpacingD9Ej5fM($this);
            }
        }
    }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m567$default$getSpacingD9Ej5fM(HorizontalOrVertical _this) {
                return Dp.m6693constructorimpl(0);
            }
        }
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m569getSpacingD9Ej5fM(HorizontalOrVertical $this) {
                return CC.m567$default$getSpacingD9Ej5fM($this);
            }
        }
    }
    ...
    public final HorizontalOrVertical m557spacedBy0680j_4(float space) {
    ...
    public final Horizontal m558spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
    ...
    /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Vertical m559spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        return new SpacedAligned(Dp.m6693constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement.aligned.1
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        return new SpacedAligned(Dp.m6693constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement.aligned.2
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4, reason: not valid java name */
        public final HorizontalOrVertical m560spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, null, 0 == true ? 1 : 0);
        }

        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Horizontal m561spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
        ...
        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Vertical m562spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            return new SpacedAligned(Dp.m6693constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                {
                    super(2);
                }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m570copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m572copy8Feqmps(f, z, function2);
        }
        ...
        public final SpacedAligned m572copy8Feqmps(float space, boolean rtlMirror, Function2<? super Integer, ? super LayoutDirection, Integer> alignment) {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m6698equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }

        public int hashCode() {
            return (((Dp.m6699hashCodeimpl(this.space) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.rtlMirror)) * 31) + (this.alignment == null ? 0 : this.alignment.hashCode());
        }
        ...
        public final float m573getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public void arrange(Density $this$arrange, int totalSize, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            int spacePx = $this$arrange.mo361roundToPx0680j_4(this.space);
            int occupied2 = 0;
            int lastSpace2 = 0;
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m6704toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
