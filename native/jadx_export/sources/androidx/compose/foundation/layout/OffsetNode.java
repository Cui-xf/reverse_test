...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo86measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelative$default($this$layout, placeable2, $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.this$0.getX()), $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default($this$layout, placeable2, $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.this$0.getX()), $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
