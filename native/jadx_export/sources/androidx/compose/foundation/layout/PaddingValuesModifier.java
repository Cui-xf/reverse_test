...
final class PaddingValuesModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo86measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        if (!(Dp.m6692compareTo0680j_4(this.paddingValues.mo632calculateLeftPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection()), Dp.m6693constructorimpl((float) 0)) >= 0 && Dp.m6692compareTo0680j_4(this.paddingValues.getTop(), Dp.m6693constructorimpl((float) 0)) >= 0 && Dp.m6692compareTo0680j_4(this.paddingValues.mo633calculateRightPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection()), Dp.m6693constructorimpl((float) 0)) >= 0 && Dp.m6692compareTo0680j_4(this.paddingValues.getBottom(), Dp.m6693constructorimpl((float) 0)) >= 0)) {
            throw new IllegalArgumentException("Padding must be non-negative".toString());
        }
        int horizontal = $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.paddingValues.mo632calculateLeftPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection())) + $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.paddingValues.mo633calculateRightPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection()));
        int vertical = $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.paddingValues.getTop()) + $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.paddingValues.getBottom());
        final Placeable placeable = measurable.mo5535measureBRTryo0(ConstraintsKt.m6655offsetNN6EwU(constraints, -horizontal, -vertical));
        int width = ConstraintsKt.m6653constrainWidthK40F9xA(constraints, placeable.getWidth() + horizontal);
        int height = ConstraintsKt.m6652constrainHeightK40F9xA(constraints, placeable.getHeight() + vertical);
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingValuesModifier$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                Placeable.PlacementScope.place$default($this$layout, placeable, $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.getPaddingValues().mo632calculateLeftPaddingu2uoSUM($this$measure_u2d3p2s80s.getLayoutDirection())), $this$measure_u2d3p2s80s.mo361roundToPx0680j_4(this.getPaddingValues().getTop()), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
