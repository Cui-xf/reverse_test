...
public final /* data */ class RowColumnParentData {
    ...
    public int hashCode() {
        return (((((Float.floatToIntBits(this.weight) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.fill)) * 31) + (this.crossAxisAlignment == null ? 0 : this.crossAxisAlignment.hashCode())) * 31) + (this.flowLayoutData != null ? this.flowLayoutData.hashCode() : 0);
    }
