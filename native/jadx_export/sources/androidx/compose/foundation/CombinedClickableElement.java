...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNodeImpl> {
    ...
    public void update(CombinedClickableNodeImpl node) {
        node.mo279updatenSzSaCc(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role);
    }
    ...
    public int hashCode() {
        ...
        int result3 = ((result2 * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.enabled)) * 31;
        String str = this.onClickLabel;
        int result4 = (result3 + (str != null ? str.hashCode() : 0)) * 31;
        Role role = this.role;
        int result5 = (((result4 + (role != null ? Role.m5953hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
