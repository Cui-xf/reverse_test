        ...
        return ComposedModifierKt.composed($this$heightInLines, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM6178getFontStyle4Lr2A7w = resolvedStyle.m6178getFontStyle4Lr2A7w();
                    ...
                    value$iv2 = fontFamilyResolver.mo6232resolveDPcqOEQ(fontFamily, fontWeight2, iM6261unboximpl, fontSynthesisM6179getFontSynthesisZQGJjVo != null ? fontSynthesisM6179getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m6275getAllGVVA2EU());
                ...
                if (invalid$iv3 || it$iv3 == Composer.INSTANCE.getEmpty()) {
                    value$iv3 = Integer.valueOf(IntSize.m6866getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (invalid$iv4 || it$iv4 == Composer.INSTANCE.getEmpty()) {
                    ...
                    value$iv4 = Integer.valueOf(IntSize.m6866getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, twoLines, 2)));
                ...
                Modifier modifierM713heightInVpY3zN4 = SizeKt.m713heightInVpY3zN4(Modifier.INSTANCE, precomputedMinLinesHeight != null ? density.mo364toDpu2uoSUM(precomputedMinLinesHeight.intValue()) : Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM(), precomputedMaxLinesHeight != null ? density.mo364toDpu2uoSUM(precomputedMaxLinesHeight.intValue()) : Dp.INSTANCE.m6713getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceGroup();
