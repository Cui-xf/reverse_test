...
final class TextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        if ($this$fastMapIndexedNotNull$iv2 != null) {
            ...
            while (index$iv$iv2 < size2) {
                ...
                if (rect != null) {
                    ...
                    Placeable placeableMo5535measureBRTryo0 = ((Measurable) inlineContentMeasurables2.get(index$iv)).mo5535measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null));
                    ...
                    pair = new Pair(placeableMo5535measureBRTryo0, IntOffset.m6816boximpl(IntOffsetKt.IntOffset(iRound, Math.round($this$fastRoundToInt$iv2))));
                } else {
                    inlineContentMeasurables = inlineContentMeasurables2;
                    $this$fastMapIndexedNotNull$iv = $this$fastMapIndexedNotNull$iv2;
                    $i$f$fastMapIndexedNotNull = $i$f$fastMapIndexedNotNull2;
        ...
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, Constraints.m6636getMaxWidthimpl(constraints), Constraints.m6635getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                for (int index$iv3 = 0; index$iv3 < size5; index$iv3++) {
                    ...
                    Placeable.PlacementScope.m5605place70tqf50$default($this$layout, placeable2, measureResult != null ? measureResult.invoke().getPackedValue() : IntOffset.INSTANCE.m6835getZeronOccac(), 0.0f, 2, null);
                }
            }
        }, 4, null);
    }
