...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, final List<? extends Measurable> list, long constraints) {
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, Constraints.m6636getMaxWidthimpl(constraints), Constraints.m6635getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                for (int index$iv = 0; index$iv < size; index$iv++) {
                    ...
                    Placeable.PlacementScope.m5605place70tqf50$default($this$layout, placeable, measureResult != null ? ((IntOffset) measureResult.invoke()).getPackedValue() : IntOffset.INSTANCE.m6835getZeronOccac(), 0.0f, 2, null);
                }
            }
        }, 4, null);
    }
