...
public final class KeyboardActions {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardActions) && this.onDone == ((KeyboardActions) other).onDone && this.onGo == ((KeyboardActions) other).onGo && this.onNext == ((KeyboardActions) other).onNext && this.onPrevious == ((KeyboardActions) other).onPrevious && this.onSearch == ((KeyboardActions) other).onSearch && this.onSend == ((KeyboardActions) other).onSend;
    }
