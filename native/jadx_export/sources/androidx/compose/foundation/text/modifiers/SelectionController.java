...
public final class SelectionController implements RememberObserver {
    ...
    public final void draw(DrawScope drawScope) throws Throwable {
        ...
        if (!this.params.getShouldClip()) {
            DrawScope.CC.m4743drawPathLG529CI$default(drawScope, selectionPath, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
            return;
        }
        float right$iv = Size.m4014getWidthimpl(drawScope.mo4662getSizeNHjbRc());
        float bottom$iv = Size.m4011getHeightimpl(drawScope.mo4662getSizeNHjbRc());
        ...
        long previousSize$iv$iv = $this$withTransform_u24lambda_u246$iv$iv2.mo4669getSizeNHjbRc();
