...
public final class MinLinesConstrainer {
    ...
    public final long m1304coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        int minHeight;
        ...
        if (Float.isNaN(oneLineHeight) || Float.isNaN(lineHeight)) {
            oneLineHeight = ParagraphKt.m6028ParagraphUdtVg6A(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & 256) != 0 ? false : false).getHeight();
            float twoLineHeight = ParagraphKt.m6028ParagraphUdtVg6A(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? false : false).getHeight();
        ...
        if (minLines != 1) {
            ...
            minHeight = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round($this$fastRoundToInt$iv), 0), Constraints.m6635getMaxHeightimpl(inConstraints));
        } else {
            minHeight = Constraints.m6637getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m6638getMinWidthimpl(inConstraints), Constraints.m6636getMaxWidthimpl(inConstraints), minHeight, Constraints.m6635getMaxHeightimpl(inConstraints));
    }
}
