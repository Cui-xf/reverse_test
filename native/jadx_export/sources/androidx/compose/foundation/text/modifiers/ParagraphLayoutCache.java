...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        ...
        this.lastDensity = InlineDensity.INSTANCE.m1300getUnspecifiedL26CHvs();
        this.layoutSize = IntSizeKt.IntSize(0, 0);
        this.prevConstraints = Constraints.INSTANCE.m6646fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6599getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation_release(Density value) {
        ...
        long newDensity = value != null ? InlineDensity.m1292constructorimpl(value) : InlineDensity.INSTANCE.m1300getUnspecifiedL26CHvs();
        if (localField == null) {
            this.density = value;
            this.lastDensity = newDensity;
        } else if (value == null || !InlineDensity.m1294equalsimpl0(this.lastDensity, newDensity)) {
            this.density = value;
            this.lastDensity = newDensity;
            markDirty();
        }
    ...
    public final void m1316setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m1315layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            finalConstraints = localMin.m1304coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        } else {
            layoutDirection2 = layoutDirection;
            finalConstraints = constraints;
        }
        boolean z2 = false;
        if (!m1313newLayoutWillBeDifferentK40F9xA(finalConstraints, layoutDirection2)) {
            if (!Constraints.m6629equalsimpl0(finalConstraints, this.prevConstraints)) {
                ...
                long localSize = ConstraintsKt.m6650constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(layoutWidth), TextDelegateKt.ceilToIntPx(localParagraph.getHeight())));
                this.layoutSize = localSize;
                if (TextOverflow.m6592equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6601getVisiblegIe3tQ8()) || (IntSize.m6867getWidthimpl(localSize) >= localParagraph.getWidth() && IntSize.m6866getHeightimpl(localSize) >= localParagraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        Paragraph it = m1312layoutTextK40F9xA(finalConstraints, layoutDirection2);
        this.prevConstraints = finalConstraints;
        long localSize2 = ConstraintsKt.m6650constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(it.getWidth()), TextDelegateKt.ceilToIntPx(it.getHeight())));
        this.layoutSize = localSize2;
        if (!TextOverflow.m6592equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6601getVisiblegIe3tQ8()) && (IntSize.m6867getWidthimpl(localSize2) < it.getWidth() || IntSize.m6866getHeightimpl(localSize2) < it.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = it;
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int result = TextDelegateKt.ceilToIntPx(m1312layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m1317updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
        this.fontFamilyResolver = fontFamilyResolver;
        this.overflow = overflow;
    ...
    private final Paragraph m1312layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics localParagraphIntrinsics = setLayoutDirection(layoutDirection);
        return ParagraphKt.m6030Paragraph_EkL_Y(localParagraphIntrinsics, LayoutUtilsKt.m1301finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m1302finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m6592equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6600getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m1313newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m6629equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m6636getMaxWidthimpl(constraints) != Constraints.m6636getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m6635getMaxHeightimpl(constraints)) < localParagraph.getHeight() || localParagraph.getDidExceedMaxLines();
    }
    ...
    public String toString() {
        return "ParagraphLayoutCache(paragraph=" + (this.paragraph != null ? "<paragraph>" : "null") + ", lastDensity=" + ((Object) InlineDensity.m1298toStringimpl(this.lastDensity)) + ')';
    }
}
