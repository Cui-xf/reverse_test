...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m1323updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        ...
        if (!TextOverflow.m6592equalsimpl0(this.overflow, overflow)) {
            this.overflow = overflow;
            return true;
        }
        return changed;
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m1311updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
        }
        if (!getIsAttached()) {
            return;
        }
    ...
    public static final /* data */ class TextSubstitutionValue {
        ...
        public int hashCode() {
            return (((((this.original.hashCode() * 31) + this.substitution.hashCode()) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isShowingSubstitution)) * 31) + (this.layoutCache == null ? 0 : this.layoutCache.hashCode());
        }
    ...
    public final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (currentTextSubstitution != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1311updateZNqEYIc(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
                ...
                */
                public final java.lang.Boolean invoke(java.util.List<androidx.compose.ui.text.TextLayoutResult> r38) {
                    ...
                    L31:
                        ...
                        r33 = 0
                        r34 = 0
                        androidx.compose.ui.text.TextStyle r5 = androidx.compose.ui.text.TextStyle.m6166mergedA7vx0o$default(r5, r6, r8, r10, r11, r12, r13, r14, r15, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r36)
                        androidx.compose.ui.text.TextLayoutInput r1 = r2.getLayoutInput()
                        ...
                        r7 = 0
                        r4 = 0
                        androidx.compose.ui.text.TextLayoutResult r1 = androidx.compose.ui.text.TextLayoutResult.m6116copyO0kMr_c$default(r2, r3, r4, r6, r7)
                        if (r1 == 0) goto Lbb
                    Lb2:
                        r3 = r1
                        r4 = 0
    ...
    public final MeasureResult m1322measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo86measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo86measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        boolean didChangeLayout = layoutCache.m1310layoutWithConstraintsK40F9xA(constraints, $this$measure_u2d3p2s80s.getLayoutDirection());
        ...
        final Placeable placeable = measurable.mo5535measureBRTryo0(Constraints.INSTANCE.m6645fitPrioritizingWidthZbe2FdA(IntSize.m6867getWidthimpl(textLayoutResult.getSize()), IntSize.m6867getWidthimpl(textLayoutResult.getSize()), IntSize.m6866getHeightimpl(textLayoutResult.getSize()), IntSize.m6866getHeightimpl(textLayoutResult.getSize())));
        int iM6867getWidthimpl = IntSize.m6867getWidthimpl(textLayoutResult.getSize());
        int iM6866getHeightimpl = IntSize.m6866getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return $this$measure_u2d3p2s80s.layout(iM6867getWidthimpl, iM6866getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope $this$draw) throws Throwable {
        ...
        boolean willClip = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m6592equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6601getVisiblegIe3tQ8());
        if (willClip) {
            ...
            Rect bounds = RectKt.m3985Recttz77jQw(Offset.INSTANCE.m3961getZeroF1C5BW0(), SizeKt.Size(width, height));
            canvas.save();
            Canvas.CC.m4161clipRectmtrdDE$default(canvas, bounds, 0, 2, null);
        }
        try {
            ...
            if (brush == null) {
                ...
                long $this$isSpecified$iv = colorProducer != null ? colorProducer.mo1537invoke0d7_KjU() : Color.INSTANCE.m4223getUnspecified0d7_KjU();
                long overrideColorVal = $this$isSpecified$iv;
                if ($this$isSpecified$iv != 16) {
                    color = overrideColorVal;
                } else {
                    if (this.style.m6176getColor0d7_KjU() != 16) {
                        color = this.style.m6176getColor0d7_KjU();
                    } else {
                        color = Color.INSTANCE.m4213getBlack0d7_KjU();
                    }
                }
                localParagraph.m6015paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m4223getUnspecified0d7_KjU() : color, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m4751getDefaultBlendMode0nO6VwU() : 0);
            } else {
                float alpha = this.style.getAlpha();
                z = true;
                localParagraph.m6017painthn5TExg(canvas, brush, (64 & 4) != 0 ? Float.NaN : alpha, (64 & 8) != 0 ? null : shadow2, (64 & 16) != 0 ? null : textDecoration2, (64 & 32) != 0 ? null : drawStyle2, (64 & 64) != 0 ? DrawScope.INSTANCE.m4751getDefaultBlendMode0nO6VwU() : 0);
            }
            TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
            if (textSubstitutionValue != null && textSubstitutionValue.isShowingSubstitution() == z) {
                hasLinks = false;
            } else {
