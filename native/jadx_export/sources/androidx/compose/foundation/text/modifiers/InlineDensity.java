...
public final class InlineDensity {
    ...
    private static final long Unspecified = m1290constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1289boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static long m1291constructorimpl(long j) {
        return j;
    }
    ...
    public static int m1297hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m1297hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1290constructorimpl(float density, float fontScale) {
        long v1$iv = Float.floatToRawIntBits(density);
        long v2$iv = Float.floatToRawIntBits(fontScale);
        return m1291constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1292constructorimpl(Density density) {
        return m1290constructorimpl(density.getDensity(), density.getFontScale());
    }

    /* renamed from: getDensity-impl, reason: not valid java name */
    public static final float m1295getDensityimpl(long arg0) {
        int bits$iv$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: getFontScale-impl, reason: not valid java name */
    public static final float m1296getFontScaleimpl(long arg0) {
    ...
    public static String m1298toStringimpl(long arg0) {
        return "InlineDensity(density=" + m1295getDensityimpl(arg0) + ", fontScale=" + m1296getFontScaleimpl(arg0) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1300getUnspecifiedL26CHvs() {
