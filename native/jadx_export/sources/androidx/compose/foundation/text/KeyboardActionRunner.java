...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m1005runActionKlQnJC8(int imeAction) {
        Function1 keyboardAction;
        Unit unit = null;
        if (ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6327getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6326getDefaulteUduSuo()) ? true : ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6330getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo1004defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    @Override // androidx.compose.foundation.text.KeyboardActionScope
    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void mo1004defaultKeyboardActionKlQnJC8(int imeAction) {
        if (!ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6329getNexteUduSuo())) {
            if (!ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6331getPreviouseUduSuo())) {
                if (!ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6327getDoneeUduSuo())) {
                    if (ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6328getGoeUduSuo()) ? true : ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6332getSearcheUduSuo()) ? true : ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6333getSendeUduSuo()) ? true : ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6326getDefaulteUduSuo())) {
                        return;
                    }
                    ImeAction.m6313equalsimpl0(imeAction, ImeAction.INSTANCE.m6330getNoneeUduSuo());
                    return;
                } else {
            ...
            getFocusManager().mo3872moveFocus3ESFkO8(FocusDirection.INSTANCE.m3868getPreviousdhqQ8s());
            return;
        }
        getFocusManager().mo3872moveFocus3ESFkO8(FocusDirection.INSTANCE.m3867getNextdhqQ8s());
    }
}
