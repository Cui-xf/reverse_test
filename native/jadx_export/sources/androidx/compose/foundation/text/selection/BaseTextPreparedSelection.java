...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final void m1328setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            $this$deselect_u24lambda_u241.setCursor(TextRange.m6141getEndimpl($this$deselect_u24lambda_u241.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m6140getCollapsedimpl($this$collapseLeftOr_u24lambda_u244.selection)) {
                ...
                boolean zIsLtr = $this$collapseLeftOr_u24lambda_u244.isLtr();
                long j = $this$collapseLeftOr_u24lambda_u244.selection;
                if (zIsLtr) {
                    $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m6144getMinimpl(j));
                } else {
                    $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m6143getMaximpl(j));
                }
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
    ...
    public final T collapseRightOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m6140getCollapsedimpl($this$collapseRightOr_u24lambda_u245.selection)) {
                ...
                boolean zIsLtr = $this$collapseRightOr_u24lambda_u245.isLtr();
                long j = $this$collapseRightOr_u24lambda_u245.selection;
                if (zIsLtr) {
                    $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m6143getMaximpl(j));
                } else {
                    $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m6144getMinimpl(j));
                }
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m6141getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m6141getEndimpl(this.selection));
    }
    ...
    public final T moveCursorPrevByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            int paragraphStart = StringHelpersKt.findParagraphStart($this$moveCursorPrevByParagraph_u24lambda_u2416.getText$foundation_release(), TextRange.m6144getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2416.selection));
            if (paragraphStart == TextRange.m6144getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2416.selection) && paragraphStart != 0) {
    ...
    public final T moveCursorNextByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            int paragraphEnd = StringHelpersKt.findParagraphEnd($this$moveCursorNextByParagraph_u24lambda_u2417.getText$foundation_release(), TextRange.m6143getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2417.selection));
            if (paragraphEnd == TextRange.m6143getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2417.selection) && paragraphEnd != $this$moveCursorNextByParagraph_u24lambda_u2417.getText$foundation_release().length()) {
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            ...
            $this$selectMovement_u24lambda_u2428.selection = TextRangeKt.TextRange(TextRange.m6146getStartimpl($this$selectMovement_u24lambda_u2428.originalSelection), TextRange.m6141getEndimpl($this$selectMovement_u24lambda_u2428.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.originalText.length()) {
            ...
            if (TextRange.m6141getEndimpl(currentWord) <= currentOffset) {
                ...
                return this.offsetMapping.transformedToOriginal(TextRange.m6141getEndimpl(currentWord));
            }
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult $this$getPrevWordOffset, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffset.m6120getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6146getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m6146getStartimpl(currentWord));
            }
        }
        return 0;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        ...
        if ((!isLtr() || it < $this$jumpByLinesOffset.getLineRight(targetLine)) && (isLtr() || it > $this$jumpByLinesOffset.getLineLeft(targetLine))) {
            ...
            return this.offsetMapping.transformedToOriginal($this$jumpByLinesOffset.m6118getOffsetForPositionk4lQ0M(OffsetKt.Offset(x, y)));
        }
        return $this$jumpByLinesOffset.getLineEnd(targetLine, true);
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6141getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6144getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6143getMaximpl(this.selection));
    }
