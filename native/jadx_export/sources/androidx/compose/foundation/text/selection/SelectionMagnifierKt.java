...
public final class SelectionMagnifierKt {
    ...
    private static final TwoWayConverter<Offset, AnimationVector2D> UnspecifiedSafeOffsetVectorConverter = VectorConvertersKt.TwoWayConverter(new Function1<Offset, AnimationVector2D>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1
        ...
        public final AnimationVector2D m1348invokek4lQ0M(long it) {
            if (!OffsetKt.m3964isSpecifiedk4lQ0M(it)) {
        ...
        public /* bridge */ /* synthetic */ Offset invoke(AnimationVector2D animationVector2D) {
            return Offset.m3934boximpl(m1349invoketuRUvjQ(animationVector2D));
        }
    ...
    private static final SpringSpec<Offset> MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m3934boximpl(OffsetDisplacementThreshold), 3, null);
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$animatedSelectionMagnifier$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3934boximpl(m1350invokeF1C5BW0());
                    }
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer $composer, int $changed) {
        ...
        if (it$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv2 = new Animatable(Offset.m3934boximpl(rememberAnimatedMagnifierPosition$lambda$1(targetValue$delegate)), UnspecifiedSafeOffsetVectorConverter, Offset.m3934boximpl(OffsetDisplacementThreshold), null, 8, null);
