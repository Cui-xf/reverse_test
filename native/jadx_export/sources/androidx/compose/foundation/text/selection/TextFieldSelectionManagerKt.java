...
public final class TextFieldSelectionManagerKt {
    ...
    public static final void TextFieldSelectionHandle(boolean isStartHandle, final ResolvedTextDirection direction, final TextFieldSelectionManager manager, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 147) != 146 || !$composer2.getSkipping()) {
            ...
            if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
                value$iv2 = new OffsetProvider() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$TextFieldSelectionHandle$1$1
                    ...
                    public final long mo977provideF1C5BW0() {
                        return manager.m1403getHandlePositiontuRUvjQ$foundation_release(z);
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            boolean zM6145getReversedimpl = TextRange.m6145getReversedimpl(manager.getValue$foundation_release().getSelection());
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            z = isStartHandle;
            AndroidSelectionHandles_androidKt.m1325SelectionHandlepzduO1o(offsetProvider, z, direction, zM6145getReversedimpl, 0L, SuspendingPointerInputFilterKt.pointerInput(companion, observer, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv3), $composer2, (($dirty2 << 3) & 112) | (($dirty2 << 3) & 896), 16);
            if (ComposerKt.isTraceInProgress()) {
