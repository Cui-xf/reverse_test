...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.INSTANCE.m3961getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo1066onStartk4lQ0M(long startPoint) {
                ...
                if (this.this$0.getEnabled() && this.this$0.getDraggingHandle() == null) {
                    ...
                    boolean z = (state == null || (layoutResult2 = state.getLayoutResult()) == null || !layoutResult2.m1098isPositionOnTextk4lQ0M(startPoint)) ? false : true;
                    ...
                    if (!z) {
                        ...
                        if (state2 != null && (layoutResult = state2.getLayoutResult()) != null) {
                            ...
                            int transformedOffset = TextLayoutResultProxy.m1096getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null);
                            int offset = textFieldSelectionManager2.getOffsetMapping().transformedToOriginal(transformedOffset);
                            TextFieldValue newValue = textFieldSelectionManager2.m1395createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getText(), TextRangeKt.TextRange(offset, offset));
                        ...
                        long adjustedStartSelection = this.this$0.m1398updateSelection8UEBfa8(TextFieldValue.m6390copy3r_uNRQ$default(this.this$0.getValue$foundation_release(), (AnnotatedString) null, TextRange.INSTANCE.m6151getZerod9O1mEE(), (TextRange) null, 5, (Object) null), startPoint, true, false, SelectionAdjustment.INSTANCE.getWord(), true);
                        this.this$0.dragBeginOffsetInText = Integer.valueOf(TextRange.m6146getStartimpl(adjustedStartSelection));
                    }
                    this.this$0.setHandleState(HandleState.None);
                    this.this$0.dragBeginPosition = startPoint;
                    this.this$0.m1397setCurrentDragPosition_kEHs6E(Offset.m3934boximpl(this.this$0.dragBeginPosition));
                    this.this$0.dragTotalDistance = Offset.INSTANCE.m3961getZeroF1C5BW0();
                }
            }
            ...
            public void mo1065onDragk4lQ0M(long delta) {
                TextLayoutResultProxy layoutResult;
                TextLayoutResultProxy layoutResult2;
                long jM1398updateSelection8UEBfa8;
                ...
                if (this.this$0.getEnabled()) {
                    ...
                    TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                    textFieldSelectionManager.dragTotalDistance = Offset.m3950plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                    LegacyTextFieldState state = this.this$0.getState();
                    if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                        TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                        textFieldSelectionManager2.m1397setCurrentDragPosition_kEHs6E(Offset.m3934boximpl(Offset.m3950plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                        if (textFieldSelectionManager2.dragBeginOffsetInText != null) {
                            ...
                            if (layoutResult.m1098isPositionOnTextk4lQ0M(offsetM1401getCurrentDragPosition_m7T9E.getPackedValue())) {
                                layoutResult2 = layoutResult;
                            } else {
                                int startOffset = textFieldSelectionManager2.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.m1096getOffsetForPosition3MmeM6k$default(layoutResult, textFieldSelectionManager2.dragBeginPosition, false, 2, null));
                                OffsetMapping offsetMapping = textFieldSelectionManager2.getOffsetMapping();
                                Offset offsetM1401getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m1401getCurrentDragPosition_m7T9E();
                                Intrinsics.checkNotNull(offsetM1401getCurrentDragPosition_m7T9E2);
                                int endOffset = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1096getOffsetForPosition3MmeM6k$default(layoutResult, offsetM1401getCurrentDragPosition_m7T9E2.getPackedValue(), false, 2, null));
                                ...
                                Offset offsetM1401getCurrentDragPosition_m7T9E3 = textFieldSelectionManager2.m1401getCurrentDragPosition_m7T9E();
                                Intrinsics.checkNotNull(offsetM1401getCurrentDragPosition_m7T9E3);
                                jM1398updateSelection8UEBfa8 = textFieldSelectionManager2.m1398updateSelection8UEBfa8(value$foundation_release, offsetM1401getCurrentDragPosition_m7T9E3.getPackedValue(), false, false, adjustment, true);
                                TextRange.m6134boximpl(jM1398updateSelection8UEBfa8);
                            }
                        }
                        Integer num = textFieldSelectionManager2.dragBeginOffsetInText;
                        int startOffset2 = num != null ? num.intValue() : layoutResult2.m1097getOffsetForPosition3MmeM6k(textFieldSelectionManager2.dragBeginPosition, false);
                        Offset offsetM1401getCurrentDragPosition_m7T9E4 = textFieldSelectionManager2.m1401getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM1401getCurrentDragPosition_m7T9E4);
                        int endOffset2 = layoutResult2.m1097getOffsetForPosition3MmeM6k(offsetM1401getCurrentDragPosition_m7T9E4.getPackedValue(), false);
                        if (textFieldSelectionManager2.dragBeginOffsetInText == null && startOffset2 == endOffset2) {
                            return;
                        }
                        TextFieldValue value$foundation_release2 = textFieldSelectionManager2.getValue$foundation_release();
                        Offset offsetM1401getCurrentDragPosition_m7T9E5 = textFieldSelectionManager2.m1401getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM1401getCurrentDragPosition_m7T9E5);
                        jM1398updateSelection8UEBfa8 = textFieldSelectionManager2.m1398updateSelection8UEBfa8(value$foundation_release2, offsetM1401getCurrentDragPosition_m7T9E5.getPackedValue(), false, false, SelectionAdjustment.INSTANCE.getWord(), true);
                        TextRange.m6134boximpl(jM1398updateSelection8UEBfa8);
                    }
            ...
            private final void onEnd() {
                ...
                boolean collapsed = TextRange.m6140getCollapsedimpl(this.this$0.getValue$foundation_release().getSelection());
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo1274onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                LegacyTextFieldState state;
                if (this.this$0.getEnabled()) {
                    if (!(this.this$0.getValue$foundation_release().getText().length() == 0) && (state = this.this$0.getState()) != null && state.getLayoutResult() != null) {
            ...
            public final void updateMouseSelection(TextFieldValue value, long currentPosition, boolean isStartOfSelection, SelectionAdjustment adjustment) {
                ...
                this.this$0.setHandleState(TextRange.m6140getCollapsedimpl(newSelection) ? HandleState.Cursor : HandleState.Selection);
            }
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo1064onDownk4lQ0M(long point) {
                ...
                long translatedPosition = layoutResult.m1100translateInnerToDecorationCoordinatesMKHz9U$foundation_release(handleCoordinates);
                this.this$0.dragBeginPosition = translatedPosition;
                this.this$0.m1397setCurrentDragPosition_kEHs6E(Offset.m3934boximpl(translatedPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m3961getZeroF1C5BW0();
                this.this$0.previousRawDragOffset = -1;
                LegacyTextFieldState state2 = this.this$0.getState();
                if (state2 != null) {
            ...
            public void mo1065onDragk4lQ0M(long delta) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m3950plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                this.this$0.m1397setCurrentDragPosition_kEHs6E(Offset.m3934boximpl(Offset.m3950plusMKHz9U(this.this$0.dragBeginPosition, this.this$0.dragTotalDistance)));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
        ...
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo1065onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    Offset offsetM1401getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m1401getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(offsetM1401getCurrentDragPosition_m7T9E);
                    int offset = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1096getOffsetForPosition3MmeM6k$default(layoutResult, offsetM1401getCurrentDragPosition_m7T9E.getPackedValue(), false, 2, null));
                    long newSelection = TextRangeKt.TextRange(offset, offset);
                    if (TextRange.m6139equalsimpl0(newSelection, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                        return;
                    }
    ...
    */
    public final void m1400deselect_kEHs6E$foundation_release(androidx.compose.ui.geometry.Offset r10) {
        /*
            ...
            boolean r0 = androidx.compose.ui.text.TextRange.m6140getCollapsedimpl(r0)
            if (r0 != 0) goto L51
        ...
        L18:
            ...
            r6 = 0
            r4 = 0
            int r2 = androidx.compose.foundation.text.TextLayoutResultProxy.m1096getOffsetForPosition3MmeM6k$default(r1, r2, r4, r5, r6)
            int r0 = r0.transformedToOriginal(r2)
            goto L3b
        L2f:
            androidx.compose.ui.text.input.TextFieldValue r0 = r9.getValue$foundation_release()
            long r2 = r0.getSelection()
            int r0 = androidx.compose.ui.text.TextRange.m6143getMaximpl(r2)
        L3b:
            ...
            r3 = 0
            r6 = 0
            androidx.compose.ui.text.input.TextFieldValue r2 = androidx.compose.ui.text.input.TextFieldValue.m6390copy3r_uNRQ$default(r2, r3, r4, r6, r7, r8)
    ...
    public final void m1405setSelectionPreviewHighlight5zctL8$foundation_release(long range) {
        ...
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1027setSelectionPreviewHighlightRange5zctL8(range);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1024setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6151getZerod9O1mEE());
        }
    ...
    public final void m1404setDeletionPreviewHighlight5zctL8$foundation_release(long range) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1024setDeletionPreviewHighlightRange5zctL8(range);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1027setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6151getZerod9O1mEE());
        }
        if (!TextRange.m6140getCollapsedimpl(range)) {
            exitSelectionMode$foundation_release();
        }
    ...
    public final void clearPreviewHighlight$foundation_release() {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1024setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6151getZerod9O1mEE());
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 == null) {
            return;
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        if (TextRange.m6140getCollapsedimpl(getValue$foundation_release().getSelection())) {
            return;
        }
        ...
        if (cancelSelection) {
            int newCursorOffset = TextRange.m6143getMaximpl(getValue$foundation_release().getSelection());
    ...
    public final void paste$foundation_release() {
        ...
        int newCursorOffset = TextRange.m6144getMinimpl(getValue$foundation_release().getSelection()) + text.length();
    ...
    public final void cut$foundation_release() {
        ...
        int newCursorOffset = TextRange.m6144getMinimpl(getValue$foundation_release().getSelection());
        TextFieldValue newValue = m1395createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
        this.onValueChange.invoke(newValue);
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
    ...
    public final void selectAll$foundation_release() {
        ...
        this.onValueChange.invoke(newValue);
        this.oldValue = TextFieldValue.m6390copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, newValue.getSelection(), (TextRange) null, 5, (Object) null);
    ...
    public final long m1403getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        ...
        int offset = isStartHandle ? TextRange.m6146getStartimpl(selection) : TextRange.m6141getEndimpl(selection);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(textLayoutResult, this.offsetMapping.originalToTransformed(offset), isStartHandle, TextRange.m6145getReversedimpl(getValue$foundation_release().getSelection()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m1402getCursorPositiontuRUvjQ$foundation_release(Density density) {
        int offset = this.offsetMapping.originalToTransformed(TextRange.m6146getStartimpl(getValue$foundation_release().getSelection()));
        LegacyTextFieldState legacyTextFieldState = this.state;
        ...
        float x = cursorRect.getLeft() + (density.mo367toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2.0f);
    ...
    */
    public final void showSelectionToolbar$foundation_release() {
        ...
        L19:
            ...
            boolean r3 = androidx.compose.ui.text.TextRange.m6140getCollapsedimpl(r3)
            r4 = 0
            if (r3 != 0) goto L36
            if (r0 != 0) goto L36
        ...
        L37:
            ...
            boolean r3 = androidx.compose.ui.text.TextRange.m6140getCollapsedimpl(r5)
            if (r3 != 0) goto L57
        ...
        L77:
            ...
            int r1 = androidx.compose.ui.text.TextRange.m6142getLengthimpl(r1)
    ...
    public final void m1399contextMenuOpenAdjustmentk4lQ0M(long position) {
        ...
        if (legacyTextFieldState != null && (layoutResult = legacyTextFieldState.getLayoutResult()) != null) {
            int offset = TextLayoutResultProxy.m1096getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
            if (!TextRange.m6137containsimpl(getValue$foundation_release().getSelection(), offset)) {
                this.previousRawDragOffset = -1;
    ...
    private final Rect getContentRect() {
        ...
        if (it != null) {
            ...
            if (it != null) {
                int transformedStart = this.offsetMapping.originalToTransformed(TextRange.m6146getStartimpl(getValue$foundation_release().getSelection()));
                int transformedEnd = this.offsetMapping.originalToTransformed(TextRange.m6141getEndimpl(getValue$foundation_release().getSelection()));
                LegacyTextFieldState legacyTextFieldState = this.state;
                long startOffset = (legacyTextFieldState == null || (layoutCoordinates4 = legacyTextFieldState.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m3961getZeroF1C5BW0() : layoutCoordinates4.mo5540localToRootMKHz9U(m1403getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState legacyTextFieldState2 = this.state;
                long endOffset = (legacyTextFieldState2 == null || (layoutCoordinates3 = legacyTextFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m3961getZeroF1C5BW0() : layoutCoordinates3.mo5540localToRootMKHz9U(m1403getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (legacyTextFieldState3 == null || (layoutCoordinates2 = legacyTextFieldState3.getLayoutCoordinates()) == null) {
                    ...
                    startTop = Offset.m3946getYimpl(layoutCoordinates2.mo5540localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(transformedStart)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (legacyTextFieldState4 != null && (layoutCoordinates = legacyTextFieldState4.getLayoutCoordinates()) != null) {
                    ...
                    endTop = Offset.m3946getYimpl(layoutCoordinates.mo5540localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(transformedEnd)) == null) ? 0.0f : cursorRect.getTop())));
                }
                float left = Math.min(Offset.m3945getXimpl(startOffset), Offset.m3945getXimpl(endOffset));
                float right = Math.max(Offset.m3945getXimpl(startOffset), Offset.m3945getXimpl(endOffset));
                float top = Math.min(startTop, endTop);
                float bottom = Math.max(Offset.m3946getYimpl(startOffset), Offset.m3946getYimpl(endOffset)) + (Dp.m6693constructorimpl(25) * it.getTextDelegate().getDensity().getDensity());
