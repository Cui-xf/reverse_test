...
public final class AndroidSelectionHandles_androidKt {
    ...
    */
    public static final void m1325SelectionHandlepzduO1o(final androidx.compose.foundation.text.selection.OffsetProvider r18, final boolean r19, androidx.compose.ui.text.style.ResolvedTextDirection r20, boolean r21, long r22, final androidx.compose.ui.Modifier r24, androidx.compose.runtime.Composer r25, final int r26, final int r27) {
        /*
            Method dump skipped, instructions count: 481
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.m1325SelectionHandlepzduO1o(androidx.compose.foundation.text.selection.OffsetProvider, boolean, androidx.compose.ui.text.style.ResolvedTextDirection, boolean, long, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
                ...
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope $this$drawWithCache) {
                            float radius = Size.m4014getWidthimpl($this$drawWithCache.m3835getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap handleImage = AndroidSelectionHandles_androidKt.createHandleImage($this$drawWithCache, radius);
                            final ColorFilter colorFilter = ColorFilter.Companion.m4228tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            ...
                            return $this$drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope $this$onDrawWithContent) throws Throwable {
                                    ...
                                    if (z2) {
                                        ...
                                        long pivot$iv = $this$scale_u2dFgt4K4Q_u24default$iv.mo4661getCenterF1C5BW0();
                                        ...
                                        try {
                                            ...
                                            try {
                                                DrawScope.CC.m4737drawImagegbVJVH8$default($this$scale_u2dFgt4K4Q_u24default$iv, imageBitmap, 0L, 0.0f, null, colorFilter2, 0, 46, null);
                                        ...
                                        DrawScope.CC.m4737drawImagegbVJVH8$default($this$onDrawWithContent, handleImage, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                    }
                                }
                            });
                        }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope $this$createHandleImage, float radius) {
        ...
        if (imageBitmap2 == null || canvas2 == null || edge2 > imageBitmap2.getWidth() || edge2 > imageBitmap2.getHeight()) {
            ImageBitmap imageBitmap3 = ImageBitmapKt.m4419ImageBitmapx__hDU$default(edge2, edge2, ImageBitmapConfig.INSTANCE.m4413getAlpha8_sVssgQ(), false, null, 24, null);
            edge = edge2;
        ...
        DrawScope.CC.m4747drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u241, Color.INSTANCE.m4213getBlack0d7_KjU(), 0L, $this$createHandleImage_u24lambda_u241.mo4662getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m4102getClear0nO6VwU(), 58, null);
        DrawScope.CC.m4747drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u241, ColorKt.Color(4278190080L), Offset.INSTANCE.m3961getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(radius, radius), 0.0f, null, null, 0, 120, null);
        ImageBitmap imageBitmap4 = imageBitmap;
        Canvas prevCanvas$iv2 = canvas;
        DrawScope.CC.m4734drawCircleVaOC9Bg$default($this$createHandleImage_u24lambda_u241, ColorKt.Color(4278190080L), radius, OffsetKt.Offset(radius, radius), 0.0f, null, null, 0, 120, null);
