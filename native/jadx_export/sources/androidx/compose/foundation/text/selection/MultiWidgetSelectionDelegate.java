...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    private final synchronized int getLastVisibleOffset(TextLayoutResult $this$lastVisibleOffset) {
        ...
        if (this._previousTextLayoutResult != $this$lastVisibleOffset) {
            if (!$this$lastVisibleOffset.getDidOverflowHeight() || $this$lastVisibleOffset.getMultiParagraph().getDidExceedMaxLines()) {
                ...
                int finalVisibleLine2 = RangesKt.coerceAtMost($this$lastVisibleOffset.getLineForVerticalPosition(IntSize.m6866getHeightimpl($this$lastVisibleOffset.getSize())), $this$lastVisibleOffset.getLineCount() - 1);
                while (finalVisibleLine2 >= 0 && $this$lastVisibleOffset.getLineTop(finalVisibleLine2) >= IntSize.m6866getHeightimpl($this$lastVisibleOffset.getSize())) {
                    finalVisibleLine2--;
                }
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder builder) {
        ...
        long relativePosition = builder.getContainerCoordinates().mo5538localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m3961getZeroF1C5BW0());
        long localPosition = Offset.m3949minusMKHz9U(builder.getCurrentPosition(), relativePosition);
        if (!OffsetKt.m3966isUnspecifiedk4lQ0M(builder.getPreviousHandlePosition())) {
            localPreviousHandlePosition = Offset.m3949minusMKHz9U(builder.getPreviousHandlePosition(), relativePosition);
        } else {
            localPreviousHandlePosition = Offset.INSTANCE.m3960getUnspecifiedF1C5BW0();
        }
        MultiWidgetSelectionDelegateKt.m1332appendSelectableInfoParwq6A(builder, textLayoutResult, localPosition, localPreviousHandlePosition, getSelectableId());
    }
    ...
    public long mo1330getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
        TextLayoutResult textLayoutResult;
    ...
    public long mo1331getRangeOfLineContainingjx7JFs(int offset) {
