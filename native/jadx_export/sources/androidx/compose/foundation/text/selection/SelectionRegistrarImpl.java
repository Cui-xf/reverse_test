...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl.sort.1
                ...
                public final Integer invoke(Selectable a, Selectable b) {
                    ...
                    if (layoutCoordinatesA != null) {
                        positionA = containerLayoutCoordinates.mo5538localPositionOfR5De75A(layoutCoordinatesA, Offset.INSTANCE.m3961getZeroF1C5BW0());
                    } else {
                        positionA = Offset.INSTANCE.m3961getZeroF1C5BW0();
                    }
                    if (layoutCoordinatesB != null) {
                        positionB = containerLayoutCoordinates.mo5538localPositionOfR5De75A(layoutCoordinatesB, Offset.INSTANCE.m3961getZeroF1C5BW0());
                    } else {
                        positionB = Offset.INSTANCE.m3961getZeroF1C5BW0();
                    }
                    if (Offset.m3946getYimpl(positionA) == Offset.m3946getYimpl(positionB)) {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m3945getXimpl(positionA)), Float.valueOf(Offset.m3945getXimpl(positionB)));
                    } else {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m3946getYimpl(positionA)), Float.valueOf(Offset.m3946getYimpl(positionB)));
                    }
    ...
    public void mo1391notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m3934boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo1390notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m3934boximpl(newPosition), Offset.m3934boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
