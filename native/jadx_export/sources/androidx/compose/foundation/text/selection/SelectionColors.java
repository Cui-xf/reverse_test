...
public final class SelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SelectionColors) && Color.m4188equalsimpl0(this.selectionHandleColor, ((SelectionColors) other).selectionHandleColor) && Color.m4188equalsimpl0(this.selectionBackgroundColor, ((SelectionColors) other).selectionBackgroundColor);
    }

    public int hashCode() {
        int result = Color.m4194hashCodeimpl(this.selectionHandleColor);
        return (result * 31) + Color.m4194hashCodeimpl(this.selectionBackgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m4195toStringimpl(this.selectionHandleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m4195toStringimpl(this.selectionBackgroundColor)) + ')';
    }
}
