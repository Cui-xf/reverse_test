    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (objM410awaitTouchSlopOrCancellationjO51t88 != coroutine_suspended) {
                    $result = objM410awaitTouchSlopOrCancellationjO51t88;
                    break;
                } else {
        ...
        if (firstDragPastSlop != null && OffsetKt.m3964isSpecifiedk4lQ0M(selectionGesturesKt$touchSelectionSubsequentPress$downResolution$1.$overSlop.element)) {
