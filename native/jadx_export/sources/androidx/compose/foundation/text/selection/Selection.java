...
public final /* data */ class Selection {
    ...
    public static final /* data */ class AnchorInfo {
        ...
        public int hashCode() {
            return (((this.direction.hashCode() * 31) + this.offset) * 31) + FloatFloatPair$$ExternalSyntheticBackport0.m(this.selectableId);
        }
    ...
    public final long m1336toTextRanged9O1mEE() {
