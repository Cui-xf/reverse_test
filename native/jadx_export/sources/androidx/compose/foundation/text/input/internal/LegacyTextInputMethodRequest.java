...
public final class LegacyTextInputMethodRequest implements PlatformTextInputMethodRequest {
    ...
    private Function1<? super ImeAction, Unit> onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.input.internal.LegacyTextInputMethodRequest$onImeActionPerformed$1
        ...
        public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
            m1176invokeKlQnJC8(imeAction.getValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-KlQnJC8, reason: not valid java name */
        public final void m1176invokeKlQnJC8(int it) {
        }
    };
    private TextFieldValue state = new TextFieldValue("", TextRange.INSTANCE.m6151getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public RecordingInputConnection createInputConnection(EditorInfo outAttributes) {
        ...
        RecordingInputConnection it = new RecordingInputConnection(textFieldValue, new InputEventCallback2() { // from class: androidx.compose.foundation.text.input.internal.LegacyTextInputMethodRequest.createInputConnection.1
            ...
            public void mo1175onImeActionKlQnJC8(int imeAction) {
                LegacyTextInputMethodRequest.this.onImeActionPerformed.invoke(ImeAction.m6310boximpl(imeAction));
            }
