...
public final /* data */ class TextFieldDecoratorModifier extends ModifierNodeElement<TextFieldDecoratorModifierNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((((((((((this.textFieldState.hashCode() * 31) + this.textLayoutState.hashCode()) * 31) + this.textFieldSelectionState.hashCode()) * 31) + (this.filter == null ? 0 : this.filter.hashCode())) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.enabled)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.readOnly)) * 31) + this.keyboardOptions.hashCode()) * 31) + (this.keyboardActionHandler != null ? this.keyboardActionHandler.hashCode() : 0)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.singleLine)) * 31) + this.interactionSource.hashCode();
    }
