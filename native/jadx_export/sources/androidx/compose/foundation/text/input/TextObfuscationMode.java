...
public final class TextObfuscationMode {
    ...
    private static final int Visible = m1129constructorimpl(0);
    private static final int RevealLastTyped = m1129constructorimpl(1);
    private static final int Hidden = m1129constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextObfuscationMode m1128boximpl(int i) {
    ...
    public static boolean m1130equalsimpl(int i, Object obj) {
        return (obj instanceof TextObfuscationMode) && i == ((TextObfuscationMode) obj).m1134unboximpl();
    }
