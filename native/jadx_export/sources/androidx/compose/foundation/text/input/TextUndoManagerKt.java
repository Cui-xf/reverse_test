...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager $this$recordChanges, TextFieldCharSequence pre, TextFieldCharSequence post, TextFieldBuffer.ChangeList changes, boolean allowMerge) {
        ...
        if (changes.getChangeCount() == 1) {
            long preRange = changes.mo1111getOriginalRangejx7JFs(0);
            long postRange = changes.mo1112getRangejx7JFs(0);
            if (!TextRange.m6140getCollapsedimpl(preRange) || !TextRange.m6140getCollapsedimpl(postRange)) {
                $this$recordChanges.record(new TextUndoOperation(TextRange.m6144getMinimpl(preRange), TextRangeKt.m6153substringFDrldGo(pre, preRange), TextRangeKt.m6153substringFDrldGo(post, postRange), pre.getSelection(), post.getSelection(), 0L, allowMerge, 32, null));
            }
        }
    }
