...
public final class StatelessInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        CharSequence result;
        if (TextRange.m6140getCollapsedimpl(getText().getSelection())) {
            result = null;
        } else {
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m6144getMinimpl(getText().getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.session.mo1141onImeActionKlQnJC8(imeAction);
        return true;
    }
