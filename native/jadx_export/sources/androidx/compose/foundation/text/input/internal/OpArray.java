...
final class OpArray {
    ...
    public static final /* synthetic */ OpArray m1183boximpl(int[] iArr) {
        return new OpArray(iArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int[] m1185constructorimpl(int[] iArr) {
        return iArr;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1187equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof OpArray) && Intrinsics.areEqual(iArr, ((OpArray) obj).getValues());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1188equalsimpl0(int[] iArr, int[] iArr2) {
        return Intrinsics.areEqual(iArr, iArr2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1192hashCodeimpl(int[] iArr) {
        return Arrays.hashCode(iArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1194toStringimpl(int[] iArr) {
        return "OpArray(values=" + Arrays.toString(iArr) + ')';
    }

    public boolean equals(Object obj) {
        return m1187equalsimpl(this.values, obj);
    }

    public int hashCode() {
        return m1192hashCodeimpl(this.values);
    }

    public String toString() {
        return m1194toStringimpl(this.values);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static int[] m1184constructorimpl(int size) {
        return m1185constructorimpl(new int[size * 3]);
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static final int m1191getSizeimpl(int[] arg0) {
        return arg0.length / 3;
    }

    /* renamed from: set-impl, reason: not valid java name */
    public static final void m1193setimpl(int[] arg0, int index, int offset, int srcLen, int destLen) {
        arg0[index * 3] = offset;
    ...
    public static final int[] m1186copyOfpSmdads(int[] arg0, int newSize) {
        int[] iArrCopyOf = Arrays.copyOf(arg0, newSize * 3);
        Intrinsics.checkNotNullExpressionValue(iArrCopyOf, "copyOf(this, newSize)");
        return m1185constructorimpl(iArrCopyOf);
    }

    /* renamed from: forEach-impl$default, reason: not valid java name */
    public static /* synthetic */ void m1190forEachimpl$default(int[] arg0, int max, boolean reversed, Function3 block, int i, Object obj) {
        if ((i & 2) != 0) {
            reversed = false;
        }
        if (max < 0) {
    ...
    public static final void m1189forEachimpl(int[] arg0, int max, boolean reversed, Function3<? super Integer, ? super Integer, ? super Integer, Unit> function3) {
        if (max < 0) {
            return;
        }
        if (reversed) {
