...
public final class TextFieldPreparedSelection {
    ...
    public final void m1257setSelection5zctL8(long j) {
        this.selection = j;
    }

    public final void deleteIfSelectedOr(Function0<TextRange> block) {
        if (!TextRange.m6140getCollapsedimpl(getSelection())) {
            TransformedTextFieldState.m1228replaceTextM8tDOmk$default(this.state, "", getSelection(), null, !this.isFromSoftKeyboard, 4, null);
            return;
        }
        TextRange textRangeInvoke = block.invoke();
        if (textRangeInvoke != null) {
            long it = textRangeInvoke.getPackedValue();
            TransformedTextFieldState.m1228replaceTextM8tDOmk$default(this.state, "", it, null, !this.isFromSoftKeyboard, 4, null);
        }
    }
    ...
    private final int jumpByPagesOffset(int pagesAmount) {
        int currentOffset = TextRange.m6141getEndimpl(this.initialValue.getSelection());
        ...
        if (fAbs > fAbs2) {
            return textLayoutResult.m6118getOffsetForPositionk4lQ0M(newPos.m3980getTopLeftF1C5BW0());
        }
        return textLayoutResult.m6118getOffsetForPositionk4lQ0M(newPos.m3973getBottomLeftF1C5BW0());
    }
    ...
    public final TextFieldPreparedSelection deselect() {
        ...
        if (this.text.length() > 0) {
            ...
            $this$deselect_u24lambda_u245.setCursor(TextRange.m6141getEndimpl($this$deselect_u24lambda_u245.selection));
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection collapseLeftOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        ...
        if (this.text.length() > 0) {
            ...
            if (TextRange.m6140getCollapsedimpl($this$collapseLeftOr_u24lambda_u248.selection)) {
                or.invoke($this$collapseLeftOr_u24lambda_u248);
            } else {
                boolean zIsLtr = $this$collapseLeftOr_u24lambda_u248.isLtr();
                long j = $this$collapseLeftOr_u24lambda_u248.selection;
                if (zIsLtr) {
                    $this$collapseLeftOr_u24lambda_u248.setCursor(TextRange.m6144getMinimpl(j));
                } else {
                    $this$collapseLeftOr_u24lambda_u248.setCursor(TextRange.m6143getMaximpl(j));
                }
            }
        }
        return this;
    ...
    public final TextFieldPreparedSelection collapseRightOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        ...
        if (this.text.length() > 0) {
            ...
            if (TextRange.m6140getCollapsedimpl($this$collapseRightOr_u24lambda_u249.selection)) {
                or.invoke($this$collapseRightOr_u24lambda_u249);
            } else {
                boolean zIsLtr = $this$collapseRightOr_u24lambda_u249.isLtr();
                long j = $this$collapseRightOr_u24lambda_u249.selection;
                if (zIsLtr) {
                    $this$collapseRightOr_u24lambda_u249.setCursor(TextRange.m6143getMaximpl(j));
                } else {
                    $this$collapseRightOr_u24lambda_u249.setCursor(TextRange.m6144getMinimpl(j));
                }
            }
        }
        return this;
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m6141getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m6141getEndimpl(this.selection));
    }
    ...
    private final TextFieldPreparedSelection moveCursorPrev() {
        ...
        if (this.text.length() > 0) {
            ...
            int oldCursor = TextRange.m6141getEndimpl($this$moveCursorPrev_u24lambda_u2410.selection);
    ...
    private final TextFieldPreparedSelection moveCursorNext() {
        ...
        if (this.text.length() > 0) {
            ...
            int oldCursor = TextRange.m6141getEndimpl($this$moveCursorNext_u24lambda_u2411.selection);
    ...
    public final TextFieldPreparedSelection moveCursorPrevByParagraph() {
        ...
        if (this.text.length() > 0) {
            ...
            int paragraphStart = StringHelpersKt.findParagraphStart($this$moveCursorPrevByParagraph_u24lambda_u2418.text, TextRange.m6144getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2418.selection));
            if (paragraphStart == TextRange.m6144getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2418.selection) && paragraphStart != 0) {
    ...
    public final TextFieldPreparedSelection moveCursorNextByParagraph() {
        ...
        if (this.text.length() > 0) {
            ...
            int paragraphEnd = StringHelpersKt.findParagraphEnd($this$moveCursorNextByParagraph_u24lambda_u2419.text, TextRange.m6143getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2419.selection));
            if (paragraphEnd == TextRange.m6143getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2419.selection) && paragraphEnd != $this$moveCursorNextByParagraph_u24lambda_u2419.text.length()) {
    ...
    public final TextFieldPreparedSelection selectMovement() {
        if (this.text.length() > 0) {
            ...
            $this$selectMovement_u24lambda_u2426.selection = TextRangeKt.TextRange(TextRange.m6146getStartimpl($this$selectMovement_u24lambda_u2426.initialValue.getSelection()), TextRange.m6141getEndimpl($this$selectMovement_u24lambda_u2426.selection));
        }
        return this;
    }
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (direction = textLayoutResult.getParagraphDirection(TextRange.m6141getEndimpl(this.selection))) == null || direction == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6141getEndimpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.initialValue.length()) {
            long currentWord = $this$getNextWordOffsetForLayout.m6120getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6141getEndimpl(currentWord) <= currentOffset) {
                currentOffset++;
            } else {
                return TextRange.m6141getEndimpl(currentWord);
            }
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult $this$getPrevWordOffsetForLayout, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffsetForLayout.m6120getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6146getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return TextRange.m6146getStartimpl(currentWord);
            }
        }
        return 0;
    }
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6144getMinimpl(textFieldPreparedSelection.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6143getMaximpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        int currentOffset = TextRange.m6141getEndimpl(this.selection);
        ...
        return $this$jumpByLinesOffset.m6118getOffsetForPositionk4lQ0M(OffsetKt.Offset(x, y));
    }
