...
public final class TextLayoutState {
    ...
    public final float m1217getMinHeightForSingleLineFieldD9Ej5fM() {
        State $this$getValue$iv = this.minHeightForSingleLineField;
        return ((Dp) $this$getValue$iv.getValue()).m6707unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1221setMinHeightForSingleLineField0680j_4(float f) {
    ...
    public final TextLayoutResult m1220layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        TextLayoutResult layoutResult = this.layoutCache.m1209layoutWithNewMeasureInputshBUhpc(density, layoutDirection, fontFamilyResolver, constraints);
    ...
    public static /* synthetic */ int m1215getOffsetForPosition3MmeM6k$default(TextLayoutState textLayoutState, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutState.m1218getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1218getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        ...
        if (coerceInVisibleBounds) {
            coercedPosition = m1216coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(position);
        } else {
            coercedPosition = position;
        }
        long relativePosition = TextLayoutStateKt.m1223fromDecorationToTextLayoutUv8p0NA(this, coercedPosition);
        return layoutResult.m6118getOffsetForPositionk4lQ0M(relativePosition);
    }

    /* renamed from: isPositionOnText-k-4lQ0M, reason: not valid java name */
    public final boolean m1219isPositionOnTextk4lQ0M(long offset) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long relativeOffset = TextLayoutStateKt.m1223fromDecorationToTextLayoutUv8p0NA(this, m1216coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(offset));
        int line = layoutResult.getLineForVerticalPosition(Offset.m3946getYimpl(relativeOffset));
        return Offset.m3945getXimpl(relativeOffset) >= layoutResult.getLineLeft(line) && Offset.m3945getXimpl(relativeOffset) <= layoutResult.getLineRight(line);
    }
    ...
    */
    public final long m1216coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long r7) {
        /*
            r6 = this;
        ...
        L2a:
            long r0 = androidx.compose.foundation.text.input.internal.TextLayoutStateKt.m1222coerceIn3MmeM6k(r7, r3)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.TextLayoutState.m1216coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long):long");
    }
}
