...
public final class TextFieldTextLayoutModifierNode extends Modifier.Node implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo86measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        TextLayoutResult result = this.textLayoutState.m1220layoutWithNewMeasureInputshBUhpc($this$measure_u2d3p2s80s, $this$measure_u2d3p2s80s.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), constraints);
        final Placeable placeable = measurable.mo5535measureBRTryo0(Constraints.INSTANCE.m6645fitPrioritizingWidthZbe2FdA(IntSize.m6867getWidthimpl(result.getSize()), IntSize.m6867getWidthimpl(result.getSize()), IntSize.m6866getHeightimpl(result.getSize()), IntSize.m6866getHeightimpl(result.getSize())));
        TextLayoutState textLayoutState = this.textLayoutState;
        if (this.singleLine) {
            fM6693constructorimpl = $this$measure_u2d3p2s80s.mo364toDpu2uoSUM(TextDelegateKt.ceilToIntPx(result.getLineBottom(0)));
        } else {
            fM6693constructorimpl = Dp.m6693constructorimpl(0);
        }
        textLayoutState.m1221setMinHeightForSingleLineField0680j_4(fM6693constructorimpl);
        ...
        int iM6867getWidthimpl = IntSize.m6867getWidthimpl(result.getSize());
        int iM6866getHeightimpl = IntSize.m6866getHeightimpl(result.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return $this$measure_u2d3p2s80s.layout(iM6867getWidthimpl, iM6866getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldTextLayoutModifierNode$measure$1
            {
                super(1);
            }
