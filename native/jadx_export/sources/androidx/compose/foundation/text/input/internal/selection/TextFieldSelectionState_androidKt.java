    ...
    public static final Function1<ContextMenuScope, Unit> contextMenuBuilder(final TextFieldSelectionState $this$contextMenuBuilder, final ContextMenuState state) {
        return new Function1<ContextMenuScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState_androidKt.contextMenuBuilder.1
            ...
            public final void invoke2(ContextMenuScope $this$null) {
                ...
                $this$null.item(new ContextMenu_androidKt.AnonymousClass1(label$iv), (10 & 2) != 0 ? Modifier.INSTANCE : null, (10 & 4) != 0 ? true : enabled$iv, (10 & 8) != 0 ? null : null, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState_androidKt$contextMenuBuilder$1$invoke$$inlined$TextItem$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                $this$null.item(new ContextMenu_androidKt.AnonymousClass1(label$iv2), (10 & 2) != 0 ? Modifier.INSTANCE : null, (10 & 4) != 0 ? true : enabled$iv2, (10 & 8) != 0 ? null : null, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState_androidKt$contextMenuBuilder$1$invoke$$inlined$TextItem$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                $this$null.item(new ContextMenu_androidKt.AnonymousClass1(label$iv3), (10 & 2) != 0 ? Modifier.INSTANCE : null, (10 & 4) != 0 ? true : enabled$iv3, (10 & 8) != 0 ? null : null, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState_androidKt$contextMenuBuilder$1$invoke$$inlined$TextItem$3
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                    ...
                    public final void invoke2() {
                        ...
                        ContextMenuState_androidKt.close(state$iv3);
                    }
                });
                ...
                $this$null.item(new ContextMenu_androidKt.AnonymousClass1(label$iv4), (10 & 2) != 0 ? Modifier.INSTANCE : null, (10 & 4) != 0 ? true : enabled$iv4, (10 & 8) != 0 ? null : null, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState_androidKt$contextMenuBuilder$1$invoke$$inlined$TextItem$4
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                    ...
                    public final void invoke2() {
                        ...
                        ContextMenuState_androidKt.close(state$iv4);
                    }
                });
            }
        };
