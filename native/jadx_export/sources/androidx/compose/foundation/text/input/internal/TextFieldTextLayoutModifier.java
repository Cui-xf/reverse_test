...
public final /* data */ class TextFieldTextLayoutModifier extends ModifierNodeElement<TextFieldTextLayoutModifierNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((this.textLayoutState.hashCode() * 31) + this.textFieldState.hashCode()) * 31) + this.textStyle.hashCode()) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.singleLine)) * 31) + (this.onTextLayout == null ? 0 : this.onTextLayout.hashCode());
    }
