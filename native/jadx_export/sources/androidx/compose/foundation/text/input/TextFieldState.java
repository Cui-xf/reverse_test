...
public final class TextFieldState {
    ...
    private TextFieldState(String initialText, long initialSelection, TextUndoManager initialTextUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(initialText, TextRangeKt.m6152coerceIn8ffj60Q(initialSelection, 0, initialText.length()), (DefaultConstructorMarker) null);
    ...
    public final TextRange m1115getCompositionMzsxiRA() {
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m6149toStringimpl(m1116getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean selectionChanged = true ^ TextRange.m6139equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1145getSelectiond9O1mEE());
        if (textChanged) {
            this.textUndoManager.clearHistory();
        }
        m1117syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, textChanged, selectionChanged);
    }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super EditingBuffer, Unit> block) {
        getMainBuffer().getChangeTracker().clearChanges();
        block.invoke(getMainBuffer());
        TextFieldCharSequence afterEditValue = new TextFieldCharSequence(getMainBuffer().toString(), getMainBuffer().m1145getSelectiond9O1mEE(), getMainBuffer().m1144getCompositionMzsxiRA(), null, 8, null);
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m6139equalsimpl0(beforeEditValue.getSelection(), this.mainBuffer.m1145getSelectiond9O1mEE())) {
            if (!Intrinsics.areEqual(beforeEditValue.getComposition(), this.mainBuffer.m1144getCompositionMzsxiRA()) || !Intrinsics.areEqual(beforeEditValue.getHighlight(), this.mainBuffer.getHighlight())) {
        ...
        TextFieldCharSequence afterEditValue = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1145getSelectiond9O1mEE(), this.mainBuffer.m1144getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null);
        ...
        boolean selectionChangedByFilter = !TextRange.m6139equalsimpl0(textFieldBuffer.getSelectionInChars(), afterEditValue.getSelection());
        if (textChangedByFilter || selectionChangedByFilter) {
            m1117syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(textFieldBuffer, null, textChangedByFilter, selectionChangedByFilter);
        } else {
            updateValueAndNotifyListeners(beforeEditValue, TextFieldBuffer.m1106toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer, 0L, afterEditValue.getComposition(), 1, null), restartImeIfContentChanges);
        }
    ...
    public final void m1117syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        String bufferString = this.mainBuffer.toString();
        TextFieldCharSequence bufferState = new TextFieldCharSequence(bufferString, this.mainBuffer.m1145getSelectiond9O1mEE(), this.mainBuffer.m1144getCompositionMzsxiRA(), null, 8, null);
        boolean compositionChanged = !Intrinsics.areEqual(newComposition, this.mainBuffer.m1144getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m6146getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m6141getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition != null && !TextRange.m6140getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.setComposition(TextRange.m6144getMinimpl(newComposition.getPackedValue()), TextRange.m6143getMaximpl(newComposition.getPackedValue()));
        } else {
        ...
        TextFieldCharSequence finalValue = new TextFieldCharSequence(textChanged ? textFieldBuffer.toString() : bufferString, this.mainBuffer.m1145getSelectiond9O1mEE(), this.mainBuffer.m1144getCompositionMzsxiRA(), null, 8, null);
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope $this$save, TextFieldState value) {
            ...
            Integer numValueOf = Integer.valueOf(TextRange.m6146getStartimpl(value.m1116getSelectiond9O1mEE()));
            Integer numValueOf2 = Integer.valueOf(TextRange.m6141getEndimpl(value.m1116getSelectiond9O1mEE()));
