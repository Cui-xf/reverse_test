...
public final class TextFieldCursorKt {
    private static final AnimationSpec<Float> cursorAnimationSpec = AnimationSpecKt.m133infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursorAnimationSpec$1
    ...
    private static final float DefaultCursorThickness = Dp.m6693constructorimpl(2);
    ...
    public static final Modifier cursor(Modifier $this$cursor, final LegacyTextFieldState state, final TextFieldValue value, final OffsetMapping offsetMapping, final Brush cursorBrush, boolean enabled) {
        return enabled ? ComposedModifierKt.composed$default($this$cursor, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                if (isWindowFocused && state.getHasFocus() && TextRange.m6140getCollapsedimpl(value.getSelection()) && isBrushSpecified) {
                    ...
                    TextRange textRangeM6134boximpl = TextRange.m6134boximpl(value.getSelection());
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer);
                    EffectsKt.LaunchedEffect(text, textRangeM6134boximpl, (Function2) value$iv2, $composer, 0);
                        ...
                        value$iv3 = (Function1) new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1$2$1
                            ...
                            public final void invoke2(ContentDrawScope $this$drawWithContent) {
                                ...
                                if (!(cursorAlphaValue == 0.0f)) {
                                    int transformedOffset = offsetMapping2.originalToTransformed(TextRange.m6146getStartimpl(textFieldValue.getSelection()));
                                    ...
                                    float cursorWidth = $this$drawWithContent.mo367toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                                    float cursorX = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(cursorRect.getLeft() + (cursorWidth / 2.0f), Size.m4014getWidthimpl($this$drawWithContent.mo4662getSizeNHjbRc()) - (cursorWidth / 2.0f)), cursorWidth / 2.0f);
                                    DrawScope.CC.m4738drawLine1RTmtNc$default($this$drawWithContent, brush, OffsetKt.Offset(cursorX, cursorRect.getTop()), OffsetKt.Offset(cursorX, cursorRect.getBottom()), cursorWidth, 0, null, cursorAlphaValue, null, 0, 432, null);
                                }
                            }
                        };
