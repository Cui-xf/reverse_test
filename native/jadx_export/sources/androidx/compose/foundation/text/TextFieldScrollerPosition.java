...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.INSTANCE.m6151getZerod9O1mEE();
    ...
    public final void m1090setPreviousSelection5zctL8(long j) {
    ...
    */
    public final void update(androidx.compose.foundation.gestures.Orientation r6, androidx.compose.ui.geometry.Rect r7, int r8, int r9) {
        ...
        L4a:
            r5.coerceOffset$foundation_release(r1, r2, r8)
    ...
    public final int m1088getOffsetToFollow5zctL8(long selection) {
        return TextRange.m6146getStartimpl(selection) != TextRange.m6146getStartimpl(this.previousSelection) ? TextRange.m6146getStartimpl(selection) : TextRange.m6141getEndimpl(selection) != TextRange.m6141getEndimpl(this.previousSelection) ? TextRange.m6141getEndimpl(selection) : TextRange.m6144getMinimpl(selection);
    }
