...
public final class PasswordInputTransformation implements InputTransformation {
    ...
    public void transformInput(TextFieldBuffer $this$transformInput) {
        boolean singleCharacterInsertion = $this$transformInput.getChanges().getChangeCount() == 1 && TextRange.m6142getLengthimpl($this$transformInput.getChanges().mo1112getRangejx7JFs(0)) == 1 && TextRange.m6142getLengthimpl($this$transformInput.getChanges().mo1111getOriginalRangejx7JFs(0)) == 0;
        if (!singleCharacterInsertion || $this$transformInput.hasSelection()) {
            setRevealCodepointIndex(-1);
            return;
        }
        int insertionPoint = TextRange.m6144getMinimpl($this$transformInput.getChanges().mo1112getRangejx7JFs(0));
