...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, Constraints.m6636getMaxWidthimpl(constraints), Constraints.m6635getMaxHeightimpl(constraints), null, placementBlock, 4, null);
    }
}
