...
public final class BasicTextFieldKt {
    ...
    private static final long MinTouchTargetSizeForHandles = DpKt.m6715DpSizeYgX7TsA(Dp.m6693constructorimpl(40), Dp.m6693constructorimpl(40));
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.BasicTextFieldKt.BasicTextField.1
                ...
                public final void invoke(Composer composer, int i23) {
                    BasicTextFieldKt.BasicTextField(state, modifier3, enabled3, readOnly3, inputTransformation4, textStyle4, keyboardOptions4, onKeyboardAction3, lineLimits3, onTextLayout2, interactionSource3, cursorBrush3, outputTransformation3, decorator3, scrollState3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
                }
            });
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:329:0x0610  */
    /* JADX WARN: Removed duplicated region for block: B:332:0x061e  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:350:0x06f5  */
    /* JADX WARN: Removed duplicated region for block: B:353:0x077f  */
    /* JADX WARN: Removed duplicated region for block: B:356:0x078b  */
    /* JADX WARN: Removed duplicated region for block: B:357:0x0791  */
    /* JADX WARN: Removed duplicated region for block: B:360:0x07c2  */
    /* JADX WARN: Removed duplicated region for block: B:364:0x07d8  */
    ...
    */
            ...
            if (TextFieldCursorHandle$lambda$9(cursorHandleState$delegate).getVisible()) {
                ...
                if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
                    value$iv2 = new OffsetProvider() { // from class: androidx.compose.foundation.text.BasicTextFieldKt$TextFieldCursorHandle$1$1
                        ...
                        public final long mo977provideF1C5BW0() {
                            return selectionState.getCursorHandleState$foundation_release(true).m1246getPositionF1C5BW0();
                        }
                    };
                ...
                ComposerKt.sourceInformationMarkerEnd($composer2);
                AndroidCursorHandle_androidKt.m974CursorHandleUSBMPiE(offsetProvider, SuspendingPointerInputFilterKt.pointerInput(companion, selectionState, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv3), MinTouchTargetSizeForHandles, $composer2, 384, 0);
            ...
            if (TextFieldSelectionHandles$lambda$13(startHandleState$delegate).getVisible()) {
                ...
                if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
                    value$iv5 = new OffsetProvider() { // from class: androidx.compose.foundation.text.BasicTextFieldKt$TextFieldSelectionHandles$1$1
                        ...
                        public final long mo977provideF1C5BW0() {
                            return selectionState.getSelectionHandleState$foundation_release(true, true).m1246getPositionF1C5BW0();
                        }
                    };
                ...
                ComposerKt.sourceInformationMarkerEnd($composer2);
                AndroidSelectionHandles_androidKt.m1325SelectionHandlepzduO1o(offsetProvider, true, direction, handlesCrossed, MinTouchTargetSizeForHandles, SuspendingPointerInputFilterKt.pointerInput(companion, selectionState, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv6), $composer2, 24624, 0);
                $composer2.endReplaceGroup();
            } else {
            ...
            if (TextFieldSelectionHandles$lambda$17(endHandleState$delegate).getVisible()) {
                ...
                if (invalid$iv3 || it$iv5 == Composer.INSTANCE.getEmpty()) {
                    value$iv3 = new OffsetProvider() { // from class: androidx.compose.foundation.text.BasicTextFieldKt$TextFieldSelectionHandles$3$1
                        ...
                        /* renamed from: provide-F1C5BW0 */
                        public final long mo977provideF1C5BW0() {
                            return selectionState.getSelectionHandleState$foundation_release(false, true).m1246getPositionF1C5BW0();
                        }
                    };
                    $composer2.updateRememberedValue(value$iv3);
                } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:256:0x0435  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:267:0x046d  */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:263:0x0432  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public static final /* synthetic */ void BasicTextField(final String value, final Function1 onValueChange, Modifier modifier, boolean enabled, boolean readOnly, TextStyle textStyle, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean singleLine, int maxLines, VisualTransformation visualTransformation, Function1 onTextLayout, MutableInteractionSource interactionSource, Brush cursorBrush, Function3 decorationBox, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty & 306783379) == 306783378 && ($dirty1 & 9363) == 9362 && $composer3.getSkipping()) {
            ...
            if (i7 != 0) {
                interactionSource3 = interactionSource2;
                cursorBrush2 = new SolidColor(Color.INSTANCE.m4213getBlack0d7_KjU(), null);
            } else {
                interactionSource3 = interactionSource2;
                cursorBrush2 = cursorBrush;
            }
            Function3 decorationBox3 = i8 != 0 ? ComposableSingletons$BasicTextFieldKt.INSTANCE.m995getLambda3$foundation_release() : decorationBox;
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ void BasicTextField(final TextFieldValue value, final Function1 onValueChange, Modifier modifier, boolean enabled, boolean readOnly, TextStyle textStyle, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean singleLine, int maxLines, VisualTransformation visualTransformation, Function1 onTextLayout, MutableInteractionSource interactionSource, Brush cursorBrush, Function3 decorationBox, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty & 306783379) == 306783378 && ($dirty1 & 9363) == 9362 && $composer3.getSkipping()) {
            ...
            Function3 decorationBox3 = i8 != 0 ? ComposableSingletons$BasicTextFieldKt.INSTANCE.m996getLambda4$foundation_release() : decorationBox;
            if (ComposerKt.isTraceInProgress()) {
