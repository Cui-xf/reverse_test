...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public void update(ToggleableNode node) {
        node.m952updateQzZPfjk(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = ChangeSize$$ExternalSyntheticBackport0.m(this.value);
        int i = result * 31;
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        int result2 = i + (mutableInteractionSource != null ? mutableInteractionSource.hashCode() : 0);
        int result3 = result2 * 31;
        IndicationNodeFactory indicationNodeFactory = this.indicationNodeFactory;
        int result4 = (((result3 + (indicationNodeFactory != null ? indicationNodeFactory.hashCode() : 0)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.enabled)) * 31;
        Role role = this.role;
        return ((result4 + (role != null ? Role.m5953hashCodeimpl(role.getValue()) : 0)) * 31) + this.onValueChange.hashCode();
    }
}
