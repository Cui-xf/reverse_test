...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope scope) {
        super(scope);
        this.surfaceSize = IntSize.INSTANCE.m6872getZeroYbymL2g();
    ...
    public final void m216setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        int w = width;
        int h = height;
        if (!IntSize.m6865equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m6872getZeroYbymL2g())) {
            w = IntSize.m6867getWidthimpl(this.surfaceSize);
            h = IntSize.m6866getHeightimpl(this.surfaceSize);
