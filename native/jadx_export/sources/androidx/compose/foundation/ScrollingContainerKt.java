...
public final class ScrollingContainerKt {
    public static final Modifier scrollingContainer(Modifier $this$scrollingContainer, ScrollableState state, Orientation orientation, boolean enabled, boolean reverseScrolling, FlingBehavior flingBehavior, MutableInteractionSource interactionSource, BringIntoViewSpec bringIntoViewSpec, Composer $composer, int $changed, int i) {
        ...
        Modifier modifierOverscroll = OverscrollKt.overscroll(ClipScrollableContainerKt.clipScrollableContainer($this$scrollingContainer, orientation), overscrollEffect);
        ScrollableDefaults scrollableDefaults = ScrollableDefaults.INSTANCE;
        ProvidableCompositionLocal<LayoutDirection> localLayoutDirection = CompositionLocalsKt.getLocalLayoutDirection();
        ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        Object objConsume = $composer.consume(localLayoutDirection);
        ComposerKt.sourceInformationMarkerEnd($composer);
        Modifier modifierScrollable = ScrollableKt.scrollable(modifierOverscroll, state, orientation, overscrollEffect, enabled, scrollableDefaults.reverseDirection((LayoutDirection) objConsume, orientation, reverseScrolling), flingBehavior, interactionSource, bringIntoViewSpec2);
        if (ComposerKt.isTraceInProgress()) {
