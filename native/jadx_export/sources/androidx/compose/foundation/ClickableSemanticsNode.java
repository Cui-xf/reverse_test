...
final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    public final void m274updateUMe6uN4(boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick) {
        this.enabled = enabled;
        this.onClickLabel = onClickLabel;
        this.role = role;
