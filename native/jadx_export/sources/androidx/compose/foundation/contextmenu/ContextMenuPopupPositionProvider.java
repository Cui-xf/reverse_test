...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo339calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m6825getXimpl(this.localPosition), IntSize.m6867getWidthimpl(popupContentSize), IntSize.m6867getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m6826getYimpl(this.localPosition), IntSize.m6866getHeightimpl(popupContentSize), IntSize.m6866getHeightimpl(windowSize), false, 8, null));
    }
}
