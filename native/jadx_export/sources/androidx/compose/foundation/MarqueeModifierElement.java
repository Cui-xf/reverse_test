...
final /* data */ class MarqueeModifierElement extends ModifierNodeElement<MarqueeModifierNode> {
    ...
    public static /* synthetic */ MarqueeModifierElement m313copylWfNwf4$default(MarqueeModifierElement marqueeModifierElement, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        float f2 = f;
        return marqueeModifierElement.m314copylWfNwf4(i, i2, i3, i4, marqueeSpacing2, f2);
    }

    /* renamed from: copy-lWfNwf4, reason: not valid java name */
    public final MarqueeModifierElement m314copylWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
    ...
    public boolean equals(Object other) {
        ...
        return this.iterations == marqueeModifierElement.iterations && MarqueeAnimationMode.m304equalsimpl0(this.animationMode, marqueeModifierElement.animationMode) && this.delayMillis == marqueeModifierElement.delayMillis && this.initialDelayMillis == marqueeModifierElement.initialDelayMillis && Intrinsics.areEqual(this.spacing, marqueeModifierElement.spacing) && Dp.m6698equalsimpl0(this.velocity, marqueeModifierElement.velocity);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((this.iterations * 31) + MarqueeAnimationMode.m305hashCodeimpl(this.animationMode)) * 31) + this.delayMillis) * 31) + this.initialDelayMillis) * 31) + this.spacing.hashCode()) * 31) + Dp.m6699hashCodeimpl(this.velocity);
    }

    public String toString() {
        return "MarqueeModifierElement(iterations=" + this.iterations + ", animationMode=" + ((Object) MarqueeAnimationMode.m306toStringimpl(this.animationMode)) + ", delayMillis=" + this.delayMillis + ", initialDelayMillis=" + this.initialDelayMillis + ", spacing=" + this.spacing + ", velocity=" + ((Object) Dp.m6704toStringimpl(this.velocity)) + ')';
    }
    ...
    public void update(MarqueeModifierNode node) {
        node.m317updatelWfNwf4(this.iterations, this.animationMode, this.delayMillis, this.initialDelayMillis, this.spacing, this.velocity);
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("animationMode", MarqueeAnimationMode.m301boximpl(this.animationMode));
        ...
        $this$inspectableProperties.getProperties().set("velocity", Dp.m6691boximpl(this.velocity));
    }
}
