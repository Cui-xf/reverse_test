...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(Transition<S> transition, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function3, String label, Function3<? super S, ? super Composer, ? super Integer, Color> function32, Composer $composer, int $changed, int i) {
        ...
        ColorSpace colorSpace = Color.m4191getColorSpaceimpl(function32.invoke(transition.getTargetState(), $composer, Integer.valueOf(($changed >> 6) & 112)).m4197unboximpl());
        ...
        State<Color> stateCreateTransitionAnimation = androidx.compose.animation.core.TransitionKt.createTransitionAnimation(transition, initialValue$iv, targetValue$iv, animationSpec$iv, typeConverter, label2, $composer, (57344 & ($changed$iv << 9)) | ($changed$iv & 14) | (458752 & ($changed$iv << 6)));
        ComposerKt.sourceInformationMarkerEnd($composer);
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final State<Color> m120animateColorDTcfvLk(InfiniteTransition $this$animateColor_u2dDTcfvLk, long initialValue, long targetValue, InfiniteRepeatableSpec<Color> infiniteRepeatableSpec, String label, Composer $composer, int $changed, int i) {
        Object value$iv;
        ...
        if (it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m4191getColorSpaceimpl(targetValue));
            $composer.updateRememberedValue(value$iv);
        } else {
            value$iv = it$iv;
        }
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        State<Color> stateAnimateValue = InfiniteTransitionKt.animateValue($this$animateColor_u2dDTcfvLk, Color.m4177boximpl(initialValue), Color.m4177boximpl(targetValue), converter, infiniteRepeatableSpec, label2, $composer, InfiniteTransition.$stable | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 12) | (($changed << 3) & 57344) | (458752 & ($changed << 3)), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final /* synthetic */ State m121animateColorRIQooxk(InfiniteTransition $this$animateColor_u2dRIQooxk, long initialValue, long targetValue, InfiniteRepeatableSpec animationSpec, Composer $composer, int $changed) {
        ...
        State<Color> stateM120animateColorDTcfvLk = m120animateColorDTcfvLk($this$animateColor_u2dRIQooxk, initialValue, targetValue, animationSpec, "ColorAnimation", $composer, InfiniteTransition.$stable | 24576 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 9) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return stateM120animateColorDTcfvLk;
    }
}
