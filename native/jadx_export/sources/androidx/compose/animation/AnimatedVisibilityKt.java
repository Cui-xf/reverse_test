...
public final class AnimatedVisibilityKt {
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibilityImpl$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                        return m63invoke3p2s80s(measureScope, measurable, constraints.getValue());
                    }

                    /* renamed from: invoke-3p2s80s, reason: not valid java name */
                    public final MeasureResult m63invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
                        long jIntSize;
                        ...
                        if ($this$layout.isLookingAhead() && !function1.invoke(transition.getTargetState()).booleanValue()) {
                            jIntSize = IntSize.INSTANCE.m6872getZeroYbymL2g();
                        } else {
                            jIntSize = IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight());
                        }
                        int iM6867getWidthimpl = IntSize.m6867getWidthimpl(jIntSize);
                        int h = IntSize.m6866getHeightimpl(jIntSize);
                        return MeasureScope.CC.layout$default($this$layout, iM6867getWidthimpl, h, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibilityImpl$1$1.1
                            {
                                super(1);
                            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:123:0x01b3 A[ADDED_TO_REGION] */
