...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements DrawModifierNode, ModifierLocalModifierNode {
    ...
    private final class LayerWithRenderer implements LayerRenderer {
        ...
        public void drawInOverlay(DrawScope drawScope) throws Throwable {
            ...
            long jMo5538localPositionOfR5De75A = renderInTransitionOverlayNode.getSharedScope().getRoot$animation_release().mo5538localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode2), Offset.INSTANCE.m3961getZeroF1C5BW0());
            float x = Offset.m3945getXimpl(jMo5538localPositionOfR5De75A);
            float y = Offset.m3946getYimpl(jMo5538localPositionOfR5De75A);
            ...
            try {
                ...
                $this$clipPath_KD09W0M_u24lambda_u245$iv.mo4671clipPathmtrdDE(clipPath, clipOp$iv);
                drawScope.getDrawContext().getTransform().translate(x, y);
                try {
                    try {
                        GraphicsLayerKt.drawLayer(drawScope, this.layer);
    ...
    public void draw(final ContentDrawScope $this$draw) {
        ...
        DrawScope.CC.m4750recordJVtK1S4$default($this$draw, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode.draw.1
            {
                super(1);
            }
