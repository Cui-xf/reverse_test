...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            ...
            this.scope.getTargetSize$animation_release().setValue(IntSize.m6859boximpl(IntSizeKt.IntSize(maxWidth, maxHeight)));
        } else if (!this.hasLookaheadOccurred) {
            this.scope.getTargetSize$animation_release().setValue(IntSize.m6859boximpl(IntSizeKt.IntSize(maxWidth, maxHeight)));
        }
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, maxWidth, maxHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedEnterExitMeasurePolicy$measure$1
