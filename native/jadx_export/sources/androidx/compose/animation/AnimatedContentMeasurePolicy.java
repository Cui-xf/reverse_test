...
final class AnimatedContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        long targetSize = IntSize.INSTANCE.m6872getZeroYbymL2g();
        int index$iv = 0;
        int size = list.size();
        while (true) {
            boolean z = true;
            ...
            if (z) {
                Placeable it = measurable.mo5535measureBRTryo0(constraints);
        ...
        for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
            ...
            if (placeables[index2] == null) {
                placeables[index2] = measurable2.mo5535measureBRTryo0(constraints);
            }
        }
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            maxWidth = IntSize.m6867getWidthimpl(targetSize2);
        } else {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            height = IntSize.m6866getHeightimpl(targetSize2);
        } else {
            if (placeables.length == 0) {
                placeable2 = null;
            } else {
        ...
        if (!$this$measure_u2d3p2s80s.isLookingAhead()) {
            this.rootScope.m59setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(maxWidth, maxHeight));
        }
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, maxWidth, maxHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                for (Placeable placeable5 : placeableArr) {
                    if (placeable5 != null) {
                        long offset = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo3791alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i, i2), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default($this$layout, placeable5, IntOffset.m6825getXimpl(offset), IntOffset.m6826getYimpl(offset), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
