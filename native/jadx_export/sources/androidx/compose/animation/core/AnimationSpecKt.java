...
public final class AnimationSpecKt {
    ...
    public static /* synthetic */ RepeatableSpec m135repeatable91I0pcU$default(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i2 & 8) != 0) {
            j = StartOffset.m168constructorimpl$default(0, 0, 2, null);
        }
        return m134repeatable91I0pcU(i, durationBasedAnimationSpec, repeatMode, j);
    }

    /* renamed from: repeatable-91I0pcU, reason: not valid java name */
    public static final <T> RepeatableSpec<T> m134repeatable91I0pcU(int iterations, DurationBasedAnimationSpec<T> durationBasedAnimationSpec, RepeatMode repeatMode, long initialStartOffset) {
    ...
    public static final /* synthetic */ RepeatableSpec repeatable(int iterations, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        return new RepeatableSpec(iterations, animation, repeatMode, StartOffset.m168constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }

    /* renamed from: infiniteRepeatable-9IiC70o$default, reason: not valid java name */
    public static /* synthetic */ InfiniteRepeatableSpec m133infiniteRepeatable9IiC70o$default(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i & 4) != 0) {
        ...
        return m132infiniteRepeatable9IiC70o(durationBasedAnimationSpec, repeatMode, j);
    }

    /* renamed from: infiniteRepeatable-9IiC70o, reason: not valid java name */
    public static final <T> InfiniteRepeatableSpec<T> m132infiniteRepeatable9IiC70o(DurationBasedAnimationSpec<T> durationBasedAnimationSpec, RepeatMode repeatMode, long initialStartOffset) {
    ...
    public static final /* synthetic */ InfiniteRepeatableSpec infiniteRepeatable(DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        return new InfiniteRepeatableSpec(animation, repeatMode, StartOffset.m168constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
