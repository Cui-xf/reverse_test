    ...
    public final boolean getHasInitialValueAnimations() {
        ...
        while (true) {
            if (index$iv$iv < size) {
                ...
                if (it.getInitialValueState() != null) {
                    z = true;
                    break;
                }
                index$iv$iv++;
        ...
        if (!z) {
            ...
            while (true) {
                if (index$iv$iv2 < size2) {
                    ...
                    Transition it2 = (Transition) item$iv$iv2;
                    if (it2.getHasInitialValueAnimations()) {
                        z2 = true;
                        break;
                    }
                    index$iv$iv2++;
    ...
    public final void animateTo$animation_core_release(final S s, Composer $composer, final int $changed) {
        ...
        if (($dirty & 19) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1493585151, $dirty, -1, "androidx.compose.animation.core.Transition.animateTo (Transition.kt:1209)");
            }
            if (!isSeeking()) {
                $composer2.startReplaceGroup(1822376658);
                ComposerKt.sourceInformation($composer2, "");
                updateTarget$animation_core_release(s);
                if (!Intrinsics.areEqual(s, getCurrentState()) || isRunning() || getUpdateChildrenNeeded()) {
                    $composer2.startReplaceGroup(1822607949);
                    ComposerKt.sourceInformation($composer2, "1217@49699L24,1218@49779L1012,1218@49740L1051");
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    ComposerKt.sourceInformationMarkerStart($composer2, 335896763, "CC(remember):Transition.kt#9igjgp");
                    ...
                    $composer2.startReplaceGroup(1823851483);
                    $composer2.endReplaceGroup();
                }
                $composer2.endReplaceGroup();
            } else {
                $composer2.startReplaceGroup(1823861403);
                $composer2.endReplaceGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
