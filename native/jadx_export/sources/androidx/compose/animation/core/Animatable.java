...
public final class Animatable<T, V extends AnimationVector> {
    ...
    public final void updateBounds(T lowerBound, T upperBound) {
        ...
        for (int i = 0; i < size; i++) {
            boolean value$iv = vInvoke.get$animation_core_release(i) <= vInvoke2.get$animation_core_release(i);
            if (!value$iv) {
            ...
            try {
                switch (anonymousClass2) {
                    case 0:
                        ...
                        final AnimationState animationStateCopy$default = AnimationStateKt.copy$default((AnimationState) anonymousClass22.this$0.getInternalState$animation_core_release(), (Object) null, (AnimationVector) null, 0L, Long.MIN_VALUE, false, 23, (Object) null);
                    ...
                    case 1:
                        ...
                        animationState = (AnimationState) anonymousClass23.L$0;
                        ResultKt.throwOnFailure(obj);
    ...
    static final class C01962 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ T $targetValue;
        int label;
        final /* synthetic */ Animatable<T, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01962(Animatable<T, V> animatable, T t, Continuation<? super C01962> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
            this.$targetValue = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C01962(this.this$0, this.$targetValue, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C01962) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object snapTo(T t, Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C01962(this, t, null), continuation, 1, null);
    ...
    static final class C01972 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01972(Animatable<T, V> animatable, Continuation<? super C01972> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C01972(this.this$0, continuation);
        }
    ...
    public final Object stop(Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C01972(this, null), continuation, 1, null);
        return objMutate$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate$default : Unit.INSTANCE;
    }
