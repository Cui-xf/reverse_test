...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m108animateColorAsStateeuL9pac(long targetValue, AnimationSpec<Color> animationSpec, String label, Function1<? super Color, Unit> function1, Composer $composer, int $changed, int i) {
        ...
        ColorSpace colorSpaceM4191getColorSpaceimpl = Color.m4191getColorSpaceimpl(targetValue);
        ComposerKt.sourceInformationMarkerStart($composer, -1018619694, "CC(remember):SingleValueAnimation.kt#9igjgp");
        boolean invalid$iv = $composer.changed(colorSpaceM4191getColorSpaceimpl);
        ...
        State<Color> stateAnimateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m4177boximpl(targetValue), converter, animationSpec2, null, label2, finishedListener, $composer, ($changed & 14) | (($changed << 3) & 896) | (($changed << 6) & 57344) | (458752 & ($changed << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m107animateColorAsStateKTwxG1Y(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        AnimationSpec animationSpec2;
        ...
        State<Color> stateM108animateColorAsStateeuL9pac = m108animateColorAsStateeuL9pac(targetValue, animationSpec2, null, finishedListener2, $composer, ($changed & 14) | ($changed & 112) | (($changed << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final Animatable<Color, AnimationVector4D> m106Animatable8_81llA(long initialValue) {
        return new Animatable<>(Color.m4177boximpl(initialValue), ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m4191getColorSpaceimpl(initialValue)), null, null, 12, null);
    }
}
