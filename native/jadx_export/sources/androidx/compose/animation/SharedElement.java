...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds($this$_get_targetBounds__u24lambda_u241 != null ? RectKt.m3985Recttz77jQw($this$_get_targetBounds__u24lambda_u241.m101calculateLookaheadOffsetF1C5BW0(), $this$_get_targetBounds__u24lambda_u241.m102getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void m100onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            this.targetBoundsProvider = state;
            Rect rect = get_targetBounds();
            Offset offsetM3934boximpl = rect != null ? Offset.m3934boximpl(rect.m3980getTopLeftF1C5BW0()) : null;
            if (offsetM3934boximpl == null ? false : Offset.m3942equalsimpl0(offsetM3934boximpl.getPackedValue(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size sizeM4002boximpl = rect2 != null ? Size.m4002boximpl(rect2.m3978getSizeNHjbRc()) : null;
                if (sizeM4002boximpl != null ? Size.m4010equalsimpl0(sizeM4002boximpl.getPackedValue(), lookaheadSize) : false) {
                    return;
                }
            }
            Rect target = RectKt.m3985Recttz77jQw(topLeft, lookaheadSize);
