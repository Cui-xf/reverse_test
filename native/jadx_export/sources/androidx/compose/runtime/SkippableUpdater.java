...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3669boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3670constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3671equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3672equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3673hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3674toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3671equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3673hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3674toStringimpl(this.composer);
    }
    ...
    public static final void m3675updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> function1) {
        arg0.startReplaceableGroup(509942095);
        function1.invoke(Updater.m3677boximpl(Updater.m3678constructorimpl(arg0)));
