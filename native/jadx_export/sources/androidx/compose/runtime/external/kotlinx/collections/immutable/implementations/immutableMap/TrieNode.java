...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m3771assert(this.nodeMap == 0);
        CommonFunctionsKt.m3771assert(this.dataMap == 0);
        CommonFunctionsKt.m3771assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m3771assert(otherNode.dataMap == 0);
