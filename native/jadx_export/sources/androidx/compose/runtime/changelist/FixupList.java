...
public final class FixupList extends OperationsDebugStringFormattable {
    ...
    public final void createAndInsertNode(Function0<? extends Object> factory, int insertIndex, Anchor groupAnchor) {
        ...
        Operations $this$createAndInsertNode_u24lambda_u241 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.InsertNodeFixup insertNodeFixup = Operation.InsertNodeFixup.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$createAndInsertNode_u24lambda_u241, Operation.ObjectParameter.m3729constructorimpl(0), factory);
        Operation.InsertNodeFixup insertNodeFixup2 = Operation.InsertNodeFixup.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$createAndInsertNode_u24lambda_u241, Operation.IntParameter.m3718constructorimpl(0), insertIndex);
        Operation.InsertNodeFixup insertNodeFixup3 = Operation.InsertNodeFixup.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$createAndInsertNode_u24lambda_u241, Operation.ObjectParameter.m3729constructorimpl(1), groupAnchor);
        ...
        if (!value$iv$iv) {
            ...
            while ($i$f$checkPrecondition < $i$f$push) {
                ...
                if (((1 << arg$iv) & this_$iv.pushedIntMask) != 0) {
                    ...
                    $this$push_u24lambda_u246_u24lambda_u243$iv2.append(operation$iv.mo3690intParamNamew8GmfQM(Operation.IntParameter.m3718constructorimpl(arg$iv)));
                    missingIntCount$iv++;
                } else {
                    i7 = $i$f$push;
                    $this$push_u24lambda_u246_u24lambda_u243$iv2 = $this$push_u24lambda_u246_u24lambda_u243$iv3;
            ...
            while (i9 < missingObjectCount$iv) {
                ...
                if (((1 << arg$iv2) & this_$iv.pushedObjectMask) != 0) {
                    ...
                    $this$push_u24lambda_u246_u24lambda_u245$iv2.append(operation$iv.mo3691objectParamName31yXWZQ(Operation.ObjectParameter.m3729constructorimpl(arg$iv2)));
        ...
        Operations $this$createAndInsertNode_u24lambda_u242 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.PostInsertNodeFixup postInsertNodeFixup = Operation.PostInsertNodeFixup.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$createAndInsertNode_u24lambda_u242, Operation.IntParameter.m3718constructorimpl(0), insertIndex);
        Operation.PostInsertNodeFixup postInsertNodeFixup2 = Operation.PostInsertNodeFixup.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$createAndInsertNode_u24lambda_u242, Operation.ObjectParameter.m3729constructorimpl(0), groupAnchor);
        ...
        while (i11 < ints) {
            ...
            if (((1 << arg$iv3) & this_$iv2.pushedIntMask) != 0) {
                ...
                i4 = i11;
                $this$push_u24lambda_u246_u24lambda_u243$iv.append(operation$iv2.mo3690intParamNamew8GmfQM(Operation.IntParameter.m3718constructorimpl(arg$iv3)));
                missingIntCount$iv2++;
            } else {
                i3 = ints;
                $this$push_u24lambda_u246_u24lambda_u243$iv = $this$push_u24lambda_u246_u24lambda_u243$iv4;
        ...
        while (i12 < missingObjectCount$iv3) {
            ...
            if (((1 << arg$iv4) & this_$iv2.pushedObjectMask) != 0) {
                ...
                i2 = i12;
                $this$push_u24lambda_u246_u24lambda_u245$iv.append(operation$iv2.mo3691objectParamName31yXWZQ(Operation.ObjectParameter.m3729constructorimpl(arg$iv4)));
    ...
    public final <V, T> void updateNode(V value, Function2<? super T, ? super V, Unit> block) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$updateNode_u24lambda_u244 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.UpdateNode updateNode = Operation.UpdateNode.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$updateNode_u24lambda_u244, Operation.ObjectParameter.m3729constructorimpl(0), value);
        ...
        Operations.WriteScope.m3767setObjectDKhxnng($this$updateNode_u24lambda_u244, iM3729constructorimpl, (Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(block, 2));
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
