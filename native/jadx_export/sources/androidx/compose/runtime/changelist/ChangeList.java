...
public final class ChangeList extends OperationsDebugStringFormattable {
    ...
    public final void pushRemember(RememberObserver value) {
        ...
        Operations $this$pushRemember_u24lambda_u240 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.Remember remember = Operation.Remember.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushRemember_u24lambda_u240, Operation.ObjectParameter.m3729constructorimpl(0), value);
        ...
        for (int i = 0; i < ints; i++) {
            ...
            if (((1 << arg$iv) & this_$iv2.pushedIntMask) != 0) {
                ...
                $this$push_u24lambda_u246_u24lambda_u243$iv.append(operation$iv.mo3690intParamNamew8GmfQM(Operation.IntParameter.m3718constructorimpl(arg$iv)));
                missingIntCount$iv++;
            }
        }
        ...
        while (missingObjectCount$iv2 < objects) {
            ...
            if (((1 << arg$iv2) & this_$iv2.pushedObjectMask) != 0) {
                ...
                this_$iv = this_$iv2;
                $this$push_u24lambda_u246_u24lambda_u245$iv.append(operation$iv.mo3691objectParamName31yXWZQ(Operation.ObjectParameter.m3729constructorimpl(arg$iv2)));
    ...
    public final void pushUpdateValue(Object value, int groupSlotIndex) {
        ...
        Operations $this$pushUpdateValue_u24lambda_u241 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.UpdateValue updateValue = Operation.UpdateValue.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushUpdateValue_u24lambda_u241, Operation.ObjectParameter.m3729constructorimpl(0), value);
        Operation.UpdateValue updateValue2 = Operation.UpdateValue.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushUpdateValue_u24lambda_u241, Operation.IntParameter.m3718constructorimpl(0), groupSlotIndex);
    ...
    public final void pushUpdateAnchoredValue(Object value, Anchor anchor, int groupSlotIndex) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushUpdateAnchoredValue_u24lambda_u242 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.UpdateAnchoredValue updateAnchoredValue = Operation.UpdateAnchoredValue.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushUpdateAnchoredValue_u24lambda_u242, Operation.ObjectParameter.m3729constructorimpl(0), value);
        Operation.UpdateAnchoredValue updateAnchoredValue2 = Operation.UpdateAnchoredValue.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushUpdateAnchoredValue_u24lambda_u242, Operation.ObjectParameter.m3729constructorimpl(1), anchor);
        Operation.UpdateAnchoredValue updateAnchoredValue3 = Operation.UpdateAnchoredValue.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushUpdateAnchoredValue_u24lambda_u242, Operation.IntParameter.m3718constructorimpl(0), groupSlotIndex);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushAppendValue(Anchor anchor, Object value) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushAppendValue_u24lambda_u243 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.AppendValue appendValue = Operation.AppendValue.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushAppendValue_u24lambda_u243, Operation.ObjectParameter.m3729constructorimpl(0), anchor);
        Operation.AppendValue appendValue2 = Operation.AppendValue.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushAppendValue_u24lambda_u243, Operation.ObjectParameter.m3729constructorimpl(1), value);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushTrimValues(int count) {
        ...
        this_$iv2.pushOp(operation$iv);
        Operations $this$pushTrimValues_u24lambda_u244 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.TrimParentValues trimParentValues = Operation.TrimParentValues.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushTrimValues_u24lambda_u244, Operation.IntParameter.m3718constructorimpl(0), count);
        boolean value$iv$iv = this_$iv2.pushedIntMask == this_$iv2.createExpectedArgMask(operation$iv.getInts()) && this_$iv2.pushedObjectMask == this_$iv2.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushUpdateAuxData(Object data) {
        ...
        this_$iv2.pushOp(operation$iv);
        Operations $this$pushUpdateAuxData_u24lambda_u245 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.UpdateAuxData updateAuxData = Operation.UpdateAuxData.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushUpdateAuxData_u24lambda_u245, Operation.ObjectParameter.m3729constructorimpl(0), data);
        boolean value$iv$iv = this_$iv2.pushedIntMask == this_$iv2.createExpectedArgMask(operation$iv.getInts()) && this_$iv2.pushedObjectMask == this_$iv2.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushEnsureGroupStarted(Anchor anchor) {
        ...
        this_$iv2.pushOp(operation$iv);
        Operations $this$pushEnsureGroupStarted_u24lambda_u246 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.EnsureGroupStarted ensureGroupStarted = Operation.EnsureGroupStarted.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushEnsureGroupStarted_u24lambda_u246, Operation.ObjectParameter.m3729constructorimpl(0), anchor);
        boolean value$iv$iv = this_$iv2.pushedIntMask == this_$iv2.createExpectedArgMask(operation$iv.getInts()) && this_$iv2.pushedObjectMask == this_$iv2.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushInsertSlots_u24lambda_u247 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.InsertSlots insertSlots = Operation.InsertSlots.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushInsertSlots_u24lambda_u247, Operation.ObjectParameter.m3729constructorimpl(0), anchor);
        Operation.InsertSlots insertSlots2 = Operation.InsertSlots.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushInsertSlots_u24lambda_u247, Operation.ObjectParameter.m3729constructorimpl(1), from);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from, FixupList fixups) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushInsertSlots_u24lambda_u248 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.InsertSlotsWithFixups insertSlotsWithFixups = Operation.InsertSlotsWithFixups.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushInsertSlots_u24lambda_u248, Operation.ObjectParameter.m3729constructorimpl(0), anchor);
        Operation.InsertSlotsWithFixups insertSlotsWithFixups2 = Operation.InsertSlotsWithFixups.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushInsertSlots_u24lambda_u248, Operation.ObjectParameter.m3729constructorimpl(1), from);
        Operation.InsertSlotsWithFixups insertSlotsWithFixups3 = Operation.InsertSlotsWithFixups.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushInsertSlots_u24lambda_u248, Operation.ObjectParameter.m3729constructorimpl(2), fixups);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushMoveCurrentGroup(int offset) {
        ...
        this_$iv2.pushOp(operation$iv);
        Operations $this$pushMoveCurrentGroup_u24lambda_u249 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.MoveCurrentGroup moveCurrentGroup = Operation.MoveCurrentGroup.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushMoveCurrentGroup_u24lambda_u249, Operation.IntParameter.m3718constructorimpl(0), offset);
        boolean value$iv$iv = this_$iv2.pushedIntMask == this_$iv2.createExpectedArgMask(operation$iv.getInts()) && this_$iv2.pushedObjectMask == this_$iv2.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushEndCompositionScope(Function1<? super Composition, Unit> action, Composition composition) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushEndCompositionScope_u24lambda_u2410 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.EndCompositionScope endCompositionScope = Operation.EndCompositionScope.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushEndCompositionScope_u24lambda_u2410, Operation.ObjectParameter.m3729constructorimpl(0), action);
        Operation.EndCompositionScope endCompositionScope2 = Operation.EndCompositionScope.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushEndCompositionScope_u24lambda_u2410, Operation.ObjectParameter.m3729constructorimpl(1), composition);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final <T, V> void pushUpdateNode(V value, Function2<? super T, ? super V, Unit> block) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushUpdateNode_u24lambda_u2411 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.UpdateNode updateNode = Operation.UpdateNode.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushUpdateNode_u24lambda_u2411, Operation.ObjectParameter.m3729constructorimpl(0), value);
        Operation.UpdateNode updateNode2 = Operation.UpdateNode.INSTANCE;
        int iM3729constructorimpl = Operation.ObjectParameter.m3729constructorimpl(1);
        ...
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushUpdateNode_u24lambda_u2411, iM3729constructorimpl, (Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(block, 2));
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushRemoveNode(int removeFrom, int moveCount) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushRemoveNode_u24lambda_u2412 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.RemoveNode removeNode = Operation.RemoveNode.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushRemoveNode_u24lambda_u2412, Operation.IntParameter.m3718constructorimpl(0), removeFrom);
        Operation.RemoveNode removeNode2 = Operation.RemoveNode.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushRemoveNode_u24lambda_u2412, Operation.IntParameter.m3718constructorimpl(1), moveCount);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushMoveNode(int to, int from, int count) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushMoveNode_u24lambda_u2413 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.MoveNode moveNode = Operation.MoveNode.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushMoveNode_u24lambda_u2413, Operation.IntParameter.m3718constructorimpl(1), to);
        Operation.MoveNode moveNode2 = Operation.MoveNode.INSTANCE;
        int i = 0;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushMoveNode_u24lambda_u2413, Operation.IntParameter.m3718constructorimpl(0), from);
        Operation.MoveNode moveNode3 = Operation.MoveNode.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushMoveNode_u24lambda_u2413, Operation.IntParameter.m3718constructorimpl(2), count);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushAdvanceSlotsBy(int distance) {
        ...
        this_$iv2.pushOp(operation$iv);
        Operations $this$pushAdvanceSlotsBy_u24lambda_u2414 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.AdvanceSlotsBy advanceSlotsBy = Operation.AdvanceSlotsBy.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushAdvanceSlotsBy_u24lambda_u2414, Operation.IntParameter.m3718constructorimpl(0), distance);
        boolean value$iv$iv = this_$iv2.pushedIntMask == this_$iv2.createExpectedArgMask(operation$iv.getInts()) && this_$iv2.pushedObjectMask == this_$iv2.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushUps(int count) {
        ...
        this_$iv2.pushOp(operation$iv);
        Operations $this$pushUps_u24lambda_u2415 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.Ups ups = Operation.Ups.INSTANCE;
        Operations.WriteScope.m3766setIntA6tL2VI($this$pushUps_u24lambda_u2415, Operation.IntParameter.m3718constructorimpl(0), count);
        boolean value$iv$iv = this_$iv2.pushedIntMask == this_$iv2.createExpectedArgMask(operation$iv.getInts()) && this_$iv2.pushedObjectMask == this_$iv2.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushDowns(Object[] nodes) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushDowns_u24lambda_u2416 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.Downs downs = Operation.Downs.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushDowns_u24lambda_u2416, Operation.ObjectParameter.m3729constructorimpl(0), nodes);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushSideEffect(Function0<Unit> effect) {
        ...
        this_$iv2.pushOp(operation$iv);
        Operations $this$pushSideEffect_u24lambda_u2417 = Operations.WriteScope.m3761constructorimpl(this_$iv2);
        Operation.SideEffect sideEffect = Operation.SideEffect.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushSideEffect_u24lambda_u2417, Operation.ObjectParameter.m3729constructorimpl(0), effect);
        boolean value$iv$iv = this_$iv2.pushedIntMask == this_$iv2.createExpectedArgMask(operation$iv.getInts()) && this_$iv2.pushedObjectMask == this_$iv2.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushDetermineMovableContentNodeIndex(IntRef effectiveNodeIndexOut, Anchor anchor) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushDetermineMovableContentNodeIndex_u24lambda_u2418 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        ...
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushDetermineMovableContentNodeIndex_u24lambda_u2418, Operation.ObjectParameter.m3729constructorimpl(0), effectiveNodeIndexOut);
        ...
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushDetermineMovableContentNodeIndex_u24lambda_u2418, Operation.ObjectParameter.m3729constructorimpl(1), anchor);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushCopyNodesToNewAnchorLocation(List<? extends Object> nodes, IntRef effectiveNodeIndex) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushCopyNodesToNewAnchorLocation_u24lambda_u2419 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.CopyNodesToNewAnchorLocation copyNodesToNewAnchorLocation = Operation.CopyNodesToNewAnchorLocation.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushCopyNodesToNewAnchorLocation_u24lambda_u2419, Operation.ObjectParameter.m3729constructorimpl(1), nodes);
        Operation.CopyNodesToNewAnchorLocation copyNodesToNewAnchorLocation2 = Operation.CopyNodesToNewAnchorLocation.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushCopyNodesToNewAnchorLocation_u24lambda_u2419, Operation.ObjectParameter.m3729constructorimpl(0), effectiveNodeIndex);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushCopySlotTableToAnchorLocation(MovableContentState resolvedState, CompositionContext parentContext, MovableContentStateReference from, MovableContentStateReference to) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushCopySlotTableToAnchorLocation_u24lambda_u2420 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushCopySlotTableToAnchorLocation_u24lambda_u2420, Operation.ObjectParameter.m3729constructorimpl(0), resolvedState);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation2 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushCopySlotTableToAnchorLocation_u24lambda_u2420, Operation.ObjectParameter.m3729constructorimpl(1), parentContext);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation3 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushCopySlotTableToAnchorLocation_u24lambda_u2420, Operation.ObjectParameter.m3729constructorimpl(3), to);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation4 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushCopySlotTableToAnchorLocation_u24lambda_u2420, Operation.ObjectParameter.m3729constructorimpl(2), from);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushReleaseMovableGroupAtCurrent(ControlledComposition composition, CompositionContext parentContext, MovableContentStateReference reference) {
        ...
        this_$iv.pushOp(operation$iv);
        Operations $this$pushReleaseMovableGroupAtCurrent_u24lambda_u2421 = Operations.WriteScope.m3761constructorimpl(this_$iv);
        Operation.ReleaseMovableGroupAtCurrent releaseMovableGroupAtCurrent = Operation.ReleaseMovableGroupAtCurrent.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushReleaseMovableGroupAtCurrent_u24lambda_u2421, Operation.ObjectParameter.m3729constructorimpl(0), composition);
        Operation.ReleaseMovableGroupAtCurrent releaseMovableGroupAtCurrent2 = Operation.ReleaseMovableGroupAtCurrent.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushReleaseMovableGroupAtCurrent_u24lambda_u2421, Operation.ObjectParameter.m3729constructorimpl(1), parentContext);
        Operation.ReleaseMovableGroupAtCurrent releaseMovableGroupAtCurrent3 = Operation.ReleaseMovableGroupAtCurrent.INSTANCE;
        Operations.WriteScope.m3767setObjectDKhxnng($this$pushReleaseMovableGroupAtCurrent_u24lambda_u2421, Operation.ObjectParameter.m3729constructorimpl(2), reference);
        boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
        if (value$iv$iv) {
            return;
        }
    ...
    public final void pushExecuteOperationsIn(ChangeList changeList, IntRef effectiveNodeIndex) {
        ...
        if (changeList.isNotEmpty()) {
            ...
            this_$iv.pushOp(operation$iv);
            Operations $this$pushExecuteOperationsIn_u24lambda_u2422 = Operations.WriteScope.m3761constructorimpl(this_$iv);
            Operation.ApplyChangeList applyChangeList = Operation.ApplyChangeList.INSTANCE;
            Operations.WriteScope.m3767setObjectDKhxnng($this$pushExecuteOperationsIn_u24lambda_u2422, Operation.ObjectParameter.m3729constructorimpl(0), changeList);
            Operation.ApplyChangeList applyChangeList2 = Operation.ApplyChangeList.INSTANCE;
            Operations.WriteScope.m3767setObjectDKhxnng($this$pushExecuteOperationsIn_u24lambda_u2422, Operation.ObjectParameter.m3729constructorimpl(1), effectiveNodeIndex);
            boolean value$iv$iv = this_$iv.pushedIntMask == this_$iv.createExpectedArgMask(operation$iv.getInts()) && this_$iv.pushedObjectMask == this_$iv.createExpectedArgMask(operation$iv.getObjects());
            if (value$iv$iv) {
                return;
            }
