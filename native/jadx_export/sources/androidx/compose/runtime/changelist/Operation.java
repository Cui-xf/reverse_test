...
public abstract class Operation {
    ...
    public String mo3690intParamNamew8GmfQM(int parameter) {
        return "IntParameter(" + parameter + ')';
    }

    /* renamed from: objectParamName-31yXWZQ, reason: not valid java name */
    public String mo3691objectParamName31yXWZQ(int parameter) {
    ...
    public static final class IntParameter {
        ...
        public static final /* synthetic */ IntParameter m3717boximpl(int i) {
            return new IntParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m3718constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3719equalsimpl(int i, Object obj) {
            return (obj instanceof IntParameter) && i == ((IntParameter) obj).m3723unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m3719equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m3721hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3722toStringimpl(this.offset);
        }
    ...
    public static final class ObjectParameter<T> {
        ...
        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ ObjectParameter m3728boximpl(int i) {
            return new ObjectParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static <T> int m3729constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3730equalsimpl(int i, Object obj) {
            return (obj instanceof ObjectParameter) && i == ((ObjectParameter) obj).m3734unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m3730equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m3732hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3733toStringimpl(this.offset);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ int m3734unboximpl() {
            return this.offset;
        }
    ...
    public static final class Ups extends Operation {
        ...
        public final int m3753getCountjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3690intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(0)) ? "count" : super.mo3690intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            int iMo3754getIntw8GmfQM = $this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0));
            for (int i = 0; i < iMo3754getIntw8GmfQM; i++) {
                applier.up();
            }
        }
    }
    ...
    public static final class Downs extends Operation {
        ...
        public final int m3705getNodesHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "nodes" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            Object[] nodes = (Object[]) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
    ...
    public static final class AdvanceSlotsBy extends Operation {
        ...
        public final int m3692getDistancejn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3690intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(0)) ? "distance" : super.mo3690intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            slots.advanceBy($this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0)));
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        public final int m3743getEffectHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "effect" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            rememberManager.sideEffect((Function0) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0)));
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "value" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            rememberManager.remembering((RememberObserver) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0)));
        }
    }
    ...
    public static final class AppendValue extends Operation {
        ...
        public final int m3693getAnchorHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3694getValueHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "anchor" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "value" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            Anchor anchor = (Anchor) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            Object value = $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
    ...
    public static final class TrimParentValues extends Operation {
        ...
        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3744getCountjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            int count = $this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0));
    ...
    public static final class UpdateValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3752getValueHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m3751getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3690intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(0)) ? "groupSlotIndex" : super.mo3690intParamNamew8GmfQM(parameter);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            Object value = $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            int groupSlotIndex = $this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0));
            if (value instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) value).getWrapped());
            }
    ...
    public static final class UpdateAnchoredValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3747getValueHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3745getAnchorHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m3746getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }
        ...
        public String mo3691objectParamName31yXWZQ(int parameter) {
            UpdateAnchoredValue updateAnchoredValue = INSTANCE;
            if (ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0))) {
                return "value";
            }
            UpdateAnchoredValue updateAnchoredValue2 = INSTANCE;
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "anchor" : super.mo3691objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            ...
            Object value = $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            UpdateAnchoredValue updateAnchoredValue2 = INSTANCE;
            Anchor anchor = (Anchor) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        public final int m3748getDataHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "data" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            slots.updateAux($this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0)));
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3708getAnchorHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "anchor" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            slots.ensureStarted((Anchor) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0)));
        }
    }
    ...
    public static final class MoveCurrentGroup extends Operation {
        ...
        public final int m3724getOffsetjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3690intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(0)) ? "offset" : super.mo3690intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            slots.moveGroup($this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0)));
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        public final int m3706getActionHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m3707getCompositionHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "anchor" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "composition" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            Function1 action = (Function1) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            Composition composition = (Composition) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
    ...
    public static final class UpdateNode extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m3750getValueHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getBlock-HpuvwBQ, reason: not valid java name */
        public final int m3749getBlockHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "value" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "block" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            Object value = $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            Function2 block = (Function2) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
    ...
    public static final class RemoveNode extends Operation {
        ...
        public final int m3742getRemoveIndexjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3741getCountjn0FJLE() {
            return IntParameter.m3718constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3690intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(0)) ? "removeIndex" : IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(1)) ? "count" : super.mo3690intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            applier.remove($this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0)), $this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(1)));
        }
    }
    ...
    public static final class MoveNode extends Operation {
        ...
        public final int m3726getFromjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }

        /* renamed from: getTo-jn0FJLE, reason: not valid java name */
        public final int m3727getTojn0FJLE() {
            return IntParameter.m3718constructorimpl(1);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m3725getCountjn0FJLE() {
            return IntParameter.m3718constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo3690intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(0)) ? "from" : IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(1)) ? "to" : IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(2)) ? "count" : super.mo3690intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            applier.move($this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0)), $this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(1)), $this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(2)));
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3712getAnchorHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m3713getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "anchor" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "from" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            SlotTable insertTable = (SlotTable) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
            Anchor anchor = (Anchor) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            slots.beginInsert();
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3714getAnchorHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m3716getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }

        /* renamed from: getFixups-HpuvwBQ, reason: not valid java name */
        public final int m3715getFixupsHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "anchor" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "from" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(2)) ? "fixups" : super.mo3691objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            SlotTable insertTable = (SlotTable) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
            Anchor anchor = (Anchor) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            FixupList fixups = (FixupList) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(2));
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        public final int m3709getFactoryHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m3711getInsertIndexjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3710getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo3690intParamNamew8GmfQM(int parameter) {
            return IntParameter.m3720equalsimpl0(parameter, IntParameter.m3718constructorimpl(0)) ? "insertIndex" : super.mo3690intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "factory" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "groupAnchor" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            Object node = ((Function0) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0))).invoke();
            Anchor groupAnchor = (Anchor) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
            int insertIndex = $this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m3736getInsertIndexjn0FJLE() {
            return IntParameter.m3718constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3735getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "groupAnchor" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            Anchor groupAnchor = (Anchor) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            int insertIndex = $this$execute.mo3754getIntw8GmfQM(IntParameter.m3718constructorimpl(0));
            applier.up();
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        public final int m3704getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m3703getAnchorHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "effectiveNodeIndexOut" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "anchor" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            IntRef effectiveNodeIndexOut = (IntRef) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
            Anchor anchor = (Anchor) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "effectiveNodeIndex" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "nodes" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            int effectiveNodeIndex = ((IntRef) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0))).getElement();
            List nodesToInsert = (List) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        public final int m3701getResolvedStateHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m3700getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }

        /* renamed from: getFrom-HpuvwBQ, reason: not valid java name */
        public final int m3699getFromHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(2);
        }

        /* renamed from: getTo-HpuvwBQ, reason: not valid java name */
        public final int m3702getToHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(3);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "resolvedState" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "resolvedCompositionContext" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(2)) ? "from" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(3)) ? "to" : super.mo3691objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) throws Throwable {
            MovableContentStateReference from = (MovableContentStateReference) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(2));
            MovableContentStateReference to = (MovableContentStateReference) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(3));
            CompositionContext parentCompositionContext = (CompositionContext) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
            MovableContentState resolvedState = (MovableContentState) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m3737getCompositionHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m3738getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }

        /* renamed from: getReference-HpuvwBQ, reason: not valid java name */
        public final int m3739getReferenceHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(2);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "composition" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "parentCompositionContext" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(2)) ? "reference" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) throws Throwable {
            OperationKt.releaseMovableGroupAtCurrent((ControlledComposition) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0)), (CompositionContext) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1)), (MovableContentStateReference) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(2)), slots);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        public final int m3695getChangesHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(0);
        }

        /* renamed from: getEffectiveNodeIndex-HpuvwBQ, reason: not valid java name */
        public final int m3696getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3729constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo3691objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(0)) ? "changes" : ObjectParameter.m3731equalsimpl0(parameter, ObjectParameter.m3729constructorimpl(1)) ? "effectiveNodeIndex" : super.mo3691objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer $this$execute, Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
            OffsetApplier offsetApplier;
            IntRef intRef = (IntRef) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(1));
            int effectiveNodeIndex = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) $this$execute.mo3755getObject31yXWZQ(ObjectParameter.m3729constructorimpl(0));
    ...
    public static final class TestOperation extends Operation {
        ...
        public TestOperation(int ints, int objects, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i = 0; i < ints; i++) {
                int index = i;
                arrayList.add(IntParameter.m3717boximpl(IntParameter.m3718constructorimpl(index)));
            }
            this.intParams = arrayList;
            ArrayList arrayList2 = new ArrayList(objects);
            for (int i2 = 0; i2 < objects; i2++) {
                int index2 = i2;
                arrayList2.add(ObjectParameter.m3728boximpl(ObjectParameter.m3729constructorimpl(index2)));
            }
