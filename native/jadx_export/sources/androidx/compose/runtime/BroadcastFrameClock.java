    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                objM6999constructorimpl = Result.m6999constructorimpl($this$resume_u24lambda_u240.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6999constructorimpl = Result.m6999constructorimpl(ResultKt.createFailure(th));
            }
            continuation.resumeWith(objM6999constructorimpl);
        }
    }
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (lock$iv) {
            ...
            if (cause == null) {
                ...
                Result.Companion companion = Result.INSTANCE;
                co.resumeWith(Result.m6999constructorimpl(ResultKt.createFailure(cause)));
            }
        }
    ...
    public final void fail(Throwable cause) {
        ...
        synchronized (lock$iv) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                Result.Companion companion = Result.INSTANCE;
                continuation.resumeWith(Result.m6999constructorimpl(ResultKt.createFailure(cause)));
            }
            this.awaiters.clear();
            this.hasAwaitersUnlocked.set(0);
            Unit unit = Unit.INSTANCE;
