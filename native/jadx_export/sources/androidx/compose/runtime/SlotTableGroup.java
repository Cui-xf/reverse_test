...
final class SlotTableGroup implements CompositionGroup, Iterable<CompositionGroup>, KMappedMarker {
    ...
    public Object getKey() {
        boolean zHasObjectKey = SlotTableKt.hasObjectKey(this.table.getGroups(), this.group);
        ...
        return Integer.valueOf(SlotTableKt.key(slotTable.getGroups(), this.group));
    }

    @Override // androidx.compose.runtime.tooling.CompositionGroup
    public String getSourceInfo() {
        boolean zHasAux = SlotTableKt.hasAux(this.table.getGroups(), this.group);
        SlotTable slotTable = this.table;
        if (zHasAux) {
            Object obj = slotTable.getSlots()[SlotTableKt.auxIndex(this.table.getGroups(), this.group)];
            if (obj instanceof String) {
                return (String) obj;
            }
            return null;
        }
        GroupSourceInformation groupSourceInformationSourceInformationOf = slotTable.sourceInformationOf(this.group);
