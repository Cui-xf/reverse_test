...
public class MutableSnapshot extends Snapshot {
    ...
    /* JADX WARN: Removed duplicated region for block: B:44:0x0115 A[LOOP:1: B:43:0x0113->B:44:0x0115, LOOP_END] */
    ...
    */
    ...
    public void dispose() {
        if (!getDisposed()) {
            super.dispose();
            mo3774nestedDeactivated$runtime_release(this);
        }
    }
    ...
    public void mo3773nestedActivated$runtime_release(Snapshot snapshot) {
        this.snapshots++;
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    /* renamed from: nestedDeactivated$runtime_release */
    public void mo3774nestedDeactivated$runtime_release(Snapshot snapshot) {
    ...
    public void mo3775recordModified$runtime_release(StateObject state) {
