...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m3776boximpl(int i) {
        return new ReaderKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3777constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3779equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m3785unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3780equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3781hashCodeimpl(int i) {
        return i;
    }
    ...
    public int hashCode() {
        return m3781hashCodeimpl(this.mask);
    }

    public String toString() {
        return m3783toStringimpl(this.mask);
    }
    ...
    public static /* synthetic */ int m3778constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m3777constructorimpl(i);
    }
    ...
    public static final int m3784withReadIn3QSx2Dw(int arg0, int reader) {
        return m3777constructorimpl(arg0 | reader);
    }

    /* renamed from: isReadIn-h_f27i8, reason: not valid java name */
    public static final boolean m3782isReadInh_f27i8(int arg0, int reader) {
    ...
    public static final class Companion {
        ...
        public final int m3786getComposition6f8NoZ8() {
            return ReaderKind.m3777constructorimpl(1);
        }

        /* renamed from: getSnapshotStateObserver-6f8NoZ8, reason: not valid java name */
        public final int m3788getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m3777constructorimpl(2);
        }

        /* renamed from: getSnapshotFlow-6f8NoZ8, reason: not valid java name */
        public final int m3787getSnapshotFlow6f8NoZ8() {
            return ReaderKind.m3777constructorimpl(4);
        }
    }
}
