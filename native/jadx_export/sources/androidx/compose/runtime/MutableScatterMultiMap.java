...
final class MutableScatterMultiMap<K, V> {
    ...
    public static final /* synthetic */ MutableScatterMultiMap m3658boximpl(MutableScatterMap mutableScatterMap) {
        return new MutableScatterMultiMap(mutableScatterMap);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <K, V> MutableScatterMap<K, Object> m3659constructorimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return mutableScatterMap;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3660equalsimpl(MutableScatterMap<K, Object> mutableScatterMap, Object obj) {
    ...
    public static final boolean m3661equalsimpl0(MutableScatterMap<K, Object> mutableScatterMap, MutableScatterMap<K, Object> mutableScatterMap2) {
        return Intrinsics.areEqual(mutableScatterMap, mutableScatterMap2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3662hashCodeimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return mutableScatterMap.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3665toStringimpl(MutableScatterMap<K, Object> mutableScatterMap) {
        return "MutableScatterMultiMap(map=" + mutableScatterMap + ')';
    }

    public boolean equals(Object obj) {
        return m3660equalsimpl(this.map, obj);
    }

    public int hashCode() {
        return m3662hashCodeimpl(this.map);
    }

    public String toString() {
        return m3665toStringimpl(this.map);
    }
    ...
    public static final void m3664putimpl(MutableScatterMap<K, Object> mutableScatterMap, K k, V v) {
        ...
        if (z) {
            ...
            mutableScatterMap.values[i] = objMutableListOf;
            return;
        }
        mutableScatterMap.values[iFindInsertIndex] = objMutableListOf;
    }

    /* renamed from: pop-impl, reason: not valid java name */
    public static final V m3663popimpl(MutableScatterMap<K, Object> mutableScatterMap, K k) {
        V v;
