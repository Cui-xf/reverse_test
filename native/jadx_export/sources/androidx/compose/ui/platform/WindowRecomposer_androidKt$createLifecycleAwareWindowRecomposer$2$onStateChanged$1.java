...
final class WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Not initialized variable reg: 4, insn: 0x0089: IF  (r4 I:??[int, boolean, OBJECT, ARRAY, byte, short, char] A[D('durationScaleJob' kotlinx.coroutines.Job)]) == (0 ??[int, boolean, OBJECT, ARRAY, byte, short, char])  -> B:25:0x008e, block:B:23:0x0089 */
        ...
        try {
            switch (r1) {
                case 0:
                    ...
                    if (it != null) {
                        StateFlow durationScaleStateFlow = WindowRecomposer_androidKt.getAnimationScaleFlowFor(windowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1.$this_createLifecycleAwareWindowRecomposer.getContext().getApplicationContext());
                    ...
                    durationScaleJob2 = jobLaunch$default;
