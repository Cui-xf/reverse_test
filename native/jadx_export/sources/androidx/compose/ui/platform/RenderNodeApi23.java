...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m4275getAutoNrFUSI();
    private int left;
    ...
    public void mo5888setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m4271equalsimpl0(value, CompositingStrategy.INSTANCE.m4277getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else {
            boolean zM4271equalsimpl0 = CompositingStrategy.m4271equalsimpl0(value, CompositingStrategy.INSTANCE.m4276getModulateAlphaNrFUSI());
            RenderNode renderNode = this.renderNode;
            if (zM4271equalsimpl0) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m4271equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m4277getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.CC.m4159clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, null);
        }
