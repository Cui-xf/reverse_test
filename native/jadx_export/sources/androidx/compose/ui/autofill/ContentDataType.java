...
public final class ContentDataType {
    ...
    private static final int Text = m3804constructorimpl(1);
    private static final int List = m3804constructorimpl(3);
    private static final int Date = m3804constructorimpl(4);
    private static final int Toggle = m3804constructorimpl(2);
    private static final int None = m3804constructorimpl(0);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ContentDataType m3803boximpl(int i) {
        return new ContentDataType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3804constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3805equalsimpl(int i, Object obj) {
        return (obj instanceof ContentDataType) && i == ((ContentDataType) obj).m3809unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m3805equalsimpl(this.dataType, obj);
    }

    public int hashCode() {
        return m3807hashCodeimpl(this.dataType);
    }

    public String toString() {
        return m3808toStringimpl(this.dataType);
    }
