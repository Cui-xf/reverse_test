...
public final class AndroidContentCaptureManager implements ContentCaptureManager, DefaultLifecycleObserver, View.OnAttachStateChangeListener {
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x0072 A[Catch: all -> 0x00af, TryCatch #1 {all -> 0x00af, blocks: (B:24:0x006a, B:26:0x0072, B:28:0x007b, B:29:0x007e, B:31:0x0082, B:32:0x008b), top: B:46:0x006a }] */
    /* JADX WARN: Removed duplicated region for block: B:37:0x00a6  */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0014  */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:35:0x00a0 -> B:20:0x0056). Please report as a decompilation issue!!! */
    /*
    ...
    */
    ...
    private final ViewStructureCompat toViewStructure(SemanticsNode $this$toViewStructure) {
        ...
        if (role != null && (it = SemanticsUtils_androidKt.m5929toLegacyClassNameV4PA4sw(role.getValue())) != null) {
        ...
        if (it6 != null) {
            ...
            float px = TextUnit.m6890getValueimpl(input.getStyle().m6177getFontSizeXSAIIZE()) * input.getDensity().getDensity() * input.getDensity().getFontScale();
