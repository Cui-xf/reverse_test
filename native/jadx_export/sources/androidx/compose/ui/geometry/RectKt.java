...
public final class RectKt {
    ...
    public static final Rect m3985Recttz77jQw(long offset, long size) {
        return new Rect(Offset.m3945getXimpl(offset), Offset.m3946getYimpl(offset), Offset.m3945getXimpl(offset) + Size.m4014getWidthimpl(size), Offset.m3946getYimpl(offset) + Size.m4011getHeightimpl(size));
    }

    /* renamed from: Rect-0a9Yr6o, reason: not valid java name */
    public static final Rect m3983Rect0a9Yr6o(long topLeft, long bottomRight) {
        return new Rect(Offset.m3945getXimpl(topLeft), Offset.m3946getYimpl(topLeft), Offset.m3945getXimpl(bottomRight), Offset.m3946getYimpl(bottomRight));
    }

    /* renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m3984Rect3MmeM6k(long center, float radius) {
        return new Rect(Offset.m3945getXimpl(center) - radius, Offset.m3946getYimpl(center) - radius, Offset.m3945getXimpl(center) + radius, Offset.m3946getYimpl(center) + radius);
    }
