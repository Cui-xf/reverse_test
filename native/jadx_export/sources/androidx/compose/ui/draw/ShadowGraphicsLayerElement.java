...
public final /* data */ class ShadowGraphicsLayerElement extends ModifierNodeElement<BlockGraphicsLayerModifier> {
    ...
    public static /* synthetic */ ShadowGraphicsLayerElement m3841copygNMxBKI$default(ShadowGraphicsLayerElement shadowGraphicsLayerElement, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        long j3 = j2;
        boolean z2 = z;
        return shadowGraphicsLayerElement.m3845copygNMxBKI(f, shape, z2, j, j3);
    }
    ...
    public final ShadowGraphicsLayerElement m3845copygNMxBKI(float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6698equalsimpl0(this.elevation, shadowGraphicsLayerElement.elevation) && Intrinsics.areEqual(this.shape, shadowGraphicsLayerElement.shape) && this.clip == shadowGraphicsLayerElement.clip && Color.m4188equalsimpl0(this.ambientColor, shadowGraphicsLayerElement.ambientColor) && Color.m4188equalsimpl0(this.spotColor, shadowGraphicsLayerElement.spotColor);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m6699hashCodeimpl(this.elevation) * 31) + this.shape.hashCode()) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.clip)) * 31) + Color.m4194hashCodeimpl(this.ambientColor)) * 31) + Color.m4194hashCodeimpl(this.spotColor);
    }

    public String toString() {
        return "ShadowGraphicsLayerElement(elevation=" + ((Object) Dp.m6704toStringimpl(this.elevation)) + ", shape=" + this.shape + ", clip=" + this.clip + ", ambientColor=" + ((Object) Color.m4195toStringimpl(this.ambientColor)) + ", spotColor=" + ((Object) Color.m4195toStringimpl(this.spotColor)) + ')';
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m3847getElevationD9Ej5fM() {
        return this.elevation;
    }
    ...
    public final long m3846getAmbientColor0d7_KjU() {
        return this.ambientColor;
    }

    /* renamed from: getSpotColor-0d7_KjU, reason: not valid java name */
    public final long m3848getSpotColor0d7_KjU() {
        return this.spotColor;
    }
    ...
    private final Function1<GraphicsLayerScope, Unit> createBlock() {
        return new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowGraphicsLayerElement.createBlock.1
            ...
            public final void invoke2(GraphicsLayerScope $this$null) {
                $this$null.setShadowElevation($this$null.mo367toPx0680j_4(ShadowGraphicsLayerElement.this.m3847getElevationD9Ej5fM()));
                $this$null.setShape(ShadowGraphicsLayerElement.this.getShape());
                $this$null.setClip(ShadowGraphicsLayerElement.this.getClip());
                $this$null.mo4357setAmbientShadowColor8_81llA(ShadowGraphicsLayerElement.this.m3846getAmbientColor0d7_KjU());
                $this$null.mo4359setSpotShadowColor8_81llA(ShadowGraphicsLayerElement.this.m3848getSpotColor0d7_KjU());
            }
        };
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("elevation", Dp.m6691boximpl(this.elevation));
        ...
        $this$inspectableProperties.getProperties().set("ambientColor", Color.m4177boximpl(this.ambientColor));
        $this$inspectableProperties.getProperties().set("spotColor", Color.m4177boximpl(this.spotColor));
    }
}
