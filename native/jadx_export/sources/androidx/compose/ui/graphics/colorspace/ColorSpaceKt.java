...
public final class ColorSpaceKt {
    ...
    private static final Connector m4614createConnectorYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
        if (source == destination) {
            return Connector.INSTANCE.identity$ui_graphics_release(source);
        }
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (ColorModel.m4601equalsimpl0(source.getModel(), ColorModel.INSTANCE.m4608getRgbxdoWZVw()) && ColorModel.m4601equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m4608getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m4613connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m4629getPerceptualuksYyKA();
        }
        return m4612connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m4612connectYBCOT_4(ColorSpace $this$connect_u2dYBCOT_4, ColorSpace destination, int intent) {
        int srcId = $this$connect_u2dYBCOT_4.getId();
        int dstId = destination.getId();
        if ((srcId | dstId) < 0) {
            return m4614createConnectorYBCOT_4($this$connect_u2dYBCOT_4, destination, intent);
        }
        MutableIntObjectMap this_$iv = ConnectorKt.getConnectors();
        int i = (dstId << 6) | srcId | (intent << 12);
        Connector connectorM4614createConnectorYBCOT_4 = this_$iv.get(i);
        if (connectorM4614createConnectorYBCOT_4 == null) {
            connectorM4614createConnectorYBCOT_4 = m4614createConnectorYBCOT_4($this$connect_u2dYBCOT_4, destination, intent);
            this_$iv.set(i, connectorM4614createConnectorYBCOT_4);
        }
        return connectorM4614createConnectorYBCOT_4;
    }
    ...
    public static final ColorSpace adapt(ColorSpace $this$adapt, WhitePoint whitePoint, Adaptation adaptation) {
        if (ColorModel.m4601equalsimpl0($this$adapt.getModel(), ColorModel.INSTANCE.m4608getRgbxdoWZVw())) {
