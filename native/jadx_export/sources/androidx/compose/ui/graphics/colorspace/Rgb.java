...
public final class Rgb extends ColorSpace {
    ...
    public Rgb(String name, float[] primaries, WhitePoint whitePoint, float[] transform, DoubleFunction oetf, DoubleFunction eotf, float min, float max, TransferParameters transferParameters, int id) {
        super(name, ColorModel.INSTANCE.m4608getRgbxdoWZVw(), id, null);
    ...
    */
    public Rgb(java.lang.String r12, float[] r13, androidx.compose.ui.graphics.colorspace.WhitePoint r14, final androidx.compose.ui.graphics.colorspace.TransferParameters r15, int r16) {
        ...
        L42:
            if (r2 == 0) goto L4b
            androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda11 r1 = new androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda11
            r1.<init>()
            r6 = r1
            goto L51
        L4b:
            androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda12 r1 = new androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda12
            r1.<init>()
            r6 = r1
        L51:
            r4 = 0
    ...
    public long mo4611xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
