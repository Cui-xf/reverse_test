...
public final class ConnectorKt {
    ...
    static {
        ...
        int renderIntent$iv = RenderIntent.INSTANCE.m4629getPerceptualuksYyKA();
        ...
        int renderIntent$iv2 = RenderIntent.INSTANCE.m4629getPerceptualuksYyKA();
        int i2 = (dst$iv2 << 6) | src$iv2 | (renderIntent$iv2 << 12);
        DefaultConstructorMarker defaultConstructorMarker = null;
        Connector connector = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.INSTANCE.m4629getPerceptualuksYyKA(), defaultConstructorMarker);
        int src$iv3 = ColorSpaces.INSTANCE.getOklab().getId();
        int dst$iv3 = ColorSpaces.INSTANCE.getSrgb().getId();
        int renderIntent$iv3 = RenderIntent.INSTANCE.m4629getPerceptualuksYyKA();
        Connectors = IntObjectMapKt.mutableIntObjectMapOf(i, connectorIdentity$ui_graphics_release, i2, connector, (renderIntent$iv3 << 12) | (dst$iv3 << 6) | src$iv3, new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.INSTANCE.m4629getPerceptualuksYyKA(), defaultConstructorMarker));
    }
    ...
    public static final int m4620connectorKeyYBCOT_4(int src, int dst, int renderIntent) {
