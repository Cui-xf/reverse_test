...
public final class PaintingStyle {
    ...
    private static final int Fill = m4454constructorimpl(0);
    private static final int Stroke = m4454constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m4453boximpl(int i) {
        return new PaintingStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4454constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4455equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4456equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4457hashCodeimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m4460getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m4461getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4458toStringimpl(int arg0) {
        return m4456equalsimpl0(arg0, Fill) ? "Fill" : m4456equalsimpl0(arg0, Stroke) ? "Stroke" : "Unknown";
    }
