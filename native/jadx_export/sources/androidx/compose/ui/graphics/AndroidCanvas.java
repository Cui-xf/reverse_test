...
public final class AndroidCanvas implements Canvas {
    ...
    public /* synthetic */ void mo4041clipRectmtrdDE(androidx.compose.ui.geometry.Rect rect, int i) {
        Canvas.CC.m4157$default$clipRectmtrdDE(this, rect, i);
    }
    ...
    public void mo4042concat58bKbWc(float[] matrix) {
        if (!MatrixKt.m4448isIdentity58bKbWc(matrix)) {
            android.graphics.Matrix frameworkMatrix = new android.graphics.Matrix();
            AndroidMatrixConversions_androidKt.m4057setFromEL8BTi8(frameworkMatrix, matrix);
    ...
    public void mo4040clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m4050toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo4039clipPathmtrdDE(Path path, int clipOp) {
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m4050toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m4050toRegionOp7u2Bmg(int $this$toRegionOp_u2d_u2d7u2Bmg) {
        return ClipOp.m4171equalsimpl0($this$toRegionOp_u2d_u2d7u2Bmg, ClipOp.INSTANCE.m4175getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo4046drawLineWko1d7g(long p1, long p2, Paint paint) {
        this.internalCanvas.drawLine(Offset.m3945getXimpl(p1), Offset.m3946getYimpl(p1), Offset.m3945getXimpl(p2), Offset.m3946getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo4043drawCircle9KIMszo(long center, float radius, Paint paint) {
        this.internalCanvas.drawCircle(Offset.m3945getXimpl(center), Offset.m3946getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo4044drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m3945getXimpl(topLeftOffset), Offset.m3946getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo4045drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m6825getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m6826getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m6825getXimpl(srcOffset) + IntSize.m6867getWidthimpl(srcSize);
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m6826getYimpl(srcOffset) + IntSize.m6866getHeightimpl(srcSize);
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m6825getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m6826getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m6825getXimpl(dstOffset) + IntSize.m6867getWidthimpl(dstSize);
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m6826getYimpl(dstOffset) + IntSize.m6866getHeightimpl(dstSize);
    ...
    public void mo4047drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        if (!PointMode.m4495equalsimpl0(pointMode, PointMode.INSTANCE.m4499getLinesr_lszbg())) {
            if (!PointMode.m4495equalsimpl0(pointMode, PointMode.INSTANCE.m4501getPolygonr_lszbg())) {
                if (PointMode.m4495equalsimpl0(pointMode, PointMode.INSTANCE.m4500getPointsr_lszbg())) {
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            this.internalCanvas.drawPoint(Offset.m3945getXimpl(point), Offset.m3946getYimpl(point), paint.getInternalPaint());
        }
    }
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m3945getXimpl(p1), Offset.m3946getYimpl(p1), Offset.m3945getXimpl(p2), Offset.m3946getYimpl(p2), frameworkPaint);
                i += stepBy;
            }
        }
    }
    ...
    public void mo4048drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
    ...
    public void mo4049drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m4093toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
}
