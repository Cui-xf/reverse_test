...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m4572boximpl(long j) {
        return new TransformOrigin(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4575constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4578equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4579equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m4582hashCodeimpl(long j) {
        return FloatFloatPair$$ExternalSyntheticBackport0.m(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4583toStringimpl(long j) {
        return "TransformOrigin(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m4578equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4582hashCodeimpl(this.packedValue);
    }
    ...
    public static final float m4580getPivotFractionXimpl(long arg0) {
        int bits$iv$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: getPivotFractionY-impl, reason: not valid java name */
    public static final float m4581getPivotFractionYimpl(long arg0) {
        int bits$iv$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m4573component1impl(long arg0) {
        return m4580getPivotFractionXimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m4574component2impl(long arg0) {
        return m4581getPivotFractionYimpl(arg0);
    }

    /* renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m4577copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m4580getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m4581getPivotFractionYimpl(j);
        }
        return m4576copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m4576copyzey9I6w(long arg0, float pivotFractionX, float pivotFractionY) {
    ...
    public static final class Companion {
        ...
        public final long m4585getCenterSzJe1aQ() {
