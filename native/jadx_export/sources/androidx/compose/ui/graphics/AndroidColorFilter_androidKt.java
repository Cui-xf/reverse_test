...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m4053actualTintColorFilterxETnrds(long color, int blendMode) {
        if (Build.VERSION.SDK_INT >= 29) {
            android.graphics.ColorFilter androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m4133BlendModeColorFilterxETnrds(color, blendMode);
            return androidColorFilter;
        }
        android.graphics.ColorFilter androidColorFilter2 = new PorterDuffColorFilter(ColorKt.m4241toArgb8_81llA(color), AndroidBlendMode_androidKt.m4038toPorterDuffModes9anfk8(blendMode));
        return androidColorFilter2;
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final android.graphics.ColorFilter m4051actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        return new android.graphics.ColorMatrixColorFilter(colorMatrix);
    }

    /* renamed from: actualLightingColorFilter--OWjLjI, reason: not valid java name */
    public static final android.graphics.ColorFilter m4052actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new android.graphics.LightingColorFilter(ColorKt.m4241toArgb8_81llA(multiply), ColorKt.m4241toArgb8_81llA(add));
    }
    ...
    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter filter) {
        if ((filter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m4267getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) filter);
        }
