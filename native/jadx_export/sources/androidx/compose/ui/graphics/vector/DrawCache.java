...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m6872getZeroYbymL2g();
    private int config = ImageBitmapConfig.INSTANCE.m4414getArgb8888_sVssgQ();
    ...
    public final void m4876drawCachedImageFqjB98A(int config, long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap targetImage = this.mCachedImage;
        Canvas targetCanvas = this.cachedCanvas;
        if (targetImage == null || targetCanvas == null || IntSize.m6867getWidthimpl(size) > targetImage.getWidth() || IntSize.m6866getHeightimpl(size) > targetImage.getHeight() || !ImageBitmapConfig.m4409equalsimpl0(this.config, config)) {
            targetImage = ImageBitmapKt.m4419ImageBitmapx__hDU$default(IntSize.m6867getWidthimpl(size), IntSize.m6866getHeightimpl(size), config, false, null, 24, null);
        ...
        long size$iv = IntSizeKt.m6879toSizeozmzZPI(size);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.CC.m4736drawImageAZ2fEMs$default(target, targetImage, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope $this$clear) {
        DrawScope.CC.m4747drawRectnJ9OG0$default($this$clear, Color.INSTANCE.m4213getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m4102getClear0nO6VwU(), 62, null);
    }
}
