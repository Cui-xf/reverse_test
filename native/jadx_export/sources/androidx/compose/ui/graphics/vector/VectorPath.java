...
public final class VectorPath extends VectorNode {
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.strokeLineWidth == ((VectorPath) other).strokeLineWidth) || !StrokeCap.m4543equalsimpl0(this.strokeLineCap, ((VectorPath) other).strokeLineCap) || !StrokeJoin.m4553equalsimpl0(this.strokeLineJoin, ((VectorPath) other).strokeLineJoin)) {
            return false;
        }
        ...
        if ((this.trimPathOffset == ((VectorPath) other).trimPathOffset) && PathFillType.m4472equalsimpl0(this.pathFillType, ((VectorPath) other).pathFillType) && Intrinsics.areEqual(this.pathData, ((VectorPath) other).pathData)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((result3 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.floatToIntBits(this.strokeAlpha)) * 31) + Float.floatToIntBits(this.strokeLineWidth)) * 31) + StrokeCap.m4544hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m4554hashCodeimpl(this.strokeLineJoin)) * 31) + Float.floatToIntBits(this.strokeLineMiter)) * 31) + Float.floatToIntBits(this.trimPathStart)) * 31) + Float.floatToIntBits(this.trimPathEnd)) * 31) + Float.floatToIntBits(this.trimPathOffset)) * 31) + PathFillType.m4473hashCodeimpl(this.pathFillType);
    }
}
