...
public final class PathComponent extends VNode {
    ...
    public final void m4890setPathFillTypeoQ8Xj4U(int value) {
        this.pathFillType = value;
        this.renderPath.mo4080setFillTypeoQ8Xj4U(value);
        invalidate();
    }
    ...
    public final void m4891setStrokeLineCapBeK7IIE(int value) {
    ...
    public final void m4892setStrokeLineJoinWw9F2mQ(int value) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int fillType = this.renderPath.mo4078getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo4080setFillTypeoQ8Xj4U(fillType);
        }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        Brush it = this.fill;
        if (it != null) {
            DrawScope.CC.m4742drawPathGBMwjPU$default($this$draw, this.renderPath, it, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (it2 != null) {
            ...
            DrawScope.CC.m4742drawPathGBMwjPU$default($this$draw, this.renderPath, it2, this.strokeAlpha, targetStroke, null, 0, 48, null);
        }
    }
