...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m4223getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m4877markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m4877markTintForColor8_81llA(long color) {
        if (!this.isTintable) {
            return;
        }
        if (color != 16) {
            ...
            } else if (!VectorKt.m4900rgbEqualOWjLjI(this.tintColor, color)) {
                markNotTintable();
            }
        }
    }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (((GroupComponent) node).isTintable && this.isTintable) {
                m4877markTintForColor8_81llA(((GroupComponent) node).tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        ...
        if (target == null) {
            float[] matrix2 = Matrix.m4424constructorimpl$default(null, 1, null);
            this.groupMatrix = matrix2;
            matrix = matrix2;
        } else {
            Matrix.m4433resetimpl(target);
            matrix = target;
        }
        Matrix.m4444translateimpl$default(matrix, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m4436rotateZimpl(matrix, this.rotation);
        Matrix.m4437scaleimpl(matrix, this.scaleX, this.scaleY, 1.0f);
        Matrix.m4444translateimpl$default(matrix, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope $this$draw) throws Throwable {
        ...
        try {
            ...
            if (fArr != null) {
                float[] it = (fArr != null ? Matrix.m4422boximpl(fArr) : null).m4445unboximpl();
                $this$draw_u24lambda_u244.mo4677transform58bKbWc(it);
            }
            Path targetClip = this.clipPath;
            if (getWillClipPath() && targetClip != null) {
                DrawTransform.CC.m4806clipPathmtrdDE$default($this$draw_u24lambda_u244, targetClip, 0, 2, null);
            }
