...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4547getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4558getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m4127getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m4222getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4477getNonZeroRgk1Os();
    ...
    public static final boolean m4900rgbEqualOWjLjI(long $this$rgbEqual_u2d_u2dOWjLjI, long other) {
        if (Color.m4193getRedimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4193getRedimpl(other)) {
            if (Color.m4192getGreenimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4192getGreenimpl(other)) {
                if (Color.m4190getBlueimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4190getBlueimpl(other)) {
                    return true;
                }
            }
        }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter $this$tintableWithAlphaMask) {
        return $this$tintableWithAlphaMask instanceof BlendModeColorFilter ? BlendMode.m4098equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m4127getSrcIn0nO6VwU()) || BlendMode.m4098equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m4129getSrcOver0nO6VwU()) : $this$tintableWithAlphaMask == null;
    }
}
