...
public final class PathHitTester {
    ...
    public final boolean m4478containsk4lQ0M(long position) {
        boolean isInverse;
        boolean isInverse2 = false;
        if (!this.path.isEmpty() && this.bounds.m3971containsk4lQ0M(position)) {
            ...
            boolean isEvenOdd = PathFillType.m4472equalsimpl0(this.path.mo4078getFillTypeRgk1Os(), PathFillType.INSTANCE.m4476getEvenOddRgk1Os());
            if (isEvenOdd) {
                winding &= 1;
            }
            if (winding != 0) {
