...
public final class StrokeJoin {
    ...
    private static final int Miter = m4551constructorimpl(0);
    private static final int Round = m4551constructorimpl(1);
    private static final int Bevel = m4551constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m4550boximpl(int i) {
        return new StrokeJoin(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4551constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m4558getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8, reason: not valid java name */
        public final int m4559getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8, reason: not valid java name */
        public final int m4557getBevelLxFBmk8() {
    ...
    public static String m4555toStringimpl(int arg0) {
        return m4553equalsimpl0(arg0, Miter) ? "Miter" : m4553equalsimpl0(arg0, Round) ? "Round" : m4553equalsimpl0(arg0, Bevel) ? "Bevel" : "Unknown";
    }
