...
final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        int iM4275getAutoNrFUSI;
        if ((i2 & 65536) == 0) {
            iM4275getAutoNrFUSI = i;
        } else {
            iM4275getAutoNrFUSI = CompositingStrategy.INSTANCE.m4275getAutoNrFUSI();
        }
        this(f, f2, f3, f4, f5, f6, f7, f8, f9, f10, j, shape, z, renderEffect, j2, j3, iM4275getAutoNrFUSI, null);
    }
    ...
    public final void m4528setTransformOrigin__ExYCQ(long j) {
    ...
    public final void m4525setAmbientShadowColor8_81llA(long j) {
    ...
    public final void m4527setSpotShadowColor8_81llA(long j) {
    ...
    public final void m4526setCompositingStrategyaDBOjCE(int i) {
    ...
    private SimpleGraphicsLayerModifier(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope $this$null) {
                ...
                $this$null.mo4360setTransformOrigin__ExYCQ(this.this$0.getTransformOrigin());
                ...
                $this$null.mo4357setAmbientShadowColor8_81llA(this.this$0.getAmbientShadowColor());
                $this$null.mo4359setSpotShadowColor8_81llA(this.this$0.getSpotShadowColor());
                $this$null.mo4358setCompositingStrategyaDBOjCE(this.this$0.getCompositingStrategy());
            }
        };
    }
    ...
    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped = DelegatableNodeKt.m5664requireCoordinator64DMado(this, NodeKind.m5778constructorimpl(2)).getWrapped();
        if (wrapped != null) {
    ...
    public MeasureResult mo86measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$measure$1
