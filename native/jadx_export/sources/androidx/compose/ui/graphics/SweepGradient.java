...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo4156createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m3966isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m4024getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset((Offset.m3945getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m3945getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m4014getWidthimpl(size) : Offset.m3945getXimpl(this.center), Offset.m3946getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m4011getHeightimpl(size) : Offset.m3946getYimpl(this.center));
        }
        return ShaderKt.m4513SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SweepGradient) && Offset.m3942equalsimpl0(this.center, ((SweepGradient) other).center) && Intrinsics.areEqual(this.colors, ((SweepGradient) other).colors) && Intrinsics.areEqual(this.stops, ((SweepGradient) other).stops);
    }

    public int hashCode() {
        int result = Offset.m3947hashCodeimpl(this.center);
