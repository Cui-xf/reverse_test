...
public interface Canvas {
    ...
    void mo4039clipPathmtrdDE(Path path, int clipOp);

    /* renamed from: clipRect-N_I0leg */
    void mo4040clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* renamed from: clipRect-mtrdD-E */
    void mo4041clipRectmtrdDE(Rect rect, int clipOp);

    /* renamed from: concat-58bKbWc */
    void mo4042concat58bKbWc(float[] matrix);
    ...
    void mo4043drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo4044drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo4045drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo4046drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo4047drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo4048drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo4049drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m4161clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-mtrdD-E");
            }
            if ((i2 & 2) != 0) {
                i = ClipOp.INSTANCE.m4176getIntersectrtfAjoo();
            }
            canvas.mo4041clipRectmtrdDE(rect, i);
        }

        /* renamed from: $default$clipRect-mtrdD-E, reason: not valid java name */
        public static void m4157$default$clipRectmtrdDE(Canvas _this, Rect rect, int clipOp) {
            _this.mo4040clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
        }

        /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
        public static /* synthetic */ void m4160clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            int iM4176getIntersectrtfAjoo;
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-N_I0leg");
            }
            if ((i2 & 16) == 0) {
                iM4176getIntersectrtfAjoo = i;
            } else {
                iM4176getIntersectrtfAjoo = ClipOp.INSTANCE.m4176getIntersectrtfAjoo();
            }
            canvas.mo4040clipRectN_I0leg(f, f2, f3, f4, iM4176getIntersectrtfAjoo);
        }

        /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
        public static /* synthetic */ void m4159clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo4039clipPathmtrdDE(path, i);
        }
        ...
        public static /* synthetic */ void m4162drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
            }
            long jM6835getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m6835getZeronOccac() : j;
            long jIntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
            canvas.mo4045drawImageRectHPBpro0(imageBitmap, jM6835getZeronOccac, jIntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m6835getZeronOccac() : j3, (i & 16) != 0 ? jIntSize : j4, paint);
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static void m4165clipRectmtrdDE(Canvas $this, Rect rect, int clipOp) {
            CC.m4157$default$clipRectmtrdDE($this, rect, clipOp);
        }
