...
public final class RootMeasurePolicy extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult mo34measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        if (list.isEmpty()) {
            return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, Constraints.m6638getMinWidthimpl(constraints), Constraints.m6637getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$1
        ...
        if (list.size() == 1) {
            final Placeable placeable = list.get(0).mo5535measureBRTryo0(constraints);
            return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, ConstraintsKt.m6653constrainWidthK40F9xA(constraints, placeable.getWidth()), ConstraintsKt.m6652constrainHeightK40F9xA(constraints, placeable.getHeight()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$2
                {
                    super(1);
                }
        ...
        return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, ConstraintsKt.m6653constrainWidthK40F9xA(constraints, maxWidth), ConstraintsKt.m6652constrainHeightK40F9xA(constraints, maxHeight), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$4
