    ...
    public final /* synthetic */ class CC {
        public static int $default$minIntrinsicWidth(MultiContentMeasurePolicy _this, IntrinsicMeasureScope $this$minIntrinsicWidth, List measurables, int height) {
            ...
            while (index$iv$iv < size) {
                ...
                ArrayList target$iv2 = new ArrayList(list.size());
                List $this$fastForEach$iv$iv2 = list;
            ...
            MeasureResult layoutResult = _this.mo629measure3p2s80s(layoutReceiver, mapped, constraints);
