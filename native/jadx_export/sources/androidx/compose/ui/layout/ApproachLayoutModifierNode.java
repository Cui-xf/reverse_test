...
public interface ApproachLayoutModifierNode extends LayoutModifierNode {
    ...
    MeasureResult mo98approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j);

    /* renamed from: isMeasurementApproachInProgress-ozmzZPI */
    boolean mo99isMeasurementApproachInProgressozmzZPI(long lookaheadSize);
    ...
    public final /* synthetic */ class CC {
        public static boolean $default$isPlacementApproachInProgress(ApproachLayoutModifierNode _this, Placeable.PlacementScope $this$isPlacementApproachInProgress, LayoutCoordinates lookaheadCoordinates) {
            return false;
        }

        /* renamed from: $default$measure-3p2s80s, reason: not valid java name */
        public static MeasureResult m5510$default$measure3p2s80s(ApproachLayoutModifierNode _this, MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
            final Placeable $this$measure_3p2s80s_u24lambda_u240 = measurable.mo5535measureBRTryo0(constraints);
            return MeasureScope.CC.layout$default($this$measure_u2d3p2s80s, $this$measure_3p2s80s_u24lambda_u240.getWidth(), $this$measure_3p2s80s_u24lambda_u240.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.ApproachLayoutModifierNode$measure$1$1
                {
                    super(1);
                }
