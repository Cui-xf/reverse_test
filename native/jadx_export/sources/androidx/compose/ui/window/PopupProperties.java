...
public final class PopupProperties {
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.inheritSecurePolicy)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.dismissOnBackPress)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.dismissOnClickOutside)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.excludeFromSystemGesture)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.usePlatformDefaultWidth);
    }
}
