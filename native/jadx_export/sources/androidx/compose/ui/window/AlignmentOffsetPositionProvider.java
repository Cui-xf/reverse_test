...
public final class AlignmentOffsetPositionProvider implements PopupPositionProvider {
    ...
    public long mo339calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long anchorAlignmentPoint = this.alignment.mo3791alignKFBX0sM(IntSize.INSTANCE.m6872getZeroYbymL2g(), anchorBounds.m6851getSizeYbymL2g(), layoutDirection);
        long popupAlignmentPoint = IntOffset.m6833unaryMinusnOccac(this.alignment.mo3791alignKFBX0sM(IntSize.INSTANCE.m6872getZeroYbymL2g(), popupContentSize, layoutDirection));
        long resolvedUserOffset = IntOffsetKt.IntOffset(IntOffset.m6825getXimpl(this.offset) * (layoutDirection == LayoutDirection.Ltr ? 1 : -1), IntOffset.m6826getYimpl(this.offset));
        return IntOffset.m6829plusqkQi6aY(IntOffset.m6829plusqkQi6aY(IntOffset.m6829plusqkQi6aY(anchorBounds.m6853getTopLeftnOccac(), anchorAlignmentPoint), popupAlignmentPoint), resolvedUserOffset);
    }
}
