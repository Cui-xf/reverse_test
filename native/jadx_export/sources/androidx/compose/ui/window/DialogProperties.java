...
public final class DialogProperties {
    ...
    public int hashCode() {
        int result = ChangeSize$$ExternalSyntheticBackport0.m(this.dismissOnBackPress);
        return (((((((result * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.dismissOnClickOutside)) * 31) + this.securePolicy.hashCode()) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.usePlatformDefaultWidth)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.decorFitsSystemWindows);
    }
}
