...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo3791alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        float centerX = (IntSize.m6867getWidthimpl(space) - IntSize.m6867getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m6866getHeightimpl(space) - IntSize.m6866getHeightimpl(size)) / 2.0f;
