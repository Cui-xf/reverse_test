...
public final class SemanticsNode {
    ...
    public final long m5967getSizeYbymL2g() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        return nodeCoordinatorFindCoordinatorToGetBounds$ui_release != null ? nodeCoordinatorFindCoordinatorToGetBounds$ui_release.mo5537getSizeYbymL2g() : IntSize.INSTANCE.m6872getZeroYbymL2g();
    }
    ...
    public final long m5964getPositionInRootF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final long m5965getPositionInWindowF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final long m5966getPositionOnScreenF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final Rect getBoundsInParent$ui_release() {
        ...
        if (it != null) {
            ...
            if (it != null && (currentCoordinates = it.getCoordinates()) != null) {
                return LayoutCoordinates.CC.localBoundingBoxOf$default(DelegatableNodeKt.m5664requireCoordinator64DMado(parent.outerSemanticsNode, NodeKind.m5778constructorimpl(8)), currentCoordinates, false, 2, null);
            }
        }
        return Rect.INSTANCE.getZero();
    }
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode $this$fillOneLayerOfSemanticsWrappers, List<SemanticsNode> list, boolean includeDeactivatedNodes) {
        ...
        do {
            ...
            if (child.isAttached() && (includeDeactivatedNodes || !child.getIsDeactivated())) {
                if (child.getNodes().m5739hasH91voCI$ui_release(NodeKind.m5778constructorimpl(8))) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        ...
        return DelegatableNodeKt.m5664requireCoordinator64DMado(semanticsModifierNode, NodeKind.m5778constructorimpl(8));
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (nodeRole != null && this.unmergedConfig.getIsMergingSemanticsOfDescendants() && !unmergedChildren.isEmpty()) {
            SemanticsNode fakeNode = m5963fakeSemanticsNodeypyhhiA(nodeRole, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver $this$fakeSemanticsNode) {
                    SemanticsPropertiesKt.m5975setRolekuIjeqM($this$fakeSemanticsNode, nodeRole.getValue());
                }
            });
        ...
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && !unmergedChildren.isEmpty() && this.unmergedConfig.getIsMergingSemanticsOfDescendants()) {
            ...
            if (contentDescription != null) {
                SemanticsNode fakeNode2 = m5963fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m5963fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {
