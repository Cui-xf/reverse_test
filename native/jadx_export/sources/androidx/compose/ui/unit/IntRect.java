...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m6843getSizeYbymL2g$annotations() {
    }
    ...
    public final long m6851getSizeYbymL2g() {
    ...
    public final IntRect m6855translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m6825getXimpl(offset), this.top + IntOffset.m6826getYimpl(offset), this.right + IntOffset.m6825getXimpl(offset), this.bottom + IntOffset.m6826getYimpl(offset));
    }
