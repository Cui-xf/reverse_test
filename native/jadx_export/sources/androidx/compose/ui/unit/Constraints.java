...
public final class Constraints {
    ...
    public static int m6639hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m6639hashCodeimpl(this.value);
    }
    ...
    private static final int m6630getFocusIndeximpl(long arg0) {
        return (int) (3 & arg0);
    }

    /* renamed from: getMinWidth-impl, reason: not valid java name */
    public static final int m6638getMinWidthimpl(long arg0) {
        int i = (int) (3 & arg0);
    ...
    public static final int m6636getMaxWidthimpl(long arg0) {
        int i = (int) (3 & arg0);
        int bitOffset$iv = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int mask = (1 << (bitOffset$iv + 13)) - 1;
    ...
    public static final int m6637getMinHeightimpl(long arg0) {
        int i = (int) (3 & arg0);
    ...
    public static final int m6635getMaxHeightimpl(long arg0) {
        int i = (int) (3 & arg0);
        int bitOffset = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int mask = (1 << (18 - bitOffset)) - 1;
        int $i$f$minHeightOffsets = bitOffset + 15;
    ...
    public static final boolean m6632getHasBoundedWidthimpl(long arg0) {
        int i = (int) (3 & arg0);
        int bitOffset$iv = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int mask = (1 << (bitOffset$iv + 13)) - 1;
    ...
    public static final boolean m6631getHasBoundedHeightimpl(long arg0) {
        int i = (int) (3 & arg0);
        int bitOffset = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int mask = (1 << (18 - bitOffset)) - 1;
        int $i$f$minHeightOffsets = bitOffset + 15;
    ...
    public static final boolean m6634getHasFixedWidthimpl(long arg0) {
        int i = (int) (3 & arg0);
        int bitOffset$iv = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int mask = (1 << (bitOffset$iv + 13)) - 1;
    ...
    public static final boolean m6633getHasFixedHeightimpl(long arg0) {
        int i = (int) (3 & arg0);
        int bitOffset = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int mask = (1 << (18 - bitOffset)) - 1;
        int $i$f$minHeightOffsets = bitOffset + 15;
    ...
    public static final boolean m6640isZeroimpl(long arg0) {
        int i = (int) (3 & arg0);
        int bitOffset = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int $i$f$widthMask = ((int) (arg0 >> 33)) & ((1 << (bitOffset + 13)) - 1);
        int maxWidth = $i$f$widthMask - 1;
        if (maxWidth == 0) {
            return true;
        }
        int $i$f$minHeightOffsets = bitOffset + 15;
        int offset = $i$f$minHeightOffsets + 31;
        int $i$f$heightMask = ((int) (arg0 >> offset)) & ((1 << (18 - bitOffset)) - 1);
        int maxHeight = $i$f$heightMask - 1;
        return maxHeight == 0;
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m6626copyZbe2FdA(long arg0, int minWidth, int maxWidth, int minHeight, int maxHeight) {
    ...
    public String toString() {
        return m6641toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6641toStringimpl(long arg0) {
        int maxWidth = m6636getMaxWidthimpl(arg0);
        String maxWidthStr = maxWidth == Integer.MAX_VALUE ? "Infinity" : String.valueOf(maxWidth);
        int maxHeight = m6635getMaxHeightimpl(arg0);
        String maxHeightStr = maxHeight != Integer.MAX_VALUE ? String.valueOf(maxHeight) : "Infinity";
        return "Constraints(minWidth = " + m6638getMinWidthimpl(arg0) + ", maxWidth = " + maxWidthStr + ", minHeight = " + m6637getMinHeightimpl(arg0) + ", maxHeight = " + maxHeightStr + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m6646fixedJhjzzOo(int width, int height) {
        ...
        public final long m6648fixedWidthOenEA2s(int width) {
        ...
        public final long m6647fixedHeightOenEA2s(int height) {
        ...
        public final long m6649restrictConstraintsxF2OJ5Q(int minWidth, int maxWidth, int minHeight, int maxHeight, boolean prioritizeWidth) {
            if (prioritizeWidth) {
                return m6645fitPrioritizingWidthZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
            }
            return m6644fitPrioritizingHeightZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
        }

        /* renamed from: fitPrioritizingWidth-Zbe2FdA, reason: not valid java name */
        public final long m6645fitPrioritizingWidthZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            int maxW;
        ...
        public final long m6644fitPrioritizingHeightZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            int maxH;
