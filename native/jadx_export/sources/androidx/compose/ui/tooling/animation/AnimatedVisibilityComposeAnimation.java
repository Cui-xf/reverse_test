...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    private final Set<AnimatedVisibilityState> states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m6615boximpl(AnimatedVisibilityState.INSTANCE.m6622getEnterjXw82LU()), AnimatedVisibilityState.m6615boximpl(AnimatedVisibilityState.INSTANCE.m6623getExitjXw82LU())});
    ...
    public Transition<Boolean> m6608getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m6608getAnimationObject().getTransitions(), 0);
