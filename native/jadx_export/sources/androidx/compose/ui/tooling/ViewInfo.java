...
public final /* data */ class ViewInfo {
    ...
    public int hashCode() {
        return (((((((((this.fileName.hashCode() * 31) + this.lineNumber) * 31) + this.bounds.hashCode()) * 31) + (this.location == null ? 0 : this.location.hashCode())) * 31) + this.children.hashCode()) * 31) + (this.layoutInfo != null ? this.layoutInfo.hashCode() : 0);
    }
