...
public final class SlotTreeKt {
    ...
    */
    private static final androidx.compose.ui.tooling.data.SourceInformationContext sourceInformationContextOf(java.lang.String r17, androidx.compose.ui.tooling.data.SourceInformationContext r18) throws androidx.compose.ui.tooling.data.ParseError {
        /*
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = coordinates.mo5537getSizeYbymL2g();
        int left = MathKt.roundToInt(Offset.m3945getXimpl(position));
        int top = MathKt.roundToInt(Offset.m3946getYimpl(position));
        int right = IntSize.m6867getWidthimpl(size) + left;
        int bottom = IntSize.m6866getHeightimpl(size) + top;
                    ...
                    if (blockField != null && (block = blockField.get(element$iv)) != null) {
                        ...
                        while (i2 < size) {
                            ...
                            if (metadata.getSortedIndex() >= fields.size()) {
                                ...
                                Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
                                parameters.add(new ParameterInformation(strSubstring, value, fromDefault, z, compared2 && !fromDefault, metadata.getInlineClass(), stable));
                            }
                            i2++;
                            block = block2;
                        }
