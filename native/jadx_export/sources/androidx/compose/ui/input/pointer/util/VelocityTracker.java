...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        ...
        this.currentPointerPositionAccumulator = Offset.INSTANCE.m3961getZeroF1C5BW0();
    }
    ...
    public final void m5507setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m5503addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m3945getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m3946getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m5504calculateVelocity9UxMQ8M() {
        return m5505calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m5505calculateVelocityAH228Gc(long maximumVelocity) {
        boolean value$iv = Velocity.m6934getXimpl(maximumVelocity) > 0.0f && Velocity.m6935getYimpl(maximumVelocity) > 0.0f;
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m6941toStringimpl(maximumVelocity)));
        }
        float velocityX = this.xVelocityTracker.calculateVelocity(Velocity.m6934getXimpl(maximumVelocity));
        float velocityY = this.yVelocityTracker.calculateVelocity(Velocity.m6935getYimpl(maximumVelocity));
