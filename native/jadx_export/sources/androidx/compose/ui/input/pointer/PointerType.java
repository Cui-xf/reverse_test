...
public final class PointerType {
    ...
    private static final int Unknown = m5475constructorimpl(0);
    private static final int Touch = m5475constructorimpl(1);
    private static final int Mouse = m5475constructorimpl(2);
    private static final int Stylus = m5475constructorimpl(3);
    private static final int Eraser = m5475constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerType m5474boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m5475constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m5476equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5478hashCodeimpl(this.value);
    }
    ...
    public static String m5479toStringimpl(int arg0) {
        switch (arg0) {
            case 1:
                return "Touch";
            case 2:
    ...
    public String toString() {
        return m5479toStringimpl(this.value);
    }
