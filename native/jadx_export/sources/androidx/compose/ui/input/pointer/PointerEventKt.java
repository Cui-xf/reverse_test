...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange $this$positionChanged) {
        return !Offset.m3942equalsimpl0(positionChangeInternal($this$positionChanged, false), Offset.INSTANCE.m3961getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange $this$positionChangedIgnoreConsumed) {
        return true ^ Offset.m3942equalsimpl0(positionChangeInternal($this$positionChangedIgnoreConsumed, true), Offset.INSTANCE.m3961getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange $this$positionChangeInternal, boolean ignoreConsumed) {
        ...
        long offset = Offset.m3949minusMKHz9U(currentPosition, previousPosition);
        return (ignoreConsumed || !$this$positionChangeInternal.isConsumed()) ? offset : Offset.INSTANCE.m3961getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange $this$consumePositionChange) {
        if (!Offset.m3942equalsimpl0(positionChange($this$consumePositionChange), Offset.INSTANCE.m3961getZeroF1C5BW0())) {
    ...
    public static final boolean m5348isOutOfBoundsO0kMr_c(PointerInputChange $this$isOutOfBounds_u2dO0kMr_c, long size) {
    ...
    public static final boolean m5349isOutOfBoundsjwHxaWs(PointerInputChange $this$isOutOfBounds_u2djwHxaWs, long size, long extendedTouchPadding) {
        if (!PointerType.m5477equalsimpl0($this$isOutOfBounds_u2djwHxaWs.getType(), PointerType.INSTANCE.m5484getTouchT8wyACA())) {
            return m5348isOutOfBoundsO0kMr_c($this$isOutOfBounds_u2djwHxaWs, size);
        }
        long position = $this$isOutOfBounds_u2djwHxaWs.getPosition();
        float x = Offset.m3945getXimpl(position);
        float y = Offset.m3946getYimpl(position);
        float minX = -Size.m4014getWidthimpl(extendedTouchPadding);
        float maxX = IntSize.m6867getWidthimpl(size) + Size.m4014getWidthimpl(extendedTouchPadding);
        float minY = -Size.m4011getHeightimpl(extendedTouchPadding);
        float maxY = IntSize.m6866getHeightimpl(size) + Size.m4011getHeightimpl(extendedTouchPadding);
