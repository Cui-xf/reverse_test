...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope {
    ...
    private static final float[] tmpMatrix = Matrix.m4424constructorimpl$default(null, 1, null);
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public int mo5774entityTypeOLwlOKw() {
            return NodeKind.m5778constructorimpl(16);
        }
        ...
        public boolean interceptOutOfBoundsChildEvents(Modifier.Node node) {
            ...
            int kind$iv3 = NodeKind.m5778constructorimpl(16);
        ...
        public void mo5773childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            layoutNode.m5695hitTestM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public int mo5774entityTypeOLwlOKw() {
            return NodeKind.m5778constructorimpl(8);
        }
        ...
        public void mo5773childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            layoutNode.m5696hitTestSemanticsM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    private Density layerDensity = getLayoutNode().getDensity();
    private LayoutDirection layerLayoutDirection = getLayoutNode().getLayoutDirection();
    private float lastLayerAlpha = 0.8f;
    private long position = IntOffset.INSTANCE.m6835getZeronOccac();
    private final Function2<Canvas, GraphicsLayer, Unit> drawBlock = new Function2<Canvas, GraphicsLayer, Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$drawBlock$1
        ...
        public final void invoke2(final Canvas canvas, final GraphicsLayer parentLayer) {
            ...
            if (zIsPlaced) {
                OwnerSnapshotObserver snapshotObserver = nodeCoordinator.getSnapshotObserver();
                NodeCoordinator nodeCoordinator2 = this.this$0;
                Function1 function1 = NodeCoordinator.onCommitAffectingLayer;
                final NodeCoordinator nodeCoordinator3 = this.this$0;
                snapshotObserver.observeReads$ui_release(nodeCoordinator2, function1, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$drawBlock$1.1
                    ...
                    public final void invoke2() {
                        nodeCoordinator3.drawContainedDrawModifiers(canvas, parentLayer);
                    }
                });
    ...
    public interface HitTestSource {
        /* renamed from: childHitTest-YqVAtuI */
        void mo5773childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer);

        /* renamed from: entityType-OLwlOKw */
        int mo5774entityTypeOLwlOKw();
    ...
    public final /* synthetic */ <T> void m5771visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        int i;
        ...
        int i3 = 0;
        boolean includeTail$iv4 = NodeKindKt.m5787getIncludeSelfInTraversalH91voCI(type);
    ...
    private final boolean m5750hasNodeH91voCI(int type) {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m5787getIncludeSelfInTraversalH91voCI(type));
        return nodeHeadNode != null && DelegatableNodeKt.m5662has64DMado(nodeHeadNode, type);
    }

    /* renamed from: head-H91voCI, reason: not valid java name */
    public final Modifier.Node m5764headH91voCI(int type) {
        boolean includeTail$iv = NodeKindKt.m5787getIncludeSelfInTraversalH91voCI(type);
    ...
    public final long mo5537getSizeYbymL2g() {
    ...
    public void replace$ui_release() {
        ...
        if (explicitLayer != null) {
            mo5602placeAtf8xVGno(getPosition(), this.zIndex, explicitLayer);
        } else {
            mo5536placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
        }
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        if (layer4 != null) {
            layer4.mo5829resizeozmzZPI(IntSizeKt.IntSize(width, height));
        } else if (getLayoutNode().isPlaced() && (nodeCoordinator = this.wrappedBy) != null) {
            nodeCoordinator.invalidateLayer();
        }
        m5603setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
        if (this.layerBlock != null) {
            updateLayerParameters(false);
        }
        int type$iv4 = NodeKind.m5778constructorimpl(4);
        boolean includeTail$iv$iv = NodeKindKt.m5787getIncludeSelfInTraversalH91voCI(type$iv4);
    ...
    protected void m5769setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        ...
        MutableVector mutableVector;
        int i = 64;
        if (!getLayoutNode().getNodes().m5739hasH91voCI$ui_release(NodeKind.m5778constructorimpl(64))) {
            return null;
        }
        ...
        while (node$iv4 != null) {
            ...
            int kind$iv = (node.getKindSet() & NodeKind.m5778constructorimpl(i)) != 0 ? 1 : 0;
            if (kind$iv != 0) {
                int iM5778constructorimpl = NodeKind.m5778constructorimpl(i);
                MutableVector mutableVector2 = null;
                Modifier.Node nodePop = node;
                while (nodePop != null) {
                    if (nodePop instanceof ParentDataModifierNode) {
                        ...
                        Modifier.Node this_$iv$iv = nodePop;
                        if (((this_$iv$iv.getKindSet() & iM5778constructorimpl) != 0) && (nodePop instanceof DelegatingNode)) {
                            int count$iv2 = 0;
                            DelegatingNode this_$iv$iv2 = (DelegatingNode) nodePop;
                            Modifier.Node node$iv$iv = this_$iv$iv2.getDelegate();
                            while (node$iv$iv != null) {
                                Modifier.Node next$iv = node$iv$iv;
                                if ((next$iv.getKindSet() & iM5778constructorimpl) != 0) {
                                    count$iv2++;
                                    this_$iv3 = this_$iv4;
                                    if (count$iv2 == 1) {
                                        nodePop = next$iv;
    ...
    public final long m5762getLastMeasurementConstraintsmsEJaDk$ui_release() {
        return getMeasurementConstraints();
    }

    /* renamed from: performingMeasure-K40F9xA, reason: not valid java name */
    protected final Placeable m5767performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
        m5604setMeasurementConstraintsBRTryo0(constraints);
        return block.invoke();
    }
    ...
    public final void onMeasured() {
        ...
        if (nodeCoordinator.m5750hasNodeH91voCI(NodeKind.m5778constructorimpl(128))) {
            ...
            int i4 = 0;
            try {
                int type$iv2 = NodeKind.m5778constructorimpl(128);
                NodeCoordinator this_$iv4 = this;
                int i5 = 0;
                boolean includeTail$iv$iv = NodeKindKt.m5787getIncludeSelfInTraversalH91voCI(type$iv2);
                    ...
                    if ((node$iv$iv.getKindSet() & type$iv2) == 0) {
                        ...
                        while (nodePop != null) {
                            ...
                            if (nodePop instanceof LayoutAwareModifierNode) {
                                ...
                                this_$iv2 = this_$iv4;
                                i3 = i5;
                                it.mo357onRemeasuredozmzZPI(nodeCoordinator.getMeasuredSize());
                            } else {
                                this_$iv2 = this_$iv4;
                                i3 = i5;
                                Modifier.Node this_$iv$iv$iv = nodePop;
    ...
    public void mo5536placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (this.forcePlaceWithLookaheadOffset) {
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            m5754placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, layerBlock, null);
            return;
        }
        m5754placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public void mo5602placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        if (this.forcePlaceWithLookaheadOffset) {
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            m5754placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, null, layer);
            return;
        }
        m5754placeSelfMLgxB_4(position, zIndex, null, layer);
    }

    /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
    private final void m5754placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer explicitLayer) {
        if (explicitLayer == null) {
            ...
            if (this.layer == null) {
                ...
                $this$placeSelf_MLgxB_4_u24lambda_u2413.mo5829resizeozmzZPI(getMeasuredSize());
                $this$placeSelf_MLgxB_4_u24lambda_u2413.mo5828movegyyYBs(position);
                this.layer = $this$placeSelf_MLgxB_4_u24lambda_u2413;
                getLayoutNode().setInnerLayerCoordinatorIsDirty$ui_release(true);
                this.invalidateParentLayer.invoke();
            }
        }
        if (!IntOffset.m6824equalsimpl0(getPosition(), position)) {
            m5769setPositiongyyYBs(position);
            ...
            if (layer != null) {
                layer.mo5828movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m5768placeSelfApparentToRealOffsetMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        m5754placeSelfMLgxB_4(IntOffset.m6829plusqkQi6aY(position, getApparentToRealOffset()), zIndex, layerBlock, layer);
    }
    ...
    public final void draw(Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        float x = IntOffset.m6825getXimpl(getPosition());
        float y = IntOffset.m6826getYimpl(getPosition());
    ...
    public final void drawContainedDrawModifiers(Canvas canvas, GraphicsLayer graphicsLayer) {
        Modifier.Node head = m5764headH91voCI(NodeKind.m5778constructorimpl(4));
        if (head == null) {
            performDraw(canvas, graphicsLayer);
        } else {
            LayoutNodeDrawScope drawScope = getLayoutNode().getMDrawScope$ui_release();
            drawScope.m5705draweZhPAX0$ui_release(canvas, IntSizeKt.m6879toSizeozmzZPI(mo5537getSizeYbymL2g()), this, head, graphicsLayer);
        }
    }
    ...
    public final void onPlaced() {
        ...
        int i3;
        MutableVector mutableVector;
        int type$iv3 = NodeKind.m5778constructorimpl(128);
        NodeCoordinator this_$iv4 = this;
        int i4 = 0;
        boolean includeTail$iv$iv = NodeKindKt.m5787getIncludeSelfInTraversalH91voCI(type$iv3);
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (layoutNode.isAttached() && layerBlock != null) {
            ...
            if (this.layer == null) {
                OwnedLayer $this$updateLayerBlock_u24lambda_u2416 = Owner.CC.createLayer$default(LayoutNodeKt.requireOwner(layoutNode), this.drawBlock, this.invalidateParentLayer, null, 4, null);
                $this$updateLayerBlock_u24lambda_u2416.mo5829resizeozmzZPI(getMeasuredSize());
                $this$updateLayerBlock_u24lambda_u2416.mo5828movegyyYBs(getPosition());
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        if (layer != null) {
            ...
            if (layerBlock != null) {
                ...
                graphicsLayerScope.m4506setSizeuvyYCjk(IntSizeKt.m6879toSizeozmzZPI(mo5537getSizeYbymL2g()));
    ...
    public final long m5763getMinimumTouchTargetSizeNHjbRc() {
        Density $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2421 = this.layerDensity;
        return $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2421.mo368toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo5699getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* renamed from: hitTest-YqVAtuI, reason: not valid java name */
    public final void m5765hitTestYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Modifier.Node head = m5764headH91voCI(hitTestSource.mo5774entityTypeOLwlOKw());
        if (!m5772withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (isTouchEvent) {
                float distanceFromEdge = m5760distanceInMinimumTouchTargettz77jQw(pointerPosition, m5763getMinimumTouchTargetSizeNHjbRc());
                if (((Float.isInfinite(distanceFromEdge) || Float.isNaN(distanceFromEdge)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge, false)) {
                    m5752hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, false, distanceFromEdge);
                    return;
                }
                return;
            }
        ...
        if (head == null) {
            mo5686hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        if (m5766isPointerInBoundsk4lQ0M(pointerPosition)) {
            m5751hit1hIXUjU(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        float distanceFromEdge2 = !isTouchEvent ? Float.POSITIVE_INFINITY : m5760distanceInMinimumTouchTargettz77jQw(pointerPosition, m5763getMinimumTouchTargetSizeNHjbRc());
        if (((Float.isInfinite(distanceFromEdge2) || Float.isNaN(distanceFromEdge2)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge2, isInLayer)) {
            m5752hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
        } else {
            m5755speculativeHitJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: hit-1hIXUjU, reason: not valid java name */
    public final void m5751hit1hIXUjU(final Modifier.Node $this$hit_u2d1hIXUjU, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer) {
        if ($this$hit_u2d1hIXUjU == null) {
            ...
            hitTestResult.hit($this$hit_u2d1hIXUjU, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m5751hit1hIXUjU(NodeCoordinatorKt.m5776nextUntilhw7D004($this$hit_u2d1hIXUjU, hitTestSource.mo5774entityTypeOLwlOKw(), NodeKind.m5778constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
                }
            });
        }
    }
    ...
    public final void m5752hitNearJHbHoSQ(final Modifier.Node $this$hitNear_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        if ($this$hitNear_u2dJHbHoSQ == null) {
            ...
            hitTestResult.hitInMinimumTouchTarget($this$hitNear_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m5752hitNearJHbHoSQ(NodeCoordinatorKt.m5776nextUntilhw7D004($this$hitNear_u2dJHbHoSQ, hitTestSource.mo5774entityTypeOLwlOKw(), NodeKind.m5778constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        }
    }
    ...
    public final void m5755speculativeHitJHbHoSQ(final Modifier.Node $this$speculativeHit_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        if ($this$speculativeHit_u2dJHbHoSQ == null) {
            ...
            hitTestResult.speculativeHit($this$speculativeHit_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m5755speculativeHitJHbHoSQ(NodeCoordinatorKt.m5776nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo5774entityTypeOLwlOKw(), NodeKind.m5778constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        } else {
            m5755speculativeHitJHbHoSQ(NodeCoordinatorKt.m5776nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo5774entityTypeOLwlOKw(), NodeKind.m5778constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
        }
    }

    /* renamed from: hitTestChild-YqVAtuI */
    public void mo5686hitTestChildYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        NodeCoordinator wrapped = this.wrapped;
        if (wrapped != null) {
            long positionInWrapped = m5749fromParentPosition8S9VItk$default(wrapped, pointerPosition, false, 2, null);
            wrapped.m5765hitTestYqVAtuI(hitTestSource, positionInWrapped, hitTestResult, isTouchEvent, isInLayer);
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long padding = m5759calculateMinimumTouchTargetPaddingE7KxVPU(m5763getMinimumTouchTargetSizeNHjbRc());
        bounds.setLeft(-Size.m4014getWidthimpl(padding));
        bounds.setTop(-Size.m4011getHeightimpl(padding));
        bounds.setRight(getMeasuredWidth() + Size.m4014getWidthimpl(padding));
        bounds.setBottom(getMeasuredHeight() + Size.m4011getHeightimpl(padding));
    ...
    public long mo5543screenToLocalMKHz9U(long relativeToScreen) {
        boolean value$iv = isAttached();
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        long positionInRoot = owner.mo5488screenToLocalMKHz9U(relativeToScreen);
        LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
        return mo5538localPositionOfR5De75A(root, positionInRoot);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToScreen-MK-Hz9U */
    public long mo5541localToScreenMKHz9U(long relativeToLocal) {
        boolean value$iv = isAttached();
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        long positionInRoot = mo5540localToRootMKHz9U(relativeToLocal);
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        return owner.mo5487localToScreenMKHz9U(positionInRoot);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: windowToLocal-MK-Hz9U */
    public long mo5546windowToLocalMKHz9U(long relativeToWindow) {
        boolean value$iv = isAttached();
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
        long positionInRoot = Offset.m3949minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo5831calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(root));
        return mo5538localPositionOfR5De75A(root, positionInRoot);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo5542localToWindowMKHz9U(long relativeToLocal) {
        long positionInRoot = mo5540localToRootMKHz9U(relativeToLocal);
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        return owner.mo5832calculatePositionInWindowMKHz9U(positionInRoot);
    }
    ...
    public long mo5538localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        return mo5539localPositionOfS_NoaFU(sourceCoordinates, relativeToSource, true);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localPositionOf-S_NoaFU */
    public long mo5539localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        if (sourceCoordinates instanceof LookaheadLayoutCoordinates) {
            ((LookaheadLayoutCoordinates) sourceCoordinates).getCoordinator().onCoordinatesUsed$ui_release();
            return Offset.m3954unaryMinusF1C5BW0(sourceCoordinates.mo5539localPositionOfS_NoaFU(this, Offset.m3954unaryMinusF1C5BW0(relativeToSource), includeMotionFrameOfReference));
        }
        ...
        while (coordinator != commonAncestor) {
            position = coordinator.m5770toParentPosition8S9VItk(position, includeMotionFrameOfReference);
            NodeCoordinator nodeCoordinator2 = coordinator.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator2);
            coordinator = nodeCoordinator2;
        }
        return m5748ancestorToLocalS_NoaFU(commonAncestor, position, includeMotionFrameOfReference);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformFrom-EL8BTi8 */
    public void mo5544transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        ...
        Matrix.m4433resetimpl(matrix);
        coordinator.m5758transformToAncestorEL8BTi8(commonAncestor, matrix);
        m5757transformFromAncestorEL8BTi8(commonAncestor, matrix);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformToScreen-58bKbWc */
    public void mo5545transformToScreen58bKbWc(float[] matrix) {
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        NodeCoordinator rootCoordinator = toCoordinator(LayoutCoordinatesKt.findRootCoordinates(this));
        m5758transformToAncestorEL8BTi8(rootCoordinator, matrix);
        owner.mo5486localToScreen58bKbWc(matrix);
    }

    /* renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m5758transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator wrapper = this;
        while (!Intrinsics.areEqual(wrapper, ancestor)) {
            OwnedLayer ownedLayer = wrapper.layer;
            if (ownedLayer != null) {
                ownedLayer.mo5830transform58bKbWc(matrix);
            }
            long position = wrapper.getPosition();
            if (!IntOffset.m6824equalsimpl0(position, IntOffset.INSTANCE.m6835getZeronOccac())) {
                Matrix.m4433resetimpl(tmpMatrix);
                Matrix.m4444translateimpl$default(tmpMatrix, IntOffset.m6825getXimpl(position), IntOffset.m6826getYimpl(position), 0.0f, 4, null);
                Matrix.m4441timesAssign58bKbWc(matrix, tmpMatrix);
            }
    ...
    private final void m5757transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (!Intrinsics.areEqual(ancestor, this)) {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator);
            nodeCoordinator.m5757transformFromAncestorEL8BTi8(ancestor, matrix);
            if (!IntOffset.m6824equalsimpl0(getPosition(), IntOffset.INSTANCE.m6835getZeronOccac())) {
                Matrix.m4433resetimpl(tmpMatrix);
                Matrix.m4444translateimpl$default(tmpMatrix, -IntOffset.m6825getXimpl(getPosition()), -IntOffset.m6826getYimpl(getPosition()), 0.0f, 4, null);
                Matrix.m4441timesAssign58bKbWc(matrix, tmpMatrix);
            }
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo5825inverseTransform58bKbWc(matrix);
            }
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        bounds.setLeft(0.0f);
        bounds.setTop(0.0f);
        bounds.setRight(IntSize.m6867getWidthimpl(sourceCoordinates.mo5537getSizeYbymL2g()));
        bounds.setBottom(IntSize.m6866getHeightimpl(sourceCoordinates.mo5537getSizeYbymL2g()));
    ...
    private final long m5748ancestorToLocalS_NoaFU(NodeCoordinator ancestor, long offset, boolean includeMotionFrameOfReference) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator wrappedBy = this.wrappedBy;
        if (wrappedBy == null || Intrinsics.areEqual(ancestor, wrappedBy)) {
            return m5761fromParentPosition8S9VItk(offset, includeMotionFrameOfReference);
        }
        return m5761fromParentPosition8S9VItk(wrappedBy.m5748ancestorToLocalS_NoaFU(ancestor, offset, includeMotionFrameOfReference), includeMotionFrameOfReference);
    }
    ...
    public long mo5540localToRootMKHz9U(long relativeToLocal) {
        boolean value$iv = isAttached();
        if (!value$iv) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        ...
        for (NodeCoordinator coordinator = this; coordinator != null; coordinator = coordinator.wrappedBy) {
            position = m5756toParentPosition8S9VItk$default(coordinator, position, false, 2, null);
        }
        return position;
    }
    ...
    public static /* synthetic */ long m5756toParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m5770toParentPosition8S9VItk(j, z);
    }

    /* renamed from: toParentPosition-8S9VItk, reason: not valid java name */
    public long m5770toParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        OwnedLayer layer = this.layer;
        long targetPosition = layer != null ? layer.mo5827mapOffset8S9VItk(position, false) : position;
        if (!includeMotionFrameOfReference && getIsPlacedUnderMotionFrameOfReference()) {
            return targetPosition;
        }
        return IntOffsetKt.m6839plusNvtHpc(targetPosition, getPosition());
    }

    /* renamed from: fromParentPosition-8S9VItk$default, reason: not valid java name */
    public static /* synthetic */ long m5749fromParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m5761fromParentPosition8S9VItk(j, z);
    }

    /* renamed from: fromParentPosition-8S9VItk, reason: not valid java name */
    public long m5761fromParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        long relativeToPosition;
        if (!includeMotionFrameOfReference && getIsPlacedUnderMotionFrameOfReference()) {
            relativeToPosition = position;
        } else {
            relativeToPosition = IntOffsetKt.m6837minusNvtHpc(position, getPosition());
        }
        OwnedLayer layer = this.layer;
        return layer != null ? layer.mo5827mapOffset8S9VItk(relativeToPosition, true) : relativeToPosition;
    }

    protected final void drawBorder(Canvas canvas, Paint paint) {
        Rect rect = new Rect(0.5f, 0.5f, IntSize.m6867getWidthimpl(getMeasuredSize()) - 0.5f, IntSize.m6866getHeightimpl(getMeasuredSize()) - 0.5f);
    ...
    public final void rectInParent$ui_release(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (layer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long minTouch = m5763getMinimumTouchTargetSizeNHjbRc();
                    float horz = Size.m4014getWidthimpl(minTouch) / 2.0f;
                    float vert = Size.m4011getHeightimpl(minTouch) / 2.0f;
                    bounds.intersect(-horz, -vert, IntSize.m6867getWidthimpl(mo5537getSizeYbymL2g()) + horz, IntSize.m6866getHeightimpl(mo5537getSizeYbymL2g()) + vert);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, IntSize.m6867getWidthimpl(mo5537getSizeYbymL2g()), IntSize.m6866getHeightimpl(mo5537getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        int x = IntOffset.m6825getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + x);
        bounds.setRight(bounds.getRight() + x);
        int y = IntOffset.m6826getYimpl(getPosition());
    ...
    protected final boolean m5772withinLayerBoundsk4lQ0M(long pointerPosition) {
        if (!OffsetKt.m3962isFinitek4lQ0M(pointerPosition)) {
            return false;
        }
        OwnedLayer layer = this.layer;
        return layer == null || !this.isClipping || layer.mo5826isInLayerk4lQ0M(pointerPosition);
    }

    /* renamed from: isPointerInBounds-k-4lQ0M, reason: not valid java name */
    protected final boolean m5766isPointerInBoundsk4lQ0M(long pointerPosition) {
        float x = Offset.m3945getXimpl(pointerPosition);
        float y = Offset.m3946getYimpl(pointerPosition);
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(NodeCoordinator other) {
        ...
        if (ancestor1 == ancestor2) {
            ...
            int iM5778constructorimpl = NodeKind.m5778constructorimpl(2);
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        ...
        int count$iv$iv;
        MutableVector mutableVector;
        Modifier.Node start = headNode(NodeKindKt.m5787getIncludeSelfInTraversalH91voCI(NodeKind.m5778constructorimpl(16)));
        if (start != null && start.getIsAttached()) {
            Modifier.Node $this$visitSelfAndLocalDescendants_u2d6rFNWt0$iv = start;
            int type$iv3 = NodeKind.m5778constructorimpl(16);
    ...
    private final long m5753offsetFromEdgeMKHz9U(long pointerPosition) {
        float x = Offset.m3945getXimpl(pointerPosition);
    ...
    protected final long m5759calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        float widthDiff = Size.m4014getWidthimpl(minimumTouchTargetSize) - getMeasuredWidth();
        float heightDiff = Size.m4011getHeightimpl(minimumTouchTargetSize) - getMeasuredHeight();
        return SizeKt.Size(Math.max(0.0f, widthDiff / 2.0f), Math.max(0.0f, heightDiff / 2.0f));
    }

    /* renamed from: distanceInMinimumTouchTarget-tz77jQw, reason: not valid java name */
    protected final float m5760distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        if (getMeasuredWidth() >= Size.m4014getWidthimpl(minimumTouchTargetSize) && getMeasuredHeight() >= Size.m4011getHeightimpl(minimumTouchTargetSize)) {
            return Float.POSITIVE_INFINITY;
        }
        long jM5759calculateMinimumTouchTargetPaddingE7KxVPU = m5759calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float width = Size.m4014getWidthimpl(jM5759calculateMinimumTouchTargetPaddingE7KxVPU);
        float height = Size.m4011getHeightimpl(jM5759calculateMinimumTouchTargetPaddingE7KxVPU);
        long offsetFromEdge = m5753offsetFromEdgeMKHz9U(pointerPosition);
        if ((width > 0.0f || height > 0.0f) && Offset.m3945getXimpl(offsetFromEdge) <= width && Offset.m3946getYimpl(offsetFromEdge) <= height) {
            return Offset.m3944getDistanceSquaredimpl(offsetFromEdge);
        }
        return Float.POSITIVE_INFINITY;
    }
