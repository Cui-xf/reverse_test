...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m5733updateRootConstraintsBRTryo0(long constraints) {
        ...
        if (!(constraints2 == null ? false : Constraints.m6629equalsimpl0(constraints2.getValue(), constraints))) {
            ...
            this.rootConstraints = Constraints.m6624boximpl(constraints);
    ...
    */
    ...
    private final boolean m5730doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean lookaheadSizeChanged;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            lookaheadSizeChanged = layoutNode.m5697lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            lookaheadSizeChanged = LayoutNode.m5693lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    private final boolean m5731doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean sizeChanged;
        if (constraints != null) {
            sizeChanged = layoutNode.m5698remeasure_Sx5XlM$ui_release(constraints);
        } else {
            sizeChanged = LayoutNode.m5694remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    public final void m5732measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean lookaheadSizeChanged = m5730doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m6624boximpl(constraints));
                ...
                m5731doRemeasuresdFAvZA(layoutNode, Constraints.m6624boximpl(constraints));
        ...
        if (layoutNode.isPlaced() || layoutNode.isPlacedByParent() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (affectsLookahead) {
                if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                    sizeChanged = m5730doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
                }
                ...
                if (layoutNode.getMeasurePending$ui_release()) {
                    sizeChanged = m5731doRemeasuresdFAvZA(layoutNode, constraints);
                }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m5730doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m5731doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
