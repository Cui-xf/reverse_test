...
public final class ComposeScrollCaptureCallback implements ScrollCaptureCallback {
    ...
    static final class C06171 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C06171(ScrollCaptureSession scrollCaptureSession, Rect rect, Consumer<Rect> consumer, Continuation<? super C06171> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return ComposeScrollCaptureCallback.this.new C06171(this.$session, this.$captureArea, this.$onComplete, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c06171 = this;
                    c06171.label = 1;
                    Object objOnScrollCaptureImageRequest = ComposeScrollCaptureCallback.this.onScrollCaptureImageRequest(c06171.$session, RectHelper_androidKt.toComposeIntRect(c06171.$captureArea), c06171);
            ...
            c06171.$onComplete.accept(RectHelper_androidKt.toAndroidRect(result));
    ...
    public void onScrollCaptureImageRequest(ScrollCaptureSession session, CancellationSignal signal, Rect captureArea, Consumer<Rect> onComplete) {
        ComposeScrollCaptureCallback_androidKt.launchWithCancellationSignal(this.coroutineScope, signal, new C06171(session, captureArea, onComplete, null));
    }
    ...
    */
    ...
    private final void drawDebugBackground(Canvas $this$drawDebugBackground) {
        $this$drawDebugBackground.drawColor(ColorKt.m4241toArgb8_81llA(Color.Companion.m4211hslJlNiLsg$default(Color.INSTANCE, Random.INSTANCE.nextFloat() * 360.0f, 0.75f, 0.5f, 1.0f, null, 16, null)));
    }
