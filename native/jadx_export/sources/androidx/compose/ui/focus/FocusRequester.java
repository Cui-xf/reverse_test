...
public final class FocusRequester {
    ...
    public final boolean findFocusTargetNode$ui_release(Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        boolean zM3906findChildCorrespondingToFocusEnterOMvw8;
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv$iv.getAggregateChildKindSet() & iM5778constructorimpl) != 0) {
                                ...
                                while (nodePop != null) {
                                    ...
                                    if (nodePop instanceof FocusTargetNode) {
                                        ...
                                        if (it$iv.fetchFocusProperties$ui_release().getCanFocus()) {
                                            zM3906findChildCorrespondingToFocusEnterOMvw8 = function1.invoke(it$iv).booleanValue();
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                        } else {
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                            zM3906findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m3906findChildCorrespondingToFocusEnterOMvw8(it$iv, FocusDirection.INSTANCE.m3864getEnterdhqQ8s(), function1);
                                        }
                                        if (zM3906findChildCorrespondingToFocusEnterOMvw8) {
                                            success$iv = true;
                                            break;
                                        }
                                    } else {
                                        ...
                                        if (((this_$iv$iv$iv$iv3.getKindSet() & iM5778constructorimpl) != 0) && (nodePop instanceof DelegatingNode)) {
