...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m3897customFocusSearchOMvw8(FocusTargetNode $this$customFocusSearch_u2d_u2dOM_u2dvw8, int focusDirection, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3867getNextdhqQ8s())) {
            return focusProperties.getNext();
        }
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3868getPreviousdhqQ8s())) {
            return focusProperties.getPrevious();
        }
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3870getUpdhqQ8s())) {
            return focusProperties.getUp();
        }
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3863getDowndhqQ8s())) {
            return focusProperties.getDown();
        }
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3866getLeftdhqQ8s())) {
        ...
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3869getRightdhqQ8s())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
        ...
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3864getEnterdhqQ8s())) {
            return focusProperties.getEnter().invoke(FocusDirection.m3854boximpl(focusDirection));
        }
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3865getExitdhqQ8s())) {
            return focusProperties.getExit().invoke(FocusDirection.m3854boximpl(focusDirection));
        }
        throw new IllegalStateException("invalid FocusDirection".toString());
    }

    /* renamed from: focusSearch-0X8WOeE, reason: not valid java name */
    public static final Boolean m3898focusSearch0X8WOeE(FocusTargetNode $this$focusSearch_u2d0X8WOeE, int focusDirection, LayoutDirection layoutDirection, Rect previouslyFocusedRect, Function1<? super FocusTargetNode, Boolean> function1) {
        int direction;
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3867getNextdhqQ8s()) ? true : FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3868getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m3901oneDimensionalFocusSearchOMvw8($this$focusSearch_u2d0X8WOeE, focusDirection, function1));
        }
        if (FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3866getLeftdhqQ8s()) ? true : FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3869getRightdhqQ8s()) ? true : FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3870getUpdhqQ8s()) ? true : FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3863getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m3910twoDimensionalFocusSearchsMXa3k8($this$focusSearch_u2d0X8WOeE, focusDirection, previouslyFocusedRect, function1);
        }
        if (!FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3864getEnterdhqQ8s())) {
            if (!FocusDirection.m3857equalsimpl0(focusDirection, FocusDirection.INSTANCE.m3865getExitdhqQ8s())) {
                throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m3859toStringimpl(focusDirection))).toString());
            }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
            case 1:
                direction = FocusDirection.INSTANCE.m3869getRightdhqQ8s();
                break;
            case 2:
                direction = FocusDirection.INSTANCE.m3866getLeftdhqQ8s();
                break;
            default:
                throw new NoWhenBranchMatchedException();
        }
        ...
        if (focusTargetNodeFindActiveFocusNode2 != null) {
            return TwoDimensionalFocusSearchKt.m3910twoDimensionalFocusSearchsMXa3k8(focusTargetNodeFindActiveFocusNode2, direction, previouslyFocusedRect, function1);
        }
        return null;
    }
                    ...
                    if ((branch$iv$iv.getAggregateChildKindSet() & type$iv3) == 0) {
                        ...
                        while (true) {
                            if (node$iv$iv == null) {
                                ...
                                while (nodePop != null) {
                                    if (nodePop instanceof FocusTargetNode) {
                                        FocusTargetNode node2 = (FocusTargetNode) nodePop;
                    ...
                    if ((node$iv$iv.getKindSet() & type$iv5) != 0) {
                        ...
                        while (nodePop != null) {
                            ...
                            if (nodePop instanceof FocusTargetNode) {
                                ...
                                Modifier.Node this_$iv$iv$iv = nodePop;
                                if (((this_$iv$iv$iv.getKindSet() & type$iv5) != 0 ? 1 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                                    type$iv3 = type$iv5;
                                    includeSelf$iv3 = includeSelf$iv5;
                                    i3 = i5;
                                } else {
