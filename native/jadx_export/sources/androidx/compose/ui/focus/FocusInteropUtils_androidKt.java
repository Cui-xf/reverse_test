...
public final class FocusInteropUtils_androidKt {
    public static final FocusDirection toFocusDirection(int androidDirection) {
        switch (androidDirection) {
            case 1:
                return FocusDirection.m3854boximpl(FocusDirection.INSTANCE.m3868getPreviousdhqQ8s());
            case 2:
                return FocusDirection.m3854boximpl(FocusDirection.INSTANCE.m3867getNextdhqQ8s());
            case 17:
    ...
    public static final Integer m3871toAndroidFocusDirection3ESFkO8(int $this$toAndroidFocusDirection_u2d3ESFkO8) {
        if (FocusDirection.m3857equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3870getUpdhqQ8s())) {
            return 33;
        }
        if (FocusDirection.m3857equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3863getDowndhqQ8s())) {
            return 130;
        }
        if (FocusDirection.m3857equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3866getLeftdhqQ8s())) {
            return 17;
        }
        if (FocusDirection.m3857equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3869getRightdhqQ8s())) {
            return 66;
        }
        if (FocusDirection.m3857equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3867getNextdhqQ8s())) {
            return 2;
        }
        return FocusDirection.m3857equalsimpl0($this$toAndroidFocusDirection_u2d3ESFkO8, FocusDirection.INSTANCE.m3868getPreviousdhqQ8s()) ? 1 : null;
    }
