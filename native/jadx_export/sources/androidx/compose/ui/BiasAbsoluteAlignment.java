...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo3791alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        long remaining = IntSizeKt.IntSize(IntSize.m6867getWidthimpl(space) - IntSize.m6867getWidthimpl(size), IntSize.m6866getHeightimpl(space) - IntSize.m6866getHeightimpl(size));
        float centerX = IntSize.m6867getWidthimpl(remaining) / 2.0f;
        float centerY = IntSize.m6866getHeightimpl(remaining) / 2.0f;
