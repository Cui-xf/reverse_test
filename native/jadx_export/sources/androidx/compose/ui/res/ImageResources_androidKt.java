...
public final class ImageResources_androidKt {
    public static final ImageBitmap imageResource(ImageBitmap.Companion $this$imageResource, Resources res, int id) throws Resources.NotFoundException {
    ...
    public static final ImageBitmap imageResource(ImageBitmap.Companion $this$imageResource, int id, Composer $composer, int $changed) throws Resources.NotFoundException {
        Object value$iv;
        Object value$iv2;
