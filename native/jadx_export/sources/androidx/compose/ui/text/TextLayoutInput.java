...
public final class TextLayoutInput {
    ...
    public static /* synthetic */ TextLayoutInput m6112copyhu1Yfo$default(TextLayoutInput textLayoutInput, AnnotatedString annotatedString, TextStyle textStyle, List list, int i, boolean z, int i2, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long j, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        boolean z2 = z;
        return textLayoutInput.m6113copyhu1Yfo(annotatedString, textStyle, list, i, z2, i2, density2, layoutDirection2, resourceLoader2, j2);
    }
    ...
    public final TextLayoutInput m6113copyhu1Yfo(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long constraints) {
