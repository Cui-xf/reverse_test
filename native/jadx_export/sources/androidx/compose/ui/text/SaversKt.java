...
public final class SaversKt {
    private static final Saver<AnnotatedString, Object> AnnotatedStringSaver = SaverKt.Saver(new Function2<SaverScope, AnnotatedString, Object>() { // from class: androidx.compose.ui.text.SaversKt$AnnotatedStringSaver$1
        ...
        public final AnnotatedString invoke(Object it) {
            ...
            List list4 = null;
            List spanStylesOrNull = ((!Intrinsics.areEqual(value$iv, (Object) false) || (saver$iv instanceof NonNullValueClassSaver)) && value$iv != null) ? (List) saver$iv.restore(value$iv) : null;
            Object value$iv2 = list3.get(2);
            Saver saver$iv2 = SaversKt.AnnotationRangeListSaver;
            List paragraphStylesOrNull = ((!Intrinsics.areEqual(value$iv2, (Object) false) || (saver$iv2 instanceof NonNullValueClassSaver)) && value$iv2 != null) ? (List) saver$iv2.restore(value$iv2) : null;
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2<SaverScope, ParagraphStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope $this$Saver, ParagraphStyle it) {
            return CollectionsKt.arrayListOf(SaversKt.save(TextAlign.m6543boximpl(it.getTextAlign())), SaversKt.save(TextDirection.m6557boximpl(it.getTextDirection())), SaversKt.save(TextUnit.m6880boximpl(it.getLineHeight()), SaversKt.getSaver(TextUnit.INSTANCE), $this$Saver), SaversKt.save(it.getTextIndent(), SaversKt.getSaver(TextIndent.INSTANCE), $this$Saver));
        }
        ...
        public final ParagraphStyle invoke(Object it) {
            ...
            if ((!Intrinsics.areEqual(value$iv4, (Object) false) || (saver$iv2 instanceof NonNullValueClassSaver)) && value$iv4 != null) {
                textIndentRestore = saver$iv2.restore(value$iv4);
            }
    ...
    private static final Saver<TextLinkStyles, Object> TextLinkStylesSaver = SaverKt.Saver(new Function2<SaverScope, TextLinkStyles, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextLinkStylesSaver$1
        ...
        public final TextLinkStyles invoke(Object it) {
            ...
            SpanStyle styleOrNull = ((!Intrinsics.areEqual(value$iv, (Object) false) || (saver$iv instanceof NonNullValueClassSaver)) && value$iv != null) ? saver$iv.restore(value$iv) : null;
            Object value$iv2 = list.get(1);
            Saver saver$iv2 = SaversKt.getSpanStyleSaver();
            SpanStyle focusedStyleOrNull = ((!Intrinsics.areEqual(value$iv2, (Object) false) || (saver$iv2 instanceof NonNullValueClassSaver)) && value$iv2 != null) ? saver$iv2.restore(value$iv2) : null;
            Object value$iv3 = list.get(2);
            Saver saver$iv3 = SaversKt.getSpanStyleSaver();
            SpanStyle hoveredStyleOrNull = ((!Intrinsics.areEqual(value$iv3, (Object) false) || (saver$iv3 instanceof NonNullValueClassSaver)) && value$iv3 != null) ? saver$iv3.restore(value$iv3) : null;
            Object value$iv4 = list.get(3);
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2<SaverScope, TextIndent, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope $this$Saver, TextIndent it) {
            return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m6880boximpl(it.getFirstLine()), SaversKt.getSaver(TextUnit.INSTANCE), $this$Saver), SaversKt.save(TextUnit.m6880boximpl(it.getRestLine()), SaversKt.getSaver(TextUnit.INSTANCE), $this$Saver));
        }
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2<SaverScope, BaselineShift, Object>() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, BaselineShift baselineShift) {
            return m6076invoke8a2Sb4w(saverScope, baselineShift.m6440unboximpl());
        }

        /* renamed from: invoke-8a2Sb4w, reason: not valid java name */
        public final Object m6076invoke8a2Sb4w(SaverScope $this$Saver, float it) {
        ...
        public final BaselineShift invoke(Object it) {
            ...
            return BaselineShift.m6434boximpl(BaselineShift.m6435constructorimpl(((Float) it).floatValue()));
        }
    });
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextRange textRange) {
            return m6082invokeFDrldGo(saverScope, textRange.getPackedValue());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: invoke-FDrldGo, reason: not valid java name */
        public final Object m6082invokeFDrldGo(SaverScope $this$Saver, long it) {
            return CollectionsKt.arrayListOf(SaversKt.save(Integer.valueOf(TextRange.m6146getStartimpl(it))), SaversKt.save(Integer.valueOf(TextRange.m6141getEndimpl(it))));
        }
        ...
        public final TextRange invoke(Object it) {
            ...
            Intrinsics.checkNotNull(it$iv2);
            return TextRange.m6134boximpl(TextRangeKt.TextRange(iIntValue, ((Number) it$iv2).intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope $this$Saver, Shadow it) {
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m4177boximpl(it.getColor()), SaversKt.getSaver(Color.INSTANCE), $this$Saver), SaversKt.save(Offset.m3934boximpl(it.getOffset()), SaversKt.getSaver(Offset.INSTANCE), $this$Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
        }
        ...
        public final Shadow invoke(Object it) {
            ...
            long jM4197unboximpl = colorRestore.m4197unboximpl();
            Object value$iv2 = list.get(1);
            ...
            Intrinsics.checkNotNull(it$iv);
            return new Shadow(jM4197unboximpl, packedValue, ((Number) it$iv).floatValue(), null);
        }
    });
    private static final NonNullValueClassSaver<Color, Object> ColorSaver = NonNullValueClassSaver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m6078invoke4WTKRHQ(saverScope, color.m4197unboximpl());
        }

        /* renamed from: invoke-4WTKRHQ, reason: not valid java name */
        public final Object m6078invoke4WTKRHQ(SaverScope $this$NonNullValueClassSaver, long it) {
            if (it == 16) {
                return false;
            }
            return Integer.valueOf(ColorKt.m4241toArgb8_81llA(it));
        }
        ...
        public final Color invoke(Object it) {
            ...
            if (Intrinsics.areEqual(it, (Object) false)) {
                jColor = Color.INSTANCE.m4223getUnspecified0d7_KjU();
            } else {
                Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
                jColor = ColorKt.Color(((Integer) it).intValue());
            }
            return Color.m4177boximpl(jColor);
        }
    });
    private static final NonNullValueClassSaver<TextUnit, Object> TextUnitSaver = NonNullValueClassSaver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextUnit textUnit) {
            return m6084invokempE4wyQ(saverScope, textUnit.getPackedValue());
        }

        /* renamed from: invoke-mpE4wyQ, reason: not valid java name */
        public final Object m6084invokempE4wyQ(SaverScope $this$NonNullValueClassSaver, long it) {
            return TextUnit.m6887equalsimpl0(it, TextUnit.INSTANCE.m6901getUnspecifiedXSAIIZE()) ? (Serializable) false : CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m6890getValueimpl(it))), SaversKt.save(TextUnitType.m6915boximpl(TextUnit.m6889getTypeUIouoOA(it))));
        }
        ...
        public final TextUnit invoke(Object it) {
            if (Intrinsics.areEqual(it, (Object) false)) {
                return TextUnit.m6880boximpl(TextUnit.INSTANCE.m6901getUnspecifiedXSAIIZE());
            }
            Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any>");
            List list = (List) it;
            Object value$iv = list.get(0);
            ...
            return TextUnit.m6880boximpl(TextUnitKt.m6902TextUnitanM5pPY(fFloatValue, textUnitType.getType()));
        }
    });
    private static final NonNullValueClassSaver<Offset, Object> OffsetSaver = NonNullValueClassSaver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Offset offset) {
            return m6080invokeUv8p0NA(saverScope, offset.getPackedValue());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
        public final Object m6080invokeUv8p0NA(SaverScope $this$NonNullValueClassSaver, long it) {
            return Offset.m3942equalsimpl0(it, Offset.INSTANCE.m3960getUnspecifiedF1C5BW0()) ? (Serializable) false : CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(Offset.m3945getXimpl(it))), SaversKt.save(Float.valueOf(Offset.m3946getYimpl(it))));
        }
        ...
        public final Offset invoke(Object it) {
            if (Intrinsics.areEqual(it, (Object) false)) {
                return Offset.m3934boximpl(Offset.INSTANCE.m3960getUnspecifiedF1C5BW0());
            }
            Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
            List list = (List) it;
            Object value$iv = list.get(0);
            ...
            Intrinsics.checkNotNull(it$iv2);
            return Offset.m3934boximpl(OffsetKt.Offset(fFloatValue, ((Number) it$iv2).floatValue()));
        }
    });
