...
public final /* data */ class ParagraphInfo {
    ...
    public final long m6027toLocalMKHz9U(long $this$toLocal_u2dMK_u2dHz9U) {
        return OffsetKt.Offset(Offset.m3945getXimpl($this$toLocal_u2dMK_u2dHz9U), Offset.m3946getYimpl($this$toLocal_u2dMK_u2dHz9U) - this.top);
    }

    public final Rect toGlobal(Rect $this$toGlobal) {
        return $this$toGlobal.m3982translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Rect toLocal(Rect $this$toLocal) {
        return $this$toLocal.m3982translatek4lQ0M(OffsetKt.Offset(0.0f, -this.top));
    }

    public final Path toGlobal(Path $this$toGlobal) {
        $this$toGlobal.mo4082translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return $this$toGlobal;
    }

    /* renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m6025toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m6026toGlobalxdX6G0(j, z);
    }

    /* renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m6026toGlobalxdX6G0(long $this$toGlobal_u2dxdX6_u2dG0, boolean treatZeroAsNull) {
        if (treatZeroAsNull && TextRange.m6139equalsimpl0($this$toGlobal_u2dxdX6_u2dG0, TextRange.INSTANCE.m6151getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6151getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m6146getStartimpl($this$toGlobal_u2dxdX6_u2dG0)), toGlobalIndex(TextRange.m6141getEndimpl($this$toGlobal_u2dxdX6_u2dG0)));
    }
}
