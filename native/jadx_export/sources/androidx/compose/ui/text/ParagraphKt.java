...
public final class ParagraphKt {
    ...
    public static final Paragraph Paragraph(String text, TextStyle style, float width, Density density, FontFamily.Resolver fontFamilyResolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m6407ActualParagraphO3s9Psw(text, style, list, list2, maxLines, ellipsis, ConstraintsKt.Constraints$default(0, ceilToInt(width), 0, 0, 13, null), density, fontFamilyResolver);
    }

    /* renamed from: Paragraph-UdtVg6A, reason: not valid java name */
    public static final Paragraph m6028ParagraphUdtVg6A(String text, TextStyle style, long constraints, Density density, FontFamily.Resolver fontFamilyResolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m6407ActualParagraphO3s9Psw(text, style, list, list2, maxLines, ellipsis, constraints, density, fontFamilyResolver);
    }
    ...
    public static final Paragraph Paragraph(ParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, float width) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m6406ActualParagraphhBUhpc(paragraphIntrinsics, maxLines, ellipsis, ConstraintsKt.Constraints$default(0, ceilToInt(width), 0, 0, 13, null));
    }

    /* renamed from: Paragraph-_EkL_-Y$default, reason: not valid java name */
    public static /* synthetic */ Paragraph m6031Paragraph_EkL_Y$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i2 & 8) != 0) {
        ...
        return m6030Paragraph_EkL_Y(paragraphIntrinsics, j, i, z);
    }

    /* renamed from: Paragraph-_EkL_-Y, reason: not valid java name */
    public static final Paragraph m6030Paragraph_EkL_Y(ParagraphIntrinsics paragraphIntrinsics, long constraints, int maxLines, boolean ellipsis) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m6406ActualParagraphhBUhpc(paragraphIntrinsics, maxLines, ellipsis, constraints);
    }
