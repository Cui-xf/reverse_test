...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics intrinsics, long constraints, int maxLines, boolean ellipsis) {
        ...
        Rect it;
        int iM6635getMaxHeightimpl;
        this.intrinsics = intrinsics;
        this.maxLines = maxLines;
        int i = 0;
        if (!(Constraints.m6638getMinWidthimpl(constraints) == 0 && Constraints.m6637getMinHeightimpl(constraints) == 0)) {
        ...
        while (index < size) {
            ...
            int iM6636getMaxWidthimpl = Constraints.m6636getMaxWidthimpl(constraints);
            if (Constraints.m6631getHasBoundedHeightimpl(constraints)) {
                iM6635getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m6635getMaxHeightimpl(constraints) - ParagraphKt.ceilToInt(currentHeight), i);
            } else {
                iM6635getMaxHeightimpl = Constraints.m6635getMaxHeightimpl(constraints);
            }
            Paragraph paragraph = ParagraphKt.m6030Paragraph_EkL_Y(intrinsics2, ConstraintsKt.Constraints$default(0, iM6636getMaxWidthimpl, 0, iM6635getMaxHeightimpl, 5, null), this.maxLines - currentLineCount, ellipsis);
        ...
        this.width = Constraints.m6636getMaxWidthimpl(constraints);
    ...
    public final /* synthetic */ void m6016paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        canvas.save();
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            it.getParagraph().mo5983paintRPmYEkk(canvas, color, shadow, decoration);
    ...
    public final void m6015paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        canvas.save();
        List $this$fastForEach$iv = this.paragraphInfoList;
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
            Object item$iv = $this$fastForEach$iv.get(index$iv);
            ParagraphInfo it = (ParagraphInfo) item$iv;
            it.getParagraph().mo5982paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas.translate(0.0f, it.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m6017painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        AndroidMultiParagraphDraw_androidKt.m6400drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(final int start, final int end) {
        ...
        MultiParagraphKt.m6018findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(start, end), new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph.getPathForRange.2
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                Path.CC.m4464addPathUv8p0NA$default(path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(start), paragraphInfo.toLocalIndex(end))), 0L, 2, null);
            }
        });
        return path;
    }
    ...
    public final int m6012getOffsetForPositionk4lQ0M(long position) {
        int paragraphIndex = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m3946getYimpl(position));
        ...
        return $this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.toGlobalIndex($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.getParagraph().mo5979getOffsetForPositionk4lQ0M($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.m6027toLocalMKHz9U(position)));
    }

    /* renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public final long m6013getRangeForRect86BmAI(Rect rect, int granularity, TextInclusionStrategy inclusionStrategy) {
        ...
        if (this.paragraphInfoList.get(firstParagraph).getBottom() >= rect.getBottom() || firstParagraph == CollectionsKt.getLastIndex(this.paragraphInfoList)) {
            ...
            return ParagraphInfo.m6025toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u2412, $this$getRangeForRect_8_6BmAI_u24lambda_u2412.getParagraph().mo5980getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u2412.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
        }
        int lastParagraph = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, rect.getBottom());
        long startRange = TextRange.INSTANCE.m6151getZerod9O1mEE();
        while (TextRange.m6139equalsimpl0(startRange, TextRange.INSTANCE.m6151getZerod9O1mEE()) && firstParagraph <= lastParagraph) {
            ParagraphInfo $this$getRangeForRect_8_6BmAI_u24lambda_u2413 = this.paragraphInfoList.get(firstParagraph);
            startRange = ParagraphInfo.m6025toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u2413, $this$getRangeForRect_8_6BmAI_u24lambda_u2413.getParagraph().mo5980getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u2413.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            firstParagraph++;
        }
        if (TextRange.m6139equalsimpl0(startRange, TextRange.INSTANCE.m6151getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6151getZerod9O1mEE();
        }
        long endRange = TextRange.INSTANCE.m6151getZerod9O1mEE();
        while (TextRange.m6139equalsimpl0(endRange, TextRange.INSTANCE.m6151getZerod9O1mEE()) && firstParagraph <= lastParagraph) {
            ParagraphInfo $this$getRangeForRect_8_6BmAI_u24lambda_u2414 = this.paragraphInfoList.get(lastParagraph);
            endRange = ParagraphInfo.m6025toGlobalxdX6G0$default($this$getRangeForRect_8_6BmAI_u24lambda_u2414, $this$getRangeForRect_8_6BmAI_u24lambda_u2414.getParagraph().mo5980getRangeForRect86BmAI($this$getRangeForRect_8_6BmAI_u24lambda_u2414.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            lastParagraph--;
        }
        return TextRange.m6139equalsimpl0(endRange, TextRange.INSTANCE.m6151getZerod9O1mEE()) ? startRange : TextRangeKt.TextRange(TextRange.m6146getStartimpl(startRange), TextRange.m6141getEndimpl(endRange));
    }
    ...
    public final float[] m6011fillBoundingBoxes8ffj60Q(final long range, final float[] array, int arrayStart) {
        requireIndexInRange(TextRange.m6144getMinimpl(range));
        requireIndexInRangeInclusiveEnd(TextRange.m6143getMaximpl(range));
        ...
        MultiParagraphKt.m6018findParagraphsByRangeSbBc2M(this.paragraphInfoList, range, new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph$fillBoundingBoxes$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                ...
                int paragraphStart = paragraphInfo.getStartIndex() > TextRange.m6144getMinimpl(j) ? paragraphInfo.getStartIndex() : TextRange.m6144getMinimpl(j);
                int paragraphEnd = paragraphInfo.getEndIndex() < TextRange.m6143getMaximpl(j) ? paragraphInfo.getEndIndex() : TextRange.m6143getMaximpl(j);
                long finalRange = TextRangeKt.TextRange(paragraphInfo.toLocalIndex(paragraphStart), paragraphInfo.toLocalIndex(paragraphEnd));
                paragraphInfo.getParagraph().mo5977fillBoundingBoxes8ffj60Q(finalRange, fArr, intRef.element);
                int currentArrayEnd = intRef.element + (TextRange.m6142getLengthimpl(finalRange) * 4);
    ...
    public final long m6014getWordBoundaryjx7JFs(int offset) {
        int paragraphIndex;
        requireIndexInRangeInclusiveEnd(offset);
        int length = getAnnotatedString().length();
        List<ParagraphInfo> list = this.paragraphInfoList;
        ...
        return $this$getWordBoundary__jx7JFs_u24lambda_u2419.m6026toGlobalxdX6G0($this$getWordBoundary__jx7JFs_u24lambda_u2419.getParagraph().mo5981getWordBoundaryjx7JFs($this$getWordBoundary__jx7JFs_u24lambda_u2419.toLocalIndex(offset)), false);
    }
