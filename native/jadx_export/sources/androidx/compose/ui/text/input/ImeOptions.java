...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m6359getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m6387getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m6326getDefaulteUduSuo() : i3, (i4 & 32) != 0 ? null : platformImeOptions, (i4 & 64) != 0 ? LocaleList.INSTANCE.getEmpty() : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m6359getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m6387getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m6326getDefaulteUduSuo() : i3, (i4 & 32) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m6359getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m6387getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m6326getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ ImeOptions m6337copywBHncE4$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return imeOptions.m6340copywBHncE4(z, i, z2, i2, i3, platformImeOptions, localeList2);
    }

    /* renamed from: copy-wBHncE4, reason: not valid java name */
    public final ImeOptions m6340copywBHncE4(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, LocaleList hintLocales) {
    ...
    public static /* synthetic */ ImeOptions m6335copyYTHSh70$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i3;
        return imeOptions.m6338copyYTHSh70(z, i, z2, i2, i5, platformImeOptions2);
    }
    ...
    public final /* synthetic */ ImeOptions m6338copyYTHSh70(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ ImeOptions m6336copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        if ((i4 & 2) != 0) {
        ...
        return imeOptions.m6339copyuxg59PA(z, i, z2, i2, (i4 & 16) != 0 ? imeOptions.imeAction : i3);
    }
    ...
    public final /* synthetic */ ImeOptions m6339copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ImeOptions) && this.singleLine == ((ImeOptions) other).singleLine && KeyboardCapitalization.m6349equalsimpl0(this.capitalization, ((ImeOptions) other).capitalization) && this.autoCorrect == ((ImeOptions) other).autoCorrect && KeyboardType.m6366equalsimpl0(this.keyboardType, ((ImeOptions) other).keyboardType) && ImeAction.m6313equalsimpl0(this.imeAction, ((ImeOptions) other).imeAction) && Intrinsics.areEqual(this.platformImeOptions, ((ImeOptions) other).platformImeOptions) && Intrinsics.areEqual(this.hintLocales, ((ImeOptions) other).hintLocales);
    }

    public int hashCode() {
        int result = ChangeSize$$ExternalSyntheticBackport0.m(this.singleLine);
        int result2 = ((((((((result * 31) + KeyboardCapitalization.m6350hashCodeimpl(this.capitalization)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.autoCorrect)) * 31) + KeyboardType.m6367hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m6314hashCodeimpl(this.imeAction)) * 31;
        PlatformImeOptions platformImeOptions = this.platformImeOptions;
        return ((result2 + (platformImeOptions != null ? platformImeOptions.hashCode() : 0)) * 31) + this.hintLocales.hashCode();
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m6351toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m6368toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m6315toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + ", hintLocales=" + this.hintLocales + ')';
    }
}
