...
public final class TextFieldValue {
    ...
    private static final Saver<TextFieldValue, Object> Saver = SaverKt.Saver(new Function2<SaverScope, TextFieldValue, Object>() { // from class: androidx.compose.ui.text.input.TextFieldValue$Companion$Saver$1
        ...
        public final Object invoke(SaverScope $this$Saver, TextFieldValue it) {
            return CollectionsKt.arrayListOf(SaversKt.save(it.getText(), SaversKt.getAnnotatedStringSaver(), $this$Saver), SaversKt.save(TextRange.m6134boximpl(it.getSelection()), SaversKt.getSaver(TextRange.INSTANCE), $this$Saver));
        }
    ...
    private TextFieldValue(AnnotatedString annotatedString, long selection, TextRange composition) {
        ...
        this.selection = TextRangeKt.m6152coerceIn8ffj60Q(selection, 0, getText().length());
        this.composition = composition != null ? TextRange.m6134boximpl(TextRangeKt.m6152coerceIn8ffj60Q(composition.getPackedValue(), 0, getText().length())) : null;
    }
    ...
    public /* synthetic */ TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        long jM6151getZerod9O1mEE;
        TextRange textRange2;
        if ((i & 2) == 0) {
            jM6151getZerod9O1mEE = j;
        } else {
            jM6151getZerod9O1mEE = TextRange.INSTANCE.m6151getZerod9O1mEE();
        }
        if ((i & 4) == 0) {
        ...
        this(annotatedString, jM6151getZerod9O1mEE, textRange2, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.INSTANCE.m6151getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ TextFieldValue m6390copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m6392copy3r_uNRQ(annotatedString, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m6392copy3r_uNRQ(AnnotatedString annotatedString, long selection, TextRange composition) {
        return new TextFieldValue(annotatedString, selection, composition, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default, reason: not valid java name */
    public static /* synthetic */ TextFieldValue m6391copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m6393copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m6393copy3r_uNRQ(String text, long selection, TextRange composition) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextFieldValue) && TextRange.m6139equalsimpl0(this.selection, ((TextFieldValue) other).selection) && Intrinsics.areEqual(this.composition, ((TextFieldValue) other).composition) && Intrinsics.areEqual(this.text, ((TextFieldValue) other).text);
    }

    public int hashCode() {
        int result = this.text.hashCode();
        int result2 = ((result * 31) + TextRange.m6147hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return result2 + (textRange != null ? TextRange.m6147hashCodeimpl(textRange.getPackedValue()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.text) + "', selection=" + ((Object) TextRange.m6149toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
