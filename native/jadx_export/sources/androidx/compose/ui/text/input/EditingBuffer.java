...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m6144getMinimpl(selection);
        this.selectionEnd = TextRange.m6143getMaximpl(selection);
    ...
    public final TextRange m6307getCompositionMzsxiRA$ui_text_release() {
    ...
    public final long m6308getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m6309updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m6144getMinimpl(newSelection));
        setSelectionEnd(TextRange.m6143getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m6309updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
