...
public final class RecordingInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m6140getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (applying$iv) {
            ...
            this.eventCallback.mo6345onImeActionKlQnJC8(imeAction);
            return true;
        }
        return applying$iv;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m6144getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
