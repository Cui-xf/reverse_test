...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m6144getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m6143getMaximpl(textFieldValue.getSelection());
