...
public final class TextOverflow {
    ...
    private static final int Clip = m6590constructorimpl(1);
    private static final int Ellipsis = m6590constructorimpl(2);
    private static final int Visible = m6590constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextOverflow m6589boximpl(int i) {
        return new TextOverflow(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m6590constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m6591equalsimpl(this.value, obj);
    }
    ...
    public static String m6594toStringimpl(int arg0) {
        return m6592equalsimpl0(arg0, Clip) ? "Clip" : m6592equalsimpl0(arg0, Ellipsis) ? "Ellipsis" : m6592equalsimpl0(arg0, Visible) ? "Visible" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m6596getClipgIe3tQ8$annotations() {
        }

        /* renamed from: getEllipsis-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m6597getEllipsisgIe3tQ8$annotations() {
        }

        /* renamed from: getVisible-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m6598getVisiblegIe3tQ8$annotations() {
        }
        ...
        public final int m6599getClipgIe3tQ8() {
            return TextOverflow.Clip;
        }

        /* renamed from: getEllipsis-gIe3tQ8, reason: not valid java name */
        public final int m6600getEllipsisgIe3tQ8() {
            return TextOverflow.Ellipsis;
        }

        /* renamed from: getVisible-gIe3tQ8, reason: not valid java name */
        public final int m6601getVisiblegIe3tQ8() {
