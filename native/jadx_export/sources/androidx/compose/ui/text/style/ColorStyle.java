...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m6449copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m6451copy8_81llA(j);
    }
    ...
    public final ColorStyle m6451copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m4188equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m4195toStringimpl(this.value)) + ')';
    }
    ...
    public final long m6452getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    /* renamed from: getColor-0d7_KjU */
    public long mo6448getColor0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m4189getAlphaimpl(mo6448getColor0d7_KjU());
    }
}
