...
public final class TextStyleKt {
    ...
    public static final int m6192resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int textDirection) {
        if (TextDirection.m6560equalsimpl0(textDirection, TextDirection.INSTANCE.m6564getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m6565getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m6566getContentOrRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
        if (TextDirection.m6560equalsimpl0(textDirection, TextDirection.INSTANCE.m6569getUnspecifieds_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m6567getLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m6568getRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
