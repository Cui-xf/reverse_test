...
public final class FontVariation {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public float toVariationValue(Density density) {
            if (density != null) {
                return TextUnit.m6890getValueimpl(this.value) * density.getFontScale();
            }
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof SettingTextUnit) && Intrinsics.areEqual(getAxisName(), ((SettingTextUnit) other).getAxisName()) && TextUnit.m6887equalsimpl0(this.value, ((SettingTextUnit) other).value);
        }

        public int hashCode() {
            int result = getAxisName().hashCode();
            return (result * 31) + TextUnit.m6891hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + ((Object) TextUnit.m6897toStringimpl(this.value)) + ')';
        }
    }
    ...
    public final Setting m6281opticalSizingR2X_6o(long textSize) {
        if (!TextUnit.m6893isSpimpl(textSize)) {
    ...
    public final Settings m6280Settings6EWAqTQ(FontWeight weight, int style, Setting... settings) {
