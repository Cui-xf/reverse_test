...
public final class Font extends AndroidPreloadedFont {
    ...
    public /* synthetic */ Font(AssetManager assetManager, String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i2 & 8) == 0) {
            iM6265getNormal_LCdwA = i;
        } else {
            iM6265getNormal_LCdwA = FontStyle.INSTANCE.m6265getNormal_LCdwA();
        }
        this(assetManager, str, normal, iM6265getNormal_LCdwA, settings, null);
    }
    ...
    public String toString() {
        return "Font(assetManager, path=" + this.path + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m6260toStringimpl(getStyle())) + ')';
    }
