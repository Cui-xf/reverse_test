...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6211getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        boolean isBold = fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0;
        boolean isItalic = FontStyle.m6258equalsimpl0(fontStyle, FontStyle.INSTANCE.m6264getItalic_LCdwA());
