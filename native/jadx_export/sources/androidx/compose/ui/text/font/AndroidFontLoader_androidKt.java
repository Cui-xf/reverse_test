...
public final class AndroidFontLoader_androidKt {
    ...
    public static final Object loadAsync(final ResourceFont $this$loadAsync, Context context, Continuation<? super android.graphics.Typeface> continuation) throws Resources.NotFoundException {
        ...
        ResourcesCompat.getFont(context, $this$loadAsync.getResId(), new ResourcesCompat.FontCallback() { // from class: androidx.compose.ui.text.font.AndroidFontLoader_androidKt$loadAsync$2$1
            ...
            public void m6962x46c88379(android.graphics.Typeface typeface) {
                CancellableContinuation<android.graphics.Typeface> cancellableContinuation = continuation2;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m6999constructorimpl(typeface));
            }

            @Override // androidx.core.content.res.ResourcesCompat.FontCallback
            /* renamed from: onFontRetrievalFailed */
            public void m6961xb24343b7(int reason) {
