...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m6296getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    public /* synthetic */ ResourceFont(int i, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        int iM6265getNormal_LCdwA = (i4 & 4) != 0 ? FontStyle.INSTANCE.m6265getNormal_LCdwA() : i2;
        this(i, normal, iM6265getNormal_LCdwA, (i4 & 8) != 0 ? FontVariation.INSTANCE.m6280Settings6EWAqTQ(normal, iM6265getNormal_LCdwA, new FontVariation.Setting[0]) : settings, (i4 & 16) != 0 ? FontLoadingStrategy.INSTANCE.m6249getAsyncPKNRLFQ() : i3, null);
    }
    ...
    public static /* synthetic */ ResourceFont m6295copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return resourceFont.m6298copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg, reason: not valid java name */
    public final ResourceFont m6298copyRetOiIg(int resId, FontWeight weight, int style) {
        return m6294copyF3nL8kk$default(this, resId, weight, style, getLoadingStrategy(), null, 16, null);
    }

    /* renamed from: copy-F3nL8kk$default, reason: not valid java name */
    public static /* synthetic */ ResourceFont m6294copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        return resourceFont.m6297copyF3nL8kk(i, fontWeight, i2, i3, (i4 & 16) != 0 ? resourceFont.variationSettings : settings);
    }

    /* renamed from: copy-F3nL8kk, reason: not valid java name */
    public final ResourceFont m6297copyF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ResourceFont) && this.resId == ((ResourceFont) other).resId && Intrinsics.areEqual(getWeight(), ((ResourceFont) other).getWeight()) && FontStyle.m6258equalsimpl0(getStyle(), ((ResourceFont) other).getStyle()) && Intrinsics.areEqual(this.variationSettings, ((ResourceFont) other).variationSettings) && FontLoadingStrategy.m6245equalsimpl0(getLoadingStrategy(), ((ResourceFont) other).getLoadingStrategy());
    }

    public int hashCode() {
        int result = this.resId;
        return (((((((result * 31) + getWeight().hashCode()) * 31) + FontStyle.m6259hashCodeimpl(getStyle())) * 31) + FontLoadingStrategy.m6246hashCodeimpl(getLoadingStrategy())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m6260toStringimpl(getStyle())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m6247toStringimpl(getLoadingStrategy())) + ')';
    }
}
