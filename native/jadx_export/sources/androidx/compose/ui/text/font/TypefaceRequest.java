...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m6299copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        Object obj3 = obj;
        int i4 = i;
        return typefaceRequest.m6302copye1PVR60(fontFamily, fontWeight, i4, i2, obj3);
    }
    ...
    public final TypefaceRequest m6302copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis, Object resourceLoaderCacheKey) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.fontFamily, typefaceRequest.fontFamily) && Intrinsics.areEqual(this.fontWeight, typefaceRequest.fontWeight) && FontStyle.m6258equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m6269equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        return ((((((((this.fontFamily == null ? 0 : this.fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m6259hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m6270hashCodeimpl(this.fontSynthesis)) * 31) + (this.resourceLoaderCacheKey != null ? this.resourceLoaderCacheKey.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m6260toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m6273toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m6303getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m6304getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
