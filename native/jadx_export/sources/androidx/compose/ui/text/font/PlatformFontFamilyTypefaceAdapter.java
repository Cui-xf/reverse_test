...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.mo6285createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m6303getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo6286createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m6303getFontStyle_LCdwA());
        } else {
            ...
            result = ((AndroidTypeface) typeface).mo6398getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m6303getFontStyle_LCdwA(), typefaceRequest.m6304getFontSynthesisGVVA2EU());
        }
