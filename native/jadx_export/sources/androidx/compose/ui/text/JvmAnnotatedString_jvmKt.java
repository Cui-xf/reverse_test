...
public final class JvmAnnotatedString_jvmKt {
    ...
    public static final AnnotatedString transform(final AnnotatedString $this$transform, final Function3<? super String, ? super Integer, ? super Integer, String> function3) {
        ...
        List $this$fastMap$iv2 = $this$transform.getParagraphStylesOrNull$ui_text_release();
        if ($this$fastMap$iv2 == null) {
            newParaStyles = null;
        } else {
            int $i$f$fastMap3 = 0;
            ArrayList target$iv3 = new ArrayList($this$fastMap$iv2.size());
        ...
        List $this$fastMap$iv3 = $this$transform.getAnnotations$ui_text_release();
        if ($this$fastMap$iv3 == null) {
            newAnnotations = null;
        } else {
            int $i$f$fastMap5 = 0;
            ArrayList target$iv5 = new ArrayList($this$fastMap$iv3.size());
