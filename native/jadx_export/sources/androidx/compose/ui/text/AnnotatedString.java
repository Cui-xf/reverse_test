...
public final class AnnotatedString implements CharSequence {
    ...
    public final AnnotatedString m5997subSequence5zctL8(long range) {
        return subSequence(TextRange.m6144getMinimpl(range), TextRange.m6143getMaximpl(range));
    }
    ...
    */
    ...
    public static final /* data */ class Range<T> {
        ...
        public int hashCode() {
            return ((((((this.item == null ? 0 : this.item.hashCode()) * 31) + this.start) * 31) + this.end) * 31) + this.tag.hashCode();
        }
