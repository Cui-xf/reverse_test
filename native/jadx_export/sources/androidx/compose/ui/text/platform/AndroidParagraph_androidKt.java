...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph m6407ActualParagraphO3s9Psw(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis, long constraints, Density density, FontFamily.Resolver fontFamilyResolver) {
    ...
    public static final Paragraph m6406ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
