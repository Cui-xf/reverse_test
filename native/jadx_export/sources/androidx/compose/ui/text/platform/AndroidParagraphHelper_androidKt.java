...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float contextFontSize, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean useEmojiCompat) {
        ...
        if (useEmojiCompat && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch emojiSupportMatch = (platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m5998boximpl(paragraphSyle.getEmojiSupportMatch());
            if (emojiSupportMatch == null ? false : EmojiSupportMatch.m6001equalsimpl0(emojiSupportMatch.getValue(), EmojiSupportMatch.INSTANCE.m6005getAll_3YsG6Y())) {
                i = 1;
            } else {
                i = 0;
            }
        ...
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m6908isUnspecifiedR2X_6o(contextTextStyle.m6185getLineHeightXSAIIZE())) {
            return currentText;
        }
        ...
        if (isIncludeFontPaddingEnabled(contextTextStyle) && contextTextStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m6428setLineHeightr9BaKPg(spannableString, contextTextStyle.m6185getLineHeightXSAIIZE(), contextFontSize, density);
            ...
            spannableString2 = spannableString;
            SpannableExtensions_androidKt.m6427setLineHeightKmRG4DE(spannableString2, contextTextStyle.m6185getLineHeightXSAIIZE(), contextFontSize, density, lineHeightStyle2);
        }
