...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    */
    ...
    public Typeface mo6398getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Font font = (Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m6254matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font == null) {
        ...
        Object objM6279synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m6279synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
        Intrinsics.checkNotNull(objM6279synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
        return (Typeface) objM6279synthesizeTypefaceFxwP2eA;
    }
}
