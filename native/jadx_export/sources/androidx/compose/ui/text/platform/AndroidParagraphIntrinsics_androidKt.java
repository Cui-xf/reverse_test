...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m6405resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m6404resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m6404resolveTextDirectionHeuristicsHklW4sA(int textDirection, LocaleList localeList) {
        Locale currentLocale;
        if (TextDirection.m6560equalsimpl0(textDirection, TextDirection.INSTANCE.m6565getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m6560equalsimpl0(textDirection, TextDirection.INSTANCE.m6566getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m6560equalsimpl0(textDirection, TextDirection.INSTANCE.m6567getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m6560equalsimpl0(textDirection, TextDirection.INSTANCE.m6568getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m6560equalsimpl0(textDirection, TextDirection.INSTANCE.m6564getContents_7Xco()) ? true : TextDirection.m6560equalsimpl0(textDirection, TextDirection.INSTANCE.m6569getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle $this$hasEmojiCompat) {
        ...
        return !(((platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m5998boximpl(paragraphSyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m6001equalsimpl0(r0.getValue(), EmojiSupportMatch.INSTANCE.m6007getNone_3YsG6Y()));
    }
}
