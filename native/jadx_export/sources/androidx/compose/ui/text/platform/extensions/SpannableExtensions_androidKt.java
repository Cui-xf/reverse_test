...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        float firstLine;
        if (textIndent != null) {
            if ((!TextUnit.m6887equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) || !TextUnit.m6887equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) && !TextUnitKt.m6908isUnspecifiedR2X_6o(textIndent.getFirstLine()) && !TextUnitKt.m6908isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                long jM6889getTypeUIouoOA = TextUnit.m6889getTypeUIouoOA(textIndent.getFirstLine());
                float restLine = 0.0f;
                if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA, TextUnitType.INSTANCE.m6923getSpUIouoOA())) {
                    firstLine = density.mo366toPxR2X_6o(textIndent.getFirstLine());
                } else {
                    firstLine = TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA, TextUnitType.INSTANCE.m6922getEmUIouoOA()) ? TextUnit.m6890getValueimpl(textIndent.getFirstLine()) * contextFontSize : 0.0f;
                }
                long jM6889getTypeUIouoOA2 = TextUnit.m6889getTypeUIouoOA(textIndent.getRestLine());
                if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA2, TextUnitType.INSTANCE.m6923getSpUIouoOA())) {
                    restLine = density.mo366toPxR2X_6o(textIndent.getRestLine());
                } else if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA2, TextUnitType.INSTANCE.m6922getEmUIouoOA())) {
                    restLine = TextUnit.m6890getValueimpl(textIndent.getRestLine()) * contextFontSize;
                }
    ...
    public static final void m6427setLineHeightKmRG4DE(Spannable $this$setLineHeight_u2dKmRG4DE, long lineHeight, float contextFontSize, Density density, LineHeightStyle lineHeightStyle) {
        float resolvedLineHeight = m6422resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
            ...
            setSpan($this$setLineHeight_u2dKmRG4DE, new LineHeightStyleSpan(resolvedLineHeight, 0, endIndex, LineHeightStyle.Trim.m6535isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m6536isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, $this$setLineHeight_u2dKmRG4DE.length());
        }
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m6428setLineHeightr9BaKPg(Spannable $this$setLineHeight_u2dr9BaKPg, long lineHeight, float contextFontSize, Density density) {
        float resolvedLineHeight = m6422resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
    ...
    private static final float m6422resolveLineHeightInPxo2QH7mI(long lineHeight, float contextFontSize, Density density) {
        long jM6889getTypeUIouoOA = TextUnit.m6889getTypeUIouoOA(lineHeight);
        if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA, TextUnitType.INSTANCE.m6923getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo366toPxR2X_6o(lineHeight);
            }
            long fontSizeSp = density.mo370toSpkPz2Gy4(contextFontSize);
            float lineHeightMultiplier = TextUnit.m6890getValueimpl(lineHeight) / TextUnit.m6890getValueimpl(fontSizeSp);
            return lineHeightMultiplier * contextFontSize;
        }
        if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA, TextUnitType.INSTANCE.m6922getEmUIouoOA())) {
            return TextUnit.m6890getValueimpl(lineHeight) * contextFontSize;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable $this$setSpanStyles, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasLetterSpacing) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < $this$setSpanStyles.length() && end2 > start2 && end2 <= $this$setSpanStyles.length() && (it = m6421createLetterSpacingSpaneAf_CNQ(style.getLetterSpacing(), density)) != null) {
    ...
    private static final void setSpanStyle(Spannable $this$setSpanStyle, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m6424setBaselineShift0ocSgnM($this$setSpanStyle, style.getBaselineShift(), start, end);
        m6425setColorRPmYEkk($this$setSpanStyle, style.m6096getColor0d7_KjU(), start, end);
        ...
        m6426setFontSizeKmRG4DE($this$setSpanStyle, style.getFontSize(), density, start, end);
        ...
        m6423setBackgroundRPmYEkk($this$setSpanStyle, style.getBackground(), start, end);
    ...
    private static final void setFontAttributes(final Spannable $this$setFontAttributes, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(contextFontSpanStyle, fontRelatedSpanStyles, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int start, int end) {
                ...
                FontStyle fontStyleM6255boximpl = FontStyle.m6255boximpl(fontStyle != null ? fontStyle.m6261unboximpl() : FontStyle.INSTANCE.m6265getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM6255boximpl, FontSynthesis.m6266boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6275getAllGVVA2EU()))), start, end, 33);
            }
        });
    }
    ...
    private static final MetricAffectingSpan m6421createLetterSpacingSpaneAf_CNQ(long letterSpacing, Density density) {
        long jM6889getTypeUIouoOA = TextUnit.m6889getTypeUIouoOA(letterSpacing);
        if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA, TextUnitType.INSTANCE.m6923getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo366toPxR2X_6o(letterSpacing));
        }
        if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA, TextUnitType.INSTANCE.m6922getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m6890getValueimpl(letterSpacing));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle $this$needsLetterSpacingSpan) {
        return TextUnitType.m6918equalsimpl0(TextUnit.m6889getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m6923getSpUIouoOA()) || TextUnitType.m6918equalsimpl0(TextUnit.m6889getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m6922getEmUIouoOA());
    }

    private static final void setShadow(Spannable $this$setShadow, Shadow shadow, int start, int end) {
        if (shadow != null) {
            setSpan($this$setShadow, new ShadowSpan(ColorKt.m4241toArgb8_81llA(shadow.getColor()), Offset.m3945getXimpl(shadow.getOffset()), Offset.m3946getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), start, end);
        }
    }
    ...
    public static final void m6423setBackgroundRPmYEkk(Spannable $this$setBackground_u2dRPmYEkk, long color, int start, int end) {
        if (color != 16) {
            setSpan($this$setBackground_u2dRPmYEkk, new BackgroundColorSpan(ColorKt.m4241toArgb8_81llA(color)), start, end);
        }
    }
    ...
    public static final void setLocaleList(Spannable $this$setLocaleList, LocaleList localeList, int start, int end) {
        ...
        if (localeList != null) {
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                localeSpan = new LocaleSpan(locale.getPlatformLocale());
            }
    ...
    public static final void m6426setFontSizeKmRG4DE(Spannable $this$setFontSize_u2dKmRG4DE, long fontSize, Density density, int start, int end) {
        long jM6889getTypeUIouoOA = TextUnit.m6889getTypeUIouoOA(fontSize);
        if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA, TextUnitType.INSTANCE.m6923getSpUIouoOA())) {
            setSpan($this$setFontSize_u2dKmRG4DE, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo366toPxR2X_6o(fontSize)), false), start, end);
        } else if (TextUnitType.m6918equalsimpl0(jM6889getTypeUIouoOA, TextUnitType.INSTANCE.m6922getEmUIouoOA())) {
            setSpan($this$setFontSize_u2dKmRG4DE, new RelativeSizeSpan(TextUnit.m6890getValueimpl(fontSize)), start, end);
        }
    }
    ...
    public static final void m6425setColorRPmYEkk(Spannable $this$setColor_u2dRPmYEkk, long color, int start, int end) {
        if (color != 16) {
            setSpan($this$setColor_u2dRPmYEkk, new ForegroundColorSpan(ColorKt.m4241toArgb8_81llA(color)), start, end);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m6424setBaselineShift0ocSgnM(Spannable $this$setBaselineShift_u2d0ocSgnM, BaselineShift baselineShift, int start, int end) {
        if (baselineShift != null) {
            float it = baselineShift.m6440unboximpl();
    ...
    private static final void setBrush(Spannable $this$setBrush, Brush brush, float alpha, int start, int end) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m6425setColorRPmYEkk($this$setBrush, ((SolidColor) brush).getValue(), start, end);
    ...
    private static final boolean hasFontAttributes(TextStyle $this$hasFontAttributes) {
        return TextPaintExtensions_androidKt.hasFontAttributes($this$hasFontAttributes.toSpanStyle()) || $this$hasFontAttributes.m6179getFontSynthesisZQGJjVo() != null;
    }
