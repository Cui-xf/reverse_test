...
public final class Placeholder {
    ...
    private Placeholder(long width, long height, int placeholderVerticalAlign) {
        ...
        if (TextUnitKt.m6908isUnspecifiedR2X_6o(this.width)) {
            throw new IllegalArgumentException("width cannot be TextUnit.Unspecified".toString());
        }
        if (TextUnitKt.m6908isUnspecifiedR2X_6o(this.height)) {
    ...
    public final Placeholder m6057copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Placeholder) && TextUnit.m6887equalsimpl0(this.width, ((Placeholder) other).width) && TextUnit.m6887equalsimpl0(this.height, ((Placeholder) other).height) && PlaceholderVerticalAlign.m6064equalsimpl0(this.placeholderVerticalAlign, ((Placeholder) other).placeholderVerticalAlign);
    }

    public int hashCode() {
        int result = TextUnit.m6891hashCodeimpl(this.width);
        return (((result * 31) + TextUnit.m6891hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m6065hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m6897toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m6897toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m6066toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
