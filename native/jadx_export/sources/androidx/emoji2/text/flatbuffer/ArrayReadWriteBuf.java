...
public class ArrayReadWriteBuf implements ReadWriteBuf {
    ...
    public long getLong(int index) {
        long j = (this.buffer[index] & 255) | ((this.buffer[r1] & 255) << 8);
        long j2 = j | ((this.buffer[r0] & 255) << 16);
        long j3 = j2 | ((this.buffer[r1] & 255) << 24);
        long j4 = j3 | ((this.buffer[r0] & 255) << 32);
        int index2 = index + 1 + 1 + 1 + 1 + 1 + 1;
        return j4 | ((this.buffer[r1] & 255) << 40) | ((255 & this.buffer[index2]) << 48) | (this.buffer[index2 + 1] << 56);
    }
