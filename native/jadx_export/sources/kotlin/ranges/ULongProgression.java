...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m8211getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        return ((int) (this.step ^ (this.step >>> 32))) + (((((int) ULong.m7173constructorimpl(this.first ^ ULong.m7173constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m7173constructorimpl(this.last ^ ULong.m7173constructorimpl(this.last >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sbAppend = sb.append((Object) ULong.m7219toStringimpl(this.first)).append("..").append((Object) ULong.m7219toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sbAppend = sb.append((Object) ULong.m7219toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m7219toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m8238fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
