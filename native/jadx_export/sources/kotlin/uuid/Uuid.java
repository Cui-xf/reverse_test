...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m7167boximpl(ULong.m7173constructorimpl(getMostSignificantBits())), ULong.m7167boximpl(ULong.m7173constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m8474toUByteArrayTcUX1vc() {
        return UByteArray.m7070constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return this.mostSignificantBits != other.mostSignificantBits ? Long.compare(ULong.m7173constructorimpl(this.mostSignificantBits) ^ Long.MIN_VALUE, ULong.m7173constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m7173constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m7173constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m8476fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m8475fromUByteArrayGBYM_sE(byte[] ubyteArray) {
