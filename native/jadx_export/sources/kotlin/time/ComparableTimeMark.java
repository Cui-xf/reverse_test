...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo8329minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo8330minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo8331plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m8333minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo8331plusLRDsOJo(Duration.m8382unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m8337compareToLRDsOJo($this.mo8330minusUwyO8pc(other), Duration.INSTANCE.m8429getZEROUwyO8pc());
        }
    }
}
