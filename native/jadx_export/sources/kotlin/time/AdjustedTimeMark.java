...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo8329minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m8448minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo8328elapsedNowUwyO8pc() {
        return Duration.m8366minusLRDsOJo(this.mark.mo8328elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo8331plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m8367plusLRDsOJo(this.adjustment, duration), null);
    }
}
