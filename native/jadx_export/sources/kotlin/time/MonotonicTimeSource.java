...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m8451boximpl(m8445markNowz9LOYto());
    }
    ...
    public long m8445markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m8454constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m8444elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m8443differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m8442adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m8454constructorimpl(LongSaturatedMathKt.m8440saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
